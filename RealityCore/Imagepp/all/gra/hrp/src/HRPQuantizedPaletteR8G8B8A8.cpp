...
/**----------------------------------------------------------------------------
   ...
   ----------------------------------------------------------------------------
*/
HRPQuantizedPaletteR8G8B8A8::HRPQuantizedPaletteR8G8B8A8(uint16_t pi_MaxEntries,
                                                         Byte pi_Precision)
...
/**----------------------------------------------------------------------------
  ...
  @param po_pHistogram An optional histogram to fill with the color counts.
   ...
   ----------------------------------------------------------------------------
*/
uint16_t HRPQuantizedPaletteR8G8B8A8::GetPalette(HRPPixelPalette*  po_pPixelPalette,
