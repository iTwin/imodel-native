...
typedef uint32_t HVE2DShapeTypeId;
...
public:
    ...
    typedef list<HVE2DShape*, allocator<HVE2DShape*> >   ShapeList;

    // Used in the management and iteration of simple shapes
    typedef list<HVE2DSimpleShape*, allocator<HVE2DSimpleShape*> >   SimpleShapeList;
    ...
    /** -----------------------------------------------------------------------------
        ...
        instantiate a new HVE2DShape object. The first one is the default
    ...
    */
    HVE2DShape();
    HVE2DShape(const HFCPtr<HGF2DCoordSys>& pi_rpCoordSys);
    HVE2DShape(const HVE2DShape& pi_rObject);
    virtual            ~HVE2DShape();

    HVE2DShape&        operator=(const HVE2DShape& pi_rObj);

    // Shape type determination
    /** -----------------------------------------------------------------------------
        This method returns true if the shape is a descendant of HVE2DSimpleShape.
    ...
    */
    ...
    /** -----------------------------------------------------------------------------
        ...
        -----------------------------------------------------------------------------
    */
    virtual HVE2DShapeTypeId     GetShapeType() const = 0;
    ...
    */
    ...
    /** -----------------------------------------------------------------------------
        This method returns a pointer to dynamically allocated 
        light shape. The light shape must be deleted when not used anymore.            
        
        @return A light shape representing the shape.
    ...
    */
    ...
    /** -----------------------------------------------------------------------------
        ...
        -----------------------------------------------------------------------------
    */
    virtual HVE2DShape*           DifferentiateFromShapeSCS(const HVE2DShape& pi_rShape) const = 0;
    /** -----------------------------------------------------------------------------
        This method returns a pointer to a dynamically allocated shape that
        defines an area containing the area defined by one shape which is
        not located in the other shape.
        ...
        @see DifferentiateShape()
        @see DifferentiateFromShapeSCS()
        @see IntersectShape()
        @see UnifyShape
        -----------------------------------------------------------------------------
    */
    virtual HVE2DShape*           DifferentiateShapeSCS(const HVE2DShape& pi_rShape) const = 0;
    ...
    /** -----------------------------------------------------------------------------
        ...
        -----------------------------------------------------------------------------
    */
    virtual HVE2DShape*           IntersectShapeSCS(const HVE2DShape& pi_rShape) const = 0;
    ...
    /** -----------------------------------------------------------------------------
        ...
        -----------------------------------------------------------------------------
    */
    virtual HVE2DShape*           UnifyShapeSCS(const HVE2DShape& pi_rShape) const = 0;
    ...
    */
    ...
    /** -----------------------------------------------------------------------------
        ...
        HVE2DShape     MyFirst(pCoordSys);
        HVE2DShape     MySecond(pCoordSys);
        ...
...
private:
    ...
    SpatialPosition              CalculateSpatialPositionOfMultipleComponentVector(const HVE2DVector& pi_rVector) const;
    SpatialPosition              CalculateSpatialPositionOfComplexShape(const HVE2DShape& pi_rShape) const;
