...
/*----------------------------------------------------------------------------+
|struct HRAImageBicubicSamplerN8
...
struct HRAImageBicubicSamplerN8 : HRAImageSampler
{
public:
    // Use HRAImageSampler::CreateBicubicSampler(...) to instanciate this class.
    friend HRAImageSampler;
    virtual ~HRAImageBicubicSamplerN8();
...
private:
    HRAImageBicubicSamplerN8(HFCPtr<HGF2DTransfoModel>& destToSrcTransfo);
