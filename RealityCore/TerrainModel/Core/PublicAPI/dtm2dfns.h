...
BENTLEYDTM_Public                      int bcdtmInterruptLoad_trianglesDtmObject (BC_DTM_OBJ *dtmP, DTMFeatureCallback loadFunctionP, long useFence, DTMFenceType fenceType, DTMFenceOption fenceOption, DPoint3d *fencePtsP, long numFencePts, void *userP);
...
BENTLEYDTM_Public                      int bcdtmLoad_contourFeature(BC_DTM_OBJ *dtmP, BENTLEYTERRAINMODEL_NAMESPACE_NAME::DTMContourParamsCR contourParams, BENTLEYTERRAINMODEL_NAMESPACE_NAME::DTMFenceParamsCR fenceParams, DTMPondAppData* pondExtendedAppData, BC_DTM_OBJ *clipDtmP, long contourDirection, DTMFeatureCallback loadFunctionP, void *userP);
...
BENTLEYDTM_EXPORT                      int bcdtmLoad_contoursFromDtmObject(BC_DTM_OBJ *dtmP, BENTLEYTERRAINMODEL_NAMESPACE_NAME::DTMContourParamsCR contourParams, BENTLEYTERRAINMODEL_NAMESPACE_NAME::DTMFenceParamsCR fenceParams, DTMFeatureCallback loadFunctionP, void* userP);
...
BENTLEYDTM_EXPORT                      int bcdtmLoad_tinMeshFromDtmObject (BC_DTM_OBJ *dtmP, bool firstCall, long maxMeshSize, long useFence, DTMFenceType fenceType, DTMFenceOption fenceOption, DPoint3dCP fencePtsP, long numFencePts, bvector<DPoint3d>& meshPts, bvector<long>& meshFaces);
BENTLEYDTM_Private                     int bcdtmLoad_traceContourDtmObject(BC_DTM_OBJ *dtmP, BENTLEYTERRAINMODEL_NAMESPACE_NAME::DTMContourParamsCR contourParams, BENTLEYTERRAINMODEL_NAMESPACE_NAME::DTMFenceParamsCR fenceParams, DTMPondAppData* pondExtendedAppData, BC_DTM_OBJ* clipDTMP, double contourValue, long p1, long p2, DTMDirection direction, unsigned char *tinLineP, DTMFeatureCallback loadFunctionP, void *userP);
BENTLEYDTM_Private                     int bcdtmLoad_traceContourFromTriangleEdgeDtmObject(BC_DTM_OBJ *dtmP, BENTLEYTERRAINMODEL_NAMESPACE_NAME::DTMContourParamsCR contourParams, BENTLEYTERRAINMODEL_NAMESPACE_NAME::DTMFenceParamsCR fenceParams, DTMPondAppData* pondExtendedAppData, BC_DTM_OBJ* clipDtmP, double contourValue, long trgPnt1, long trgPnt2, DTMFeatureCallback loadFunctionP, void *userP);
BENTLEYDTM_Private                     int bcdtmLoad_traceContourLatticeObject (DTM_LAT_OBJ *latticeP, BENTLEYTERRAINMODEL_NAMESPACE_NAME::DTMContourParamsCR contourParams, BENTLEYTERRAINMODEL_NAMESPACE_NAME::DTMFenceParamsCR fenceParams, DTMPondAppData* pondExtendedAppData, BC_DTM_OBJ* clipDtmP, unsigned char *markLatP, float contourValue, long i1, long j1, long i2, long j2, DTMFeatureCallback loadFunctionP, void *userP);
BENTLEYDTM_Private                     int bcdtmLoad_traceZeroSlopeContourDtmObject (BC_DTM_OBJ *dtmP, BENTLEYTERRAINMODEL_NAMESPACE_NAME::DTMContourParamsCR contourParams, BENTLEYTERRAINMODEL_NAMESPACE_NAME::DTMFenceParamsCR fenceParams, DTMPondAppData* pondExtendedAppData, BC_DTM_OBJ* clipDtmP, long p1, long p2, DTMDirection direction, long contourDirection, double contourValue, unsigned char *tinLineP, DTMFeatureCallback loadFunctionP, void *userP);
...
BENTLEYDTM_Public                      int bcdtmPolygon_storePolygonTag (TagValue **TagList, long TagFlag, TagValue TagValue, long *Tagne, long *Tagme, long Tagminc);
BENTLEYDTM_Public                      int bcdtmPolygon_storeTagListInTagObject (TAGOBJ *Tag, TagValue *TagList, long NumTagValues, long Utag1, long Utag2, long Utag3, long Utag4);
...
BENTLEYDTM_Public                      int bcdtmTinVolume_prismToFlatPlane (double elevation, double X1, double Y1, double Z1, double X2, double Y2, double Z2, double X3, double Y3, double Z3, double &cutP, double &fillP, double &cutAreaP, double &fillAreaP);
