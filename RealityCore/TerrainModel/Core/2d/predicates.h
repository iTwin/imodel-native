...
#define doublePRINT doubleprint
#define doubleRAND doublerand
...
extern double epsilon;         /* = 2^(-p).  Used to estimate roundoff errors. */
/* A set of coefficients used to calculate maximum roundoff errors.          */
extern double resulterrbound;
extern double ccwerrboundA, ccwerrboundB, ccwerrboundC;
extern double o3derrboundA, o3derrboundB, o3derrboundC;
extern double iccerrboundA, iccerrboundB, iccerrboundC;
extern double isperrboundA, isperrboundB, isperrboundC;
extern double o3derrboundlifted;
...
inline int grow_expansion (int elen, double *e, double b, double *h)
...
inline int grow_expansion_zeroelim (int elen, double *e, double b, double *h)
/* e and h can be the same. */
    {
    double Q, hh;
    INEXACT double Qnew;
...
inline int expansion_sum (int elen, double *e, int flen, double *f, double *h)
...
inline int expansion_sum_zeroelim1 (int elen, double *e, int flen, double *f, double *h)
/* e and h can be the same, but f and h cannot. */
    {
    double Q;
    INEXACT double Qnew;
...
inline int expansion_sum_zeroelim2 (int elen, double *e, int flen, double *f, double *h)
/* e and h can be the same, but f and h cannot. */
    {
    double Q, hh;
    INEXACT double Qnew;
...
inline int fast_expansion_sum (int elen, double *e, int flen, double *f, double *h)
/* h cannot be e or f. */
    {
    double Q;
    INEXACT double Qnew;
...
inline int fast_expansion_sum_zeroelim (int elen, double *e, int flen, double *f, double *h)
/* h cannot be e or f. */
    {
    double Q;
    INEXACT double Qnew;
...
inline int linear_expansion_sum (int elen, double *e, int flen, double *f, double *h)
/* h cannot be e or f. */
    {
    double Q, q;
    INEXACT double Qnew;
...
inline int linear_expansion_sum_zeroelim (int elen, double *e, int flen, double *f,
                                   double *h)
                                   /* h cannot be e or f. */
    {
    double Q, q, hh;
...
inline int scale_expansion (int elen, double *e, double b, double *h)
...
inline int scale_expansion_zeroelim (int elen, double *e, double b, double *h)
/* e and h cannot be the same. */
    {
...
inline int compress (int elen, double *e, double *h)
...
inline double estimate (int elen, double *e)
    {
    double Q;
    int eindex;
...
inline double orient2dfast (DPoint3dCR pa, DPoint3dCR pb, DPoint3dCR pc)
    {
...
inline double orient2dexact (DPoint3dCR pa, DPoint3dCR pb, DPoint3dCR pc)
    {
...
inline double orient2dslow (DPoint3dCR pa, DPoint3dCR pb, DPoint3dCR pc)
    {
...
inline double orient2dadapt (DPoint3dCR pa, DPoint3dCR pb, DPoint3dCR pc, double detsum)
    {
    INEXACT double acx, acy, bcx, bcy;
...
inline double orient2d (DPoint3dCR pa, DPoint3dCR pb, DPoint3dCR pc)
    {
...
inline double orient1dexact_lifted
(
const double* pa,
const double* pb,
bool        lifted
    ...
    double axax1, ayay1, azaz1, bxbx1, byby1, bzbz1;
    double axax0, ayay0, azaz0, bxbx0, byby0, bzbz0;
    double aterms[4], bterms[4], cterms[4];
...
inline double orient3dfast (DPoint3dCR pa, DPoint3dCR pb, DPoint3dCR pc, DPoint3dCR pd)
    {
    double adx, bdx, cdx;
    double ady, bdy, cdy;
    double adz, bdz, cdz;
...
inline double orient3dexact (DPoint3dCR pa, DPoint3dCR pb, DPoint3dCR pc, DPoint3dCR pd)
    {
    ...
    alen = scale_expansion_zeroelim (bcdlen, bcd, pa.z, adet);
    blen = scale_expansion_zeroelim (cdalen, cda, -pb.z, bdet);
    clen = scale_expansion_zeroelim (dablen, dab, pc.z, cdet);
    dlen = scale_expansion_zeroelim (abclen, abc, -pd.z, ddet);
...
inline double orient3dslow (DPoint3dCR pa, DPoint3dCR pb, DPoint3dCR pc, DPoint3dCR pd)
    {
    ...
    Two_Diff (pa.x, pd.x, adx, adxtail);
    Two_Diff (pa.y, pd.y, ady, adytail);
    Two_Diff (pa.z, pd.z, adz, adztail);
    Two_Diff (pb.x, pd.x, bdx, bdxtail);
    Two_Diff (pb.y, pd.y, bdy, bdytail);
    Two_Diff (pb.z, pd.z, bdz, bdztail);
    Two_Diff (pc.x, pd.x, cdx, cdxtail);
    Two_Diff (pc.y, pd.y, cdy, cdytail);
    Two_Diff (pc.z, pd.z, cdz, cdztail);
...
inline double orient3dadapt (DPoint3dCR pa, DPoint3dCR pb, DPoint3dCR pc, DPoint3dCR pd, double permanent)
    {
...
inline double orient3d (DPoint3dCR pa, DPoint3dCR pb, DPoint3dCR pc, DPoint3dCR pd)
    {
    ...
    const double adz = pa.z - pd.z;
    const double bdz = pb.z - pd.z;
    const double cdz = pc.z - pd.z;
    ...
    const double permanent = (Absolute (bdxcdy) + Absolute (cdxbdy)) * Absolute (adz)
...
inline double incirclefast (DPoint3dCR pa, DPoint3dCR pb, DPoint3dCR pc, DPoint3dCR pd)
    {
...
inline double incircleexact (DPoint3dCR pa, DPoint3dCR pb, DPoint3dCR pc, DPoint3dCR pd)
    {
    INEXACT double axby1, bxcy1, cxdy1, dxay1, axcy1, bxdy1;
    INEXACT double bxay1, cxby1, dxcy1, axdy1, cxay1, dxby1;
    double axby0, bxcy0, cxdy0, dxay0, axcy0, bxdy0;
...
inline double incircleslow (DPoint3dCR pa, DPoint3dCR pb, DPoint3dCR pc, DPoint3dCR pd)
    {
...
inline double incircleadapt (DPoint3dCR pa, DPoint3dCR pb, DPoint3dCR pc, DPoint3dCR pd, double permanent)
    {
    INEXACT double adx, bdx, cdx, ady, bdy, cdy;
    double det, errbound;
...
inline double incircle (DPoint3dCR pa, DPoint3dCR pb, DPoint3dCR pc, DPoint3dCR pd)
    {
...
inline double orient2dexact_lifted
(
const double* pa,
const double* pb,
const double* pc,
bool        lifted
    ...
    {
    double aax1, aax0, aay1, aay0, aaz[2];
    double temp[4];
    double palift[6], pblift[6], pclift[6];
    double xy1terms[12], xy2terms[12];

    double aterms[24], bterms[24], cterms[24];
    double v[48], w[72];
...
inline double orient3dexact_lifted
(
double* predData,
const double* pa,
const double* pb,
...
bool        lifted
    ...
    double aax1, aax0, aay1, aay0, aaz[2];
    double temp[4];
    double palift[6], pblift[6], pclift[6], pdlift[6];
    double xy1terms[12], xy2terms[12];

    double ab[24], bc[24], cd[24], da[24], ac[24], bd[24];
    double temp48[48];
    double cda[72], dab[72], abc[72], bcd[72];
    double adet[144], bdet[144], cdet[144], ddet[144];
    double abdet[288], cddet[288];
    double deter[576];
...
inline double orient3dfastexact_lifted
(
double* predData,
const double*     pa,
const double*     pb,
...
bool            lifted
    ...
    return orient3dexact_lifted (predData, pa, pb, pc, pd, lifted);
    }
...
//    double abc, bcd, cda, dab;
    ...
    double abplus = Absolute (aexbey) + Absolute (bexaey);
    ab = aexbey - bexaey;

    double bexcey = bex * cey;
    double cexbey = cex * bey;
    double bcplus = Absolute (bexcey) + Absolute (cexbey);
    bc = bexcey - cexbey;

    double cexdey = cex * dey;
    double dexcey = dex * cey;
    double cdplus = Absolute (cexdey) + Absolute (dexcey);
    cd = cexdey - dexcey;

    double dexaey = dex * aey;
    double aexdey = aex * dey;
    double daplus = Absolute (dexaey) + Absolute (aexdey);
    da = dexaey - aexdey;

    double aexcey = aex * cey;
    double cexaey = cex * aey;
    double acplus = Absolute (aexcey) + Absolute (cexaey);
    ac = aexcey - cexaey;

    double bexdey = bex * dey;
    double dexbey = dex * bey;
    double bdplus = Absolute (bexdey) + Absolute (dexbey);
    bd = bexdey - dexbey;

    double det = (cd * blift - bd * clift + bc * dlift) * aez
        + (-cd * alift - da * clift - ac * dlift) * bez
        + (bd * alift + da * blift + ab * dlift) * cez
        + (-bc * alift + ac * blift - ab * clift) * dez;

    double aezplus = Absolute (aez);
    double bezplus = Absolute (bez);
    double cezplus = Absolute (cez);
    double dezplus = Absolute (dez);
    double permanent = (cdplus * blift + bdplus * clift + bcplus * dlift) * aezplus
...
inline double insphereexact (DPoint3dCR pa, DPoint3dCR pb, DPoint3dCR pc, DPoint3dCR pd, DPoint3dCR pe)
    {
...
inline double insphereslow (DPoint3dCR pa, DPoint3dCR pb, DPoint3dCR pc, DPoint3dCR pd, DPoint3dCR pe)
    {
    ...
    Two_Diff (pa.x, pe.x, aex, aextail);
    Two_Diff (pa.y, pe.y, aey, aeytail);
    Two_Diff (pa.z, pe.z, aez, aeztail);
    Two_Diff (pb.x, pe.x, bex, bextail);
    Two_Diff (pb.y, pe.y, bey, beytail);
    Two_Diff (pb.z, pe.z, bez, beztail);
    Two_Diff (pc.x, pe.x, cex, cextail);
    Two_Diff (pc.y, pe.y, cey, ceytail);
    Two_Diff (pc.z, pe.z, cez, ceztail);
    Two_Diff (pd.x, pe.x, dex, dextail);
    Two_Diff (pd.y, pe.y, dey, deytail);
    Two_Diff (pd.z, pe.z, dez, deztail);
...
inline double insphereadapt (DPoint3dCR pa, DPoint3dCR pb, DPoint3dCR pc, DPoint3dCR pd, DPoint3dCR pe,
                      double permanent)
    {
    INEXACT double aex, bex, cex, dex, aey, bey, cey, dey, aez, bez, cez, dez;
    double det, errbound;
...
inline double insphere (DPoint3dCR pa, DPoint3dCR pb, DPoint3dCR pc, DPoint3dCR pd, DPoint3dCR pe)
    {
    double aex, bex, cex, dex;
    double aey, bey, cey, dey;
    double aez, bez, cez, dez;
    ...
    double alift, blift, clift, dlift;
    double ab, bc, cd, da, ac, bd;
    double abplus, bcplus, cdplus, daplus, acplus, bdplus;
...
inline double insphereOld (DPoint3dCR pa, DPoint3dCR pb, DPoint3dCR pc, DPoint3dCR pd, DPoint3dCR pe)
    {
    double aex, bex, cex, dex;
    double aey, bey, cey, dey;
    double aez, bez, cez, dez;
    ...
    return insphereadapt (pa, pb, pc, pd, pe, permanent);
     ...
     inline int d_fast_expansion_sum_zeroelim
        (
        int      elen,
        double *e,
        int      flen,
     ...
     inline double d_fast_expansion_sum_sign
        (
        int      elen,
        double *e,
        int      flen,
     ...
     inline int d_scale_expansion_zeroelim
         (
         //const double* predConsts,
         int             elen,
         double*       e,
         double        b,
         double*       h
     ...
     inline int d_squared_scale_expansion_zeroelim
          (
          int             elen,
          double        *e,
          double        b,
     ...
     inline int mult_add
          ...
          {
          int tempalen = d_scale_expansion_zeroelim (lena, a, fa, tempa);
          int tempblen = d_scale_expansion_zeroelim (lenb, b, fb, tempb);
          int tempablen = d_fast_expansion_sum_zeroelim (tempalen, tempa, tempblen, tempb, tempab);
          tempalen = d_scale_expansion_zeroelim (lenc, c, fc, tempa);
     ...
     inline int calc_det
          ...
          int xlen = d_squared_scale_expansion_zeroelim (temp2len, temp2, f[0], temp8x);
          int ylen = d_squared_scale_expansion_zeroelim (temp2len, temp2, f[1], temp8y);
          int len = d_fast_expansion_sum_zeroelim (xlen, temp8x, ylen, temp8y, temp16);
          int zlen = d_squared_scale_expansion_zeroelim (temp2len, temp2, f[2], temp8z);

          return d_fast_expansion_sum_zeroelim (len, temp16, zlen, temp8z, ret24);
          }

     inline int calc_det_adapt
          (
          double           *a,
          int                alen,
          const double     x,
          ...
          {
          int xlen = d_squared_scale_expansion_zeroelim (alen, a, x, tempx);
          int ylen = d_squared_scale_expansion_zeroelim (alen, a, y, tempy);
          int zlen = d_squared_scale_expansion_zeroelim (alen, a, z, tempz);
    ...
    inline double orient3dExact_Lifted
        ...
        double* ab = predData; predData += 24;
        double* bc = predData; predData += 24;
        double* cd = predData; predData += 24;
        double* da = predData; predData += 24;
        double* ac = predData; predData += 24;
        double* bd = predData; predData += 24;
        double* temp48 = predData; predData += 48;
        double* cda = predData; predData += 72;
        double* dab = predData; predData += 72;
        double* abc = predData; predData += 72;
        double* bcd = predData; predData += 72;
        double* adet = predData; predData += 144;
        double* bdet = predData; predData += 144;
        double* cdet = predData; predData += 144;
        double* ddet = predData; predData += 144;
        double* abdet = predData; predData += 288;
        double* cddet = predData;
        ...
        // Compute the determinant as usual
        xy1len = d_scale_expansion_zeroelim (pblen, pblift, pa[1], xy1terms);
        xy2len = d_scale_expansion_zeroelim (palen, palift, -pb[1], xy2terms);
        ablen = d_fast_expansion_sum_zeroelim (xy1len, xy1terms, xy2len, xy2terms, ab);

        xy1len = d_scale_expansion_zeroelim (pclen, pclift, pb[1], xy1terms);
        xy2len = d_scale_expansion_zeroelim (pblen, pblift, -pc[1], xy2terms);
        bclen = d_fast_expansion_sum_zeroelim (xy1len, xy1terms, xy2len, xy2terms, bc);

        xy1len = d_scale_expansion_zeroelim (pdlen, pdlift, pc[1], xy1terms);
        xy2len = d_scale_expansion_zeroelim (pclen, pclift, -pd[1], xy2terms);
        cdlen = d_fast_expansion_sum_zeroelim (xy1len, xy1terms, xy2len, xy2terms, cd);

        xy1len = d_scale_expansion_zeroelim (palen, palift, pd[1], xy1terms);
        xy2len = d_scale_expansion_zeroelim (pdlen, pdlift, -pa[1], xy2terms);
        dalen = d_fast_expansion_sum_zeroelim (xy1len, xy1terms, xy2len, xy2terms, da);

        xy1len = d_scale_expansion_zeroelim (pclen, pclift, pa[1], xy1terms);
        xy2len = d_scale_expansion_zeroelim (palen, palift, -pc[1], xy2terms);
        aclen = d_fast_expansion_sum_zeroelim (xy1len, xy1terms, xy2len, xy2terms, ac);

        xy1len = d_scale_expansion_zeroelim (pdlen, pdlift, pb[1], xy1terms);
        xy2len = d_scale_expansion_zeroelim (pblen, pblift, -pd[1], xy2terms);
        ...
        alen = d_scale_expansion_zeroelim (bcdlen, bcd, pa[0], adet);
        blen = d_scale_expansion_zeroelim (cdalen, cda, -pb[0], bdet);
        clen = d_scale_expansion_zeroelim (dablen, dab, pc[0], cdet);
        dlen = d_scale_expansion_zeroelim (abclen, abc, -pd[0], ddet);
        ...
        inline double d_fast_expansion_sum_estimate
        (
        int      elen,
        double *e,
        int      flen,
    ...
    inline double insphereExact
        ...
        {
        // Index into global memory
        double* temp96 = predData; predData += Temp96Size;     //  abcd, bcde, cdea, deab, eabc;
        double* det384x = predData; predData += Det384xSize;
        double* det384y = predData; predData += Det384ySize;
        double* detxy = predData; predData += DetxySize;
        double* adet = predData; predData += AdetSize;
        double* bdet = predData; predData += BdetSize;
        double* abdet = predData; predData += AbdetSize;
        double* cdedet = predData;
        double* det384z = det384x;
        double* cdet = adet;
        double* ddet = bdet;
        double* edet = adet;
        double* cddet = abdet;
        double* temp48a = det384x;
        double* temp48b = det384y;
        ...
        two_mult_sub (pa, pb, ab);
        two_mult_sub (pb, pc, bc);
        two_mult_sub (pc, pd, cd);
        two_mult_sub (pd, pe, de);
        two_mult_sub (pe, pa, ea);
        two_mult_sub (pa, pc, ac);
        two_mult_sub (pb, pd, bd);
        two_mult_sub (pc, pe, ce);
        two_mult_sub (pd, pa, da);
        two_mult_sub (pe, pb, eb);

        // pa[2] # pb[2] # pc[2] => abc[24]
        abclen = mult_add (bc, 4, pa[2], ac, 4, -pb[2], ab, 4, pc[2], temp8a, temp8b, temp16, abc);
        bcdlen = mult_add (cd, 4, pb[2], bd, 4, -pc[2], bc, 4, pd[2], temp8a, temp8b, temp16, bcd);
        cdelen = mult_add (de, 4, pc[2], ce, 4, -pd[2], cd, 4, pe[2], temp8a, temp8b, temp16, cde);
        dealen = mult_add (ea, 4, pd[2], da, 4, -pe[2], de, 4, pa[2], temp8a, temp8b, temp16, dea);
        eablen = mult_add (ab, 4, pe[2], eb, 4, -pa[2], ea, 4, pb[2], temp8a, temp8b, temp16, eab);
        abdlen = mult_add (bd, 4, pa[2], da, 4, pb[2], ab, 4, pd[2], temp8a, temp8b, temp16, abd);
        bcelen = mult_add (ce, 4, pb[2], eb, 4, pc[2], bc, 4, pe[2], temp8a, temp8b, temp16, bce);
        cdalen = mult_add (da, 4, pc[2], ac, 4, pd[2], cd, 4, pa[2], temp8a, temp8b, temp16, cda);
        deblen = mult_add (eb, 4, pd[2], bd, 4, pe[2], de, 4, pb[2], temp8a, temp8b, temp16, deb);
        eaclen = mult_add (ac, 4, pe[2], ce, 4, pa[2], ea, 4, pc[2], temp8a, temp8b, temp16, eac);

        ///////////////////////////

        // => deab
        clen = calc_det (eab, eablen, deb, deblen, abd, abdlen, dea, dealen, pc,
                         temp48a, temp48b, temp96, det384x, det384y, det384z, detxy, cdet);

        // => eabc
        dlen = calc_det (abc, abclen, eac, eaclen, bce, bcelen, eab, eablen, pd,
                         temp48a, temp48b, temp96, det384x, det384y, det384z, detxy, ddet);

        cdlen = d_fast_expansion_sum_zeroelim (clen, cdet, dlen, ddet, cddet);

        // => abcd
        elen = calc_det (bcd, bcdlen, abd, abdlen, cda, cdalen, abc, abclen, pe,
        ...
        // => bcde
        alen = calc_det (cde, cdelen, bce, bcelen, deb, deblen, bcd, bcdlen, pa,
                         temp48a, temp48b, temp96, det384x, det384y, det384z, detxy, adet);

        // => cdea
        blen = calc_det (dea, dealen, cda, cdalen, eac, eaclen, cde, cdelen, pb,
                         temp48a, temp48b, temp96, det384x, det384y, det384z, detxy, bdet);

        ablen = d_fast_expansion_sum_zeroelim (alen, adet, blen, bdet, abdet);

        double ret = d_fast_expansion_sum_sign (ablen, abdet, cd_elen, cdedet);

        return ret;
        }

    inline double insphereAdaptExact
        (
        double*           predData,
        const double*     pa,
        const double*     pb,
        ...
        {
        double* tempData = predData;

        // Index into global memory
        double* xdet = tempData; tempData += 96;
        double* ydet = tempData; tempData += 96;
        double* zdet = tempData; tempData += 96;
        double* xydet = tempData; tempData += 192;
        double* adet = tempData; tempData += 288;
        double* bdet = tempData; tempData += 288;
        double* abdet = tempData; tempData += 576;
        double* cddet = tempData;
        double* cdet = adet;
        double* ddet = bdet;
        ...
        double abeps, bceps, cdeps, daeps, aceps, bdeps;
        double temp8a[8], temp8b[8], temp16[16], temp24[24];
        int temp24len;
        ...
        temp24len = mult_add (cd, 4, -bez, bd, 4, cez, bc, 4, -dez, temp8a, temp8b, temp16, temp24);
        alen = calc_det_adapt (temp24, temp24len, aex, aey, aez, xdet, ydet, zdet, xydet, adet);

        temp24len = mult_add (da, 4, cez, ac, 4, dez, cd, 4, aez, temp8a, temp8b, temp16, temp24);
        blen = calc_det_adapt (temp24, temp24len, bex, bey, bez, xdet, ydet, zdet, xydet, bdet);

        ablen = d_fast_expansion_sum_zeroelim (alen, adet, blen, bdet, abdet);

        temp24len = mult_add (ab, 4, -dez, bd, 4, -aez, da, 4, -bez, temp8a, temp8b, temp16, temp24);
        clen = calc_det_adapt (temp24, temp24len, cex, cey, cez, xdet, ydet, zdet, xydet, cdet);

        temp24len = mult_add (bc, 4, aez, ac, 4, -bez, ab, 4, cez, temp8a, temp8b, temp16, temp24);
        dlen = calc_det_adapt (temp24, temp24len, dex, dey, dez, xdet, ydet, zdet, xydet, ddet);
        ...
        return insphereExact (predData, pa, pb, pc, pd, pe);
        }

        inline double insphereFastAdaptExact
        (
        double*       predData,
        const double* pa,
        const double* pb,
        ...
        return insphereAdaptExact (predData, pa, pb, pc, pd, pe, permanent);   // Needs exact predicate
        }
#undef Split