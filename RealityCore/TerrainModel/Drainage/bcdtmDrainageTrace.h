...
int bcdtmDrainage_traceToLowPointDtmObject(BC_DTM_OBJ *dtmP,DTMDrainageTables *drainageTablesP,DTMFeatureCallback loadFunctionP,double falseLowDepth,ZeroSlopeTraceOption zeroSlopeOption,bool loadFlag,long pnt1,long pnt2,long pnt3,double X,double Y,double Z,void *userP,long *lowPoint1P,long *lowPoint2P ) ;
...
int bcdtmDrainage_traceMaximumDescentFromTriangleEdgeDtmObject( BC_DTM_OBJ *dtmP,DTMDrainageTables *drainageTablesP,ZeroSlopeTraceOption zeroSlopeOption,bool isFalseLow,double lastTraceAngle,long startPnt1, long startPnt2, long startPnt3, double startX, double startY, long *nextPnt1P, long *nextPnt2P, long *nextPnt3P, double *nextXP, double *nextYP, double *nextZP, bool *tracePointFoundP, long *exitPointP, long *priorPointP, long *nextPointP ) ;
int bcdtmDrainage_traceMaximumDescentFromTrianglePointDtmObject( BC_DTM_OBJ *dtmP, DTMDrainageTables *drainageTablesP,ZeroSlopeTraceOption zeroSlopeOption,bool isFalseLow,double lastAngle, long lastPnt, long startPnt, double startX, double startY, long *nextPnt1P, long *nextPnt2P, long *nextPnt3P, double *nextXP, double *nextYP, double *nextZP, bool *processP, long *exitPointP, long *priorPointP, long *nextPointP ) ;
int bcdtmDrainage_traceMaximumDescentFromPondExitPointDtmObject( BC_DTM_OBJ *dtmP, DTMDrainageTables *drainageTablesP, long priorPnt, long exitPnt, long nextPnt, double startX, double startY, long *nextPnt1P, long *nextPnt2P, long *nextPnt3P, double *nextXP, double *nextYP, double *nextZP, bool *processP ) ;
...
int bcdtmDrainage_traceToHighPointDtmObject(BC_DTM_OBJ *dtmP,DTMDrainageTables *drainageTablesP,DTMFeatureCallback loadFunctionP,double falseHighElevation,ZeroSlopeTraceOption traceOverZeroSlope,long loadFlag,long trgStartType, long pnt1,long pnt2,long pnt3,double X,double Y,double Z,void *userP,long *highPnt1P,long *highPnt2P,double *highXP,double *highYP,double *highZP) ;
int bcdtmDrainage_traceMaximumAscentFromTriangleEdgeDtmObject(BC_DTM_OBJ *dtmP,DTMDrainageTables *drainageTablesP,long isFalseHigh,ZeroSlopeTraceOption traceOverZeroSlope,double lastAngle,long pnt1,long pnt2,long pnt3,double startX,double startY,long *nextPnt1P,long *nextPnt2P,long *nextPnt3P,double *nextXP,double *nextYP,double *nextZP,bool *tracePointFoundP ) ;
int bcdtmDrainage_traceMaximumAscentFromTrianglePointDtmObject(BC_DTM_OBJ *dtmP,DTMDrainageTables *drainageTablesP,long isFalseHigh,ZeroSlopeTraceOption traceOverZeroSlope,double lastAngle,long lastPnt,long startPnt,double startX,double startY,long *nextPnt1P,long *nextPnt2P,long *nextPnt3P,double *nextXP,double *nextYP,double *nextZP,bool *tracePointFoundP ) ;
...
int bcdtmDrainage_traceToSumpLineFromTriangleEdgeDtmObject(BC_DTM_OBJ *dtmP,double lastAngle,long startPnt1,long startPnt2,long startPnt3,double startX,double startY,long *nextPnt1P,long *nextPnt2P,long *nextPnt3P,double *nextXP,double *nextYP,double *nextZP,bool *processP) ;
int bcdtmDrainage_traceToSumpLineFromTrianglePointDtmObject(BC_DTM_OBJ *dtmP,double lastAngle,long lastPnt,long startPnt,double startX,double startY,long *nextPnt1P,long *nextPnt2P,long *nextPnt3P,double *nextXP,double *nextYP,double *nextZP,bool *processP) ;
...
int bcdtmDrainage_checkTraceToSumpLineDtmObject(BC_DTM_OBJ *dtmP,DTMDrainageTables *drainageTablesP,long checkOption,double falseLowDepth,ZeroSlopeTraceOption traceOverZeroSlope,double X,double Y,double Z,double sumpX,double sumpY,double sumpZ,long sumpPoint1,long sumpPoint2,bool& tracedToSump) ;
int bcdtmDrainage_checkTraceToDrainPointDtmObject(BC_DTM_OBJ *dtmP,DTMDrainageTables *drainageTablesP,double falseLowDepth,ZeroSlopeTraceOption traceOverZeroSlope,double X,double Y, double Z,int drainPoint, bool& tracedToDrain) ;
