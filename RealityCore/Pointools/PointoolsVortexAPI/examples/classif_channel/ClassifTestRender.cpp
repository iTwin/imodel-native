...
//-----------------------------------------------------------------------------
ClassifTestRenderer::ClassifTestRenderer(int buffersize) 
...
//-----------------------------------------------------------------------------
void			ClassifTestRenderer::setClassifUserChannel( PThandle uc )
//-----------------------------------------------------------------------------
{
	m_channel = uc;
}
//-----------------------------------------------------------------------------
bool ClassifTestRenderer::drawPointClouds(bool dynamic, bool clearFrame)
//-----------------------------------------------------------------------------
{
...
//-----------------------------------------------------------------------------
void ClassifTestRenderer::initializeColMap()
//-----------------------------------------------------------------------------
{
	// Random Colors
	int i;
...
//-----------------------------------------------------------------------------
const PTubyte	* ClassifTestRenderer::mapClassificationToColor()
//-----------------------------------------------------------------------------
{
	if (!m_mapInit)
	{
	...
	const PTubyte *classification = reinterpret_cast<const PTubyte*>(m_queryBuffer.getChannelBuffer());
