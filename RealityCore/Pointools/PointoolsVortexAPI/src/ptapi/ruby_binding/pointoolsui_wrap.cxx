...
#define SWIG_init    Init_PointoolsUI
#define SWIG_name    "PointoolsUI"

static VALUE mPointoolsUI;
...
extern "C"
#endif
SWIGEXPORT void Init_PointoolsUI(void) {
    size_t i;
    
    SWIG_InitRuntime();
    mPointoolsUI = rb_define_module("PointoolsUI");
    ...
    rb_define_module_function(mPointoolsUI, "ptShowInterface", VALUEFUNC(_wrap_ptShowInterface), -1);
    rb_define_module_function(mPointoolsUI, "ptFlipMouseYCoords", VALUEFUNC(_wrap_ptFlipMouseYCoords), -1);
    rb_define_module_function(mPointoolsUI, "ptDontFlipMouseYCoords", VALUEFUNC(_wrap_ptDontFlipMouseYCoords), -1);
    rb_define_module_function(mPointoolsUI, "ptMouseMove", VALUEFUNC(_wrap_ptMouseMove), -1);
    rb_define_module_function(mPointoolsUI, "ptLButtonUp", VALUEFUNC(_wrap_ptLButtonUp), -1);
    rb_define_module_function(mPointoolsUI, "ptLButtonDown", VALUEFUNC(_wrap_ptLButtonDown), -1);
    rb_define_module_function(mPointoolsUI, "ptRButtonUp", VALUEFUNC(_wrap_ptRButtonUp), -1);
    rb_define_module_function(mPointoolsUI, "ptRButtonDown", VALUEFUNC(_wrap_ptRButtonDown), -1);
    rb_define_module_function(mPointoolsUI, "ptMButtonUp", VALUEFUNC(_wrap_ptMButtonUp), -1);
    rb_define_module_function(mPointoolsUI, "ptMButtonDown", VALUEFUNC(_wrap_ptMButtonDown), -1);
    rb_define_module_function(mPointoolsUI, "ptFindNearestPoint", VALUEFUNC(_wrap_ptFindNearestPoint), -1);
    rb_define_module_function(mPointoolsUI, "ptNearestPointX", VALUEFUNC(_wrap_ptNearestPointX), -1);
    rb_define_module_function(mPointoolsUI, "ptNearestPointY", VALUEFUNC(_wrap_ptNearestPointY), -1);
    rb_define_module_function(mPointoolsUI, "ptNearestPointZ", VALUEFUNC(_wrap_ptNearestPointZ), -1);
}
