...
struct C3dBridgeTestsFixture : ::testing::Test
    ...
    protected:
    static C3dBridgeTestsLogProvider s_logProvider;
    ...
    C3dBridgeTestsFixture() : m_client(nullptr) {}
    ~C3dBridgeTestsFixture();
    ...
    static BentleyApi::BeFileName GetC3dBridgeDllName();
    static WCharCP GetC3dBridgeRegSubKey();
...
struct LogProcessor
    ...
    LogProcessor(std::function<C3dBridgeTestsLogProvider::T_IsSeverityEnabled> sevf, std::function<C3dBridgeTestsLogProvider::T_LogMessage> logf)
        ...
        C3dBridgeTestsFixture::s_logProvider.m_sev = sevf;
        m_wasProc = C3dBridgeTestsFixture::s_logProvider.m_proc;
        C3dBridgeTestsFixture::s_logProvider.m_proc = logf;
        }

    ~LogProcessor()
        {
        C3dBridgeTestsFixture::s_logProvider.m_sev = m_wasSev;
        C3dBridgeTestsFixture::s_logProvider.m_proc = m_wasProc;
        }
    };
