...
*--------------------------------------------------------------------------------------------*/
#include "C3dBridgeTestsFixture.h"
...
C3dBridgeTestsLogProvider C3dBridgeTestsFixture::s_logProvider;
WString C3dBridgeTestsFixture::s_dwgbridgeRegSubKey;


/*---------------------------------------------------------------------------------**//**
* @bsimethod                                                    Don.Fu          06/19
+---------------+---------------+---------------+---------------+---------------+------*/
WCharCP C3dBridgeTestsFixture::GetC3dBridgeRegSubKey ()
    {
    if (s_dwgbridgeRegSubKey.empty())
        s_dwgbridgeRegSubKey.assign (L"C3dBridge");
    return s_dwgbridgeRegSubKey.c_str();
    }

/*---------------------------------------------------------------------------------**//**
* @bsimethod                                    Abeesh.Basheer                  10/2018
+---------------+---------------+---------------+---------------+---------------+------*/
BentleyApi::BeFileName C3dBridgeTestsFixture::GetOutputDir()
    {
...
* @bsimethod                                    Abeesh.Basheer                  10/2018
+---------------+---------------+---------------+---------------+---------------+------*/
BentleyApi::BeFileName  C3dBridgeTestsFixture::GetOutputFileName(BentleyApi::WCharCP filename)
    {
...
* @bsimethod                                    Abeesh.Basheer                  10/2018
+---------------+---------------+---------------+---------------+---------------+------*/
BentleyApi::BeFileName C3dBridgeTestsFixture::GetC3dBridgeDllName()
    {
    auto fileName = BentleyApi::Desktop::FileSystem::GetExecutableDir();
    fileName.AppendToPath(L"C3dBridgeM02.dll");
    return fileName;
    }
...
* @bsimethod                                    Abeesh.Basheer                  10/2018
+---------------+---------------+---------------+---------------+---------------+------*/
BentleyApi::BeFileName C3dBridgeTestsFixture::GetSeedFile()
    {
    BentleyApi::Dgn::ScopedDgnHost host;

    //Initialize parameters needed to create a DgnDb
    BentleyApi::BeSQLite::BeGuid guid;
    guid.FromString("dddfca2c-e231-491f-b20c-a3244333a224");    // Set the DbGuid, which is required by imodel-bank server
...
* @bsimethod                                    Abeesh.Basheer                  10/2018
+---------------+---------------+---------------+---------------+---------------+------*/
void C3dBridgeTestsFixture::SetUpTestCase()
    {
    ...
    sqLangFile.AppendToPath(L"sqlang\\C3dBridgeTests_en-US.sqlang.db3");
...
+---------------+---------------+---------------+---------------+---------------+------*/
void C3dBridgeTestsFixture::TearDownTestCase()
    {
...
+---------------+---------------+---------------+---------------+---------------+------*/
BentleyApi::BeFileName C3dBridgeTestsFixture::GetTestDataDir()
    {
...
* @bsimethod                                    Abeesh.Basheer                  10/2018
+---------------+---------------+---------------+---------------+---------------+------*/
void C3dBridgeTestsFixture::MakeCopyOfFile(BentleyApi::BeFileNameR outFile, BentleyApi::WCharCP filename, BentleyApi::WCharCP suffix)
    {
...
* @bsimethod                                    Abeesh.Basheer                  10/2018
+---------------+---------------+---------------+---------------+---------------+------*/
void C3dBridgeTestsFixture::SetUpBridgeProcessingArgs(BentleyApi::bvector<BentleyApi::WString>& args, WCharCP stagingDir, WCharCP bridgeRegSubkey, WCharCP iModelName)
    {
    auto useBank = GetIModelBankServerJs();
    auto rspFileName = useBank? L"imodel-bank.rsp": L"imodel-hub.rsp";

    FwkArgvMaker argvMaker;
    argvMaker.SetUpBridgeProcessingArgs(stagingDir, bridgeRegSubkey, GetC3dBridgeDllName(), iModelName, useBank, rspFileName);
...
* @bsimethod                                    Abeesh.Basheer                  10/2018
+---------------+---------------+---------------+---------------+---------------+------*/
void C3dBridgeTestsFixture::AddAttachment(BentleyApi::BeFileName& inputFile, BentleyApi::BeFileNameR refFile, int32_t num, bool useOffsetForElement)
    {
...
* @bsimethod                                    Abeesh.Basheer                  10/2018
+---------------+---------------+---------------+---------------+---------------+------*/
uint64_t C3dBridgeTestsFixture::AddLine(BentleyApi::BeFileName& inputFile, int num)
    {
    BentleyApi::Dgn::ScopedDgnHost dgnHost;
    ScopedDwgHost dwgHost;
    uint64_t    elementId = 0;
    DPoint3d    point1 = DPoint3d::From(70860, 1209510, 0);
    DPoint3d    point2 = DPoint3d::From(73860, 1209510, 0);
    DwgFileEditor editor(inputFile);
...
+---------------+---------------+---------------+---------------+---------------+------*/
BentleyApi::Dgn::DgnElementId C3dBridgeTestsFixture::DbFileInfo::GetRepositoryLinkByFileNameLike(BentleyApi::Utf8StringCR fn)
    {
...
+---------------+---------------+---------------+---------------+---------------+------*/
void C3dBridgeTestsFixture::DbFileInfo::ClearRepositoryAdmin()
    {
...
* @bsimethod                                    Sam.Wilson                      04/2019
+---------------+---------------+---------------+---------------+---------------+------*/
void C3dBridgeTestsFixture::DbFileInfo::SetRepositoryAdminFromBriefcaseClient(IModelClientForBridges& client)
    {
...
* @bsimethod                                    Abeesh.Basheer                  10/2018
+---------------+---------------+---------------+---------------+---------------+------*/
int32_t C3dBridgeTestsFixture::DbFileInfo::GetElementCount()
    {
...
* @bsimethod                                    Abeesh.Basheer                  10/2018
+---------------+---------------+---------------+---------------+---------------+------*/
C3dBridgeTestsFixture::DbFileInfo::DbFileInfo(BentleyApi::BeFileNameCR fileName)
    {
...
* @bsimethod                                    Sam.Wilson                      04/2019
+---------------+---------------+---------------+---------------+---------------+------*/
C3dBridgeTestsFixture::DbFileInfo::~DbFileInfo()
    {
...
* @bsimethod                                    Abeesh.Basheer                  10/2018
+---------------+---------------+---------------+---------------+---------------+------*/
int32_t C3dBridgeTestsFixture::DbFileInfo::GetModelCount ()
    {
...
* @bsimethod                                    Abeesh.Basheer                  10/2018
+---------------+---------------+---------------+---------------+---------------+------*/
int32_t C3dBridgeTestsFixture::DbFileInfo::GetPhysicalModelCount()
    {
...
* @bsimethod                                    Abeesh.Basheer                  10/2018
+---------------+---------------+---------------+---------------+---------------+------*/
int32_t C3dBridgeTestsFixture::DbFileInfo::GetBISClassCount(CharCP className)
    {
...
* @bsimethod                                    Abeesh.Basheer                  10/2018
+---------------+---------------+---------------+---------------+---------------+------*/
int32_t C3dBridgeTestsFixture::DbFileInfo::GetModelProvenanceCount(BentleyApi::BeSQLite::BeGuidCR fileGuid)
    {
...
* @bsimethod                                    Sam.Wilson                      03/19
+---------------+---------------+---------------+---------------+---------------+------*/
BentleyApi::BeFileName C3dBridgeTestsFixture::CreateTestDir(WCharCP testDir)
    {
...
* @bsimethod                                    Sam.Wilson                      03/19
+---------------+---------------+---------------+---------------+---------------+------*/
size_t C3dBridgeTestsFixture::GetChangesetCount()
    {
...
* @bsimethod                                    Sam.Wilson                      03/19
+---------------+---------------+---------------+---------------+---------------+------*/
RevisionStats C3dBridgeTestsFixture::ComputeRevisionStats(BentleyApi::Dgn::DgnDbR db, size_t start, size_t end)
    {
    RevisionStats stats{};
...
* @bsimethod                                    Sam.Wilson                      03/19
+---------------+---------------+---------------+---------------+---------------+------*/
BentleyApi::Utf8String C3dBridgeTestsFixture::ComputeAccessToken(Utf8CP uname)
    {
...
* @bsimethod                                    Sam.Wilson                      03/19
+---------------+---------------+---------------+---------------+---------------+------*/
BentleyApi::BeFileName C3dBridgeTestsFixture::WriteRulesFile(WCharCP fname, Utf8CP rules)
    {
...
BentleyApi::WString FwkArgvMaker::ReadRspFileFromTestData(BentleyApi::WCharCP rspFileBaseName)
    ...
    if (BSISUCCESS != readEntireFile(wargs, rspFileName))
        {
        BentleyApi::NativeLogging::LoggingManager::GetLogger("C3dBridgeTests")->errorv(L"%ls - response file not found\n", rspFileName.c_str());
        return L"";
        }
...
* @bsimethod                                    Sam.Wilson                      03/19
+---------------+---------------+---------------+---------------+---------------+------*/
BentleyApi::WebServices::ClientInfoPtr C3dBridgeTestsFixture::GetClientInfo()
    {
...
* @bsimethod                                    Sam.Wilson                      03/19
+---------------+---------------+---------------+---------------+---------------+------*/
BentleyApi::Dgn::IModelBankClient* C3dBridgeTestsFixture::CreateIModelBankClient(BentleyApi::Utf8StringCR accessToken)
    {
    FwkArgvMaker argvMaker;
...
* @bsimethod                                    Sam.Wilson                      03/19
+---------------+---------------+---------------+---------------+---------------+------*/
BentleyApi::Dgn::IModelHubClient* C3dBridgeTestsFixture::CreateIModelHubClient(BentleyApi::Utf8StringCR accessToken)
    {
    FwkArgvMaker argvMaker;
...
* @bsimethod                                    Sam.Wilson                      03/19
+---------------+---------------+---------------+---------------+---------------+------*/
BentleyApi::Dgn::TestIModelHubClientForBridges* C3dBridgeTestsFixture::CreateMockClient()
    {
...
* @bsimethod                                    Sam.Wilson                      03/19
+---------------+---------------+---------------+---------------+---------------+------*/
void C3dBridgeTestsFixture::SetupClient(BentleyApi::Utf8StringCR accessToken)
    {
    // TODO: Consult argv and check for --imodel-bank or --imodel-hub
    auto imbPath = GetIModelBankServerJs();
    if (imbPath != nullptr)
        {
        BentleyApi::NativeLogging::LoggingManager::GetLogger("C3dBridgeTests")->trace("Using IModelBankClient");
        m_client = CreateIModelBankClient(accessToken);
        }
    else if (getenv("DWGBRIDGE_TESTS_IMODEL_HUB"))
        {
        BentleyApi::NativeLogging::LoggingManager::GetLogger("C3dBridgeTests")->trace("Using IModelHubClient");
        m_client = CreateIModelHubClient(accessToken);
        }
    else
        {
        BentleyApi::NativeLogging::LoggingManager::GetLogger("C3dBridgeTests")->trace("Using TestIModelHubClientForBridges");
...
* @bsimethod                                    Sam.Wilson                      03/19
+---------------+---------------+---------------+---------------+---------------+------*/
C3dBridgeTestsFixture::~C3dBridgeTestsFixture()
    {
    if (m_client != nullptr)
        {
        delete m_client;
...
BentleyApi::BentleyStatus ProcessRunner::Start(size_t waitMs)
    ...
    BentleyApi::NativeLogging::LoggingManager::GetLogger("C3dBridgeTests")->tracev(L"++++++++++++++++++ %ls\n", m_cmdline.c_str());
    ...
    if (ok)
        ...
        do  {
            if (::strstr(Utf8String(processEntry.szExeFile).c_str(), name))
                ...
                BentleyApi::NativeLogging::LoggingManager::GetLogger("C3dBridgeTests")->tracev("%s %ld\n", processEntry.szExeFile, processEntry.th32ProcessID);
                break;
                }
...
BentleyApi::BentleyStatus ProcessRunner::Stop(size_t waitMs)
    ...
    if (WAIT_OBJECT_0 != status)
        ...
        BentleyApi::NativeLogging::LoggingManager::GetLogger("C3dBridgeTests")->warningv("%s wait = %x\n", m_cmdline.c_str(), status);
        }
    ...
    BentleyApi::NativeLogging::LoggingManager::GetLogger("C3dBridgeTests")->tracev(L"xxxxxxxxxxxxxxxxx %ls\n", m_cmdline.c_str());
...
* @bsimethod                                    Sam.Wilson                      03/19
+---------------+---------------+---------------+---------------+---------------+------*/
ProcessRunner C3dBridgeTestsFixture::StartImodelBankServer(BentleyApi::BeFileNameCR imodelDir, BentleyApi::Dgn::IModelBankClient& bankClient)
    {
...
* @bsimethod                                    Sam.Wilson                      03/19
+---------------+---------------+---------------+---------------+---------------+------*/
ProcessRunner C3dBridgeTestsFixture::StartImodelBridgeFwkExe(FwkArgvMaker const& argvMaker, size_t msWaitForStart)
    {
...
* @bsimethod                                    Sam.Wilson                      03/19
+---------------+---------------+---------------+---------------+---------------+------*/
BentleyApi::BeFileName C3dBridgeTestsFixture::GetIModelParentDir()
    {
...
* @bsimethod                                    Sam.Wilson                      03/19
+---------------+---------------+---------------+---------------+---------------+------*/
BentleyApi::BeFileName C3dBridgeTestsFixture::GetIModelDir()
    {
    BentleyApi::BeFileName outImodelDir = GetIModelParentDir();
    outImodelDir.AppendToPath(L"dddfca2c-e231-491f-b20c-a3244333a224");     // must match Tests/data/imodelfs and imodel.json
    return outImodelDir;
    }
...
* @bsimethod                                    Sam.Wilson                      03/19
+---------------+---------------+---------------+---------------+---------------+------*/
void C3dBridgeTestsFixture::CreateImodelBankRepository(BentleyApi::BeFileNameCR seedFile)
    {
...
* @bsimethod                                    Sam.Wilson                      03/19
+---------------+---------------+---------------+---------------+---------------+------*/
void C3dBridgeTestsFixture::CreateRepository(Utf8CP repoName)
    {
    if (nullptr == repoName)
...
* @bsimethod                                    Sam.Wilson                      03/19
+---------------+---------------+---------------+---------------+---------------+------*/
ProcessRunner C3dBridgeTestsFixture::StartServer()
    {
...
* @bsimethod                                    Abeesh.Basheer                  10/2018
+---------------+---------------+---------------+---------------+---------------+------*/
void C3dBridgeTestsFixture::RunTheBridge(BentleyApi::bvector<BentleyApi::WString> const& args)
    {
    iModelBridgeFwk fwk;
...
* @bsimethod                                    Abeesh.Basheer                  10/2018
+---------------+---------------+---------------+---------------+---------------+------*/
void C3dBridgeTestsFixture::SetupTestDirectory(BentleyApi::BeFileNameR testDir, BentleyApi::WCharCP dirName, BentleyApi::WCharCP iModelName,
    ...
    BentleyApi::WString dwgbridgeRegSubKey = GetC3dBridgeRegSubKey();
...
+---------------+---------------+---------------+---------------+---------------+------*/
BentleyApi::BentleyStatus C3dBridgeTestsFixture::DbFileInfo::GetiModelElementByDgnElementId(BentleyApi::Dgn::DgnElementId& elementId, uint64_t srcElementId)
    {
...
// @bsimethod                                    Sam.Wilson                      07/14
//---------------------------------------------------------------------------------------
void C3dBridgeTestsFixture::DbFileInfo::MustFindFileByName(RepositoryLinkId& fileid, BentleyApi::BeFileNameCR dwgFileNameIn, int expectedCount)
    {
...
// @bsimethod                                    Sam.Wilson                      07/14
//---------------------------------------------------------------------------------------
void C3dBridgeTestsFixture::DbFileInfo::MustFindModelByDwgModelId(DgnModelId& fmid, RepositoryLinkId ffid, uint64_t dwgHandle, int expectedCount)
    {
...
// @bsimethod                                    Sam.Wilson                      07/14
//---------------------------------------------------------------------------------------
void C3dBridgeTestsFixture::DbFileInfo::MustFindElementByDwgModelId(DgnElementId& eid, DgnModelId fmid, uint64_t dwgHandle, int expectedCount)
    {
...
// @bsimethod                                    Sam.Wilson                      04/2019
//---------------------------------------------------------------------------------------
uint64_t C3dBridgeTestsFixture::GetDefaultDwgModelId(BentleyApi::BeFileNameCR inputFile)
    {
    BentleyApi::Dgn::ScopedDgnHost dgnHost;
    ScopedDwgHost dwgHost;
    DwgFileEditor editor(inputFile);
...
uint64_t ExternalSourceAspectTests::AddLayer (BentleyApi::BeFileName& inputFile, BentleyApi::Utf8StringCR layerName)
{
    BentleyApi::Dgn::ScopedDgnHost dgnHost;
    ScopedDwgHost dwgHost;
    DwgString wLayerName(layerName);
    DwgFileEditor editor(inputFile);
    DwgDbObjectId id;
...
{
    C3dBridgeTestsFixture::DbFileInfo info (dbFile);
...
* @bsimethod                                    Sam.Wilson                      04/2019
+---------------+---------------+---------------+---------------+---------------+------*/
BentleyApi::Dgn::SubjectCPtr C3dBridgeTestsFixture::DbFileInfo::GetFirstJobSubject()
    {
...
* @bsimethod                                    Sam.Wilson                      04/2019
+---------------+---------------+---------------+---------------+---------------+------*/
BentleyApi::Dgn::DgnCodeInfoSet C3dBridgeTestsFixture::DbFileInfo::GetCodeInfos(DgnCodeSet const& codes, BentleyApi::Dgn::IModelClientForBridges& client)
    {
...
* @bsimethod                                    Sam.Wilson                      04/2019
+---------------+---------------+---------------+---------------+---------------+------*/
BentleyApi::BentleyStatus C3dBridgeTestsFixture::DbFileInfo::GetCodeInfo(BentleyApi::Dgn::DgnCodeInfo& codeInfo, BentleyApi::Dgn::DgnCode const& code, BentleyApi::Dgn::IModelClientForBridges& client)
    {
    DgnCodeSet codes;
    codes.insert(code);
...
* @bsimethod                                    Sam.Wilson                      04/2019
+---------------+---------------+---------------+---------------+---------------+------*/
BentleyApi::Dgn::LockLevel C3dBridgeTestsFixture::DbFileInfo::QueryLockLevel(BentleyApi::Dgn::LockableId lockable, BentleyApi::Dgn::IModelClientForBridges& client)
    {
    BentleyApi::Http::HttpClient::Reinitialize(); // In case Unintialize was called prior to this.
    SetRepositoryAdminFromBriefcaseClient(client);
