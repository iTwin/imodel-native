...
class MainWindow:
    ...
    def __initialize_controls(self):
        ...
        self.__create_repo_checkbutton = Checkbutton(self.__main_label_frame, text='Create Repository (if necessary)?',
        ...
        self.__skip_assignment_check_checkbutton = Checkbutton(self.__main_label_frame, text='Skip Assignment Check?',
        ...
        self.__main_label_frame.columnconfigure(1, weight=1)
