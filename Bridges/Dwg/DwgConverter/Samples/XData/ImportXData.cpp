...
BentleyStatus   ImportXData::_ImportEntity (ElementImportResults& results, ElementImportInputs& inputs)
    ...
    LOG.tracev ("DgnElement %s has been created from entity %lld, checking XDATA...", dgnElement->GetDisplayLabel().c_str(), inputs.GetEntity().GetObjectId().ToUInt64());
...
// @bsimethod
//---------------------------------------------------------------------------------------
void ImportXDataSample::_SetClientInfo ()
    {
    // Set CONNECTION Client information to track product usage
    // Sample product name
    static constexpr char s_bridgeName[] = "iModelBridgeService-ImportXDataSample";
    // A GUID generated specifically for this sample product
    static constexpr char s_bridgeGuid[] = "6C554D3A-776E-47FE-8F47-E49E9D2CB9B9";
    // PRGID, a product ID registered by PRG
