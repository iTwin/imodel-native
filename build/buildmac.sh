...
export NDEBUG=1
python3 "$SrcRoot"imodel-native/build/BentleyBuild/BentleyBuild.py -s "$SrcRoot"imodel-native/build/strategies/iModelJsNodeAddonOpen.BuildStrategy.xml -a $arch --srcroot="$SrcRoot" --outputroot="$SrcRoot"../out build ${@:1}
