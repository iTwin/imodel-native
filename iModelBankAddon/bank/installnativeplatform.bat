...
echo on
xcopy /QYIS %OutRoot%\Winx64\imodelbankaddon_pkgs\imodel-bank           %destDir%
xcopy /QYIS %OutRoot%\Winx64\imodelbankaddon_pkgs\imodel-bank-win32-x64 %destDir%\imodel-bank-win32-x64
@echo off
