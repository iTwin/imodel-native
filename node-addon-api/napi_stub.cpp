...
*--------------------------------------------------------------------------------------------*/
#include "Napi/node_api-config.h"
#include "Napi/node-src/node_api.h"
#include <signal.h>
#include <stdlib.h>
#include <stdio.h>
...
// On Windows, we delay load iTwinNapi.dll.
// We Register a delay-load hook to redirect any of its references to be from the loading executable (node.exe or electron.exe)
...
#if NAPI_VERSION >= 5
FORWARD_NAPI_EXPORT("create_date")
FORWARD_NAPI_EXPORT("get_date_value")
FORWARD_NAPI_EXPORT("is_date")
...
FORWARD_NAPI_EXPORT("get_all_property_names")
FORWARD_NAPI_EXPORT("get_instance_data")
...
NAPI_EXTERN napi_status napi_get_uv_event_loop(napi_env env,
                                               struct uv_loop_s** loop){ return napi_ok; }

#endif  // NAPI_VERSION >= 2

#if NAPI_VERSION >= 3

NAPI_EXTERN napi_status napi_fatal_exception(napi_env env, napi_value err){ return napi_ok; }
...
NAPI_EXTERN napi_status napi_open_callback_scope(napi_env env,
                                                 ...
                                                 napi_callback_scope* result){ return napi_ok; }

NAPI_EXTERN napi_status napi_close_callback_scope(napi_env env,
                                                  napi_callback_scope scope){ return napi_ok; }
...
napi_create_threadsafe_function(napi_env env,
                                ...
                                napi_threadsafe_function* result){ return napi_ok; }
...
napi_call_threadsafe_function(napi_threadsafe_function func,
                              void* data,
                              napi_threadsafe_function_call_mode is_blocking){ return napi_ok; }

NAPI_EXTERN napi_status
napi_acquire_threadsafe_function(napi_threadsafe_function func){ return napi_ok; }

NAPI_EXTERN napi_status
napi_release_threadsafe_function(napi_threadsafe_function func,
                                 napi_threadsafe_function_release_mode mode){ return napi_ok; }

NAPI_EXTERN napi_status
napi_unref_threadsafe_function(napi_env env, napi_threadsafe_function func){ return napi_ok; }

NAPI_EXTERN napi_status
napi_ref_threadsafe_function(napi_env env, napi_threadsafe_function func){ return napi_ok; }
...
napi_get_last_error_info(napi_env env,
                         const napi_extended_error_info** result){ return napi_ok; }

// Getters for defined singletons
NAPI_EXTERN napi_status napi_get_undefined(napi_env env, napi_value* result){ return napi_ok; }
...
NAPI_EXTERN napi_status napi_get_cb_info(
    ...
    void** data){ return napi_ok; }          // [out] Receives the data pointer for the callback.
...
NAPI_EXTERN napi_status napi_set_instance_data(napi_env env,
                                               void* data,
                                               napi_finalize finalize_cb,
                                               void* finalize_hint){ return napi_ok; }
