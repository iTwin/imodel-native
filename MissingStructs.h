...
constexpr double s_oneKilometer = 1000.0;
constexpr double s_circumferenceOfEarth = 40075.0 * s_oneKilometer; // approximate
...
typedef ElementAlignedBox3d const &ElementAlignedBox3dCR;
...
typedef ElementAlignedBox2d const &ElementAlignedBox2dCR;
...
public:
  ...
  AxisAlignedBox3d CalculateRange() const;
  ...
  bool TryApplyTransform(TransformCR trans);
  ...
  bool IsValid() const
  {
    ...
    double maxCoord = s_circumferenceOfEarth;
