...
struct EventServiceConnection
    ...
    private:
        ...
        EventServiceConnection(Utf8String sasToken, Utf8String nameSpace, Utf8String connectionId);
        //__PUBLISH_SECTION_START__
    public:
        DGNDBSERVERCLIENT_EXPORT static EventServiceConnectionPtr Create(Utf8String sasToken, Utf8String nameSpace);
        DGNDBSERVERCLIENT_EXPORT static EventServiceConnectionPtr Create(Utf8String sasToken, Utf8String nameSpace, Utf8String connectionId);
        ...
        DGNDBSERVERCLIENT_EXPORT Utf8String GetConnectionId();
    };
