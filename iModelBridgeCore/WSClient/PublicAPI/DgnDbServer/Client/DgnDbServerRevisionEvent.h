...
struct DgnDbServerRevisionEvent : public IDgnDbServerEvent
    ...
    private:
        ...
        Utf8String m_date;
        DgnDbServerRevisionEvent(Utf8String repoId, Utf8String userId, Utf8String revisionId, Utf8String date);

    public:
        DGNDBSERVERCLIENT_EXPORT static std::shared_ptr<struct DgnDbServerRevisionEvent> Create(Utf8String repoId, Utf8String userId, Utf8String revisionId, Utf8String date);
