/*--------------------------------------------------------------------------------------+
 |
 |     $Source: Client/MobileTracking.cpp $
 |
...
+---------------+---------------+---------------+---------------+---------------+------*/
MobileTracking::MobileTracking() : m_deviceID(""), m_imsUserID(""), m_productID(""), m_projectID(""), m_usageDate(""), m_version("") {}
...
MobileTracking::MobileTracking (Utf8StringCR device, Utf8StringCR userId, Utf8StringCR productId, Utf8StringCR projectId, DateTimeCR usageDate, Utf8StringCR version) 
    : m_deviceID(device), m_imsUserID(userId), m_productID(productId), m_projectID(projectId), m_version(version)
    {
