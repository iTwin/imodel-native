...
HCWSCCBUFFER buf
    ...
    switch(buf->lSchemaType)
        {
        case SCHEMA_TYPE_PROJECTSHARE:
            {
            return ProjectShare_DataBufferFree(api, buf);
            }
...
WCharP str
    ...
    switch (buf->lSchemaType)
        ...
        case SCHEMA_TYPE_PROJECTSHARE:
            {
            return ProjectShare_GetStringProperty(api, buf, bufferProperty, index, strLength, str);
            }
        case SCHEMA_TYPE_GLOBALSCHEMA:
            {
...
size_t* outStringSize
    ...
    switch (buf->lSchemaType)
        ...
        case SCHEMA_TYPE_PROJECTSHARE:
            {
            return ProjectShare_GetStringLength(api, buf, bufferProperty, index, outStringSize);
            }
        case SCHEMA_TYPE_GLOBALSCHEMA:
            {
...
WCharP dateTime
    ...
    switch (buf->lSchemaType)
        ...
        case SCHEMA_TYPE_PROJECTSHARE:
            {
            return ProjectShare_GetDatetimeProperty(api, buf, bufferProperty, index, strLength, dateTime);
            }
        case SCHEMA_TYPE_GLOBALSCHEMA:
            {
...
bool* boolean
    ...
    switch (buf->lSchemaType)
        ...
        case SCHEMA_TYPE_PROJECTSHARE:
            {
            return ProjectShare_GetBooleanProperty(api, buf, bufferProperty, index, boolean);
            }
        case SCHEMA_TYPE_GLOBALSCHEMA:
            {
...
int64_t* pLong
    ...
    switch (buf->lSchemaType)
        ...
        case SCHEMA_TYPE_PROJECTSHARE:
            {
            return ProjectShare_GetLongProperty(api, buf, bufferProperty, index, pLong);
            }
        case SCHEMA_TYPE_GLOBALSCHEMA:
            {
