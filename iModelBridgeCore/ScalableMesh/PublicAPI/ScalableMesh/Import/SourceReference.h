/*--------------------------------------------------------------------------------------+
|
|     $Source: PublicAPI/ScalableMesh/Import/SourceReference.h $
...
public:
    ...
    IMPORT_DLLE const IDTMSourcePtr         GetDtmSource() const;
...
protected:
    ...
    IMPORT_DLLE                             SourceRefBase                          (const SourceRefBase&   rhs);

public: 
    
    void                                    SetDtmSource(const IDTMSourcePtr&        dtmSourcePtr);
...
protected:
    ...
    explicit                                SourceRefMixinBase                     (const SourceRefMixinBase&   rhs);
