...
struct IScalableMesh abstract:  IRefCounted 
    ...
    protected:                         
        ...
        virtual int                                 _SaveAs(const WString& destination, BENTLEY_NAMESPACE_NAME::Dgn::ClipVectorPtr clips = nullptr, IScalableMeshProgressPtr progress = nullptr) = 0;
    ...
    public:
        ...
        BENTLEY_SM_EXPORT int                    SaveAs(const WString& destination, BENTLEY_NAMESPACE_NAME::Dgn::ClipVectorPtr clips = nullptr, IScalableMeshProgressPtr progress = nullptr);
