...
struct IScalableMeshPublisher abstract : virtual public RefCountedBase
    ...
    private:
        ...
        virtual void _Publish(IScalableMeshNodePtr nodePtr, BENTLEY_NAMESPACE_NAME::Dgn::ClipVectorPtr clips, const uint64_t& coverageID, bool isClipBoundary, GeoCoordinates::BaseGCSCPtr sourceGCS, GeoCoordinates::BaseGCSCPtr destinationGCS, bvector<Byte>& outData, bool outputTexture) = 0;
    ...
    public:
        ...
        BENTLEY_SM_EXPORT void Publish(IScalableMeshNodePtr nodePtr, BENTLEY_NAMESPACE_NAME::Dgn::ClipVectorPtr clips, const uint64_t& coverageID, bool isClipBoundary, GeoCoordinates::BaseGCSCPtr sourceGCS, GeoCoordinates::BaseGCSCPtr destinationGCS, bvector<Byte>& outData, bool outputTexture);
