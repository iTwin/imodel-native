...
struct IScalableMeshPublisher abstract : virtual public RefCountedBase
    ...
    private:
        ...
        virtual void _Publish(IScalableMeshNodePtr nodePtr, const uint64_t& clipID, bool isClipBoundary, GeoCoordinates::BaseGCSCPtr sourceGCS, GeoCoordinates::BaseGCSCPtr destinationGCS, bvector<Byte>& outData) = 0;
    ...
    public:
        ...
        BENTLEY_SM_EXPORT void Publish(IScalableMeshNodePtr nodePtr, const uint64_t& clipID, bool isClipBoundary, GeoCoordinates::BaseGCSCPtr sourceGCS, GeoCoordinates::BaseGCSCPtr destinationGCS, bvector<Byte>& outData);
