...
struct IScalableMeshPublisher abstract : virtual public RefCountedBase
    ...
    public:
        ...
        BENTLEY_SM_IMPORT_EXPORT void Publish(IScalableMeshNodePtr nodePtr, ClipVectorPtr clips, const uint64_t& coverageID, bool isClipBoundary, GeoCoordinates::BaseGCSCPtr sourceGCS, GeoCoordinates::BaseGCSCPtr destinationGCS, bvector<Byte>& outData, bool outputTexture);
