...
struct ScalableMeshGroup : public RefCounted<IScalableMesh>
    ...
    protected:
        ...
        virtual BentleyStatus                      _DetectGroundForRegion(BeFileName& createdTerrain, const BeFileName& coverageTempDataFolder, const bvector<DPoint3d>& coverageData, uint64_t id, IScalableMeshGroundPreviewerPtr groundPreviewer, BaseGCSPtr& destinationGcs, bool limitResolution) override;
