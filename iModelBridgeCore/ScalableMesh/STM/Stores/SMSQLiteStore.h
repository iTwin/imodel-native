...
template <class POINT, class EXTENT> class SMSQLiteStore : public ISMDataStore<SMIndexMasterHeader<EXTENT>, SMIndexNodeHeader<EXTENT>>
    {
    private : 
...
template <class POINT, class EXTENT> class SMSQLiteNodePointStore : public ISMNodeDataStore<POINT, SMIndexNodeHeader<EXTENT>> 
    ...
    public:
        ...
        SMSQLiteNodePointStore(SMIndexNodeHeader<EXTENT>* nodeHeader, ISMDataStore* dataStore, SMSQLiteFilePtr& smSQLiteFile)
