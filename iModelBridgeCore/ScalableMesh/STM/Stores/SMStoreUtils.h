...
inline ISMStore::NodeID ConvertBlockID(const HPMBlockID& blockID)
    {
    return static_cast<ISMStore::NodeID>(blockID.m_integerID);
    }

inline ISMStore::NodeID ConvertChildID(const HPMBlockID& childID)
    {
    return static_cast<ISMStore::NodeID>(childID.m_integerID);
    }

inline ISMStore::NodeID ConvertNeighborID(const HPMBlockID& neighborID)
    {
    return static_cast<ISMStore::NodeID>(neighborID.m_integerID);
    }

inline bool IsValidID(const HPMBlockID& blockID)
    {
