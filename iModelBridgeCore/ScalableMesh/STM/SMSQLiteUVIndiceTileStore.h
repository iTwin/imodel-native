...
template <class EXTENT> class SMSQLiteUVIndiceTileStore : public SMPointTileStore<int32_t, EXTENT>
    {
    private:
    ...
    public:
        /*SMSQLiteUVIndiceTileStore(BENTLEY_NAMESPACE_NAME::WString filename, const ISMStore::AccessMode& accessMode)
            {
        ...
        SMSQLiteUVIndiceTileStore(SMSQLiteFilePtr file)
            {
            m_smSQLiteFile = file;
            }

        virtual ~SMSQLiteUVIndiceTileStore()
            {
        ...
        virtual HPMBlockID StoreNewBlock(int32_t* DataTypeArray, size_t countData)
            ...
            m_smSQLiteFile->StoreUVIndices(id, indexData, countData*sizeof(int32_t));
        ...
        virtual size_t LoadBlock(int32_t* DataTypeArray, size_t maxCountData, HPMBlockID blockID)
            ...
            m_smSQLiteFile->GetUVIndices(blockID.m_integerID, ptData, uncompressedSize);
            HCDPacket pi_uncompressedPacket, pi_compressedPacket;
