...
template <typename DataType> class SMMemoryPoolGenericBlobItem : public SMMemoryPoolItemBase
    ...
    public : 
#ifdef VANCOUVER_API
        static SMMemoryPoolGenericBlobItem<DataType>* CreateItem(DataType* data, size_t size, uint64_t nodeId, SMPoolDataTypeDesc dataType, uint64_t smId)
            {
...
#ifdef VANCOUVER_API
        static SMStoredMemoryPoolGenericBlobItem<DataType>* CreateItem(uint64_t nodeId, IHPMDataStore<DataType>* store, SMPoolDataTypeDesc dataType, uint64_t smId)
            {
...
template <typename DataType> class SMStoredMemoryPoolBlobItem : public SMMemoryPoolBlobItem<DataType>
    ...
    public : 
#ifdef VANCOUVER_API
        static SMStoredMemoryPoolBlobItem<DataType>* CreateItem(uint64_t nodeId, IHPMDataStore<DataType>* store, SMPoolDataTypeDesc dataType, uint64_t smId)
            {
            return new SMStoredMemoryPoolBlobItem<DataType>(nodeId, store, dataType, smId);
            }
        static SMStoredMemoryPoolBlobItem<DataType>* CreateItem(uint64_t nodeId, IHPMDataStore<DataType>* store, const DataType* data, uint64_t dataSize, SMPoolDataTypeDesc dataType, uint64_t smId)
            {
...
template <typename DataType> class SMStoredMemoryPoolGenericVectorItem : public SMMemoryPoolGenericVectorItem<DataType>
    ...
    public:        
#ifdef VANCOUVER_API
        static SMStoredMemoryPoolGenericVectorItem<DataType>* CreateItem(uint64_t nodeId, IHPMDataStore<DataType>* store, SMPoolDataTypeDesc dataType, uint64_t smId)
            {
    ...
    template <typename DataType> class SMStoredMemoryPoolVectorItem : public SMMemoryPoolVectorItem<DataType>
        ...
        public:
#ifdef VANCOUVER_API
            static SMStoredMemoryPoolVectorItem<DataType>* CreateItem(uint64_t nodeId, IHPMDataStore<DataType>* store, SMPoolDataTypeDesc dataType, uint64_t smId)
                {
