/*--------------------------------------------------------------------------------------+
|
|     $Source: Import/ImportConfigs.cpp $
...
DefaultTargetScalableMeshConfig::ClassID DefaultTargetScalableMeshConfig::s_GetClassID() { return super_class::s_GetClassID(); }

/*---------------------------------------------------------------------------------**//**
* @description
* @bsiclass                                                  Raymond.Gauthier   06/2011
+---------------+---------------+---------------+---------------+---------------+------*/
DefaultTargetScalableMeshConfig::DefaultTargetScalableMeshConfig(const DefaultTargetScalableMeshConfig& rhs)
    : super_class(rhs),
    m_data(rhs.m_data),
    m_implP(0)
{
...
* @bsiclass                                                  Raymond.Gauthier   06/2011
+---------------+---------------+---------------+---------------+---------------+------*/
DefaultTargetScalableMeshConfig::DefaultTargetScalableMeshConfig(const ScalableMeshData& data)
    : m_data(data),
    m_implP(0)
{
}
...
* @bsiclass                                                  Raymond.Gauthier   06/2011
+---------------+---------------+---------------+---------------+---------------+------*/
DefaultTargetScalableMeshConfig::~DefaultTargetScalableMeshConfig()
{
}
...
* @bsiclass                                                  Raymond.Gauthier   06/2011
+---------------+---------------+---------------+---------------+---------------+------*/
const ScalableMeshData& DefaultTargetScalableMeshConfig::Get() const
{
    return m_data;
}
