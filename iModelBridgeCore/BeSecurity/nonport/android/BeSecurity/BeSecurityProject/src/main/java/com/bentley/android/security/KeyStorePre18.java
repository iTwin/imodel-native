...
/*
 * Bentley - original from https://github.com/android/platform_frameworks_base/blob/master/keystore/java/android/security/KeyStore.java
 */
...
public class KeyStorePre18 {
    ...
    public static KeyStorePre18 getInstance() {
        return new KeyStorePre18();
    }
    ...
    public String errorToStr(int rc) {
        switch (rc) {
        case KeyStorePre18.NO_ERROR:
            return "NO_ERROR";
        case KeyStorePre18.LOCKED:
            return "LOCKED";
        case KeyStorePre18.UNINITIALIZED:
            return "UNINITIALIZED";
        case KeyStorePre18.SYSTEM_ERROR:
            return "SYSTEM_ERROR";
        case KeyStorePre18.PROTOCOL_ERROR:
            return "PROTOCOL_ERROR";
        case KeyStorePre18.PERMISSION_DENIED:
            return "PERMISSION_DENIED";
        case KeyStorePre18.KEY_NOT_FOUND:
            return "KEY_NOT_FOUND";
        case KeyStorePre18.VALUE_CORRUPTED:
            return "VALUE_CORRUPTED";
        case KeyStorePre18.UNDEFINED_ACTION:
            return "UNDEFINED_ACTION";
        case KeyStorePre18.WRONG_PASSWORD:
