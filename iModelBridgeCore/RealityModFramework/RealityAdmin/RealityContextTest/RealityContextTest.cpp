        ...
        while ((msg = curl_multi_info_read(m_pCurlHandle, &nbQueue)))
            ...
            if (msg->msg == CURLMSG_DONE)
                ...
                if (msg->data.result == CURLE_OK)
                    ...
                    {
                    //failCounter++;
                    s_stats.InsertStats(user->m_currentOperation, false, user->m_downloadStart);
