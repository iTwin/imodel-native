...
int main(int argc, char* argv[])
    ...
    for (int i = 0; i < argc; ++i)
        ...
        /*else if (strstr(argv[i], "-t") || strstr(argv[i], "--token:"))
            {
            substringPosition = strstr(argv[i], ":");
            substringPosition++;
            token = Utf8String(substringPosition);
            }*/
        }
