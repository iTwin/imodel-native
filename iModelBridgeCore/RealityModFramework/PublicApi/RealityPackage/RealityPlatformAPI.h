/*--------------------------------------------------------------------------------------+
|
|     $Source: PublicApi/RealityPackage/RealityPlatformAPI.h $
|
...
#define BEGIN_BENTLEY_REALITYPLATFORM_NAMESPACE         BEGIN_BENTLEY_NAMESPACE namespace RealityPackage {
#define END_BENTLEY_REALITYPLATFORM_NAMESPACE           } END_BENTLEY_NAMESPACE
#define USING_NAMESPACE_BENTLEY_REALITYPLATFORM         using namespace BentleyApi::RealityPackage;
...
REALITYPLATFORM_TYPEDEFS(ConnectedRealityDataProjectRelationship)
REALITYPLATFORM_REF_COUNTED_PTR(ConnectedRealityDataProjectRelationship)
...
// RealiteSources
REALITYPLATFORM_TYPEDEFS(RealityDataSource)
REALITYPLATFORM_REF_COUNTED_PTR(RealityDataSource)
