...
REALITYPLATFORM_TYPEDEFS(RealityDataUrl)
REALITYPLATFORM_REF_COUNTED_PTR(RealityDataUrl)

REALITYPLATFORM_TYPEDEFS(RealityDataPagedRequest)
REALITYPLATFORM_REF_COUNTED_PTR(RealityDataPagedRequest)

REALITYPLATFORM_TYPEDEFS(RealityDataByIdRequest)
REALITYPLATFORM_REF_COUNTED_PTR(RealityDataByIdRequest)

REALITYPLATFORM_TYPEDEFS(RealityDataDocumentByIdRequest)
REALITYPLATFORM_REF_COUNTED_PTR(RealityDataDocumentByIdRequest)

REALITYPLATFORM_TYPEDEFS(RealityDataDocumentContentByIdRequest)
REALITYPLATFORM_REF_COUNTED_PTR(RealityDataDocumentContentByIdRequest)

REALITYPLATFORM_TYPEDEFS(RealityDataFolderByIdRequest)
REALITYPLATFORM_REF_COUNTED_PTR(RealityDataFolderByIdRequest)

REALITYPLATFORM_TYPEDEFS(RealityDataListByEnterprisePagedRequest)
REALITYPLATFORM_REF_COUNTED_PTR(RealityDataListByEnterprisePagedRequest)

REALITYPLATFORM_TYPEDEFS(RealityDataProjectRelationshipByProjectIdRequest)
REALITYPLATFORM_REF_COUNTED_PTR(RealityDataProjectRelationshipByProjectIdRequest)

REALITYPLATFORM_TYPEDEFS(RealityDataProjectRelationshipByProjectIdPagedRequest)
REALITYPLATFORM_REF_COUNTED_PTR(RealityDataProjectRelationshipByProjectIdPagedRequest)

REALITYPLATFORM_TYPEDEFS(RealityDataServiceUpload)
REALITYPLATFORM_REF_COUNTED_PTR(RealityDataServiceUpload)
