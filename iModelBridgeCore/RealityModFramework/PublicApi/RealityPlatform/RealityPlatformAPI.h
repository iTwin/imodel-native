...
REALITYPLATFORM_TYPEDEFS(HttpData)
REALITYPLATFORM_REF_COUNTED_PTR(HttpData)

REALITYPLATFORM_TYPEDEFS(HttpThumbnail)
REALITYPLATFORM_REF_COUNTED_PTR(HttpThumbnail)

REALITYPLATFORM_TYPEDEFS(HttpMetadata)
REALITYPLATFORM_REF_COUNTED_PTR(HttpMetadata)

REALITYPLATFORM_TYPEDEFS(HttpServer)
REALITYPLATFORM_REF_COUNTED_PTR(HttpServer)