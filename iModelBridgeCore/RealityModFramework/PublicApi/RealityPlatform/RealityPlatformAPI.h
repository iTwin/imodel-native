...
REALITYPLATFORM_TYPEDEFS(RealityDataProjectRelationByProjectIdPagedRequest)
REALITYPLATFORM_REF_COUNTED_PTR(RealityDataProjectRelationByProjectIdPagedRequest)
