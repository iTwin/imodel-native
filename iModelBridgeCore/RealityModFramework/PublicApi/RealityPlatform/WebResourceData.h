/*--------------------------------------------------------------------------------------+
|
|     $Source: PublicApi/RealityPlatform/WebResourceData.h $
|
...
//=====================================================================================
//! @bsiclass                                   Jean-Francois.Cote              4/2016
//! Status codes for WebResource traversal operations.
//=====================================================================================
enum class WebResourceStatus
    {
...
//=====================================================================================
struct IWebResourceTraversalObserver
{
public:
...
//! @bsiclass                                   Jean-Francois.Cote              4/2016
//=====================================================================================
struct WebResourceClient : public RefCountedBase
{
public:
    ...
    REALITYDATAPLATFORM_EXPORT WebResourceStatus DownloadContent(Utf8CP outputDirPath = NULL) const;

    //! Get a list of all files from all directories starting at root.
    REALITYDATAPLATFORM_EXPORT WebResourceStatus GetFileList(bvector<Utf8String>& fileList) const;
    ...
    REALITYDATAPLATFORM_EXPORT WebResourceStatus GetData() const;
    ...
    //! Set the IWebResourceTraversalObserver to be called after each extraction. Only one observer
    //! can be set. Typically, the user of the handler would implement the IWebResourceTraversalObserver
    //! interface and send "this" as the argument to this method.
    REALITYDATAPLATFORM_EXPORT void SetObserver(IWebResourceTraversalObserver* pObserver);

protected:
    WebResourceClient(Utf8CP serverUrl, Utf8CP serverName);
    ~WebResourceClient();
    ...
    static IWebResourceTraversalObserver* m_pObserver;
...
//! @bsiclass                                   Jean-Francois.Cote              4/2016
//=====================================================================================
struct WebResourceRequest : public RefCountedBase
{
public:
    //! Get response from request.
    virtual WebResourceResponsePtr Perform();
...
//! @bsiclass                                   Jean-Francois.Cote              4/2016
//=====================================================================================
struct WebResourceResponse : public RefCountedBase
{
public:
    //! Create invalid response with WebResourceStatus::UnknownError.
    static WebResourceResponsePtr Create();

    //! Create response.
    static WebResourceResponsePtr Create(Utf8CP effectiveUrl, Utf8CP m_content, WebResourceStatus traversalStatus);
    ...
    //! Get status.
    WebResourceStatus GetStatus() const;

    //! Return if request was a success or not.
    bool IsSuccess() const;

protected:
    WebResourceResponse(Utf8CP effectiveUrl, Utf8CP content, WebResourceStatus status);

    Utf8String m_effectiveUrl;
    Utf8String m_content;
    WebResourceStatus m_status;
};

//=====================================================================================
//! @bsiclass                                   Jean-Francois.Cote              5/2016
//=====================================================================================
struct WebResourceThumbnail : public RefCountedBase
{
public:
    //! Create invalid thumbnail.
    REALITYDATAPLATFORM_EXPORT static WebResourceThumbnailPtr Create();

    //! Create from raster file.
    REALITYDATAPLATFORM_EXPORT static WebResourceThumbnailPtr Create(RealityDataCR rasterData);
...
protected:
    WebResourceThumbnail();
    WebResourceThumbnail(RealityDataCR rasterData);
...
//! @bsiclass                                   Jean-Francois.Cote              5/2016
//=====================================================================================
struct WebResourceMetadata : public RefCountedBase
{
public:
    //! Create empty metadata.
    REALITYDATAPLATFORM_EXPORT static WebResourceMetadataPtr Create();

    //! Create from xml file.
    REALITYDATAPLATFORM_EXPORT static WebResourceMetadataPtr CreateFromFile(Utf8CP filePath);
...
protected:
    WebResourceMetadata();
    WebResourceMetadata(Utf8CP filePath);
...
//! @bsiclass                                   Jean-Francois.Cote              5/2016
//=====================================================================================
struct WebResourceServer : public RefCountedBase
{
public:
    //! Create invalid server.
    REALITYDATAPLATFORM_EXPORT static WebResourceServerPtr Create();

    //! Create from url.
    REALITYDATAPLATFORM_EXPORT static WebResourceServerPtr Create(Utf8CP url, Utf8CP name = NULL);
...
protected:
    WebResourceServer();
    WebResourceServer(Utf8CP url, Utf8CP name);
...
//! @bsiclass                                   Jean-Francois.Cote              4/2016
//=====================================================================================
struct WebResourceData : public RefCountedBase
{
public:
    //! Create invalid data.
    REALITYDATAPLATFORM_EXPORT static WebResourceDataPtr Create();
    ...
    REALITYDATAPLATFORM_EXPORT void SetThumbnail(WebResourceThumbnailR thumbnail);

    //! Get/Set
    REALITYDATAPLATFORM_EXPORT WebResourceMetadataCR GetMetadata() const;
    REALITYDATAPLATFORM_EXPORT void SetMetadata(WebResourceMetadataR metadata);

    //! Get/Set
    REALITYDATAPLATFORM_EXPORT WebResourceServerCR GetServer() const;
    REALITYDATAPLATFORM_EXPORT void SetServer(WebResourceServerR server);
...
//! @bsiclass                                   Jean-Francois.Cote              4/2016
//=====================================================================================
struct WebResourceDataHandler
{
public:
    //! Unzip files.
    REALITYDATAPLATFORM_EXPORT static WebResourceStatus UnzipFiles(Utf8CP inputDirPath, Utf8CP outputDirPath);
