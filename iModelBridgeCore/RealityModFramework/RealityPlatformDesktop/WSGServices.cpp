/*--------------------------------------------------------------------------------------+
|
|     $Source: RealityPlatformDesktop/WSGServices.cpp $
|
...
//-------------------------------------------------------------------------------------
void* RequestConstructor::PrepareCurl(const WSGURL& wsgRequest, RawServerResponse& response, bool verifyPeer, BeFile* file) const
    {
...
void* WSGRequest::PrepareRequest(const WSGURL& wsgRequest, RawServerResponse& responseObject, bool verifyPeer, BeFile* file) const
    {
    CURL* curl = static_cast<CURL*>(PrepareCurl(wsgRequest, responseObject, verifyPeer, file));
