...
//    ASSERT_STREQ(RPACKAGE_POLYGON2, pPackage->GetBoundingPolygon().ToString().c_str());
    ...
    ASSERT_TRUE((pMultiBandSource = dynamic_cast<MultiBandSourceP>(&(pPackage->GetImageryGroup()[7]->GetSourceR(0)))) != NULL);
    ...
    ASSERT_STREQ(RPACKAGE_PINDATA_B_RESOLUTION, pPackage->GetPinnedGroup()[0]->GetResolution().c_str());
