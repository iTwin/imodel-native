...
TEST_F(PackageTestFixture, InvalidLongLat)
    ...
    Utf8CP package =
        "<?xml version='1.0' encoding='UTF-8'?>"
        "<RealityDataPackage xmlns='http://www.bentley.com/RealityDataServer/v2' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' version='2.0'>"
            "<Name>ProjectName</Name>"
            "<ImageryGroup>"
                "<ImageryData>"
                    "<Sources>"
...
//         }    
    ...
    // Imagery
    ASSERT_TRUE(pPackage->GetImageryGroup()[0]->GetDataSourceCount() == 1);
    ASSERT_STREQ(RPACKAGE_JPEG, pPackage->GetImageryGroup()[0]->GetDataSource(0).GetUri().GetSource().c_str());
    ASSERT_STREQ("image/jpeg", pPackage->GetImageryGroup()[0]->GetDataSource(0).GetDataType().c_str());
    ...
    ASSERT_NEAR(pPackage->GetImageryGroup()[0]->GetFootprint()[PackageRealityData::Corners::LowerRight].latitude, RPACKAGE_JPEG_LR_y, LONGLAT_EPSILON);
    ASSERT_NEAR(pPackage->GetImageryGroup()[0]->GetFootprint()[PackageRealityData::Corners::UpperLeft].longitude, RPACKAGE_JPEG_UL_x, LONGLAT_EPSILON);
    ASSERT_NEAR(pPackage->GetImageryGroup()[0]->GetFootprint()[PackageRealityData::Corners::UpperLeft].latitude, RPACKAGE_JPEG_UL_y, LONGLAT_EPSILON);
    ASSERT_NEAR(pPackage->GetImageryGroup()[0]->GetFootprint()[PackageRealityData::Corners::UpperRight].longitude, RPACKAGE_JPEG_UR_x, LONGLAT_EPSILON);
    ASSERT_NEAR(pPackage->GetImageryGroup()[0]->GetFootprint()[PackageRealityData::Corners::UpperRight].latitude, RPACKAGE_JPEG_UR_y, LONGLAT_EPSILON);

    ASSERT_TRUE(pPackage->GetImageryGroup()[1]->GetDataSourceCount() == 1);
    ASSERT_STREQ(RPACKAGE_WMS_URI, pPackage->GetImageryGroup()[1]->GetDataSource(0).GetUri().GetSource().c_str());
    ASSERT_STREQ("wms", pPackage->GetImageryGroup()[1]->GetDataSource(0).GetDataType().c_str());

    // Model
    ASSERT_TRUE(pPackage->GetModelGroup()[0]->GetDataSourceCount() == 1);
    ASSERT_STREQ(RPACKAGE_ROAD_URI, pPackage->GetModelGroup()[0]->GetDataSource(0).GetUri().GetSource().c_str());
    ASSERT_STREQ("shapefile", pPackage->GetModelGroup()[0]->GetDataSource(0).GetDataType().c_str());

    // Pinned
    ASSERT_TRUE(pPackage->GetPinnedGroup()[0]->GetDataSourceCount() == 1);
    ASSERT_STREQ(RPACKAGE_HOUSE_URI, pPackage->GetPinnedGroup()[0]->GetDataSource(0).GetUri().GetSource().c_str());
    ASSERT_STREQ("image/jpeg", pPackage->GetPinnedGroup()[0]->GetDataSource(0).GetDataType().c_str());
    ...
    ASSERT_TRUE(pPackage->GetPinnedGroup()[1]->GetDataSourceCount() == 1);
    ASSERT_STREQ(RPACKAGE_TRAFFIC_URI, pPackage->GetPinnedGroup()[1]->GetDataSource(0).GetUri().GetSource().c_str());
    ASSERT_STREQ("video/avi", pPackage->GetPinnedGroup()[1]->GetDataSource(0).GetDataType().c_str());
    ...
    // Terrain
    ASSERT_TRUE(pPackage->GetTerrainGroup()[0]->GetDataSourceCount() == 1);
    ASSERT_STREQ(RPACKAGE_CANADA_POD_URI, pPackage->GetTerrainGroup()[0]->GetDataSource(0).GetUri().GetSource().c_str());
    ASSERT_STREQ("pod", pPackage->GetTerrainGroup()[0]->GetDataSource(0).GetDataType().c_str());

    ASSERT_TRUE(pPackage->GetTerrainGroup()[1]->GetDataSourceCount() == 1);
    ASSERT_STREQ(RPACKAGE_CANADA_DTM_URI, pPackage->GetTerrainGroup()[1]->GetDataSource(0).GetUri().GetSource().c_str());
    ASSERT_STREQ("dtm", pPackage->GetTerrainGroup()[1]->GetDataSource(0).GetDataType().c_str());
    }
...
TEST_F (PackageTestFixture, ReadVersion_2_0A)
    ...
    #define RPACKAGE_IMDATA_MULTI_B1_SRC_COPYRIGHT   "All data belongs to the European Space Agency provided free of charge to USGS."
    #define RPACKAGE_IMDATA_MULTI_B1_SRC_TERMOFUSE   "https://lta.cr.usgs.gov/sites/default/files/Sentinel_Data_Terms_and_Conditions.pdf"
    #define RPACKAGE_IMDATA_MULTI_B1_SRC_PROVIDER    "ESA"
    #define RPACKAGE_IMDATA_MULTI_B1_SRC_SERVERLOGINKEY          "EarthExplorer"
    ...
    #define RPACKAGE_IMDATA_MULTI_B1_RED_SRC_SERVERLOGINMETHOD       "CUSTOM"
    #define RPACKAGE_IMDATA_MULTI_B1_RED_SRC_SERVERREGISTRATIONPAGE  "http://earthexplorer.usgs.gov/Register"
    #define RPACKAGE_IMDATA_MULTI_B1_RED_SRC_SERVERORGANISATIONPAGE  "http://earthexplorer.usgs.gov/"
    ...
    #define RPACKAGE_IMDATA_MULTI_B1_GREEN_SRC_SERVERLOGINMETHOD       "CUSTOM"
    #define RPACKAGE_IMDATA_MULTI_B1_GREEN_SRC_SERVERREGISTRATIONPAGE  "http://earthexplorer.usgs.gov/Register"
    #define RPACKAGE_IMDATA_MULTI_B1_GREEN_SRC_SERVERORGANISATIONPAGE  "http://earthexplorer.usgs.gov/"
    ...
    #define RPACKAGE_IMDATA_MULTI_B1_BLUE_SRC_SERVERLOGINMETHOD       "CUSTOM"
    #define RPACKAGE_IMDATA_MULTI_B1_BLUE_SRC_SERVERREGISTRATIONPAGE  "http://earthexplorer.usgs.gov/Register"
    #define RPACKAGE_IMDATA_MULTI_B1_BLUE_SRC_SERVERORGANISATIONPAGE  "http://earthexplorer.usgs.gov/"
...
#define RPACKAGE_IMDATA_MULTI_B1_PANCHROMATIC_SRC_URI         "http://dds.cr.usgs.gov/ltaauth/hsm/s2/s2a/2016/10/13/S2A_OPER_MSI_L1C_TL_MTI__20161013T152337_20161013T200524_A006843_T18NYK_N02_04_01.zip?id=$(AUTHENTICATIONKEY)&amp;iid=443910&amp;did=275426842&amp;ver=production#GRANULE/S2A_OPER_MSI_L1C_TL_MTI__20161013T200524_A006843_T18NYK_N02.04/IMG_DATA/S2A_OPER_MSI_L1C_TL_MTI__20161013T200524_A006843_T18NYK_B08.jp2"
    ...
    #define RPACKAGE_IMDATA_MULTI_B1_PANCHROMATIC_SRC_SERVERLOGINMETHOD       "CUSTOM"
    #define RPACKAGE_IMDATA_MULTI_B1_PANCHROMATIC_SRC_SERVERREGISTRATIONPAGE  "http://earthexplorer.usgs.gov/Register"
    #define RPACKAGE_IMDATA_MULTI_B1_PANCHROMATIC_SRC_SERVERORGANISATIONPAGE  "http://earthexplorer.usgs.gov/"
    #define RPACKAGE_IMDATA_MULTI_B1_PANCHROMATIC_SRC_NUMSIS      0
    #define RPACKAGE_IMDATA_MULTI_B1_PANCHROMATIC_SRC_NODATA      "0"


    #define RPACKAGE_IMDATA_MULTI_B2_SRC_URI         "#S2A_OPER_PRD_MSIL1C_PDMC_20161013T120754_R054_V20160918T154922_20160918T155625.SAFE/GRANULE/S2A_OPER_MSI_L1C_TL_MTI__20160918T205501_A006486_T18TXT_N02.04/IMG_DATA/S2A_OPER_MSI_L1C_TL_MTI__20160918T205501_A006486_T18TXT_B04"
    #define RPACKAGE_IMDATA_MULTI_B2_SRC_URI_TYPE    "jp2"
    #define RPACKAGE_IMDATA_MULTI_B2_SRC_ID          "ESA:S2A_OPER_MSI_L1C_TL_MTI__20161013T152337_20161013T200524_A006843_T18NYK_N02_04_01"
    #define RPACKAGE_IMDATA_MULTI_B2_SRC_COPYRIGHT   "All data belongs to the European Space Agency."
    #define RPACKAGE_IMDATA_MULTI_B2_SRC_TERMOFUSE   "The Sentinels Scientific Data Hub provides complete, free and open access to Sentinel-1 and Sentinel-2 user products, starting from the In-Orbit Commissioning Review (IOCR)."
    #define RPACKAGE_IMDATA_MULTI_B2_SRC_PROVIDER    "ESA"
    #define RPACKAGE_IMDATA_MULTI_B2_SRC_SERVERLOGINKEY          "Scihub.Copernicus"
    #define RPACKAGE_IMDATA_MULTI_B2_SRC_SERVERLOGINMETHOD       "STANDARD"
    #define RPACKAGE_IMDATA_MULTI_B2_SRC_SERVERREGISTRATIONPAGE  "https://scihub.copernicus.eu/dhus/Register"
    #define RPACKAGE_IMDATA_MULTI_B2_SRC_SERVERORGANISATIONPAGE  "https://scihub.copernicus.eu/"
    #define RPACKAGE_IMDATA_MULTI_B2_SRC_SIZE        253831
    #define RPACKAGE_IMDATA_MULTI_B2_SRC_NUMSIS      0
    #define RPACKAGE_IMDATA_MULTI_B2_SRC_NODATA      "0"

    #define RPACKAGE_IMDATA_MULTI_B2_RED_SRC_URI         "#S2A_OPER_PRD_MSIL1C_PDMC_20161013T120754_R054_V20160918T154922_20160918T155625.SAFE/GRANULE/S2A_OPER_MSI_L1C_TL_MTI__20160918T205501_A006486_T18TXT_N02.04/IMG_DATA/S2A_OPER_MSI_L1C_TL_MTI__20160918T205501_A006486_T18TXT_B04.jp2"
    #define RPACKAGE_IMDATA_MULTI_B2_RED_SRC_URI_TYPE    "jp2"
    #define RPACKAGE_IMDATA_MULTI_B2_RED_SRC_ID          "ESA:S2A_OPER_MSI_L1C_TL_MTI__20161013T152337_20161013T200524_A006843_T18NYK_N02_04_01:RED"
    #define RPACKAGE_IMDATA_MULTI_B2_RED_SRC_SERVERLOGINKEY          "Scihub.Copernicus"
    #define RPACKAGE_IMDATA_MULTI_B2_RED_SRC_SERVERLOGINMETHOD       "STANDARD"
    #define RPACKAGE_IMDATA_MULTI_B2_RED_SRC_SERVERREGISTRATIONPAGE  "https://scihub.copernicus.eu/dhus/Register"
    #define RPACKAGE_IMDATA_MULTI_B2_RED_SRC_SERVERORGANISATIONPAGE  "https://scihub.copernicus.eu/"
    #define RPACKAGE_IMDATA_MULTI_B2_RED_SRC_NUMSIS      0
    #define RPACKAGE_IMDATA_MULTI_B2_RED_SRC_NODATA      "0"
                                   
    #define RPACKAGE_IMDATA_MULTI_B2_GREEN_SRC_URI         "#S2A_OPER_PRD_MSIL1C_PDMC_20161013T120754_R054_V20160918T154922_20160918T155625.SAFE/GRANULE/S2A_OPER_MSI_L1C_TL_MTI__20161013T200524_A006843_T18NYK_N02.04/IMG_DATA/S2A_OPER_MSI_L1C_TL_MTI__20161013T200524_A006843_T18NYK_B08.jp2"
    #define RPACKAGE_IMDATA_MULTI_B2_GREEN_SRC_URI_TYPE    "jp2"
    #define RPACKAGE_IMDATA_MULTI_B2_GREEN_SRC_ID          "ESA:S2A_OPER_MSI_L1C_TL_MTI__20161013T152337_20161013T200524_A006843_T18NYK_N02_04_01:GREEN"
    #define RPACKAGE_IMDATA_MULTI_B2_GREEN_SRC_SERVERLOGINKEY          "Scihub.Copernicus"
    #define RPACKAGE_IMDATA_MULTI_B2_GREEN_SRC_SERVERLOGINMETHOD       "STANDARD"
    #define RPACKAGE_IMDATA_MULTI_B2_GREEN_SRC_SERVERREGISTRATIONPAGE  "https://scihub.copernicus.eu/dhus/Register"
    #define RPACKAGE_IMDATA_MULTI_B2_GREEN_SRC_SERVERORGANISATIONPAGE  "https://scihub.copernicus.eu/"
    #define RPACKAGE_IMDATA_MULTI_B2_GREEN_SRC_NUMSIS      0
    #define RPACKAGE_IMDATA_MULTI_B2_GREEN_SRC_NODATA      "0"

    #define RPACKAGE_IMDATA_MULTI_B2_BLUE_SRC_URI         "#S2A_OPER_PRD_MSIL1C_PDMC_20161013T120754_R054_V20160918T154922_20160918T155625.SAFE/GRANULE/S2A_OPER_MSI_L1C_TL_MTI__20161013T200524_A006843_T18NYK_N02.04/IMG_DATA/S2A_OPER_MSI_L1C_TL_MTI__20161013T200524_A006843_T18NYK_B01.jp2"
    #define RPACKAGE_IMDATA_MULTI_B2_BLUE_SRC_URI_TYPE    "jp2"
    #define RPACKAGE_IMDATA_MULTI_B2_BLUE_SRC_ID          "ESA:S2A_OPER_MSI_L1C_TL_MTI__20161013T152337_20161013T200524_A006843_T18NYK_N02_04_01:BLUE"
    #define RPACKAGE_IMDATA_MULTI_B2_BLUE_SRC_SERVERLOGINKEY          "Scihub.Copernicus"
    #define RPACKAGE_IMDATA_MULTI_B2_BLUE_SRC_SERVERLOGINMETHOD       "STANDARD"
    #define RPACKAGE_IMDATA_MULTI_B2_BLUE_SRC_SERVERREGISTRATIONPAGE  "https://scihub.copernicus.eu/dhus/Register"
    #define RPACKAGE_IMDATA_MULTI_B2_BLUE_SRC_SERVERORGANISATIONPAGE  "https://scihub.copernicus.eu/"
    #define RPACKAGE_IMDATA_MULTI_B2_BLUE_SRC_NUMSIS      0
    #define RPACKAGE_IMDATA_MULTI_B2_BLUE_SRC_NODATA      "0"

    #define RPACKAGE_IMDATA_MULTI_B2_PANCHROMATIC_SRC_URI         "#S2A_OPER_PRD_MSIL1C_PDMC_20161013T120754_R054_V20160918T154922_20160918T155625.SAFE/GRANULE/S2A_OPER_MSI_L1C_TL_MTI__20161013T200524_A006843_T18NYK_N02.04/IMG_DATA/S2A_OPER_MSI_L1C_TL_MTI__20161013T200524_A006843_T18NYK_B08.jp2"
    #define RPACKAGE_IMDATA_MULTI_B2_PANCHROMATIC_SRC_URI_TYPE    "jp2"
    #define RPACKAGE_IMDATA_MULTI_B2_PANCHROMATIC_SRC_ID          "ESA:S2A_OPER_MSI_L1C_TL_MTI__20161013T152337_20161013T200524_A006843_T18NYK_N02_04_01:PANCHROMATIC"
    #define RPACKAGE_IMDATA_MULTI_B2_PANCHROMATIC_SRC_SERVERLOGINKEY          "Scihub.Copernicus"
    #define RPACKAGE_IMDATA_MULTI_B2_PANCHROMATIC_SRC_SERVERLOGINMETHOD       "STANDARD"
    #define RPACKAGE_IMDATA_MULTI_B2_PANCHROMATIC_SRC_SERVERREGISTRATIONPAGE  "https://scihub.copernicus.eu/dhus/Register"
    #define RPACKAGE_IMDATA_MULTI_B2_PANCHROMATIC_SRC_SERVERORGANISATIONPAGE  "https://scihub.copernicus.eu/"
    #define RPACKAGE_IMDATA_MULTI_B2_PANCHROMATIC_SRC_NUMSIS      0
    #define RPACKAGE_IMDATA_MULTI_B2_PANCHROMATIC_SRC_NODATA      "0"
    ...
    #define RPACKAGE_MODDATA_A_SRC_2_SERVERLOGINKEY          "BentleyCONNECT"
    #define RPACKAGE_MODDATA_A_SRC_2_SERVERLOGINMETHOD       "CUSTOM"
    #define RPACKAGE_MODDATA_A_SRC_2_SERVERORGANISATIONPAGE  "http://www.bentley.com/"
    ...
    #define RPACKAGE_MODDATA_B_SRC_1_URI_PART1      "https://dev-realitydataservices-eus.cloudapp.net/v2.4/Repositories/S3MXECPlugin--Server/S3MX/Document/e82a584b-9fae-409f-9581-fd154f7b9ef9~2FMarseille3mx~2FMarseille.3mx/$file"
    #define RPACKAGE_MODDATA_B_SRC_1_URI_TYPE       "S3MX"
    #define RPACKAGE_MODDATA_B_SRC_1_STREAMED       "true"
    #define RPACKAGE_MODDATA_B_SRC_1_COPYRIGHT      "Bentley Systems inc"
    ...
    #define RPACKAGE_TERDATA_A_SRC_1_GEOCS          "EPSG:4326;GEOID"
    ...
    #define RPACKAGE_TERDATA_B_SRC_1_GEOCS          "EPSG:4326;GEOID"
    ...
    #define RPACKAGE_TERDATA_B_SRC_2_GEOCS          "EPSG:4326;GEOID"
    ...
    #define RPACKAGE_TERDATA_B_SRC_3_GEOCS          "EPSG:4326;GEOID"
    ...
    "<ImageryData>"
        ...
        "<Sources>"
            "<MultiBandSource uri='" RPACKAGE_IMDATA_MULTI_B1_SRC_URI "' type='" RPACKAGE_IMDATA_MULTI_B1_SRC_URI_TYPE "'>"
                ...
                "<Copyright>" RPACKAGE_IMDATA_MULTI_B1_SRC_COPYRIGHT "</Copyright>"
                "<TermOfUse>" RPACKAGE_IMDATA_MULTI_B1_SRC_TERMOFUSE "</TermOfUse>"
                "<Provider>" RPACKAGE_IMDATA_MULTI_B1_SRC_PROVIDER "</Provider>"
                "<!-- This entry indicates that authentication using USGS Earth Explorer account is required -->"
                "<ServerLoginKey>" RPACKAGE_IMDATA_MULTI_B1_SRC_SERVERLOGINKEY "</ServerLoginKey>" 
                "<!-- In the case the client application does not know the method associated with the key the method can provide an indication if the method is standard or not,"
                "     Here USGS Earth Explorer makes use of a custom method. -->"
                "<ServerLoginMethod>" RPACKAGE_IMDATA_MULTI_B1_SRC_SERVERLOGINMETHOD "</ServerLoginMethod>"
                "<!-- This points to the registration page. This page can be used by client application to help out the user register if no account exists -->"
                ...
                "<!-- The no data value is the padding color of raster file -->"
                "<NoDataValue>" RPACKAGE_IMDATA_MULTI_B1_SRC_NODATA "</NoDataValue>"
                "<Red>"
                    "<!-- May be noticed in the URI the embedded $(AUTHENTICATIONKEY). This placeholder variable is there to indicate where the authentication key"
                    "     should be inserted. This particular variable is specific to servers that use a token upon the http request command instead of setting in the header."
                    ...
                    "<Source uri='" RPACKAGE_IMDATA_MULTI_B1_RED_SRC_URI "' type='" RPACKAGE_IMDATA_MULTI_B1_RED_SRC_URI_TYPE "'>"
                        ...
                        "     should make sure the user only registers once. -->"
                        "<ServerLoginKey>" RPACKAGE_IMDATA_MULTI_B1_RED_SRC_SERVERLOGINKEY "</ServerLoginKey>"
                        "<ServerLoginMethod>" RPACKAGE_IMDATA_MULTI_B1_RED_SRC_SERVERLOGINMETHOD "</ServerLoginMethod>"
                        "<ServerRegistrationPage>" RPACKAGE_IMDATA_MULTI_B1_RED_SRC_SERVERREGISTRATIONPAGE "</ServerRegistrationPage>"
                        "<ServerOrganisationPage>" RPACKAGE_IMDATA_MULTI_B1_RED_SRC_SERVERORGANISATIONPAGE "</ServerOrganisationPage>"
                        "<!-- The no data value is the padding color of raster file -->"
                        "<NoDataValue>" RPACKAGE_IMDATA_MULTI_B1_RED_SRC_NODATA "</NoDataValue>"
                    "</Source>"
                "</Red>"
                "<Green>"
                    ...
                    "<Source uri='" RPACKAGE_IMDATA_MULTI_B1_GREEN_SRC_URI "' type='" RPACKAGE_IMDATA_MULTI_B1_GREEN_SRC_URI_TYPE "'>"
                        ...
                        "<ServerRegistrationPage>" RPACKAGE_IMDATA_MULTI_B1_GREEN_SRC_SERVERREGISTRATIONPAGE "</ServerRegistrationPage>"
                        "<ServerOrganisationPage>" RPACKAGE_IMDATA_MULTI_B1_GREEN_SRC_SERVERORGANISATIONPAGE "</ServerOrganisationPage>"
                        "<!-- The no data value is the padding color of raster file -->"
                        "<NoDataValue>" RPACKAGE_IMDATA_MULTI_B1_GREEN_SRC_NODATA "</NoDataValue>"
                    "</Source>"
                "</Green>"
                "<Blue>"
                    "<Source uri='" RPACKAGE_IMDATA_MULTI_B1_BLUE_SRC_URI "' type='" RPACKAGE_IMDATA_MULTI_B1_BLUE_SRC_URI_TYPE "'>"
                        ...
                        "<ServerRegistrationPage>" RPACKAGE_IMDATA_MULTI_B1_BLUE_SRC_SERVERREGISTRATIONPAGE "</ServerRegistrationPage>"
                        "<ServerOrganisationPage>" RPACKAGE_IMDATA_MULTI_B1_BLUE_SRC_SERVERORGANISATIONPAGE "</ServerOrganisationPage>"
                        "<!-- The no data value is the padding color of raster file -->"
                        "<NoDataValue>" RPACKAGE_IMDATA_MULTI_B1_BLUE_SRC_NODATA "</NoDataValue>"
                    "</Source>"
                "</Blue>"
                "<Panchromatic>"
                    "<Source uri='" RPACKAGE_IMDATA_MULTI_B1_PANCHROMATIC_SRC_URI "' type='" RPACKAGE_IMDATA_MULTI_B1_PANCHROMATIC_SRC_URI_TYPE "'>"
                        ...
                        "<ServerRegistrationPage>" RPACKAGE_IMDATA_MULTI_B1_PANCHROMATIC_SRC_SERVERREGISTRATIONPAGE "</ServerRegistrationPage>"
                        "<ServerOrganisationPage>" RPACKAGE_IMDATA_MULTI_B1_PANCHROMATIC_SRC_SERVERORGANISATIONPAGE "</ServerOrganisationPage>"
                        "<!-- The no data value is the padding color of raster file -->"
                        "<NoDataValue>" RPACKAGE_IMDATA_MULTI_B1_PANCHROMATIC_SRC_NODATA "</NoDataValue>"
                    "</Source>"
                "</Panchromatic>"
            "</MultiBandSource>"
            "<!-- Now, this is a real example. USGS redistributes data provided by the ESA. If Earth Explorer download server is not available then the ESA can be used. -->"
            "<MultiBandSource uri='" RPACKAGE_IMDATA_MULTI_B2_SRC_URI "' type='" RPACKAGE_IMDATA_MULTI_B2_SRC_URI_TYPE "'>"
                "<Id>" RPACKAGE_IMDATA_MULTI_B2_SRC_ID "</Id>"
                "<Copyright>" RPACKAGE_IMDATA_MULTI_B2_SRC_COPYRIGHT "</Copyright>"
                "<TermOfUse>" RPACKAGE_IMDATA_MULTI_B2_SRC_TERMOFUSE "</TermOfUse>"
                "<Provider>" RPACKAGE_IMDATA_MULTI_B2_SRC_PROVIDER "</Provider>"
                "<!-- This entry indicates that authentication using Science Hub account on the Copernicus ESA tool account is required -->"
                "<ServerLoginKey>" RPACKAGE_IMDATA_MULTI_B2_SRC_SERVERLOGINKEY "</ServerLoginKey>"
                "<!-- Here the method indicates that if the key is unknown then standard login method (http in this case) can be used. -->"
                "<ServerLoginMethod>" RPACKAGE_IMDATA_MULTI_B2_SRC_SERVERLOGINMETHOD "</ServerLoginMethod>"
                "<!-- This points to the registration page. This page can be used by client application to help out the user register if no account exists -->"
                "<ServerRegistrationPage>" RPACKAGE_IMDATA_MULTI_B2_SRC_SERVERREGISTRATIONPAGE "</ServerRegistrationPage>"
                "<!-- If the registration page is unknown or unreacheable(moved) then the organisation page can be provided to client. -->"
                "<ServerOrganisationPage>" RPACKAGE_IMDATA_MULTI_B2_SRC_SERVERORGANISATIONPAGE "</ServerOrganisationPage>"
                "<!-- The size here represents the total size of the download zip file. In the case of the ESA distributed Sentinel-2 files the zip file constains"
                "     many data compounded together (around 8 images). This is the reason the download size is much bigger than USGS distributed data. If other Image Data is part of the same compound document"
                "     then file should only be downloaded once. -->"
                "<Size>" STRINGIFY(RPACKAGE_IMDATA_MULTI_B2_SRC_SIZE) "</Size>"
                "<!-- The no data value is the padding color of raster file -->"
                "<NoDataValue>" RPACKAGE_IMDATA_MULTI_B2_SRC_NODATA "</NoDataValue>"
                "<Red>"
                    "<Source uri='" RPACKAGE_IMDATA_MULTI_B2_RED_SRC_URI "' type='" RPACKAGE_IMDATA_MULTI_B2_RED_SRC_URI_TYPE "'>"
                        "<Id>" RPACKAGE_IMDATA_MULTI_B2_RED_SRC_ID "</Id>"
                        "<!-- The size of individual bands is unknown -->"
                        "<!-- Since there is no way to correlate the band source with the compound multiband source, login information is repeated for every band. The application"
                        "     should make sure the user only registers once. -->"
                        "<ServerLoginKey>" RPACKAGE_IMDATA_MULTI_B2_RED_SRC_SERVERLOGINKEY "</ServerLoginKey>"
                        "<ServerLoginMethod>" RPACKAGE_IMDATA_MULTI_B2_RED_SRC_SERVERLOGINMETHOD "</ServerLoginMethod>"
                        "<ServerRegistrationPage>" RPACKAGE_IMDATA_MULTI_B2_RED_SRC_SERVERREGISTRATIONPAGE "</ServerRegistrationPage>"
                        "<ServerOrganisationPage>" RPACKAGE_IMDATA_MULTI_B2_RED_SRC_SERVERORGANISATIONPAGE "</ServerOrganisationPage>"
                        "<!-- The no data value is the padding color of raster file -->"
                        "<NoDataValue>" RPACKAGE_IMDATA_MULTI_B2_RED_SRC_NODATA "</NoDataValue>"
                    "</Source>"
                "</Red>"
                "<Green>"
                    "<!-- IMPORTANT: You will notice here that all bands are located in the same compound file. Since there are no provisions in the package file to refer to a file already"
                    "     downloaded, the full compound document based URI is specified for every band. The download manager should make use of the MultiBandSource size estimate upon downloading and"
                    "     use the cached file for the other bands  -->"
                    "<Source uri='" RPACKAGE_IMDATA_MULTI_B2_GREEN_SRC_URI "' type='" RPACKAGE_IMDATA_MULTI_B2_GREEN_SRC_URI_TYPE "'>"
                        "<Id>" RPACKAGE_IMDATA_MULTI_B2_GREEN_SRC_ID "</Id>"
                        "<ServerLoginKey>" RPACKAGE_IMDATA_MULTI_B2_GREEN_SRC_SERVERLOGINKEY "</ServerLoginKey>"
                        "<ServerLoginMethod>" RPACKAGE_IMDATA_MULTI_B2_GREEN_SRC_SERVERLOGINMETHOD "</ServerLoginMethod>"
                        "<ServerRegistrationPage>" RPACKAGE_IMDATA_MULTI_B2_GREEN_SRC_SERVERREGISTRATIONPAGE "</ServerRegistrationPage>"
                        "<ServerOrganisationPage>" RPACKAGE_IMDATA_MULTI_B2_GREEN_SRC_SERVERORGANISATIONPAGE "</ServerOrganisationPage>"
                        "<!-- The no data value is the padding color of raster file -->"
                        "<NoDataValue>" RPACKAGE_IMDATA_MULTI_B2_GREEN_SRC_NODATA "</NoDataValue>"
                    "</Source>"
                "</Green>"
                "<Blue>"
                    "<Source uri='" RPACKAGE_IMDATA_MULTI_B2_BLUE_SRC_URI "' type='" RPACKAGE_IMDATA_MULTI_B2_BLUE_SRC_URI_TYPE "'>"
                        "<Id>" RPACKAGE_IMDATA_MULTI_B2_BLUE_SRC_ID "</Id>"
                        "<ServerLoginKey>" RPACKAGE_IMDATA_MULTI_B2_BLUE_SRC_SERVERLOGINKEY "</ServerLoginKey>"
                        "<ServerLoginMethod>" RPACKAGE_IMDATA_MULTI_B2_BLUE_SRC_SERVERLOGINMETHOD "</ServerLoginMethod>"
                        "<ServerRegistrationPage>" RPACKAGE_IMDATA_MULTI_B2_BLUE_SRC_SERVERREGISTRATIONPAGE "</ServerRegistrationPage>"
                        "<ServerOrganisationPage>" RPACKAGE_IMDATA_MULTI_B2_BLUE_SRC_SERVERORGANISATIONPAGE "</ServerOrganisationPage>"
                        "<!-- The no data value is the padding color of raster file -->"
                        "<NoDataValue>" RPACKAGE_IMDATA_MULTI_B2_BLUE_SRC_NODATA "</NoDataValue>"
                    "</Source>"
                "</Blue>"
                "<Panchromatic>"
                    "<Source uri='" RPACKAGE_IMDATA_MULTI_B2_PANCHROMATIC_SRC_URI "' type='" RPACKAGE_IMDATA_MULTI_B2_PANCHROMATIC_SRC_URI_TYPE "'>"
                        "<Id>" RPACKAGE_IMDATA_MULTI_B2_PANCHROMATIC_SRC_ID "</Id>"
                        "<ServerLoginKey>" RPACKAGE_IMDATA_MULTI_B2_PANCHROMATIC_SRC_SERVERLOGINKEY "</ServerLoginKey>"
                        "<ServerLoginMethod>" RPACKAGE_IMDATA_MULTI_B2_PANCHROMATIC_SRC_SERVERLOGINMETHOD "</ServerLoginMethod>"
                        "<ServerRegistrationPage>" RPACKAGE_IMDATA_MULTI_B2_PANCHROMATIC_SRC_SERVERREGISTRATIONPAGE "</ServerRegistrationPage>"
                        "<ServerOrganisationPage>" RPACKAGE_IMDATA_MULTI_B2_PANCHROMATIC_SRC_SERVERORGANISATIONPAGE "</ServerOrganisationPage>"
                        "<!-- The no data value is the padding color of raster file -->"
                        "<NoDataValue>" RPACKAGE_IMDATA_MULTI_B2_PANCHROMATIC_SRC_NODATA "</NoDataValue>"
                    "</Source>"
                "</Panchromatic>"
            "</MultiBandSource>"
        "</Sources>"
            ...
            "<Sources>"
                ...
                "<Source uri='" RPACKAGE_MODDATA_A_SRC_2_URI_PART1 "' type='" RPACKAGE_MODDATA_A_SRC_2_URI_TYPE "'>"
                   "<Copyright>" RPACKAGE_MODDATA_A_SRC_2_COPYRIGHT "</Copyright>"
                    ...
                    "<!-- Indicates that authentication using Bentley CONNECT credentials are required to access the data -->"
                    "<ServerLoginKey>" RPACKAGE_MODDATA_A_SRC_2_SERVERLOGINKEY "</ServerLoginKey>"
                    "<ServerLoginMethod>" RPACKAGE_MODDATA_A_SRC_2_SERVERLOGINMETHOD "</ServerLoginMethod>"
                    "<ServerOrganisationPage>" RPACKAGE_MODDATA_A_SRC_2_SERVERORGANISATIONPAGE "</ServerOrganisationPage>"
                "</Source>"
            "</Sources>"
      "</ModelData>"
      "<ModelData>"
            "<!-- Here is an example of a streamed data source with authentication required. -->"
            "<Sources>"
                "<Source uri='" RPACKAGE_MODDATA_B_SRC_1_URI_PART1 "' type='" RPACKAGE_MODDATA_B_SRC_1_URI_TYPE "' streamed='" RPACKAGE_MODDATA_B_SRC_1_STREAMED "'>" 
                    "<Copyright>" RPACKAGE_MODDATA_B_SRC_1_COPYRIGHT "</Copyright>"
                    "<!-- The size is omitted since the data is streamed. -->"
...
//    ASSERT_STREQ(RPACKAGE_POLYGON2, pPackage->GetBoundingPolygon().ToString().c_str());
    ...
    // Imagery group
    ASSERT_TRUE(pPackage->GetImageryGroup().size() == 9);
    ...
    ASSERT_STREQ(RPACKAGE_SOURCE, pPackage->GetImageryGroup()[0]->GetDataSource(0).GetElementName());

    ASSERT_STREQ(RPACKAGE_IMDATA_A_SRC_1_URI_PART1, pPackage->GetImageryGroup()[0]->GetDataSource(0).GetUri().GetSource().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_A_SRC_1_URI_TYPE, pPackage->GetImageryGroup()[0]->GetDataSource(0).GetDataType().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_A_SRC_1_COPYRIGHT, pPackage->GetImageryGroup()[0]->GetDataSource(0).GetMetadataCP()->GetLegal().c_str());
    ...
    ASSERT_STREQ(RPACKAGE_IMDATA_A_SRC_1_METADATA, pPackage->GetImageryGroup()[0]->GetDataSource(0).GetMetadataCP()->GetDescription().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_A_SRC_1_METTYPE, pPackage->GetImageryGroup()[0]->GetDataSource(0).GetMetadataCP()->GetMetadataType().c_str());

    ASSERT_STREQ("", pPackage->GetImageryGroup()[0]->GetDataSource(0).GetGeoCS().c_str());

    ASSERT_TRUE(pPackage->GetImageryGroup()[0]->GetDataSource(0).GetSisterFiles().size() == 0);


    // image data 2
    ASSERT_TRUE(pPackage->GetImageryGroup()[1]->GetDataSourceCount() == 2);
    ...
    ASSERT_STREQ(RPACKAGE_IMDATA_B_RESOLUTION, pPackage->GetImageryGroup()[1]->GetResolution().c_str());
        ...
        // 2A
    ASSERT_STREQ(RPACKAGE_SOURCE, pPackage->GetImageryGroup()[1]->GetDataSource(0).GetElementName());

    ASSERT_STREQ(RPACKAGE_IMDATA_B_SRC_1_URI_PART1, pPackage->GetImageryGroup()[1]->GetDataSource(0).GetUri().GetSource().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_B_SRC_1_URI_TYPE, pPackage->GetImageryGroup()[1]->GetDataSource(0).GetDataType().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_B_SRC_1_COPYRIGHT, pPackage->GetImageryGroup()[1]->GetDataSource(0).GetMetadataCP()->GetLegal().c_str());
    ...
    ASSERT_STREQ(RPACKAGE_IMDATA_B_SRC_1_METADATA, pPackage->GetImageryGroup()[1]->GetDataSource(0).GetMetadataCP()->GetDescription().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_B_SRC_1_METTYPE, pPackage->GetImageryGroup()[1]->GetDataSource(0).GetMetadataCP()->GetMetadataType().c_str());

    ASSERT_STREQ("", pPackage->GetImageryGroup()[1]->GetDataSource(0).GetGeoCS().c_str());

    ASSERT_TRUE(pPackage->GetImageryGroup()[1]->GetDataSource(0).GetSisterFiles().size() == 0);

        // 2B
    ASSERT_STREQ(RPACKAGE_SOURCE, pPackage->GetImageryGroup()[1]->GetDataSource(1).GetElementName());

    ASSERT_STREQ(RPACKAGE_IMDATA_B_SRC_2_URI_PART1, pPackage->GetImageryGroup()[1]->GetDataSource(1).GetUri().GetSource().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_B_SRC_2_URI_TYPE, pPackage->GetImageryGroup()[1]->GetDataSource(1).GetDataType().c_str());
    ...
    ASSERT_STREQ(RPACKAGE_IMDATA_B_SRC_2_METADATA, pPackage->GetImageryGroup()[1]->GetDataSource(1).GetMetadataCP()->GetDescription().c_str());
    ASSERT_STREQ("", pPackage->GetImageryGroup()[1]->GetDataSource(1).GetMetadataCP()->GetMetadataType().c_str());

    ASSERT_STREQ(RPACKAGE_IMDATA_B_SRC_2_GEOCS, pPackage->GetImageryGroup()[1]->GetDataSource(1).GetGeoCS().c_str());

    ASSERT_TRUE(pPackage->GetImageryGroup()[1]->GetDataSource(1).GetSisterFiles().size() == 0);

    // image data 3
    ASSERT_TRUE(pPackage->GetImageryGroup()[2]->GetDataSourceCount() == 1);
    ...
    ASSERT_STREQ(RPACKAGE_SOURCE, pPackage->GetImageryGroup()[2]->GetDataSource(0).GetElementName());

    ASSERT_STREQ(RPACKAGE_IMDATA_C_SRC_1_URI_PART1, pPackage->GetImageryGroup()[2]->GetDataSource(0).GetUri().GetSource().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_C_SRC_1_URI_TYPE, pPackage->GetImageryGroup()[2]->GetDataSource(0).GetDataType().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_C_SRC_1_COPYRIGHT, pPackage->GetImageryGroup()[2]->GetDataSource(0).GetMetadataCP()->GetLegal().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_C_SRC_1_TERMOFUSE, pPackage->GetImageryGroup()[2]->GetDataSource(0).GetMetadataCP()->GetTermsOfUse().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_C_SRC_1_ID, pPackage->GetImageryGroup()[2]->GetDataSource(0).GetId().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_C_SRC_1_PROVIDER, pPackage->GetImageryGroup()[2]->GetDataSource(0).GetProvider().c_str());
    ASSERT_EQ(RPACKAGE_IMDATA_C_SRC_1_SIZE, pPackage->GetImageryGroup()[2]->GetDataSource(0).GetSize());

    ASSERT_STREQ(RPACKAGE_IMDATA_C_SRC_1_URI_PART2, pPackage->GetImageryGroup()[2]->GetDataSource(0).GetUri().GetFileInCompound().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_C_SRC_1_METADATA, pPackage->GetImageryGroup()[2]->GetDataSource(0).GetMetadataCP()->GetDescription().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_C_SRC_1_METTYPE, pPackage->GetImageryGroup()[2]->GetDataSource(0).GetMetadataCP()->GetMetadataType().c_str());

    ASSERT_STREQ("", pPackage->GetImageryGroup()[2]->GetDataSource(0).GetGeoCS().c_str());

    ASSERT_TRUE(pPackage->GetImageryGroup()[2]->GetDataSource(0).GetSisterFiles().size() == 0);

    // image data 4
    ASSERT_TRUE(pPackage->GetImageryGroup()[3]->GetDataSourceCount() == 1);
    ...
    ASSERT_STREQ(RPACKAGE_SOURCE, pPackage->GetImageryGroup()[3]->GetDataSource(0).GetElementName());

    ASSERT_STREQ(RPACKAGE_IMDATA_D_SRC_1_URI_PART1, pPackage->GetImageryGroup()[3]->GetDataSource(0).GetUri().GetSource().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_D_SRC_1_URI_TYPE, pPackage->GetImageryGroup()[3]->GetDataSource(0).GetDataType().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_D_SRC_1_COPYRIGHT, pPackage->GetImageryGroup()[3]->GetDataSource(0).GetMetadataCP()->GetLegal().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_D_SRC_1_ID, pPackage->GetImageryGroup()[3]->GetDataSource(0).GetId().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_D_SRC_1_PROVIDER, pPackage->GetImageryGroup()[3]->GetDataSource(0).GetProvider().c_str());
    ASSERT_EQ(RPACKAGE_IMDATA_D_SRC_1_SIZE, pPackage->GetImageryGroup()[3]->GetDataSource(0).GetSize());

    ASSERT_STREQ(RPACKAGE_IMDATA_D_SRC_1_URI_PART2, pPackage->GetImageryGroup()[3]->GetDataSource(0).GetUri().GetFileInCompound().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_D_SRC_1_METADATA, pPackage->GetImageryGroup()[3]->GetDataSource(0).GetMetadataCP()->GetDescription().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_D_SRC_1_METTYPE, pPackage->GetImageryGroup()[3]->GetDataSource(0).GetMetadataCP()->GetMetadataType().c_str());

    ASSERT_STREQ("", pPackage->GetImageryGroup()[3]->GetDataSource(0).GetGeoCS().c_str());

    ASSERT_TRUE(pPackage->GetImageryGroup()[3]->GetDataSource(0).GetSisterFiles().size() == 1);
    ASSERT_STREQ(RPACKAGE_IMDATA_D_SRC_1_SIS1, pPackage->GetImageryGroup()[3]->GetDataSource(0).GetSisterFiles()[0]->GetSource().c_str());
    ASSERT_STREQ("", pPackage->GetImageryGroup()[3]->GetDataSource(0).GetSisterFiles()[0]->GetFileInCompound().c_str());

    // image data 5
    ASSERT_TRUE(pPackage->GetImageryGroup()[4]->GetDataSourceCount() == 1);
    ASSERT_STREQ(RPACKAGE_IMDATA_E_ID, pPackage->GetImageryGroup()[4]->GetIdentifier().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_E_NAME, pPackage->GetImageryGroup()[4]->GetName().c_str());

    ASSERT_STREQ(RPACKAGE_SOURCE, pPackage->GetImageryGroup()[4]->GetDataSource(0).GetElementName());

    ASSERT_STREQ(RPACKAGE_IMDATA_E_SRC_1_URI_PART1, pPackage->GetImageryGroup()[4]->GetDataSource(0).GetUri().GetSource().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_E_SRC_1_URI_TYPE, pPackage->GetImageryGroup()[4]->GetDataSource(0).GetDataType().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_E_SRC_1_COPYRIGHT, pPackage->GetImageryGroup()[4]->GetDataSource(0).GetMetadataCP()->GetLegal().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_E_SRC_1_ID, pPackage->GetImageryGroup()[4]->GetDataSource(0).GetId().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_E_SRC_1_PROVIDER, pPackage->GetImageryGroup()[4]->GetDataSource(0).GetProvider().c_str());
    ASSERT_EQ(RPACKAGE_IMDATA_E_SRC_1_SIZE, pPackage->GetImageryGroup()[4]->GetDataSource(0).GetSize());

    ASSERT_STREQ(RPACKAGE_IMDATA_E_SRC_1_URI_PART2, pPackage->GetImageryGroup()[4]->GetDataSource(0).GetUri().GetFileInCompound().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_E_SRC_1_METADATA, pPackage->GetImageryGroup()[4]->GetDataSource(0).GetMetadataCP()->GetDescription().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_E_SRC_1_METTYPE, pPackage->GetImageryGroup()[4]->GetDataSource(0).GetMetadataCP()->GetMetadataType().c_str());

    ASSERT_STREQ("", pPackage->GetImageryGroup()[4]->GetDataSource(0).GetGeoCS().c_str());

    ASSERT_TRUE(pPackage->GetImageryGroup()[4]->GetDataSource(0).GetSisterFiles().size() == 0);

    // image data 6
    ASSERT_TRUE(pPackage->GetImageryGroup()[5]->GetDataSourceCount() == 3);
    ASSERT_STREQ(RPACKAGE_IMDATA_F_ID, pPackage->GetImageryGroup()[5]->GetIdentifier().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_F_NAME, pPackage->GetImageryGroup()[5]->GetName().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_F_DATASET, pPackage->GetImageryGroup()[5]->GetDataset().c_str());

        // 6A
    ASSERT_STREQ(RPACKAGE_SOURCE, pPackage->GetImageryGroup()[5]->GetDataSource(0).GetElementName());

    ASSERT_STREQ(RPACKAGE_IMDATA_F_SRC_1_URI_PART1, pPackage->GetImageryGroup()[5]->GetDataSource(0).GetUri().GetSource().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_F_SRC_1_URI_TYPE, pPackage->GetImageryGroup()[5]->GetDataSource(0).GetDataType().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_F_SRC_1_COPYRIGHT, pPackage->GetImageryGroup()[5]->GetDataSource(0).GetMetadataCP()->GetLegal().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_F_SRC_1_ID, pPackage->GetImageryGroup()[5]->GetDataSource(0).GetId().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_F_SRC_1_PROVIDER, pPackage->GetImageryGroup()[5]->GetDataSource(0).GetProvider().c_str());
    ASSERT_EQ(RPACKAGE_IMDATA_F_SRC_1_SIZE, pPackage->GetImageryGroup()[5]->GetDataSource(0).GetSize());

    ASSERT_STREQ(RPACKAGE_IMDATA_F_SRC_1_URI_PART2, pPackage->GetImageryGroup()[5]->GetDataSource(0).GetUri().GetFileInCompound().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_F_SRC_1_METADATA, pPackage->GetImageryGroup()[5]->GetDataSource(0).GetMetadataCP()->GetDescription().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_F_SRC_1_METTYPE, pPackage->GetImageryGroup()[5]->GetDataSource(0).GetMetadataCP()->GetMetadataType().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_F_SRC_1_GEOCS, pPackage->GetImageryGroup()[5]->GetDataSource(0).GetGeoCS().c_str());

    ASSERT_TRUE(pPackage->GetImageryGroup()[5]->GetDataSource(0).GetSisterFiles().size() == 0);

        // 6B
    ASSERT_STREQ(RPACKAGE_SOURCE, pPackage->GetImageryGroup()[5]->GetDataSource(1).GetElementName());

    ASSERT_STREQ(RPACKAGE_IMDATA_F_SRC_2_URI_PART1, pPackage->GetImageryGroup()[5]->GetDataSource(1).GetUri().GetSource().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_F_SRC_2_URI_TYPE, pPackage->GetImageryGroup()[5]->GetDataSource(1).GetDataType().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_F_SRC_2_COPYRIGHT, pPackage->GetImageryGroup()[5]->GetDataSource(1).GetMetadataCP()->GetLegal().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_F_SRC_2_TERMOFUSE, pPackage->GetImageryGroup()[5]->GetDataSource(1).GetMetadataCP()->GetTermsOfUse().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_F_SRC_2_ID, pPackage->GetImageryGroup()[5]->GetDataSource(1).GetId().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_F_SRC_2_PROVIDER, pPackage->GetImageryGroup()[5]->GetDataSource(1).GetProvider().c_str());
    ASSERT_EQ(RPACKAGE_IMDATA_F_SRC_2_SIZE, pPackage->GetImageryGroup()[5]->GetDataSource(1).GetSize());

    ASSERT_STREQ(RPACKAGE_IMDATA_F_SRC_2_URI_PART2, pPackage->GetImageryGroup()[5]->GetDataSource(1).GetUri().GetFileInCompound().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_F_SRC_2_METADATA, pPackage->GetImageryGroup()[5]->GetDataSource(1).GetMetadataCP()->GetDescription().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_F_SRC_2_METTYPE, pPackage->GetImageryGroup()[5]->GetDataSource(1).GetMetadataCP()->GetMetadataType().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_F_SRC_2_GEOCS, pPackage->GetImageryGroup()[5]->GetDataSource(1).GetGeoCS().c_str());

    ASSERT_TRUE(pPackage->GetImageryGroup()[5]->GetDataSource(1).GetSisterFiles().size() == 0);

        // 6C
    ASSERT_STREQ(RPACKAGE_SOURCE, pPackage->GetImageryGroup()[5]->GetDataSource(2).GetElementName());

    ASSERT_STREQ(RPACKAGE_IMDATA_F_SRC_3_URI_PART1, pPackage->GetImageryGroup()[5]->GetDataSource(2).GetUri().GetSource().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_F_SRC_3_URI_TYPE, pPackage->GetImageryGroup()[5]->GetDataSource(2).GetDataType().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_F_SRC_3_COPYRIGHT, pPackage->GetImageryGroup()[5]->GetDataSource(2).GetMetadataCP()->GetLegal().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_F_SRC_3_TERMOFUSE, pPackage->GetImageryGroup()[5]->GetDataSource(2).GetMetadataCP()->GetTermsOfUse().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_F_SRC_3_ID, pPackage->GetImageryGroup()[5]->GetDataSource(2).GetId().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_F_SRC_3_PROVIDER, pPackage->GetImageryGroup()[5]->GetDataSource(2).GetProvider().c_str());
    ASSERT_EQ(RPACKAGE_IMDATA_F_SRC_3_SIZE, pPackage->GetImageryGroup()[5]->GetDataSource(2).GetSize());

    ASSERT_STREQ(RPACKAGE_IMDATA_F_SRC_3_URI_PART2, pPackage->GetImageryGroup()[5]->GetDataSource(2).GetUri().GetFileInCompound().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_F_SRC_3_METADATA, pPackage->GetImageryGroup()[5]->GetDataSource(2).GetMetadataCP()->GetDescription().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_F_SRC_3_METTYPE, pPackage->GetImageryGroup()[5]->GetDataSource(2).GetMetadataCP()->GetMetadataType().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_F_SRC_3_GEOCS, pPackage->GetImageryGroup()[5]->GetDataSource(2).GetGeoCS().c_str());

    ASSERT_TRUE(pPackage->GetImageryGroup()[5]->GetDataSource(2).GetSisterFiles().size() == 1);
    ASSERT_STREQ(RPACKAGE_IMDATA_F_SRC_3_SIS1, pPackage->GetImageryGroup()[5]->GetDataSource(2).GetSisterFiles()[0]->GetSource().c_str());
    ASSERT_STREQ("", pPackage->GetImageryGroup()[5]->GetDataSource(2).GetSisterFiles()[0]->GetFileInCompound().c_str());



    // image data 7
    ASSERT_TRUE(pPackage->GetImageryGroup()[6]->GetDataSourceCount() == 1);
    ASSERT_STREQ(RPACKAGE_IMDATA_G_ID, pPackage->GetImageryGroup()[6]->GetIdentifier().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_G_NAME, pPackage->GetImageryGroup()[6]->GetName().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_G_DATASET, pPackage->GetImageryGroup()[6]->GetDataset().c_str());

    ASSERT_STREQ(RPACKAGE_SOURCE, pPackage->GetImageryGroup()[6]->GetDataSource(0).GetElementName());

    ASSERT_STREQ(RPACKAGE_IMDATA_G_SRC_1_URI_PART1, pPackage->GetImageryGroup()[6]->GetDataSource(0).GetUri().GetSource().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_G_SRC_1_URI_TYPE, pPackage->GetImageryGroup()[6]->GetDataSource(0).GetDataType().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_G_SRC_1_COPYRIGHT, pPackage->GetImageryGroup()[6]->GetDataSource(0).GetMetadataCP()->GetLegal().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_G_SRC_1_TERMOFUSE, pPackage->GetImageryGroup()[6]->GetDataSource(0).GetMetadataCP()->GetTermsOfUse().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_G_SRC_1_ID, pPackage->GetImageryGroup()[6]->GetDataSource(0).GetId().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_G_SRC_1_PROVIDER, pPackage->GetImageryGroup()[6]->GetDataSource(0).GetProvider().c_str());
    ASSERT_EQ(RPACKAGE_IMDATA_G_SRC_1_SIZE, pPackage->GetImageryGroup()[6]->GetDataSource(0).GetSize());

    ASSERT_STREQ(RPACKAGE_IMDATA_G_SRC_1_URI_PART2, pPackage->GetImageryGroup()[6]->GetDataSource(0).GetUri().GetFileInCompound().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_G_SRC_1_METADATA, pPackage->GetImageryGroup()[6]->GetDataSource(0).GetMetadataCP()->GetDescription().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_G_SRC_1_METTYPE, pPackage->GetImageryGroup()[6]->GetDataSource(0).GetMetadataCP()->GetMetadataType().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_G_SRC_1_GEOCS, pPackage->GetImageryGroup()[6]->GetDataSource(0).GetGeoCS().c_str());

    ASSERT_TRUE(pPackage->GetImageryGroup()[6]->GetDataSource(0).GetSisterFiles().size() == 2);
    ASSERT_STREQ("", pPackage->GetImageryGroup()[6]->GetDataSource(0).GetSisterFiles()[0]->GetSource().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_G_SRC_1_SIS1, pPackage->GetImageryGroup()[6]->GetDataSource(0).GetSisterFiles()[0]->GetFileInCompound().c_str());

    ASSERT_STREQ("", pPackage->GetImageryGroup()[6]->GetDataSource(0).GetSisterFiles()[1]->GetSource().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_G_SRC_1_SIS2, pPackage->GetImageryGroup()[6]->GetDataSource(0).GetSisterFiles()[1]->GetFileInCompound().c_str());

    // image data 8
    ASSERT_TRUE(pPackage->GetImageryGroup()[7]->GetDataSourceCount() == 1);
    ASSERT_STREQ(RPACKAGE_IMDATA_MULTI_A_ID, pPackage->GetImageryGroup()[7]->GetIdentifier().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_MULTI_A_NAME, pPackage->GetImageryGroup()[7]->GetName().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_MULTI_A_DATASET, pPackage->GetImageryGroup()[7]->GetDataset().c_str());

    ASSERT_STREQ(RPACKAGE_MULTIBANDSOURCE, pPackage->GetImageryGroup()[7]->GetDataSource(0).GetElementName());

    ASSERT_STREQ(RPACKAGE_IMDATA_MULTI_A_SRC_URI, pPackage->GetImageryGroup()[7]->GetDataSource(0).GetUri().GetSource().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_MULTI_A_SRC_URI_TYPE, pPackage->GetImageryGroup()[7]->GetDataSource(0).GetDataType().c_str());
    ...
    ASSERT_STREQ(RPACKAGE_IMDATA_MULTI_A_SRC_METADATA, pPackage->GetImageryGroup()[7]->GetDataSource(0).GetMetadataCP()->GetDescription().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_MULTI_A_SRC_METATYPE, pPackage->GetImageryGroup()[7]->GetDataSource(0).GetMetadataCP()->GetMetadataType().c_str());
    ASSERT_STREQ(RPACKAGE_IMDATA_MULTI_A_SRC_GEOCS, pPackage->GetImageryGroup()[7]->GetDataSource(0).GetGeoCS().c_str());

    ASSERT_TRUE(pPackage->GetImageryGroup()[7]->GetDataSource(0).GetSisterFiles().size() == 0);

    // Now cast as a multiband and extract information
    MultiBandSourcePtr pMultiBandSource;
    ASSERT_TRUE((pMultiBandSource = dynamic_cast<MultiBandSourceP>(&(pPackage->GetImageryGroup()[7]->GetDataSource(0)))) != NULL);
    ...
    ASSERT_NEAR(pPackage->GetImageryGroup()[1]->GetFootprint()[PackageRealityData::Corners::LowerLeft].longitude, RPACKAGE_IMDATA_B_CORNER_LL_LONG, LONGLAT_EPSILON);
    ASSERT_NEAR(pPackage->GetImageryGroup()[1]->GetFootprint()[PackageRealityData::Corners::LowerLeft].latitude, RPACKAGE_IMDATA_B_CORNER_LL_LAT, LONGLAT_EPSILON);
    ASSERT_NEAR(pPackage->GetImageryGroup()[1]->GetFootprint()[PackageRealityData::Corners::LowerRight].longitude, RPACKAGE_IMDATA_B_CORNER_LR_LONG, LONGLAT_EPSILON);
    ASSERT_NEAR(pPackage->GetImageryGroup()[1]->GetFootprint()[PackageRealityData::Corners::LowerRight].latitude, RPACKAGE_IMDATA_B_CORNER_LR_LAT, LONGLAT_EPSILON);
    ASSERT_NEAR(pPackage->GetImageryGroup()[1]->GetFootprint()[PackageRealityData::Corners::UpperLeft].longitude, RPACKAGE_IMDATA_B_CORNER_UL_LONG, LONGLAT_EPSILON);
    ASSERT_NEAR(pPackage->GetImageryGroup()[1]->GetFootprint()[PackageRealityData::Corners::UpperLeft].latitude, RPACKAGE_IMDATA_B_CORNER_UL_LAT, LONGLAT_EPSILON);
    ...
    // Model
    ASSERT_STREQ(RPACKAGE_MODDATA_A_SRC_1_URI_PART1, pPackage->GetModelGroup()[0]->GetDataSource(0).GetUri().GetSource().c_str());
    ASSERT_STREQ(RPACKAGE_MODDATA_A_SRC_1_URI_TYPE, pPackage->GetModelGroup()[0]->GetDataSource(0).GetDataType().c_str());

    // Pinned
    ASSERT_TRUE(pPackage->GetPinnedGroup().size() == 4);

    ASSERT_TRUE(pPackage->GetPinnedGroup()[0]->GetDataSourceCount() == 2);
    ASSERT_STREQ(RPACKAGE_PINDATA_A_ID, pPackage->GetPinnedGroup()[0]->GetIdentifier().c_str());
    ASSERT_STREQ(RPACKAGE_PINDATA_A_NAME, pPackage->GetPinnedGroup()[0]->GetName().c_str());
    ASSERT_STREQ(RPACKAGE_PINDATA_A_DATASET, pPackage->GetPinnedGroup()[0]->GetDataset().c_str());

    ASSERT_STREQ(RPACKAGE_HOUSE_URI, pPackage->GetPinnedGroup()[0]->GetDataSource(0).GetUri().GetSource().c_str());
    ASSERT_STREQ(RPACKAGE_PINDATA_A_SRC_1_URI_TYPE, pPackage->GetPinnedGroup()[0]->GetDataSource(0).GetDataType().c_str());
    ...
    ASSERT_STREQ(RPACKAGE_PINDATA_B_SRC_1_URI_PART1, pPackage->GetPinnedGroup()[1]->GetDataSource(0).GetUri().GetSource().c_str());
    ASSERT_STREQ(RPACKAGE_PINDATA_B_SRC_1_URI_TYPE, pPackage->GetPinnedGroup()[1]->GetDataSource(0).GetDataType().c_str());
    ...
    ASSERT_STREQ(RPACKAGE_TERDATA_A_SRC_1_URI_PART1, pPackage->GetTerrainGroup()[0]->GetDataSource(0).GetUri().GetSource().c_str());
    ASSERT_STREQ(RPACKAGE_TERDATA_A_SRC_1_URI_TYPE, pPackage->GetTerrainGroup()[0]->GetDataSource(0).GetDataType().c_str());

    ASSERT_TRUE(pPackage->GetTerrainGroup()[1]->GetDataSourceCount() == 4);
    ASSERT_STREQ(RPACKAGE_TERDATA_B_SRC_1_URI_PART1, pPackage->GetTerrainGroup()[1]->GetDataSource(0).GetUri().GetSource().c_str());
    ASSERT_STREQ(RPACKAGE_TERDATA_B_SRC_1_URI_TYPE, pPackage->GetTerrainGroup()[1]->GetDataSource(0).GetDataType().c_str());
    ...
    ASSERT_STREQ(RPACKAGE_UNDDATA_A_ID, pPackage->GetUndefinedGroup()[0]->GetIdentifier().c_str());
    ASSERT_STREQ(RPACKAGE_UNDDATA_A_NAME, pPackage->GetUndefinedGroup()[0]->GetName().c_str());
    ASSERT_STREQ(RPACKAGE_UNDDATA_A_DATASET, pPackage->GetUndefinedGroup()[0]->GetDataset().c_str());

    ASSERT_STREQ(RPACKAGE_SOURCE, pPackage->GetUndefinedGroup()[0]->GetDataSource(0).GetElementName());

    ASSERT_STREQ(RPACKAGE_UNDDATA_A_SRC_1_URI_PART1, pPackage->GetUndefinedGroup()[0]->GetDataSource(0).GetUri().GetSource().c_str());
    ASSERT_STREQ(RPACKAGE_UNDDATA_A_SRC_1_URI_TYPE, pPackage->GetUndefinedGroup()[0]->GetDataSource(0).GetDataType().c_str());
    ASSERT_STREQ(RPACKAGE_UNDDATA_A_SRC_1_COPYRIGHT, pPackage->GetUndefinedGroup()[0]->GetDataSource(0).GetMetadataCP()->GetLegal().c_str());
    ASSERT_STREQ("", pPackage->GetUndefinedGroup()[0]->GetDataSource(0).GetMetadataCP()->GetTermsOfUse().c_str());
    ASSERT_STREQ(RPACKAGE_UNDDATA_A_SRC_1_ID, pPackage->GetUndefinedGroup()[0]->GetDataSource(0).GetId().c_str());
    ASSERT_STREQ(RPACKAGE_UNDDATA_A_SRC_1_PROVIDER, pPackage->GetUndefinedGroup()[0]->GetDataSource(0).GetProvider().c_str());
    ASSERT_EQ(RPACKAGE_UNDDATA_A_SRC_1_SIZE, pPackage->GetUndefinedGroup()[0]->GetDataSource(0).GetSize());

    ASSERT_STREQ(RPACKAGE_UNDDATA_A_SRC_1_METADATA, pPackage->GetUndefinedGroup()[0]->GetDataSource(0).GetMetadataCP()->GetDescription().c_str());

    ASSERT_STREQ(RPACKAGE_UNDDATA_A_SRC_1_GEOCS, pPackage->GetUndefinedGroup()[0]->GetDataSource(0).GetGeoCS().c_str());

    ASSERT_TRUE(pPackage->GetUndefinedGroup()[0]->GetDataSource(0).GetSisterFiles().size() == 0);
    }
...
// @bsimethod                                                   Mathieu.Marchand  3/2015
//----------------------------------------------------------------------------------------
TEST_F (PackageTestFixture, CreateAndRead_1_0)
    {
    ...
    pPackage->SetMajorVersion(1);
    ASSERT_TRUE(1 == pPackage->GetMajorVersion());
    ...
    // *** Reality entries
    bvector<GeoPoint2d> jpegCorners = {{5.123456789, 4.987654321}, {55.4554, 22.44}, {111.22, 15.4551234}, {5.14, 89.999}};
    PackageRealityDataPtr pJpegImagery = PackageRealityData::CreateImagery(*pJpegDataSource, jpegCorners);
    ASSERT_TRUE(pJpegImagery.IsValid());
    pPackage->GetImageryGroupR().push_back(pJpegImagery);
    PackageRealityDataPtr pWmsImagery = PackageRealityData::CreateImagery(*pWmsDataDataSource, bvector<GeoPoint2d>());
    ASSERT_TRUE(pWmsImagery.IsValid());
    pPackage->GetImageryGroupR().push_back(pWmsImagery);
    
    PackageRealityDataPtr pShapeModel = PackageRealityData::CreateModel(*pShapeDataSource);
    ASSERT_TRUE(pShapeModel.IsValid());
    pPackage->GetModelGroupR().push_back(pShapeModel);

    PackageRealityDataPtr pPinnedJpeg = PackageRealityData::CreatePinned(*pMyHouseDataDataSource, -180, 89.123456789);
    ASSERT_TRUE(pPinnedJpeg.IsValid());
    pPackage->GetPinnedGroupR().push_back(pPinnedJpeg);
    pPackage->GetPinnedGroupR().push_back(PackageRealityData::CreatePinned(*pAviDataDataSource, 166.987654321, -90));

    PackageRealityDataPtr pPodTerrain = PackageRealityData::CreateTerrain(*pPodDataSource);
    ASSERT_TRUE(pPodTerrain.IsValid());
    pPackage->GetTerrainGroupR().push_back(pPodTerrain);
    pPackage->GetTerrainGroupR().push_back(PackageRealityData::CreateTerrain(*pDtmDataSource));
    pPackage->GetTerrainGroupR().push_back(PackageRealityData::CreateTerrain(*pTifDataSource));
    ...
    for(size_t index=0; index < pPackage->GetImageryGroup().size(); ++index)
        {
        PackageRealityDataPtr pLeft = pPackage->GetImageryGroup()[index];
        PackageRealityDataPtr pRight = pReadPackage->GetImageryGroup()[index];

        ASSERT_STREQ(pLeft->GetDataSource(0).GetUri().GetSource().c_str(), pRight->GetDataSource(0).GetUri().GetSource().c_str());
        ASSERT_STREQ(pLeft->GetDataSource(0).GetDataType().c_str(), pRight->GetDataSource(0).GetDataType().c_str());

        ASSERT_STREQ(pLeft->GetDataSource(0).GetMetadataCP()->GetLegal().c_str(), pRight->GetDataSource(0).GetMetadataCP()->GetLegal().c_str());
        ASSERT_STREQ(pLeft->GetDataSource(0).GetId().c_str(), pRight->GetDataSource(0).GetId().c_str());
        ASSERT_STREQ(pLeft->GetDataSource(0).GetProvider().c_str(), pRight->GetDataSource(0).GetProvider().c_str());
        ASSERT_STREQ(pLeft->GetDataSource(0).GetMetadataCP()->GetDescription().c_str(), pRight->GetDataSource(0).GetMetadataCP()->GetDescription().c_str());
        ASSERT_EQ(pLeft->GetDataSource(0).GetSize(), pRight->GetDataSource(0).GetSize());
        
        ASSERT_EQ((pLeft->GetFootprint().size()), (pRight->GetFootprint().size()));
        if(!pLeft->GetFootprint().empty())
            {
            ASSERT_NEAR(pLeft->GetFootprint()[PackageRealityData::Corners::LowerLeft].longitude, pRight->GetFootprint()[PackageRealityData::Corners::LowerLeft].longitude, LONGLAT_EPSILON);
            ASSERT_NEAR(pLeft->GetFootprint()[PackageRealityData::Corners::LowerLeft].latitude, pRight->GetFootprint()[PackageRealityData::Corners::LowerLeft].latitude, LONGLAT_EPSILON);
            ASSERT_NEAR(pLeft->GetFootprint()[PackageRealityData::Corners::LowerRight].longitude, pRight->GetFootprint()[PackageRealityData::Corners::LowerRight].longitude, LONGLAT_EPSILON);
            ASSERT_NEAR(pLeft->GetFootprint()[PackageRealityData::Corners::LowerRight].latitude, pRight->GetFootprint()[PackageRealityData::Corners::LowerRight].latitude, LONGLAT_EPSILON);
            ASSERT_NEAR(pLeft->GetFootprint()[PackageRealityData::Corners::UpperLeft].longitude, pRight->GetFootprint()[PackageRealityData::Corners::UpperLeft].longitude, LONGLAT_EPSILON);
            ASSERT_NEAR(pLeft->GetFootprint()[PackageRealityData::Corners::UpperLeft].latitude, pRight->GetFootprint()[PackageRealityData::Corners::UpperLeft].latitude, LONGLAT_EPSILON);
            ASSERT_NEAR(pLeft->GetFootprint()[PackageRealityData::Corners::UpperRight].longitude, pRight->GetFootprint()[PackageRealityData::Corners::UpperRight].longitude, LONGLAT_EPSILON);
            ASSERT_NEAR(pLeft->GetFootprint()[PackageRealityData::Corners::UpperRight].latitude, pRight->GetFootprint()[PackageRealityData::Corners::UpperRight].latitude, LONGLAT_EPSILON);
            }
        }
    ...
    for(size_t index=0; index < pPackage->GetModelGroup().size(); ++index)
        {
        PackageRealityDataPtr pLeft = pPackage->GetModelGroup()[index];
    ...
    for(size_t index=0; index < pPackage->GetPinnedGroup().size(); ++index)
        {
        PackageRealityDataPtr pLeft = pPackage->GetPinnedGroup()[index];
    ...
    for(size_t index=0; index < pPackage->GetTerrainGroup().size(); ++index)
        {
        PackageRealityDataPtr pLeft = pPackage->GetTerrainGroup()[index];
