...
namespace IndexECPlugin.Tests
{
    ...
    class USGSDataExtractorsTests
    {
        ...
        public void HRODataExtractorTest()
        {
            ...
            Assert.AreEqual("USGS High Resolution Orthoimagery for Monterey County, CA: 10SEF910560 200606 0x5000m CL 1", title);
        ...
        public void NAIPDataExtractorTest()
        {
            ...
            Assert.AreEqual("FSA 10:1 NAIP Imagery m_3309603_ne_14_1_20130612_20130729 3.75 x 3.75 minute JPEG2000 from The National Map", title);
        ...
        public void NEDDataExtractorTest()
        {
            ...
            Assert.AreEqual("USGS NED n72w157 1 arc-second 2013 1 x 1 degree IMG", title);
            Assert.AreEqual("2013 01 01", String.Format("{0:yyyy MM dd}", date.Value));
            Assert.AreEqual("1\"", resolution);
            Assert.AreEqual("9.7952x30.87", resolutionInMeters);
            ...
            Assert.AreEqual("USGS NED one meter x24y459 IL 12-County-HenryCO 2009 IMG 2015", title);
            Assert.AreEqual("2015 03 19", String.Format("{0:yyyy MM dd}", date.Value));
            Assert.AreEqual("1.0m", resolution);
            Assert.AreEqual("1.0x1.0", resolutionInMeters);
            ...
            Assert.AreEqual("USGS NED 1/3 arc-second n43w078 1 x 1 degree IMG 2015", title);
            Assert.AreEqual("2015 06 03", String.Format("{0:yyyy MM dd}", date.Value));
            Assert.AreEqual("1/3\"", resolution);
            Assert.AreEqual("7.5866x10.29", resolutionInMeters);
            ...
            Assert.AreEqual("USGS NED ned19_n66x75_w145x25_ak_yukonflats_2009 1/9 arc-second 2010 15 x 15 minute IMG", title);
        ...
        public void DefaultDataExtractorTest()
        {
            ...
            Assert.AreEqual("USGS Lidar Point Cloud NY FEMA-R2-Seneca 2012 18tum405880 LAS 2015", title);
        ...
        public void NLCDDataExtractorTest()
        {
            ...
            Assert.AreEqual("NLCD 2011 Land Cover Alaska, 3 x 3 Degree: NLCD2011_LC_N63W159", title);
            Assert.AreEqual("2011 01 01", String.Format("{0:yyyy MM dd}", date.Value));
            ...
            Assert.AreEqual("NLCD 2006 Land Cover (2011 Edition, amended 2014), by State: NLCD2006_LC_Kentucky", title);
            Assert.AreEqual("2006 01 01", String.Format("{0:yyyy MM dd}", date.Value));
            Assert.AreEqual("30.0m", resolution);
            Assert.AreEqual("30.0x30.0", resolutionInMeters);
            ...
            Assert.AreEqual("NLCD 2001 Percent Developed Imperviousness (2011 Edition, amended 2014), by State: NLCD2001_IMP_Arizona", title);
