        ...
        public void ExtractTitleDateAndResolution(JToken token, out string title, out DateTime date, out string resolution, out string resolutionInMeters)
        {
            ...
            switch (m_dataset)
            {
                ...
                case "National Elevation Dataset (NED) 1/9 arc-second":
                    ...
                    //It should never be as small as 0.0001, so i've put this to prevent errors in case of bad input... 
                    //Anyway 0.0001 is way smaller than the error of the ConvertArcsecLatToMeter function.
