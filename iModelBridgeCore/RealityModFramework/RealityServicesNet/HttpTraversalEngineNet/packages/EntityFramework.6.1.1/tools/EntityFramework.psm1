...
function Update-Database
{
    ...
    try
    {
        Invoke-RunnerCommand $runner System.Data.Entity.Migrations.UpdateDatabaseCommand @( $Source: RealityServicesNet/HttpTraversalEngineNet/packages/EntityFramework.6.1.1/tools/EntityFramework.psm1 $Verbose.IsPresent )
        $error = Get-RunnerError $runner
