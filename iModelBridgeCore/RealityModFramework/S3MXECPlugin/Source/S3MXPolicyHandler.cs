...
namespace S3MXECPlugin.Source
    ...
    internal static class IndexPolicyHandler
        ...
        private static void ApplyStreambackableAssertion
        (
            DefaultPolicyModule sender,
            PersistenceServicePolicy policy,
            ECPolicyContext context
        )
            {
        ...
        private static void ApplyUpdatableAssertion
        (
            DefaultPolicyModule sender,
            PersistenceServicePolicy policy,
            ECPolicyContext context
