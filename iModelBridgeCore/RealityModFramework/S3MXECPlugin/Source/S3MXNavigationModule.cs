...
namespace S3MX.Source
    ...
    public class S3MXNavigationModule : NavigationModule
        ...
        /// <returns></returns>
        public override NavNode GetNodeByMoniker
        (
        ...
        /// <param name="extendedParameters"></param>
        /// <returns></returns>
        public override NavNode GetParent
        (
            RepositoryConnection connection,
            NavNode ecNavNode,
            IExtendedParameters extendedParameters
        ...
        /// <param name="extendedParameters"></param>
        /// <returns></returns>
        public override string GetMonikerByNode
        (
            RepositoryConnection connection,
            NavNode navNode,
            IExtendedParameters extendedParameters
        ...
        /// <param name="extendedParameters"></param>
        /// <returns></returns>
        public override NavNode GetNodeFromKey
        (
            RepositoryConnection connection, 
            ECTypedKey key,
            IExtendedParameters extendedParameters
        ...
        /// <param name="extendedParameters"></param>
        /// <returns></returns>
        public override PageableContainer<NavNode> GetRootNodes 
        (
            RepositoryConnection connection,
            IExtendedParameters extendedParameters
        )
            ...
            s3mxBlobApi.CreateContainer("s3mx");
        ...
        /// <param name="extendedParameters"></param>
        /// <returns></returns>
        public override PageableContainer<NavNode> GetChildren 
        (
            RepositoryConnection connection,
            NavNode ecNavNode,
            int pageSize,
        ...
        private static string extractLastSegmentOfUri
        (
            string uri,
            char separator
        )
