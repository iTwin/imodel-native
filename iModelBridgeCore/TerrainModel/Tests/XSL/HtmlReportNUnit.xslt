										...
										<table cellpadding="1" class="subtitleText">
											<tbody>
												<tr>
													...
													<td><xsl:value-of select="./test-results/@date" />&#160;at&#160;<xsl:value-of select="./test-results/@time" /></td>
												</tr>
												<tr>
										...
										<table cellpadding="1">
											<tbody>
												...
												<tr>
													...
													<td>&#160;&#160;</td>
													<td align="right"><xsl:value-of select="sum(./test-results/@total)" /></td>
												</tr>
												<tr>
													<td>&#160;&#160;</td>
													<td align="right" class="heading">Failures:</td>
													<td>&#160;&#160;</td>
													<td align="right"><xsl:value-of select="count(//test-case[ @success = 'False' ])" /></td> <!--sum(./test-results/@failures)-->
												</tr>
												<tr>
													<td>&#160;&#160;</td>
													<td align="right" class="heading">Not run:</td>
													<td>&#160;&#160;</td>
													<td align="right"><xsl:value-of select="sum(./test-results/@not-run)" /></td>
												</tr>
												<tr>
													<td>&#160;&#160;</td>
	...
	<xsl:template name="suiteSummary">
		...
		<xsl:for-each select="//test-results">
			<xsl:call-template name="coverageDetail">
				...
				<xsl:with-param name="failures" select="count(//test-case[ @success = 'False' ])" /> <!--./@failures-->
				<xsl:with-param name="not-run" select="./@not-run" />
				<xsl:with-param name="time" select="./test-suite/@time" />
			</xsl:call-template>
		</xsl:for-each>
	</xsl:template>
