...
namespace Bentley.DTM.ElementTemplate
    {
    public class DisplayProperties : ElementTemplateExtenderPropertyProvider, ICanApplyProperties
        {
        public const string PREFIX_DISPLAY = "DisplaySourceFeatures";
        ...
        public const string PREFIX_THEMATICSDISPLAYED = "ThematicsDisplayed";
        ...
        public const string CATEGORY_DISPLAY = "DTMElementExtender_DisplaySettings";
        ...
        public override void AddProperties (Bentley.ECObjects.Schema.IECClass ecClass, Bentley.ECObjects.Instance.IECInstance category)
            {
                ...
                CreateBooleanProp(PREFIX_THEMATICSDISPLAYED, StringLocalizer.Instance.GetLocalizedString("Thematics"), ecClass, category, (int)PropertyPriority.Thematics);
        ...
        public void ApplyProperties (Bentley.DTM.Element.DTMElement elem, BECO.Instance.IECInstance templateInstance)
            ...
            if (!templateInstance[PREFIX_THEMATICSDISPLAYED].IsNull)
                elem.WantBanding = System.Convert.ToBoolean (templateInstance[PREFIX_THEMATICSDISPLAYED].IntValue);
            else
                elem.WantBanding = false;
        ...
        public override void CreateCategories (System.Collections.Hashtable categories)
            {
            m_category = BECO.UI.ECPropertyPane.CreateCategory (
                CATEGORY_DISPLAY,
                StringLocalizer.Instance.GetLocalizedString ("DisplaySourceFeatures"),
                StringLocalizer.Instance.GetLocalizedString("DisplaySourceFeatures"),
                BECO.UI.ECPropertyPane.CategorySortPriorityHigh - 100);
            categories.Add (CATEGORY_DISPLAY, m_category);
            }
        ...
        public override void IsActivated (BECO.Instance.IECInstance instance, List<BECO.Instance.IECPropertyValue> properties)
            ...
            propertyValue = instance[PREFIX_THEMATICSDISPLAYED];
            if (propertyValue != null)
                {
                propertyValue.IntValue = System.Convert.ToInt32 (false);
                properties.Add (propertyValue);
