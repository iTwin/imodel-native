//:>--------------------------------------------------------------------------------------+
//:>
//:>     $Source: ScalableTerrainModel/PrivateAPI/STMInternal/Storage/IDTMFeatureArray.hpp $
//:>
...
void IDTMFeatureArray<PointType, HeaderType>::Insert   (const_iterator  pi_Position,
    ...
    transform(pi_Begin, pi_End, BentleyApi::ImagePP::AccumulateIter(InsertedPointsQty), mem_fun_ref(&value_type::GetSize));
