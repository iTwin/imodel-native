//:>--------------------------------------------------------------------------------------+
//:>
//:>     $Source: ScalableTerrainModel/PrivateAPI/STMInternal/Storage/HPUCompositeArray.h $
//:>
...
//private:
    ...
    * @see          IDTMCompositeFacadeBase
    * @see          IDTMCompositeFacadeBaseWExtCopy
    * @see          BentleyApi::ImagePP::RandomAccessIteratorWithAutoReverseConst
    *
    * @bsiclass                                                  Raymond.Gauthier   5/2010
    +---------------+---------------+---------------+---------------+---------------+------*/
    template <bool IsConst = false>
    class Iterator : public BentleyApi::ImagePP::RandomAccessIteratorWithAutoReverseConst<Iterator<IsConst>,
        Iterator<!IsConst>,
        typename BentleyApi::ImagePP::ConstTriggerTrait<FacadeT, IsConst>::type>
        {
    public:
        typedef BentleyApi::ImagePP::RandomAccessIteratorWithAutoReverseConst<Iterator<IsConst>,
                                                                Iterator<!IsConst>,
                                                                typename BentleyApi::ImagePP::ConstTriggerTrait<FacadeT, IsConst>::type>
        ...
        //       See BentleyApi::ImagePP::RandomAccessIterator.
...
#include <STMInternal/Storage/HPUCompositeArray.hpp>
