/*--------------------------------------------------------------------------------------+
|
|     $Source: ScalableTerrainModel/STM/MrDTMPolicy.cpp $
|    $RCSfile: MrDTMPolicy.cpp,v $
|   $Revision: 1.5 $
...
#include <ScalableTerrainModel/Foundations/Message.h>
...
USING_NAMESPACE_BENTLEY_MRDTM_FOUNDATIONS
