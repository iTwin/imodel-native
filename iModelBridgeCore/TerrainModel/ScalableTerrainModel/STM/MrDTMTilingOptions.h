/*--------------------------------------------------------------------------------------+
|
|     $Source: ScalableTerrainModel/STM/MrDTMTilingOptions.h $
|    $RCSfile: MrDTMTilingOptions.h,v $
|   $Revision: 1.5 $
...
class MrDTMTilingOptionsBase
    ...
    public:     
        ...
        BENTLEYSTM_EXPORT MrDTMTilingOptionsBase();

        BENTLEYSTM_EXPORT virtual ~MrDTMTilingOptionsBase();
    };