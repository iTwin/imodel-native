//:>--------------------------------------------------------------------------------------+
//:>
//:>     $Source: ScalableTerrainModel/STM/MrDTMRelevanceDistribution.cpp $
//:>    $RCSfile: MrDTMRelevanceDistribution.cpp,v $
//:>   $Revision: 1.6 $
...
-----------------------------------------------------------------------------*/
template<class DATATYPE> DATATYPE MrDTMRelevanceDistribution<DATATYPE>::GetRelevancePercentileValue(double pi_percentage)
    {
...
-----------------------------------------------------------------------------*/
template<class DATATYPE> double MrDTMRelevanceDistribution<DATATYPE>::GetRelevancePercentile(DATATYPE pi_relevanceValue, 
                                                                                             bool     pi_inPercent)
    {        
    double   percentile;        
...
template<class DATATYPE> DATATYPE MrDTMRelevanceDistribution<DATATYPE>::GetRelevanceMean() const
    {
    DATATYPE mean = 0;
...
template<class DATATYPE> DATATYPE MrDTMRelevanceDistribution<DATATYPE>::GetRelevanceStdDev() const
    {
...
template class MrDTMRelevanceDistribution<double>;
