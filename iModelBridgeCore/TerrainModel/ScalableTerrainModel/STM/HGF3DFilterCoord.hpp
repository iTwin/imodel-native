...
// in text format
//-----------------------------------------------------------------------------
inline void HGF3DCoord<Int32>::PrintState(ostream& po_rOutput) const
{
#ifdef __HMR_PRINTSTATE
    char	DumString[256];
    sprintf(DumString, "Object is a HGF3DCoord<Int32> X = %15d , Y = %15d , Z = %15d", m_XValue, m_YValue, m_ZValue);
    HDUMP0(DumString);
    HDUMP0("\n");
    po_rOutput << DumString << endl;
#endif
...
// in text format
//-----------------------------------------------------------------------------
inline void HGF3DCoord<UInt32>::PrintState(ostream& po_rOutput) const
{
#ifdef __HMR_PRINTSTATE
    char	DumString[256];
    sprintf(DumString, "Object is a HGF3DCoord<UInt32> X = %15u , Y = %15u , Z = %15u", m_XValue, m_YValue, m_ZValue);
    HDUMP0(DumString);
    HDUMP0("\n");
    po_rOutput << DumString << endl;
#endif
