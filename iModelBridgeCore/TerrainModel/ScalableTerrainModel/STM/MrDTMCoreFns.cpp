/*--------------------------------------------------------------------------------------+
|
|     $Source: ScalableTerrainModel/STM/MrDTMCoreFns.cpp $
|    $RCSfile: MrDTMCoreFns.cpp,v $
|   $Revision: 1.40 $
...
/*----------------------------------------------------------------------+
|                                                                       |
|   MrDTMFileCreator.cpp                        (C) Copyright 2001.     |
|                                               BCIVIL Corporation.     |
|                                               All Rights Reserved.    |
|                                                                       |
+----------------------------------------------------------------------*/
...
*/
 ...
 if( mrDtmFP == NULL )
   {
    bcdtmWrite_message(1,0,0,"Cannot Open MrDTM File %s",xyzFileNameP) ;
    goto errexit ;
   }
/*
...
*/
 if( dbg ) bcdtmWrite_message(0,0,0,"Reading Tiles Filtering And Writing Tiles To MrDTM") ;
 for( tofsP = tileOffsetsP ; tofsP < tileOffsetsP + numTiles ; ++tofsP )
   {
...
*/
    ...
    if( bcdtmFwrite(tilePointsP,sizeof(DPoint3d),(tileIndexP+tofsP->tileNumber)->numPoints,mrDtmFP) != (tileIndexP+tofsP->tileNumber)->numPoints )
      {
       bcdtmWrite_message(1,0,0,"Error Writing MrDTM File") ;
       goto errexit ;
      }
    fileWritePosition = _ftelli64(mrDtmFP) ;
/*
...
**  Update MrDTM File
*/
    if( dbg ) bcdtmWrite_message(0,0,0,"Updating MrDTM File") ;
...
/*
**     Write Updated Resolution Points Index To MrDTM File
*/
       ...
       if( bcdtmFwrite(tileOffsetsP+filt1P->tileNumber,sizeof(BC_MRES2_TILE_FILE_OFFSETS),1,mrDtmFP) != 1 )  
         {
          bcdtmWrite_message(0,0,0,"Error Writing MrDTM File") ;
          goto errexit ;
         }  
/*
