...
template<class POINT, class EXTENT> void MrDTMQuadTreeBCLIBProgressiveGlobalFilter<POINT, EXTENT>::InitRelevanceDistribution(ULong32 pi_nbBins, 
    ...
    for (int passInd = 0; passInd < pi_nbPasses; passInd++)
        {        
        m_pRelevanceDistributions.push_back(new MrDTMRelevanceDistribution<double>(pi_nbBins, 
                                                                                   pi_minRelevance, 
                                                                                   pi_maxRelevance));    
        }
    }
...
template<class POINT, class EXTENT> MrDTMQuadTreeBCLIBProgressiveGlobalFilter<POINT, EXTENT>::~MrDTMQuadTreeBCLIBProgressiveGlobalFilter()
    {
...
-----------------------------------------------------------------------------*/
template<class POINT, class EXTENT> bool MrDTMQuadTreeBCLIBProgressiveGlobalFilter<POINT, EXTENT>::Filter(
...
template<class POINT, class EXTENT> void MrDTMQuadTreeBCLIBProgressiveGlobalFilter<POINT, EXTENT>::FilterChildNode(HFCPtr<HGFPointIndexNode<POINT, EXTENT> > parentNode, 
...
-----------------------------------------------------------------------------*/
template<class POINT, class EXTENT> bool MrDTMQuadTreeBCLIBProgressiveGlobalFilter<POINT, EXTENT>::FilterLeaf (HFCPtr<HGFPointIndexNode<POINT, EXTENT> > outputNode, 
...
template<class POINT, class EXTENT> bool MrDTMQuadTreeBCLIBProgressiveGlobalFilter<POINT, EXTENT>::ComputeObjectRelevance(HFCPtr<HGFPointIndexNode<POINT, EXTENT> > outputNode) 
    {
...
/**----------------------------------------------------------------------------
 Indicates if the filtering is progressinve or not.
-----------------------------------------------------------------------------*/
template<class POINT, class EXTENT> bool MrDTMQuadTreeBCLIBProgressiveGlobalFilter<POINT, EXTENT>::IsProgressiveFilter() const
{
    return true;
}
...
// template class MrDTMQuadTreeBCLIBProgressiveGlobalFilter<HGF3DFilterCoord<double, double>, HGF2DTemplateExtent<double, HGF3DCoord<double>>>;
template class MrDTMQuadTreeBCLIBProgressiveGlobalFilter<HGF3DFilterCoord<double, double>, HGF3DExtent<double>>;

template class MrDTMQuadTreeBCLIBProgressiveGlobalFilter<IDTMFile::Point3d64fM64f, IDTMFile::Extent3d64f>;
