...
*/
    {
    int    ret = DTM_SUCCESS, dbg = DTM_TRACE_VALUE(0);
    ZeroSlopeTraceOption zeroSlopeOption = ZeroSlopeTraceOption::TraceLastAngle;                               // Trace At Last Angle Over Zero Slope Triangles
    long   trgPnt1 = 0, trgPnt2 = 0, trgPnt3 = 0, lowPnt1 = 0, lowPnt2 = 0, pointType = 0;
    ...
    */
    if (bcdtmMath_distance(startX, startY, pointAddrP(dtmP, trgPnt1)->x, pointAddrP(dtmP, trgPnt1)->y) <= dtmP->ppTol)
        {
        pointType = 1; trgPnt2 = trgPnt3 = dtmP->nullPnt;
        }
    if (trgPnt2 != dtmP->nullPnt) if (bcdtmMath_distance(startX, startY, pointAddrP(dtmP, trgPnt2)->x, pointAddrP(dtmP, trgPnt2)->y) <= dtmP->ppTol)
        {
        pointType = 1; trgPnt1 = trgPnt2; trgPnt2 = trgPnt3 = dtmP->nullPnt;
        }
    if (trgPnt3 != dtmP->nullPnt) if (bcdtmMath_distance(startX, startY, pointAddrP(dtmP, trgPnt3)->x, pointAddrP(dtmP, trgPnt3)->y) <= dtmP->ppTol)
        {
...
cleanup:
    ...
    */
    ...
    {
    long noTPtr = 0;
    bcdtmList_checkForNoneNullTptrValuesDtmObject(dtmP, &noTPtr);
...
*/
    {
    int    ret = DTM_SUCCESS, dbg = DTM_TRACE_VALUE(0);
    long   mp1, mp2, minp, onLine;
    bool  firstFound = true, edge1 = true, edge2 = true, edge3 = true;
    ...
    */
        ...
        if (edge1 == true)
            ...
            if (bcdtmMath_sideOf(startX, startY, xr, yr, pointAddrP(dtmP, pnt1)->x, pointAddrP(dtmP, pnt1)->y) < 0 &&
                ...
                bcdtmMath_sideOf(pointAddrP(dtmP, pnt1)->x, pointAddrP(dtmP, pnt1)->y, pointAddrP(dtmP, pnt2)->x, pointAddrP(dtmP, pnt2)->y, xr, yr) < 0)
                {
                mp1 = pnt1; mp2 = pnt2;
                }
            }
        if (edge2 == true)
            ...
            if (bcdtmMath_sideOf(startX, startY, xr, yr, pointAddrP(dtmP, pnt2)->x, pointAddrP(dtmP, pnt2)->y) < 0 &&
                ...
                bcdtmMath_sideOf(pointAddrP(dtmP, pnt2)->x, pointAddrP(dtmP, pnt2)->y, pointAddrP(dtmP, pnt3)->x, pointAddrP(dtmP, pnt3)->y, xr, yr) < 0)
                {
                mp1 = pnt2; mp2 = pnt3;
                }
            }
        if (edge3 == true)
            ...
            if (bcdtmMath_sideOf(startX, startY, xr, yr, pointAddrP(dtmP, pnt3)->x, pointAddrP(dtmP, pnt3)->y) < 0 &&
                ...
                bcdtmMath_sideOf(pointAddrP(dtmP, pnt3)->x, pointAddrP(dtmP, pnt3)->y, pointAddrP(dtmP, pnt1)->x, pointAddrP(dtmP, pnt1)->y, xr, yr) < 0)
                {
                mp1 = pnt3; mp2 = pnt1;
                }
            }
...
*/
    ...
    */
    ...
    if (mp1 != dtmP->nullPnt)
        ...
        if (startX <= xr)
            {
            minRadX = startX; maxRadX = xr;
            }
        else
            {
            minRadX = xr; maxRadX = startX;
            }
        if (startY <= yr)
            {
            minRadY = startX; maxRadY = yr;
            }
        else
            {
            minRadY = yr; maxRadY = startY;
            }
...
*/
    {
    int    ret = DTM_SUCCESS, dbg = DTM_TRACE_VALUE(0);
    long   mp1, mp2, minp = 0, onLine;
    bool  firstFound = true, zeroSlopeTriangle = false;
    ...
    */
    if (pointAddrP(dtmP, pnt1)->z == pointAddrP(dtmP, pnt2)->z && pointAddrP(dtmP, pnt1)->z == pointAddrP(dtmP, pnt3)->z) zeroSlopeTriangle = true;
...
(
    ...
    DTMFeatureCallback loadFunctionP,   // ==> Pointer To Load Function
    double falseLowDepth,               // ==> False Low Depth
    ZeroSlopeTraceOption zeroSlopeOption,             // ==> Zero Slope Option ( 1 == Trace At Last Angle , 2 == Create Pond )
...
*/
    ...
    long   lastPoint, exitPoint, priorPoint, nextPoint, numSumpLines = 0, hullFlag;
    bool process, isFalseLow, previousExit;
    ...
    */
    ...
    isFalseLow = false;
    if (falseLowDepth > 0.0) isFalseLow = true;
    if (zeroSlopeOption < ZeroSlopeTraceOption::TraceLastAngle || zeroSlopeOption > ZeroSlopeTraceOption::Pond) zeroSlopeOption = ZeroSlopeTraceOption::TraceLastAngle;
        ...
        if (trace)
            ...
            do
                ...
                if (pnt2 != dtmP->nullPnt)
                    {
                    if (bcdtmDrainage_traceMaximumDescentFromTriangleEdgeDtmObject(dtmP, drainageTablesP, zeroSlopeOption, isFalseLow, lastAngle, pnt1, pnt2, pnt3, startX, startY, &nextPnt1, &nextPnt2, &nextPnt3, &nextX, &nextY, &nextZ, &process, &exitPoint, &priorPoint, &nextPoint)) goto errexit;
                    }
                else
                    {
                    if (bcdtmDrainage_traceMaximumDescentFromTrianglePointDtmObject(dtmP, drainageTablesP, zeroSlopeOption, isFalseLow, lastAngle, lastPoint, pnt1, startX, startY, &nextPnt1, &nextPnt2, &nextPnt3, &nextX, &nextY, &nextZ, &process, &exitPoint, &priorPoint, &nextPoint)) goto errexit;
                    }
                ...
                if (/*pnt2 == dtmP->nullPnt && */nextPnt2 == dtmP->nullPnt && startZ == nextZ)
                    {
                    if (tracePoints.CheckForPriorTracePoint(nextPnt1))
                        process = false;
                    }
                ...
                if (process)
                    ...
                    startY = nextY;
                    startZ = nextZ;
                    if (startX == firstX && startY == firstY) process = false;
                    }
                else
                    {
                    ...
                    if (exitPoint != dtmP->nullPnt)
                        ...
                        if (loadFlag)
                            ...
                            if (savePnt2 == dtmP->nullPnt)
                                ...
                                if (nextPnt2 == dtmP->nullPnt && nextPnt3 == dtmP->nullPnt)
                                    {
                                    if (bcdtmDrainage_determinePondAboutLowPointDtmObject(dtmP, nullptr, nullptr, nullptr, loadFunctionP, savePnt1, true, false, &exitPoint, &priorPoint, &nextPoint, &polygonP, userP)) goto errexit;
                        ...
                        if (pointAddrP(dtmP, exitPoint)->z == startZ || (falseLowDepth > 0.0  && pointAddrP(dtmP, exitPoint)->z - startZ <= falseLowDepth))
                            ...
                            if (tracePoints.CheckForPriorExitPoint(exitPoint, dtmP->nullPnt)) previousExit = true;
                            if (tracePoints.StoreTracePoint(pointAddrP(dtmP, exitPoint)->x, pointAddrP(dtmP, exitPoint)->y, pointAddrP(dtmP, exitPoint)->z, exitPoint, dtmP->nullPnt)) goto errexit;
...
(
    BC_DTM_OBJ *dtmP,                   // ==> Pointer To Tin Object
    DTMDrainageTables *drainageTablesP, // ==> Pointer To Drainage Tables
    ZeroSlopeTraceOption zeroSlopeOption,             // ==> Zero Slope Option
    bool   isFalseLow,                  // ==> Is False Low Processing
    ...
    bool   *tracePointFoundP,           // <== Next Trace Point Found
...
*/
    ...
    double dx, dy, xRad, yRad, area, radius, descentAngle, ascentAngle, slope;
    ...
    *nextZP = 0.0;
    ...
    if (!hullLine)
        ...
        if (pointAddrP(dtmP, startPnt1)->z == pointAddrP(dtmP, startPnt2)->z  && pointAddrP(dtmP, startPnt1)->z == pointAddrP(dtmP, startPnt3)->z) zeroSlopeTriangle = true;
        ...
        if (zeroSlopeTriangle)
            ...
            if (zeroSlopeOption == ZeroSlopeTraceOption::TraceLastAngle)
                {
...
(
    ...
    */
    if (descentType == 0)
        ...
        if (!hullPoint)
            {
            if (drainageTablesP != nullptr && drainageTablesP->SizeOfLowPointPondTable() > 0)
                {
                ...
                *nextPointP = nextPnt;
                ...
                {
                if (bcdtmDrainage_determinePondAboutLowPointDtmObject(dtmP, drainageTablesP, nullptr, nullptr, nullptr, startPnt, false, false, exitPointP, priorPointP, nextPointP, &polygonP, nullptr)) goto errexit;
                }
            if (*exitPointP == dtmP->nullPnt)
                {
            ...
            *processP = true;
            ...
            if (drainageTablesP != nullptr && drainageTablesP->SizeOfZeroSlopeLinePondTable() > 0)
                ...
                *nextPointP = nextPnt;
                ...
                {
                if (bcdtmDrainage_determinePondAboutZeroSlopeSumpLineDtmObject(dtmP, drainageTablesP, nullptr, nullptr, startPnt, descentPnt1, false, false, exitPointP, priorPointP, nextPointP, &sumpLinesP, &numSumpLines, &polygonP, nullptr, &area)) goto errexit;
                if (sumpLinesP != nullptr)
                    {
                    free(sumpLinesP); sumpLinesP = nullptr;
                    }
    ...
    if (descentType == 2 && descentSlope == 0.0)
        ...
        if (zeroSlopeOption == ZeroSlopeTraceOption::TraceLastAngle)
            ...
            if (lastAngle == -99.99)
                ...
                bcdtmDrainage_findEdgeFromPointAndAngleDtmObject(dtmP, startPnt, lastAngle, descentPnt1, descentPnt2);
            ...
            if (pointAddrP(dtmP, startPnt)->z < *nextZP)
                {
                *processP = false;
...
errexit:
    ...
    |                                                                    |
    +-------------------------------------------------------------------*/
    int bcdtmDrainage_rangeScanPointForMaximumDescentSumpLineDtmObject
    (
        BC_DTM_OBJ *dtmP,               /* ==> Pointer To Tin Object                */
        DTMDrainageTables *drainageTablesP, // ==> Pointer To Drainage Tables
        long point,                      /* ==> Point To Scan About                  */
        long startPoint,                 /* ==> Scan Start Point                     */
        long endPoint,                   /* ==> Scan End Point                       */
        long *sumpPointP,                /* <== Sump Line End Point                  */
        double *sumpSlopeP               /* <== Sump Line Slope                      */
    )
        /*
        ...
        ** Scan Around Point For Sump Lines
        */
        if( startPoint != endPoint && nodeAddrP(dtmP,point)->cPtr != dtmP->nullPtr )
            {
            clkPnt  = startPoint ;
            if(( scanPnt = bcdtmList_nextAntDtmObject(dtmP,point,clkPnt))  < 0 ) goto errexit ;
            if(( antPnt  = bcdtmList_nextAntDtmObject(dtmP,point,scanPnt)) < 0 ) goto errexit ;
    ...
    |                                                                    |
    +-------------------------------------------------------------------*/
int  bcdtmDrainage_rangeScanPointForMaximumDescentTriangleDtmObject
    (
        BC_DTM_OBJ *dtmP,             /* ==> Pointer To Tin Object                */
        DTMDrainageTables *drainageTablesP,  // ==> Pointer To Drainage Tables
        long point,                    /* ==> Point To Scan About                  */
        ...
        /*
        ** This Function Rnage Scans The Triangles About A Point Looking For The Maximum Descent Triangle
        */
        {
        ...
        */
        clkPnt  = startPoint ;
        angleClkPnt = bcdtmMath_getPointAngleDtmObject(dtmP,point,clkPnt) ;
        while ( clkPnt != endPoint )
            {
            /*
            **  Get Next CCW Tin Point
            */
            if(( antPnt  = bcdtmList_nextAntDtmObject(dtmP,point,clkPnt)) < 0 ) goto errexit ;
            angleAntPnt = bcdtmMath_getPointAngleDtmObject(dtmP,point,antPnt) ;
            /*
            **  Check For Valid Triangle
            */
            if(  nodeAddrP(dtmP,point)->hPtr != antPnt )
                ...
                */
                if (bcdtmDrainage_getTriangleSlopeAndSlopeAnglesDtmObject(dtmP, drainageTablesP, point, antPnt, clkPnt, voidTriangle, slope, descentAngle, ascentAngle) != DTM_SUCCESS) goto errexit;
                /*
                **     Get Ascent Angle And Slope For Triangle
                */
                if( ! voidTriangle )
                    {
                    /*
...
|                                                                    |
+-------------------------------------------------------------------*/
int bcdtmDrainage_rangeScanPointForMaximumDescentDtmObject
    (
        BC_DTM_OBJ *dtmP,               /* ==> Pointer To Tin Object                */
        DTMDrainageTables *drainageTablesP, // ==> Pointer To Drainage Tables
        long point,                      /* ==> Point To Scan About                  */
        ...
        /*
        ** This Function Scans A Point In A CCW Direction From startPoint To endPoint For Maximum Descent
        */
        {
        int    ret=DTM_SUCCESS,dbg=0 ;
        long   sumpPnt,trgPnt1,trgPnt2 ;
        ...
        ** Write Entry Message
        */
        if( dbg ) bcdtmWrite_message(0,0,0,"Range Scanning Point For Maximum Descent") ;
        /*
        ** Initialise
        */
        *descentTypeP  = 0 ;
        ...
        **  Get Maximum Descent Sump Line
        */
        if( bcdtmDrainage_rangeScanPointForMaximumDescentSumpLineDtmObject(dtmP,drainageTablesP,point,startPoint,endPoint,&sumpPnt,&sumpSlope) ) goto errexit ;
        if( sumpPnt != dtmP->nullPnt ) sumpDescentAngle = bcdtmMath_getPointAngleDtmObject(dtmP,point,sumpPnt) ;
        /*
        **  Get Maximum Descent Triangle
        */
        if( bcdtmDrainage_rangeScanPointForMaximumDescentTriangleDtmObject(dtmP,drainageTablesP,point,startPoint,endPoint,&trgPnt1,&trgPnt2,&trgDescentAngle,&trgSlope) ) goto errexit ;
        /*
        ** Maximum Descent Down A Sump Line
        */
        if( sumpPnt != dtmP->nullPnt && trgPnt1 == dtmP->nullPnt )
    ...
    cleanup :
        ...
        ** Job Completed
        */
        if( dbg && ret == DTM_SUCCESS ) bcdtmWrite_message(0,0,0,"Range Scanning Point For Maximum Descent Completed") ;
        if( dbg && ret == DTM_SUCCESS ) bcdtmWrite_message(0,0,0,"Range Scanning Point For Maximum Descent Error") ;
        return(ret) ;
        /*
        ** Error Exit
        */
            ...
            */
            if (pointAddrP(dtmP, point)->z >= pointAddrP(dtmP, scanPnt)->z)
                ...
                if (lineType == DTMFeatureType::SumpLine)
                    ...
                    dd = sqrt(dx*dx + dy*dy);
                    slope = dz / dd;
                    if (*sumpPointP == dtmP->nullPnt)
                        {
                        *sumpPointP = scanPnt; *sumpSlopeP = slope;
                        }
                    else if (slope < *sumpSlopeP)
                        {
                        *sumpPointP = scanPnt; *sumpSlopeP = slope;
                        }
                    }
...
*/
    {
    int    ret = DTM_SUCCESS, dbg = DTM_TRACE_VALUE(0);
    long   trgPnt1 = 0, trgPnt2 = 0, trgPnt3 = 0, highPnt1 = 0, highPnt2 = 0, pointType = 0;
    bool pntInVoid = false;
    ZeroSlopeTraceOption traceOverZeroSlope = ZeroSlopeTraceOption::TraceLastAngle;
    long loadFlag = 1, startType = 3;
...
(
    ...
    DTMFeatureCallback loadFunctionP,              // ==> Pointer To Load Function
    double             falseHighElevation,         // ==> False High Elevation
    ZeroSlopeTraceOption traceOverZeroSlope,         // ==> Trace Over Zero Slopes
...
*/
    {
    int            ret = DTM_SUCCESS, dbg = DTM_TRACE_VALUE(0);
    long           nextPnt1, nextPnt2, nextPnt3, lastPoint, startPointType;
    bool           tracePointFound, isFalseHigh = false;
    double         firstX, firstY, firstZ, startX, startY, startZ, nextX, nextY, nextZ;
    ...
    */
    if (startPointType >= 1 && startPointType <= 3)
        ...
        */
        tracePointFound = true;
        while (tracePointFound)
            {
            if (dbg) bcdtmWrite_message(0, 0, 0, "Tracing To Next High Point From %10ld %10ld %10ld", pnt1, pnt2, pnt3);
            if (pnt2 != dtmP->nullPnt)
                {
                if (bcdtmDrainage_traceMaximumAscentFromTriangleEdgeDtmObject(dtmP, drainageTablesP, isFalseHigh, traceOverZeroSlope, lastAngle, pnt1, pnt2, pnt3, startX, startY, &nextPnt1, &nextPnt2, &nextPnt3, &nextX, &nextY, &nextZ, &tracePointFound)) goto errexit;
                }
            else
                {
                if (bcdtmDrainage_traceMaximumAscentFromTrianglePointDtmObject(dtmP, drainageTablesP, isFalseHigh, traceOverZeroSlope, lastAngle, lastPoint, pnt1, startX, startY, &nextPnt1, &nextPnt2, &nextPnt3, &nextX, &nextY, &nextZ, &tracePointFound)) goto errexit;
                }
            ...
            */
            if (tracePointFound && nextZ == startZ && nextPnt2 == dtmP->nullPnt)
                {
                if (streamPoints.CheckIfPointInCache(nextX, nextY, nextZ)) tracePointFound = false;
                }
            /*
            ...
            */
            if (tracePointFound)
                ...
                if (startX == firstX && startY == firstY) tracePointFound = false;
                }
            }
        }
    /*
...
(
    ...
    DTMDrainageTables *drainageTablesP,           // ==> Pointer To Drainage Tables
    long              isFalseHigh,
    ZeroSlopeTraceOption traceOverZeroSlope,
    double            lastAngle,
    long              pnt1,
    long              pnt2,
    long              pnt3,
    ...
    double            *nextYP,
    double            *nextZP,
    bool              *tracePointFoundP
)
    {
    int    ret = DTM_SUCCESS, dbg = DTM_TRACE_VALUE(0);
    long   hullLine, numAscentLines, edgeType, intPnt;
    double dx, dy, radX, radY, radius, descentAngle = 0.0, ascentAngle = 0.0, slope;
    int    sdof, flowDirection;
    DTM_ASCENT_LINE *ascentLinesP = nullptr;
    bool voidTriangle = false, zeroSlopeTriangle = false;
    /*
    ** Write Entry Message
    */
    if (dbg)
   ...
   */
            ...
            */
                ...
                */
                ...
                if (ascentLinesP != nullptr)
                    {
                    free(ascentLinesP); ascentLinesP = nullptr;
                    }
                }
            break;
        ...
        case  3:               // Zero Slope Triangle
            ...
            if (traceOverZeroSlope != ZeroSlopeTraceOption::None && lastAngle != DTM_2PYE) ascentAngle = lastAngle;
            else     break;
...
(
    ...
    ZeroSlopeTraceOption traceOverZeroSlope,           // ==> Trace Over Zero Slope
   ...
   */
    ...
    */
    ...
    if (ascentType && ascentSlope == 0.0 && traceOverZeroSlope == ZeroSlopeTraceOption::None) ascentType = 0;
    /*
...
(
    ...
    DTM_ASCENT_LINE *pnt1LinesP = nullptr, *pnt2LinesP = nullptr, *alineP;
    /*
    ** Write Entry Message
    */
    if (dbg)
    ...
    */
    *numAscentLinesP = 0;
    if (*ascentLinesPP != nullptr)
        {
        free(*ascentLinesPP);
        *ascentLinesPP = nullptr;
        }
    /*
    ...
    */
cleanup:
    if (pnt1LinesP != nullptr) free(pnt1LinesP);
    if (pnt2LinesP != nullptr) free(pnt2LinesP);
    /*
    ** Return
    */
...
(
    ...
    DTM_ASCENT_LINE *ridgeLinesP = nullptr, *ascentTrianglesP = nullptr, *alineP;
    /*
    ** Write Entry Message
    */
    if (dbg)
    ...
    *numAscentLinesP = 0;
    if (*ascentLinesPP != nullptr)
        {
        free(*ascentLinesPP); *ascentLinesPP = nullptr;
        }
    /*
    ...
    */
cleanup:
    if (ridgeLinesP != nullptr) free(ridgeLinesP);
    if (ascentTrianglesP != nullptr) free(ascentTrianglesP);
    /*
    ** Return
    */
...
*/
    ...
    *numAscentSumpLinesP = 0;
    if (*ascentSumpLinesPP != nullptr)
        {
        free(*ascentSumpLinesPP); *ascentSumpLinesPP = nullptr;
        }
    /*
    ** Scan Around Point For Ridge Lines
    */
                    ...
                    if (antFlow >= 0 && clkFlow >= 0 && (antFlow > 0 || clkFlow > 0))
                        ...
                        */
                        if (*numAscentSumpLinesP == memAscentSumpLines)
                            ...
                            if (*ascentSumpLinesPP == nullptr) *ascentSumpLinesPP = (DTM_ASCENT_LINE *)malloc(memAscentSumpLines * sizeof(DTM_ASCENT_LINE));
...
*/
    ...
    */
    *numRidgeLinesP = 0;
    if (*ridgeLinesPP != nullptr)
        {
        free(*ridgeLinesPP); *ridgeLinesPP = nullptr;
        }
    /*
    ** Scan Around Point For Ridge Lines
    */
                ...
                if ((!antVoid || !clkVoid) && (antFlow < 0 && clkFlow < 0))
                    ...
                    */
                    if (*numRidgeLinesP == memRidgeLines)
                        ...
                        if (*ridgeLinesPP == nullptr) *ridgeLinesPP = (DTM_ASCENT_LINE *)malloc(memRidgeLines * sizeof(DTM_ASCENT_LINE));
...
*/
    ...
    *numAscentTrianglesP = 0;
    if (*ascentTrianglesPP != nullptr)
        {
        free(*ascentTrianglesPP); *ascentTrianglesPP = nullptr;
        }
    /*
    ** Scan Around point
    */
                ...
                if (a2 <= a1 && a2 >= a3)
                    ...
                    */
                    if (*numAscentTrianglesP == memAscentTriangles)
                        ...
                        if (*ascentTrianglesPP == nullptr) *ascentTrianglesPP = (DTM_ASCENT_LINE *)malloc(memAscentTriangles * sizeof(DTM_ASCENT_LINE));
    ...
    */
    do
        ...
        */
        if (pnt2 != dtmP->nullPnt)
            {
            if (bcdtmDrainage_traceToSumpLineFromTriangleEdgeDtmObject(dtmP, lastAngle, pnt1, pnt2, pnt3, startX, startY, &nextPnt1, &nextPnt2, &nextPnt3, &nextX, &nextY, &nextZ, &process)) goto errexit;
            }
        else
            {
            if (bcdtmDrainage_traceToSumpLineFromTrianglePointDtmObject(dtmP, lastAngle, lastPoint, pnt1, startX, startY, &nextPnt1, &nextPnt2, &nextPnt3, &nextX, &nextY, &nextZ, &process)) goto errexit;
            }
...
(
    ...
    double dx, dy, dz, xRad, yRad, radius, descentAngle, ascentAngle, slope;
    bool   zeroSlopeTriangle;
    /*
   ** Write Entry Message
   */
        ...
        if (flowDirection < 0 || zeroSlopeTriangle)
            ...
            */
            if (sdof > 0)
                ...
                if (bcdtmMath_distance(pointAddrP(dtmP, startPnt3)->x, pointAddrP(dtmP, startPnt3)->y, *nextXP, *nextYP) <= dtmP->ppTol)
                    {
                    *nextPnt1P = startPnt3; *nextPnt2P = *nextPnt3P = dtmP->nullPnt;
                    }
                else if (bcdtmMath_distance(pointAddrP(dtmP, startPnt2)->x, pointAddrP(dtmP, startPnt2)->y, *nextXP, *nextYP) <= dtmP->ppTol)
                    {
                    *nextPnt1P = startPnt2; *nextPnt2P = *nextPnt3P = dtmP->nullPnt;
                    }
                else
                    {
            ...
            */
            if (sdof < 0)
                ...
                else if (bcdtmMath_distance(pointAddrP(dtmP, startPnt1)->x, pointAddrP(dtmP, startPnt1)->y, *nextXP, *nextYP) <= dtmP->ppTol)
                    {
                    *nextPnt1P = startPnt1; *nextPnt2P = *nextPnt3P = dtmP->nullPnt;
                    }
                else
                    {
...
(
    ...
    {
    int    ret = DTM_SUCCESS, dbg = DTM_TRACE_VALUE(0);
    long   pnt1, pnt2, clPtr, antPnt, clkPnt;
    bool voidTriangle;
    DTMFeatureType lineType;
...
(
    ...
    double falseLowDepth,                    // ==> False Low Depth
    ZeroSlopeTraceOption traceOverZeroSlope, // ==> Trace Over Zero slope Triangles
    double X,                                // ==> Start Trace Point X Coordinate
    double Y,                                // ==> Start Trace Point Y Coordinate
    double Z,                                // ==> Start Trace Point Z Coordinate
...
// Triangle Points pnt1-pnt2-pnt3 Must Be Set Anti Clockwise
    ...
    long   lastPoint, exitPoint, priorPoint, nextPoint, hullFlag;
    bool process, isFalseLow, previousExit;
    ...
    do
        ...
        */
        ...
        if (pnt2 != dtmP->nullPnt)
            {
            if (bcdtmDrainage_traceMaximumDescentFromTriangleEdgeDtmObject(dtmP, drainageTablesP, traceOverZeroSlope, isFalseLow, lastAngle, pnt1, pnt2, pnt3, startX, startY, &nextPnt1, &nextPnt2, &nextPnt3, &nextX, &nextY, &nextZ, &process, &exitPoint, &priorPoint, &nextPoint)) goto errexit;
            }
        else
            {
            if (bcdtmDrainage_traceMaximumDescentFromTrianglePointDtmObject(dtmP, drainageTablesP, traceOverZeroSlope, isFalseLow, lastAngle, lastPoint, pnt1, startX, startY, &nextPnt1, &nextPnt2, &nextPnt3, &nextX, &nextY, &nextZ, &process, &exitPoint, &priorPoint, &nextPoint)) goto errexit;
            }
