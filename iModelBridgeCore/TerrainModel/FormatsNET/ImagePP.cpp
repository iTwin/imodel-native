...
ImagePPConverter::ImagePPConverter (System::String^ filename)
    ...
    m_unmanaged->m_converter = Bentley::TerrainModel::ImagePPConverter::Create (p);
    }
...
Bentley::TerrainModelNET::DTM^ ImagePPConverter::ImportAndTriangulateImage (double imageScaleFactor, System::String^ projectionKey, double unitConversionFactor, double elevationScaleFactor)
    {
