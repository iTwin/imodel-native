...
static int _countTriangulatedPointsCallback(void*,long,DPoint3d*,CIVdtmtin*,ULong);
static int _countTriangulatedPoint(struct CIVdtmpnt*);
static int _sendTriangulatedPointsCallback(void*,long,DPoint3d*,CIVdtmtin*,ULong);
static int _sendTriangulatedPoint(struct CIVdtmpnt*);
static int _sendCircularListCallback(void*,long,DPoint3d*,CIVdtmtin*,ULong);
...
static ULong _curIndex = 0;
static ULong _numTriangulatedPoints = 0;
static ULong _numFeatures = 0;
