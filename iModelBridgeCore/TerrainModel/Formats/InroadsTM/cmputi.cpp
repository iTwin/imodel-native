...
typedef struct
{
    ...
    long                alc;
    int                 nStyleFlag;
    int                 (*pStyleFilterFunc)(GUID *, struct CIVdtmsrf *, int, BOOL *);
} ComponentListDat;
...
/*%-----------------------------------------------------------------------------
 ...
 DESC: Given a component GUID, this function returns a pointer to the
       corresponding component.
 HIST: Original - twl 21-Jul-2002
 MISC:
 KEYW: DTM FIND COMPONENT BY GUID
-----------------------------------------------------------------------------%*/
...
/*%-----------------------------------------------------------------------
 ...
 HIST: Original - twl 26-Apr-2002
 MISC:
 KEYW: DTM INDEX COMPONENTS BY GUID
-----------------------------------------------------------------------%*/
...
/*%-----------------------------------------------------------------------
 ...
 HIST: Original - twl 26-Apr-2002
 MISC:
 KEYW: DTM DESTROY INDEX COMPONENT GUID
-----------------------------------------------------------------------%*/
...
/*%-----------------------------------------------------------------------
 ...
 HIST: Original - twl 26-Apr-2002
 MISC:
 KEYW: DTM INSERT INDEX COMPONENT BY GUID
-----------------------------------------------------------------------%*/
...
/*%-----------------------------------------------------------------------
 ...
 HIST: Original - twl 26-Apr-2002
 MISC:
 KEYW: DTM REMOVE INDEX COMPONENT BY GUID
-----------------------------------------------------------------------%*/
