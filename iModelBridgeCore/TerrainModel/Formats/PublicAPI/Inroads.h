...
BENTLEYDTMFORMATS_EXPORT DTMStatusInt bcdtmFormatInroads_importTinFromDtmObject (BC_DTM_OBJ *dtmP, int (*tinStatsCallBackFunctionP) (long numRandomPoints,long numFeaturePoints,long numTriangles,long numFeatures), int (*tinRandomPointsCallBackFunctionP) (long pntIndex,double x,double y,double z), int (*tinFeaturePointsCallBackFunctionP) (long pntIndex,double x,double y,double z), int (*tinTrianglesCallBackFunctionP) (long trgIndex,long pntIndex1,long pntIndex2,long pntIndex3,long voidTriangle,long side1TrgIndex,long side2TrgIndex,long side3TrgIndex), int (*tinFeaturesCallBackFunctionP) (DTMFeatureType dtmFeatureType,Int64 dtmUsertag,Int64 dtmFeatureId,long *pointIndicesP,long numPointIndices)); 
                         ...
                         DTMStatusInt bcdtmFormatInroads_loadFeaturesFromDtmObject (BC_DTM_OBJ *dtmP, DTMFeatureId hullFeatureId, int (*loadFunctionP) (DTMFeatureType dtmFeatureType,Int64 dtmUsertag,Int64 dtmFeatureId,long *pointIndicesP,long numPointIndices));
