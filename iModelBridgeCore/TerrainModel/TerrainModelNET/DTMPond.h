...
public ref class DTMPondDesignCriteria
    ...
    private:
        ...
        double m_sideSlope;
        double m_freeBoard;
        DTMPondTarget m_pondTarget;
        DTMPondDesignMethod  m_designMethod;
    ...
    public:
		...
		DTMPondDesignCriteria()
            {
            // Set default params
			m_designMethod = DTMPondDesignMethod::BottomUp;
            m_sideSlope = 1.0;
            m_freeBoard = 0.0;
            m_pondTarget = DTMPondTarget::Volume;
		...
		DTMPondDesignCriteria(DTMPondDesignMethod perimeterOrInvert, array<BGEO::DPoint3d>^ perimerOrInvertPoints, double sideSlope, double freeBoard, DTMPondTarget pondTarget, double target,
			...
			if (pondTarget == DTMPondTarget::Volume)
        ...
        property DTMPondTarget PondTarget
            {
            DTMPondTarget get()
                {
                return m_pondTarget;
                }
            void set(DTMPondTarget value)
                {
                m_pondTarget = value;
                }
            }

        property DTMPondDesignMethod PondDesignMethod
            {
            DTMPondDesignMethod get()
                {
                return m_designMethod;
                }
            void set(DTMPondDesignMethod value)
                {
