...
if ($removeClash eq 1)
{
	...
	removeStringFromFile($distribDir."\\PointoolsVortexAPI-ReleaseNotes-2.0.0.203.txt", "clash");
	removeStringFromFile($distribDir."\\PointoolsVortexAPI-ReleaseNotes-2.0.0.203.txt", "IClashTree");
...
if ($removeClientServer eq 1)
{
	...
	removeStringFromFile($distribDir."\\PointoolsVortexAPI-ReleaseNotes-2.0.0.203.txt", "streaming");
