...
NVEB_EFFECT_EPILOG
    ...
    NVEB_EFFECT_EPILOG
#else
    #define cgCreateProgram __nvebCgCreateProgram
    NVEB_EFFECT_PROLOG
	    extern CGprogram __nvebCgCreateProgram(CGcontext, CGenum, const char *, CGprofile, const char *, const char **);
    NVEB_EFFECT_EPILOG

    #define cgCreateProgramFromFile __nvebCgCreateProgramFromFile
        NVEB_EFFECT_PROLOG
        extern CGprogram __nvebCgCreateProgramFromFile(CGcontext, CGenum, const char *, CGprofile, const char *, const char **);
    NVEB_EFFECT_EPILOG
#endif
