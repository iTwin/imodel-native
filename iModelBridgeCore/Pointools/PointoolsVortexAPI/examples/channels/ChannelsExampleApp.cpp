...
This Example
--------------------------
This example demonstrates the creation, updating and querying of user channels
...
#include "..\include\EditTool.h"		// Editing tools
#include "ChannelsTest.h"				// The user channels test code

// Main Entry Point
int main(int argc, char* argv[])
{
	VortexExampleApp example( std::string("User Channels Example") );
	...
	if (example.initializeApplication(argc, argv, false))
	{
		...
		example.addTool(new ChannelsTest);				// see code in ChannelsTest.cpp for implementation of user channel test
