...
#include "ClassifChannelTest.h"				// The user channels test code

// Main Entry Point
int main(int argc, char* argv[])
{
	VortexExampleApp example( std::string("Classification in User Channel Example") );
	...
	if (example.initializeApplication(argc, argv, false))
	{
		...
		example.addTool(new ClassifChannelTest);		// see code in ClassifChannelTest.cpp for implementation of user channel test
