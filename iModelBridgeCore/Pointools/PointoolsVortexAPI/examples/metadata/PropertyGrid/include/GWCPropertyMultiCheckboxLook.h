...
#ifndef __GWCPROPERTYMULTICHECKBOXLOOK_H
#define __GWCPROPERTYMULTICHECKBOXLOOK_H

#include "GWCPropertyLook.h"
#include "GWCPropertiesLink.h"

class GWCPROPCTRL_LINKAGE GWCPropertyMultiCheckboxLook : public GWCPropertyLook  
{
	// Construction
	public:
		GWCPropertyMultiCheckboxLook();
		virtual ~GWCPropertyMultiCheckboxLook();
...
#endif // __GWCPROPERTYMULTICHECKBOXLOOK_H
