...
L"OPTIONS:\n"
L"--input-gcs=gcsspec         (optional)  Specifies the GCS of the input DGN root model. Ignored if DGN root model already has a GCS. gcsspec must be in JSON format. See --output-gcs for details.\n"
...
L"                                        Typical format when the GCS is specified using a keyname is: \n"
L"                                            {\n"
L"                                                \"gcs\" : {\n"
L"                                                   \"coordinateSystemName\" : \"NAD27.BLM-16N.ft\",\n"
L"                                                   \"verticalDatum\" : \"NAVD88\"\n"
L"                                                 }\n"
L"                                            }\n"
L"                                        where the verticalDatum specification is optional but coordinateSystemName is not. Note that when passing the JSON on the command line it will look something like:\n"
L"                                        --output-gcs=\"{\\\"gcs\\\":{\\\"coordinateSystemKeyName\\\":\\\"NAD27.BLM-16N.ft\\\", \\\"verticalDatum\\\":\\\"NAVD88\\\"}}.\n"
L"                                        with internal quotes escaped and no lines.\n"
L"                                        Supported values for verticalDatum are: ELLIPSOID, GEOID, NGVD29 and NAVD88, the last two only valid if the geodetic datum of the coordinate \n"
L"                                        is NAD27 or NAD83 or one derivative or equivalent (HPGN, HARN, NSRS07, NAD83/2011,...)\n"
L"                                        Typical format for AZMEA (Azimuthal Equal Area) is:\n"
L"                                            {\n"
L"                                                \"gcs\" : {\n"
L"                                                   \"azmea\" : {\n"
L"                                                      \"azimuthAngle\" : 123.2\n"
L"                                                      \"geoPoint\" : {\n"
L"                                                          \"latitude\": 46.48\n"
L"                                                          \"longitude\": 71.24\n"
L"                                                          \"elevation\": 0.0\n"
L"                                                        }\n"
L"                                                     },\n"
L"                                                   \"verticalDatum\" : \"GEOID\"\n"
L"                                                 }\n"
L"                                            }\n"
L"                                        The AZMEA gcs is always based on the WGS84 geodetic datum.\n"
L"                                        The gcs definition can also contain the gcsCalculationMethod property set to string values: default, reproject, transform and transformscaled.\n"
L"                                        These indicate how the coordinate convertions should be performed either using a linear approximation (with or without scale application) or fully reprojected.\n"
