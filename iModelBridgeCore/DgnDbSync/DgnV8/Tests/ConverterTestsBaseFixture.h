...
struct ConverterTestBaseFixture : public testing::Test
    ...
    void DoUpdate(BentleyApi::BeFileNameCR output, BentleyApi::BeFileNameCR input, bool expectFailure = false, bool expectUpdate = true, bool doDetectDeletedDocuments = false, bool onAllDocsProcessed = false, bool expectedInitRootModelFailure = false);
