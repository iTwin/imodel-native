...
TEST_F(DgnMaterialTests, MaterialAttachment)
    ...
    RenderMaterialId materialId = RenderMaterial::QueryMaterialId(m_params.GetMergeDefinitions()? db->GetDictionaryModel(): *GetJobDefinitionModel(*db), "SavedPalette", "Material35");
