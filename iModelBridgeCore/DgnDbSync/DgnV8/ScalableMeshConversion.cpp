...
ConvertToDgnDbElementExtension::Result ConvertScalableMeshAttachment::_PreConvertElement(DgnV8EhCR v8el, Converter& converter, ResolvedModelMapping const& v8mm)
    {
    DgnV8Api::ElementHandle::XAttributeIter xai(v8el, DgnV8Api::XAttributeHandlerId(ScalableMeshElementHandler::XATTRIBUTEID_ScalableMeshAttachment, 0), 0);
    if (!xai.IsValid())
    ...
    for (UInt32 index=0; true; index++)
        {
        DgnV8Api::ElementHandle::XAttributeIter xai(v8el, DgnV8Api::XAttributeHandlerId(ScalableMeshElementHandler::XATTRIBUTEID_ScalableMeshAttachment, (int) MRMeshMinorXAttributeId_Clip), index);
    ...
    for (UInt32 index=0; true; index++)
        {
        DgnV8Api::ElementHandle::XAttributeIter xai(v8el, DgnV8Api::XAttributeHandlerId(ScalableMeshElementHandler::XATTRIBUTEID_ScalableMeshAttachment, (int)MRMeshMinorXAttributeId_ClipElement), index);
