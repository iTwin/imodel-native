...
// define DwgDb runtime objects as pseudo-database objects
DWGDB_PSEUDO_DEFINE_MEMBERS(SymbolTable)
DWGDB_PSEUDO_DEFINE_MEMBERS(SymbolTableRecord)
DWGDB_PSEUDO_DEFINE_MEMBERS(BlockTable)
DWGDB_PSEUDO_DEFINE_MEMBERS(BlockTableRecord)
DWGDB_PSEUDO_DEFINE_MEMBERS(LayerTable)
DWGDB_PSEUDO_DEFINE_MEMBERS(LayerTableRecord)
DWGDB_PSEUDO_DEFINE_MEMBERS(LinetypeTable)
DWGDB_PSEUDO_DEFINE_MEMBERS(LinetypeTableRecord)
DWGDB_PSEUDO_DEFINE_MEMBERS(ViewportTable)
DWGDB_PSEUDO_DEFINE_MEMBERS(ViewportTableRecord)
DWGDB_PSEUDO_DEFINE_MEMBERS(TextStyleTable)
DWGDB_PSEUDO_DEFINE_MEMBERS(TextStyleTableRecord)
DWGDB_PSEUDO_DEFINE_MEMBERS(RegAppTable)
DWGDB_PSEUDO_DEFINE_MEMBERS(RegAppTableRecord)

// define common DbObject methods
DWGDB_OBJECT_DEFINE_MEMBERS(SymbolTable)
DWGDB_OBJECT_DEFINE_MEMBERS(SymbolTableRecord)
DWGDB_OBJECT_DEFINE_MEMBERS(BlockTable)
DWGDB_OBJECT_DEFINE_MEMBERS(BlockTableRecord)
DWGDB_OBJECT_DEFINE_MEMBERS(LayerTable)
DWGDB_OBJECT_DEFINE_MEMBERS(LayerTableRecord)
DWGDB_OBJECT_DEFINE_MEMBERS(LinetypeTable)
DWGDB_OBJECT_DEFINE_MEMBERS(LinetypeTableRecord)
DWGDB_OBJECT_DEFINE_MEMBERS(ViewportTable)
DWGDB_OBJECT_DEFINE_MEMBERS(ViewportTableRecord)
DWGDB_OBJECT_DEFINE_MEMBERS(TextStyleTable)
DWGDB_OBJECT_DEFINE_MEMBERS(TextStyleTableRecord)
DWGDB_OBJECT_DEFINE_MEMBERS(RegAppTable)
DWGDB_OBJECT_DEFINE_MEMBERS(RegAppTableRecord)

// define SmartPtr members
DWGDB_DEFINE_SMARTPTR_MEMBERS(SymbolTable)
DWGDB_DEFINE_SMARTPTR_MEMBERS(SymbolTableRecord)
DWGDB_DEFINE_SMARTPTR_MEMBERS(BlockTable)
DWGDB_DEFINE_SMARTPTR_MEMBERS(BlockTableRecord)
DWGDB_DEFINE_SMARTPTR_MEMBERS(LayerTable)
DWGDB_DEFINE_SMARTPTR_MEMBERS(LayerTableRecord)
DWGDB_DEFINE_SMARTPTR_MEMBERS(LinetypeTable)
DWGDB_DEFINE_SMARTPTR_MEMBERS(LinetypeTableRecord)
DWGDB_DEFINE_SMARTPTR_MEMBERS(ViewportTable)
DWGDB_DEFINE_SMARTPTR_MEMBERS(ViewportTableRecord)
DWGDB_DEFINE_SMARTPTR_MEMBERS(TextStyleTable)
DWGDB_DEFINE_SMARTPTR_MEMBERS(TextStyleTableRecord)
...
DWGDB_DEFINE_SYMBOLTABLERECORD_GETNAME(BlockTableRecord)
DWGDB_DEFINE_SYMBOLTABLERECORD_GETNAME(LayerTableRecord)
DWGDB_DEFINE_SYMBOLTABLERECORD_GETNAME(LinetypeTableRecord)
DWGDB_DEFINE_SYMBOLTABLERECORD_GETNAME(ViewportTableRecord)
DWGDB_DEFINE_SYMBOLTABLERECORD_GETNAME(TextStyleTableRecord)
DWGDB_DEFINE_SYMBOLTABLERECORD_GETNAME(RegAppTableRecord)
