...
public:
    ...
    virtual BentleyStatus _FinalizeChanges(DgnDbR) {return BSISUCCESS;}
    ...
    virtual void _AdjustProjectExtents(AxisAlignedBox3dR extents, DRange3dCR rangeWithOutliers, DgnDbR) {}
