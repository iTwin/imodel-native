...
public:
    ...
    BentleyStatus  WriteProvenanceAspect(DgnElementR, SyncInfo::ElementProvenanceAspectData const&);
    ...
    DgnDbStatus InsertResults(ElementConversionResults&, SyncInfo::ElementProvenanceAspectData const&);
    DgnDbStatus UpdateResultsForOneElement(ElementConversionResults&, DgnElementId existingElementId, SyncInfo::ElementProvenanceAspectData const&);
    DgnDbStatus UpdateResultsForChildren(ElementConversionResults&, SyncInfo::ElementProvenanceAspectData const&);
    DgnDbStatus UpdateResults(ElementConversionResults&, DgnElementId existingElementId, SyncInfo::ElementProvenanceAspectData const&);
