...
// Edition by Block
//-----------------------------------------------------------------------------
HSTATUS HRFFliLineEditor::ReadBlock(uint32_t              pi_PosBlockX,
    ...
    HASSERT(DataSize == (pi_PosBlockX*pi_PosBlockY));
...
// Edition by Block
//-----------------------------------------------------------------------------
HSTATUS HRFFliLineEditor::WriteBlock(uint32_t              pi_PosBlockX,
                                     uint32_t              pi_PosBlockY,
                                     const Byte*          pi_pData,
                                     HFCLockMonitor const* pi_pSisterFileLock)
    {
