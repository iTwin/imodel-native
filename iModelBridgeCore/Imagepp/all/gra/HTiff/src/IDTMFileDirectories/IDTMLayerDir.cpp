//:>--------------------------------------------------------------------------------------+
//:>
//:>     $Source: all/gra/HTiff/src/IDTMFileDirectories/IDTMLayerDir.cpp $
//:>
...
HCPWKT LayerDir::GetWkt () const
    {
    WCharP pUnicodeWkt = L"";
    AttributeMgr().Get(IDTM_ATTRIBUTEID_LAYERDIR_WKT_SPATIAL_REFERENCE_SYSTEM, pUnicodeWkt);
