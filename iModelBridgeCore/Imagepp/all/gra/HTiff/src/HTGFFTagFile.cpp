//:>--------------------------------------------------------------------------------------+
//:>
//:>     $Source: all/gra/HTiff/src/HTGFFTagFile.cpp $
//:>
...
#include <ImagePP/all/h/HTGFFPacketIdIter.h>
...
bool TagFile::AddSubDirToListing (DirectoryID pi_DirectoryID)
    ...
    ImagePP::expandCopyBuffer(pSubDirListingBegin, SubDirListingCapacity, pNewDirectoryIds, NewDirectoryIdQty, DirectoryID(0));
...
TagFile::DirectoryID TagFile::AddSubDir   (DirectoryTagID  pi_SubDirsTagID,
    ...
    ImagePP::expandCopyBuffer(pDirectoryIds, DirectoryQty, pNewDirectoryIds, NewDirectoryIdQty, DirectoryID(0));
...
void TagFile::ReallocDataPacketIndex (size_t pi_PacketQty)
    ...
    ImagePP::expandCopyBuffer(pOldOffsetsData, OldOffsetsBufferSize, pNewOffsetsData, NewBufferSize);
    ...
    ImagePP::expandCopyBuffer(pOldByteCountsData, OldByteCountsBufferSize, pNewByteCountsData, NewBufferSize);
