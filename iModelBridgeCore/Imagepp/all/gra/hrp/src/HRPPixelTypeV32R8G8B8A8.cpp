...
int16_t ConverterV32R8G8B8A8_I8R8G8B8::m_LostChannels[] = {3, -1};
...
int16_t ConverterV32R8G8B8A8_V24B8G8R8::m_LostChannels[] = {3, -1};
...
int16_t ConverterV32R8G8B8A8_V24R8G8B8::m_LostChannels[] = {3, -1};
...
/** -----------------------------------------------------------------------------
    ...
    -----------------------------------------------------------------------------
 */
uint16_t HRPPixelTypeV32R8G8B8A8::CountValueBits() const
    {
    return 32;
    }
