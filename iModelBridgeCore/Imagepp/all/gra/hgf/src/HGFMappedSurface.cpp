...
// Constructor
//-----------------------------------------------------------------------------
HGFMappedSurface::HGFMappedSurface(HGSSurfaceImplementation*    pi_pImplementation,
                                   const HFCPtr<HGF2DCoordSys>& pi_rpRefCoordSys)
    : HGSSurface(pi_pImplementation)
    {
...
HGFMappedSurface::HGFMappedSurface(const HFCPtr<HGSSurfaceDescriptor>&  pi_rpDescriptor,
                                   ...
                                   const HFCPtr<HGF2DCoordSys>&         pi_rpRefCoordSys)
    : HGSSurface(pi_rpDescriptor, pi_pToolbox, pi_pCapabilities)
    {
    InitObject(pi_rpRefCoordSys);
    }
