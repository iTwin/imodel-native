//:>--------------------------------------------------------------------------------------+
//:>
//:>     $Source: PublicApi/ImagePP/all/h/HTGFFPacketIter.h $
//:>
...
+---------------+---------------+---------------+---------------+---------------+------*/
template <typename EditorT>
class PacketIter : public ImagePP::BidirectionalIteratorWithAutoReverseConst<PacketIter<EditorT>,
                                                                            PacketIter<typename ImagePP::ReverseConstTrait<EditorT>::type>,
                                                                            EditorT>
    {
public: 
    typedef ImagePP::BidirectionalIteratorWithAutoReverseConst<PacketIter<EditorT>,
                                                                PacketIter<typename ImagePP::ReverseConstTrait<EditorT>::type>,
                                                                EditorT>
    ...
    typedef typename ImagePP::RemoveConst<typename EditorT::base_type>::type 
                            editor_base_type;

    typename ImagePP::RemoveConst<EditorT>::type           
                            m_editor;
...
#include <Imagepp/all/h/HTGFFPacketIter.hpp>
