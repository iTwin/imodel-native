...
#include "HRFIntergraphRGBCompressFile.h"
...
#if defined(IPP_HAVE_ERMAPPER_SUPPORT)  && defined(__IPP_EXTERNAL_THIRD_PARTY_SUPPORTED)      
...
#if defined(IPP_HAVE_MRSID_SUPPORT) && defined(__IPP_EXTERNAL_THIRD_PARTY_SUPPORTED)
...
#if !defined(PROJECTWISE_FILE_FORMATS) && !defined(IPPSTATICLIB_FILE_FORMATS) && defined(__IPP_EXTERNAL_THIRD_PARTY_SUPPORTED)
...
#if !defined(PROJECTWISE_FILE_FORMATS) && !defined(BENTLEYPUBLISHER_FILE_FORMATS) && !defined(IPPSTATICLIB_FILE_FORMATS)
...
#   if !defined(BENTLEYPUBLISHER_FILE_FORMATS) && !defined(PROJECTWISE_FILE_FORMATS) && !defined(IPPSTATICLIB_FILE_FORMATS)
...
#define REGISTER_SUPPORTED_FILEFORMAT            \
    ...
    HOST_REGISTER_FILEFORMAT(HRFIntergraphRGBCompressCreator)\
    ...
    HOST_REGISTER_FILEFORMAT(HRFPWCreator)              \
