...
public:
    ...
    HDECLARE_CLASS_ID(1366, HRFRasterFile)

    friend class HRFxChEditor;

    _HDLLg                         HRFxChFile       (const HFCPtr<HFCURL>& pi_rpURL,
                                                     HFCAccessMode         pi_AccessMode = HFC_READ_ONLY,
                                                     uint64_t              pi_Offset = 0);

    _HDLLg                         HRFxChFile         (const HFCPtr<HFCURL>& pi_rpRedFileURL,
                                                       const HFCPtr<HFCURL>& pi_rpGreenFileURL,
                                                       const HFCPtr<HFCURL>& pi_rpBlueFileURL,
                                                       const HFCPtr<HFCURL>& pi_rpAlphaFileURL = 0);

    _HDLLg virtual                 ~HRFxChFile               ();
...
private:
    HFC_DECLARE_SINGLETON_DLL(_HDLLg, HRFxChCreator)
