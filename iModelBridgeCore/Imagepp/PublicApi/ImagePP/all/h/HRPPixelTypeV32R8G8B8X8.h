...
class HRPPixelTypeV32R8G8B8X8 : public HRPPixelTypeRGB
    {
    HPM_DECLARE_CLASS_DLL(_HDLLg,  1286)

public:
    // Primary methods
    _HDLLg                 HRPPixelTypeV32R8G8B8X8();
    _HDLLg                 HRPPixelTypeV32R8G8B8X8(const HRPPixelTypeV32R8G8B8X8& pi_rObj);

    _HDLLg virtual         ~HRPPixelTypeV32R8G8B8X8();
