//:>--------------------------------------------------------------------------------------+
//:>
//:>     $Source: PublicApi/ImagePP/all/h/HPUCompositeArray.h $
//:>
...
//private:
    ...
    * @see          IDTMCompositeFacadeBase
    * @see          IDTMCompositeFacadeBaseWExtCopy
    * @see          ImagePP::RandomAccessIteratorWithAutoReverseConst
    *
    * @bsiclass                                                  Raymond.Gauthier   5/2010
    +---------------+---------------+---------------+---------------+---------------+------*/
    template <bool IsConst = false>
    class Iterator : public ImagePP::RandomAccessIteratorWithAutoReverseConst<Iterator<IsConst>,
        Iterator<!IsConst>,
        typename ImagePP::ConstTriggerTrait<FacadeT, IsConst>::type>
        {
    public:
        typedef ImagePP::RandomAccessIteratorWithAutoReverseConst<Iterator<IsConst>,
                                                                Iterator<!IsConst>,
                                                                typename ImagePP::ConstTriggerTrait<FacadeT, IsConst>::type>
...
public:
    ...
    const_iterator Begin () const
        {
        return const_iterator((m_HeaderArray.Begin()), (ReinterpretAsDerived()));   //TDORay
        }
    const_iterator End () const
        {   
        return const_iterator((m_HeaderArray.End()), (ReinterpretAsDerived()));     //TDORay
        }
...
#include <ImagePP/all/h/HPUCompositeArray.hpp>
