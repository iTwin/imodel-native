...
public:
    ...
    virtual HRABitmapEditor* CreateEditor   (HFCAccessMode pi_Mode) override;

    virtual HRABitmapEditor* CreateEditor   (const HVEShape& pi_rShape, HFCAccessMode pi_Mode) override;

    virtual HRABitmapEditor* CreateEditor   (const HGFScanLines& pi_rShape, HFCAccessMode pi_Mode) override;

    virtual HRABitmapEditor* CreateEditorUnShaped (HFCAccessMode pi_Mode) override;
