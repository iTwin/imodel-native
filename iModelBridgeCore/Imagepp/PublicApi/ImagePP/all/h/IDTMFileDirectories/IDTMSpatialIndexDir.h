//:>--------------------------------------------------------------------------------------+
//:>
//:>     $Source: PublicApi/ImagePP/all/h/IDTMFileDirectories/IDTMSpatialIndexDir.h $
//:>
...
public:
    ...
    _HDLLg SpatialIndexType     GetType                            () const;


    _HDLLg const Extent3d64f&   GetContentExtent                   () const;
