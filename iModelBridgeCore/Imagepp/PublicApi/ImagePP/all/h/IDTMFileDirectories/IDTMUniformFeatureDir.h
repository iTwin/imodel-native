//:>--------------------------------------------------------------------------------------+
//:>
//:>     $Source: PublicApi/ImagePP/all/h/IDTMFileDirectories/IDTMUniformFeatureDir.h $
//:>
...
public:
    struct Options : public UserOptions
        {
        _HDLLg explicit             Options                            (bool                        pi_PointOnly);
    ...
    _HDLLg FeatureType              GetFeatureType                     () const;
    ...
    * Direct access to underlying point directory.
    ...
    _HDLLg static UniformFeatureDir*
