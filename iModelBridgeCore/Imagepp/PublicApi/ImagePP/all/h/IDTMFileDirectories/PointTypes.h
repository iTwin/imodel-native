//:>--------------------------------------------------------------------------------------+
//:>
//:>     $Source: PublicApi/ImagePP/all/h/IDTMFileDirectories/PointTypes.h $
//:>
...
_HDLLg bool                                 operator==             (const Point2d64f&           lhs,
...
_HDLLg bool                                 operator==             (const Point2d64fR8G8B8I8&   lhs,
...
_HDLLg bool                                 operator==             (const Point2d64fG32&        lhs,
...
_HDLLg bool                                 operator==             (const Point3d64f&           lhs,
...
_HDLLg bool                                 operator==             (const Point3d64fR8G8B8I8&   lhs,
...
_HDLLg bool                                 operator==             (const Point3d64fG32&        lhs,
...
_HDLLg bool                                 operator==             (const Point3d64fM64f&       lhs,
...
_HDLLg bool                                 operator==             (const Point3d64fM64fG32&    lhs,
...
_HDLLg bool                             Point2dEqual               (double lx, double ly,
                                                                    double rx, double ry);

_HDLLg bool                             Point2dLess                (double lx, double ly,
                                                                    double rx, double ry);

_HDLLg bool                             Point3dEqual               (double lx, double ly, double lz,
                                                                    double rx, double ry, double rz);

_HDLLg bool                             Point3dLess                (double lx, double ly, double lz,
                                                                    double rx, double ry, double rz);
...
#include <Imagepp/all/h/IDTMFileDirectories/PointTypes.hpp>
