//:>--------------------------------------------------------------------------------------+
//:>
//:>     $Source: PublicApi/ImagePP/all/h/hgfspatialindex.h $
//:>
...
template<class DataType> class CopyVector<HFCPtr<HPMStoredPooledVector<DataType> > >
    {
public:
    static void Copy(HFCPtr<HPMStoredPooledVector<DataType> > destination, HFCPtr<HPMPooledVector<DataType> > source)
        {
        destination->push_back(source);
        }
    };
...
public:
    ...
    const EXTENT& GetNodeExtent() const;
        const EXTENT& GetExtent() const {return GetNodeExtent();}
        return GetNodeExtent();
        }
