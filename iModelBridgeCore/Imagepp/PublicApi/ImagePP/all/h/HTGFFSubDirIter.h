//:>--------------------------------------------------------------------------------------+
//:>
//:>     $Source: PublicApi/ImagePP/all/h/HTGFFSubDirIter.h $
//:>
...
#include <ImagePP/all/h/HTGFFSubDirManager.h> // NTERAY: Try to uncouple from this? If SubDirManagerBase came as a separate header, it could be done.
...
+---------------+---------------+---------------+---------------+---------------+------*/
template <typename EditorT>
class SubDirIter : public ImagePP::BidirectionalIteratorWithAutoReverseConst<SubDirIter<EditorT>,
                                                                             SubDirIter<typename ImagePP::ReverseConstTrait<EditorT>::type>,
                                                                             EditorT>
    {
public:
...
#include <ImagePP/all/h/HTGFFSubDirIter.hpp>
