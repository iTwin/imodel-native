...
class HGF2DPolygonOfSegments : public HGF2DSimpleShape
    ...
    HDECLARE_CLASS_ID(8304, HGF2DSimpleShape)
...
public:
    ...
    */
    ...
    _HDLLg                      HGF2DPolygonOfSegments(const HGF2DPolySegment& pi_rPolySegment);
    HGF2DPolygonOfSegments(const HGF2DRectangle& pi_rRectangle);
    _HDLLg                      HGF2DPolygonOfSegments(size_t  pi_BufferLength,
                                                  double pi_aBuffer[]);
    _HDLLg                      HGF2DPolygonOfSegments(const HGF2DPolygonOfSegments&   pi_rObject);
    _HDLLg virtual              ~HGF2DPolygonOfSegments();
    ...
    // Setting
//    _HDLLg virtual void       SetLinear(const HGF2DLinear& pi_rLinear);

    // Simplification
    _HDLLg HGF2DRectangle*      GenerateCorrespondingRectangle() const;
    ...
    _HDLLg virtual HGF2DShapeTypeId
                                GetShapeType() const;
...
private:
    ...
    HGF2DShape::SpatialPosition
    CalculateSpatialPositionOfPolygonOfSegments(const HGF2DPolygonOfSegments& pi_rPolygon) const;

    HGF2DShape::SpatialPosition
    CalculateSpatialPositionOfNonCrossingPolygonOfSegments(const HGF2DPolygonOfSegments& pi_rPolygon) const;
...
HGF2DShape* fCreateShapeFromAutoCrossingPolySegment(const HGF2DPolySegment& pi_rAutoCrossingPolySegment);
