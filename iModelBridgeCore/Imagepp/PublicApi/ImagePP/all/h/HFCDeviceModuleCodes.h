//:>--------------------------------------------------------------------------------------+
//:>
//:>     $Source: PublicApi/ImagePP/all/h/HFCDeviceModuleCodes.h $
//:>
...
HFC_ERRORCODE_START_DECLARATION_CLASS2(HFCDeviceExceptionBuilder, HFCErrorCodeBuilder, HFCErrorCodeHandler)
...
HFC_ERRORCODE_START_DECLARATION_CLASS(HFCNoDiskSpaceLeftExceptionBuilder, HFCDeviceExceptionBuilder)
HFC_ERRORCODE_DECLARE_BUILDER_EXCEPTION
HFC_ERRORCODE_DECLARE_HANDLER
HFC_ERRORCODE_END_DECLARATION

// HFC_DEVICE_ABORT_EXCEPTION
HFC_ERRORCODE_START_DECLARATION_CLASS(HFCDeviceAbortExceptionBuilder, HFCDeviceExceptionBuilder)
HFC_ERRORCODE_DECLARE_BUILDER_EXCEPTION
HFC_ERRORCODE_DECLARE_HANDLER
HFC_ERRORCODE_END_DECLARATION
