...
/**----------------------------------------------------------------------------
 ...
 @see GetSearchPart
-----------------------------------------------------------------------------*/
inline const Utf8String& HFCURLECWPS::GetPath() const
    {
    return m_Path;
    }
...
/**----------------------------------------------------------------------------
 ...
 understood by the IWS server, that is embedded in the "url-path"
 ...
 @see GetPath
-----------------------------------------------------------------------------*/
inline const Utf8String& HFCURLECWPS::GetSearchPart() const
    {
    return m_SearchPart;
    }
