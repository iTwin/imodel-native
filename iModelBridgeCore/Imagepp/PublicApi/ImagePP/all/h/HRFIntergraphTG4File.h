...
public:
    ...
    HFC_DECLARE_SINGLETON_DLL(_HDLLg, HRFTG4Capabilities)
    };
...
public:
    ...
    HDECLARE_CLASS_ID(1483, HRFIntergraphMonochromeFile)
...
struct HRFIntergraphTG4Creator : public HRFIntergraphFile::Creator
    ...
    Create(const HFCPtr<HFCURL>& pi_rpURL,
           ...
           uint64_t             pi_Offset = 0) const;
private:
    HFC_DECLARE_SINGLETON_DLL(_HDLLg, HRFIntergraphTG4Creator)
