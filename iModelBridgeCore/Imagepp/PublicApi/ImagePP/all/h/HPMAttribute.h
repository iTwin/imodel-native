...
HPM_DEFINE_ATTRIBUTE(HRFAttributeResolutionUnit,               uint16_t,               HRF_ATTRIBUTEID_ResolutionUnit,               L"Resolution Unit");
...
HPM_DEFINE_ATTRIBUTE(HRFAttributeImageSlo,                     uint16_t,               HRF_ATTRIBUTEID_ImageSlo,                     L"Slo");
...
HPM_DEFINE_ATTRIBUTE(HRFAttributeGTModelType,                  uint16_t,               HRF_ATTRIBUTEID_GTModelType,                  L"GTModelType");
HPM_DEFINE_ATTRIBUTE(HRFAttributeGTRasterType,                 uint16_t,               HRF_ATTRIBUTEID_GTRasterType,                 L"GTRasterType");
HPM_DEFINE_ATTRIBUTE(HRFAttributePCSCitation,                  WString,              HRF_ATTRIBUTEID_PCSCitation,                  L"PCSCitation");
HPM_DEFINE_ATTRIBUTE(HRFAttributeProjectedCSType,              uint16_t,               HRF_ATTRIBUTEID_ProjectedCSType,              L"ProjectedCSType");
...
HPM_DEFINE_ATTRIBUTE(HRFAttributeProjection,                   uint16_t,               HRF_ATTRIBUTEID_Projection,                   L"Projection");
HPM_DEFINE_ATTRIBUTE(HRFAttributeProjCoordTrans,               uint16_t,               HRF_ATTRIBUTEID_ProjCoordTrans,               L"ProjCoordTrans");
HPM_DEFINE_ATTRIBUTE(HRFAttributeProjLinearUnits,              uint16_t,               HRF_ATTRIBUTEID_ProjLinearUnits,              L"ProjLinearUnits");
HPM_DEFINE_ATTRIBUTE(HRFAttributeProjLinearUnitSize,           double,               HRF_ATTRIBUTEID_ProjLinearUnitSize,           L"ProjLinearUnitSize");
HPM_DEFINE_ATTRIBUTE(HRFAttributeGeographicType,               uint16_t,               HRF_ATTRIBUTEID_GeographicType,               L"GeographicType");
HPM_DEFINE_ATTRIBUTE(HRFAttributeGeogCitation,                 WString,              HRF_ATTRIBUTEID_GeogCitation,                 L"GeogCitation");
HPM_DEFINE_ATTRIBUTE(HRFAttributeGeogGeodeticDatum,            uint16_t,               HRF_ATTRIBUTEID_GeogGeodeticDatum,            L"GeogGeodeticDatum");
HPM_DEFINE_ATTRIBUTE(HRFAttributeGeogPrimeMeridian,            uint16_t,               HRF_ATTRIBUTEID_GeogPrimeMeridian,            L"GeogPrimeMeridian");
HPM_DEFINE_ATTRIBUTE(HRFAttributeGeogLinearUnits,              uint16_t,               HRF_ATTRIBUTEID_GeogLinearUnits,              L"GeogLinearUnits");
HPM_DEFINE_ATTRIBUTE(HRFAttributeGeogLinearUnitSize,           double,               HRF_ATTRIBUTEID_GeogLinearUnitSize,           L"GeogLinearUnitSize");
HPM_DEFINE_ATTRIBUTE(HRFAttributeGeogAngularUnits,             uint16_t,               HRF_ATTRIBUTEID_GeogAngularUnits,             L"GeogAngularUnits");
HPM_DEFINE_ATTRIBUTE(HRFAttributeGeogAngularUnitSize,          double,               HRF_ATTRIBUTEID_GeogAngularUnitSize,          L"GeogAngularUnitSize");
HPM_DEFINE_ATTRIBUTE(HRFAttributeGeogEllipsoid,                uint16_t,               HRF_ATTRIBUTEID_GeogEllipsoid,                L"GeogEllipsoid");
...
HPM_DEFINE_ATTRIBUTE(HRFAttributeGeogAzimuthUnits,             uint16_t,               HRF_ATTRIBUTEID_GeogAzimuthUnits,             L"GeogAzimuthUnits");
...
HPM_DEFINE_ATTRIBUTE(HRFAttributeVerticalCSType,               uint16_t,       HRF_ATTRIBUTEID_VerticalCSType,               L"VerticalCSType");
HPM_DEFINE_ATTRIBUTE(HRFAttributeVerticalCitation,             WString,              HRF_ATTRIBUTEID_VerticalCitation,             L"VerticalCitation");
HPM_DEFINE_ATTRIBUTE(HRFAttributeVerticalDatum,                uint16_t,       HRF_ATTRIBUTEID_VerticalDatum,                L"VerticalDatum");
HPM_DEFINE_ATTRIBUTE(HRFAttributeVerticalUnits,                uint16_t,       HRF_ATTRIBUTEID_VerticalUnits,                L"VerticalUnits");
...
HPM_DEFINE_ATTRIBUTE(HRFAttributeGPSDifferential,              uint16_t,               HRF_ATTRIBUTEID_GPSDifferential,              L"GPSDifferential");
...
HPM_DEFINE_ATTRIBUTE(HRFAttributeExposureProgram,              uint16_t,               HRF_ATTRIBUTEID_ExposureProgram,              L"ExposureProgram");
HPM_DEFINE_ATTRIBUTE(HRFAttributeSpectralSensitivity,          WString,              HRF_ATTRIBUTEID_SpectralSensitivity,          L"SpectralSensitivity");
HPM_DEFINE_ATTRIBUTE(HRFAttributeISOSpeedRatings,              vector<uint16_t>,       HRF_ATTRIBUTEID_ISOSpeedRatings,              L"ISOSpeedRatings");
...
HPM_DEFINE_ATTRIBUTE(HRFAttributeMeteringMode,                 uint16_t,               HRF_ATTRIBUTEID_MeteringMode,                 L"MeteringMode");
HPM_DEFINE_ATTRIBUTE(HRFAttributeLightSource,                  uint16_t,               HRF_ATTRIBUTEID_LightSource,                  L"LightSource");
HPM_DEFINE_ATTRIBUTE(HRFAttributeFlash,                        uint16_t,               HRF_ATTRIBUTEID_Flash,                        L"Flash");
HPM_DEFINE_ATTRIBUTE(HRFAttributeFocalLength,                  double,               HRF_ATTRIBUTEID_FocalLength,                  L"FocalLength");
HPM_DEFINE_ATTRIBUTE(HRFAttributeSubjectArea,                  vector<uint16_t>,       HRF_ATTRIBUTEID_SubjectArea,                  L"SubjectArea");
...
HPM_DEFINE_ATTRIBUTE(HRFAttributeColorSpace,                   uint16_t,               HRF_ATTRIBUTEID_ColorSpace,                   L"ColorSpace");
...
HPM_DEFINE_ATTRIBUTE(HRFAttributeFocalPlaneResolutionUnit,     uint16_t,               HRF_ATTRIBUTEID_FocalPlaneResolutionUnit,     L"FocalPlaneResolutionUnit");
HPM_DEFINE_ATTRIBUTE(HRFAttributeSubjectLocation,              vector<uint16_t>,       HRF_ATTRIBUTEID_SubjectLocation,              L"SubjectLocation");
HPM_DEFINE_ATTRIBUTE(HRFAttributeExposureIndex,                double,               HRF_ATTRIBUTEID_ExposureIndex,                L"ExposureIndex");
HPM_DEFINE_ATTRIBUTE(HRFAttributeSensingMethod,                uint16_t,               HRF_ATTRIBUTEID_SensingMethod,                L"SensingMethod");
...
HPM_DEFINE_ATTRIBUTE(HRFAttributeCustomRendered,               uint16_t,               HRF_ATTRIBUTEID_CustomRendered,               L"CustomRendered");
HPM_DEFINE_ATTRIBUTE(HRFAttributeExposureMode,                 uint16_t,               HRF_ATTRIBUTEID_ExposureMode,                 L"ExposureMode");
HPM_DEFINE_ATTRIBUTE(HRFAttributeWhiteBalance,                 uint16_t,               HRF_ATTRIBUTEID_WhiteBalance,                 L"WhiteBalance");
HPM_DEFINE_ATTRIBUTE(HRFAttributeDigitalZoomRatio,             double,               HRF_ATTRIBUTEID_DigitalZoomRatio,             L"DigitalZoomRatio");
HPM_DEFINE_ATTRIBUTE(HRFAttributeFocalLengthIn35mmFilm,        uint16_t,               HRF_ATTRIBUTEID_FocalLengthIn35mmFilm,        L"FocalLengthIn35mmFilm");
HPM_DEFINE_ATTRIBUTE(HRFAttributeSceneCaptureType,             uint16_t,               HRF_ATTRIBUTEID_SceneCaptureType,             L"SceneCaptureType");
HPM_DEFINE_ATTRIBUTE(HRFAttributeGainControl,                  uint16_t,               HRF_ATTRIBUTEID_GainControl,                  L"GainControl");
HPM_DEFINE_ATTRIBUTE(HRFAttributeContrast,                     uint16_t,               HRF_ATTRIBUTEID_Contrast,                     L"Contrast");
HPM_DEFINE_ATTRIBUTE(HRFAttributeSaturation,                   uint16_t,               HRF_ATTRIBUTEID_Saturation,                   L"Saturation");
HPM_DEFINE_ATTRIBUTE(HRFAttributeSharpness,                    uint16_t,               HRF_ATTRIBUTEID_Sharpness,                    L"Sharpness");
...
HPM_DEFINE_ATTRIBUTE(HRFAttributeSubjectDistanceRange,         uint16_t,               HRF_ATTRIBUTEID_SubjectDistanceRange,         L"SubjectDistanceRange");
