//:>--------------------------------------------------------------------------------------+
//:>
//:>     $Source: PublicApi/ImagePP/all/h/HTGFFPacketManager.h $
//:>
...
public:
    ...
    _HDLLg PacketIdIter                 beginId                        () const;
    _HDLLg PacketIdIter                 endId                          () const;

    _HDLLg PacketIdIter                 FindIdIterFor                  (PacketID                pi_ID) const;
...
#include <ImagePP/all/h/HTGFFPacketManager.hpp>
