...
const double HVE_USE_INTERNAL_EPSILON = -1.0;

// Type used for the main vector type
typedef uint32_t HVE2DVectorTypeId;
...
/** -----------------------------------------------------------------------------
    ...
    -----------------------------------------------------------------------------
*/
class HNOVTABLEINIT HVE2DVector : public HGFGraphicObject
    {
    HPM_DECLARE_CLASS_DLL(_HDLLg,  1113)
...
public:
    ...
    /** -----------------------------------------------------------------------------
        ...
        permit to instantiate a new HVE2DVector object. When the default
        ...
        @param pi_rpCoordSys Constant reference to a smart pointer to
                             ...
                             in the interpretation of the vector.

        @param pi_rObject Constant reference to a HVE2DVector to duplicate.
        ...
        @see HGF2DCoordSys
        @see HGFGraphicObject
        -----------------------------------------------------------------------------
    */
    HVE2DVector();
    HVE2DVector(const HFCPtr<HGF2DCoordSys>& pi_rpCoordSys);
    HVE2DVector(const HVE2DVector&    pi_rObject);
    virtual            ~HVE2DVector();

    HVE2DVector&       operator=(const HVE2DVector& pi_rObj);
    ...
    /** -----------------------------------------------------------------------------
        ...
        @param pi_rPoint Constant reference to an HGF2DLocation containing the
        ...
        -----------------------------------------------------------------------------
    */
    virtual HGF2DLocation    CalculateClosestPoint(const HGF2DLocation& pi_rPoint) const = 0;
    ...
    /** -----------------------------------------------------------------------------
        ...
        @param pi_rPoint Constant reference to a HGF2DLocation located on the
        ...
        -----------------------------------------------------------------------------
    */
    _HDLLg virtual HGFBearing CalculateBearing(const HGF2DLocation& pi_rPoint,
    ...
    /** -----------------------------------------------------------------------------
        ...
        -----------------------------------------------------------------------------
    */
    _HDLLg virtual HGFBearing CalculatePerpendicularBearingAt(const HGF2DLocation& pi_rPoint,
                                                              HVE2DVector::ArbitraryDirection
                                                              pi_DirectionToRight = HVE2DVector::BETA,
    ...
    */
    ...
    /** -----------------------------------------------------------------------------
        ...
        @param po_pCrossPoints An HGF2DLocationCollection that is appended all the
                               cross points found.
    ...
    */
    virtual size_t     Intersect(const HVE2DVector& pi_rVector,
                                 HGF2DLocationCollection* po_pCrossPoints) const = 0;
    ...
    /** -----------------------------------------------------------------------------
        ...
        @param pi_rObject Constant reference to a HVE2DVector to find
                          contiguousness points with.

        @param po_pContiguousnessPoints    An HGF2DLocationCollection to which is
    ...
    */
    virtual size_t     ObtainContiguousnessPoints(const HVE2DVector& pi_rVector,
                                                  HGF2DLocationCollection* po_pContiguousnessPoints) const = 0;
    ...
    /** -----------------------------------------------------------------------------
        ...
        @param po_pFirstContiguousnessPoint Pointer to a HGF2DLocation which will receive
                                            the start of the studied contiguousness region.
        @param po_pSecondContiguousnessPoint Pointer to a HGF2DLocation which will receive
    ...
    */
    virtual void       ObtainContiguousnessPointsAt(const HVE2DVector& pi_rVector,
                                                    ...
                                                    HGF2DLocation* pi_pSecondContiguousnessPoint) const = 0;

    /** -----------------------------------------------------------------------------
        This method returns a dynamically allocated copy of the vector,
        expressed in a different, specified coordinate system. It is
        insured that the vector will remain of the same basic
        type (linear, shape...) but it is uncertain as if the vector of
        this type will be the same, or simply be equivalent. The vector
        must be deleted by the caller when the copy is no more useful.

        @param pi__rpCoordSys Constant reference to a smart pointer to coordinate
                              system in which the new vector will be expressed.
        ...
        @see HGF2DCoordSys
        @see Clone()
        @see GetMainVectorType()
        -----------------------------------------------------------------------------
    */
    virtual HVE2DVector*          AllocateCopyInCoordSys(const HFCPtr<HGF2DCoordSys>& pi_rpCoordSys) const = 0;
    ...
    /** -----------------------------------------------------------------------------
        ...
        -----------------------------------------------------------------------------
    */
    virtual bool      Crosses(const HVE2DVector& pi_rVector) const = 0;
    ...
    /** -----------------------------------------------------------------------------
        ...
        -----------------------------------------------------------------------------
    */
    _HDLLg virtual bool      AreContiguous(const HVE2DVector& pi_rVector) const = 0;
    ...
    /** -----------------------------------------------------------------------------
        ...
        -----------------------------------------------------------------------------
    */
    _HDLLg virtual bool      AreAdjacent(const HVE2DVector& pi_rVector) const = 0;
    ...
    /** -----------------------------------------------------------------------------
        ...
        @param pi_ExtremityProcessing An optional flag indicating if the extremities are to be
                                      ...
                                      This parameter can take one of the following values :
                                        HVE2DVector::INCLUDE_EXTREMITIES
                                        HVE2DVector::EXCLUDE_EXTREMITIES
    ...
    */
    _HDLLg virtual bool      IsPointOn(const HGF2DLocation& pi_rTestPoint,
                                       ...
                                       double pi_Tolerance = HVE_USE_INTERNAL_EPSILON) const = 0;
    ...
    /** -----------------------------------------------------------------------------
        ...
        The same tolerance is also applied when extremities
        are to be excluded.
        The method will only accept locations which are expressed in the
        same coordinate system as the vector. The post-fix SCS stands for Same
        Coordinate System. This method is mainly provided for performance
        reason.
    ...
    */
    ...
    _HDLLg virtual bool      IsConnectedBy(const HVE2DLinear& pi_rLinear) const;
    ...
    /** -----------------------------------------------------------------------------
        ...
        @param pi_rLocation Constant reference to a HGF2DLocation containing
    ...
    */
    _HDLLg virtual bool      AreContiguousAt(const HVE2DVector& pi_rVector,
                                             const HGF2DLocation& pi_rPoint) const = 0;

    /** -----------------------------------------------------------------------------
        This method checks if the given point is located at an extremity of the
        vector within a tolerance.

        @param pi_rLocation Constant reference to point to check if it
    ...
    */
    ...
    /** -----------------------------------------------------------------------------
        ...
        the class that directly inherits from HVE2DVector (Such as
        HVE2DShape::TYPE_ID or HVE2DLinear) of the vector object.
        ...
        -----------------------------------------------------------------------------
    */
    virtual HVE2DVectorTypeId    GetMainVectorType() const = 0;
    ...
    _HDLLg HFCPtr<HGFTolerance>  GetStrokeTolerance() const;
    _HDLLg virtual void          SetStrokeTolerance(const HFCPtr<HGFTolerance> & pi_Tolerance);


    bool                         TendsToTheLeftOfSCS(const HVE2DVector&   pi_rVector,
                                                     const HGF2DLocation& pi_rPoint,
    ...
    /** -----------------------------------------------------------------------------
        ...
        @param pi_rLocation Constant reference to a HGF2DLocation containing
                            the position of point which must be located on
                            both vector objects (IsPointOn()).
        @param po_pFirstPoint Pointer to HGF2DLocation which receives the
                              first contiguousness point if any.

        @param po_pSecondPoint Pointer to HGF2DLocation which receives
...
protected:
    ...
    _HDLLg virtual bool      IntersectsAtSplitPoint(const HVE2DVector& pi_rVector,
