//:>--------------------------------------------------------------------------------------+
//:>
//:>     $Source: PublicApi/ImagePP/all/h/HTGFFCompression.h $
//:>
...
public:
    ...
    _HDLLg Type                         GetType                        () const;

    _HDLLg bool                         Accept                         (Visitor&                                pi_rVisitor) const;
...
public:
    ...
    _HDLLg bool                         Accept                         (Compression::Visitor&                   pi_rVisitor) const;
    _HDLLg Base*                        Clone                          () const;
...
public:
    _HDLLg static Compression           Create                         ();
    };
...
public:
    ...
    _HDLLg void   Visit                          (const None&                             pi_rCompression);
    _HDLLg void   Visit                          (const Deflate&                          pi_rCompression);
