...
class HRPPixelTypeI4R8G8B8A8 : public HRPPixelTypeRGB
    ...
    HPM_DECLARE_CLASS_DLL(_HDLLg,  1214)

public:
    // Primary methods
    _HDLLg                 HRPPixelTypeI4R8G8B8A8    ();
    _HDLLg                 HRPPixelTypeI4R8G8B8A8    (const HRPPixelPalette& pi_Palette);

    _HDLLg                 HRPPixelTypeI4R8G8B8A8(const HRPPixelTypeI4R8G8B8A8& pi_rObj);

    _HDLLg virtual         ~HRPPixelTypeI4R8G8B8A8();
