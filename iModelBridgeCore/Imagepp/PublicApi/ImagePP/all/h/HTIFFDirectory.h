...
public:
    ...
    bool               Remove    (HTagID pi_Tag);

    HTagIdIter          TagIDBegin () const;
    HTagIdIter          TagIDEnd () const;
    ...
    _HDLLg bool        GetValues (HTagID pi_Tag, unsigned short* po_pVal);
    _HDLLg bool        GetValues (HTagID pi_Tag, uint32_t* po_pVal);
    bool               GetValues (HTagID pi_Tag, double* po_pVal);
    bool               GetValues (HTagID pi_Tag, uint64_t* po_pVal);
    bool               GetValues (HTagID pi_Tag, char** po_ppVal);
    bool               GetValues (HTagID pi_Tag, WChar** po_ppVal);
    ...
    bool               GetValues (HTagID pi_Tag, uint32_t* po_pCount, uint32_t** po_ppVal);
    bool               GetValues (HTagID pi_Tag, uint32_t* po_pCount, double** po_ppVal);
    _HDLLg bool        GetValues (HTagID pi_Tag, uint32_t* po_pCount, Byte** po_ppVal);
    bool               GetValues (HTagID pi_Tag, uint32_t* po_pCount, uint64_t** po_ppVal);


    bool               SetValues (HTagID pi_Tag, unsigned short pi_Val);
    bool               SetValues (HTagID pi_Tag, uint32_t pi_Val);
    bool               SetValues (HTagID pi_Tag, double pi_Val);
    bool               SetValues (HTagID pi_Tag, uint64_t pi_Val);
    bool               SetValues (HTagID pi_Tag, const char*  pi_pVal);
    bool               SetValues (HTagID pi_Tag, const WChar*  pi_pVal);
    bool               SetValues (HTagID pi_Tag, unsigned short pi_Val1,  unsigned short pi_Val2);
    bool               SetValues (HTagID pi_Tag, uint32_t pi_pVal1, uint32_t pi_pVal2);     // RATIONAL
    bool               SetValues (HTagID pi_Tag, uint32_t pi_Count, const unsigned short* pi_pVal);
    bool               SetValues (HTagID pi_Tag, uint32_t pi_Count, const uint32_t* pi_pVal);
    bool               SetValues (HTagID pi_Tag, uint32_t pi_Count, const double* pi_pVal);
    bool               SetValues (HTagID pi_Tag, uint32_t pi_Count, const Byte* pi_pVal);
    bool               SetValues (HTagID pi_Tag, uint32_t pi_Count, const uint64_t* pi_pVal);
