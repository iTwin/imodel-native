//:>--------------------------------------------------------------------------------------+
//:>
//:>     $Source: PublicApi/ImagePP/all/h/IDTMScatteredPointsFeatureArray.h $
//:>
...
public:
    ...
    typedef ImagePP::IndexedElementRandomIterator<facade_type, point_iterator, point_idx_const_iterator, value_type>
    iterator;
    typedef ImagePP::IndexedElementRandomIterator<facade_type, point_const_iterator, point_idx_const_iterator, const value_type>
    const_iterator;
