...
/** -----------------------------------------------------------------------------
    ...
    -----------------------------------------------------------------------------
*/
template<class DataType> inline bool HGF3DCoord<DataType>::operator==(const HGF3DCoord<DataType>& pi_rObj) const
    {
...
// in text format
//-----------------------------------------------------------------------------
template<> inline void HGF3DCoord<char>::PrintState(ostream& po_rOutput) const
    {
#ifdef __HMR_PRINTSTATE
    char       DumString[256];
...
// in text format
//-----------------------------------------------------------------------------
template<> inline void HGF3DCoord<signed char>::PrintState(ostream& po_rOutput) const
    {
#ifdef __HMR_PRINTSTATE
    char       DumString[256];
...
// in text format
//-----------------------------------------------------------------------------
template<> inline void HGF3DCoord<unsigned char>::PrintState(ostream& po_rOutput) const
    {
#ifdef __HMR_PRINTSTATE
    char       DumString[256];
...
// in text format
//-----------------------------------------------------------------------------
template<> inline void HGF3DCoord<double>::PrintState(ostream& po_rOutput) const
    {
#ifdef __HMR_PRINTSTATE
    char       DumString[256];
...
// in text format
//-----------------------------------------------------------------------------
template<> inline void HGF3DCoord<int32_t>::PrintState(ostream& po_rOutput) const
    {
#ifdef __HMR_PRINTSTATE
    char       DumString[256];
...
// in text format
//-----------------------------------------------------------------------------
template<> inline void HGF3DCoord<uint32_t>::PrintState(ostream& po_rOutput) const
    {
#ifdef __HMR_PRINTSTATE
    char       DumString[256];
...
// in text format
//-----------------------------------------------------------------------------
template<> inline void HGF3DCoord<float>::PrintState(ostream& po_rOutput) const
    {
#ifdef __HMR_PRINTSTATE
    char       DumString[256];
