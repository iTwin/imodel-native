//:>--------------------------------------------------------------------------------------+
//:>
//:>     $Source: PublicApi/ImagePP/all/h/HTGFFSubDirIdIter.h $
//:>
...
+---------------+---------------+---------------+---------------+---------------+------*/
class SubDirIdIter : public ImagePP::BidirectionalIterator<SubDirIdIter, uint32_t>
    {
public:
