...
class HGF2DLinearModelAdapter : public HGF2DTransfoModelAdapter
    {
    HDECLARE_CLASS_ID(1283, HGF2DTransfoModelAdapter)

public:

    // Primary methods
    _HDLLg                 HGF2DLinearModelAdapter();

    _HDLLg                 HGF2DLinearModelAdapter(const HGF2DTransfoModel& pi_rNonLinearTransfoModel,
                                                   const HGF2DLiteExtent&   pi_ApplicationArea,
                                                   double                  pi_Step,
                                                   bool                    pi_AdaptAsAffine = false);


    _HDLLg                 HGF2DLinearModelAdapter(const HGF2DLinearModelAdapter& pi_rObj);
    _HDLLg virtual         ~HGF2DLinearModelAdapter();
    HGF2DLinearModelAdapter&    operator=(const HGF2DLinearModelAdapter& pi_rObj);

    const HGF2DLiteExtent&
    GetApplicationArea() const;
...
#include "HGF2DLinearModelAdapter.hpp"
