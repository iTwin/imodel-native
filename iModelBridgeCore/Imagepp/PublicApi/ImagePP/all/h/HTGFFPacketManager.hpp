//:>--------------------------------------------------------------------------------------+
//:>
//:>     $Source: PublicApi/ImagePP/all/h/HTGFFPacketManager.hpp $
//:>
...
inline bool PacketManagerBase::Get (PacketID    pi_ID,
    ...
    return H_SUCCESS == GetFile().ReadPacket(po_rPacket.EditPacket(), pi_ID);
    }
...
inline bool PacketManagerBase::Set (PacketID        pi_ID,
    ...
    return H_SUCCESS == GetFile().WritePacket(pi_rPacket.GetPacket(), pi_ID);
    }
...
inline bool PacketManagerBase::Add (PacketID&       po_rID,
    ...
    // Append packet
    TagFile::PacketID ID;
    const bool Success = (H_SUCCESS == GetFile().AppendPacket(pi_rPacket.GetPacket(), ID));
...
inline bool PacketManagerBase::Remove (PacketID pi_ID)
    {
    return H_SUCCESS == GetFile().RemovePacket(pi_ID);
    }
