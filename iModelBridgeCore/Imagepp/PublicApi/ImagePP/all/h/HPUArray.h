//:>--------------------------------------------------------------------------------------+
//:>
//:>     $Source: PublicApi/ImagePP/all/h/HPUArray.h $
//:>
...
+---------------+---------------+---------------+---------------+---------------+------*/
template <typename T>
class Array : public HFCShareableObject<Array<T>>
    {
public:
    typedef HFCPtr<Array<T>>    Ptr;
    typedef HFCPtr<Array<T>>    CPtr;
...
#include <ImagePP/all/h/HPUArray.hpp>
