//:>--------------------------------------------------------------------------------------+
//:>
//:>     $Source: PrivateApi/ImagePPInternal/gra/HRAImageNearestSamplerN8.h $
//:>
...
/*----------------------------------------------------------------------------+
|struct HRAImageNearestSamplerN8
...
struct HRAImageNearestSamplerN8 : HRAImageSampler
    {
public:
    // Use HRAImageSampler::CreateNearestN8(...) to instanciate this class.
    friend HRAImageSampler;

    virtual ~HRAImageNearestSamplerN8();
...
private:
    ...
    * @bsimethod                                                   Mathieu.Marchand  10/2014
    ...
    HRAImageNearestSamplerN8(HFCPtr<HGF2DTransfoModel>& destToSrcTransfo);
