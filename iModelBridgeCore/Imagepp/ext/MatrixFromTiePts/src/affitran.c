/*--------------------------------------------------------------------------------------+
|
|     $Source: ext/MatrixFromTiePts/src/affitran.c $
|
...
**
**  ALAIN LAPIERRE          Version originale        4 21/12/92
**===========================================================================*/
...
{
    double yprod[2];
    trf_transfoCoordPrepAffi2D(mapping, coef3D, ptIn, yprod);
    trf_transfoCoordDoAffi2D(mapping, coef3D, ptIn, ptOut, yprod);
}
...
/*fh=========================================================================
**
**  trf_transfoCoordDoAffiScanLine2D
**
