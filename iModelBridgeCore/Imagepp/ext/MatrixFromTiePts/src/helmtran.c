/*--------------------------------------------------------------------------------------+
|
|     $Source: ext/MatrixFromTiePts/src/helmtran.c $
|
...
**      transformation of coordinates using the Helmert transform
**
**===========================================================================*/
...
void trf_transfoCoordHelm2D(int32_t                mapping,
    ...
    {
    double yprod[2];
    trf_transfoCoordPrepHelm2D(mapping, coef3D, ptIn, yprod);
    trf_transfoCoordDoHelm2D(mapping, coef3D, ptIn, ptOut, yprod);
    }
...
/*fh=========================================================================
**
**  trf_transfoCoordDoHelmScanLine2D
**
