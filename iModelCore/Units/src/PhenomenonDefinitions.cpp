...
void UnitRegistry::AddDefaultPhenomena ()
    ...
    AddPhenomena(LINEAR_COST, "FINANCE*LENGTH(-1)");
    AddPhenomena(LINEAR_RATE, "RATIO*LENGTH(-1)");

    AddPhenomena(LINEAR_COEFFICIENT_OF_THERMAL_EXPANSION, "LENGTH*LENGTH(-1)*TEMPERATURE_CHANGE(-1)");
    //AddPhenomena(AREA_COEFFICIENT_OF_THERMAL_EXPANSION, "AREA*AREA(-1)*TEMPERATURE_CHANGE(-1)");
    //AddPhenomena(VOLUMETRIC_COEFFICIENT_OF_THERMAL_EXPANSION, "VOLUME*VOLUME(-1)*TEMPERATURE_CHANGE(-1)");
