...
private:
    ...
    void AddCopy(SymbolWithExponentCR sWE) { m_symbolExpression.push_back(new SymbolWithExponent(sWE)); }
    void Add(SymbolCP symbol, int exponent) { m_symbolExpression.push_back(new SymbolWithExponent(symbol, exponent)); }
