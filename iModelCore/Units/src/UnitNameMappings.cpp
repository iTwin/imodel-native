...
void UnitNameMappings::AddMappings()
    ...
    AddECMapping("2PI", "UNITS:2PI");
    AddECMapping("360DEG", "UNITS:360DEG");
    ...
    AddECMapping("CM/REVOLUTION", "UNITS:CM_PER_REVOLUTION");
    AddECMapping("CM/SEC", "UNITS:CM_PER_SEC");
    AddECMapping("CM/SEC.SQ", "UNITS:CM_PER_SEC_SQ");
    AddECMapping("CM^4", "UNITS:CM_P4");
    AddECMapping("CM^6", "UNITS:CM_P6");
    ...
    AddECMapping("FT/REVOLUTION", "UNITS:FT_PER_REVOLUTION");
    ...
    AddECMapping("FT^4", "UNITS:FT_P4");
    AddECMapping("FT^6", "UNITS:FT_P6");
    ...
    AddECMapping("IN/RAD", "UNITS:IN_PER_RAD");
    AddECMapping("IN/REVOLUTION", "UNITS:IN_PER_REVOLUTION");
    AddECMapping("IN/SEC", "UNITS:IN_PER_SEC");
    AddECMapping("IN^4", "UNITS:IN_P4");
    AddECMapping("IN^6", "UNITS:IN_P6");
    AddECMapping("IN_H2O@32F", "UNITS:IN_H2O_32F");
    AddECMapping("IN_H2O@39.2F", "UNITS:IN_H2O_39_2F");
    AddECMapping("IN_H2O@60F", "UNITS:IN_H2O_60F");
    AddECMapping("IN_HG@32F", "UNITS:IN_HG_32F");
    AddECMapping("IN_HG@60F", "UNITS:IN_HG_60F");
    ...
    AddECMapping("M/DEGREE", "UNITS:M_PER_DEGREE");
    ...
    AddECMapping("MM/RAD", "UNITS:MM_PER_RAD");
    AddECMapping("MM/REVOLUTION", "UNITS:MM_PER_REVOLUTION");
    AddECMapping("MM/SEC", "UNITS:MM_PER_SEC");
    AddECMapping("MM^4", "UNITS:MM_P4");
    AddECMapping("MM^6", "UNITS:MM_P6");
    AddECMapping("MM_HG@32F", "UNITS:MM_HG_32F");
    ...
    AddECMapping("M^4", "UNITS:M_P4");
    AddECMapping("M^6", "UNITS:M_P6");
    ...
    AddECMapping("PI/2", "UNITS:PI_PER_2");
    AddECMapping("PI/4", "UNITS:PI_PER_4");
