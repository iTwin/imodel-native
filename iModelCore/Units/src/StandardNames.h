...
static Utf8CP const SPECIFIC_VOLUME = "SPECIFIC_VOLUME";
static Utf8CP const LINEAR_DENSITY = "LINEAR_DENSITY";
static Utf8CP const SURFACE_DENSITY = "SURFACE_DENSITY";
...
static Utf8CP const THERMAL_RESISTANCE = "THERMAL_RESISTANCE";
...
static Utf8CP const VOLUMETRIC_COEFFICIENT_OF_THERMAL_EXPANSION = "VOLUMETRIC_COEFFICIENT_OF_THERMAL_EXPANSION";

static Utf8CP const VOLUME_RATIO = "VOLUME_RATIO";
