...
public:
    ...
    UNITS_EXPORT bool ToJson(BeJsValue out, bool verbose) const;
    ...
    // TODO - Naron: this should be somewhere else?^M
...
private:
    ...
    public:
        ...
        bool ToJson(BeJsValue jval, bool verbose = false) const;
    ...
    public:
        ...
        bool GetIsNegative () { return m_negative; }
