...
TEST_F(FormatIntegerTest, FormatIntegerThousandsSeparatorTests)
    ...
    nfs.SetThousandSeparator('_');
    EXPECT_EQ((int)strlen("1_000"), nfs.FormatInteger(1000, buff, (int)FormattingTest::Countof(buff)));
    EXPECT_STREQ("1_000", buff);
    EXPECT_EQ((int)strlen("-1_000"), nfs.FormatInteger(-1000, buff, (int)FormattingTest::Countof(buff)));
    EXPECT_STREQ("-1_000", buff);

    EXPECT_STREQ("1_000", nfs.FormatInteger(1000).c_str());
    EXPECT_STREQ("-1_000", nfs.FormatInteger(-1000).c_str());

    EXPECT_STREQ("1_000", nfs.FormatIntegerToString(1000, 0).c_str());
    EXPECT_STREQ("001_000", nfs.FormatIntegerToString(1000, (int)strlen("1000")+2).c_str());
    EXPECT_STREQ("0_001_000", nfs.FormatIntegerToString(1000, (int)strlen("1000")+3).c_str());
    EXPECT_STREQ("-1_000", nfs.FormatIntegerToString(-1000, 0).c_str());
    EXPECT_STREQ("-001_000", nfs.FormatIntegerToString(-1000, (int)strlen("1000")+2).c_str());
    EXPECT_STREQ("-0_0001_000", nfs.FormatIntegerToString(-1000, (int)strlen("1000")+3).c_str());
...
//// @bsimethod                                    Victor.Cushman                  03/18
////---------------+---------------+---------------+---------------+---------------+-------
//TEST_F(FormattingTest, DefaultFormats)
//    {
...
//// @bsimethod                                    Victor.Cushman                  03/18
////---------------+---------------+---------------+---------------+---------------+-------
//TEST_F(FormattingTest, CustomJsonFormat)
//    {
//    static auto const validateCustomJsonFormat = [](double dval, Utf8CP unitName, Utf8CP jsonCustomFormat) -> void
//        {
//            BEU::UnitCP const unit = BEU::UnitRegistry::Instance().LookupUnit(unitName);
//            ASSERT_NE(nullptr, unit) << "Invalid unit of measure: " << unitName;
//            BEU::Quantity const qty(dval, *unit);
//            
//            // Now we need to add a new format definition from the json string.
//            FormatProblemDetail problem;
//            NamedFormatSpecCP const nfs = StdFormatSet::AddFormat(jsonCustomFormat, problem);
//            ASSERT_FALSE(problem.IsProblem()) << "Invalid JSON definition. Error code " << (std::underlying_type<FormatProblemCode>::type)problem.GetProblemCode();
//
...
//            LOG.infov("===CustomFormatAnalyzer: %f of %s = %s", dval, unitName, str.c_str());
//        };
//
//    Utf8CP customJsonFormat = R"fmt({
//        "NumericFormat": {
//            "decPrec": 2,
//            "minWidth": 4,
//            "presentType": "Stop100"
...
//        "SpecType": "numeric"
//    })fmt";
//    validateCustomJsonFormat(98765.4321, "FT", customJsonFormat);
//
//    customJsonFormat = R"fmt({
//        "NumericFormat": {
//            "decPrec": 2,
//            "minWidth": 4,
//            "presentType": "Stop100",
...
//        "NumericFormat": {
//            "fractPrec": 8,
//            "presentType": "Fractional"
//        },
//        "SpecAlias": "CustomFT",
//        "SpecName": "CustomFT",
//        "SpecType": "composite"
//    })fmt";
//    validateCustomJsonFormat(23.5, "FT", customJsonFormat);
//    //validateCustomJsonFormat(23.5, "M", customJsonFormat);
//
//    customJsonFormat = R"fmt({
//        "CompositeFormat": {
//            "MajorUnit": {
...
//        "SpecType": "composite"
//    })fmt";
//    validateCustomJsonFormat(23.5, "ARC_DEG", customJsonFormat);
//
//    customJsonFormat = R"fmt({
//        "CompositeFormat": {
//            "MajorUnit": {
...
//        "SpecType": "composite"
//    })fmt";
//    validateCustomJsonFormat(123.25, "ARC_DEG", customJsonFormat);
//    }
//
///*---------------------------------------------------------------------------------**//**
//* @bsimethod                            David.Fox-Rabinovitz                      03/17
//+---------------+---------------+---------------+---------------+---------------+------*/
//TEST_F(FormattingTest, Preliminary)
//    {
...
//
//    //FormattingTestFixture::FormattingTestFixture::RegistryLookupUnitTest("arc_deg");
//    //FormattingTestFixture::FormattingTestFixture::RegistryLookupUnitTest("ARC_DEG");
//    //FormattingTestFixture::FormattingTestFixture::RegistryLookupUnitTest("FT");
//    //FormattingTestFixture::FormattingTestFixture::RegistryLookupUnitTest("ft");
//    //FormattingTestFixture::FormattingTestFixture::RegistryLookupUnitTest("IN");
//    //FormattingTestFixture::FormattingTestFixture::RegistryLookupUnitTest("in");
//
...
//+---------------+---------------+---------------+---------------+---------------+------*/
//TEST_F(FormattingTest, StdFormatting)
//    {
//    FormattingTestFixture::SetUpL10N();
//
...
//* @bsimethod                            David.Fox-Rabinovitz                      12/17
//+---------------+---------------+---------------+---------------+---------------+------*/
//TEST_F(FormattingTest, FullySpecifiedFUS)
//    {
...
//+---------------+---------------+---------------+---------------+---------------+------*/
//TEST_F(FormattingTest, PhysValues)
//    {
//    FormattingTestFixture::SetUpL10N();
//
...
//* @bsimethod                            David.Fox-Rabinovitz                      01/17
//+---------------+---------------+---------------+---------------+---------------+------*/
//TEST_F(FormattingTest, LargeNumbers)
//    {
...
//* @bsimethod                            David.Fox-Rabinovitz                      01/17
//+---------------+---------------+---------------+---------------+---------------+------*/
//TEST_F(FormattingTest, DictionaryValidation)
//    {
...
//+---------------+---------------+---------------+---------------+---------------+------*/
//TEST_F(FormattingTest, PhenomenaTest)
//    {
//    LOG.infov("\n================  Phenomena Test ===========================");
