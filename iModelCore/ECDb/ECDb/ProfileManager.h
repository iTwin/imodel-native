...
private:
    ...
    static ProfileVersion GetExpectedVersion() { return ProfileVersion(3, 113, 0, 0); }
    //! Minimum version of the ECDb profile which can still be auto-upgraded to the latest profile version.
    static ProfileVersion GetMinimumSupportedVersion() { return ProfileVersion(3, 113, 0, 0); }
