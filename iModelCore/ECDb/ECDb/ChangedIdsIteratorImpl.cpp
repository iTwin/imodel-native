...
// @bsimethod
//---------------------------------------------------------------------------------------
ChangedIdsIterator::const_iterator ChangedIdsIterator::begin() const {
    return const_iterator(*this, m_changes.begin());
}
//---------------------------------------------------------------------------------------
// @bsimethod
//---------------------------------------------------------------------------------------
ChangedIdsIterator::const_iterator ChangedIdsIterator::end() const {
    return const_iterator(*this, m_changes.end());
}
...
// @bsimethod
//---------------------------------------------------------------------------------------
ChangedIdsIterator::iterator::~iterator() {
    FreeSqlChange();
}
