...
uint64_t IECSqlValue::GetDateTimeJulianDaysMsec(DateTime::Info& metadata) const {
    return _GetDateTimeJulianDaysMsec(metadata);
}
...
double IECSqlValue::GetDateTimeJulianDays(DateTime::Info& metadata) const {
    return _GetDateTimeJulianDays(metadata);
}
...
// @bsimethod
//+---------------+---------------+---------------+---------------+---------------+------
IECSqlValue const& IECSqlValue::operator[](Utf8CP structMemberName) const {
    return _GetStructMemberValue(structMemberName);
}

// --------------------------------------------------------------------------------------
// @bsimethod
//+---------------+---------------+---------------+---------------+---------------+------
IECSqlValueIterable const& IECSqlValue::GetStructIterable() const {
    return _GetStructIterable();
}

//--------------------------------------------------------------------------------------
// @bsimethod
//+---------------+---------------+---------------+---------------+---------------+------
int IECSqlValue::GetArrayLength() const {
...
// @bsimethod
//+---------------+---------------+---------------+---------------+---------------+------
IECSqlValueIterable const& IECSqlValue::GetArrayIterable() const {
    return _GetArrayIterable();
}
...
// @bsimethod
//+---------------+---------------+---------------+---------------+---------------+------
IECSqlValueIterable::const_iterator IECSqlValueIterable::begin() const {
