...
// @bsimethod
//---------------------------------------------------------------------------------------
ECSqlStatus IECSqlBinder::BindZeroBlob(int blobSize) {
    return _BindZeroBlob(blobSize);
}
...
// @bsimethod
//---------------------------------------------------------------------------------------
ECSqlStatus IECSqlBinder::BindDateTime(uint64_t julianDayMsec, DateTime::Info const& metadata) {
    return _BindDateTime(julianDayMsec, metadata);
}
...
ECSqlStatus IECSqlBinder::BindDateTime(double julianDay, DateTime::Info const& metadata) {
    return _BindDateTime(julianDay, metadata);
}
...
ECSqlStatus IECSqlBinder::BindText(Utf8CP value, IECSqlBinder::MakeCopy makeCopy, int byteCount) {
    return _BindText(value, makeCopy, byteCount);
}
...
// @bsimethod
//---------------------------------------------------------------------------------------
ECSqlStatus IECSqlBinder::BindVirtualSet(std::shared_ptr<VirtualSet> virtualSet) {
...
// @bsimethod
//---------------------------------------------------------------------------------------
IECSqlBinder& IECSqlBinder::operator[](Utf8CP structMemberPropertyName) {
    return _BindStructMember(structMemberPropertyName);
}

// --------------------------------------------------------------------------------------
// @bsimethod
//---------------------------------------------------------------------------------------
IECSqlBinder& IECSqlBinder::operator[](ECN::ECPropertyId structMemberPropertyId) {
    return _BindStructMember(structMemberPropertyId);
}

//---------------------------------------------------------------------------------------
// @bsimethod
//---------------------------------------------------------------------------------------
IECSqlBinder& IECSqlBinder::AddArrayElement() {
...
// @bsimethod
//---------------------------------------------------------------------------------------
BinderInfo const& IECSqlBinder::GetBinderInfo() {
    return _GetBinderInfo();
}
