...
private:
    ...
    // SELECT
    static std::unique_ptr<SingleSelectStatementExp>   parse_single_select_statement   (ECSqlParseContext& ctx, connectivity::OSQLParseNode const* parseNode);
    ...
    static BooleanSqlOperator                          parse_comparison                (ECSqlParseContext& ctx, connectivity::OSQLParseNode const* parseNode);
    ...
    static std::unique_ptr<ComputedExp>                parse_in_predicate_part_2       (ECSqlParseContext& ctx, BooleanSqlOperator& inOperator, connectivity::OSQLParseNode const* parseNode);
    ...
    static SelectStatementExp::Operator                parse_compound_select_op        (ECSqlParseContext& ctx, connectivity::OSQLParseNode const* parseNode);
