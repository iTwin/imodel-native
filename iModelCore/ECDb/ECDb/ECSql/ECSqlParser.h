...
private:
    ...
    BentleyStatus ParseCatalogName(Utf8StringCP& catalogName, Utf8StringCP& schemaName, Utf8StringCP& className, connectivity::OSQLParseNode const*) const;
    ...
    BentleyStatus ParseTableName(Utf8StringCP& tableName, connectivity::OSQLParseNode const*) const;
    ...
    BentleyStatus ParseSchemaName(Utf8StringCP& schemaName, Utf8StringCP& className, connectivity::OSQLParseNode const*) const;
