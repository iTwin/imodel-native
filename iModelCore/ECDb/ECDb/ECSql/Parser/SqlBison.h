...
#ifndef YY_SQLYY_F_GITMODEL_NATIVE_SRC_IMODEL_NATIVE_IMODELCORE_ECDB_SCRIPTS_ECDB_ECSQL_PARSER_SQLBISON_H_INCLUDED
# define YY_SQLYY_F_GITMODEL_NATIVE_SRC_IMODEL_NATIVE_IMODELCORE_ECDB_SCRIPTS_ECDB_ECSQL_PARSER_SQLBISON_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    SQL_TOKEN_DOLLAR = 325,        /* SQL_TOKEN_DOLLAR  */
    SQL_BITWISE_NOT = 326,         /* SQL_BITWISE_NOT  */
    SQL_TOKEN_NAVIGATION_VALUE = 327, /* SQL_TOKEN_NAVIGATION_VALUE  */
    ...
    SQL_TOKEN_OR = 359,            /* SQL_TOKEN_OR  */
    SQL_TOKEN_AND = 360,           /* SQL_TOKEN_AND  */
    SQL_ARROW = 361,               /* SQL_ARROW  */
    SQL_BITWISE_OR = 362,          /* SQL_BITWISE_OR  */
    SQL_BITWISE_AND = 363,         /* SQL_BITWISE_AND  */
    SQL_BITWISE_SHIFT_LEFT = 364,  /* SQL_BITWISE_SHIFT_LEFT  */
    SQL_BITWISE_SHIFT_RIGHT = 365, /* SQL_BITWISE_SHIFT_RIGHT  */
    SQL_LESSEQ = 366,              /* SQL_LESSEQ  */
    SQL_GREATEQ = 367,             /* SQL_GREATEQ  */
    SQL_NOTEQUAL = 368,            /* SQL_NOTEQUAL  */
    SQL_LESS = 369,                /* SQL_LESS  */
    SQL_GREAT = 370,               /* SQL_GREAT  */
    SQL_EQUAL = 371,               /* SQL_EQUAL  */
    SQL_CONCAT = 372,              /* SQL_CONCAT  */
    SQL_TOKEN_INVALIDSYMBOL = 373  /* SQL_TOKEN_INVALIDSYMBOL  */
  };
...
#endif /* !YY_SQLYY_F_GITMODEL_NATIVE_SRC_IMODEL_NATIVE_IMODELCORE_ECDB_SCRIPTS_ECDB_ECSQL_PARSER_SQLBISON_H_INCLUDED  */
