...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    SQL_TOKEN_DELETE = 279,        /* SQL_TOKEN_DELETE  */
    SQL_TOKEN_DESC = 280,          /* SQL_TOKEN_DESC  */
    SQL_TOKEN_DISTINCT = 281,      /* SQL_TOKEN_DISTINCT  */
    SQL_TOKEN_FORWARD = 282,       /* SQL_TOKEN_FORWARD  */
    SQL_TOKEN_BACKWARD = 283,      /* SQL_TOKEN_BACKWARD  */
    SQL_TOKEN_ESCAPE = 284,        /* SQL_TOKEN_ESCAPE  */
    SQL_TOKEN_EXCEPT = 285,        /* SQL_TOKEN_EXCEPT  */
    SQL_TOKEN_EXISTS = 286,        /* SQL_TOKEN_EXISTS  */
    SQL_TOKEN_FALSE = 287,         /* SQL_TOKEN_FALSE  */
    SQL_TOKEN_FROM = 288,          /* SQL_TOKEN_FROM  */
    SQL_TOKEN_FULL = 289,          /* SQL_TOKEN_FULL  */
    SQL_TOKEN_GROUP = 290,         /* SQL_TOKEN_GROUP  */
    SQL_TOKEN_HAVING = 291,        /* SQL_TOKEN_HAVING  */
    SQL_TOKEN_IN = 292,            /* SQL_TOKEN_IN  */
    SQL_TOKEN_INNER = 293,         /* SQL_TOKEN_INNER  */
    SQL_TOKEN_INSERT = 294,        /* SQL_TOKEN_INSERT  */
    SQL_TOKEN_INTO = 295,          /* SQL_TOKEN_INTO  */
    SQL_TOKEN_IS = 296,            /* SQL_TOKEN_IS  */
    SQL_TOKEN_INTERSECT = 297,     /* SQL_TOKEN_INTERSECT  */
    SQL_TOKEN_JOIN = 298,          /* SQL_TOKEN_JOIN  */
    SQL_TOKEN_LIKE = 299,          /* SQL_TOKEN_LIKE  */
    SQL_TOKEN_LEFT = 300,          /* SQL_TOKEN_LEFT  */
    SQL_TOKEN_RIGHT = 301,         /* SQL_TOKEN_RIGHT  */
    SQL_TOKEN_MAX = 302,           /* SQL_TOKEN_MAX  */
    SQL_TOKEN_MIN = 303,           /* SQL_TOKEN_MIN  */
    SQL_TOKEN_NATURAL = 304,       /* SQL_TOKEN_NATURAL  */
    SQL_TOKEN_NULL = 305,          /* SQL_TOKEN_NULL  */
    SQL_TOKEN_ON = 306,            /* SQL_TOKEN_ON  */
    SQL_TOKEN_ORDER = 307,         /* SQL_TOKEN_ORDER  */
    SQL_TOKEN_OUTER = 308,         /* SQL_TOKEN_OUTER  */
    SQL_TOKEN_ROLLBACK = 309,      /* SQL_TOKEN_ROLLBACK  */
    SQL_TOKEN_IIF = 310,           /* SQL_TOKEN_IIF  */
    SQL_TOKEN_SELECT = 311,        /* SQL_TOKEN_SELECT  */
    SQL_TOKEN_SET = 312,           /* SQL_TOKEN_SET  */
    SQL_TOKEN_SOME = 313,          /* SQL_TOKEN_SOME  */
    SQL_TOKEN_SUM = 314,           /* SQL_TOKEN_SUM  */
    SQL_TOKEN_TRUE = 315,          /* SQL_TOKEN_TRUE  */
    SQL_TOKEN_UNION = 316,         /* SQL_TOKEN_UNION  */
    SQL_TOKEN_UNIQUE = 317,        /* SQL_TOKEN_UNIQUE  */
    SQL_TOKEN_UNKNOWN = 318,       /* SQL_TOKEN_UNKNOWN  */
    SQL_TOKEN_UPDATE = 319,        /* SQL_TOKEN_UPDATE  */
    SQL_TOKEN_USING = 320,         /* SQL_TOKEN_USING  */
    SQL_TOKEN_VALUE = 321,         /* SQL_TOKEN_VALUE  */
    SQL_TOKEN_VALUES = 322,        /* SQL_TOKEN_VALUES  */
    SQL_TOKEN_WHERE = 323,         /* SQL_TOKEN_WHERE  */
    SQL_TOKEN_DOLLAR = 324,        /* SQL_TOKEN_DOLLAR  */
    ...
    SQL_ARROW = 359,               /* SQL_ARROW  */
    SQL_BITWISE_OR = 360,          /* SQL_BITWISE_OR  */
    SQL_BITWISE_AND = 361,         /* SQL_BITWISE_AND  */
    SQL_BITWISE_SHIFT_LEFT = 362,  /* SQL_BITWISE_SHIFT_LEFT  */
    SQL_BITWISE_SHIFT_RIGHT = 363, /* SQL_BITWISE_SHIFT_RIGHT  */
    SQL_LESSEQ = 364,              /* SQL_LESSEQ  */
    SQL_GREATEQ = 365,             /* SQL_GREATEQ  */
    SQL_NOTEQUAL = 366,            /* SQL_NOTEQUAL  */
    SQL_LESS = 367,                /* SQL_LESS  */
    SQL_GREAT = 368,               /* SQL_GREAT  */
    SQL_EQUAL = 369,               /* SQL_EQUAL  */
    SQL_CONCAT = 370,              /* SQL_CONCAT  */
    SQL_TOKEN_INVALIDSYMBOL = 371  /* SQL_TOKEN_INVALIDSYMBOL  */
  };
