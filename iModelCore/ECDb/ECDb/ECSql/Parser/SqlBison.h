...
#ifndef YY_SQLYY_D_BSW_GIT_NATIVE_SCHEMA_LOCK_SRC_IMODEL_NATIVE_IMODELCORE_ECDB_SCRIPTS_ECDB_ECSQL_PARSER_SQLBISON_H_INCLUDED
# define YY_SQLYY_D_BSW_GIT_NATIVE_SCHEMA_LOCK_SRC_IMODEL_NATIVE_IMODELCORE_ECDB_SCRIPTS_ECDB_ECSQL_PARSER_SQLBISON_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    SQL_TOKEN_CURRENT_DATE = 327,  /* SQL_TOKEN_CURRENT_DATE  */
    SQL_TOKEN_CURRENT_TIME = 328,  /* SQL_TOKEN_CURRENT_TIME  */
    SQL_TOKEN_CURRENT_TIMESTAMP = 329, /* SQL_TOKEN_CURRENT_TIMESTAMP  */
    SQL_TOKEN_EVERY = 330,         /* SQL_TOKEN_EVERY  */
    SQL_TOKEN_CASE = 331,          /* SQL_TOKEN_CASE  */
    SQL_TOKEN_THEN = 332,          /* SQL_TOKEN_THEN  */
    SQL_TOKEN_END = 333,           /* SQL_TOKEN_END  */
    SQL_TOKEN_WHEN = 334,          /* SQL_TOKEN_WHEN  */
    SQL_TOKEN_ELSE = 335,          /* SQL_TOKEN_ELSE  */
    SQL_TOKEN_LIMIT = 336,         /* SQL_TOKEN_LIMIT  */
    SQL_TOKEN_OFFSET = 337,        /* SQL_TOKEN_OFFSET  */
    SQL_TOKEN_ONLY = 338,          /* SQL_TOKEN_ONLY  */
    SQL_TOKEN_PRAGMA = 339,        /* SQL_TOKEN_PRAGMA  */
    SQL_TOKEN_FOR = 340,           /* SQL_TOKEN_FOR  */
    SQL_TOKEN_MATCH = 341,         /* SQL_TOKEN_MATCH  */
    SQL_TOKEN_ECSQLOPTIONS = 342,  /* SQL_TOKEN_ECSQLOPTIONS  */
    SQL_TOKEN_INTEGER = 343,       /* SQL_TOKEN_INTEGER  */
    SQL_TOKEN_INT = 344,           /* SQL_TOKEN_INT  */
    SQL_TOKEN_INT64 = 345,         /* SQL_TOKEN_INT64  */
    SQL_TOKEN_LONG = 346,          /* SQL_TOKEN_LONG  */
    SQL_TOKEN_BOOLEAN = 347,       /* SQL_TOKEN_BOOLEAN  */
    SQL_TOKEN_DOUBLE = 348,        /* SQL_TOKEN_DOUBLE  */
    SQL_TOKEN_REAL = 349,          /* SQL_TOKEN_REAL  */
    SQL_TOKEN_FLOAT = 350,         /* SQL_TOKEN_FLOAT  */
    SQL_TOKEN_STRING = 351,        /* SQL_TOKEN_STRING  */
    SQL_TOKEN_VARCHAR = 352,       /* SQL_TOKEN_VARCHAR  */
    SQL_TOKEN_BINARY = 353,        /* SQL_TOKEN_BINARY  */
    SQL_TOKEN_BLOB = 354,          /* SQL_TOKEN_BLOB  */
    SQL_TOKEN_DATE = 355,          /* SQL_TOKEN_DATE  */
    SQL_TOKEN_TIME = 356,          /* SQL_TOKEN_TIME  */
    SQL_TOKEN_TIMESTAMP = 357,     /* SQL_TOKEN_TIMESTAMP  */
    SQL_TOKEN_OR = 358,            /* SQL_TOKEN_OR  */
    SQL_TOKEN_AND = 359,           /* SQL_TOKEN_AND  */
    SQL_ARROW = 360,               /* SQL_ARROW  */
    SQL_BITWISE_OR = 361,          /* SQL_BITWISE_OR  */
    SQL_BITWISE_AND = 362,         /* SQL_BITWISE_AND  */
    SQL_BITWISE_SHIFT_LEFT = 363,  /* SQL_BITWISE_SHIFT_LEFT  */
    SQL_BITWISE_SHIFT_RIGHT = 364, /* SQL_BITWISE_SHIFT_RIGHT  */
    SQL_LESSEQ = 365,              /* SQL_LESSEQ  */
    SQL_GREATEQ = 366,             /* SQL_GREATEQ  */
    SQL_NOTEQUAL = 367,            /* SQL_NOTEQUAL  */
    SQL_LESS = 368,                /* SQL_LESS  */
    SQL_GREAT = 369,               /* SQL_GREAT  */
    SQL_EQUAL = 370,               /* SQL_EQUAL  */
    SQL_CONCAT = 371,              /* SQL_CONCAT  */
    SQL_TOKEN_INVALIDSYMBOL = 372  /* SQL_TOKEN_INVALIDSYMBOL  */
  };
...
#endif /* !YY_SQLYY_D_BSW_GIT_NATIVE_SCHEMA_LOCK_SRC_IMODEL_NATIVE_IMODELCORE_ECDB_SCRIPTS_ECDB_ECSQL_PARSER_SQLBISON_H_INCLUDED  */
