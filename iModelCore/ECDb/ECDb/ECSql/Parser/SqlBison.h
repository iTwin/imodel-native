...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    SQL_TOKEN_DEFAULT = 282,       /* SQL_TOKEN_DEFAULT  */
    SQL_TOKEN_DELETE = 283,        /* SQL_TOKEN_DELETE  */
    SQL_TOKEN_DESC = 284,          /* SQL_TOKEN_DESC  */
    SQL_TOKEN_DISTINCT = 285,      /* SQL_TOKEN_DISTINCT  */
    SQL_TOKEN_FORWARD = 286,       /* SQL_TOKEN_FORWARD  */
    SQL_TOKEN_BACKWARD = 287,      /* SQL_TOKEN_BACKWARD  */
    SQL_TOKEN_ESCAPE = 288,        /* SQL_TOKEN_ESCAPE  */
    SQL_TOKEN_EXCEPT = 289,        /* SQL_TOKEN_EXCEPT  */
    SQL_TOKEN_EXISTS = 290,        /* SQL_TOKEN_EXISTS  */
    SQL_TOKEN_FALSE = 291,         /* SQL_TOKEN_FALSE  */
    SQL_TOKEN_FROM = 292,          /* SQL_TOKEN_FROM  */
    SQL_TOKEN_FULL = 293,          /* SQL_TOKEN_FULL  */
    SQL_TOKEN_GROUP = 294,         /* SQL_TOKEN_GROUP  */
    SQL_TOKEN_HAVING = 295,        /* SQL_TOKEN_HAVING  */
    SQL_TOKEN_IN = 296,            /* SQL_TOKEN_IN  */
    SQL_TOKEN_INNER = 297,         /* SQL_TOKEN_INNER  */
    SQL_TOKEN_INSERT = 298,        /* SQL_TOKEN_INSERT  */
    SQL_TOKEN_INTO = 299,          /* SQL_TOKEN_INTO  */
    SQL_TOKEN_IS = 300,            /* SQL_TOKEN_IS  */
    SQL_TOKEN_INTERSECT = 301,     /* SQL_TOKEN_INTERSECT  */
    SQL_TOKEN_JOIN = 302,          /* SQL_TOKEN_JOIN  */
    SQL_TOKEN_LIKE = 303,          /* SQL_TOKEN_LIKE  */
    SQL_TOKEN_LEFT = 304,          /* SQL_TOKEN_LEFT  */
    SQL_TOKEN_RIGHT = 305,         /* SQL_TOKEN_RIGHT  */
    SQL_TOKEN_MAX = 306,           /* SQL_TOKEN_MAX  */
    SQL_TOKEN_MIN = 307,           /* SQL_TOKEN_MIN  */
    SQL_TOKEN_NATURAL = 308,       /* SQL_TOKEN_NATURAL  */
    SQL_TOKEN_NULL = 309,          /* SQL_TOKEN_NULL  */
    ...
    SQL_TOKEN_OR = 361,            /* SQL_TOKEN_OR  */
    SQL_TOKEN_AND = 362,           /* SQL_TOKEN_AND  */
    SQL_ARROW = 363,               /* SQL_ARROW  */
    SQL_BITWISE_OR = 364,          /* SQL_BITWISE_OR  */
    SQL_BITWISE_AND = 365,         /* SQL_BITWISE_AND  */
    SQL_BITWISE_SHIFT_LEFT = 366,  /* SQL_BITWISE_SHIFT_LEFT  */
    SQL_BITWISE_SHIFT_RIGHT = 367, /* SQL_BITWISE_SHIFT_RIGHT  */
    SQL_LESSEQ = 368,              /* SQL_LESSEQ  */
    SQL_GREATEQ = 369,             /* SQL_GREATEQ  */
    SQL_NOTEQUAL = 370,            /* SQL_NOTEQUAL  */
    SQL_LESS = 371,                /* SQL_LESS  */
    SQL_GREAT = 372,               /* SQL_GREAT  */
    SQL_EQUAL = 373,               /* SQL_EQUAL  */
    SQL_CONCAT = 374,              /* SQL_CONCAT  */
    SQL_TOKEN_INVALIDSYMBOL = 375  /* SQL_TOKEN_INVALIDSYMBOL  */
  };
