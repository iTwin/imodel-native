...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    SQL_TOKEN_GROUP_CONCAT = 310,  /* SQL_TOKEN_GROUP_CONCAT  */
    SQL_TOKEN_ON = 311,            /* SQL_TOKEN_ON  */
    SQL_TOKEN_ORDER = 312,         /* SQL_TOKEN_ORDER  */
    SQL_TOKEN_OUTER = 313,         /* SQL_TOKEN_OUTER  */
    SQL_TOKEN_ROLLBACK = 314,      /* SQL_TOKEN_ROLLBACK  */
    SQL_TOKEN_IIF = 315,           /* SQL_TOKEN_IIF  */
    SQL_TOKEN_SELECT = 316,        /* SQL_TOKEN_SELECT  */
    SQL_TOKEN_SET = 317,           /* SQL_TOKEN_SET  */
    SQL_TOKEN_SOME = 318,          /* SQL_TOKEN_SOME  */
    SQL_TOKEN_SUM = 319,           /* SQL_TOKEN_SUM  */
    SQL_TOKEN_TRUE = 320,          /* SQL_TOKEN_TRUE  */
    SQL_TOKEN_UNION = 321,         /* SQL_TOKEN_UNION  */
    SQL_TOKEN_UNIQUE = 322,        /* SQL_TOKEN_UNIQUE  */
    SQL_TOKEN_UNKNOWN = 323,       /* SQL_TOKEN_UNKNOWN  */
    SQL_TOKEN_UPDATE = 324,        /* SQL_TOKEN_UPDATE  */
    SQL_TOKEN_USING = 325,         /* SQL_TOKEN_USING  */
    SQL_TOKEN_VALUE = 326,         /* SQL_TOKEN_VALUE  */
    SQL_TOKEN_VALUES = 327,        /* SQL_TOKEN_VALUES  */
    SQL_TOKEN_WHERE = 328,         /* SQL_TOKEN_WHERE  */
    SQL_TOKEN_DOLLAR = 329,        /* SQL_TOKEN_DOLLAR  */
    SQL_BITWISE_NOT = 330,         /* SQL_BITWISE_NOT  */
    SQL_TOKEN_CURRENT_DATE = 331,  /* SQL_TOKEN_CURRENT_DATE  */
    SQL_TOKEN_CURRENT_TIME = 332,  /* SQL_TOKEN_CURRENT_TIME  */
    SQL_TOKEN_CURRENT_TIMESTAMP = 333, /* SQL_TOKEN_CURRENT_TIMESTAMP  */
    SQL_TOKEN_EVERY = 334,         /* SQL_TOKEN_EVERY  */
    SQL_TOKEN_CASE = 335,          /* SQL_TOKEN_CASE  */
    SQL_TOKEN_THEN = 336,          /* SQL_TOKEN_THEN  */
    SQL_TOKEN_END = 337,           /* SQL_TOKEN_END  */
    SQL_TOKEN_WHEN = 338,          /* SQL_TOKEN_WHEN  */
    SQL_TOKEN_ELSE = 339,          /* SQL_TOKEN_ELSE  */
    SQL_TOKEN_LIMIT = 340,         /* SQL_TOKEN_LIMIT  */
    SQL_TOKEN_OFFSET = 341,        /* SQL_TOKEN_OFFSET  */
    SQL_TOKEN_ONLY = 342,          /* SQL_TOKEN_ONLY  */
    SQL_TOKEN_PRAGMA = 343,        /* SQL_TOKEN_PRAGMA  */
    SQL_TOKEN_FOR = 344,           /* SQL_TOKEN_FOR  */
    SQL_TOKEN_MATCH = 345,         /* SQL_TOKEN_MATCH  */
    SQL_TOKEN_ECSQLOPTIONS = 346,  /* SQL_TOKEN_ECSQLOPTIONS  */
    SQL_TOKEN_INTEGER = 347,       /* SQL_TOKEN_INTEGER  */
    SQL_TOKEN_INT = 348,           /* SQL_TOKEN_INT  */
    SQL_TOKEN_INT64 = 349,         /* SQL_TOKEN_INT64  */
    SQL_TOKEN_LONG = 350,          /* SQL_TOKEN_LONG  */
    SQL_TOKEN_BOOLEAN = 351,       /* SQL_TOKEN_BOOLEAN  */
    SQL_TOKEN_DOUBLE = 352,        /* SQL_TOKEN_DOUBLE  */
    SQL_TOKEN_REAL = 353,          /* SQL_TOKEN_REAL  */
    SQL_TOKEN_FLOAT = 354,         /* SQL_TOKEN_FLOAT  */
    SQL_TOKEN_STRING = 355,        /* SQL_TOKEN_STRING  */
    SQL_TOKEN_VARCHAR = 356,       /* SQL_TOKEN_VARCHAR  */
    SQL_TOKEN_BINARY = 357,        /* SQL_TOKEN_BINARY  */
    SQL_TOKEN_BLOB = 358,          /* SQL_TOKEN_BLOB  */
    SQL_TOKEN_DATE = 359,          /* SQL_TOKEN_DATE  */
    SQL_TOKEN_TIME = 360,          /* SQL_TOKEN_TIME  */
    SQL_TOKEN_TIMESTAMP = 361,     /* SQL_TOKEN_TIMESTAMP  */
    SQL_TOKEN_OVER = 362,          /* SQL_TOKEN_OVER  */
    SQL_TOKEN_ROW_NUMBER = 363,    /* SQL_TOKEN_ROW_NUMBER  */
    SQL_TOKEN_NTILE = 364,         /* SQL_TOKEN_NTILE  */
    SQL_TOKEN_LEAD = 365,          /* SQL_TOKEN_LEAD  */
    SQL_TOKEN_LAG = 366,           /* SQL_TOKEN_LAG  */
    SQL_TOKEN_FIRST_VALUE = 367,   /* SQL_TOKEN_FIRST_VALUE  */
    SQL_TOKEN_LAST_VALUE = 368,    /* SQL_TOKEN_LAST_VALUE  */
    SQL_TOKEN_NTH_VALUE = 369,     /* SQL_TOKEN_NTH_VALUE  */
    SQL_TOKEN_EXCLUDE = 370,       /* SQL_TOKEN_EXCLUDE  */
    SQL_TOKEN_OTHERS = 371,        /* SQL_TOKEN_OTHERS  */
    SQL_TOKEN_TIES = 372,          /* SQL_TOKEN_TIES  */
    SQL_TOKEN_FOLLOWING = 373,     /* SQL_TOKEN_FOLLOWING  */
    SQL_TOKEN_UNBOUNDED = 374,     /* SQL_TOKEN_UNBOUNDED  */
    SQL_TOKEN_PRECEDING = 375,     /* SQL_TOKEN_PRECEDING  */
    SQL_TOKEN_RANGE = 376,         /* SQL_TOKEN_RANGE  */
    SQL_TOKEN_ROWS = 377,          /* SQL_TOKEN_ROWS  */
    SQL_TOKEN_PARTITION = 378,     /* SQL_TOKEN_PARTITION  */
    SQL_TOKEN_WINDOW = 379,        /* SQL_TOKEN_WINDOW  */
    SQL_TOKEN_NO = 380,            /* SQL_TOKEN_NO  */
    SQL_TOKEN_CURRENT = 381,       /* SQL_TOKEN_CURRENT  */
    SQL_TOKEN_ROW = 382,           /* SQL_TOKEN_ROW  */
    SQL_TOKEN_RANK = 383,          /* SQL_TOKEN_RANK  */
    SQL_TOKEN_DENSE_RANK = 384,    /* SQL_TOKEN_DENSE_RANK  */
    SQL_TOKEN_PERCENT_RANK = 385,  /* SQL_TOKEN_PERCENT_RANK  */
    SQL_TOKEN_CUME_DIST = 386,     /* SQL_TOKEN_CUME_DIST  */
    SQL_TOKEN_COLLATE = 387,       /* SQL_TOKEN_COLLATE  */
