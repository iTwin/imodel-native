            ...
            struct
                ...
                Utf8String          sRuleName;  // the name of the rule ("single_select_statement")
                }   aRuleDescriptions[] =
                    {
                            ...
                            {OSQLParseNode::opt_null_treatment, "opt_null_treatment"},
                            ...
                            {OSQLParseNode::offset, "offset"},
                            {OSQLParseNode::default_expression, "default_expression"},
                            {OSQLParseNode::null_treatment, "null_treatment"},
                            ...
                            {OSQLParseNode::opt_from_first_or_last, "opt_from_first_or_last"},
                            {OSQLParseNode::nth_value_function, "nth_value_function"},
                            {OSQLParseNode::nth_row, "nth_row"},
                            {OSQLParseNode::from_first_or_last, "from_first_or_last"},
