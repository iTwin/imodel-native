            ...
            struct
                ...
                Utf8String          sRuleName;  // the name of the rule ("single_select_statement")
                }   aRuleDescriptions[] =
                    {
                            ...
                            {OSQLParseNode::conflict_target, "conflict_target"},
                            ...
                            {OSQLParseNode::on_conflict_clause, "on_conflict_clause"},
                            {OSQLParseNode::on_conflict_do_clause, "on_conflict_do_clause"},
                            ...
                            {OSQLParseNode::opt_on_conflict_clause, "opt_on_conflict_clause"},
