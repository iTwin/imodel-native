...
// @bsimethod
//+---------------+---------------+---------------+---------------+---------------+------
JsonECSqlValue::JsonECSqlValue(ECDbCR ecdb, rapidjson::Value const& json, ECSqlColumnInfo const& columnInfo)
...
// @bsimethod
//+---------------+---------------+---------------+---------------+---------------+------
void const* JsonECSqlValue::_GetBlob(int* blobSize) const
    {
...
// @bsimethod
//+---------------+---------------+---------------+---------------+---------------+------
bool JsonECSqlValue::_GetBoolean() const
    {
...
// @bsimethod
//+---------------+---------------+---------------+---------------+---------------+------
uint64_t JsonECSqlValue::_GetDateTimeJulianDaysMsec(DateTime::Info& metadata) const
    {
...
// @bsimethod
//+---------------+---------------+---------------+---------------+---------------+------
double JsonECSqlValue::_GetDateTimeJulianDays(DateTime::Info& metadata) const
    {
...
// @bsimethod
//+---------------+---------------+---------------+---------------+---------------+------
double JsonECSqlValue::_GetDouble() const
    {
...
// @bsimethod
//+---------------+---------------+---------------+---------------+---------------+------
int JsonECSqlValue::_GetInt() const
    {
...
// @bsimethod
//+---------------+---------------+---------------+---------------+---------------+------
int64_t JsonECSqlValue::_GetInt64() const
    {
...
// @bsimethod
//+---------------+---------------+---------------+---------------+---------------+------
Utf8CP JsonECSqlValue::_GetText() const
    {
...
// @bsimethod
//+---------------+---------------+---------------+---------------+---------------+------
DPoint2d JsonECSqlValue::_GetPoint2d() const
    {
...
// @bsimethod
//+---------------+---------------+---------------+---------------+---------------+------
DPoint3d JsonECSqlValue::_GetPoint3d() const
    {
...
// @bsimethod
//+---------------+---------------+---------------+---------------+---------------+------
IGeometryPtr JsonECSqlValue::_GetGeometry() const
    {
...
// @bsimethod
//---------------------------------------------------------------------------------------
IECSqlValue const& JsonECSqlValue::_GetStructMemberValue(Utf8CP memberName) const
    {
...
// @bsimethod
//---------------------------------------------------------------------------------------
IECSqlValueIterable const& JsonECSqlValue::_GetStructIterable() const
    {
    if (!m_columnInfo.GetDataType().IsStruct())
        {
...
// @bsimethod
//---------------------------------------------------------------------------------------
int JsonECSqlValue::_GetArrayLength() const
    {
    if (!m_columnInfo.GetDataType().IsArray())
        {
...
// @bsimethod
//---------------------------------------------------------------------------------------
IECSqlValueIterable const& JsonECSqlValue::_GetArrayIterable() const
    {
    if (!m_columnInfo.GetDataType().IsArray())
        {
...
// @bsimethod
//---------------------------------------------------------------------------------------
IECSqlValueIterable::const_iterator JsonECSqlValue::_CreateIterator() const
    {
...
// @bsimethod
//+---------------+---------------+---------------+---------------+---------------+------
IECSqlValue const& JsonECSqlValue::CreateStructMemberValue(ECN::ECPropertyCR memberProp) const
    {
...
// @bsimethod
//+---------------+---------------+---------------+---------------+---------------+------
bool JsonECSqlValue::CanCallGetFor(ECN::PrimitiveType getMethodType) const
    {
...
//+---------------+---------------+---------------+---------------+---------------+------
//static
Utf8CP JsonECSqlValue::GetPrimitiveGetMethodName(ECN::PrimitiveType getMethodType)
    {
...
//**************************** JsonECSqlValue::ArrayIteratorState ****************

//---------------------------------------------------------------------------------------
// @bsimethod
//---------------------------------------------------------------------------------------
void JsonECSqlValue::ArrayIteratorState::_MoveToNext(bool onInitializingIterator) const
    {
...
// @bsimethod
//---------------------------------------------------------------------------------------
IECSqlValue const& JsonECSqlValue::ArrayIteratorState::_GetCurrent() const
    {
...
//**************************** JsonECSqlValue::StructIteratorState ****************

//---------------------------------------------------------------------------------------
// @bsimethod
//---------------------------------------------------------------------------------------
JsonECSqlValue::StructIteratorState::StructIteratorState(JsonECSqlValue const& val, ECN::ECPropertyIterableCR structMemberPropertyIterable)
...
// @bsimethod
//---------------------------------------------------------------------------------------
void JsonECSqlValue::StructIteratorState::_MoveToNext(bool onInitializingIterator) const
    {
...
// @bsimethod
//---------------------------------------------------------------------------------------
IECSqlValue const& JsonECSqlValue::StructIteratorState::_GetCurrent() const
    {
