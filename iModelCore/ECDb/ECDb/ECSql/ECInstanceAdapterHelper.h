...
struct ECValueBindingInfoCollection final {
   public:
    ...
    struct const_iterator final {
        ...
        using value_type = ECValueBindingInfo const*;
        using difference_type = std::ptrdiff_t;
        using pointer = ECValueBindingInfo const**;
        using reference = ECValueBindingInfo const*&;
   ...
   public:
    struct ECInstanceInfo final {
       ...
       public:
        ...
        ECN::IECInstanceCR GetInstance() const {
            BeAssert(HasInstance());
            return *m_instance;
        }
        bool AllowPointersIntoInstanceMemory() const {
            BeAssert(HasInstance());
            return m_allowPointersIntoInstanceMemory;
        }
