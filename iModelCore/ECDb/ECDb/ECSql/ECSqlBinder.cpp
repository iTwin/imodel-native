    ...
    switch (propMap.GetType())
        {
            ...
            if (!classMap.GetUpdatableViewInfo().HasView() && contextTable.GetType() == DbTable::Type::Virtual)
            ...
            if (!classMap.GetUpdatableViewInfo().HasView() && col.GetTable().GetType() == DbTable::Type::Virtual)
                return true;
