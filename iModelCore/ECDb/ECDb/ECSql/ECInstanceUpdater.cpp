...
// @bsimethod
//+---------------+---------------+---------------+---------------+---------------+------
DbResult ECInstanceUpdater::Update(ECN::IECInstanceCR instance) const {
...
DbResult ECInstanceUpdater::Impl::Update(IECInstanceCR instance) const {
    ...
    if ((nullptr != relationshipInstance) && (relationshipInstance->GetSource().IsValid())) {
        ...
        Utf8String ecSql("SELECT " ECDBSYS_PROP_SourceECInstanceId "," ECDBSYS_PROP_SourceECClassId "," ECDBSYS_PROP_TargetECInstanceId "," ECDBSYS_PROP_TargetECClassId " FROM ");
