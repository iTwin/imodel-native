...
//+---------------+---------------+---------------+---------------+---------------+------
// static
ECSqlStatus JsonECSqlBinder::BindPrimitiveArrayValue(IECSqlBinder& binder, BeJsConst arrayJson, PrimitiveType primType) {
    return BindArrayValue(binder, arrayJson, &primType, nullptr);
}
...
//+---------------+---------------+---------------+---------------+---------------+------
// static
ECSqlStatus JsonECSqlBinder::BindStructArrayValue(IECSqlBinder& binder, BeJsConst arrayJson, ECStructClassCR structType) {
    return BindArrayValue(binder, arrayJson, nullptr, &structType);
}
...
ECSqlStatus JsonECSqlBinder::BindArrayValue(IECSqlBinder& binder, BeJsConst arrayJson, PrimitiveType const* primType, ECStructClassCP structType) {
    ...
    arrayJson.ForEachArrayMember([&](Json::ArrayIndex i, BeJsConst arrayElemJson) {
        stat = isPrimitive ? BindPrimitiveValue(binder.AddArrayElement(), arrayElemJson, *primType) : BindStructValue(binder.AddArrayElement(), arrayElemJson, *structType);
...
//+---------------+---------------+---------------+---------------+---------------+------
// static
ECSqlStatus JsonECSqlBinder::BindPrimitiveArrayValue(IECSqlBinder& binder, RapidJsonValueCR arrayJson, PrimitiveType primType) {
    return BindArrayValue(binder, arrayJson, &primType, nullptr);
}
...
//+---------------+---------------+---------------+---------------+---------------+------
// static
ECSqlStatus JsonECSqlBinder::BindStructArrayValue(IECSqlBinder& binder, RapidJsonValueCR arrayJson, ECStructClassCR structType) {
    return BindArrayValue(binder, arrayJson, nullptr, &structType);
}
...
ECSqlStatus JsonECSqlBinder::BindArrayValue(IECSqlBinder& binder, RapidJsonValueCR arrayJson, PrimitiveType const* primType, ECStructClassCP structType) {
    ...
    for (RapidJsonValueCR arrayElemJson : arrayJson.GetArray()) {
        ECSqlStatus stat = isPrimitive ? BindPrimitiveValue(binder.AddArrayElement(), arrayElemJson, *primType) : BindStructValue(binder.AddArrayElement(), arrayElemJson, *structType);
