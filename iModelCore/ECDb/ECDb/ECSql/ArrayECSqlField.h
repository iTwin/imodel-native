...
public:
    ArrayECSqlField(IECSqlFieldReader& reader, ECSqlColumnInfo const& colInfo, int sqliteColumnIndex) : ECSqlField(reader, colInfo, true, true), m_sqliteColumnIndex(sqliteColumnIndex) {}
    ~ArrayECSqlField() {}
    };
