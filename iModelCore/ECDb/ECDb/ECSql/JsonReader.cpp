...
//@bsimethod
//+---------------+---------------+---------------+---------------+---------------+------
JsonReader::JsonReader(ECDbCR ecdb, ECClassCR ecClass, JsonECSqlSelectAdapter::FormatOptions const& formatOptions) : m_ecdb(ecdb), m_formatOptions(formatOptions) {
    m_isValid = Initialize(ecClass) == SUCCESS;
}

//---------------------------------------------------------------------------------------
//@bsimethod
//+---------------+---------------+---------------+---------------+---------------+------
JsonReader::JsonReader(ECDbCR ecdb, ECClassId ecClassId, JsonECSqlSelectAdapter::FormatOptions const& formatOptions) : m_ecdb(ecdb), m_formatOptions(formatOptions) {
