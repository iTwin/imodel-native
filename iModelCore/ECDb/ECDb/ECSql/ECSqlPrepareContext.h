...
struct ECSqlPrepareContext final {
    ...
    struct ExpScope final {
       ...
       public:
        ...
        void IncrementNativeSqlSelectClauseColumnCount(size_t value) {
            BeAssert(m_ecsqlType == ECSqlType::Select);
   ...
   public:
    ...
    SingleECSqlPreparedStatement& GetPreparedStatement() const {
        BeAssert(m_singlePreparedStatement != nullptr);
        return *m_singlePreparedStatement;
    }
    ...
    int IncrementSystemSqlParameterSuffix() {
        m_nextSystemSqlParameterNameSuffix++;
        return m_nextSystemSqlParameterNameSuffix;
    }
