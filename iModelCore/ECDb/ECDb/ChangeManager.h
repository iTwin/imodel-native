...
struct ChangeManager final
    ...
    private:
        ...
        mutable BeFileName m_cacheFilePath;
    ...
    public:
        ...
        void OnDbAttached(DbTableSpace const&, Utf8CP fileName) const;
        ...
        static BentleyStatus ValidateChangeCache(ECDbCR changeCache, IssueDataSource const&);
