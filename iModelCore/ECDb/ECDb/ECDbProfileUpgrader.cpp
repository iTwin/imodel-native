...
Utf8CP ECDbProfileECSchemaUpgrader::GetECDbSystemECSchemaXml ()
    ...
    return "<?xml version='1.0' encoding='utf-8'?> "
        ...
        "    </ECClass> "
        "    <ECClass typeName='ArrayOfGeometry' isDomainClass='True' isStruct='True' > "
        "        <BaseClass>ArrayOfPrimitives</BaseClass> "
        "        <ECArrayProperty propertyName='PrimitiveArray' typeName='Bentley.Geometry.Common.IGeometry'/> "
        "    </ECClass> "
