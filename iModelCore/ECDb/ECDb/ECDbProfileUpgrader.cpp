...
Utf8CP ECDbProfileECSchemaUpgrader::GetECDbSystemECSchemaXml ()
    ...
    return "<?xml version='1.0' encoding='utf-8'?> "
        ...
        "    </ECCustomAttributes> "
        "    <ECClass typeName='PrimitiveArray' isDomainClass='True'> "
        "        <ECCustomAttributes> "
        ...
        "        </ECCustomAttributes> "
        "    </ECClass> "
        "    <ECClass typeName='BinaryArray' isDomainClass='True' > "
        "        <BaseClass>PrimitiveArray</BaseClass> "
        "        <ECArrayProperty propertyName='Array' typeName='binary'/> "
        "    </ECClass> "
        "    <ECClass typeName='BooleanArray' isDomainClass='True' > "
        "        <BaseClass>PrimitiveArray</BaseClass> "
        "        <ECArrayProperty propertyName='Array' typeName='boolean'/> "
        "    </ECClass> "
        "    <ECClass typeName='DateTimeArray' isDomainClass='True' > "
        "        <BaseClass>PrimitiveArray</BaseClass> "
        "        <ECArrayProperty propertyName='Array' typeName='dateTime'/> "
        "    </ECClass> "
        "    <ECClass typeName='DoubleArray' isDomainClass='True' > "
        "        <BaseClass>PrimitiveArray</BaseClass> "
        "        <ECArrayProperty propertyName='Array' typeName='double'/> "
        "    </ECClass> "
        "    <ECClass typeName='IntegerArray' isDomainClass='True' > "
        "        <BaseClass>PrimitiveArray</BaseClass> "
        "        <ECArrayProperty propertyName='Array' typeName='int'/> "
        "    </ECClass> "
        "    <ECClass typeName='GeometryArray' isDomainClass='True' > "
        "        <BaseClass>PrimitiveArray</BaseClass> "
        "        <ECArrayProperty propertyName='Array' typeName='Bentley.Geometry.Common.IGeometry'/> "
        "    </ECClass> "
        "    <ECClass typeName='LongArray' isDomainClass='True' > "
        "        <BaseClass>PrimitiveArray</BaseClass> "
        "        <ECArrayProperty propertyName='Array' typeName='long'/> "
        "    </ECClass> "
        "    <ECClass typeName='Point2dArray' isDomainClass='True' > "
        "        <BaseClass>PrimitiveArray</BaseClass> "
        "        <ECArrayProperty propertyName='Array' typeName='point2d'/> "
        "    </ECClass> "
        "    <ECClass typeName='Point3dArray' isDomainClass='True'> "
        "        <BaseClass>PrimitiveArray</BaseClass> "
        "        <ECArrayProperty propertyName='Array' typeName='point3d'/> "
        "    </ECClass> "
        "    <ECClass typeName='StringArray' isDomainClass='True' > "
        "        <BaseClass>PrimitiveArray</BaseClass> "
        "        <ECArrayProperty propertyName='Array' typeName='string'/> "
        "    </ECClass> "
        "    <ECClass typeName='ECSqlSystemProperties' isDomainClass='False' isStruct='False' isCustomAttributeClass='False' >"
        "        <ECCustomAttributes> "
        "            <ClassMap xmlns='ECDbMap.01.00'> "
        "                <MapStrategy>"
        "                   <Strategy>NotMapped</Strategy>"
