...
DbResult ECDbProfileUpgrader_3701::_Upgrade(ECDbCR ecdb) const
    ...
    DbResult stat = ecdb.ExecuteSql("CREATE TABLE ec_ClassHasTables("
    ...
    stat = ecdb.ExecuteSql("CREATE INDEX ix_ec_ClassHasTables_ClassId ON ec_ClassHasTables(ClassId);"
    ...
    stat= ecdb.ExecuteSql("CREATE INDEX ix_ec_ClassHierarchy_ClassId ON ec_ClassHierarchy(ClassId);"
