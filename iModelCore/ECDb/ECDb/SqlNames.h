...
static_assert((int)ECN::CustomAttributeContainerType::Any == 4095 &&
                  ...
                  (int)ECN::CustomAttributeContainerType::TargetRelationshipConstraint == 2048,
              "Persisted Enum has changed: ECN::CustomAttributeContainerType.");
...
static_assert((int)DbColumn::Type::Any == 0 &&
                  ...
                  (int)DbColumn::Type::TimeStamp == 3,
              "Persisted Enum has changed: DbColumn::Type.");

static_assert((int)ECN::ECClassModifier::Abstract == 1 &&
                  (int)ECN::ECClassModifier::None == 0 &&
                  (int)ECN::ECClassModifier::Sealed == 2,
              "Persisted Enum has changed: ECN::ECClassModifier.");
...
static_assert((int)ECN::ECClassType::CustomAttribute == 3 &&
              ...
              "Persisted Enum has changed: ECN::ECClassType.");
...
static_assert((int)PropertyKind::Navigation == 4 &&
                  ...
                  (int)PropertyKind::StructArray == 3,
              "Persisted Enum has changed: PropertyKind.");

static_assert((int)ECN::StrengthType::Embedding == 2 &&
                  (int)ECN::StrengthType::Holding == 1 &&
                  (int)ECN::StrengthType::Referencing == 0,
              "Persisted Enum has changed: ECN::StrengthType.");

static_assert((int)ECN::ECRelatedInstanceDirection::Backward == 2 &&
                  (int)ECN::ECRelatedInstanceDirection::Forward == 1,
              "Persisted Enum has changed: ECN::ECRelatedInstanceDirection.");

static_assert((int)ECN::ECRelationshipEnd::ECRelationshipEnd_Source == 0 &&
                  (int)ECN::ECRelationshipEnd::ECRelationshipEnd_Target == 1,
              "Persisted Enum has changed: ECN::ECRelationshipEnd.");
...
static_assert((int)ForeignKeyDbConstraint::ActionType::Cascade == 1 &&
                  ...
                  (int)ForeignKeyDbConstraint::ActionType::SetNull == 3,
              "Persisted Enum has changed: ForeignKeyDbConstraint::ActionType.");
...
static_assert((int)SchemaPersistenceHelper::GeneralizedCustomAttributeContainerType::Class == 30 &&
                  ...
                  (int)SchemaPersistenceHelper::GeneralizedCustomAttributeContainerType::TargetRelationshipConstraint == 2048,
              "Persisted Enum has changed: ECDbSchemaPersistenceHelper::GeneralizedCustomAttributeContainerType.");
...
static_assert((int)ECN::PrimitiveType::PRIMITIVETYPE_Binary == 0x101 &&
                  ...
                  (int)ECN::PrimitiveType::PRIMITIVETYPE_String == 0x901,
              "Persisted Enum has changed: ECN::PrimitiveType.");
