...
#define TABLEDDL_UnitSystem "CREATE TABLE " TABLE_UnitSystem                              \
                            ...
                            "DisplayLabel TEXT,"                                          \
                            "Description TEXT);"                                          \
                            "CREATE INDEX ix_ec_UnitSystem_SchemaId ON " TABLE_UnitSystem \
                            "(SchemaId);"                                                 \
...
#define TABLEDDL_Phenomenon "CREATE TABLE " TABLE_Phenomenon                              \
                            ...
                            "CREATE INDEX ix_ec_Phenomenon_SchemaId ON " TABLE_Phenomenon \
                            "(SchemaId);"                                                 \
...
#define TABLEDDL_Unit "CREATE TABLE " TABLE_Unit                                   \
                      ...
                      "DisplayLabel TEXT,"                                         \
                      "Description TEXT,"                                          \
                      "PhenomenonId INTEGER NOT NULL REFERENCES " TABLE_Phenomenon \
                      "(Id) ON DELETE NO ACTION,"                                  \
                      "UnitSystemId INTEGER REFERENCES " TABLE_UnitSystem          \
                      "(Id) ON DELETE NO ACTION,"                                  \
                      ...
                      "Offset REAL,"                                               \
                      "IsConstant BOOLEAN,"                                        \
                      "InvertingUnitId INTEGER REFERENCES " TABLE_Unit             \
                      "(Id) ON DELETE NO ACTION);"                                 \
                      "CREATE INDEX ix_ec_Unit_SchemaId ON " TABLE_Unit            \
                      "(SchemaId);"                                                \
                      "CREATE INDEX ix_ec_Unit_Name ON " TABLE_Unit                \
                      "(Name);"                                                    \
                      "CREATE INDEX ix_ec_Unit_PhenomenonId ON " TABLE_Unit        \
                      "(PhenomenonId);"                                            \
                      "CREATE INDEX ix_ec_Unit_UnitSystemId ON " TABLE_Unit        \
                      "(UnitSystemId);"                                            \
...
#define TABLEDDL_Format "CREATE TABLE " TABLE_Format                          \
                        ...
                        "NumericSpec TEXT,"                                   \
                        "CompositeSpec TEXT);"                                \
                        "CREATE INDEX ix_ec_Format_SchemaId ON " TABLE_Format \
                        "(SchemaId);"                                         \
...
#define TABLEDDL_FormatCompositeUnit "CREATE TABLE " TABLE_FormatCompositeUnit                                                       \
                                     "(Id INTEGER PRIMARY KEY,"                                                                      \
                                     "FormatId INTEGER NOT NULL REFERENCES " TABLE_Format                                            \
                                     "(Id) ON DELETE CASCADE,"                                                                       \
                                     "Label TEXT,"                                                                                   \
                                     "UnitId INTEGER REFERENCES " TABLE_Unit                                                         \
                                     "(Id) ON DELETE NO ACTION,"                                                                     \
                                     "Ordinal INTEGER NOT NULL);"                                                                    \
                                     "CREATE UNIQUE INDEX uix_ec_FormatCompositeUnit_FormatId_Ordinal ON " TABLE_FormatCompositeUnit \
                                     "(FormatId,Ordinal);"                                                                           \
...
// @bsiclass
//+===============+===============+===============+===============+===============+======
struct ProfileUpgrader_4004 final : ProfileUpgrader {
    // intentionally use compiler generated ctor, dtor, copy ctor and copy assignment op
   private:
    DbResult _Upgrade(ECDbCR) const override;
};
