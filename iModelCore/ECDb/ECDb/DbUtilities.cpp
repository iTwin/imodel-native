...
//---------------------------------------------------------------------------------------
// static
bool DbTableSpace::IsMain(Utf8CP tableSpace) {
    return BeStringUtilities::StricmpAscii(tableSpace, TABLESPACE_Main) == 0;
}
...
//---------------------------------------------------------------------------------------
// static
bool DbTableSpace::IsTemp(Utf8CP tableSpace) {
    return BeStringUtilities::StricmpAscii(tableSpace, TABLESPACE_Temp) == 0;
}
