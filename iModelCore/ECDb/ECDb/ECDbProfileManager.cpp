...
//static
const SchemaVersion ECDbProfileManager::MINIMUM_SUPPORTED_VERSION = SchemaVersion(2, 9, 0, 0);
...
DbResult ECDbProfileManager::CreateECProfileTables(ECDbR ecdb)
    ...
    stat = ecdb.ExecuteSql("CREATE TABLE ec_Index("
                           ...
                           "AddNotNullWhereExp BOOL NOT NULL CHECK (AddNotNullWhereExp IN (0,1)), "
