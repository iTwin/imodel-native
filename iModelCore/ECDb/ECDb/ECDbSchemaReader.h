...
struct ECDbSchemaReader
    ...
    private:
        ...
        KindOfQuantityCP GetKindOfQuantity(Context&, Utf8CP schemaName, Utf8CP koqName) const;
    ...
    public:
        ...
        KindOfQuantityCP GetKindOfQuantity(Utf8CP schemaName, Utf8CP koqName) const;
