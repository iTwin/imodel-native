...
// @bsimethod
//---------------------------------------------------------------------------------------
bool ViewGenerator::SelectFromViewContext::IsInSelectClause(Utf8StringCR exp, bool alwaysSelectSystemProperties) const {
    return m_prepareCtx.GetSelectionOptions().IsSelected(exp, alwaysSelectSystemProperties);
}
