...
DbResult ProfileManager::RunUpgraders() const
    ...
    if (m_profileVersion < ProfileVersion(4, 0, 0, 2))
...
DbResult ProfileManager::CreateProfileTables() const
    ...
    return m_ecdb.ExecuteDdl("CREATE INDEX ix_ec_cache_ClassHierarchy_ClassId ON " TABLE_ClassHierarchyCache "(ClassId);"
