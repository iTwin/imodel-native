...
DbResult ProfileManager::CreateProfileTables() const
    ...
    stat = m_ecdb.GetImpl().ExecuteDDL("CREATE UNIQUE INDEX uix_ec_SchemaReference_SchemaId_ReferencedSchemaId ON " TABLE_SchemaReference "(SchemaId,ReferencedSchemaId);"
    ...
    stat = m_ecdb.GetImpl().ExecuteDDL("CREATE INDEX ix_ec_Class_SchemaId_Name ON " TABLE_Class "(SchemaId,Name);"
    ...
    stat = m_ecdb.GetImpl().ExecuteDDL("CREATE UNIQUE INDEX uix_ec_ClassHasBaseClasses_ClassId_BaseClassId ON " TABLE_ClassHasBaseClasses "(ClassId,BaseClassId);"
    ...
    stat = m_ecdb.GetImpl().ExecuteDDL("CREATE INDEX ix_ec_Enumeration_SchemaId ON " TABLE_Enumeration "(SchemaId);"
    ...
    stat = m_ecdb.GetImpl().ExecuteDDL("CREATE INDEX ix_ec_KindOfQuantity_SchemaId ON " TABLE_KindOfQuantity "(SchemaId);"
    ...
    stat = m_ecdb.GetImpl().ExecuteDDL("CREATE INDEX ix_ec_PropertyCategory_SchemaId ON " TABLE_PropertyCategory "(SchemaId);"
    ...
    stat = m_ecdb.GetImpl().ExecuteDDL("CREATE UNIQUE INDEX uix_ec_Property_ClassId_Name ON " TABLE_Property "(ClassId,Name);"
    ...
    stat = m_ecdb.GetImpl().ExecuteDDL("CREATE UNIQUE INDEX uix_ec_RelationshipConstraint_RelationshipClassId_RelationshipEnd ON " TABLE_RelationshipConstraint "(RelationshipClassId,RelationshipEnd);"
    ...
    stat = m_ecdb.GetImpl().ExecuteDDL("CREATE UNIQUE INDEX uix_ec_RelationshipConstraintClass_ConstraintId_ClassId ON " TABLE_RelationshipConstraintClass "(ConstraintId,ClassId);"
    ...
    stat = m_ecdb.GetImpl().ExecuteDDL("CREATE UNIQUE INDEX uix_ec_CustomAttribute_ContainerId_ContainerType_Ordinal ON " TABLE_CustomAttribute "(ContainerId,ContainerType,Ordinal);"
    ...
    stat = m_ecdb.GetImpl().ExecuteDDL("CREATE INDEX ix_ec_Table_ParentTableId ON " TABLE_Table "(ParentTableId);"
    ...
    stat = m_ecdb.GetImpl().ExecuteDDL("CREATE UNIQUE INDEX uix_ec_Column_TableId_Name ON " TABLE_Column "(TableId,Name);"
    ...
    stat = m_ecdb.GetImpl().ExecuteDDL("CREATE INDEX ix_ec_Index_TableId ON " TABLE_Index "(TableId);"
    ...
    stat = m_ecdb.GetImpl().ExecuteDDL("CREATE UNIQUE INDEX uix_ec_IndexColumn_IndexId_ColumnId_Ordinal ON " TABLE_IndexColumn "(IndexId,ColumnId,Ordinal);"
    ...
    stat = m_ecdb.GetImpl().ExecuteDDL("CREATE INDEX ix_ec_cache_ClassHasTables_ClassId_TableId ON " TABLE_ClassHasTablesCache "(ClassId);"
