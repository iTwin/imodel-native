...
struct ECDbMap :NonCopyableClass
    ...
    private:
        ...
        BentleyStatus EvaluateColumnNotNullConstraints(IdSet<DbColumnId>& modifiedColumnIds, ECN::ECClassId endTableRelClassId, bool impliesNotNullOnFkColumn) const;
