...
//---------------------------------------------------------------------------------------
ECDbSqlIndex* SchemaImportECDbMapDb::CreateIndex(ECDbSqlTable& table, Utf8CP indexName, bool isUnique, std::vector<ECDbSqlColumn const*> const& columns, ECN::ECClassId classId, bool isAutoGenerated, IndexScope scope)
    {
    if (columns.empty())
        return nullptr;
...
// @bsimethod                                                    Affan.Khan        09/2014
//---------------------------------------------------------------------------------------
ECDbSqlIndex* SchemaImportECDbMapDb::CreateIndex(ECDbSqlTable& table, Utf8CP indexName, bool isUnique, std::vector<Utf8CP> const& columnNames, ECN::ECClassId classId, bool isAutoGenerated, IndexScope scope)
    {
...
// @bsimethod                                                    Affan.Khan        09/2014
//---------------------------------------------------------------------------------------
ECDbSqlIndex* SchemaImportECDbMapDb::CacheIndex(ECDbSqlTable& table, Utf8CP indexName, bool isUnique, ECN::ECClassId classId, bool isAutoGenerated, IndexScope scope) const
    {
    ...
    ECDbSqlIndex* index = CacheIndex(m_coreMapDb.GetManagerR().GetIdGenerator().NextIndexId(),
...
// @bsimethod                                                    Affan.Khan        09/2014
//---------------------------------------------------------------------------------------
ECDbSqlIndex* SchemaImportECDbMapDb::CacheIndex(ECDbIndexId id, ECDbSqlTable& table, Utf8CP indexName, bool isUnique) const
    {
...
// @bsimethod                                                    Krischan.Eberle  10/2015
//---------------------------------------------------------------------------------------
bool SchemaImportECDbMapDb::Contains(ECDbSqlIndex const& index) const
    {
    return true;
    }
...
// @bsimethod                                                    Krischan.Eberle  10/2015
//---------------------------------------------------------------------------------------
bool SchemaImportECDbMapDb::ExistsInDb(ECDbCR ecdb, ECDbSqlIndex const& index) const
    {
...
// @bsimethod                                                    Affan.Khan        10/2014
//---------------------------------------------------------------------------------------
BentleyStatus SchemaImportECDbMapDb::DropInDb(ECDbR ecdb, ECDbSqlIndex const& index) const
    {
...
// @bsimethod                                                    Krischan.Eberle   10/2015
//---------------------------------------------------------------------------------------
void SchemaImportECDbMapDb::SetColumnIsShared(ECDbSqlColumn const& col, ColumnKind kind)
    {
...
// @bsimethod                                                    Krischan.Eberle   10/2015
//---------------------------------------------------------------------------------------
bool SchemaImportECDbMapDb::IsColumnShared(ECDbSqlColumn const& col, ColumnKind kind) const
    {
