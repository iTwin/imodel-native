...
protected:
    SystemPropertyMap (ECN::ECPropertyCR property, std::vector<ECDbSqlColumn const*> columns, ECSqlSystemProperty kind);
...
private:
    ECInstanceIdPropertyMap(ECN::ECPropertyCR ecInstanceIdProperty, ClassMap const&, std::vector<ECDbSqlColumn const*>);
...
protected:
    RelationshipConstraintPropertyMap (ECN::ECPropertyCR constraintProperty, std::vector<ECDbSqlColumn const*>, ECSqlSystemProperty, Utf8CP endTableColumnAlias);
...
struct ECInstanceIdRelationshipConstraintPropertyMap : RelationshipConstraintPropertyMap
    {
private:
    ECInstanceIdRelationshipConstraintPropertyMap(ECN::ECPropertyCR constraintProperty, std::vector<ECDbSqlColumn const*>, ECSqlSystemProperty, Utf8CP endTableColumnAlias);
...
private:
    ...
    ECClassIdRelationshipConstraintPropertyMap (ECN::ECPropertyCR constraintProperty, std::vector<ECDbSqlColumn const*>, ECSqlSystemProperty, ECN::ECClassId defaultClassId, ClassMap const&, Utf8CP endTableColumnAlias, bool colIsDelayGenerated);
...
public:
    ...
    static RefCountedPtr<ECClassIdRelationshipConstraintPropertyMap> Create (ECN::ECRelationshipEnd, ECDbSchemaManagerCR, std::vector<ECDbSqlColumn const*>, ECN::ECClassId defaultSourceECClassId, ClassMap const&, Utf8CP endTableColumnAlias = nullptr, bool colIsDelayGenerated = false);
