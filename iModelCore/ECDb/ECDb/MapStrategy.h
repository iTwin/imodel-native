...
struct TablePerHierarchyInfo final {
   ...
   private:
    ...
    BentleyStatus DetermineSharedColumnsInfo(ShareColumnsCustomAttribute const&, MapStrategyExtendedInfo const* baseMapStrategy, ECN::ECClassCR, IssueDataSource const&);
    BentleyStatus DetermineJoinedTableInfo(bool hasJoinedTablePerDirectSubclassOption, MapStrategyExtendedInfo const* baseMapStrategy, ECN::ECClassCR, IssueDataSource const&);
   ...
   public:
    ...
    BentleyStatus Initialize(ShareColumnsCustomAttribute const&, MapStrategyExtendedInfo const* baseMapStrategy, bool hasJoinedTablePerDirectSubclassOption, ECN::ECClassCR, IssueDataSource const&);
...
struct MapStrategyExtendedInfo final {
   ...
   public:
    ...
    MapStrategyExtendedInfo(MapStrategy strat, TablePerHierarchyInfo const& tphInfo) : m_strategy(strat), m_tphInfo(tphInfo), m_isValid(true) {
        BeAssert(strat == MapStrategy::TablePerHierarchy);
    ...
    TablePerHierarchyInfo const& GetTphInfo() const {
        BeAssert(IsTablePerHierarchy() == m_tphInfo.IsValid());
        return m_tphInfo;
    }
