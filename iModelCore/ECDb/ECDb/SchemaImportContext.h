...
private:
    ...
    BentleyStatus BuildCreateIndexDdl(NativeSqlBuilder&, ECDbCR, ECDbSqlIndex const&, NativeSqlBuilder const& whereClause) const;
    BentleyStatus GenerateIndexWhereClause(NativeSqlBuilder&, ECDbCR, ECDbSqlIndex const&) const;

    ECDbSqlIndex* CacheIndex(ECDbCR, ECDbIndexId, ECDbSqlTable&, Utf8CP indexName, bool isUnique, std::vector<ECDbSqlColumn const*> const&, Utf8CP primaryWhereClause, bool isAutoGenerated, ECN::ECClassId, bool applyToSubclassesIfPartial) const;
...
public:
    ...
    ECDbSqlIndex* CreateIndex(ECDbCR, ECDbSqlTable&, Utf8CP indexName, bool isUnique, std::vector<ECDbSqlColumn const*> const&, Utf8CP primaryWhereClause, bool isAutoGenerated, ECN::ECClassId, bool applyToSubclassesIfPartial = true);
    ECDbSqlIndex* CreateIndex(ECDbCR, ECDbSqlTable&, Utf8CP indexName, bool isUnique, std::vector<Utf8CP> const& columnNames, Utf8CP primaryWhereClause, bool isAutoGenerated, ECN::ECClassId, bool applyToSubclassesIfPartial = true);
