...
struct ConcurrentQueryManager final
    ...
    struct Config final
        ...
        public:
            ...
            bool GetUseUncommittedRead() const noexcept { return m_useUncommittedRead; }
            ...
            Config& SetUseUncommittedRead(bool v) noexcept { m_useUncommittedRead = v;  return *this; }
