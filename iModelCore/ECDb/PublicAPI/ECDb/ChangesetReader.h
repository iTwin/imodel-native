...
public:
    ...
    ECDB_EXPORT BentleyStatus SetUseJsNamesForChangeFetchedPropertyNames(bool v);
    ...
    ECDB_EXPORT BentleyStatus SetUseClassFullNameInsteadofClassNameForChangeFetchedPropertyNames(bool v);
