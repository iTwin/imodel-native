...
struct JsReadOptions final {
   ...
   public:
    ...
    JsReadOptions& SetAbbreviateBlobs(bool v) {
        m_abbreviateBlobs = v;
        return *this;
    }
    JsReadOptions& SetConvertClassIdsToClassNames(bool v) {
        m_classIdToClassNames = v;
        return *this;
    }
    JsReadOptions& SetUseJsNames(bool v) {
        m_useJsName = v;
        return *this;
    }
    JsReadOptions& SetDoNotConvertClassIdsToClassNamesWhenAliased(bool v) {
        m_doNotConvertClassIdsToClassNamesWhenAliased = v;
        return *this;
    }
    JsReadOptions& SetSkipReadOnlyProperties(bool v) {
        m_skipReadOnlyProperties = v;
        return *this;
    }
    JsReadOptions& SetUseClassFullNameInsteadofClassName(bool v) {
        m_useClassFullNameInsteadofClassName = v;
        return *this;
    }
