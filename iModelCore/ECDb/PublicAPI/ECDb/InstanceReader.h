...
struct InstanceReader final {
   public:
    ...
    struct Position final {
       ...
       public:
        Position(ECInstanceId instanceId, ECN::ECClassId classId, Utf8CP accessString = nullptr) : m_instanceId(instanceId), m_classId(classId), m_accessString(accessString), m_classFullName(nullptr) {}
        Position(ECInstanceId instanceId, Utf8CP classFullName, Utf8CP accessString = nullptr) : m_instanceId(instanceId), m_classFullName(classFullName), m_accessString(accessString) {}
