...
struct JsonECSqlBinder final {
   private:
    ...
    static ECSqlStatus BindValue(IECSqlBinder& binder, BeJsConst memberJson, ECN::ECPropertyCR);
    static ECSqlStatus BindArrayValue(IECSqlBinder&, BeJsConst arrayJson, ECN::PrimitiveType const*, ECN::ECStructClass const*);
   ...
   public:
    ...
    //! @return ECSqlStatus
    ECDB_EXPORT static ECSqlStatus BindValue(IECSqlBinder& binder, BeJsConst json, ECN::ECPropertyCR prop, ECN::IECClassLocater& classLocater);
    ...
    //! @return ECSqlStatus
    ECDB_EXPORT static ECSqlStatus BindPrimitiveValue(IECSqlBinder& binder, BeJsConst primitiveJson, ECN::PrimitiveType primitiveType);
    ...
    //! @return ECSqlStatus
    ECDB_EXPORT static ECSqlStatus BindStructValue(IECSqlBinder& binder, BeJsConst structJson, ECN::ECStructClassCR structType);
    ...
    //! @return ECSqlStatus
    ECDB_EXPORT static ECSqlStatus BindPrimitiveArrayValue(IECSqlBinder& binder, BeJsConst arrayJson, ECN::PrimitiveType arrayElementType);
    ...
    //! @param[in] arrayElementType Array element type
    //! @return ECSqlStatus
    ECDB_EXPORT static ECSqlStatus BindStructArrayValue(IECSqlBinder& binder, BeJsConst arrayJson, ECN::ECStructClassCR arrayElementType);
    ...
    //! @return ECSqlStatus
    ECDB_EXPORT static ECSqlStatus BindNavigationValue(IECSqlBinder& binder, BeJsConst navJson, ECN::IECClassLocater& classLocater);
...
struct JsonECSqlSelectAdapter final {
   ...
   public:
    ...
    ECDB_EXPORT BentleyStatus GetRow(BeJsValue json, bool appendToJson = false, bool abbreviateBlobs = false) const;
    ECDB_EXPORT BentleyStatus GetRowAsArray(BeJsValue json, bool appendToJson = false, bool abbreviateBlobs = false, bool classIdToClassNames = true) const;
    BentleyStatus GetRow(RapidJsonValueR json, rapidjson::MemoryPoolAllocator<>& allocator, bool appendToJson = false, bool abbreviateBlobs = false) const { return GetRow(BeJsValue(json, allocator), appendToJson, abbreviateBlobs); }

    ECDB_EXPORT BentleyStatus GetJsonPropertyNames(std::vector<Utf8String>&) const;
    ECDB_EXPORT BentleyStatus GetRow(BeJsValue json, ECSqlStatement const& stmt, bool appendToJson = false, bool abbreviateBlobs = false) const;
    //! Gets the current row as JSON object with pairs of property name value for each
    ...
    ECDB_EXPORT BentleyStatus GetRowInstance(BeJsValue json, ECN::ECClassId classId) const;
    BentleyStatus GetRowInstance(RapidJsonValueR json, ECN::ECClassId classId, rapidjson::MemoryPoolAllocator<>& allocator) const { return GetRowInstance(BeJsValue(json, allocator), classId); }
};
...
struct JsonReader final {
   ...
   public:
    ...
    ECDB_EXPORT BentleyStatus Read(BeJsValue jsonInstance, ECInstanceId ecInstanceId) const;
    BentleyStatus Read(RapidJsonValueR json, ECInstanceId ecInstanceId, rapidjson::MemoryPoolAllocator<>& allocator) const { return Read(BeJsValue(json, allocator), ecInstanceId); }
};
...
struct JsonInserter final {
   ...
   public:
    ...
    ECDB_EXPORT DbResult Insert(ECInstanceKey& key, BeJsConst json) const;
    ...
    //! @param[in] json EC JSON object to insert
    //! @return BE_SQLITE_OK in case of success, error codes otherwise
    ECDB_EXPORT DbResult Insert(BeJsValue json) const;
...
struct JsonUpdater final {
   ...
   public:
    ...
    ECDB_EXPORT DbResult Update(ECInstanceId instanceId, BeJsConst json) const;
