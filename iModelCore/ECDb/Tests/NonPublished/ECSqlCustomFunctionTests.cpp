...
TEST_F(ECSqlCustomFunctionTestFixture, RegisterUnregisterCustomSqlFunction) {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("ecsqlfunctiontest.ecdb", SchemaItem::CreateForFile("ECSqlTest.01.00.00.ecschema.xml"), ECDb::OpenParams(Db::OpenMode::Readonly)));
...
TEST_F(ECSqlCustomFunctionTestFixture, searchForAFunction) {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("searchForAFunction.ecdb", SchemaItem::CreateForFile("ECSqlTest.01.00.00.ecschema.xml"), ECDb::OpenParams(Db::OpenMode::Readonly)));
    ASSERT_EQ(SUCCESS, PopulateECDb(3));
...
TEST_F(ECSqlCustomFunctionTestFixture, CallUnregisteredSqlFunction) {
    ...
    Utf8CP ecsql = "SELECT I,POW2(I,2) FROM ecsql.P";
...
TEST_F(ECSqlCustomFunctionTestFixture, NumericSqlFunction) {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("NumericSqlFunction.ecdb", SchemaItem::CreateForFile("ECSqlTest.01.00.00.ecschema.xml")));
    ...
    {
        ECSqlStatement stmt;
        ASSERT_EQ(ECSqlStatus::Success, stmt.Prepare(m_ecdb, "SELECT I,POW2(I,2) FROM ecsql.P WHERE I IS NOT NULL"));
    ...
    {
        ECSqlStatement stmt;
        ASSERT_EQ(ECSqlStatus::Success, stmt.Prepare(m_ecdb, "SELECT I, POW2(I,?) FROM ecsql.P WHERE I IS NOT NULL"));
    ...
    {
        ECSqlStatement stmt;
        ASSERT_EQ(ECSqlStatus::Success, stmt.Prepare(m_ecdb, "SELECT POW2(I,NULL) FROM ecsql.P"));
    ...
    {
        ECSqlStatement stmt;
        ASSERT_EQ(ECSqlStatus::Success, stmt.Prepare(m_ecdb, "SELECT POW2(NULL,2) FROM ecsql.P"));
        ASSERT_EQ(BE_SQLITE_ERROR, stmt.Step()) << "Step is expected to fail if function is called with NULL arg";
    }

    {
        ECSqlStatement stmt;
        ASSERT_EQ(ECSqlStatus::Success, stmt.Prepare(m_ecdb, "SELECT POW2(NULL,NULL) FROM ecsql.P"));
        ASSERT_EQ(BE_SQLITE_ERROR, stmt.Step()) << "Step is expected to fail if function is called with NULL arg";
    }

    {
        ECSqlStatement stmt;
        ASSERT_EQ(ECSqlStatus::Success, stmt.Prepare(m_ecdb, "SELECT POW2(I,2) FROM ecsql.P WHERE I IS NULL"));
        ASSERT_EQ(BE_SQLITE_ERROR, stmt.Step()) << "Step is expected to fail if function is called with NULL arg";
    }
...
TEST_F(ECSqlCustomFunctionTestFixture, BlobSqlFunction) {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("ecsqlfunctiontest.ecdb", SchemaItem::CreateForFile("ECSqlTest.01.00.00.ecschema.xml")));
    ASSERT_EQ(SUCCESS, PopulateECDb(3));
