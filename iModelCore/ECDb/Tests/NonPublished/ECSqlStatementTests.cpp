...
TEST_F(ECSqlStatementTestFixture, SelectAsterisk) {
    ...
    ASSERT_EQ(BE_SQLITE_DONE, GetHelper().ExecuteInsertECSql(aLinksBKey, Utf8PrintfString("INSERT INTO ts.ALinksB(SourceECInstanceId,TargetECInstanceId) VALUES(%" PRIu64 ",%" PRIu64 ")",
                                                                                          aKey.GetInstanceId().GetValue(), bKey.GetInstanceId().GetValue())
                                                                             .c_str()));
    ASSERT_EQ(BE_SQLITE_DONE, GetHelper().ExecuteInsertECSql(subBLinksFileInfoKey, Utf8PrintfString("INSERT INTO ts.SubBLinksFileInfo(SourceECInstanceId,TargetECInstanceId, Priority) VALUES(%" PRIu64 ",%" PRIu64 ", 400)",
                                                                                                    subBKey.GetInstanceId().GetValue(), fileInfoKey.GetInstanceId().GetValue())
                                                                                       .c_str()));
...
TEST_F(ECSqlStatementTestFixture, SelectAsteriskAndViewGenerator) {
    ...
    EXPECT_STRCASEEQ(SqlPrintfString("SELECT [AOwnsB].[ECInstanceId],[AOwnsB].[ECClassId],[AOwnsB].[SourceECInstanceId],[AOwnsB].[SourceECClassId],[AOwnsB].[TargetECInstanceId],[AOwnsB].[TargetECClassId] FROM "
                                     "(SELECT [ts_B].[Id] ECInstanceId,%d ECClassId,[ts_B].[AId] SourceECInstanceId,[ts_A].[ECClassId] SourceECClassId,[ts_B].[Id] TargetECInstanceId,[ts_B].[ECClassId] TargetECClassId FROM [main].[ts_B] "
                                     "INNER JOIN [main].[ts_A] ON [ts_A].[Id]=[ts_B].[AId] WHERE [ts_B].[AId] IS NOT NULL) [AOwnsB] "
                                     "WHERE [AOwnsB].[SourceECClassId]=:_ecdb_sqlparam_ix1_col1",
                                     CLASS_ID(ts, AOwnsB))
                         .GetUtf8CP(),
                     stmt.GetNativeSql())
        << stmt.GetECSql();
    ...
    EXPECT_STRCASEEQ(SqlPrintfString("SELECT [ALinksB].[ECInstanceId],[ALinksB].[ECClassId],[ALinksB].[SourceECInstanceId],[ALinksB].[SourceECClassId],[ALinksB].[TargetECInstanceId],[ALinksB].[TargetECClassId] FROM "
                                     ...
                                     "INNER JOIN [main].[ts_A] [SourceECClassPrimaryTable] ON [SourceECClassPrimaryTable].[Id]=[ts_ALinksB].[SourceId] "
                                     "INNER JOIN [main].[ts_B] [TargetECClassPrimaryTable] ON [TargetECClassPrimaryTable].[Id]=[ts_ALinksB].[TargetId]) [ALinksB] "
                                     "WHERE [ALinksB].[SourceECInstanceId]=:_ecdb_sqlparam_ix1_col1 AND [ALinksB].[SourceECClassId]=:_ecdb_sqlparam_ix2_col1",
                                     CLASS_ID(ts, ALinksB))
                         .GetUtf8CP(),
                     stmt.GetNativeSql())
        << stmt.GetECSql();
    ...
    EXPECT_STRCASEEQ(SqlPrintfString("SELECT [ALinksB].[ECInstanceId],[ALinksB].[ECClassId],[ALinksB].[SourceECInstanceId],[ALinksB].[SourceECClassId],[ALinksB].[TargetECInstanceId],[ALinksB].[TargetECClassId] FROM "
                                     ...
                                     "INNER JOIN [main].[ts_A] [SourceECClassPrimaryTable] ON [SourceECClassPrimaryTable].[Id]=[ts_ALinksB].[SourceId] "
                                     "INNER JOIN [main].[ts_B] [TargetECClassPrimaryTable] ON [TargetECClassPrimaryTable].[Id]=[ts_ALinksB].[TargetId]) [ALinksB] "
                                     "WHERE [ALinksB].[SourceECClassId]=:_ecdb_sqlparam_ix1_col1",
                                     CLASS_ID(ts, ALinksB))
                         .GetUtf8CP(),
                     stmt.GetNativeSql())
        << stmt.GetECSql();
    ...
    EXPECT_STRCASEEQ(SqlPrintfString("SELECT [ALinksB].[ECInstanceId],[ALinksB].[ECClassId],[ALinksB].[SourceECInstanceId],[ALinksB].[SourceECClassId],[ALinksB].[TargetECInstanceId],[ALinksB].[TargetECClassId] FROM "
                                     ...
                                     "INNER JOIN [main].[ts_A] [SourceECClassPrimaryTable] ON [SourceECClassPrimaryTable].[Id]=[ts_ALinksB].[SourceId] "
                                     "INNER JOIN [main].[ts_B] [TargetECClassPrimaryTable] ON [TargetECClassPrimaryTable].[Id]=[ts_ALinksB].[TargetId]) [ALinksB] "
                                     "WHERE [ALinksB].[TargetECInstanceId]=:_ecdb_sqlparam_ix1_col1 AND [ALinksB].[TargetECClassId]=:_ecdb_sqlparam_ix2_col1",
                                     CLASS_ID(ts, ALinksB))
                         .GetUtf8CP(),
                     stmt.GetNativeSql())
        << stmt.GetECSql();
    ...
    EXPECT_STRCASEEQ(SqlPrintfString("SELECT [ALinksB].[ECInstanceId],[ALinksB].[ECClassId],[ALinksB].[SourceECInstanceId],[ALinksB].[SourceECClassId],[ALinksB].[TargetECInstanceId],[ALinksB].[TargetECClassId] FROM "
                                     ...
                                     "INNER JOIN [main].[ts_A] [SourceECClassPrimaryTable] ON [SourceECClassPrimaryTable].[Id]=[ts_ALinksB].[SourceId] "
                                     "INNER JOIN [main].[ts_B] [TargetECClassPrimaryTable] ON [TargetECClassPrimaryTable].[Id]=[ts_ALinksB].[TargetId]) [ALinksB] "
                                     "WHERE [ALinksB].[TargetECClassId]=:_ecdb_sqlparam_ix1_col1",
                                     CLASS_ID(ts, ALinksB))
                         .GetUtf8CP(),
                     stmt.GetNativeSql())
        << stmt.GetECSql();
...
TEST_F(ECSqlStatementTestFixture, InsertWithoutPropClause) {
    ...
    ECInstanceKey bKey;
    {
        ...
        EXPECT_EQ(BE_SQLITE_ROW, GetHelper().ExecuteECSql(Utf8PrintfString("SELECT 1 FROM ts.B WHERE ECInstanceId=%" PRIu64 " AND ECClassId=%" PRIu64 " AND A.Id=%" PRIu64 " AND Name='B-1'",
                                                                           bKey.GetInstanceId().GetValue(), bKey.GetClassId().GetValue(), aKey.GetInstanceId().GetValue())
                                                              .c_str()));
    }
    ...
    ECInstanceKey subBKey;
    {
        ...
        EXPECT_EQ(BE_SQLITE_ROW, GetHelper().ExecuteECSql(Utf8PrintfString("SELECT 1 FROM ts.SubB WHERE ECInstanceId=%" PRIu64 " AND ECClassId=%" PRIu64 " AND A.Id=%" PRIu64 " AND Name='B-2' AND SubName='Sub 1'",
                                                                           subBKey.GetInstanceId().GetValue(), subBKey.GetClassId().GetValue(), aKey.GetInstanceId().GetValue())
                                                              .c_str()));
    }
    ...
    EXPECT_EQ(BE_SQLITE_ROW, GetHelper().ExecuteECSql(Utf8PrintfString("SELECT 1 FROM ecdbf.ExternalFileInfo WHERE ECInstanceId=%" PRIu64 " AND ECClassId=%" PRIu64 " AND Name='DataFile-1' AND Size=1000 AND Description='A test file' AND LastModified=TIMESTAMP '2018-11-23T00:00Z' AND RootFolder=ecdbf.StandardRootFolderType.TemporaryFolder AND RelativePath='files/large'",
                                                                       fileInfoKey.GetInstanceId().GetValue(), fileInfoKey.GetClassId().GetValue())
                                                          .c_str()));

    {
        ...
        EXPECT_EQ(BE_SQLITE_ROW, GetHelper().ExecuteECSql(Utf8PrintfString("SELECT 1 FROM ts.ALinksB WHERE ECInstanceId=%" PRIu64 " AND ECClassId=%" PRIu64 " AND SourceECInstanceId=%" PRIu64 " AND SourceECClassId=%" PRIu64 " AND TargetECInstanceId=%" PRIu64 " AND TargetECClassId=%" PRIu64,
                                                                           ...
                                                                           aKey.GetInstanceId().GetValue(), aKey.GetClassId().GetValue(),
                                                                           bKey.GetInstanceId().GetValue(), bKey.GetClassId().GetValue())
                                                              .c_str()));
    }
...
TEST_F(ECSqlStatementTestFixture, IsNull) {
    ...
    for (Utf8CP testClassName : testClassNames) {
        ...
        ecsql.Sprintf(
            "SELECT Struct, Struct.struct_array, Struct_Array, "
    ...
    for (Utf8CP testClassName : testClassNames) {
        Utf8String ecsql;
        ecsql.Sprintf(
            "INSERT INTO ts.%s(L_Array, Struct.l_array, Struct.struct_array, Struct_Array) "
            "VALUES(?,?,?,?)",
            testClassName);
        ECSqlStatement stmt;
        ASSERT_EQ(ECSqlStatus::Success, stmt.Prepare(m_ecdb, ecsql.c_str())) << ecsql.c_str();
...
TEST_F(ECSqlStatementTestFixture, NullLiteralForPoints) {
    ...
    ecsqls[
        "SELECT CAST(NULL AS Point3D) FROM ecsql.PASpatial "
        "UNION ALL "
        "SELECT P3D FROM ecsql.P"] = true;

    ecsqls[
        "SELECT CAST(NULL AS Double) FROM ecsql.PASpatial "
        "UNION ALL "
        "SELECT P3D FROM ecsql.P"] = false;

    ecsqls[
        "SELECT CAST(NULL AS Point2D) FROM ecsql.PASpatial "
        "UNION ALL "
        "SELECT P3D FROM ecsql.P"] = false;

    ecsqls[
        "SELECT P3D FROM ecsql.P "
        "UNION ALL "
        "SELECT NULL FROM ecsql.PASpatial"] = true;

    ecsqls[
        "SELECT NULL FROM ecsql.PASpatial "
        "UNION ALL "
        "SELECT P3D FROM ecsql.P"] = false;
...
TEST_F(ECSqlStatementTestFixture, NullLiteralForStructs) {
    ...
    bmap<Utf8CP, bool> ecsqls;
    ecsqls[
        "SELECT CAST(NULL AS ecsql.PStruct) FROM ecsql.P "
        "UNION ALL "
    ...
    ecsqls[
        "SELECT NULL FROM ecsql.P "
        "UNION ALL "
        "SELECT PStructProp FROM ecsql.PSA"] = false;

    ecsqls[
        "SELECT PStructProp FROM ecsql.PSA "
        "UNION ALL "
...
TEST_F(ECSqlStatementTestFixture, NullLiteralForPrimArrays) {
    ...
    bmap<Utf8CP, bool> ecsqls;
    ecsqls[
        "SELECT CAST(NULL AS Double) FROM ecsql.P "
        "UNION ALL "
        "SELECT Dt_Array FROM ecsql.PSA"] = false;

    ecsqls[
        "SELECT CAST(NULL AS TimeStamp) FROM ecsql.P "
        "UNION ALL "
        "SELECT Dt_Array FROM ecsql.PSA"] = false;
    ...
    ecsqls[
        "SELECT Dt_Array FROM ecsql.PSA "
        "UNION ALL "
        "SELECT NULL FROM ecsql.P"] = true;
...
TEST_F(ECSqlStatementTestFixture, NullLiteralForStructArrays) {
    ...
    ecsqls[
        "SELECT PStruct_Array FROM ecsql.PSA "
        "UNION ALL "
        "SELECT NULL FROM ecsql.P"] = true;
...
TEST_F(ECSqlStatementTestFixture, ColumnInfoForStructArrays) {
    ...
    // out of bounds test
    ASSERT_FALSE(topLevelStructValue[""].GetColumnInfo().IsValid()) << "GetValue ("
                                                                       ").GetColumnInfo () for struct value";
...
TEST_F(ECSqlStatementTestFixture, WriteCalculatedECProperty) {
    ...
    Utf8String instanceXml =
        "<Manager xmlns = \"SimpleCompany.01.00\" >"
...
TEST_F(ECSqlStatementTestFixture, verify_inf_and_nan_handling_Point3D) {
    ...
    if ("insert row") {
        ...
        ASSERT_EQ(stmt.Prepare(m_ecdb, R"sqlstr(insert into ts.Element(
            ...
            inf_neg, inf_neg_combo_1, inf_neg_combo_2, inf_neg_combo_3, inf_neg_combo_4, inf_neg_combo_5, inf_neg_combo_6,
            nan_val, nan_val_combo_1, nan_val_combo_2, nan_val_combo_3, nan_val_combo_4, nan_val_combo_5, nan_val_combo_6) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?))sqlstr"),
                  ECSqlStatus::Success);
    ...
    if ("read row") {
        ...
        ASSERT_EQ(stmt.Prepare(m_ecdb, R"sqlstr(select inf_pos, inf_neg, nan_val,
            ...
            nan_val_combo_1, nan_val_combo_2, nan_val_combo_3, nan_val_combo_4, nan_val_combo_5, nan_val_combo_6 from ts.Element)sqlstr"),
                  ECSqlStatus::Success);
        ASSERT_EQ(stmt.Step(), BE_SQLITE_ROW);
...
TEST_F(ECSqlStatementTestFixture, SelectAnySomeAll) {
    ...
    if ("Select 1") {
        ...
        Utf8PrintfString expectedSql(
            "SELECT 1 FROM (SELECT [Id] ECInstanceId,%d ECClassId FROM [main].[ts_SomeEntity]) [SomeEntity] "
            "WHERE EXISTS(SELECT 10 WHERE 10 = 10)",
            classId);
    ...
    if ("Select single column") {
        ...
        Utf8PrintfString expectedSql(
            "SELECT [SomeEntity].[ECInstanceId],[SomeEntity].[ECClassId],[SomeEntity].[Name],[SomeEntity].[Primary],[SomeEntity].[Secondary],[SomeEntity].[Random] "
            "FROM (SELECT [Id] ECInstanceId,%d ECClassId,[Name],[Primary],[Secondary],[Random] FROM [main].[ts_SomeEntity]) [SomeEntity] "
            "WHERE EXISTS(SELECT [SomeEntity].[Secondary] FROM (SELECT [Id] ECInstanceId,%d ECClassId,[Secondary] FROM [main].[ts_SomeEntity]) [SomeEntity] WHERE [SomeEntity].[Primary] = [SomeEntity].[Secondary])",
            classId, classId);
        ECSqlStatement stmt;
        ASSERT_EQ(ECSqlStatus::Success, stmt.Prepare(m_ecdb, ecsql));
        ASSERT_EQ(6, stmt.GetColumnCount());
    ...
    if ("Select multiple columns") {
        ...
        Utf8PrintfString expectedSql(
            ...
            "FROM [main].[ts_SomeEntity]) [SomeEntity] WHERE [SomeEntity].[Primary] = [SomeEntity].[Random] OR [SomeEntity].[Primary] = [SomeEntity].[Secondary])",
            classId, classId);
    ...
    if ("Select less than ANY") {
        ...
        Utf8PrintfString expectedSql(
            ...
            "WHERE ([SomeEntity].[Random]<=0) AND ([SomeEntity].[Primary] < [SomeEntity].[Secondary]))",
            classId, classId);
    ...
    if ("Select with GROUP BY") {
        ...
        Utf8PrintfString expectedSql(
            ...
            "FROM [main].[ts_SomeEntity]) [SomeEntity] WHERE [SomeEntity].[Primary] < [SomeEntity].[Secondary]  GROUP BY [SomeEntity].[Random])",
            classId, classId);
    ...
    if ("Select with WHERE") {
        ...
        Utf8PrintfString expectedSql(
            ...
            "WHERE ([SomeEntity].[Secondary]>0) AND ([SomeEntity].[Primary] >= [SomeEntity].[Secondary]))",
            classId, classId);
    ...
    if ("Select with Limit") {
        ...
        Utf8PrintfString expectedSql(
            ...
            "FROM (SELECT [Id] ECInstanceId,%d ECClassId,[Name],[Primary],[Secondary],[Random] FROM [main].[ts_SomeEntity]) [SomeEntity] "
            "WHERE EXISTS(SELECT [SomeEntity].[Secondary] FROM (SELECT [Id] ECInstanceId,%d ECClassId,[Secondary] FROM [main].[ts_SomeEntity]) [SomeEntity] "
            "WHERE ([SomeEntity].[Secondary]>0) AND ([SomeEntity].[Primary] <= [SomeEntity].[Secondary])  LIMIT 1)",
            classId, classId);
    ...
    if ("Select more than ALL") {
        ...
        Utf8PrintfString expectedSql(
            ...
            "WHERE ([SomeEntity].[Random]=0) AND ([SomeEntity].[Secondary] > [SomeEntity].[Primary]))",
            classId, classId);
    ...
    if ("Select less than ALL") {
        ...
        Utf8PrintfString expectedSql(
            ...
            "WHERE [SomeEntity].[Secondary] < [SomeEntity].[Primary])",
            classId, classId);
