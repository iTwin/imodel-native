...
// @bsimethod
//+---------------+---------------+---------------+---------------+---------------+------
TEST_F(ECSqlStatementTestFixture, SQLiteWindowFunctions)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("SQLiteWindowFunctions.ecdb", SchemaItem(
        R"xml(<ECSchema schemaName="TestSchema" alias="ts" version="1.0.0" xmlns="http://www.bentley.com/schemas/Bentley.ECXML.3.2">
            <ECEntityClass typeName="SomeEntity" >
                <ECProperty propertyName="Primary" typeName="string" />
                <ECProperty propertyName="Secondary" typeName="string" />
...
// @bsimethod
//+---------------+---------------+---------------+---------------+---------------+------
TEST_F(ECSqlStatementTestFixture, WindowPartitionClause)
    {
    ...
    if ("with RTRIM collate function")
        {
    ...
    if ("with NOCASE collate function")
        {
    ...
    if ("with BINARY collate function")
        {
    ...
    if ("supports multiple PARTITION BY arguments")
        {
...
// @bsimethod
//+---------------+---------------+---------------+---------------+---------------+------
TEST_F(ECSqlStatementTestFixture, WindowFrameSpecifications)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("SQLiteWindowFunctions.ecdb", SchemaItem(
        R"xml(<ECSchema schemaName="TestSchema" alias="ts" version="1.0.0" xmlns="http://www.bentley.com/schemas/Bentley.ECXML.3.2">
            <ECEntityClass typeName="SomeEntity" >
    ...
    if ("rows with windows frame start")
        {
    ...
    if ("rows with windows frame between")
        {
...
// @bsimethod
//+---------------+---------------+---------------+---------------+---------------+------
TEST_F(ECSqlStatementTestFixture, WindowName)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("SQLiteWindowFunctions.ecdb", SchemaItem(
        R"xml(<ECSchema schemaName="TestSchema" alias="ts" version="1.0.0" xmlns="http://www.bentley.com/schemas/Bentley.ECXML.3.2">
            <ECEntityClass typeName="SomeEntity" >
