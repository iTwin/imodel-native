...
TEST_F(ECSqlStatementTestFixture, CTECrash) {
    ASSERT_EQ(DbResult::BE_SQLITE_OK, SetupECDb("cte_crash.ecdb"));
    auto ecsql = R"(
        WITH RECURSIVE
        F (A) AS (SELECT 1),
...
TEST_F(ECSqlStatementTestFixture, NestedValConstructor) {
    ASSERT_EQ(DbResult::BE_SQLITE_OK, SetupECDb("RowConstructor.ecdb"));
...
TEST_F(ECSqlStatementTestFixture, NavPropAlias)
    {
    ASSERT_EQ(DbResult::BE_SQLITE_OK, SetupECDb("NavPropAlias.ecdb"));
    ECSqlStatement stmt;
...
TEST_F(ECSqlStatementTestFixture, SelectAsterisk)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("SelectAsterisk.ecdb", SchemaItem(
        R"xml(<?xml version="1.0" encoding="utf-8"?>
...
TEST_F(ECSqlStatementTestFixture, SelectAsteriskOnRelationshipClass)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("SelectAsteriskOnRelationshipClass.ecdb", SchemaItem(
        R"xml(<?xml version="1.0" encoding="utf-8"?>
                <ECSchema schemaName="TestSchema" alias="ts" version="1.0.0" xmlns="http://www.bentley.com/schemas/Bentley.ECXML.3.2">
                    <ECSchemaReference name="ECDbMap" version="02.00.00" alias="ecdbmap" />
                    <ECEntityClass typeName="A">
...
TEST_F(ECSqlStatementTestFixture, InsertWithoutPropClause)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("InsertWithoutPropClause.ecdb", SchemaItem(
        R"xml(<?xml version="1.0" encoding="utf-8"?>
                <ECSchema schemaName="TestSchema" alias="ts" version="1.0.0" xmlns="http://www.bentley.com/schemas/Bentley.ECXML.3.2">
                    <ECSchemaReference name="ECDbMap" version="02.00.00" alias="ecdbmap" />
                    <ECSchemaReference name="ECDbFileInfo" version="02.00.01" alias="ecdbf" />
...
TEST_F(ECSqlStatementTestFixture, ClassAliases)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("classaliases.ecdb", SchemaItem(
        R"xml(<?xml version="1.0" encoding="utf-8"?>
...
TEST_F(ECSqlStatementTestFixture, IsNull)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("ecsqlisnull.ecdb", SchemaItem(
...
TEST_F(ECSqlStatementTestFixture, SubQueryAliasCheck)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("TopLevelAliasCheck.ecdb", SchemaItem(R"(
...
TEST_F(ECSqlStatementTestFixture, CompositPropertyAccessFromASubQuery)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("SubQueryAlias.ecdb", SchemaItem(
        "<?xml version='1.0' encoding='utf-8'?>"
        "<ECSchema schemaName='TestSchema' alias='ts' version='1.0' xmlns='http://www.bentley.com/schemas/Bentley.ECXML.3.1'>"
        "<ECSchemaReference name='ECDbMap' version='02.00' alias='ecdbmap' />"
...
TEST_F(ECSqlStatementTestFixture, PrimitiveArrayUnsetMembers)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("ecsqlprimarray_unsetmembers.ecdb", SchemaItem(
        R"xml(<?xml version="1.0" encoding="utf-8"?>
    <ECSchema schemaName="TestSchema" alias="ts" version="1.0" xmlns="http://www.bentley.com/schemas/Bentley.ECXML.3.1">
...
TEST_F(ECSqlStatementTestFixture, StructArrayUnsetMembers)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("ecsqlstructarray_unsetmembers.ecdb", SchemaItem(
        R"xml(<?xml version="1.0" encoding="utf-8"?>
        <ECSchema schemaName="TestSchema" alias="ts" version="1.0" xmlns="http://www.bentley.com/schemas/Bentley.ECXML.3.1">
          <ECEntityClass typeName="MyClass">
...
TEST_F(ECSqlStatementTestFixture, DateTimeCast)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("datetimecast.ecdb", SchemaItem::CreateForFile("ECSqlTest.01.00.00.ecschema.xml")));
...
TEST_F(ECSqlStatementTestFixture, NullLiteralForPoints)
    ...
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("nullliterals.ecdb", SchemaItem::CreateForFile("ECSqlTest.01.00.00.ecschema.xml")));
...
TEST_F(ECSqlStatementTestFixture, ParametersInNestedSelectStatement)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("parametersinnestedselect.ecdb", SchemaItem::CreateForFile("ECSqlTest.01.00.00.ecschema.xml")));
...
TEST_F(ECSqlStatementTestFixture, GroupByPoint)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("ECSqlStatementTests.ecdb", SchemaItem(R"xml(<ECSchema schemaName="TestSchema" alias="ts" version="1.0" xmlns="http://www.bentley.com/schemas/Bentley.ECXML.3.1">
...
TEST_F(ECSqlStatementTestFixture, HexLiteral)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("HexLiteral.ecdb", SchemaItem(
        R"xml(<ECSchema schemaName="TestSchema" alias="ts" version="1.0" xmlns="http://www.bentley.com/schemas/Bentley.ECXML.3.1">
...
TEST_F(ECSqlStatementTestFixture, BindECInstanceIdAsString)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("BindIdStrings.ecdb", SchemaItem(
...
TEST_F(ECSqlStatementTestFixture, BindStringToGuidParameter)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("BindStringToGuidParameter.ecdb", SchemaItem(
        R"xml(<ECSchema schemaName="TestSchema" alias="ts" version="1.0.0" xmlns="http://www.bentley.com/schemas/Bentley.ECXML.3.2">
...
TEST_F(ECSqlStatementTestFixture, PolymorphicDelete)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("PolymorphicDeleteSharedTable.ecdb", SchemaItem::CreateForFile("NestedStructArrayTest.01.00.00.ecschema.xml")));
...
TEST_F(ECSqlStatementTestFixture, PolymorphicUpdateNoTph)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("PolymorphicUpdateNoTph.ecdb", SchemaItem(
        R"xml(<ECSchema schemaName="TestSchema" alias="ts" version="1.0" xmlns="http://www.bentley.com/schemas/Bentley.ECXML.3.1">
...
TEST_F(ECSqlStatementTestFixture, PolymorphicUpdate)
    ...
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("PolymorphicUpdateTest.ecdb", testSchema));
...
TEST_F(ECSqlStatementTestFixture, DeleteStructArray)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("PolymorphicUpdateTest.ecdb", SchemaItem::CreateForFile("NestedStructArrayTest.01.00.00.ecschema.xml")));
...
TEST_F(ECSqlStatementTestFixture, Int64InStructArrays)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("Int64InStructArrays.ecdb", SchemaItem(
        "<?xml version='1.0' encoding='utf-8'?>"
        "<ECSchema schemaName='testSchema' alias='ts' version='1.0' xmlns='http://www.bentley.com/schemas/Bentley.ECXML.3.1'>"
        "    <ECStructClass typeName='MyStruct' >"
        "        <ECProperty propertyName='I' typeName='int' />"
...
TEST_F(ECSqlStatementTestFixture, ColumnInfoAndSystemProperties)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("ecsqlstatementtests.ecdb", SchemaItem::CreateForFile("ECSqlTest.01.00.00.ecschema.xml"), ECDb::OpenParams(Db::OpenMode::Readonly)));
...
TEST_F(ECSqlStatementTestFixture, BindToNumericProps)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("BindToNumericProps.ecdb", SchemaItem(
...
TEST_F(ECSqlStatementTestFixture, InsertNullForECInstanceId)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("ecinstanceidbindnull.ecdb", SchemaItem::CreateForFile("ECSqlTest.01.00.00.ecschema.xml")));
...
TEST_F(ECSqlStatementTestFixture, BindEnum)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("BindEnum.ecdb", SchemaItem(
        R"xml(<ECSchema schemaName="TestSchema" alias="ts" version="1.0.0" xmlns="http://www.bentley.com/schemas/Bentley.ECXML.3.2">
...
TEST_F(ECSqlStatementTestFixture, BindPrimitiveArrayWithDifferentTypes)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("BindPrimitiveArrayWithDifferentTypes.ecdb", SchemaItem::CreateForFile("ECSqlTest.01.00.00.ecschema.xml")));
...
TEST_F(ECSqlStatementTestFixture, ConstrainedArrayProps)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("ConstrainedArrayProps.ecdb", SchemaItem(R"xml(<?xml version="1.0" encoding="utf-8" ?>
                                                    <ECSchema schemaName="TestSchema" alias="ts" version="1.0" xmlns="http://www.bentley.com/schemas/Bentley.ECXML.3.1">
                                                       <ECEntityClass typeName="Foo">
...
TEST_F(ECSqlStatementTestFixture, UpdateWithStructBinding)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("UpdateWithStructBinding.ecdb", SchemaItem::CreateForFile("ECSqlTest.01.00.00.ecschema.xml")));
    ASSERT_EQ(SUCCESS, PopulateECDb(10));
...
TEST_F(ECSqlStatementTestFixture, StructsInWhereClause)
    ...
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("ecsqlstatementtests.ecdb", schema));
...
TEST_F(ECSqlStatementTestFixture, ReadonlyPropertiesAreUpdatable)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("ReadonlyPropertiesAreUpdatable.ecdb",
...
TEST_F(ECSqlStatementTestFixture, GetArrayValue)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("GetArrayValue.ecdb", SchemaItem::CreateForFile("ECSqlTest.01.00.00.ecschema.xml")));
...
TEST_F(ECSqlStatementTestFixture, GeometryAndOverflow)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("ecsql_geometry.ecdb", SchemaItem(R"xml(
                            <ECSchema schemaName="TestSchema" alias="ts" version="1.0" xmlns="http://www.bentley.com/schemas/Bentley.ECXML.3.1">
                             <ECSchemaReference name="ECDbMap" version="02.00" alias="ecdbmap" />
                              <ECEntityClass typeName="Element">
                                 <ECCustomAttributes>
...
TEST_F(ECSqlStatementTestFixture, SystemProperties) {
    ASSERT_EQ(DbResult::BE_SQLITE_OK, SetupECDb("system.ecdb"));
...
TEST_F(ECSqlStatementTestFixture, AmbiguousQuery)
    ...
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("AmbiguousQuery.ecdb", schemaXml));
...
TEST_F(ECSqlStatementTestFixture, BindNegECInstanceId)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("BindNegECInstanceId.ecdb", SchemaItem::CreateForFile("ECSqlTest.01.00.00.ecschema.xml")));
...
TEST_F(ECSqlStatementTestFixture, InstanceInsertionInArray)
    ...
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("InstanceInsertionInArray.ecdb", schema));
...
TEST_F(ECSqlStatementTestFixture, SelectAfterImport)
    ...
    ASSERT_EQ(DbResult::BE_SQLITE_OK, SetupECDb("ImportTwoInARow.ecdb"));
...
TEST_F(ECSqlStatementTestFixture, RowConstructor)
    {
    ASSERT_EQ(DbResult::BE_SQLITE_OK, SetupECDb("emptydb.ecdb"));
...
TEST_F(ECSqlStatementTestFixture, WriteCalculatedECProperty)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("SimpleCompany.ecdb", SchemaItem::CreateForFile("SimpleCompany.01.00.00.ecschema.xml")));
...
TEST_F(ECSqlStatementTestFixture, PointsMappedToSharedColumns)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("pointsmappedtosharedcolumns.ecdb", SchemaItem(
        "<?xml version='1.0' encoding='utf-8'?>"
        "<ECSchema schemaName='TestSchema' nameSpacePrefix='ts' version='1.0' xmlns='http://www.bentley.com/schemas/Bentley.ECXML.3.0'>"
        "    <ECSchemaReference name='ECDbMap' version='02.00' prefix='ecdbmap' />"
        "    <ECEntityClass typeName='Base'>"
...
TEST_F(ECSqlStatementTestFixture, BindZeroBlob)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("bindzeroblob.ecdb", SchemaItem(R"xml(
                            <ECSchema schemaName="TestSchema" alias="ts" version="1.0" xmlns="http://www.bentley.com/schemas/Bentley.ECXML.3.1">
                             <ECSchemaReference name="ECDbMap" version="02.00" alias="ecdbmap" />
                              <ECEntityClass typeName="Element">
                                 <ECCustomAttributes>
...
TEST_F(ECSqlStatementTestFixture, BlobIO)
    ...
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("blobio.ecdb", SchemaItem::CreateForFile("ECSqlTest.01.00.00.ecschema.xml")));
...
TEST_F(ECSqlStatementTestFixture, BlobIOForInvalidProperties)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("blobioinvalidcases.ecdb", SchemaItem::CreateForFile("ECSqlTest.01.00.00.ecschema.xml")));
    ...
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("blobioinvalidcases2.ecdb", SchemaItem(R"xml(
...
TEST_F(ECSqlStatementTestFixture, ECSqlOnAbstractClassWithOrderbyClause)
    ...
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("ecsqlonabstractclasswithorderbyclause.ecdb", SchemaItem("<?xml version='1.0' encoding='utf-8'?>"
...
TEST_F(ECSqlStatementTestFixture, OrderByAgainstMixin)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("orderbyonmixin.ecdb", SchemaItem(
        R"xml(<?xml version="1.0" encoding="utf-8"?>
        <ECSchema schemaName="TestSchema" alias="ts" version="1.0" xmlns="http://www.bentley.com/schemas/Bentley.ECXML.3.1">
            <ECSchemaReference name="CoreCustomAttributes" version="01.00.00" alias="CoreCA"/>
...
TEST_F(ECSqlStatementTestFixture, UpdateAndDeleteAgainstMixin)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("updatedeletemixin.ecdb",
...
TEST_F(ECSqlStatementTestFixture, PrepareECSqlStatmentUsingSecondaryReadonlyConnection)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("econn1.ecdb", SchemaItem(
        R"xml(<?xml version="1.0" encoding="utf-8"?>
                <ECSchema schemaName="TestSchema" alias="ts" version="1.0" xmlns="http://www.bentley.com/schemas/Bentley.ECXML.3.1">
                    <ECEntityClass typeName="A">
                        <ECProperty propertyName="Name" typeName="string" />
    ...
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("econn2.ecdb", SchemaItem(
        R"xml(<?xml version="1.0" encoding="utf-8"?>
                <ECSchema schemaName="TestSchema" alias="ts" version="1.0" xmlns="http://www.bentley.com/schemas/Bentley.ECXML.3.1">
                    <ECEntityClass typeName="A">
                        <ECProperty propertyName="Name" typeName="string" />
...
TEST_F(ECSqlStatementTestFixture, InterruptStep)
    {
    ASSERT_EQ(DbResult::BE_SQLITE_OK, SetupECDb("InterruptStep.ecdb"));
...
TEST_F(ECSqlStatementTestFixture, OptimizeECSqlForSealedAndClassWithNotDerviedClasses)
    ...
    if (true)
        {
        ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("ecsqlOpt00.ecdb", SchemaItem(
            R"xml(<?xml version="1.0" encoding="utf-8"?>
                <ECSchema schemaName="TestSchema" alias="ts" version="1.0" xmlns="http://www.bentley.com/schemas/Bentley.ECXML.3.1">
                    <ECEntityClass typeName="Foo">
                        <ECProperty propertyName="Name" typeName="string" />
    ...
    if (true)
        {
        ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("ecsqlOpt01.ecdb", SchemaItem(
            R"xml(<?xml version="1.0" encoding="utf-8"?>
                <ECSchema schemaName="TestSchema" alias="ts" version="1.0" xmlns="http://www.bentley.com/schemas/Bentley.ECXML.3.1">
                    <ECSchemaReference name="ECDbMap" version="02.00" alias="ecdbmap" />
...
\                       <BaseClass>Boo</BaseClass>
    ...
    if (true)
        {
        ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("ecsqlOpt02.ecdb", SchemaItem(
            R"xml(<?xml version="1.0" encoding="utf-8"?>
                <ECSchema schemaName="TestSchema" alias="ts" version="1.0" xmlns="http://www.bentley.com/schemas/Bentley.ECXML.3.1">
                    <ECSchemaReference name="ECDbMap" version="02.00" alias="ecdbmap" />
                    <ECEntityClass typeName="Boo">
...
TEST_F(ECSqlStatementTestFixture, EnumeratorNamesForEC31Enums)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("EnumeratorNamesForEC31Enums.ecdb", SchemaItem(
        "<?xml version='1.0' encoding='utf-8' ?>"
...
TEST_F(ECSqlStatementTestFixture, EnumeratorNames)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("EnumeratorNames.ecdb", SchemaItem(
        "<?xml version='1.0' encoding='utf-8' ?>"
...
TEST_F(ECSqlStatementTestFixture, ORedEnumerators)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("ORedEnumerators.ecdb", SchemaItem(
        R"xml(<ECSchema schemaName="TestSchema" alias="ts" version="1.0.0" xmlns="http://www.bentley.com/schemas/Bentley.ECXML.3.2">
...
TEST_F(ECSqlStatementTestFixture, TryGetContainedEnumerators)
    {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("TryGetContainedEnumerators.ecdb", SchemaItem(
        R"xml(<ECSchema schemaName="TestSchema" alias="ts" version="1.0.0" xmlns="http://www.bentley.com/schemas/Bentley.ECXML.3.2">
...
TEST_F(ECSqlStatementTestFixture, ConfuseRealNumberWithClassName) {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("ECSqlStatementTests.ecdb", SchemaItem(
...
TEST_F(ECSqlStatementTestFixture, verify_inf_and_nan_handling_Point2D) {
    auto v1 = R"(<ECSchema schemaName="TestSchema" alias="ts" version="1.0.0" xmlns="http://www.bentley.com/schemas/Bentley.ECXML.3.2">
                    <ECEntityClass typeName="Element">
                        <ECProperty propertyName="inf_pos" typeName="Point2d" description="Both Co-ordinates are INF/NaN" />
                        <ECProperty propertyName="inf_neg" typeName="Point2d" description="Both Co-ordinates are INF/NaN" />
                        <ECProperty propertyName="nan_val" typeName="Point2d" description="Both Co-ordinates are INF/NaN" />

                        <ECProperty propertyName="inf_pos_combo_1" typeName="Point2d" description="Co-ordinate X is a double and Co-ordinate Y is INF" />
                        <ECProperty propertyName="inf_pos_combo_2" typeName="Point2d" description="Co-ordinate Y is a double and Co-ordinate X is INF" />

                        <ECProperty propertyName="inf_neg_combo_1" typeName="Point2d" description="Co-ordinate X is a double and Co-ordinate Y is -INF" />
                        <ECProperty propertyName="inf_neg_combo_2" typeName="Point2d" description="Co-ordinate Y is a double and Co-ordinate X is -INF" />

                        <ECProperty propertyName="nan_val_combo_1" typeName="Point2d" description="Co-ordinate X is a double and Co-ordinate Y is NaN" />
                        <ECProperty propertyName="nan_val_combo_2" typeName="Point2d" description="Co-ordinate Y is a double and Co-ordinate X is NaN" />
                    </ECEntityClass>
                </ECSchema>)"_schema;
    ...
    if("insert row") {
        ...
        for (const auto& columnValue : { pos_inf, neg_inf, nan_val })
            {
            stmt.BindPoint2d(++columnNumber, DPoint2d::From(columnValue, columnValue)); // Treat both co-ordinates as null
            stmt.BindPoint2d(++columnNumber, DPoint2d::From(1, columnValue)); // Treat Y value as null
            stmt.BindPoint2d(++columnNumber, DPoint2d::From(columnValue, 1)); // Treat X value as null
            }
        ASSERT_EQ(columnNumber, 9);
        ASSERT_EQ(stmt.Step(), BE_SQLITE_DONE);
    }
    if("read row") {
        ECSqlStatement stmt;
        ...
        for (auto columnIndex = 0; columnIndex < stmt.GetColumnCount(); ++columnIndex)
            ...
            EXPECT_FALSE(std::isinf(coordX)) << "Value at column " << columnIndex + 1 << " should not be infinity";
            EXPECT_FALSE(std::isinf(coordY)) << "Value at column " << columnIndex + 1 << " should not be infinity";

            EXPECT_FALSE(std::isnan(coordX)) << "Value at column " << columnIndex + 1 << " should not be NaN";
            EXPECT_FALSE(std::isnan(coordY)) << "Value at column " << columnIndex + 1 << " should not be NaN";
            EXPECT_TRUE(stmt.IsValueNull(columnIndex)) << "Value at column " << columnIndex + 1 << " should be NULL";
            }
    }
    if ("jsoncpp must return null for inf") {
        ECSqlStatement stmt;
    ...
    for (const auto& columnValue : { pos_inf, neg_inf, nan_val })
        {
        stmt1.BindDouble(++columnNumber, columnValue);
        stmt1.BindDouble(++columnNumber, columnValue);
        stmt1.BindDouble(++columnNumber, 1);
        stmt1.BindDouble(++columnNumber, columnValue);
        stmt1.BindDouble(++columnNumber, columnValue);
        stmt1.BindDouble(++columnNumber, 1);
        }
    ASSERT_EQ(columnNumber, 18);
    ASSERT_EQ(BE_SQLITE_DONE, stmt1.Step());

    if("read row") {
        ECSqlStatement stmt;
        ASSERT_EQ(stmt.Prepare(m_ecdb, "select inf_pos, inf_neg, nan_val, inf_pos_combo_1, inf_neg_combo_1, nan_val_combo_1, inf_pos_combo_2, inf_neg_combo_2, nan_val_combo_2 from ts.Element"), ECSqlStatus::Success);
        ASSERT_EQ(stmt.Step(), BE_SQLITE_ROW);
...
TEST_F(ECSqlStatementTestFixture, verify_inf_and_nan_handling_Point3D) {
    auto v1 = R"(<ECSchema schemaName="TestSchema" alias="ts" version="1.0.0" xmlns="http://www.bentley.com/schemas/Bentley.ECXML.3.2">
                    <ECEntityClass typeName="Element">
                        <ECProperty propertyName="inf_pos" typeName="Point3d" description="Both Co-ordinates are INF/NaN" />
                        <ECProperty propertyName="inf_neg" typeName="Point3d" description="Both Co-ordinates are INF/NaN" />
                        <ECProperty propertyName="nan_val" typeName="Point3d" description="Both Co-ordinates are INF/NaN" />

                        <ECProperty propertyName="inf_pos_combo_1" typeName="Point3d" description="Co-ordinate X is double, Co-ordinate Y is double, Co-ordinate Z is INF" />
                        <ECProperty propertyName="inf_pos_combo_2" typeName="Point3d" description="Co-ordinate X is double, Co-ordinate Y is INF, Co-ordinate Z is double" />
                        <ECProperty propertyName="inf_pos_combo_3" typeName="Point3d" description="Co-ordinate X is INF, Co-ordinate Y is double, Co-ordinate Z is double" />
                        <ECProperty propertyName="inf_pos_combo_4" typeName="Point3d" description="Co-ordinate X is INF, Co-ordinate Y is INF, Co-ordinate Z is double" />
                        <ECProperty propertyName="inf_pos_combo_5" typeName="Point3d" description="Co-ordinate X is double, Co-ordinate Y is INF, Co-ordinate Z is INF" />
                        <ECProperty propertyName="inf_pos_combo_6" typeName="Point3d" description="Co-ordinate X is INF, Co-ordinate Y is double, Co-ordinate Z is INF" />

                        <ECProperty propertyName="inf_neg_combo_1" typeName="Point3d" description="Co-ordinate X is double, Co-ordinate Y is double, Co-ordinate Z is INF" />
                        <ECProperty propertyName="inf_neg_combo_2" typeName="Point3d" description="Co-ordinate X is double, Co-ordinate Y is INF, Co-ordinate Z is double" />
                        <ECProperty propertyName="inf_neg_combo_3" typeName="Point3d" description="Co-ordinate X is INF, Co-ordinate Y is double, Co-ordinate Z is double" />
                        <ECProperty propertyName="inf_neg_combo_4" typeName="Point3d" description="Co-ordinate X is INF, Co-ordinate Y is INF, Co-ordinate Z is double" />
                        <ECProperty propertyName="inf_neg_combo_5" typeName="Point3d" description="Co-ordinate X is double, Co-ordinate Y is INF, Co-ordinate Z is INF" />
                        <ECProperty propertyName="inf_neg_combo_6" typeName="Point3d" description="Co-ordinate X is INF, Co-ordinate Y is double, Co-ordinate Z is INF" />

                        <ECProperty propertyName="nan_val_combo_1" typeName="Point3d" description="Co-ordinate X is double, Co-ordinate Y is double, Co-ordinate Z is INF" />
                        <ECProperty propertyName="nan_val_combo_2" typeName="Point3d" description="Co-ordinate X is double, Co-ordinate Y is INF, Co-ordinate Z is double" />
                        <ECProperty propertyName="nan_val_combo_3" typeName="Point3d" description="Co-ordinate X is INF, Co-ordinate Y is double, Co-ordinate Z is double" />
                        <ECProperty propertyName="nan_val_combo_4" typeName="Point3d" description="Co-ordinate X is INF, Co-ordinate Y is INF, Co-ordinate Z is double" />
                        <ECProperty propertyName="nan_val_combo_5" typeName="Point3d" description="Co-ordinate X is double, Co-ordinate Y is INF, Co-ordinate Z is INF" />
                        <ECProperty propertyName="nan_val_combo_6" typeName="Point3d" description="Co-ordinate X is INF, Co-ordinate Y is double, Co-ordinate Z is INF" />
                    </ECEntityClass>
                </ECSchema>)"_schema;
    ...
    const auto neg_inf = -std::numeric_limits<double>::infinity();
    const auto nan_val = std::numeric_limits<double>::quiet_NaN();
    constexpr auto selectStmt = R"sqlstr(select inf_pos, inf_pos_combo_1, inf_pos_combo_2, inf_pos_combo_3, inf_pos_combo_4, inf_pos_combo_5, inf_pos_combo_6,
            inf_neg, inf_neg_combo_1, inf_neg_combo_2, inf_neg_combo_3, inf_neg_combo_4, inf_neg_combo_5, inf_neg_combo_6,
            nan_val, nan_val_combo_1, nan_val_combo_2, nan_val_combo_3, nan_val_combo_4, nan_val_combo_5, nan_val_combo_6 from ts.Element)sqlstr";

    if("insert row") {
        ECSqlStatement stmt;
        ASSERT_EQ(stmt.Prepare(m_ecdb, R"sqlstr(insert into ts.Element(
        ...
        for (const auto& columnValue : { pos_inf, neg_inf, nan_val })
            {
            stmt.BindPoint3d(++columnNumber, DPoint3d::From(columnValue, columnValue, columnValue));
            stmt.BindPoint3d(++columnNumber, DPoint3d::From(1, 1, columnValue));
            stmt.BindPoint3d(++columnNumber, DPoint3d::From(1, columnValue, 1));
            stmt.BindPoint3d(++columnNumber, DPoint3d::From(columnValue, 1, 1));
            stmt.BindPoint3d(++columnNumber, DPoint3d::From(columnValue, columnValue, 1));
            stmt.BindPoint3d(++columnNumber, DPoint3d::From(1, columnValue, columnValue));
            stmt.BindPoint3d(++columnNumber, DPoint3d::From(columnValue, 1, columnValue));
            }
        ASSERT_EQ(columnNumber, 21);
        ASSERT_EQ(stmt.Step(), BE_SQLITE_DONE);
    }
    if("read row") {
        ECSqlStatement stmt;
        ...
        for (auto columnIndex = 0; columnIndex < stmt.GetColumnCount(); ++columnIndex)
            ...
            EXPECT_FALSE(std::isinf(coordX)) << "Value at column " << columnIndex + 1 << " should not be infinity";
            EXPECT_FALSE(std::isinf(coordY)) << "Value at column " << columnIndex + 1 << " should not be infinity";
            EXPECT_FALSE(std::isinf(coordZ)) << "Value at column " << columnIndex + 1 << " should not be infinity";

            EXPECT_FALSE(std::isnan(coordX)) << "Value at column " << columnIndex + 1 << " should not be NaN";
            EXPECT_FALSE(std::isnan(coordY)) << "Value at column " << columnIndex + 1 << " should not be NaN";
            EXPECT_FALSE(std::isnan(coordZ)) << "Value at column " << columnIndex + 1 << " should not be NaN";
            EXPECT_TRUE(stmt.IsValueNull(columnIndex)) << "Value at column " << columnIndex + 1 << " should be NULL";
            }
    }
    if ("jsoncpp must return null for inf") {
    ...
    ASSERT_EQ(columnNumber, 63);
    ASSERT_EQ(BE_SQLITE_DONE, stmt1.Step());

    if("read row") {
        ECSqlStatement stmt;
        ASSERT_EQ(stmt.Prepare(m_ecdb, R"sqlstr(select inf_pos, inf_neg, nan_val,
            inf_pos_combo_1, inf_pos_combo_2, inf_pos_combo_3, inf_pos_combo_4, inf_pos_combo_5, inf_pos_combo_6,
            inf_neg_combo_1, inf_neg_combo_2, inf_neg_combo_3, inf_neg_combo_4, inf_neg_combo_5, inf_neg_combo_6,
            nan_val_combo_1, nan_val_combo_2, nan_val_combo_3, nan_val_combo_4, nan_val_combo_5, nan_val_combo_6 from ts.Element)sqlstr"), ECSqlStatus::Success);
        ASSERT_EQ(stmt.Step(), BE_SQLITE_ROW);
...
TEST_F(ECSqlStatementTestFixture, SelectAnySomeAll)
    ...
    auto classId = m_ecdb.Schemas().GetClassId("ts", "SomeEntity").GetValue();
...
TEST_F(ECSqlStatementTestFixture, ValuesClauseTest) {
    ...
    {
    // Simple SELECT query using VALUES clause
    ...
    {
    // SELECT query with one column from VALUES clause
    ...
    {
    // SELECT query with multiple columns from VALUES clause
    ...
    {
    // SELECT query with asterisk expansion
    ...
    {
    // SELECT query with asterisk expansion and multiple columns
    ...
    {
    // SELECT query with asterisk expansion and multiple subquery aliases
    ...
    {
    // SELECT query with multiple inline tables
    ...
    {
    // SELECT query with nested values clause
    ...
    {
    // SELECT query with triple nested values clause
    ...
    {
    // SELECT query with nested values clause and asterisk expansion
    ...
    {
    // SELECT query having column in nested values clause with asterisk expansion
    ...
    {
    // SELECT query with nested values clause and column alias
    ...
    {
    // SELECT query with triple nested values clause and column alias
    ...
    {
    // SELECT query with various primitive types in VALUES clause
    ECSqlStatement selectVaiousPrimitives;
    std::string query = "SELECT * FROM (VALUES(1, 2.5, 'test', 3.14, TRUE))";
    ASSERT_EQ(ECSqlStatus::Success, selectVaiousPrimitives.Prepare(m_ecdb, query.c_str()));
    ASSERT_STREQ(selectVaiousPrimitives.GetNativeSql(), "SELECT column1,column2,column3,column4,column5 FROM (SELECT column1,column2,column3,column4,column5 FROM (VALUES (1,2.5,'test',3.14,1)))");

    EXPECT_EQ(BE_SQLITE_ROW, selectVaiousPrimitives.Step());
    ASSERT_EQ(5, selectVaiousPrimitives.GetColumnCount());

    ASSERT_EQ(1, selectVaiousPrimitives.GetValueInt(0));
    ASSERT_EQ(2.5, selectVaiousPrimitives.GetValueDouble(1));
    ASSERT_STREQ("test", selectVaiousPrimitives.GetValueText(2));
    ASSERT_EQ(3.14, selectVaiousPrimitives.GetValueDouble(3));
    ASSERT_EQ(true, selectVaiousPrimitives.GetValueBoolean(4));
    }

    {
    // SELECT query with UNION of two VALUES clauses
    ECSqlStatement selectUnion;
    std::string query = "SELECT column1, column2 FROM (VALUES(1,2)) UNION SELECT column1, column2 FROM (VALUES(3,4))";
    ASSERT_EQ(ECSqlStatus::Success, selectUnion.Prepare(m_ecdb, query.c_str()));
    ASSERT_STREQ(selectUnion.GetNativeSql(), "SELECT column1,column2 FROM (SELECT column1,column2 FROM (VALUES (1,2))) UNION SELECT column1,column2 FROM (SELECT column1,column2 FROM (VALUES (3,4)))");

    EXPECT_EQ(BE_SQLITE_ROW, selectUnion.Step());
    ASSERT_EQ(2, selectUnion.GetColumnCount());

    ASSERT_EQ(1, selectUnion.GetValueInt(0));
    ASSERT_EQ(2, selectUnion.GetValueInt(1));
    }

    {
    // SELECT query with aliased columns in VALUES clause
    ECSqlStatement selectAliasedColumns;
    std::string query = "SELECT * FROM (SELECT column1 a, column2 b FROM  (VALUES(1,2)))";
    ASSERT_EQ(ECSqlStatus::Success, selectAliasedColumns.Prepare(m_ecdb, query.c_str()));
    ASSERT_STREQ(selectAliasedColumns.GetNativeSql(), "SELECT [K2],[K3] FROM (SELECT column1 [K2],column2 [K3] FROM (SELECT column1,column2 FROM (VALUES (1,2))))");

    EXPECT_EQ(BE_SQLITE_ROW, selectAliasedColumns.Step());
    ASSERT_EQ(2, selectAliasedColumns.GetColumnCount());

    ASSERT_EQ(1, selectAliasedColumns.GetValueInt(0));
    ASSERT_EQ(2, selectAliasedColumns.GetValueInt(1));
    }

    {
    // SELECT query with Cartesian product of two VALUES clauses
    ECSqlStatement selectCartesianProduct;
    std::string query = "SELECT * FROM (VALUES(1,2)) a, (VALUES(2,3)) b";
    ASSERT_EQ(ECSqlStatus::Success, selectCartesianProduct.Prepare(m_ecdb, query.c_str()));
    ASSERT_STREQ(selectCartesianProduct.GetNativeSql(), "SELECT a.column1,a.column2,b.column1,b.column2 FROM (SELECT column1,column2 FROM (VALUES (1,2))) [a],(SELECT column1,column2 FROM (VALUES (2,3))) [b]");

    EXPECT_EQ(BE_SQLITE_ROW, selectCartesianProduct.Step());
    ASSERT_EQ(4, selectCartesianProduct.GetColumnCount());

    ASSERT_EQ(1, selectCartesianProduct.GetValueInt(0));
    ASSERT_EQ(2, selectCartesianProduct.GetValueInt(1));
    ASSERT_EQ(2, selectCartesianProduct.GetValueInt(2));
    ASSERT_EQ(3, selectCartesianProduct.GetValueInt(3));
    }

    // {
    // // TODO: SELECT query with WHERE clause on Cartesian product of two VALUES clauses
    // ECSqlStatement selectWhereClause;
    // std::string query = "SELECT * FROM (VALUES(1,2)) a, (VALUES(2,3)) b WHERE a.column2=2";
    // ASSERT_EQ(ECSqlStatus::Success, selectWhereClause.Prepare(m_ecdb, query.c_str()));
    // ASSERT_STREQ(selectWhereClause.GetNativeSql(), "SELECT a.column1,a.column2,b.column1,b.column2 FROM (SELECT column1,column2 FROM (VALUES (1,2))) [a],(SELECT column1,column2 FROM (VALUES (2,3))) [b] WHERE a.column2=2");

    // EXPECT_EQ(BE_SQLITE_ROW, selectWhereClause.Step());
    // ASSERT_EQ(4, selectWhereClause.GetColumnCount());

    // ASSERT_EQ(1, selectWhereClause.GetValueInt(0));
    // ASSERT_EQ(2, selectWhereClause.GetValueInt(1));
    // ASSERT_EQ(2, selectWhereClause.GetValueInt(2));
    // ASSERT_EQ(3, selectWhereClause.GetValueInt(3));
    // }

    // {
    // // TODO: Bind parameters in VALUES clause
    // ECSqlStatement bindPrimitives;
    // std::string query = "SELECT * FROM (VALUES(?,?),(?,?)) a";
    // ASSERT_EQ(ECSqlStatus::Success, bindPrimitives.Prepare(m_ecdb, query.c_str()));
    // ASSERT_EQ(ECSqlStatus::Success, bindPrimitives.BindInt(1, 1));
    // ASSERT_EQ(ECSqlStatus::Success, bindPrimitives.BindInt(2, 2));
    // ASSERT_EQ(ECSqlStatus::Success, bindPrimitives.BindInt(3, 3));
    // ASSERT_EQ(ECSqlStatus::Success, bindPrimitives.BindInt(3, 4));
    // ASSERT_STREQ(bindPrimitives.GetNativeSql(), "SELECT column1,column2,column3,column4,column5 FROM (SELECT column1,column2,column3,column4,column5 FROM (VALUES (1,2.5,'test',3.14,1)))");

    // EXPECT_EQ(BE_SQLITE_ROW, bindPrimitives.Step());
    // ASSERT_EQ(5, bindPrimitives.GetColumnCount());

    // ASSERT_EQ(1, bindPrimitives.GetValueInt(0));
    // ASSERT_EQ(2.5, bindPrimitives.GetValueDouble(1));
    // ASSERT_STREQ("test", bindPrimitives.GetValueText(2));
    // ASSERT_EQ(3.14, bindPrimitives.GetValueDouble(3));
    // ASSERT_EQ(true, bindPrimitives.GetValueBoolean(4));
    // }
