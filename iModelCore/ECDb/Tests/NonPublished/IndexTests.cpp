...
TEST_F(IndexTests, InvalidUserDefinedIndexes) {
    ASSERT_EQ(ERROR, TestHelper::RunSchemaImport(SchemaItem(
                         ...
                         "    </ECEntityClass>"
                         "</ECSchema>")))
        << "DbIndexList CA with empty Indexes property is not supported";
    ...
    ASSERT_EQ(ERROR, TestHelper::RunSchemaImport(SchemaItem(
                         ...
                         "    </ECEntityClass>"
                         "</ECSchema>")))
        << "Empty DbIndexList CA is not supported";
    ...
    ASSERT_EQ(ERROR, TestHelper::RunSchemaImport(SchemaItem(
                         ...
                         "    </ECEntityClass>"
                         "</ECSchema>")))
        << "DbIndexList CA with empty DbIndex is not supported";
    ...
    ASSERT_EQ(ERROR, TestHelper::RunSchemaImport(SchemaItem(
                         ...
                         "    </ECEntityClass>"
                         "</ECSchema>")))
        << "DbIndexList CA with DbIndex with empty Properties is not supported";
    ...
    ASSERT_EQ(ERROR, TestHelper::RunSchemaImport(SchemaItem(
                         ...
                         "    </ECEntityClass>"
                         "</ECSchema>")))
        << "DbIndexList CA with DbIndex without Name is not supported";
    ...
    ASSERT_EQ(ERROR, TestHelper::RunSchemaImport(SchemaItem(
                         ...
                         "    </ECEntityClass>"
                         "</ECSchema>")))
        << "Property in index does not exist";
    ...
    ASSERT_EQ(ERROR, TestHelper::RunSchemaImport(SchemaItem(
                         ...
                         "    </ECEntityClass>"
                         "</ECSchema>")))
        << "Cannot define index on struct prop";
    ...
    ASSERT_EQ(ERROR, TestHelper::RunSchemaImport(SchemaItem(
                         ...
                         "    </ECEntityClass>"
                         "</ECSchema>")))
        << "Cannot define index on struct array prop";
    ...
    ASSERT_EQ(ERROR, TestHelper::RunSchemaImport(SchemaItem(
                         ...
                         "  </ECRelationshipClass>"
                         "</ECSchema>")))
        << "Cannot define index on navigation prop";
    ...
    ASSERT_EQ(ERROR, TestHelper::RunSchemaImport(SchemaItem(
                         ...
                         "    </ECEntityClass>"
                         "</ECSchema>")))
        << "Cannot define index on primitive array prop";
    ...
    ASSERT_EQ(ERROR, TestHelper::RunSchemaImport(SchemaItem(
                         ...
                         "    </ECEntityClass>"
                         "</ECSchema>")))
        << "Index with properties that map to different tables is not supported";
}
...
TEST_F(IndexTests, UserDefinedIndexesOnEntityClassSystemProperties) {
    {
        ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("UserDefinedIndexesOnSystemProperties_entityclass.ecdb", SchemaItem(R"xml(<?xml version='1.0' encoding='utf-8'?>
            ...
            << "Indexes on ECInstanceId and non-virtual ECClassId props";
    ...
    ASSERT_EQ(ERROR, TestHelper::RunSchemaImport(SchemaItem(
        ...
        << "Cannot define index on virtual ECClassId col";

    {
        ...
        ASSERT_EQ(ERROR, TestHelper::RunSchemaImport(SchemaItem(
            ...
            << "Cannot define index on virtual RelECClassId col";
...
TEST_F(IndexTests, UserDefinedIndexesOnLinkTableRelSystemProperties) {
    {
        ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("UserDefinedIndexesOnSystemProperties_linktable.ecdb", SchemaItem(R"xml(<?xml version='1.0' encoding='utf-8'?>
            ...
            << "Indexes on all system props of a link table rel";
    ...
    ASSERT_EQ(ERROR, TestHelper::RunSchemaImport(SchemaItem(R"xml(<?xml version='1.0' encoding='utf-8'?>
        ...
        << "Index on SourceECClassId is expected to fail as SourceECClassId is never mapped to the link table";
    ...
    ASSERT_EQ(ERROR, TestHelper::RunSchemaImport(SchemaItem(
        ...
        << "Index on SourceECClassId is expected to fail as SourceECClassId is virtual column";
    ...
    ASSERT_EQ(ERROR, TestHelper::RunSchemaImport(SchemaItem(
        ...
        << "Index on TargetECClassId is expected to fail as TargetECClassId is never mapped to the link table";
    ...
    ASSERT_EQ(ERROR, TestHelper::RunSchemaImport(SchemaItem(
        ...
        << "Index on TargetECClassId is expected to fail as TargetECClassId is virtual column";
}
...
TEST_F(IndexTests, UserDefinedIndexesOnTph) {
    ...
    ASSERT_STRCASEEQ(IndexInfo(indexName, true, "ts4_Base", "Code").ToDdl().c_str(),
                     GetHelper().GetIndexDdl(indexName).c_str())
        << indexName << "> This index is not affected as index is still applying to entire hierarchy";
    ...
    ASSERT_STRCASEEQ(IndexInfo(indexName, true, "ts4_Base", "Sub3_Prop", IndexInfo::WhereClause({sub3ClassId, sub4ClassId})).ToDdl().c_str(),
                     GetHelper().GetIndexDdl(indexName).c_str())
        << indexName << "> This index must include the new subclass Sub4";
    ...
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("userdefinedindextest8.ecdb", SchemaItem(
                                                                                  ...
                                                                                  "    </ECEntityClass>"
                                                                                  "</ECSchema>")))
        << "Index on abstract classes - Schema 1";
    ...
    ASSERT_EQ(SUCCESS, ImportSchema(SchemaItem(
                           ...
                           "    </ECEntityClass>"
                           " </ECSchema>")))
        << "Index on abstract classes - Schema 2";
...
TEST_F(IndexTests, UserDefinedUniqueIndexesOnNonTph) {
    ...
    EXPECT_EQ(ERROR, TestHelper::RunSchemaImport(SchemaItem(R"xml(<?xml version="1.0" encoding="utf-8"?>
        ...
        << "index on abstract base class with single subclasses";
    ...
    EXPECT_EQ(ERROR, TestHelper::RunSchemaImport(SchemaItem(R"xml(<?xml version="1.0" encoding="utf-8"?>
        ...
        << "index on abstract base class with multiple subclasses";
...
TEST_F(IndexTests, UserDefinedIndexWhenClassModifierIsUpgraded) {
    {
        ...
        EXPECT_EQ(ERROR, GetHelper().ImportSchema(SchemaItem(R"xml(<?xml version="1.0" encoding="utf-8"?>
            ...
            << "Class modifier changed from Sealed to None -> index should not be allowed anymore";
    }

    {
        ...
        EXPECT_EQ(SUCCESS, GetHelper().ImportSchema(SchemaItem(R"xml(<?xml version="1.0" encoding="utf-8"?>
            ...
            << "Unsealed subclass (TPH) -> index still valid";
        EXPECT_TRUE(GetHelper().TableExists("ts_Base"));
        EXPECT_STRCASEEQ(IndexInfo("ix_foo", false, "ts_Base", "Code", IndexInfo::WhereClause(fooId)).ToDdl().c_str(), GetHelper().GetIndexDdl("ix_foo").c_str()) << "index on sealed class";
    }
    {
        ...
        EXPECT_EQ(ERROR, GetHelper().ImportSchema(SchemaItem(R"xml(<?xml version="1.0" encoding="utf-8"?>
            ...
            << "Class modifier changed from Abstract is generally not supported.";
    }

    {
        ...
        EXPECT_EQ(SUCCESS, GetHelper().ImportSchema(SchemaItem(R"xml(<?xml version="1.0" encoding="utf-8"?>
            ...
            << "DbIndexes cannot be added during schema upgrade";
    }
}
...
TEST_F(IndexTests, UserDefinedIndexesOnSharedColumns) {
...

    {
        ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("indexonsharedcolumns2.ecdb", SchemaItem(R"xml(<?xml version="1.0" encoding="utf-8"?>
            ...
            << "Unique indices on shared columns are supported.";
...
TEST_F(IndexTests, DuplicateUserDefinedIndexes) {
    ASSERT_EQ(ERROR, TestHelper::RunSchemaImport(SchemaItem(R"xml(<?xml version="1.0" encoding="utf-8"?>
        ...
        << "Index with same name and definition on same class";
    ...
    ASSERT_EQ(ERROR, TestHelper::RunSchemaImport(SchemaItem(R"xml(<?xml version="1.0" encoding="utf-8"?>
        ...
        << "Index with same name and different definition on same class";
    ...
    ASSERT_EQ(ERROR, TestHelper::RunSchemaImport(SchemaItem(
        ...
        << "Index with same name and different definition in subclass";

    {
        ...
        EXPECT_EQ(ERROR, GetHelper().ImportSchema(SchemaItem(
            ...
            << "Index with same name already exists";
        ...
        EXPECT_EQ(ERROR, GetHelper().ImportSchema(SchemaItem(
            ...
            << "Two indexes with same name in same schema";
    }

    {
        ...
        EXPECT_EQ(ERROR, GetHelper().ImportSchema(SchemaItem(
            ...
            << "Index with same name already exists in same table";
    }
}
...
TEST_F(IndexTests, ImplicitIndexesForRelationships) {
...

    {
        ...
        ASSERT_STRCASEEQ(IndexInfo("uix_ts8_B_fk_ts8_RelNonPoly_target", true, "ts8_B", "A2Id", indexWhereClause).ToDdl().c_str(),
                         GetHelper().GetIndexDdl("uix_ts8_B_fk_ts8_RelNonPoly_target").c_str())
