...
TEST_F(RelationshipMappingTestFixture, IdenticalFKRelsWithDifferentConstraints) {
    ...
    EXPECT_STREQ(GetHelper().GetDdl("ts_BaseTPH").c_str(),
                 "CREATE TABLE [ts_BaseTPH]([Id] INTEGER PRIMARY KEY, [ECClassId] INTEGER NOT NULL, [ps1] BLOB, [ps2] BLOB, [ps3] BLOB, [NavPropId] INTEGER, "
