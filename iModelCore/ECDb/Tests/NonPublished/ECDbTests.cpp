...
TEST_F(ECDbTestFixture, ElementRefersToElementsExtendedUniqueIndex)
    ...
    importSchemasTestAndReset(SchemaItem(Utf8PrintfString(bisCoreCommon, 0, "")), {SchemaItem(Utf8PrintfString(bisCoreCommon, 1, memberPriorityProp)), SchemaItem(Utf8PrintfString(testSchema, 1))}, false);
    ...
    importSchemasTestAndReset(SchemaItem(Utf8PrintfString(bisCoreCommon, 0, memberPriorityProp)), {SchemaItem(Utf8PrintfString(testSchema, 0))}, false);
