...
TEST_F(PerformanceSchemaManagerTests, ECClassIdLookup_AllClasses) {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("ecclassidlookup.ecdb", SchemaItem::CreateForFile("ECSqlTest.01.00.00.ecschema.xml"), ECDb::OpenParams(ECDb::OpenMode::Readonly)));
...
TEST_F(PerformanceSchemaManagerTests, GetECClassIdSqlScenarios) {
    ASSERT_EQ(BentleyStatus::SUCCESS, SetupECDb("ecclassidsqlscenarios.ecdb", SchemaItem::CreateForFile("ECSqlTest.01.00.00.ecschema.xml")));
