...
static const SchemaVersion EXPECTED_PROFILEVERSION (3, 104, 0, 0);
...
TEST_F(ECDbTestFixture, CheckECDbProfileVersion)
    ...
    std::vector<std::tuple<SchemaVersion, Db::OpenMode, DbResult, bool>> testVersions {
            ...
            {SchemaVersion(3,104,0,0), Db::OpenMode::Readonly, BE_SQLITE_OK, false},
            {SchemaVersion(3,104,0,0), Db::OpenMode::ReadWrite, BE_SQLITE_OK, false},
            {SchemaVersion(3,104,0,1), Db::OpenMode::Readonly, BE_SQLITE_OK, false},
            {SchemaVersion(3,104,0,1), Db::OpenMode::ReadWrite, BE_SQLITE_OK, false},
            {SchemaVersion(3,104,1,0), Db::OpenMode::Readonly, BE_SQLITE_OK, false},
            {SchemaVersion(3,104,1,0), Db::OpenMode::ReadWrite, BE_SQLITE_ERROR_ProfileTooNewForReadWrite, false},
            {SchemaVersion(3,105,0,0), Db::OpenMode::Readonly, BE_SQLITE_ERROR_ProfileTooNew, false},
            {SchemaVersion(3,105,0,0), Db::OpenMode::ReadWrite, BE_SQLITE_ERROR_ProfileTooNew, false},
