...
TEST_F(ECDbTestFixture, CheckECDbProfileVersion)
    ...
    std::vector<std::tuple<SchemaVersion, Db::OpenMode, DbResult, bool>> testVersions {
            ...
            {SchemaVersion(3,7,0,0), Db::OpenMode::Readonly, BE_SQLITE_OK, true},
            {SchemaVersion(3,7,0,0), Db::OpenMode::ReadWrite, BE_SQLITE_OK, true},
            {SchemaVersion(3,7,0,1), Db::OpenMode::Readonly, BE_SQLITE_OK, true},
            ...
            {SchemaVersion(3,8,1,0), Db::OpenMode::ReadWrite, BE_SQLITE_ERROR_ProfileTooNew, false},
