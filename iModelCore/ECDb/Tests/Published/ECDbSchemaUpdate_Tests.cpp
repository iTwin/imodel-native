...
TEST_F(ECSchemaUpdateTests, AddSharedColumnCount)
    ...
    m_updatedDbs.clear();
    AssertSchemaUpdate(editedSchemaXml, filePath, {true, true}, "Adding SharedColumnCount");
    }
...
TEST_F(ECSchemaUpdateTests, DeleteSharedColumnCount)
    ...
    m_updatedDbs.clear();
    AssertSchemaUpdate(editedSchemaXml, filePath, {true, true}, "Deleting SharedColumnCount.");
    }
