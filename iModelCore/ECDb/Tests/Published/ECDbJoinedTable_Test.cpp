...
TEST_F(JoinedTableECDbMapStrategyTests, BasicCRUD)
    ...
    testSchemas.push_back (SchemaItem(
        ...
        "        <ECProperty propertyName='F' typeName='string'/>"
        "    </ECEntityClass>"
        "   <ECEntityClass typeName='Roo' isDomainClass='True' isStruct='False' isCustomAttributeClass='False'>"
        "        <BaseClass>Boo</BaseClass>"
        "        <ECProperty propertyName='G' typeName='long'/>"
        "        <ECProperty propertyName='H' typeName='string'/>"
        "    </ECEntityClass>"
...
TEST_F (JoinedTableECDbMapStrategyTests, SelfJoinRelationships)
    ...
    SchemaItem testSchema (
        ...
        "        <ECProperty propertyName='D' typeName='string'/>"
        "    </ECEntityClass>"
        "    <ECRelationshipClass typeName='FooHasFoo' strength='referencing'>"
        ...
        "    </Target>"
        "  </ECRelationshipClass>"
        "    <ECRelationshipClass typeName='ManyFooHasManyFoo' strength='referencing'>"
...
TEST_F (JoinedTableECDbMapStrategyTests, BaseAndDirectDerivedClassRelationship)
    ...
    SchemaItem testSchema (
        ...
        "        <ECProperty propertyName='D' typeName='string'/>"
        "    </ECEntityClass>"
        "    <ECRelationshipClass typeName='FooHasGoo' strength='referencing'>"
        "    <Source cardinality='(0,1)' polymorphic='True'>"
        "      <Class class = 'Foo' />"
        "    </Source>"
        "    <Target cardinality='(1,1)' polymorphic='True'>"
        ...
        "    </Target>"
        "  </ECRelationshipClass>"
        "    <ECRelationshipClass typeName='FooHasManyGoo' strength='referencing'>"
        "    <Source cardinality='(0,1)' polymorphic='True'>"
        "      <Class class = 'Foo' />"
        "    </Source>"
        "    <Target cardinality='(0,N)' polymorphic='True'>"
        ...
        "    </Target>"
        "  </ECRelationshipClass>"
        "    <ECRelationshipClass typeName='ManyFooHasManyGoo' strength='referencing'>"
        "    <Source cardinality='(0,N)' polymorphic='True'>"
        "      <Class class = 'Foo' />"
        "    </Source>"
        "    <Target cardinality='(0,N)' polymorphic='True'>"
...
TEST_F (JoinedTableECDbMapStrategyTests, RelationshipsWithKeyProp)
    ...
    SchemaItem testSchema (
        ...
        "        <ECProperty propertyName='D' typeName='string'/>"
        "    </ECEntityClass>"
        "    <ECRelationshipClass typeName='FooHasGooWithKeyProp' strength='referencing'>"
        "    <Source cardinality='(0,1)' polymorphic='True'>"
        "      <Class class = 'Foo' />"
        "    </Source>"
        "    <Target cardinality='(1,1)' polymorphic='True'>"
        ...
        "    </Target>"
        "  </ECRelationshipClass>"
        "    <ECRelationshipClass typeName='FooHasManyGooWithKeyProp' strength='referencing'>"
        "    <Source cardinality='(0,1)' polymorphic='True'>"
        "      <Class class = 'Foo' />"
        "    </Source>"
        "    <Target cardinality='(0,N)' polymorphic='True'>"
...
TEST_F (JoinedTableECDbMapStrategyTests, RelationshipBetweenSubClasses)
    ...
    SchemaItem testSchema (
        ...
        "        <ECProperty propertyName='H' typeName='string'/>"
        "    </ECEntityClass>"
        "    <ECRelationshipClass typeName='GooHasRoo'  strength='referencing'>"
        "    <Source cardinality='(0,1)' polymorphic='True'>"
        "      <Class class = 'Goo' />"
        "    </Source>"
        "    <Target cardinality='(1,1)' polymorphic='True'>"
        ...
        "    </Target>"
        "  </ECRelationshipClass>"
        "    <ECRelationshipClass typeName='GooHasManyRoo' strength='referencing'>"
        "    <Source cardinality='(0,1)' polymorphic='True'>"
        "      <Class class = 'Goo' />"
        "    </Source>"
        "    <Target cardinality='(0,N)' polymorphic='True'>"
        ...
        "    </Target>"
        "  </ECRelationshipClass>"
        "    <ECRelationshipClass typeName='ManyGooHasManyRoo' strength='referencing'>"
        "    <Source cardinality='(0,N)' polymorphic='True'>"
        "      <Class class = 'Goo' />"
        "    </Source>"
        "    <Target cardinality='(0,N)' polymorphic='True'>"
...
TEST_F (JoinedTableECDbMapStrategyTests, RelationshipBetweenSubClassesWithKeyProp)
    ...
    SchemaItem testSchema (
        ...
        "        <ECProperty propertyName='H' typeName='string'/>"
        "    </ECEntityClass>"
        "    <ECRelationshipClass typeName='GooHasRooWithKeyProp' strength='referencing'>"
        "    <Source cardinality='(0,1)' polymorphic='True'>"
        "      <Class class = 'Goo' />"
        "    </Source>"
        "    <Target cardinality='(1,1)' polymorphic='True'>"
        ...
        "    </Target>"
        "  </ECRelationshipClass>"
        "    <ECRelationshipClass typeName='GooHasManyRooWithKeyProp' strength='referencing'>"
        "    <Source cardinality='(0,1)' polymorphic='True'>"
        "      <Class class = 'Goo' />"
        "    </Source>"
        "    <Target cardinality='(0,N)' polymorphic='True'>"
...
TEST_F (JoinedTableECDbMapStrategyTests, RelationshipWithStandAloneClass)
    ...
    SchemaItem testSchema (
        ...
        "        <ECProperty propertyName='F' typeName='string'/>"
        "    </ECEntityClass>"
        "    <ECRelationshipClass typeName='FooHasRoo' strength='referencing'>"
        "    <Source cardinality='(0,1)' polymorphic='True'>"
        "      <Class class = 'Foo' />"
        "    </Source>"
        "    <Target cardinality='(1,1)' polymorphic='True'>"
        ...
        "    </Target>"
        "  </ECRelationshipClass>"
        "    <ECRelationshipClass typeName='FooHasManyRoo' strength='referencing'>"
        "    <Source cardinality='(0,1)' polymorphic='True'>"
        "      <Class class = 'Foo' />"
        "    </Source>"
        "    <Target cardinality='(0,N)' polymorphic='True'>"
        ...
        "    </Target>"
        "  </ECRelationshipClass>"
        "    <ECRelationshipClass typeName='ManyFooHasManyRoo' strength='referencing'>"
        "    <Source cardinality='(0,N)' polymorphic='True'>"
        "      <Class class = 'Foo' />"
        "    </Source>"
        "    <Target cardinality='(0,N)' polymorphic='True'>"
...
TEST_F (JoinedTableECDbMapStrategyTests, RelationshipWithStandAloneClass1)
    ...
    SchemaItem testSchema (
        ...
        "        <ECProperty propertyName='F' typeName='string'/>"
        "    </ECEntityClass>"
        "    <ECRelationshipClass typeName='RooHasFoo' strength='referencing'>"
        "    <Source cardinality='(0,1)' polymorphic='True'>"
        "      <Class class = 'Roo' />"
        "    </Source>"
        "    <Target cardinality='(1,1)' polymorphic='True'>"
        ...
        "    </Target>"
        "  </ECRelationshipClass>"
        "    <ECRelationshipClass typeName='RooHasManyFoo' strength='referencing'>"
        "    <Source cardinality='(0,1)' polymorphic='True'>"
        "      <Class class = 'Roo' />"
        "    </Source>"
        "    <Target cardinality='(0,N)' polymorphic='True'>"
        ...
        "    </Target>"
        "  </ECRelationshipClass>"
        "    <ECRelationshipClass typeName='ManyRooHasManyFoo' strength='referencing'>"
        "    <Source cardinality='(0,N)' polymorphic='True'>"
        "      <Class class = 'Roo' />"
        "    </Source>"
        "    <Target cardinality='(0,N)' polymorphic='True'>"
