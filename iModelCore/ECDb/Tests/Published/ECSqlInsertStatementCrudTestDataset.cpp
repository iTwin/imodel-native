...
ECSqlTestDataset ECSqlInsertTestDataset::ArrayTests ()
    ...
    ECSqlStatementCrudTestDatasetHelper::AddNonSelect (dataset, ecsql);
...
ECSqlTestDataset ECSqlInsertTestDataset::CommonGeometryTests ()
    ...
    ECSqlStatementCrudTestDatasetHelper::AddNonSelect (dataset, ecsql);
        ...
        {
        ecsql = "INSERT INTO ecsql.PASpatial (I, Geometry) VALUES (123, ?)";
        auto& testItem = ECSqlStatementCrudTestDatasetHelper::AddNonSelect (dataset, ecsql);
...
ECSqlTestDataset ECSqlInsertTestDataset::IntoTests ()
    ...
    ECSqlStatementCrudTestDatasetHelper::AddPrepareFailing (dataset, ecsql, ECSqlExpectedResult::Category::Invalid, "Custom Attributes classes are invalid in INSERT statements.");
    ...
    ECSqlStatementCrudTestDatasetHelper::AddPrepareFailing (dataset, ecsql, ECSqlExpectedResult::Category::Invalid, "Unmapped classes cannot be used in INSERT statements.");

    //*******************************************************
    // Abstract classes
    //*******************************************************
    ecsql = "INSERT INTO ecsql.Abstract (I, S) VALUES (123, 'hello')";
    ECSqlStatementCrudTestDatasetHelper::AddPrepareFailing (dataset, ecsql, ECSqlExpectedResult::Category::Invalid, "Abstract classes cannot be used in INSERT statements.");
...
ECSqlTestDataset ECSqlInsertTestDataset::MiscTests (ECDbR ecdb)
    ...
    ecsql = "INSERT INTO ecsql.P (ECInstanceId) VALUES (123)";
    ECSqlStatementCrudTestDatasetHelper::AddNonSelect (dataset, ecsql, false);
    //provoke pk constraint violation as instance with id 123 already exists
    ECSqlStatementCrudTestDatasetHelper::AddStepFailingNonSelect (dataset, ecsql, ECSqlExpectedResult::Category::Invalid);
...
ECSqlTestDataset ECSqlInsertTestDataset::RelationshipEndTableMappingTests (ECDbR ecdb)
    ...
    ECSqlStatementCrudTestDatasetHelper::AddStepFailingNonSelect (dataset, ecsqlStr.c_str (), ECSqlExpectedResult::Category::Invalid);
    }
    ...
    ecsqlStr.Sprintf ("INSERT INTO ecsql.PSAHasP (SourceECInstanceId, SourceECClassId, TargetECInstanceId) VALUES (%lld, ?, %lld);",
        psaECInstanceId.GetValue (), pECInstanceId.GetValue ());
    auto& testItem = ECSqlStatementCrudTestDatasetHelper::AddNonSelect (dataset, ecsqlStr.c_str (), true);
    ...
    ECSqlStatementCrudTestDatasetHelper::AddPrepareFailing (dataset, ecsqlStr.c_str (), ECSqlExpectedResult::Category::Invalid);
    }
    ...
    ecsqlStr.Sprintf ("INSERT INTO ecsql.PSAHasTHBase_0N (SourceECInstanceId, SourceECClassId, TargetECInstanceId, TargetECClassId) VALUES (%lld, ?, %lld, ?);",
        psaECInstanceId.GetValue (), thBaseECInstanceId.GetValue ());
    auto& testItem = ECSqlStatementCrudTestDatasetHelper::AddStepFailingNonSelect (dataset, ecsqlStr.c_str (), ECSqlExpectedResult::Category::Invalid);
    testItem.AddParameterValue (ECSqlTestItem::ParameterValue (ECValue (psaClassId)));
    }
    ...
    ecsqlStr.Sprintf ("INSERT INTO ecsql.PSAHasTHBase_0N (SourceECInstanceId, TargetECInstanceId, TargetECClassId) VALUES (%lld, %lld, ?);",
        psaECInstanceId.GetValue (), thBaseECInstanceId.GetValue ());
    auto& testItem = ECSqlStatementCrudTestDatasetHelper::AddPrepareFailing (dataset, ecsqlStr.c_str (), ECSqlExpectedResult::Category::Invalid);
    testItem.AddParameterValue (ECSqlTestItem::ParameterValue (ECValue (pClassId)));
    }
...
ECSqlTestDataset ECSqlInsertTestDataset::RelationshipLinkTableMappingTests (ECDbCR ecdb)
    ...
    ecsqlStr.Sprintf ("INSERT INTO ecsql.PSAHasPSA (SourceECInstanceId, TargetECInstanceId, TargetECClassId) VALUES (201, 234, %lld);",
                        psaClassId);
    ECSqlStatementCrudTestDatasetHelper::AddNonSelect (dataset, ecsqlStr.c_str ());
    }
