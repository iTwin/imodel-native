...
TEST(ECDbInstances, WriteCalculatedECProperty)
{
    ...
    WString instanceXml = L"<Manager xmlns = \"SimpleCompany.01.00\" >"
        L"<FirstName>StRiNg - 10002</FirstName>"
        L"<LastName>StRiNg - 10002</LastName>"
        L"<EmployeeId>10002</EmployeeId>"
        L"<LatestEducation>"
        L"<Degree>StRiNg - 10007</Degree>"
        L"<Year>10010</Year>"
        L"</LatestEducation>"
        L"<EducationHistory>"
        L"<EducationStruct>"
        L"<Degree>StRiNg - 10008</Degree>"
        L"<GPA>10004.5</GPA>"
        L"</EducationStruct>"
        L"<EducationStruct>"
        L"<Degree>StRiNg - 10009</Degree>"
        L"<Year>10011</Year>"
        L"<GPA>10005</GPA>"
        L"</EducationStruct>"
        L"<EducationStruct>"
        ...
        L"</EducationStruct>"
        L"</EducationHistory>"
        L"<FullName>StRiNg - 10002 StRiNg - 10002</FullName>"
        L"</Manager>";
