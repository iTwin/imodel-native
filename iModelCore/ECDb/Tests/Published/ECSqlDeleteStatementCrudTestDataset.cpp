...
ECSqlTestDataset ECSqlDeleteTestDataset::FromTests (int rowCountPerClass)
    ...
    ECSqlStatementCrudTestDatasetHelper::AddPrepareFailing (dataset, ecsql, ECSqlExpectedResult::Category::Invalid, "Custom Attributes classes are invalid in DELETE statements.");
    ...
    ECSqlStatementCrudTestDatasetHelper::AddPrepareFailing (dataset, ecsql, ECSqlExpectedResult::Category::Invalid, "Unmapped classes cannot be used in DELETE statements.");
