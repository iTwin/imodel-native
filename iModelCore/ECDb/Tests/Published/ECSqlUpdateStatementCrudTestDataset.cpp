...
ECSqlTestDataset ECSqlUpdateTestDataset::DateTimeTests (int rowCountPerClass)
    ...
    auto& testItem = ECSqlStatementCrudTestDatasetHelper::AddNonSelect (dataset, ecsql, 0, true);
    testItem.AddParameterValue (ECSqlTestItem::ParameterValue (DateTime (DateTime::Kind::Utc, 2013, 2, 18, 6, 0, 0)));
    testItem.AddParameterValue (ECSqlTestItem::ParameterValue (DateTime (DateTime::Kind::Utc, 2013, 2, 18, 6, 0, 0)));
    testItem.AddParameterValue (ECSqlTestItem::ParameterValue (DateTime (DateTime::Kind::Unspecified, 2013, 2, 18, 6, 0, 0)));
    testItem.AddParameterValue (ECSqlTestItem::ParameterValue (DateTime (2013, 2, 18)));
...
ECSqlTestDataset ECSqlUpdateTestDataset::MiscTests (int rowCountPerClass)
    ...
    ecsql = "UPDATE ONLY ecsql.PSA SET [ECInstanceId] = -3, I = 123";
    ECSqlStatementCrudTestDatasetHelper::AddPrepareFailing (dataset, ecsql, IECSqlExpectedResult::Category::NotYetSupported, "The bracketed property [ECInstanceId] refers to an ECProperty (and not to the system property ECInstanceId). Parsing [ECInstanceId] is not yet supported.");
...
ECSqlTestDataset ECSqlUpdateTestDataset::TargetClassTests (int rowCountPerClass)
    ...
    ECSqlStatementCrudTestDatasetHelper::AddPrepareFailing (dataset, ecsql, IECSqlExpectedResult::Category::Invalid, "Custom Attributes classes are invalid in UPDATE statements.");
    ...
    ECSqlStatementCrudTestDatasetHelper::AddPrepareFailing (dataset, ecsql, IECSqlExpectedResult::Category::Invalid, "Unmapped classes cannot be used in UPDATE statements.");
    ...
    ECSqlStatementCrudTestDatasetHelper::AddPrepareFailing (dataset, ecsql, IECSqlExpectedResult::Category::Invalid, "Empty classes cannot be used in UPDATE statements.");
