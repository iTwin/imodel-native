...
TEST_F(ECDbMappingTestFixture, RelationshipKeyPropertiesWithMultipleConstraints)
    {
            ...
            SchemaItem testItem("<?xml version='1.0' encoding='utf-8'?>"
                                ...
                                "  </ECEntityClass>"
                                "  <ECRelationshipClass typeName='ParentHasChildren' modifier='Sealed' strength='referencing'>"
...
TEST_F(ECDbMappingTestFixture, SharedTableAppliesToSubclasses_SharedColumns_DisableSharedColumns)
    ...
    //Verify that data inserted Successfully
    ECSqlStatement selectS1, selectS2, selectS3, selectS4, selectS5;
    ASSERT_EQ(ECSqlStatus::Success, selectS1.Prepare(db, "SELECT * FROM rc.BaseClass WHERE P1='HelloWorld'"));
    ASSERT_EQ(BE_SQLITE_ROW, selectS1.Step());
    ASSERT_EQ(ECSqlStatus::Success, selectS2.Prepare(db, "SELECT * FROM rc.ChildDomainClassA WHERE P1='ChildClassA' AND P2=10.002"));
    ASSERT_EQ(BE_SQLITE_ROW, selectS2.Step());
    ASSERT_EQ(ECSqlStatus::Success, selectS3.Prepare(db, "SELECT * FROM rc.ChildDomainClassB WHERE P1='ChildClassB' AND P3=2"));
    ASSERT_EQ(BE_SQLITE_ROW, selectS3.Step());
    ASSERT_EQ(ECSqlStatus::Success, selectS4.Prepare(db, "SELECT * FROM rc.DerivedA WHERE P1='DerivedA' AND P2=11.003 AND P4=12.004"));
    ASSERT_EQ(BE_SQLITE_ROW, selectS4.Step());
    ASSERT_EQ(ECSqlStatus::Success, selectS5.Prepare(db, "SELECT * FROM rc.DerivedB WHERE P1='DerivedB' AND P3=11 AND P5='DerivedB'"));
    ASSERT_EQ(BE_SQLITE_ROW, selectS5.Step());
    }
...
TEST_F(ECDbMappingTestFixture, MultiInheritence_TablePerHierarchyPlusVirtualTable)
    ...
    ECDbCR ecdb = SetupECDb("multiinheritance.ecdb", SchemaItem(
        "<?xml version='1.0' encoding='utf-8'?>"
        "<ECSchema schemaName='Test' nameSpacePrefix='ts1' version='1.0' xmlns='http://www.bentley.com/schemas/Bentley.ECXML.3.0'>"
        "    <ECSchemaReference name='ECDbMap' version='01.01' prefix='ecdbmap' />"
        "    <ECEntityClass typeName='Base1' modifier='Abstract'>"
        "        <ECCustomAttributes>"
        "            <ClassMap xmlns='ECDbMap.01.01'>"
    ...
    ECClassId myClassId = ecdb.Schemas().GetECClassId("ts1", "MyClass", ResolveSchema::BySchemaNamespacePrefix);
...
TEST_F(ECDbMappingTestFixture, IndexCreationForRelationships)
    {
            ...
            AssertIndex(ecdb, "uix_ts_RelNN_sourcetarget", true, "ts_RelNN", {"SourceECInstanceId", "TargetECInstanceId"});
                ...
                SchemaItem testItem(
                    ...
                    "    </ECEntityClass>"
                    "   <ECRelationshipClass typeName='Rel11' modifier='Sealed' strength='embedding'>"
                    "    <Source cardinality='(0,1)' polymorphic='True'>"
                    "      <Class class='A' />"
                    "    </Source>"
                    "    <Target cardinality='(0,1)' polymorphic='True'>"
                    ...
                    "    </Target>"
                    "  </ECRelationshipClass>"
                    "   <ECRelationshipClass typeName='AnotherRel11' modifier='Sealed' strength='embedding'>"
                    "    <Source cardinality='(0,1)' polymorphic='True'>"
                    "      <Class class='A' />"
                    "    </Source>"
                    "    <Target cardinality='(0,1)' polymorphic='True'>"
                    ...
                    "    </Target>"
                    "  </ECRelationshipClass>"
                    "   <ECRelationshipClass typeName='Rel1N' modifier='Sealed' strength='embedding'>"
                    "    <Source cardinality='(0,1)' polymorphic='True'>"
                    "      <Class class='A' />"
                    "    </Source>"
                    "    <Target cardinality='(1,N)' polymorphic='True'>"
                    ...
                    "    </Target>"
                    "  </ECRelationshipClass>"
                    "   <ECRelationshipClass typeName='Rel1NNoKeyProp' modifier='Sealed' strength='embedding'>"
                    "    <Source cardinality='(0,1)' polymorphic='True'>"
                    "      <Class class='A' />"
                    "    </Source>"
                    "    <Target cardinality='(1,N)' polymorphic='True'>"
...
TEST_F(ECDbMappingTestFixture, ForeignKeyMapWithKeyProperty)
    ...
    SchemaItem testItem("<ECSchema schemaName='TestSchema' nameSpacePrefix='ts' version='1.0' xmlns='http://www.bentley.com/schemas/Bentley.ECXML.3.0'>"
                        ...
                        "    <ECStructProperty propertyName='Code' typeName='ElementCode' />"
                        "  </ECEntityClass>"
                        "  <ECRelationshipClass typeName='AuthorityIssuesCode' modifier='Sealed' strength='referencing'>"
                        "    <ECCustomAttributes>"
                        "        <ForeignKeyRelationshipMap xmlns='ECDbMap.01.00'>"
...
TEST_F(ECDbMappingTestFixture, RelationshipWithAbstractConstraintClassAndNoSubclasses)
    ...
    ASSERT_NE(ECSqlStatus::Success, insertStmt.Prepare(ecdb, "INSERT INTO ts.GeometrySourceHasGeometry(SourceECInstanceId, SourceECClassId, TargetECInstanceId, TargetECClassId) VALUES(?,?,?,?)"));
