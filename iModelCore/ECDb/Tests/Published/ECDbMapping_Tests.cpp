...
TEST_F(ECDbMappingTestFixture, ECDbMapTests)
    ...
    testSchemas.push_back("<?xml version='1.0' encoding='utf-8'?>"
                          ...
                          "    </ECClass>"
                          "</ECSchema>");
    testItems.push_back(SchemaItem(testSchemas, false, "SingleJoinedTableForSubclasses cannot be applied if it was already specified higher up in the hierarchy"));
    testSchemas.clear();
    ...
    testItems.push_back(SchemaItem(
        ...
        "        <ECProperty propertyName='Price' typeName='double' />"
        "    </ECClass>"
        "</ECSchema>", false, "Option SharedColumnsForSubclasses is only allowed on class that defines SharedTable."));
    ...
    testItems.push_back(SchemaItem(
        ...
        "    </ECClass>"
        "</ECSchema>", false, "Struct is not supported within a class hierarchy."));
