...
// @bsimethod
//+---------------+---------------+---------------+---------------+---------------+------
IGeometryPtr ECDbBackDoor::BentleyGeometryFlatBuffer::BytesToGeometrySafe(Byte const* buffer, size_t const bufferSize)
    {
    return BentleyApi::BentleyGeometryFlatBuffer::BytesToGeometrySafe(buffer, bufferSize, true);
    }
