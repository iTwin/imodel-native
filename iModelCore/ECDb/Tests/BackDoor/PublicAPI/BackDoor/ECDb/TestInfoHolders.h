...
struct AccessString final {
    ...
    Utf8String ToString() const {
        Utf8String str;
        str.Sprintf("%s:%s.%s", m_schemaNameOrAlias.c_str(), m_className.c_str(), m_propAccessString.c_str());
        return str;
    }
};

enum class Virtual { Yes,
                     No };
...
struct Column final {
   ...
   public:
    ...
    Column(Column const& rhs) : m_tableName(rhs.m_tableName), m_name(rhs.m_name), m_type(rhs.m_type), m_virtual(rhs.m_virtual), m_notNullConstraint(rhs.m_notNullConstraint), m_uniqueConstraint(rhs.m_uniqueConstraint), m_checkConstraint(rhs.m_checkConstraint), m_defaultConstraint(rhs.m_defaultConstraint), m_collationConstraint(rhs.m_collationConstraint), m_kind(rhs.m_kind), m_ordinalInPrimaryKey(rhs.m_ordinalInPrimaryKey) {}

    Column(Column&& rhs) : m_tableName(std::move(rhs.m_tableName)), m_name(std::move(rhs.m_name)), m_type(std::move(rhs.m_type)), m_virtual(std::move(rhs.m_virtual)), m_notNullConstraint(std::move(rhs.m_notNullConstraint)), m_uniqueConstraint(std::move(rhs.m_uniqueConstraint)), m_checkConstraint(std::move(rhs.m_checkConstraint)), m_defaultConstraint(std::move(rhs.m_defaultConstraint)), m_collationConstraint(std::move(rhs.m_collationConstraint)), m_kind(std::move(rhs.m_kind)), m_ordinalInPrimaryKey(std::move(rhs.m_ordinalInPrimaryKey)) {}
...
struct Table final {
   ...
   public:
    ...
    Table(Table&& rhs) : m_name(std::move(rhs.m_name)), m_type(std::move(rhs.m_type)), m_parentTableName(std::move(rhs.m_parentTableName)), m_exclusiveRootClassId(std::move(rhs.m_exclusiveRootClassId)), m_columns(std::move(rhs.m_columns)), m_columnLookupMap(std::move(rhs.m_columnLookupMap)) {}
