...
#define TEST_URL_UNSAFE_CHARS_NO_FRAGMENT           R"(http://httpbin.org:80/ip?<>"{}|\^[]`)"
#define TEST_URL_UNSAFE_CHARS_NO_FRAGMENT_ESCAPED   R"(http://httpbin.org:80/ip?%3C%3E%22%7B%7D%7C%5C%5E%5B%5D%60)"
