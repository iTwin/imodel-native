...
BENTLEY_TRANSLATABLE_STRINGS_START(HttpErrorL10N, HttpError)
    ...
    L10N_STRING(MSG_ConnectionStatus_CouldNotResolveProxy)  // =="Could not resolve proxy server. Please check proxy configuration"==
    ...
    L10N_STRING(STATUS_HttpStatus_407)                      // =="Proxy authentication required"==
    L10N_STRING(STATUS_HttpStatus_407_WithRealm)            // =="Proxy authentication required for server from '%s'"==
