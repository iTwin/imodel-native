...
#include <BEGTEST_FRAMEWORK_SQLANG_DEF.h> // This file is generated by buildGtest.mke
...
struct BeGTestHost : RefCounted<BeTest::Host>
    ...
    void _GetFrameworkSqlangFiles (BeFileName& path) override
        ...
        path.AppendToPath(BEGTEST_FRAMEWORK_SQLANG); // This macro is defined by buildGtest.mke
        }
