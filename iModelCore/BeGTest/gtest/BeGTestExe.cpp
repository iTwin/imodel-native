...
int main(int argc, char **argv)
    ...
    if (umdh_Use(argc, argv))
        ...
        printf("%s\n", winSdkDir);
        CharCP  defArch = "x64";// WinGetEnv("DEFAULT_TARGET_PROCESSOR_ARCHITECTURE");
        //printf("%s\n", defArch);
        ...
        ///printf("%ls\n", currentDirectoryExe.c_str());
        BeStringUtilities::WCharToUtf8(gflagsSet, currentDirectoryExe.c_str());
        //enable gflags first
        //CharP gflagsPath = "C:\\Program Files (x86)\\Windows Kits\\10\\Debuggers\\x64\\gflags.exe";
        ...
        //CharP umdhPath = "C:\\Program Files (x86)\\Windows Kits\\10\\Debuggers\\x64\\umdh.exe";
        ...
        printf("%s\n", generateSnapshot1.c_str());

        // For debugging purposes, take initial snapshot of memory
        ///sprintf_s(strCommand, sizeof(strCommand), "C:\\Program Files (x86)\\Windows Kits\\10\\Debuggers\\x64\\umdh.exe -p:%ld -f:E:\\junk\\findleak.dump.1", GetCurrentProcessId());
    ...
    if (umdh_Use(argc, argv))
        ...
        printf("%ls\n", currentDirectory2.c_str());
        printf("%ls\n", currentDirectory3.c_str());
        ...
        printf("%s\n", generateSnapshot2.c_str());
        // For debugging purposes, take terminal snapshot of memory
        ///sprintf_s(strCommand, sizeof(strCommand), "C:\\Program Files (x86)\\Windows Kits\\10\\Debuggers\\x64\\umdh.exe -p:%ld -f:E:\\junk\\findleak.dump.2", GetCurrentProcessId());
