/*--------------------------------------------------------------------------------------+
|
|     $Source: PublicAPI/Bentley/simple_segregated_storage.h $
|
...
#ifndef BBOOST_SIMPLE_SEGREGATED_STORAGE_HPP
#define BBOOST_SIMPLE_SEGREGATED_STORAGE_HPP
...
#ifdef BBOOST_POOL_VALIDATE
#  define BBOOST_POOL_VALIDATE_INTERNALS validate();
#else
#  define BBOOST_POOL_VALIDATE_INTERNALS
#endif
...
class simple_segregated_storage
{
  ...
  public:
    ...
    { //! Add block
      ...
      //!  \post !empty()
      BBOOST_POOL_VALIDATE_INTERNALS
