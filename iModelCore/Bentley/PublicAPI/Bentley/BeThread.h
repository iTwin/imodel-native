...
#include "BeTimeUtilities.h"
    ...
    //=======================================================================================
    //
    // All of this miserable stuff is here only because the C++/CLI compiler doesn't support std::threads.
    // Until we can get rid of the whole Windows "managed" code, we're stuck with this nonsense.
    //
...
DEFINE_POINTER_SUFFIX_TYPEDEFS(BeMutex);
DEFINE_POINTER_SUFFIX_TYPEDEFS(BeMutexHolder);
DEFINE_POINTER_SUFFIX_TYPEDEFS(IConditionVariablePredicate);
DEFINE_POINTER_SUFFIX_TYPEDEFS(BeConditionVariable);
