...
struct __string_ref
{
    ...
    typedef BENTLEY_BSTDCXX::basic_string<_CharT, _Traits, _Allocator>   string_type;
...
#  ifndef _RWSTD_NO_STRING_REF_COUNT
        ...
        _C_refs.store (1 - _RWSTD_STRING_REF_OFFSET);
...
#  ifndef _RWSTD_NO_STRING_REF_COUNT
        ...
        return _C_refs.load() + _RWSTD_STRING_REF_OFFSET;
    ...
    void _C_unref () {
        ...
        if (this != string_type::_C_nullref ())
            _C_refs.store (-_RWSTD_STRING_REF_OFFSET);
...
// BENTLEY_CHANGE
//extern BENTLEYDLL_EXPORT unsigned long __nullref[];
