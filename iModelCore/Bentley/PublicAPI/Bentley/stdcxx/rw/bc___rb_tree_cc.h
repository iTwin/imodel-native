...
bc___rb_tree (const key_compare    &__cmp /* = key_compare () */,
...
bc___rb_tree<_Key, _Val, _KeyOf, _Comp, _Alloc>& 
bc___rb_tree<_Key, _Val, _KeyOf, _Comp, _Alloc>::
operator= (const bc___rb_tree &__x)
{
    if (this != &__x) {
        erase (begin (), end ());
...
template <class _Key, class _Val, class _KeyOf, class _Comp, class _Alloc>
bc___rb_tree<_Key, _Val, _KeyOf, _Comp, _Alloc>::
bc___rb_tree (const bc___rb_tree &__lnk)
...
template <class _Key, class _Val, class _KeyOf, class _Comp, class _Alloc>
void bc___rb_tree<_Key, _Val, _KeyOf, _Comp, _Alloc>::
_C_add_new_buffer ()
{
    const size_type __bufsize =
        _C_buf_ptr_t () == _C_buf_list ? 0 : _C_buf_list->size;

    size_type __newsize = _RWSTD_NEW_CAPACITY (bc___rb_tree, this, __bufsize);
...
template <class _Key, class _Val, class _KeyOf, class _Comp, class _Alloc>
void bc___rb_tree<_Key, _Val, _KeyOf, _Comp, _Alloc>::
_C_insert (const value_type &__v, BENTLEY_BSTDCXX::bpair<iterator, bool> &__ret,
           bool __dup)
{
    ...
    typedef BENTLEY_BSTDCXX::bpair<iterator, bool> _IterPair;
...
template <class _Key, class _Val, class _KeyOf, class _Comp, class _Alloc>
typename bc___rb_tree<_Key, _Val, _KeyOf, _Comp, _Alloc>::iterator 
bc___rb_tree<_Key, _Val, _KeyOf, _Comp, _Alloc>::erase (iterator __it)
{
    _RWSTD_ASSERT_RANGE (begin (), __it);
...
template <class _Key, class _Val, class _KeyOf, class _Comp, class _Alloc>
typename bc___rb_tree<_Key, _Val, _KeyOf, _Comp, _Alloc>::size_type 
bc___rb_tree<_Key, _Val, _KeyOf, _Comp, _Alloc>::
erase (const key_type &__x)
{
    const BENTLEY_BSTDCXX::bpair<iterator, iterator> __p = equal_range(__x);

    const size_type __n = BC__DISTANCE (__p.first, __p.second, size_type);
...
template <class _Key, class _Val, class _KeyOf, class _Comp, class _Alloc>
typename bc___rb_tree<_Key, _Val, _KeyOf, _Comp, _Alloc>::_C_link_t 
bc___rb_tree<_Key, _Val, _KeyOf, _Comp, _Alloc>::
