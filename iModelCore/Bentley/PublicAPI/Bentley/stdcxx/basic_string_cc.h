/*--------------------------------------------------------------------------------------+
|
|     $Source: PublicAPI/Bentley/stdcxx/basic_string_cc.h $
|
...
// *** BENTLEY_CHANGE
 #include <Bentley/stdcxx/rw/_iterbase.h>
...
template <class _CharT, class _Traits, class _Allocator>
BC__RW::__null_ref<_CharT, _Traits, _Allocator>
basic_string<_CharT, _Traits, _Allocator>::
_C_null_ref;
...
{   
    ...
    const size_type __n = __s? traits_type::length (__s): 0;
...
BENTLEY_BSTDCXX::basic_string<_CharT, _Traits, _Alloc>& 
__rw_replace (basic_string<_CharT, _Traits, _Alloc> &__s, 
    ...
    typedef basic_string<_CharT, _Traits, _Alloc> _C_string_type;
         ...
         _InputIter __first2, _InputIter __last2, void*)
{
    ...
    if (bc___is_bidirectional_iterator (_RWSTD_ITERATOR_CATEGORY(_InputIter,
                                                                    __last2)))
...
__rw_replace_aux (basic_string<_CharT, _Traits, _Alloc> &__s, 
                  _StringIter __first1, _StringIter __last1,
                  _InputIter __first2, _InputIter __last2)
{
    typedef _Traits                                   traits_type;
               ...
               _InputIter __first2, _InputIter __last2)
{
    ...
    const size_type  __n2 = BC__DISTANCE (__first2, __last2, size_type);
    const size_type  __n  = __s._C_off (__first1, __last1);
    const size_type __pos = __s._C_off (__first1);
