...
#ifndef BENTLEY_UTIL_BTREE_BTREE_CONTAINER_H__
#define BENTLEY_UTIL_BTREE_BTREE_CONTAINER_H__
...
// A common base class for btree_set, bmap, btree_multiset and
// btree_multimap.
...
// A common base class for bmap and safe_bmap.
template <typename Tree>
class bmap_container : public btree_unique_container<Tree> {
  typedef bmap_container<Tree> self_type;
 ...
 public:
  // Default constructor.
  bmap_container(const key_compare &comp = key_compare(),
                      const allocator_type &alloc = allocator_type())
      : super_type(comp, alloc) {
  }

  // Copy constructor.
  bmap_container(const self_type &x)
      : super_type(x) {
  }

  // Range constructor.
  template <class InputIterator>
  bmap_container(InputIterator b, InputIterator e,
                      const key_compare &comp = key_compare(),
                      const allocator_type &alloc = allocator_type())
...
#endif  // BENTLEY_UTIL_BTREE_BTREE_CONTAINER_H__
