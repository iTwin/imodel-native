/*--------------------------------------------------------------------------------------+
|
|     $Source: Tests/Published/Http/WebTestsHelper.h $
|
...
HttpRequest StubHttpRequest (Utf8StringCR url, Utf8StringCR method, Utf8StringCR body, const std::map<Utf8String, Utf8String>& headers = std::map<Utf8String, Utf8String> ());
HttpRequest StubHttpGetRequest (Utf8StringCR url, const std::map<Utf8String, Utf8String>& headers = std::map<Utf8String, Utf8String> ());
