...
static void test_regex()
    {
#if IS_GCC
    BeTest::Log ("TestRunner", BeTest::PRIORITY_INFO, "C++11 test - This platform does not support: std::regex");
#else
...
// override
#if IS_GCC
    REPORT_MISSING_FEATURE(override)
#else
