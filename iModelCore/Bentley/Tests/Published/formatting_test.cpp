...
TEST(FormattingTest, Simple)
{
	...
	/*EXPECT_EQ(0, curs.TrueIndex(0, sizeof(int)));
	EXPECT_EQ(1, curs.TrueIndex(1, sizeof(int)));
	EXPECT_EQ(2, curs.TrueIndex(2, sizeof(int)));
	EXPECT_EQ(3, curs.TrueIndex(3, sizeof(int)));
	curs.GetConstants()->ForceBigEndian();
	EXPECT_EQ(3, curs.TrueIndex(0, sizeof(int)));
	EXPECT_EQ(2, curs.TrueIndex(1, sizeof(int)));
	EXPECT_EQ(1, curs.TrueIndex(2, sizeof(int)));
	EXPECT_EQ(0, curs.TrueIndex(3, sizeof(int)));*/
