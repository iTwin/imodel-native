...
// @betest
//---------------------------------------------------------------------------------------
TEST(DateTimeTests, FromStringCharCPTests)
    {
    auto assertFromString = [] (CharCP dateStr, DateTime const& expectedDt, bool expectedSuccess)
        {
        DateTime actualDt;
        if (expectedSuccess)
            {
