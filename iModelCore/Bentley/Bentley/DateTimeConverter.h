...
struct DateTimeConverter : NonCopyableClass
    ...
    private:
        ...
        static DateTime ParseJulianDay(uint64_t jdInMsec, DateTime::Info const& targetInfo);
    ...
    public:
        ...
        static DateTime ConvertFromJulianDay(uint64_t jdInMsec, DateTime::Info const& targetInfo, bool applyTimezoneOffset);
...
private:
    ...
    static DateTime FromIso8601TimeOfDay(Utf8CP iso8601TimeOfDay);
...
public:
    ...
    static DateTime FromIso8601(Utf8CP iso8601DateTime);
};
