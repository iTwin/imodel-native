...
* @bsimethod
+---------------+---------------+---------------+---------------+---------------+------*/
PSolidFacetTopologyTable (IBRepEntityCR in, IFacetOptionsCR options)
    {
...
* @bsimethod
+---------------+---------------+---------------+---------------+---------------+------*/
void            FacetEntity (IBRepEntityCR in, IFacetOptionsCR facetOptions)
    {
    PK_ENTITY_t entityTag = PSolidUtil::GetEntityTag(in);
    Transform   entityTransform = in.GetEntityTransform();
    ...
    __except(GetExceptionCode() == EXCEPTION_ACCESS_VIOLATION)
    {
        ...
        PK_THREAD_tidy();
        throw "ExceptionAccessViolation";
    }
#endif
...
* @bsimethod
+---------------+---------------+---------------+---------------+---------------+------*/
static PSolidFacetTopologyTable* CreateNewFacetTable (IBRepEntityCR in, IFacetOptionsCR options)
    {
...
* @bsimethod
+---------------+---------------+---------------+---------------+---------------+------*/
PolyfaceHeaderPtr PSolidUtil::FacetEntity(IBRepEntityCR entity, IFacetOptionsCR facetOptions)
    {
...
* @bsimethod
+---------------+---------------+---------------+---------------+---------------+------*/
static bool facetTableToPolyfaces(IBRepEntityCR entity, bvector<PolyfaceHeaderPtr>& polyfaces, bvector<FaceAttachment>& params, IFacetOptionsCR facetOptions, IFacetTopologyTable& facetTopo)
    {
...
* @bsimethod
+---------------+---------------+---------------+---------------+---------------+------*/
bool PSolidUtil::FacetEntity(IBRepEntityCR entity, bvector<PolyfaceHeaderPtr>& polyfaces, bvector<FaceAttachment>& params, IFacetOptionsCR facetOptions)
    {
    if (nullptr == entity.GetFaceMaterialAttachments())
        return false; // No reason to call this method when there aren't attachments...can't return params...
