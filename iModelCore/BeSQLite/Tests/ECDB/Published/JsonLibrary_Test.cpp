...
TEST (RapidJson, InsertIntoECDb)
    ...
    db.GetEC().GetSchemaManager().GetECClass (documentClass, "eB_PW_CommonSchema_WSB", "Document");
    ASSERT_TRUE (documentClass != nullptr);
    ECJsonInserter inserter (db, documentClass->GetId());
