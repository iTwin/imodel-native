...
struct PerformanceAdapterTestFixture : PerformanceTestFixture 
    ...
    private:
        ...
        void DoSelect(bool oneAtATime, ECDb& ecdb, ECClassP classP, Utf8String propertyName, bmap<Utf8String, double>& results, StopWatch &LogTimer, Utf8String TestDetails)
            {
    ...
    public:
        ...
        void RunArrayTests(bool oneAtATime, StopWatch &Logtimer, Utf8String TestDetails)
            ...
            EXPECT_EQ (SUCCESS, ecdb.GetEC().GetSchemaManager().GetECClass(classP, schemaName.c_str(), className.c_str()));
