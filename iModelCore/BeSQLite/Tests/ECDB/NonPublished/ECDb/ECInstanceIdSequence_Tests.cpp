...
TEST(ECInstanceIdSequenceTests, ECInstanceIdSequenceFirstIdTest)
    ...
    InsertInstance (actualFirstKey, ecdb, *(schema->GetClassP (L"AAA")));
...
TEST(ECInstanceIdSequenceTests, ECInstanceIdSequenceIncrementationTest)
    ...
    ECInstanceKey id1;
    IECInstancePtr instance1 = InsertInstance (id1, ecdb, *(schema->GetClassP (L"AAA")));
        
    ECInstanceKey id2;
    IECInstancePtr instance2 = InsertInstance (id2, ecdb, *(schema->GetClassP (L"ClassWithPrimitiveProperties")));
    ...
    ECInstanceKey id3;
    IECInstancePtr instance3 = InsertInstance (id3, ecdb, *(schema->GetClassP (L"Foo")));
    ...
    ECInstanceKey id4;
    IECInstancePtr instance4 = InsertInstance (id4, ecdb, *(schema->GetClassP (L"ClassWithPrimitiveArrayProperties")));
...
TEST(ECInstanceIdSequenceTests, ECInstanceIdSequenceIncrementationWithOneToManyRelationshipsTest)
    ...
    IECInstancePtr parentInstance = InsertInstance (parentId, ecdb, *(schema->GetClassP (L"Company")));

    //insert first child instance
    ECInstanceKey child1Id;
    IECInstancePtr child1Instance = InsertInstance (child1Id, ecdb, *(schema->GetClassP (L"Employee")));
    ...
    IECInstancePtr child2Instance = InsertInstance (child2Id, ecdb, *(schema->GetClassP (L"Employee")));
    ...
    ECRelationshipClassCP relClass = schema->GetClassP (L"EmployeeCompany")->GetRelationshipClassCP();
    ...
    ECInstanceKey id;
    InsertInstance (id, ecdb, *(schema->GetClassP (L"AAA")));
...
TEST(ECInstanceIdSequenceTests, ECInstanceIdSequenceIncrementationWithManyToManyRelationshipsTest)
    ...
    ECClassP sourceClass = schema->GetClassP (L"Employee");
    ECInstanceKey id;
    ...
    ECClassP targetClass = schema->GetClassP (L"Hardware");
    ...
    ECRelationshipClassCP relClass = schema->GetClassP (L"EmployeeHardware")->GetRelationshipClassCP();
    EXPECT_TRUE (relClass != nullptr);
...
TEST(ECInstanceIdSequenceTests, ChangeRepositoryIdTest)
    ...
    size_t sequenceIndex = 0;
    ASSERT_TRUE (ecdb.TryGetRepositoryLocalValueIndex (sequenceIndex, ECINSTANCEIDSEQUENCE_BELOCAL_KEY));
    ECClassR testClass = *(schema->GetClassP (L"AAA"));
