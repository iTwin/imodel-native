...
TEST_F(FTS5Test, VirtualTable)
    ...
    EXPECT_EQ(BE_SQLITE_OK, m_db.ExecuteSql("INSERT INTO email (sender, title, body, nosearch) VALUES ('isabelle.schaeffer@nbc.com', 'Retirement', 'Good luck Dave!', 'cc jan luigsech')"));
