...
private:
    ...
    BeSQLite::DbResult CreateECPropertyEntry                    (ECPropertyCR ecProperty, ECPropertyId ecPropertyId, ECClassId ecClassId, Int32 index);
    ...
    BeSQLite::DbResult ImportECProperty                         (ECN::ECPropertyCR ecProperty, ECClassId ecClassId, Int32 index);
