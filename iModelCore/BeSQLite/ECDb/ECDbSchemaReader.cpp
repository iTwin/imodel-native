...
ECClassP ECDbSchemaReader::GetECClass (Utf8StringCR schemaNameOrPrefix, Utf8String className) 
    {
    ...
    stmt->BindText (1, schemaNameOrPrefix.c_str(), Statement::MAKE_COPY_No);
    stmt->BindText (2, className.c_str(), Statement::MAKE_COPY_No);
