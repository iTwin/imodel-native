...
BentleyStatus ECDb_ECSqlSelectBuilder ()
    ...
    ECClassP employeeClass = nullptr;
    BentleyStatus schemaStat = ecdb.GetEC ().GetSchemaManager ().GetECClass (employeeClass, "StartupCompany", "Employee");
    if (SUCCESS != schemaStat)
        {
