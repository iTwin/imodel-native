...
struct ClassDbView : NonCopyableClass
    {
private:
    ClassMapCP m_classMap;

public:
    explicit ClassDbView (ClassMapCR classMap) : m_classMap (&classMap) 
        {}
    virtual ~ClassDbView () {}
...
private:
    ...
    void DoProcessIndices (ClassMapInfoCR mapInfo);
...
public:
    ...
    BentleyStatus GenerateParameterBindings (BindingsR parameterBindings, int firstParameterIndex) const;
    };
