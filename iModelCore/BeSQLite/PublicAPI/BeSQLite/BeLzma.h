   ...
   public:
    struct LzmaParams {
       ...
       public:
        ...
        LzmaParams& SetDictSize(uint32_t dictSize) {
            m_dictSize = dictSize;
            return *this;
        }
        LzmaParams& SetSupportRandomAccess(uint32_t supportRandomAccess) {
            m_supportRandomAccess = supportRandomAccess;
            return *this;
        }
        LzmaParams& SetLevel(int level) {
            m_level = level;
            return *this;
        }
        LzmaParams& SetNumThreads(int threads) {
            m_numThreads = threads;
            return *this;
        }
        LzmaParams& SetAlog(Algorithm algorithm) {
            m_algo = algorithm;
            return *this;
        }
        LzmaParams& SetLC(int lc) {
            m_lc = lc;
            return *this;
        }
        LzmaParams& SetLP(int lp) {
            m_lp = lp;
            return *this;
        }
        LzmaParams& SetPB(int pb) {
            m_pb = pb;
            return *this;
        }
        LzmaParams& SetFB(int fb) {
            m_fb = fb;
            return *this;
        }
        LzmaParams& SetMC(int mc) {
            m_mc = mc;
            return *this;
        }
        LzmaParams& SetNumHashBytes(int numHashBytes) {
            m_numHashBytes = numHashBytes;
            return *this;
        }
        LzmaParams& SetWriteEndMark(int writeEndMark) {
            m_writeEndMark = writeEndMark;
            return *this;
        }
        LzmaParams& SetBTMode(BtMode btMode) {
            m_btMode = btMode;
            return *this;
        }
        LzmaParams& SetBlockSize(size_t size) {
            m_blockSize = size;
            return *this;
        }
        LzmaParams& SetNumBlockThreads(int threads) {
            m_numBlockThreads = threads;
            return *this;
        }
        LzmaParams& SetNumTotalThreads(int threads) {
            m_numTotalThreads = threads;
            return *this;
        }
