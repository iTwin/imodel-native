...
struct Modify
    ...
    DGNPLATFORM_EXPORT static BentleyStatus SweepBody(IBRepEntityPtr& target, DVec3dCR path);

    // NEEDSWORK: Add method that calls PK_BODY_reverse_orientation for sheet bodies...
    };
