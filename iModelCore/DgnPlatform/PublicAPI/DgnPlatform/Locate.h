/*--------------------------------------------------------------------------------------+
|
|     $Source: PublicAPI/DgnPlatform/Locate.h $
|
...
#include <DgnPlatform/HitDetail.h>
...
public:
    ...
    uint32_t GetKeypointDivisor() {return _GetKeypointDivisor();}
    ...
    double GetAperture() {return _GetAperture();}
    void GetLocateError(Utf8StringR reasonString, int reason) {_GetLocateError(reasonString, reason);}
    void InitToolLocate() {_InitToolLocate();}
