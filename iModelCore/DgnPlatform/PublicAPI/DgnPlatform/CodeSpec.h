...
#define BIS_CODESPEC_GraphicalTypeRecipe2d          BIS_CODESPEC(BIS_CLASS_GraphicalTypeRecipe2d)
...
#define BIS_CODESPEC_PhysicalTypeRecipe             BIS_CODESPEC(BIS_CLASS_PhysicalTypeRecipe)
