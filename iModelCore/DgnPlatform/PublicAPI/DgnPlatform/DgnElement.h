...
public:
    ...
    BeSQLite::EC::ECInstanceKey GetECInstanceKey() const {return BeSQLite::EC::ECInstanceKey(GetElementClassId().GetValue(), BeSQLite::EC::ECInstanceId(GetElementId().GetValue()));}
