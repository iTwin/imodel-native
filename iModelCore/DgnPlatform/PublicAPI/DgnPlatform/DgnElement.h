...
public:
    ...
    //! @param[in] placement    The placement for the new element.
    ...
    DGNPLATFORM_EXPORT PhysicalElementCPtr MakeCopy(DgnDbStatus* stat, DgnModelR targetModel, PhysicalElementCR sourceElement, 
        Placement3dCR placement, DgnElement::Code const& code, DgnElementId newParentId = DgnElementId());
};
