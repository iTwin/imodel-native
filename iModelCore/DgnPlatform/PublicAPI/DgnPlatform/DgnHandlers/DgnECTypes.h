...
/*__PUBLISH_SECTION_START__*/
        ...
        //! Named scale : double
        NamedScale                          = 19,
        //! Material projection named group : string. Context must supply DgnModel containing named group.
...
/*__PUBLISH_SECTION_END__*/
        ...
        NamedGroupType                      = 56,
/*__PUBLISH_SECTION_START__*/
        //! Point property containing rotations around 3 axes, formatted as angles with units. Units derived from context's DgnModel, if provided.
        XyzRotations                        = 57,
...
public:
    ...
    DGNPLATFORM_EXPORT static DgnECExtendedTypeR    GetByName (WCharCP extendTypeName);
...
/*__PUBLISH_SECTION_END__*/
private:
    DGNPLATFORM_EXPORT virtual bool _ConvertToString (WStringR str, ECN::ECValueCR v, ECN::IECTypeAdapterContextCR context, ECN::IECInstanceCP formatter) const override;
    DGNPLATFORM_EXPORT virtual bool _ConvertFromString (ECN::ECValueR v, WCharCP str, ECN::IECTypeAdapterContextCR context) const override;
...
protected:
    ...
    virtual bool            _ConvertToString (WStringR valueAsString, ECN::ECValueCR v, IDgnECTypeAdapterContextCR context, ECN::IECInstanceCP formatter) const = 0;
    virtual bool            _ConvertFromString (ECN::ECValueR v, WCharCP stringValue, IDgnECTypeAdapterContextCR context) const = 0;
...
/*__PUBLISH_SECTION_END__*/
    ...
    static IDgnECTypeAdapterP                       GetByFormatterName (WCharCP fmtrName);
/*__PUBLISH_SECTION_START__*/
    };
