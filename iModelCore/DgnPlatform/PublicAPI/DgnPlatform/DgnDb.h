...
public:
    ...
    //! This is done by opening the DgnDb by setting the option to enable schema import (@see DgnDb::OpenParams). 
    //! <pre>
    ...
    //! import. If an error happens during the import, the new transaction is abandoned in the call. 
