...
ClipPlaneContainment ClassifyRange (DRange3dCR range, bool ignoreMasks = false) const;
ClipPlaneContainment ClassifyElementRange (DRange3dCR range, bool is3d, bool ignoreMasks = false) const;
