/*--------------------------------------------------------------------------------------+
|
|     $Source: PublicAPI/DgnPlatform/DgnCore/ClipUtil.h $
|
...
struct ClipUtil
{
    DGNPLATFORM_EXPORT static double    ComputeFrustumOverlap       (ViewportR viewport, DPoint3dCP  testFrustumRootPoints);
