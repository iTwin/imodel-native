...
DGNPLATFORM_TYPEDEFS (MaterialModel)
...
protected:
    ...
    explicit GeometricModel(CreateParams const& params) : T_Super(params), m_rangeIndex(nullptr) { }
public:
...
//=======================================================================================
//! A non-geometric DgnModel which holds materials.
//! @ingroup DgnModelGroup
// @bsiclass                                                    Paul.Connelly   09/15
//=======================================================================================
struct MaterialModel : DgnModel
{
    DEFINE_T_SUPER(DgnModel);
protected:
    ...
    DgnModels::Model::CoordinateSpace _GetCoordinateSpace() const override {return DgnModels::Model::CoordinateSpace::World;}
public:
    explicit MaterialModel(CreateParams const& params) : T_Super(params) { }
};
...
namespace dgn_ModelHandler
{
    ...
    //! The ModelHandler for MaterialModel
    struct EXPORT_VTABLE_ATTRIBUTE Material : Model
    {
        MODELHANDLER_DECLARE_MEMBERS(DGN_CLASSNAME_MaterialModel, MaterialModel, Material, Model, DGNPLATFORM_EXPORT)
    };
};
