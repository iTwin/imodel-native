...
protected:
    ...
    //! The scene is first generated by QueryViewController from the elements in the view.
    //! A subclass can override this method to add non-element-based graphics to the scene. Or, a subclass
    //! can override this method to do add elements that QueryViewController would normally exclude.
