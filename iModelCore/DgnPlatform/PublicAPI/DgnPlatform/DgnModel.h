...
public:
    ...
    */
    ...
    DGNPLATFORM_EXPORT PhysicalElementCPtr GetCapturedSolution(DgnDbStatus* stat, PhysicalModelR catalogModel, ModelSolverDef::ParameterSet const& parameters, bool generateSolution = true);
