...
public:
    ...
    RenderMaterialCPtr Update(DgnDbStatus* status = nullptr) {return GetDgnDb().Elements().Update<RenderMaterial>(*this, status);} //!< Updates this RenderMaterial in the DgnDb and returns the updated persistent RenderMaterial
