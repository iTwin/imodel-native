...
private:
    ...
    Render::GraphicPtr _CreateBranch(Render::GraphicBranch&, TransformCP, ClipVectorCP) override {return new SimplifyGraphic::Base(Render::Graphic::CreateParams(), *this, *this);}
