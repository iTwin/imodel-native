...
enum DgnErrorCategories
    ...
    DGNLOAD_ERROR_BASE              = 0x12000,
    DGNOPEN_STATUS_BASE             = 0x13000,
    DGNFILE_ERROR_BASE              = 0x14000,

    DGNSTREAM_ERROR_BASE            = 0x15000,
    DGNSHAREDFILE_ERROR_BASE        = 0x17000,
    DGNEMBED_ERROR_BASE             = 0x18000,
    DGNELEMENT_ERROR_BASE           = 0x19000,
    GEOCOORD_ATTACH_ERROR_BASE      = 0x1a000,
    VIEW_INFO_ERROR_BASE            = 0x1b000,
    VIEW_GROUP_ERROR_BASE           = 0x1c000,
    NAMED_VIEW_ERROR_BASE           = 0x1d000,
    VIEW_GROUP_MANAGER_ERROR_BASE   = 0x1e000,
    LINESTYLE_ERROR_BASE            = 0x1f000,
    NAMED_GROUP_ERROR_BASE          = 0x20000,
    GEOREFERENCE_ERROR_BASE         = 0x21000,
    VIEWFRUSTUM_ERROR_BASE          = 0x22000,
    VIEWPORT_ERROR_BASE             = 0x23000,
    REGISTERED_APP_ERROR_BASE       = 0x24000,
    DGNPROJECT_ERROR_BASE           = 0x25000,
    PATHNAME_ERROR_BASE             = 0x26000,
    PATHNAME_ERROR_LAST             = 0x26FFF,
    REFRANGEPATH_ERROR_BASE         = 0x27000,
    ANNOTATIONATTACHMENT_ERROR_BASE = 0x28000,
    DCMODEL_ERROR_BASE              = 0x30000,
    MARKUPPROJECT_ERROR_BASE        = 0x31000,
    DGNSCHEMA_ERROR_BASE            = 0x32000,
    };
...
enum DgnFileStatus
    ...
    DGNPROJECT_ERROR_MustBeInProjectDir         = DGNPROJECT_ERROR_BASE + 0x01,
    DGNPROJECT_ERROR_CorruptDatabase            = DGNPROJECT_ERROR_BASE + 0x02,
    DGNPROJECT_ERROR_MissingProjectFile         = DGNPROJECT_ERROR_BASE + 0x03,
    DGNPROJECT_ERROR_CantCreateProjectFile      = DGNPROJECT_ERROR_BASE + 0x04,
    DGNPROJECT_ERROR_CantCreateDgnFile          = DGNPROJECT_ERROR_BASE + 0x05,
    DGNPROJECT_ERROR_NotBoundProject            = DGNPROJECT_ERROR_BASE + 0x06,
    DGNPROJECT_ERROR_CantOpenSeedFile           = DGNPROJECT_ERROR_BASE + 0x07,
    DGNPROJECT_ERROR_ViewNotFound               = DGNPROJECT_ERROR_BASE + 0x08,
    DGNPROJECT_ERROR_WrongBeSQLiteSchemaVersion = DGNPROJECT_ERROR_BASE + 0x09,
    DGNPROJECT_ERROR_InvalidSchemaVersion       = DGNPROJECT_ERROR_BASE + 0x0a,
    DGNPROJECT_ERROR_SQLSchemaError             = DGNPROJECT_ERROR_BASE + 0x0b,
    DGNPROJECT_ERROR_MissingDomain              = DGNPROJECT_ERROR_BASE + 0x0e,
    DGNPROJECT_ERROR_UnitsMissing               = DGNPROJECT_ERROR_BASE + 0x0f,
    DGNPROJECT_ERROR_MissingPropertyTable       = DGNPROJECT_ERROR_BASE + 0x10,
    DGNPROJECT_ERROR_NotDgnMarkupProject        = DGNPROJECT_ERROR_BASE + 0x11,

    DGNPATHNAME_ERROR_IllegalName               = PATHNAME_ERROR_BASE + (UInt32)BeFileNameStatus::IllegalName,
    DGNPATHNAME_ERROR_AlreadyExists             = PATHNAME_ERROR_BASE + (UInt32)BeFileNameStatus::AlreadyExists,
    DGNPATHNAME_ERROR_CantCreate                = PATHNAME_ERROR_BASE + (UInt32)BeFileNameStatus::CantCreate,
    DGNPATHNAME_ERROR_FileNotFound              = PATHNAME_ERROR_BASE + (UInt32)BeFileNameStatus::FileNotFound,
    DGNPATHNAME_ERROR_CantDeleteFile            = PATHNAME_ERROR_BASE + (UInt32)BeFileNameStatus::CantDeleteFile,
    DGNPATHNAME_ERROR_AccessViolation           = PATHNAME_ERROR_BASE + (UInt32)BeFileNameStatus::AccessViolation,
    DGNPATHNAME_ERROR_CantDeleteDir             = PATHNAME_ERROR_BASE + (UInt32)BeFileNameStatus::CantDeleteDir,
...
enum DgnModelStatus
    ...
    DGNMODEL_STATUS_OutOfMemory                 = DGNMODEL_ERROR_BASE + 0x04,
    DGNMODEL_STATUS_ElementNotFound             = DGNMODEL_ERROR_BASE + 0x05,
    DGNMODEL_STATUS_BadModelPtr                 = DGNMODEL_ERROR_BASE + 0x06,
    ...
    DGNMODEL_STATUS_ComplexComponent            = DGNMODEL_ERROR_BASE + 0x0d,       /* error deleting component of a complex element */
    ...
    DGNMODEL_STATUS_InvalidDependency           = DGNMODEL_ERROR_BASE + 0x11,
    DGNMODEL_STATUS_NotComplexHeader            = DGNMODEL_ERROR_BASE + 0x12,
    DGNMODEL_STATUS_2d3dMismatch                = DGNMODEL_ERROR_BASE + 0x13,
    DGNMODEL_STATUS_ReplacingDeleted            = DGNMODEL_ERROR_BASE + 0x14,
    DGNMODEL_STATUS_OversizeElement             = DGNMODEL_ERROR_BASE + 0x15,
    DGNMODEL_STATUS_UndersizeElement            = DGNMODEL_ERROR_BASE + 0x16,
    DGNMODEL_STATUS_InvalidAttrOffset           = DGNMODEL_ERROR_BASE + 0x17,
    DGNMODEL_STATUS_InvalidXattribute           = DGNMODEL_ERROR_BASE + 0x18,
    DGNMODEL_STATUS_InvalidXattributeId         = DGNMODEL_ERROR_BASE + 0x19,
    DGNMODEL_STATUS_DuplicateModelName          = DGNMODEL_ERROR_BASE + 0x1a,
    DGNMODEL_STATUS_NoChange                    = DGNMODEL_ERROR_BASE + 0x1b,
    DGNMODEL_STATUS_DuplicateDependency         = DGNMODEL_ERROR_BASE + 0x1c,
    ...
    DGNMODEL_STATUS_BadAssemblyId               = DGNMODEL_ERROR_BASE + 0x29,
