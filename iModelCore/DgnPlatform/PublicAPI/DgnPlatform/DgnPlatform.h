...
DGNPLATFORM_TYPEDEFS(GraphicalTypeRecipe2d)
...
DGNPLATFORM_TYPEDEFS(PhysicalTypeRecipe)
...
DGNPLATFORM_TYPEDEFS(TemplateGeometryModel2d)
DGNPLATFORM_TYPEDEFS(TemplateGeometryModel3d)
...
DGNPLATFORM_TYPEDEFS(TypeRecipeElement)
...
DGNPLATFORM_REF_COUNTED_PTR(GraphicalTypeRecipe2d)
...
DGNPLATFORM_REF_COUNTED_PTR(PhysicalTypeRecipe)
...
DGNPLATFORM_REF_COUNTED_PTR(TemplateGeometryModel2d)
DGNPLATFORM_REF_COUNTED_PTR(TemplateGeometryModel3d)
DGNPLATFORM_REF_COUNTED_PTR(TextString)
DGNPLATFORM_REF_COUNTED_PTR(TextStringStyle)
DGNPLATFORM_REF_COUNTED_PTR(TxnManager)
DGNPLATFORM_REF_COUNTED_PTR(TypeRecipeElement)
