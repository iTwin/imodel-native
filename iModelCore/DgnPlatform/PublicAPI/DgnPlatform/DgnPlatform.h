...
DGNPLATFORM_TYPEDEFS(GraphicalRecipe2d)
...
DGNPLATFORM_TYPEDEFS(PhysicalRecipe)
...
DGNPLATFORM_TYPEDEFS(RecipeElement)
...
DGNPLATFORM_REF_COUNTED_PTR(GraphicalRecipe2d)
...
DGNPLATFORM_REF_COUNTED_PTR(PhysicalRecipe)
DGNPLATFORM_REF_COUNTED_PTR(PhysicalType)
DGNPLATFORM_REF_COUNTED_PTR(RecipeElement)
...
BEGIN_BENTLEY_RENDER_NAMESPACE
    ...
    DEFINE_POINTER_SUFFIX_TYPEDEFS(Primitive);
    DEFINE_POINTER_SUFFIX_TYPEDEFS(PrimitiveList);

    DEFINE_REF_COUNTED_PTR(Primitive);
