...
/**
* @addtogroup GROUP_Annotation Annotation Module
* The "annotations" module contains APIs related to representing graphical markup in a project, typically in a drawing model, of geometry. For example, a TextAnnotation is a piece of text with an optional frame and leaders/arrows.
*/
