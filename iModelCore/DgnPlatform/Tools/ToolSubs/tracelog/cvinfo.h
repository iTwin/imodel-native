...
#define CV_ZEROLEN 0
    ...
    ((_MSC_VER >= 800) &&  \
     defined(_M_IX86) &&   \
     (_M_IX86 >= 300))
// above ifdef tests for 32-bit compiler and existence of Int32 double support
typedef struct {
    char b[10];
} FLOAT10 ;
...
#define CV_NEWMODE(typ, nm)     ((CV_typ16_t)(((typ) & ~CV_MMASK) | ((nm) << CV_MSHIFT)))
...
#define LF_PAD0PAD1	0xf0f1
#define LF_PAD1PAD2	0xf1f2
#define LF_PAD2PAD3	0xf2f3
#define LF_PAD3PAD4	0xf3f4
#define LF_PAD4PAD5	0xf4f5
#define LF_PAD5PAD6	0xf5f6
#define LF_PAD6PAD7	0xf6f7
#define LF_PAD7PAD8	0xf7f8
 ...
 *      above structure.  The "UInt16 leaf" of the above structure and
 *      the "UInt16 leaf" of the following type definitions are the same
 *      symbol.  When the OMF record is locked via the MHOMFLock API
 *      call, the address of the "UInt16 leaf" is returned
 */
...
#endif
#ifdef  __cplusplus
typedef struct lfPointer_32t : public lfPointerBody_32t {
#endif
    union  {
        struct {
...
// what I actually find reverse engineering LF_POINTER records:
...
//      type record for LF_UNION (reverse engineered)
...
// my reverse engineered version of lfIndex:
...
//      subfield record for friend struct function
...
typedef enum SYM_ENUM_e {
    ...
    S_REGISTER_32t  =  0x1001, // Register variable
    S_CONSTANT_32t  =  0x1002, // constant symbol
    S_UDT_32t       =  0x1003, // User defined type
    S_COBOLUDT_32t  =  0x1004, // special UDT for cobol that does not symbol pack
    S_MANYREG_32t   =  0x1005, // multiple register variable
    S_BPREL32_32t   =  0x1006, // BP-relative
    S_LDATA32_32t   =  0x1007, // Module-local symbol
    S_GDATA32_32t   =  0x1008, // Global data symbol
    S_PUB32_32t     =  0x1009, // a public symbol (CV internal reserved)
    S_LPROC32_32t   =  0x100a, // Local procedure start
    S_GPROC32_32t   =  0x100b, // Global procedure start
    S_VFTABLE32_32t =  0x100c, // address of virtual function table
    S_REGREL32_32t  =  0x100d, // register relative address
    S_LTHREAD32_32t =  0x100e, // local thread storage
    S_GTHREAD32_32t =  0x100f, // global thread storage
    S_LPROCMIPS_32t =  0x1010, // Local procedure start
    S_GPROCMIPS_32t =  0x1011  // Global procedure start
