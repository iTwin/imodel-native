...
TEST_F(DgnLinkTest, Iterator)
    ...
    ASSERT_TRUE(SUCCESS == db.Links().InsertOnElement(element1.GetElementKey(), *links[0]));
    EXPECT_TRUE(1 == db.Links().MakeIterator().QueryCount());

    //.............................................................................................
    for (size_t iLink = 1; iLink < NUM_LINKS; ++iLink)
        ASSERT_TRUE(SUCCESS == db.Links().InsertOnElement(element1.GetElementKey(), *links[iLink]));
    ...
    //.............................................................................................
    db.Links().DeleteFromElement(element1.GetElementKey(), links[0]->GetId());
    EXPECT_TRUE(NUM_LINKS == db.Links().MakeIterator().QueryCount());
