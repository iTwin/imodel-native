...
def main():
    ...
    if is_same(currentDatasetPath, oldDatasetPath):
        ...
        print "An existing test file has changed or new test files are available. Run iModelEvolutionTests-PublishTestPackage job to create a new test file package."
        sys.exit(1)
