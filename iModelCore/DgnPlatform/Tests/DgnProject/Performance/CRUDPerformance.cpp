/*--------------------------------------------------------------------------------------+
|
|  $Source: Tests/DgnProject/Performance/CRUDPerformance.cpp $
|
|  $Copyright: (c) 2016 Bentley Systems, Incorporated. All rights reserved. $
|
+--------------------------------------------------------------------------------------*/
#include "CRUDPerformance.h"

//---------------------------------------------------------------------------------------
// @bsimethod                                      Muhammad Hassan                  11/16
//+---------------+---------------+---------------+---------------+---------------+------
void CRUDPerformance::SetUpTestDgnDb(WCharCP destFileName, Utf8CP testClassName, int initialInstanceCount)
    {
    ...
    DbResult status;
    //m_db->ChangeBriefcaseId(BeBriefcaseId(123));
...
// @bsimethod                                      Muhammad Hassan                  11/16
//+---------------+---------------+---------------+---------------+---------------+------
DgnDbStatus CRUDPerformance::SetPerfElementPropertyValues(DgnElementPtr element, bool update) const
    {
...
// @bsimethod                                      Muhammad Hassan                  11/16
//+---------------+---------------+---------------+---------------+---------------+------
DgnDbStatus CRUDPerformance::SetPerfElementSub1PropertyValues(DgnElementPtr element, bool update) const
    {
...
// @bsimethod                                      Muhammad Hassan                  11/16
//+---------------+---------------+---------------+---------------+---------------+------
DgnDbStatus CRUDPerformance::SetPerfElementSub2PropertyValues(DgnElementPtr element, bool update) const
    {
...
// @bsimethod                                      Muhammad Hassan                  11/16
//+---------------+---------------+---------------+---------------+---------------+------
DgnDbStatus CRUDPerformance::SetPerfElementSub3PropertyValues(DgnElementPtr element, bool update) const
    {
...
// @bsimethod                                      Muhammad Hassan                  11/16
//+---------------+---------------+---------------+---------------+---------------+------
DgnDbStatus CRUDPerformance::SetPropertyValues(Utf8CP className, DgnElementPtr element, bool update) const
    {
...
// @bsimethod                                      Muhammad Hassan                  11/16
//+---------------+---------------+---------------+---------------+---------------+------
DgnDbStatus CRUDPerformance::VerifyPerfElementSelectParams(DgnElementCR element)
    {
...
// @bsimethod                                      Muhammad Hassan                  11/16
//+---------------+---------------+---------------+---------------+---------------+------
DgnDbStatus CRUDPerformance::VerifyPerfElementSub1SelectParams(DgnElementCR element)
    {
...
// @bsimethod                                      Muhammad Hassan                  11/16
//+---------------+---------------+---------------+---------------+---------------+------
DgnDbStatus CRUDPerformance::VerifyPerfElementSub2SelectParams(DgnElementCR element)
    {
...
// @bsimethod                                      Muhammad Hassan                  11/16
//+---------------+---------------+---------------+---------------+---------------+------
DgnDbStatus CRUDPerformance::VerifyPerfElementSub3SelectParams(DgnElementCR element)
    {
...
// @bsimethod                                      Muhammad Hassan                  11/16
//+---------------+---------------+---------------+---------------+---------------+------
DgnDbStatus CRUDPerformance::GetPropertyValues(DgnElementCR element, Utf8CP className)
    {
    if (0 == strcmp(className, PERF_TEST_PERFELEMENT_CLASS_NAME))
...
//+---------------+---------------+---------------+---------------+---------------+------
void CRUDPerformance::LogTiming(StopWatch& timer, Utf8CP description, Utf8CP testClassName, bool omitClassIdFilter, int initialInstanceCount, int opCount) const
    {
...
//---------------------------------------------------------------------------------------
DgnElementId CRUDPerformance::generateTimeBasedId(int counter)
    {
...
// @bsimethod                                   Shaun.Sewall                    09/2016
//---------------------------------------------------------------------------------------
DgnElementId CRUDPerformance::generateAlternatingBriefcaseId(int counter)
    {
...
// @bsimethod                                      Muhammad Hassan                  11/16
//+---------------+---------------+---------------+---------------+---------------+------
void CRUDPerformance::ApiInsertTime(Utf8CP className, int initialInstanceCount, int opCount, bool setFederationGuid, int idStrategy)
    {
    WString wClassName;
...
// @bsimethod                                      Muhammad Hassan                  11/16
//+---------------+---------------+---------------+---------------+---------------+------
void CRUDPerformance::ApiSelectTime(Utf8CP className, int initialInstanceCount, int opCount)
    {
    WString wClassName;
    wClassName.AssignUtf8(className);
...
// @bsimethod                                      Muhammad Hassan                  11/16
//+---------------+---------------+---------------+---------------+---------------+------
void CRUDPerformance::ApiUpdateTime(Utf8CP className, int initialInstanceCount, int opCount)
    {
...
// @bsimethod                                      Muhammad Hassan                  11/16
//+---------------+---------------+---------------+---------------+---------------+------
void CRUDPerformance::ApiDeleteTime(Utf8CP className, int initialInstanceCount, int opCount)
    {
...
// @bsimethod                                      Muhammad Hassan                  11/16
//+---------------+---------------+---------------+---------------+---------------+------
TEST_F(CRUDPerformance, InsertTest)
    {
...
// @bsimethod                                      Muhammad Hassan                  11/16
//+---------------+---------------+---------------+---------------+---------------+------
TEST_F(CRUDPerformance, SelectTest)
    {
...
// @bsimethod                                      Muhammad Hassan                  11/16
//+---------------+---------------+---------------+---------------+---------------+------
TEST_F(CRUDPerformance, UpdateTest)
    {
...
// @bsimethod                                      Muhammad Hassan                  11/16
//+---------------+---------------+---------------+---------------+---------------+------
TEST_F(CRUDPerformance, DeleteTest)
    {
