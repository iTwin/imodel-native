...
BENTLEY_TRANSLATABLE_STRINGS_START(DgnCoreL10N,dgncore_msg)
    L10N_STRING(UNDOMSG_FMT_UNDONE)                                 // ==" Undone"== <<must preserve leading space>>
    L10N_STRING(UNDOMSG_FMT_REDONE)                                        // ==" Redone"== <<must preserve leading space>>
    ...
    L10N_STRING(DISPLAY_INFO_MessageID_Level)                              // =="Level: "==
    L10N_STRING(DISPLAY_INFO_MessageID_Model)                              // =="Model: "==
    L10N_STRING(DISPLAY_INFO_MessageID_GG)                                 // =="GG"==
    L10N_STRING(DISPLAY_INFO_MessageID_Groups)                             // =="Groups= "==
    L10N_STRING(DISPLAY_INFO_MessageID_Transient)                          // =="<transient>"==
    L10N_STRING(HARD_CODED_DGN_FONT_NAMED_SYMBOL_Unknown)                  // =="(Unnamed)"==
    L10N_STRING(HARD_CODED_DGN_FONT_NAMED_SYMBOL_Degree)                    // =="Degree"==
    L10N_STRING(HARD_CODED_DGN_FONT_NAMED_SYMBOL_Diameter)                  // =="Diameter"==
    L10N_STRING(HARD_CODED_DGN_FONT_NAMED_SYMBOL_PlusMinus)               // =="Plus/Minus"==
    L10N_STRING(HARD_CODED_DGN_FONT_NAMED_SYMBOL_CenterLine)              // =="Center Line"==
    L10N_STRING(SCALEDEFINITION_MSGID_SheetScaleCustom)                    // =="CUSTOM"==
