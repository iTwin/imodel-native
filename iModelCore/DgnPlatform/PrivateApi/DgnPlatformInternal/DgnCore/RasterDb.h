...
public:
    ...
    struct Row
        ...
        private:
            ...
            Utf8String          m_name;
            UInt32              m_blockWidth;      // in pixels. 
            UInt32              m_blockHeight;     // in pixels. 
        ...
        public:
            Row (Utf8CP name, UInt32 blockWidth, UInt32 blockHeight, CompressionType compressType, PixelType pixelType, 
    ...
    DgnRasterTable(DgnProjectR project) : m_project(project) {}
...
public:
    ...
    struct RasterBlockData : RefCountedBase
        ...
        public:
            ...
            void const* GetData(UInt32& dataSize) {dataSize = m_stmt.GetColumnBytes(0); return m_stmt.GetValueBlob(0);}
        };


    DgnRasterDataTable(DgnProjectR project) : m_project(project) {}
    ...
    DGNPLATFORM_EXPORT BeSQLite::DbResult ReadData (void* data, UInt32& outDataSize, UInt32 inDataSize, DgnRasterFileId rasterId, UInt32 resolutionLevel, UInt32 rowBlockId, UInt32 columnBlockId);
    ...
    DGNPLATFORM_EXPORT RasterBlockDataPtr ReadDataPtr (BeSQLite::DbResult& status, DgnRasterFileId rasterId, UInt32 resolutionLevel, UInt32 rowBlockId, UInt32 columnBlockId);
    ...
    //! @return BE_SQLITE_OK if the data was successfully read, and error status otherwise.
    //! @note You can use QueryFile get the file's id and to determine how many bytes to allocate for data.
    DGNPLATFORM_EXPORT BeSQLite::DbResult AddData (void const* data, UInt32 datasize, DgnRasterFileId rasterId, UInt32 resolutionLevel, UInt32 rowBlockId, UInt32 columnBlockId);
};
