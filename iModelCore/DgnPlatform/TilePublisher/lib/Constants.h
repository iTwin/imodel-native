...
"computeSingleLight (diffuseIntensity, specularIntensity, normal, toEye, lightDir1, .2, specularExponent);\n"
"computeSingleLight (diffuseIntensity, specularIntensity, normal, toEye, lightDir2, .3, specularExponent);\n"
"computeSingleLight (diffuseIntensity, specularIntensity, normal, toEye, czm_sunDirectionWC, .5, specularExponent);\n"
