...
static bool equalOne(double r1) {return BeNumerical::CompareUsingTolerance(r1, 1.0) == 0;}
static bool equalMinusOne(double r1) {return BeNumerical::CompareUsingTolerance(r1, -1.0) == 0;}
