...
//---------------------------------------------------------------------------------------
AnnotationFrameDrawPtr AnnotationFrameDraw::Create(AnnotationFrameLayoutCR frameLayout) { return new AnnotationFrameDraw(frameLayout); }
...
// @bsimethod                                                   Jeff.Marker     06/2014
//---------------------------------------------------------------------------------------
AnnotationFrameDrawPtr AnnotationFrameDraw::Clone() const { return new AnnotationFrameDraw(*this); }
AnnotationFrameDraw::AnnotationFrameDraw(AnnotationFrameDrawCR rhs) : T_Super(rhs) { CopyFrom(rhs); }
AnnotationFrameDrawR AnnotationFrameDraw::operator=(AnnotationFrameDrawCR rhs) { T_Super::operator=(rhs); if (&rhs != this) CopyFrom(rhs); return *this;}
...
// @bsimethod                                                   Jeff.Marker     06/2014
//---------------------------------------------------------------------------------------
AnnotationFrameLayoutCR AnnotationFrameDraw::GetFrameLayout() const { return *m_frameLayout; }
