...
// @bsimethod                                                   Jeff.Marker     05/2014
//---------------------------------------------------------------------------------------
AnnotationTextBlockPtr AnnotationTextBlock::Create(DgnDbR project, DgnElementId styleID)
    {
...
// @bsimethod                                                   Jeff.Marker     05/2014
//---------------------------------------------------------------------------------------
AnnotationTextBlockPtr AnnotationTextBlock::Create(DgnDbR project, DgnElementId styleID, AnnotationParagraphR par)
    {
...
// @bsimethod                                                   Jeff.Marker     05/2014
//---------------------------------------------------------------------------------------
AnnotationTextBlockPtr AnnotationTextBlock::Create(DgnDbR project, DgnElementId styleID, Utf8CP content)
    {
...
// @bsimethod                                                   Jeff.Marker     05/2014
//---------------------------------------------------------------------------------------
void AnnotationTextBlock::SetStyleId(DgnElementId value, SetAnnotationTextStyleOptions options)
    {
    m_styleID = value;
...
BentleyStatus AnnotationTextBlockPersistence::DecodeFromFlatBuf(AnnotationTextBlockR document, FB::AnnotationTextBlock const& fbDocument)
    ...
    document.SetStyleId(DgnElementId((uint64_t)fbDocument.styleId()), SetAnnotationTextStyleOptions::Direct);
    ...
    if (fbDocument.has_paragraphs())
        ...
        for (auto const& fbParagraph : *fbDocument.paragraphs())
            ...
            paragraph->SetStyleId(DgnElementId((uint64_t)fbParagraph.styleId()), SetAnnotationTextStyleOptions::Direct);
            ...
            if (fbParagraph.has_runs())
                ...
                for (auto const& fbRun : *fbParagraph.runs())
                    ...
                    run->SetStyleId(DgnElementId((uint64_t)fbRun.styleId()), SetAnnotationTextStyleOptions::Direct);
