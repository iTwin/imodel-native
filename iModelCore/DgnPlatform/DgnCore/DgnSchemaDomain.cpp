...
HANDLER_EXTENSION_DEFINE_MEMBERS(IDragManipulatorExtension)
HANDLER_EXTENSION_DEFINE_MEMBERS(IDeleteManipulatorExtension)
HANDLER_EXTENSION_DEFINE_MEMBERS(ITransformManipulatorExtension)
HANDLER_EXTENSION_DEFINE_MEMBERS(IPropertyManipulatorExtension)
HANDLER_EXTENSION_DEFINE_MEMBERS(IVertexManipulatorExtension)
HANDLER_EXTENSION_DEFINE_MEMBERS(IPopupDialogManipulatorExtension)
