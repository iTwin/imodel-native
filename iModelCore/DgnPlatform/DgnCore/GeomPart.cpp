...
StatusInt DbGeometryPartsWriter::SaveGeometryPartToRow(GeomStreamCR geom, DgnCodeCR code, DgnGeometryPartId geomPartId, ElementAlignedBox3dCR box)
    ...
    return (DgnDbStatus::Success == geom.WriteGeomStreamAndStep(m_dgndb, DGN_TABLE(DGN_CLASSNAME_GeometryPart), "Geom", geomPartId.GetValue(), *m_stmt, Column::Geom))? BSISUCCESS: BSIERROR;
    }
