...
//flex || int FindKnotInterval (t) || return knot index to left of parameter. ||
    ...
    GEOMDLLIMPEXP bool AdvanceToBezier(BCurveSegment& segment, size_t &bezierSelect, bool saturateKnots = true) const;
...
//flex 
    ...
    //! Create a series of B�zier curve for the B-spline curve.
    //! @DotNetMethodExclude
    ...
    //! Create a B-spline curve from a series of B�zier curve.
