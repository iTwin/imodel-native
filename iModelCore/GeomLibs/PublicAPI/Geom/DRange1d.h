...
//! function (typically passed as a parameter) for boolean "AND" of 2 parameters.
static GEOMDLLIMPEXP bool BooleanAND (bool a, bool b);
//! function (typically passed as a parameter) for boolean "OR" of 2 parameters.
static GEOMDLLIMPEXP bool BooleanOR(bool a, bool b);
//! function (typically passed as a parameter) for boolean "XOR" of 2 parameters.
static GEOMDLLIMPEXP bool BooleanXOR(bool a, bool b);
//! function (typically passed as a parameter) for boolean "ANotB" of 2 parameters.
static GEOMDLLIMPEXP bool BooleanANotB(bool a, bool b);
...
//! @description return parity of intervals in two pre-sorted sets.  Output may NOT be the same as either input.
static GEOMDLLIMPEXP void ParitySorted(bvector <DRange1d> &dataA, bvector <DRange1d> &dataB, bvector <DRange1d> &dataOut);

//! @description difference of intervals in two pre-sorted sets.  Output may NOT be the same as either input.
...
static GEOMDLLIMPEXP bool AnyRangeContains (bvector<DRange1d> const &data, double x);
