...
public: 
    ...
    //! Test if the angle is a NaN.
    bool IsNan () const { return isnan (m_radians);}
...
public:
    ...
    void SetDegrees(double degrees = 0.0) { m_degrees = degrees; }
    ...
    //! return true if the angle is nan.
    bool IsNan () const { return isnan (m_degrees);}
};
...
public:
    ...
    //! Set all 3 angles to zero.
    void SetZero () {m_roll.SetDegrees (0.0); m_pitch.SetDegrees (0.0); m_yaw.SetDegrees (0.0); }
    ...
    bool IsNan () const { return m_roll.IsNan () || m_pitch.IsNan () || m_yaw.IsNan ();}
