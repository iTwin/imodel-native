...
struct BCurveSegment
    ...
    //! Get a copy of all the knots.
    GEOMDLLIMPEXP void GetKnots (bvector<double> &knots) const;
    //! Get a copy of all the poles, simple xyz copy
    GEOMDLLIMPEXP void GetPolesXYZ(bvector<DPoint3d> &poles) const;
