...
//! This is a strong match of angular parameterization.
...
//! @return true if points at all fractions are equal.
//! This allows start and sweep to be different as long as fractions correspond.
bool IsAlmostEqualByFractionMatch(DEllipse3dCR other, double tolerance) const;
