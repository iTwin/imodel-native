...
GEOMDLLIMPEXP static IPolyfaceConstructionPtr New (IFacetOptionsR options, double pointMatchTolerance = DoubleOps::SmallMetricDistance (), double paramMatchTolerance = 1.0E-12, double normalMatchTolerance = 1.0E-12);
...
//! @param [in] paramMatchTolerance tolerance for testing for identical params (0.0 to use relative tolerance)
//! @param [in] normalMatchTolerance tolerance for testing for identical normals (0.0 to use relative tolerance)
GEOMDLLIMPEXP static IPolyfaceConstructionPtr Create (IFacetOptionsR options, double pointMatchTolerance = DoubleOps::SmallMetricDistance(), double paramMatchTolerance = 1.0E-12, double normalMatchTolerance = 1.0E-12);
