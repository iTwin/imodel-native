...
/*---------------------------------------------------------------------------------**//**
* FIRST, restrict delta to a half period on either side of zero. SECOND, apply scale factor.
* @bsimethod
+---------------+---------------+---------------+---------------+---------------+------*/
...
/*---------------------------------------------------------------------------------**//**
* Compute the aspect ratio of a triange, defined as mu = area/ sum of squared edge lengths This variant uses full 3D coordinates.
* @bsimethod
+---------------+---------------+---------------+---------------+---------------+------*/
...
/*PF*/
/*---------------------------------------------------------------------------------**//**
* regularize the y coordinates in a graph, i.e. insert edges so each face has a single local min and a single local max
* @bsimethod
+---------------+---------------+---------------+---------------+---------------+------*/
