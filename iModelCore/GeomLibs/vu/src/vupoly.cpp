...
/*---------------------------------------------------------------------------------**//**
* Construct loop from contiguous subset of an array of points. Omit duplicates within an xy tolerance. No disconnect logic -- next level up
* must do that.
* @bsimethod
+---------------+---------------+---------------+---------------+---------------+------*/
...
/*---------------------------------------------------------------------------------**//**
* Construct loops from an array of points. Omit duplicates within an xy tolerance. DISCONNECT as either x or y value indicates separator
* point. This initiates new loop; only first loop is indicated by the return value.
* @bsimethod
+---------------+---------------+---------------+---------------+---------------+------*/
