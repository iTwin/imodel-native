//--------------------------------------------------------------------------------------
//     $Source: serialization/src/FlatBuffer/allcg_generated.h $
...
struct PolyfaceBuilder {
  ...
  flatbuffers::Offset<Polyface> Finish() {
    auto o = flatbuffers::Offset<Polyface>(fbb_.EndTable(start_, 17));
    return o;
  }
};
...
struct TransitionSpiralBuilder {
  ...
  flatbuffers::Offset<TransitionSpiral> Finish() {
    auto o = flatbuffers::Offset<TransitionSpiral>(fbb_.EndTable(start_, 2));
    return o;
  }
};
