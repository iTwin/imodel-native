...
struct InterpolationCurve FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const DVector3d *startTangent() const {
    return GetStruct<const DVector3d *>(VT_STARTTANGENT);
  }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<DVector3d>(verifier, VT_STARTTANGENT) &&
...
struct InterpolationCurveBuilder {
  ...
  void add_startTangent(const DVector3d *startTangent) {
...
struct Polyface FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<uint32_t> *intColor() const {
    return GetPointer<const flatbuffers::Vector<uint32_t> *>(VT_INTCOLOR);
  }
  ...
  const flatbuffers::Vector<int32_t> *edgeMateIndex() const {
    return GetPointer<const flatbuffers::Vector<int32_t> *>(VT_EDGEMATEINDEX);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_EDGEMATEINDEX) &&
           verifier.VerifyVector(edgeMateIndex()) &&
           verifier.EndTable();
  }
  ...
  bool has_edgeMateIndex() const { return CheckField(VT_EDGEMATEINDEX); }
};
...
struct PolyfaceBuilder {
  ...
  void add_intColor(flatbuffers::Offset<flatbuffers::Vector<uint32_t>> intColor) {
  ...
  void add_edgeMateIndex(flatbuffers::Offset<flatbuffers::Vector<int32_t>> edgeMateIndex) {
    fbb_.AddOffset(Polyface::VT_EDGEMATEINDEX, edgeMateIndex);
  }
...
inline flatbuffers::Offset<Polyface> CreatePolyface(
    ...
    flatbuffers::Offset<flatbuffers::Vector<uint32_t>> intColor = 0,
...
inline flatbuffers::Offset<Polyface> CreatePolyfaceDirect(
    ...
    const std::vector<uint32_t> *intColor = nullptr,
    ...
    int32_t expectedClosure = 0,
    flatbuffers::Offset<TaggedNumericData> taggedNumericData = 0,
    const std::vector<int32_t> *edgeMateIndex = nullptr) {
  ...
  auto intColor__ = intColor ? _fbb.CreateVector<uint32_t>(*intColor) : 0;
  ...
  auto edgeMateIndex__ = edgeMateIndex ? _fbb.CreateVector<int32_t>(*edgeMateIndex) : 0;
