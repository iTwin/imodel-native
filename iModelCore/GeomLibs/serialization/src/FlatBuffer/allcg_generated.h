...
#ifndef FLATBUFFERS_GENERATED_ALLCG_BENTLEY_GEOMETRY_FB_H_
#define FLATBUFFERS_GENERATED_ALLCG_BENTLEY_GEOMETRY_FB_H_
...
struct Polyface : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<uint32_t> *intColor() const { return GetPointer<const flatbuffers::Vector<uint32_t> *>(12); }
...
struct PolyfaceBuilder {
  ...
  void add_intColor(flatbuffers::Offset<flatbuffers::Vector<uint32_t>> intColor) { fbb_.AddOffset(12, intColor); }
...
#endif  // FLATBUFFERS_GENERATED_ALLCG_BENTLEY_GEOMETRY_FB_H_
