    ...
    if (IsValidCurveIndex (curveId))
        ...
        switch  (desc.type)
            ...
            case RIMSBS_MSBsplineCurve:
                ...
                MSBsplineCurvePtr partialCurve = MSBsplineCurve::CreatePtr();
                if (SUCCESS != bspcurv_segmentCurve (partialCurve.get(), pCurve, s0, s1))
                    break;
        ...
        switch  (desc.type)
            ...
            case RIMSBS_MSBsplineCurve:
                ...
                jmdlRIMSBS_segmentMSBSplineCurveIntersection
                            (this, pRG, pIntersections, pEdgeData0, pEdgeData1, partialCurve.get());
                break;
                }
