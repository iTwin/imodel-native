...
double maxStrokeLength
    ...
    if (NULL != pSpiral)
        ...
        if (maxStrokeLength != 0.0)
            {
            double refDistance = fabs (distanceB - distanceA);
            double myMinStrokeLength = 0.2 * refDistance / sMaxRadians;
            maxStrokeLength = fabs (maxStrokeLength);
            while (maxStrokeLength < myMinStrokeLength)
                maxStrokeLength *= 10.0;
            }
