...
int                     order    /* => order of output curve */
    ...
    BeStringUtilities::Memcpy (pOut->poles, pOut->GetNumPoles() * sizeof(DPoint3d), &Pw[0], numPoles*sizeof(DPoint3d));
    BeStringUtilities::Memcpy (pOut->knots, pOut->GetNumKnots() * sizeof(double), &knots[0], (mknt+1)*sizeof(double));
    return MSB_SUCCESS;
    }
...
int                     order       /* => order of output curve */
    ...
    pOut->Allocate (numPoles, order, false, false);
    BeStringUtilities::Memcpy (pOut->poles, pOut->GetNumPoles() * sizeof(DPoint3d) , &Pw[0], numPoles*sizeof(DPoint3d));
    BeStringUtilities::Memcpy (pOut->knots, pOut->GetNumKnots() * sizeof(double), &knots[0], (mk+1)*sizeof(double));
