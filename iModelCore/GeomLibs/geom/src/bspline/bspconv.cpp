...
* @bsimethod
+---------------+---------------+---------------+---------------+---------------+------*/
void MSBsplineSurface::GetIsoULineVIntersections (double u, bvector<double> &vParamsOut) const
    {
    bspsurf_intersectBoundariesWithUVLine (&vParamsOut, u, this, false);
    }

/*---------------------------------------------------------------------------------**//**
* @bsimethod
+---------------+---------------+---------------+---------------+---------------+------*/
void MSBsplineSurface::GetIsoVLineUIntersections (double v, bvector<double> &uParamsOut) const
    {
    bspsurf_intersectBoundariesWithUVLine (&uParamsOut, v, this, true);
    }
