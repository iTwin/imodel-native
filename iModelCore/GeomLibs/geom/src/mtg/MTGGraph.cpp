...
void MTGGraph::CollectAllNodes (bvector <MTGNodeId> &allNodes)
    {
    allNodes.clear ();
    MTGARRAY_SET_LOOP(currNodeId, this)
        {
        allNodes.push_back(currNodeId);
        }
    MTGARRAY_END_SET_LOOP(currNodeId, this)
    }
...
MTGMask MTGGraph::GrabMask ()
    ...
    PUSH_REVIEWED_STATIC_ANALYSIS_WARNING(6316) // This bit-testing logic is valid
