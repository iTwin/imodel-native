/*--------------------------------------------------------------------------------------+
|
|     $Source: geom/src/mtg/jmdl_mtgswap.cpp $
|
...
/*----------------------------------------------------------------------+
|                                                                       |
| name          jmdlMTGSwap_chooseAndRemove                             |
|                                                                       |
| author        earlinLutz                                      9/99    |
|                                                                       |
+----------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------+
|                                                                       |
| name          jmdlMTGSwap_transferVertexId                            |
|                                                                       |
| author        earlinLutz                                      9/99    |
|                                                                       |
+----------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------+
|                                                                       |
| name          jmdlMTGSwap_quadraticAspectRatio                        |                       |
|                                                                       |
| author        earlinLutz                                      9/99    |
|                                                                       |
...
/*----------------------------------------------------------------------+
|                                                                       |
| name          jmdlMTGSwap_quadraticFlipTest                           |
|                                                                       |
| author        earlinLutz                                      9/99    |
|                                                                       |
+----------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------+
|                                                                       |
| name          jmdlMTGSwap_quadraticXYZFlipTest                        |
|                                                                       |
| author        earlinLutz                                      9/99    |
|                                                                       |
+----------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------+
|                                                                       |
| name          jmdlMTGSwap_scaledQuadraticFlipTest                     |
|                                                                       |
| author        earlinLutz                                      9/99    |
|                                                                       |
+----------------------------------------------------------------------*/
