/*--------------------------------------------------------------------------------------+
|
|     $Source: geom/src/funcs/YawPitchRollAnglesInDegrees.cpp $
|
...
YawPitchRollAngles YawPitchRollAngles::FromRadians (double yawRadians, double pitchRadians, double rollRadians)
    {
...
YawPitchRollAngles YawPitchRollAngles::FromDegrees (double yawDegrees, double pitchDegrees, double rollDegrees)
    {
...
YawPitchRollAngles::YawPitchRollAngles (AngleInDegrees yaw, AngleInDegrees pitch, AngleInDegrees roll)
    : m_yaw (yaw), m_pitch (pitch), m_roll (roll)
    {
    }

YawPitchRollAngles::YawPitchRollAngles (Angle yaw, Angle pitch, Angle roll)
    : m_yaw (yaw), m_pitch (pitch), m_roll (roll) 
    {
    }
...
* Service functions
---------------------------------------------------------------------------------------*/
Transform YawPitchRollAngles::ToTransform (DPoint3dCR origin) const
    {
...
YawPitchRollAngles::YawPitchRollAngles ()
    {
    m_roll = m_pitch = m_yaw = AngleInDegrees::FromDegrees (0.0);
    }
...
AngleInDegrees YawPitchRollAngles::GetYaw ()   const   {return m_yaw;}
AngleInDegrees YawPitchRollAngles::GetPitch () const   {return m_pitch;}
AngleInDegrees YawPitchRollAngles::GetRoll ()  const   {return m_roll;}

void YawPitchRollAngles::SetYaw (AngleInDegrees angle)   { m_yaw = angle;}
void YawPitchRollAngles::SetPitch (AngleInDegrees angle) {m_pitch = angle;}
void YawPitchRollAngles::SetRoll (AngleInDegrees angle)  {m_roll = angle;}
