...
void DMap4d::SetTypeBits (int targetMask) {MDL_HM_SETTYPE (this, targetMask);}
...
#ifdef CompileAll
/*---------------------------------------------------------------------------------**//**
* Interpolate y as a function of x. Return average if vertical. RETURNS interpolated y
* @bsimethod
+---------------+---------------+---------------+---------------+---------------+------*/
