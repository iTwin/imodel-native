...
DVec3dR zAxis
    ...
    /* Pick a principle axis not too parallel to pZAxis.
       This is the rule from DXF interchange book.
    */
...
RotMatrixCR matrix,
    ...
    {
    this->x =     matrix.form3d[0][0] * ax
                + matrix.form3d[0][1] * ay
                + matrix.form3d[0][2] * az;

    this->y =     matrix.form3d[1][0] * ax
                + matrix.form3d[1][1] * ay
                + matrix.form3d[1][2] * az;

    this->z =     matrix.form3d[2][0] * ax
                + matrix.form3d[2][1] * ay
                + matrix.form3d[2][2] * az;
    }
...
RotMatrixCR matrix,
    ...
    {
    this->x =     matrix.form3d[0][0] * ax
                + matrix.form3d[1][0] * ay
                + matrix.form3d[2][0] * az;

    this->y =     matrix.form3d[0][1] * ax
                + matrix.form3d[1][1] * ay
                + matrix.form3d[2][1] * az;

    this->z =     matrix.form3d[0][2] * ax
                + matrix.form3d[1][2] * ay
                + matrix.form3d[2][2] * az;
    }
