...
DPoint3dCR spacePoint
    ...
    {
    double param;
    bool result = this->PointToFractionParameter (param, spacePoint);
...
DPoint3dCR spacePoint
    ...
    {
    return ProjectPointBounded (closestPoint, closestParam, spacePoint, false, false);
    }
/*---------------------------------------------------------------------------------**//**
