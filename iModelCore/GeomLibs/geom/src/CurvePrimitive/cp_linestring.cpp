...
* @bsimethod
+--------------------------------------------------------------------------------------*/
bool CurvePrimitiveLineString::_IsValidGeometry(GeometryValidatorPtr &validator) const
    {
    if (!validator.IsValid ())
        return true;
    return validator->IsValidGeometry(m_points);
    }
...
* @bsimethod
+--------------------------------------------------------------------------------------*/
bool CurvePrimitivePointString::_IsValidGeometry(GeometryValidatorPtr &validator) const
    {
    if (!validator.IsValid())
        return true;
    return validator->IsValidGeometry(m_points);
