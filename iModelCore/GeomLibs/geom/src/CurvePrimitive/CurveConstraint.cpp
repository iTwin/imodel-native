...
#include <Geom/capi/ccctangent_capi.h>
...
struct ITryConstruction : public RefCountedBase
    {
    virtual void TryConstruction (ConstructionContext const &searcher, bvector<ICurvePrimitivePtr> &result) = 0;
    };

typedef RefCountedPtr<ITryConstruction> ITryConstructionPtr;

static void TryConstruction (bvector<CurveConstraint>&constraints, bvector<ITryConstructionPtr> methods, bvector<ICurvePrimitivePtr> &result)
    {
...
static bvector<ConstructionContext::ITryConstructionPtr> s_lineBuilders =
bvector<ConstructionContext::ITryConstructionPtr>
    {
...
static bvector<ConstructionContext::ITryConstructionPtr> s_circleBuilders =
bvector<ConstructionContext::ITryConstructionPtr>
    {
