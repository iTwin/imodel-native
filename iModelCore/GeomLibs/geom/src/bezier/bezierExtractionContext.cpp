/*--------------------------------------------------------------------------------------+
|
|     $Source: geom/src/bezier/bezierExtractionContext.cpp $
|
...
bool        *pbClosed
    ...
    if (*pbClosed
        ...
        double  tol = bsiTrig_maxAbsDPoint3dDPoint3d ((DPoint3d*) pP, (DPoint3d*) (pP + lastPoleIndex)) * 0.00001;
        if (tol > 1.0)
            tol = 1.0;
