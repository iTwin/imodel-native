...
#ifdef NEED_SIGNATURES
Public bool      jmdlEmbeddedDPoint2dArray_insertDPoint3d
(
        EmbeddedDPoint2dArray   *pHeader,
const   DPoint3d                *pInPoint,
        int                     index
);
Public bool      jmdlEmbeddedDPoint2dArray_getDPoint3d
(
...
/*---------------------------------------------------------------------------------**//**
* @description Allocate a new EmbeddedDPoint2dArray header from the system heap.
*
...
+---------------+---------------+---------------+---------------+---------------+------*/
Public EmbeddedDPoint2dArray *jmdlEmbeddedDPoint2dArray_new
(
void
)
    {
    return new EmbeddedDPoint2dArray ();
    }


/*---------------------------------------------------------------------------------**//**
* @description Initialize an EmbeddedDPoint2dArray header.  Prior contents are
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public void  jmdlEmbeddedDPoint2dArray_init
(
EmbeddedDPoint2dArray   *pHeader
)
    {
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public EmbeddedDPoint2dArray *jmdlEmbeddedDPoint2dArray_free
(
EmbeddedDPoint2dArray   *pHeader
)
    {
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public void  jmdlEmbeddedDPoint2dArray_empty
(
EmbeddedDPoint2dArray   *pHeader
)
    {
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public void  jmdlEmbeddedDPoint2dArray_releaseMem
(
EmbeddedDPoint2dArray   *pHeader
)
    {
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public EmbeddedDPoint2dArray *jmdlEmbeddedDPoint2dArray_grab
(
void
)
    {
    ...
    if (!pCache)
        initCache ();
    return (EmbeddedDPoint2dArray *)omdlPtrCache_grabFromCache (pCache);
#else
    return jmdlEmbeddedDPoint2dArray_new ();
#endif
    }
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public EmbeddedDPoint2dArray *jmdlEmbeddedDPoint2dArray_drop
(
EmbeddedDPoint2dArray   *pHeader
)
    {
    ...
    return NULL;
#else
    return jmdlEmbeddedDPoint2dArray_free (pHeader);
#endif
    }
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public void  jmdlEmbeddedDPoint2dArray_swapContents
(
EmbeddedDPoint2dArray   *pHeader0,
EmbeddedDPoint2dArray   *pHeader1
)
    {
    EmbeddedDPoint2dArray scratchHeader = *pHeader0;
    *pHeader0 = *pHeader1;
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDPoint2dArray_ensureCapacity
(
EmbeddedDPoint2dArray   *pHeader,
int                     n
)
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDPoint2dArray_setExactBufferSize
(
EmbeddedDPoint2dArray   *pHeader,
int                     n
)
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public int   jmdlEmbeddedDPoint2dArray_getCount
(
const   EmbeddedDPoint2dArray   *pHeader
)
    {
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDPoint2dArray_addDPoint2d
(
        EmbeddedDPoint2dArray   *pHeader,
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDPoint2dArray_insertDPoint2d
(
        EmbeddedDPoint2dArray   *pHeader,
const   DPoint2d                *pPoint,
        int                     index
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDPoint2dArray_addDPoint2dArray
(
        EmbeddedDPoint2dArray   *pHeader,
const   DPoint2d                *pPoint,
        int                     n
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDPoint2dArray_insertDPoint2dArray
(
        EmbeddedDPoint2dArray   *pHeader,
const   DPoint2d                *pPoint,
        int                     index,
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDPoint2dArray_getDPoint2dArray
(
const   EmbeddedDPoint2dArray   *pHeader,
        DPoint2d                *pBuffer,
        int                     *nGot,
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDPoint2dArray_getDPoint2d
(
const   EmbeddedDPoint2dArray   *pHeader,
        DPoint2d                *pPoint,
        int                     index
...
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDPoint2dArray_dropRange
(
EmbeddedDPoint2dArray   *pHeader,
int                     index,
int                     nDrop
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDPoint2dArray_setDPoint2d
(
EmbeddedDPoint2dArray   *pHeader,
DPoint2d                *pPoint,
int                     index
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public DPoint2d  *jmdlEmbeddedDPoint2dArray_getBlock
(
EmbeddedDPoint2dArray   *pHeader,
int                     n
)
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public int   jmdlEmbeddedDPoint2dArray_getIndexedDPoint2dArray
(
const   EmbeddedDPoint2dArray   *pHeader,
        DPoint2d                *pVertex,
        int                     maxVertex,
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public DPoint2d* jmdlEmbeddedDPoint2dArray_getPtr
(
EmbeddedDPoint2dArray   *pHeader,
int                     index
)
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public const DPoint2d* jmdlEmbeddedDPoint2dArray_getConstPtr
(
const   EmbeddedDPoint2dArray   *pHeader,
        int                     index
)
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDPoint2dArray_swapValues
(
EmbeddedDPoint2dArray   *pHeader,
int                     index1,
int                     index2
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDPoint2dArray_copy
(
        EmbeddedDPoint2dArray   *pDestHeader,
const   EmbeddedDPoint2dArray   *pSourceHeader
)
    {
...
* @remarks This function cannot be called from MDL; instead use
    <PRE>
    ~mmdlUtil_quickSort (jmdlEmbeddedDPoint2dArray_getPtr (pDestHeader, 0),
                       jmdlEmbeddedDPoint2dArray_getCount (pDestHeader),
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public void  jmdlEmbeddedDPoint2dArray_sort
(
EmbeddedDPoint2dArray   *pDestHeader,
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDPoint2dArray_addDPoint4d
(
        EmbeddedDPoint2dArray   *pHeader,
const   DPoint4d                *pInPoint
    ...
    return pHeader != NULL
        ...
        && jmdlEmbeddedDPoint2dArray_insertDPoint3d (pHeader, &point, -1);
    }
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDPoint2dArray_crossProduct3Points
(
const   EmbeddedDPoint2dArray   *pHeader,
        DPoint3d                *pProduct,
        int                     index0,
    ...
    if (   jmdlEmbeddedDPoint2dArray_getDPoint3d (pHeader, &point0, index0)
            && jmdlEmbeddedDPoint2dArray_getDPoint3d (pHeader, &point1, index1)
            && jmdlEmbeddedDPoint2dArray_getDPoint3d (pHeader, &point2, index2)
       )
        {
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDPoint2dArray_addDPoint3d
(
        EmbeddedDPoint2dArray   *pHeader,
const   DPoint3d                *pInPoint
)
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDPoint2dArray_addDPoint3dArray
(
        EmbeddedDPoint2dArray   *pHeader,
const   DPoint3d                *pPointArray,
    ...
    for (i = 0; i < n; i++)
        {
        if (!jmdlEmbeddedDPoint2dArray_addDPoint3d (pHeader, pPointArray + i))
            return false;
        }
    return true;
    }
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDPoint2dArray_insertDPoint3dArray
(
        EmbeddedDPoint2dArray   *pHeader,
const   DPoint3d                *pPointArray,
        int                     index,
    ...
    for (i = 0; i < n; i++)
        {
        if (!jmdlEmbeddedDPoint2dArray_insertDPoint3d (pHeader, pPointArray + i, index + i))
            return false;
        }
    return true;
    }
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDPoint2dArray_getDPoint3dArray
(
const   EmbeddedDPoint2dArray   *pHeader,
        DPoint3d                *pBuffer,
        int                     *pCount,
    ...
    for (i = 0; i < nreq; i++)
        {
        if (!jmdlEmbeddedDPoint2dArray_getDPoint3d (pHeader, pBuffer + i, i0 + i))
            break;
        *pCount += 1;
        }
    return *pCount > 0;
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDPoint2dArray_setDPoint3d
(
EmbeddedDPoint2dArray   *pHeader,
DPoint3d                *pInPoint,
int                     index
    ...
    DPoint2d fPoint;
    bsiDPoint2d_initFromDPoint3d (&fPoint, pInPoint);
    return jmdlEmbeddedDPoint2dArray_setDPoint2d (pHeader, &fPoint, index);
    }
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDPoint2dArray_addFPoint3d
(
        EmbeddedDPoint2dArray   *pHeader,
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDPoint2dArray_addFPoint3dArray
(
        EmbeddedDPoint2dArray   *pHeader,
const   FPoint3d                *pPointArray,
    ...
    for (i = 0; i < n; i++)
        {
        if (!jmdlEmbeddedDPoint2dArray_addFPoint3d (pHeader, pPointArray + i))
            return false;
        }
    return true;
    }
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDPoint2dArray_insertFPoint3d
(
        EmbeddedDPoint2dArray   *pHeader,
const   FPoint3d                *pInPoint,
        int                     index
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDPoint2dArray_insertFPoint3dArray
(
        EmbeddedDPoint2dArray   *pHeader,
const   FPoint3d                *pPointArray,
        int                     index,
    ...
    for (i = 0; i < n; i++)
        {
        if (!jmdlEmbeddedDPoint2dArray_insertFPoint3d (pHeader, pPointArray + i, index + i))
            return false;
        }
    return true;
    }
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDPoint2dArray_getFPoint3d
(
const   EmbeddedDPoint2dArray   *pHeader,
        FPoint3d                *pPoint,
        int                     index
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDPoint2dArray_getFPoint3dArray
(
const   EmbeddedDPoint2dArray   *pHeader,
        FPoint3d                *pBuffer,
        int                     *pCount,
    ...
    for (i = 0; i < nreq; i++)
        {
        if (!jmdlEmbeddedDPoint2dArray_getFPoint3d (pHeader, pBuffer + i, i0 + i))
            break;
        *pCount += 1;
        }
    return *pCount > 0;
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDPoint2dArray_setFPoint3d
(
EmbeddedDPoint2dArray   *pHeader,
FPoint3d                *pInPoint,
int                     index
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDPoint2dArray_addFPoint2d
(
        EmbeddedDPoint2dArray   *pHeader,
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDPoint2dArray_addFPoint2dArray
(
        EmbeddedDPoint2dArray   *pHeader,
const   FPoint2d                *pPointArray,
    ...
    for (i = 0; i < n; i++)
        {
        if (!jmdlEmbeddedDPoint2dArray_addFPoint2d (pHeader, pPointArray + i))
            return false;
        }
    return true;
    }
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDPoint2dArray_insertFPoint2d
(
        EmbeddedDPoint2dArray   *pHeader,
const   FPoint2d                *pInPoint,
        int                     index
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDPoint2dArray_insertFPoint2dArray
(
        EmbeddedDPoint2dArray   *pHeader,
const   FPoint2d                *pPointArray,
        int                     index,
    ...
    for (i = 0; i < n; i++)
        {
        if (!jmdlEmbeddedDPoint2dArray_insertFPoint2d (pHeader, pPointArray + i, index + i))
            return false;
        }
    return true;
    }
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDPoint2dArray_getFPoint2d
(
const   EmbeddedDPoint2dArray   *pHeader,
        FPoint2d                *pPoint,
        int                     index
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDPoint2dArray_getFPoint2dArray
(
const   EmbeddedDPoint2dArray   *pHeader,
        FPoint2d                *pBuffer,
        int                     *pCount,
    ...
    for (i = 0; i < nreq; i++)
        {
        if (!jmdlEmbeddedDPoint2dArray_getFPoint2d (pHeader, pBuffer + i, i0 + i))
            break;
        *pCount += 1;
        }
    return *pCount > 0;
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDPoint2dArray_setFPoint2d
(
EmbeddedDPoint2dArray   *pHeader,
FPoint2d                *pInPoint,
int                     index
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDPoint2dArray_getDRange3d
(
const   EmbeddedDPoint2dArray   *pHeader,
        DRange3d                *pRange
)
...
+---------------+---------------+---------------+---------------+---------------+------*/
Public void  jmdlEmbeddedDPoint2dArray_reverse
(
EmbeddedDPoint2dArray*  pHeader
)
    {
...
+---------------+---------------+---------------+---------------+---------------+------*/
Public void jmdlEmbeddedDPoint2dArray_trim
(
EmbeddedDPoint2dArray *pHeader,
int count
)
