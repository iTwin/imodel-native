...
/*----------------------------------------------------------------------+
|SECTION Integer arrays arrays                                          |
|Functions jmdlVArrayInt_XXXX provide DEPRECATED services for           |
| manipulating arrays of integers.                                      |
|                                                                       |
| As of July 2009, the EmbeddedIntArray is a typedef renaming of        |
| bvector<int>, and the functions here are wrappers around          |
| bvector<int> operations with the "negative index" semantics       |
