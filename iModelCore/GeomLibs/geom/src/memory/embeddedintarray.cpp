...
+---------------+---------------+---------------+---------------+---------------+------*/
Public EmbeddedIntArray  *jmdlEmbeddedIntArray_new
(
void
)
    {
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public void  jmdlEmbeddedIntArray_init
(
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public EmbeddedIntArray  *jmdlEmbeddedIntArray_free
(
EmbeddedIntArray *pHeader
)
    {
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public void  jmdlEmbeddedIntArray_empty
(
EmbeddedIntArray *pHeader
)
    {
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public void  jmdlEmbeddedIntArray_releaseMem
(
EmbeddedIntArray *pHeader
)
    {
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public EmbeddedIntArray  *jmdlEmbeddedIntArray_grab
(
void
)
    {
#ifdef USE_PTR_CACHE
#message USE_PTR_CACHE is defined !!!
    if (!pCache)
        initCache ();
    return (EmbeddedIntArray *)omdlPtrCache_grabFromCache (pCache);
#else
    return jmdlEmbeddedIntArray_new ();
#endif
    }
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public EmbeddedIntArray  *jmdlEmbeddedIntArray_drop
(
EmbeddedIntArray     *pHeader
)
    {
    ...
    return NULL;
#else
    return jmdlEmbeddedIntArray_free (pHeader);
#endif
    }
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public void  jmdlEmbeddedIntArray_swapContents
(
EmbeddedIntArray    *pHeader0,
EmbeddedIntArray    *pHeader1
)
    {
    EmbeddedIntArray scratchHeader = *pHeader0;
    *pHeader0 = *pHeader1;
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedIntArray_ensureCapacity
(
EmbeddedIntArray    *pHeader,
int                 n
)
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedIntArray_setExactBufferSize
(
EmbeddedIntArray    *pHeader,
int                 n
)
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public int   jmdlEmbeddedIntArray_getCount
(
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedIntArray_addInt
(
        EmbeddedIntArray    *pHeader,
const   int                 value
)
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedIntArray_insertInt
(
        EmbeddedIntArray    *pHeader,
const   int                 value,
        int                 index
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedIntArray_addIntArray
(
        EmbeddedIntArray    *pHeader,
const   int                 *pIn,
        int                 n
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedIntArray_insertIntArray
(
        EmbeddedIntArray    *pHeader,
const   int                 *pIn,
        int                 index,
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedIntArray_getIntArray
(
const   EmbeddedIntArray    *pHeader,
        int                 *pBuffer,
        int                 *nGot,
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedIntArray_getInt
(
const   EmbeddedIntArray    *pHeader,
        int                 *pValue,
        int                 index
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedIntArray_dropRange
(
EmbeddedIntArray   *pHeader,
int                     index,
int                     nDrop
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedIntArray_setInt
(
EmbeddedIntArray    *pHeader,
int                 value,
int                 index
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public int   *jmdlEmbeddedIntArray_getBlock
(
EmbeddedIntArray    *pHeader,
int                 n
)
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public int   jmdlEmbeddedIntArray_getIndexedIntArray
(
const   EmbeddedIntArray    *pHeader,
        int                 *pOut,
        int                 maxOut,
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public int*  jmdlEmbeddedIntArray_getPtr
(
EmbeddedIntArray    *pHeader,
int                 index
)
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public const int*    jmdlEmbeddedIntArray_getConstPtr
(
const   EmbeddedIntArray    *pHeader,
        int                 index
)
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedIntArray_swapValues
(
EmbeddedIntArray    *pHeader,
int                 index1,
int                 index2
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedIntArray_copy
(
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public void  jmdlEmbeddedIntArray_sort
(
EmbeddedIntArray    *pHeader
)
    {
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public void  jmdlEmbeddedIntArray_compressMatchingNeighbors
(
EmbeddedIntArray    *pHeader
)
    {
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public int   jmdlEmbeddedIntArray_binarySearch
(
const EmbeddedIntArray    *pHeader,
      int                 target
)
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public void  jmdlEmbeddedIntArray_setConstant
(
EmbeddedIntArray    *pHeader,
int                 value,
int                 num
    ...
    int i;
    int *pBuffer;
    jmdlEmbeddedIntArray_empty (pHeader);
    pBuffer = jmdlEmbeddedIntArray_getBlock (pHeader, num);
    for (i = 0; i < num; i++)
        pBuffer[i] = value;
    }
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedIntArray_popInt
(
EmbeddedIntArray    *pHeader,
int                 *pValue
)
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedIntArray_add2Int
(
EmbeddedIntArray    *pHeader,
int                 value0,
int                 value1
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public void  jmdlEmbeddedIntArray_replaceByLast
(
EmbeddedIntArray    *pHeader,
int                 index
)
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public void  jmdlEmbeddedIntArray_replaceMatched
(
EmbeddedIntArray    *pHeader,
int                 oldValue,
int                 newValue
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public EmbeddedIntArray  *jmdlEmbeddedIntArray_grabOrEmpty
(
EmbeddedIntArray    *pUserArray
    ...
    if (pUserArray)
        {
        jmdlEmbeddedIntArray_empty (pUserArray);
        return pUserArray;
        }
    else
        return jmdlEmbeddedIntArray_grab ();
    }
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public void  jmdlEmbeddedIntArray_dropIfGrabbed
(
...
const   EmbeddedIntArray    *pUserArray
    ...
    if (!pUserArray)
        {
        jmdlEmbeddedIntArray_drop (pArray);
        }
    }
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public int   jmdlEmbeddedIntArray_findIntFromEnd
(
EmbeddedIntArray    *pHeader,
int                 target
)
    {
    int i;
    int n = jmdlEmbeddedIntArray_getCount(pHeader);
    int *pBuffer = jmdlEmbeddedIntArray_getPtr (pHeader, 0);
    for (i = n; --i >= 0; )
        {
        if (pBuffer[i] == target)
            return i;
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedIntArray_add3Int
(
EmbeddedIntArray    *pHeader,
int                 value0,
int                 value1,
...
+---------------+---------------+---------------+---------------+---------------+------*/
Public void  jmdlEmbeddedIntArray_reverse
(
EmbeddedIntArray*  pHeader
)
    {
...
* @bsimethod                                                    DavidAssaf      02/05
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedIntArray_reverseBlock
(
EmbeddedIntArray*   pHeader,
int                 index,
int                 num
...
+---------------+---------------+---------------+---------------+---------------+------*/
Public void jmdlEmbeddedIntArray_trim
(
EmbeddedIntArray *pHeader,
int count
)
