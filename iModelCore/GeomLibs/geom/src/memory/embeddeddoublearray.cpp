/*--------------------------------------------------------------------------------------+
|
|     $Source: geom/src/memory/embeddeddoublearray.cpp $
|
...
+---------------+---------------+---------------+---------------+---------------+------*/
Public EmbeddedDoubleArray *jmdlEmbeddedDoubleArray_new
(
void
)
    {
    return new EmbeddedDoubleArray ();
    }
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public void  jmdlEmbeddedDoubleArray_init
(
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public EmbeddedDoubleArray   *jmdlEmbeddedDoubleArray_free
(
EmbeddedDoubleArray *pHeader
)
    {
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public void  jmdlEmbeddedDoubleArray_empty
(
EmbeddedDoubleArray *pHeader
)
    {
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public void  jmdlEmbeddedDoubleArray_releaseMem
(
EmbeddedDoubleArray *pHeader
)
    {
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public EmbeddedDoubleArray   *jmdlEmbeddedDoubleArray_grab
(
void
)
    {
    ...
    if (!pCache)
        initCache ();
    return (EmbeddedDoubleArray *)omdlPtrCache_grabFromCache (pCache);
#else
    return jmdlEmbeddedDoubleArray_new ();
#endif
    }
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public EmbeddedDoubleArray   *jmdlEmbeddedDoubleArray_drop
(
EmbeddedDoubleArray     *pHeader
)
    {
    ...
    return NULL;
#else
    return jmdlEmbeddedDoubleArray_free (pHeader);
#endif
    }
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public void  jmdlEmbeddedDoubleArray_swapContents
(
EmbeddedDoubleArray *pHeader0,
EmbeddedDoubleArray *pHeader1
)
    {
    EmbeddedDoubleArray scratchHeader = *pHeader0;
    *pHeader0 = *pHeader1;
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDoubleArray_ensureCapacity
(
EmbeddedDoubleArray *pHeader,
int                 n
)
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDoubleArray_setExactBufferSize
(
EmbeddedDoubleArray    *pHeader,
int                 n
)
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public int   jmdlEmbeddedDoubleArray_getCount
(
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDoubleArray_addDouble
(
        EmbeddedDoubleArray *pHeader,
const   double              value
)
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDoubleArray_insertDouble
(
        EmbeddedDoubleArray *pHeader,
const   double              value,
        int                 index
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDoubleArray_addDoubleArray
(
        EmbeddedDoubleArray *pHeader,
const   double              *pIn,
        int                 n
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDoubleArray_insertDoubleArray
(
        EmbeddedDoubleArray *pHeader,
const   double              *pIn,
        int                 index,
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDoubleArray_getDoubleArray
(
const   EmbeddedDoubleArray *pHeader,
        double              *pBuffer,
        int                 *nGot,
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDoubleArray_getDouble
(
const   EmbeddedDoubleArray *pHeader,
        double              *pValue,
        int                 index
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDoubleArray_dropRange
(
EmbeddedDoubleArray   *pHeader,
int                     index,
int                     nDrop
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDoubleArray_setDouble
(
EmbeddedDoubleArray *pHeader,
double              value,
int                 index
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public double    *jmdlEmbeddedDoubleArray_getBlock
(
EmbeddedDoubleArray *pHeader,
int                 n
)
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public int   jmdlEmbeddedDoubleArray_getIndexedDoubleArray
(
const   EmbeddedDoubleArray *pHeader,
        double              *pOut,
        int                 maxOut,
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public double*   jmdlEmbeddedDoubleArray_getPtr
(
EmbeddedDoubleArray *pHeader,
int                 index
)
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public const double* jmdlEmbeddedDoubleArray_getConstPtr
(
const   EmbeddedDoubleArray *pHeader,
        int                 index
)
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDoubleArray_swapValues
(
EmbeddedDoubleArray *pHeader,
int                 index1,
int                 index2
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public bool      jmdlEmbeddedDoubleArray_copy
(
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public void  jmdlEmbeddedDoubleArray_sort
(
EmbeddedDoubleArray *pHeader
)
    {
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public void jmdlEmbeddedDoubleArray_trim
(
EmbeddedDoubleArray *pHeader,
int count
)
...
+---------------+---------------+---------------+---------------+---------------+------*/
Public void  jmdlEmbeddedDoubleArray_reverse
(
EmbeddedDoubleArray*  pHeader
)
    {
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public void  jmdlEmbeddedDoubleArray_setConstant
(
EmbeddedDoubleArray    *pHeader,
double              value,
int                 num
    ...
    int i;
    double *pBuffer;
    jmdlEmbeddedDoubleArray_empty (pHeader);
    pBuffer = jmdlEmbeddedDoubleArray_getBlock (pHeader, num);
    for (i = 0; i < num; i++)
        pBuffer[i] = value;
    }
