...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public GEOMDLLIMPEXP bool      jmdlEmbeddedDPoint3dArray_addFPoint3d
(
        EmbeddedDPoint3dArray   *pHeader,
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public GEOMDLLIMPEXP bool      jmdlEmbeddedDPoint3dArray_addFPoint3dArray
(
        EmbeddedDPoint3dArray   *pHeader,
const   FPoint3d                *pPointArray,
    ...
    for (i = 0; i < n; i++)
        {
        if (!jmdlEmbeddedDPoint3dArray_addFPoint3d (pHeader, pPointArray + i))
            return false;
        }
    return true;
    }
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public GEOMDLLIMPEXP bool      jmdlEmbeddedDPoint3dArray_insertFPoint3d
(
        EmbeddedDPoint3dArray   *pHeader,
const   FPoint3d                *pInPoint,
        int                     index
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public GEOMDLLIMPEXP bool      jmdlEmbeddedDPoint3dArray_insertFPoint3dArray
(
        EmbeddedDPoint3dArray   *pHeader,
const   FPoint3d                *pPointArray,
        int                     index,
    ...
    for (i = 0; i < n; i++)
        {
        if (!jmdlEmbeddedDPoint3dArray_insertFPoint3d (pHeader, pPointArray + i, index + i))
            return false;
        }
    return true;
    }
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public GEOMDLLIMPEXP bool      jmdlEmbeddedDPoint3dArray_getFPoint3d
(
const   EmbeddedDPoint3dArray   *pHeader,
        FPoint3d                *pPoint,
        int                     index
    ...
    DPoint3d fPoint;
    if (   pHeader != NULL
        && jmdlEmbeddedDPoint3dArray_getDPoint3d (pHeader, &fPoint, index))
        {
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public GEOMDLLIMPEXP bool      jmdlEmbeddedDPoint3dArray_getFPoint3dArray
(
const   EmbeddedDPoint3dArray   *pHeader,
        FPoint3d                *pBuffer,
        int                     *pCount,
    ...
    for (i = 0; i < nreq; i++)
        {
        if (!jmdlEmbeddedDPoint3dArray_getFPoint3d (pHeader, pBuffer + i, i0 + i))
            break;
        *pCount += 1;
        }
    return *pCount > 0;
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public GEOMDLLIMPEXP bool      jmdlEmbeddedDPoint3dArray_setFPoint3d
(
EmbeddedDPoint3dArray   *pHeader,
FPoint3d                *pInPoint,
int                     index
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public GEOMDLLIMPEXP bool      jmdlEmbeddedDPoint3dArray_addFPoint2d
(
        EmbeddedDPoint3dArray   *pHeader,
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public GEOMDLLIMPEXP bool      jmdlEmbeddedDPoint3dArray_addFPoint2dArray
(
        EmbeddedDPoint3dArray   *pHeader,
const   FPoint2d                *pPointArray,
    ...
    for (i = 0; i < n; i++)
        {
        if (!jmdlEmbeddedDPoint3dArray_addFPoint2d (pHeader, pPointArray + i))
            return false;
        }
    return true;
    }
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public GEOMDLLIMPEXP bool      jmdlEmbeddedDPoint3dArray_insertFPoint2d
(
        EmbeddedDPoint3dArray   *pHeader,
const   FPoint2d                *pInPoint,
        int                     index
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public GEOMDLLIMPEXP bool      jmdlEmbeddedDPoint3dArray_insertFPoint2dArray
(
        EmbeddedDPoint3dArray   *pHeader,
const   FPoint2d                *pPointArray,
        int                     index,
    ...
    for (i = 0; i < n; i++)
        {
        if (!jmdlEmbeddedDPoint3dArray_insertFPoint2d (pHeader, pPointArray + i, index + i))
            return false;
        }
    return true;
    }
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public GEOMDLLIMPEXP bool      jmdlEmbeddedDPoint3dArray_getFPoint2d
(
const   EmbeddedDPoint3dArray   *pHeader,
        FPoint2d                *pPoint,
        int                     index
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public GEOMDLLIMPEXP bool      jmdlEmbeddedDPoint3dArray_getFPoint2dArray
(
const   EmbeddedDPoint3dArray   *pHeader,
        FPoint2d                *pBuffer,
        int                     *pCount,
    ...
    for (i = 0; i < nreq; i++)
        {
        if (!jmdlEmbeddedDPoint3dArray_getFPoint2d (pHeader, pBuffer + i, i0 + i))
            break;
        *pCount += 1;
        }
    return *pCount > 0;
...
* @bsimethod                                    EarlinLutz      01/02
+---------------+---------------+---------------+---------------+---------------+------*/
Public GEOMDLLIMPEXP bool      jmdlEmbeddedDPoint3dArray_setFPoint2d
(
EmbeddedDPoint3dArray   *pHeader,
FPoint2d                *pInPoint,
int                     index
