...
/*----------------------------------------------------------------------+
|                                                                       |
| name      omdlPtrCache_new                                            |
|                                                                       |
| Allocate and return a pointer to a new cache of pointers to some      |
| data structure.                                                       |
+----------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------+
|                                                                       |
| name      omdlPtrCache_setDebug                                       |
|                                                                       |
| Set a debug level for a pointer cache.  0 is no debug,                |
| nonzero enables console output of grab, drop, free.                   |
+----------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------+
|                                                                       |
| name      omdlPtrCache_free                                           |
|                                                                       |
| Free a cache.  All instances in the cache are passed to the           |
| free function indicated in the cache definition.                      |
| (Note that all cached pointers were passed to the drop function       |
| when dropped into the cache.)                                         |
+----------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------+
|                                                                       |
| name      omdlPtrCache_grabFromCache                                  |
|                                                                       |
| Grab an instance of the data structure.   If a cached instance        |
| is available, use it; otherwise use pNewFunc to get a fresh one.      |
| In either case, invoke the grab function.                             |
+----------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------+
|                                                                       |
| name      omdlPtrCache_dropToCache                                    |
|                                                                       |
| Pass pInstance to the cache's drop function, then either insert the   |
| pointer to the cache or free it.                                      |
+----------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------+
|                                                                       |
| name      omdlPtrCache_flushCache                                     |
|                                                                       |
| author    ChuckKirschman                                  04/99       |
|                                                                       |
