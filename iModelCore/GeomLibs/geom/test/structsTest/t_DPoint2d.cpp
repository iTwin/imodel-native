...
// @bsimethod
//---------------------------------------------------------------------------------------
TEST(DPoint2d, Center3Points)
    {
    auto point00 = DPoint2d::From (0,0);
    auto point20 = DPoint2d::From(2, 0);
    auto point02 = DPoint2d::From(0, 2);
    DPoint2d center;
    Check::True(DPoint2dOps::CircleCenterThrough3Points (point00, point20, point02, center));
    Check::Near (center, 1, 1);

    auto pointA = DPoint2d::From (2,5);
    auto pointB = DPoint2d::From (7,3);
    auto pointC = DPoint2d::From (-3,-9);
    Check::True(DPoint2dOps::CircleCenterThrough3Points(pointA, pointB, pointC, center));
    double r = pointA.Distance(center);
    Check::Near (r, pointB.Distance(center));
    Check::Near(r, pointC.Distance(center));

    Check::False (DPoint2dOps::CircleCenterThrough3Points(point00, point20, point00, center));
    Check::False(DPoint2dOps::CircleCenterThrough3Points(point00, point02, point02, center));
    Check::False(DPoint2dOps::CircleCenterThrough3Points(point00, point20, point00, center));
    }
