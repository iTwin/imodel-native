...
folly::Future<WebEntitlementResult> EntitlementProvider::FetchWebEntitlementV4(const std::vector<int>& productIds, BeVersionCR version, Utf8StringCR deviceId, Utf8StringCR projectId, Utf8StringCR accessToken)
	{
