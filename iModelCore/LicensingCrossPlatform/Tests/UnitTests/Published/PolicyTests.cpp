/*--------------------------------------------------------------------------------------+
|
|     $Source: LicensingCrossPlatform/Tests/UnitTests/Published/PolicyTests.cpp $
|
...
TEST_F(PolicyTests, Create_Policy)
	...
	auto policy = Policy::Create(policyToken);
...
TEST_F(PolicyTests, Validate_ProperRead)
	...
	ASSERT_TRUE(userData->GetUltimateSAPId().Equals("1001464881"));
