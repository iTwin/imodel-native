/*--------------------------------------------------------------------------------------+
|
|     $Source: PublicAPI/Licensing/Connect/IImsClient.h $
|
...
typedef AsyncResult<SamlTokenPtr, Http::HttpError> SamlTokenResult;
...
struct IImsClient
    ...
    public:
        ...
        virtual AsyncTaskPtr<SamlTokenResult> RequestToken(Http::CredentialsCR creds, Utf8String rpUri = nullptr, uint64_t lifetime = 0) = 0;
