...
struct BuddiError : public AsyncError
    ...
    public:
        ...
        LICENSING_EXPORT BuddiError();
        LICENSING_EXPORT BuddiError(Status status);
        LICENSING_EXPORT BuddiError(Http::ResponseCR httpResponse);

        LICENSING_EXPORT Status GetStatus() const;
    };
