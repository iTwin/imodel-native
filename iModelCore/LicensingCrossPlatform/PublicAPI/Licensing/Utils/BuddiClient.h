...
struct EXPORT_VTABLE_ATTRIBUTE BuddiClient : public IBuddiClient
    ...
    public:
        ...
        LICENSING_EXPORT AsyncTaskPtr<BuddiRegionsResult> GetRegions() override;
        ...
        LICENSING_EXPORT AsyncTaskPtr<BuddiUrlResult> GetUrl(Utf8StringCR urlName, uint32_t regionId = 0) override;
    };
