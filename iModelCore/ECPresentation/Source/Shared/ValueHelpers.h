...
public:
    ...
    static rapidjson::Document GetJsonFromPrimitiveValue(ECN::PrimitiveType, BeSQLite::EC::IECSqlValue const&, rapidjson::MemoryPoolAllocator<>*, Utf8StringCR);
    ...
    static rapidjson::Document GetJsonFromArrayValue(BeSQLite::EC::IECSqlValue const&, rapidjson::MemoryPoolAllocator<>*, Utf8StringCR);
    static rapidjson::Document GetJsonFromString(ECN::PrimitiveType, Utf8StringCR, rapidjson::MemoryPoolAllocator<>*, Utf8StringCR);
    ECPRESENTATION_EXPORT static rapidjson::Document GetJsonFromECValue(ECN::ECValueCR, rapidjson::MemoryPoolAllocator<>*);

    static ECN::ECValue GetECValueFromSqlValue(ECN::PrimitiveType, BeSQLite::DbValue const&, Utf8StringCR);
    static ECN::ECValue GetECValueFromSqlValue(ECN::PrimitiveType, BeSQLite::EC::IECSqlValue const&, Utf8StringCR);
