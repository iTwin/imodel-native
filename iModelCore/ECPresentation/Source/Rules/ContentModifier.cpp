...
bool ContentModifiersList::ReadJson(BeJsConst json)
    ...
    if (json.isMember(CONTENTMODIFIER_JSON_ATTRIBUTE_PROPERTYDISPLAYSPECIFICATIONS))
        {
        if (CommonToolsInternal::ValidateJsonValueType(CONTENTMODIFIER_RULE_JSON_TYPE, CONTENTMODIFIER_JSON_ATTRIBUTE_PROPERTYDISPLAYSPECIFICATIONS, json[CONTENTMODIFIER_JSON_ATTRIBUTE_PROPERTYDISPLAYSPECIFICATIONS]))
