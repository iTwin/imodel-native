...
ContentDescriptor::ContentDescriptor(IConnectionCR connection, PresentationRuleSetCR ruleset, RulesetVariables rulesetVariables, INavNodeKeysContainerCR inputKeys)
    ...
    m_sortingFieldIndex(-1), m_sortDirection(SortDirection::Ascending), m_differentFromInputRuleset(false)
    {
    }
...
ContentDescriptor::ContentDescriptor(ContentDescriptorCR other)
    ...
    m_ruleset(other.m_ruleset), m_rulesetVariables(other.m_rulesetVariables), m_differentFromInputRuleset(other.m_differentFromInputRuleset)
    {
