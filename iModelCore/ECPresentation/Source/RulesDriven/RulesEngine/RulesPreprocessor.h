...
private:
    ...
    static void AddSpecificationsByHierarchy(PresentationRuleSetCR, Utf8CP specificationHash, bool requested, RuleTargetTree, ExpressionContextR, ECExpressionsCache&, ChildNodeRuleSpecificationsList& specs, bool& handled, bool& stopProcessing, OptimizedExpressionsParameters const*);
    template<typename RuleType> static bool AddSpecificationsByHierarchy(bvector<RuleType*> const& rules, Utf8CP specificationHash, bool requested, RuleTargetTree, ExpressionContextR, ECExpressionsCache&, unsigned depth, bvector<NavigationRuleSpecification<RuleType>>& specs, bool& handled, bool& stopProcessing, OptimizedExpressionsParameters const*);
    template<typename RuleType> static bool AddMatchingSpecifications(bvector<RuleType*> const& rules, RuleTargetTree, ExpressionContextR, ECExpressionsCache&, bvector<NavigationRuleSpecification<RuleType>>& specs, bool& handled, OptimizedExpressionsParameters const*);
    template<typename RuleType> static void ProcessSubConditions(RuleType const& rule, SubConditionList const&, ExpressionContextR, ECExpressionsCache&, bvector<NavigationRuleSpecification<RuleType>>& specs, OptimizedExpressionsParameters const*);
