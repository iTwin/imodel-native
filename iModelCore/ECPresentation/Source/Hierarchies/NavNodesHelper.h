...
public:
    ...
    ECPRESENTATION_EXPORT NavNodePtr CreateECClassGroupingNode(IConnectionCR, Utf8StringCR, NavNodeKeyCP, ECClassCR, bool, LabelDefinitionCR label, uint64_t) const;
    ECPRESENTATION_EXPORT NavNodePtr CreateECRelationshipGroupingNode(IConnectionCR, Utf8StringCR, NavNodeKeyCP, ECRelationshipClassCR, LabelDefinitionCR label, uint64_t) const;
    ECPRESENTATION_EXPORT NavNodePtr CreateECPropertyGroupingNode(IConnectionCR, Utf8StringCR, NavNodeKeyCP, ECClassCR, ECPropertyCR, LabelDefinitionCR label, Utf8CP imageId, RapidJsonValueCR groupingValue, bool isRangeGrouping, uint64_t) const;
    ECPRESENTATION_EXPORT NavNodePtr CreateDisplayLabelGroupingNode(IConnectionCR, Utf8StringCR, NavNodeKeyCP, LabelDefinitionCR label, uint64_t, std::unique_ptr<bvector<ECInstanceKey>> = nullptr) const;
    ECPRESENTATION_EXPORT NavNodePtr CreateCustomNode(IConnectionCR, Utf8StringCR, NavNodeKeyCP, LabelDefinitionCR label, Utf8CP description, Utf8CP imageId, Utf8CP type) const;
