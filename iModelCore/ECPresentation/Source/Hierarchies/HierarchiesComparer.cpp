...
HierarchiesComparer::CompareResult HierarchiesComparer::CompareDataSources(CompareWithConnectionParams const& params, NavNodesProviderCR lhsProvider, NavNodesProviderR rhsProvider) const
    ...
    DIAGNOSTICS_DEV_LOG(DiagnosticsCategory::HierarchiesUpdate, LOG_TRACE, Utf8PrintfString("Sizes LHS: %" PRIu64 ", RHS: %" PRIu64, (uint64_t)lhsProvider.GetNodesCount(), (uint64_t)rhsProvider.GetNodesCount()));
