...
#define LOGGER_NAMESPACE_ECPRESENTATION_UPDATE_HIERARCHIES  LOGGER_NAMESPACE_ECPRESENTATION_UPDATE ".Hierarchies"
#define LOGGER_NAMESPACE_ECPRESENTATION_UPDATE_CONTENT      LOGGER_NAMESPACE_ECPRESENTATION_UPDATE ".Content"
