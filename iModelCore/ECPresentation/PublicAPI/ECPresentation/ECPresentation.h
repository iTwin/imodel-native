...
#define LOGGER_NAMESPACE_ECPRESENTATION_HIEARCHIES          LOGGER_NAMESPACE_ECPRESENTATION ".Navigation"
#define LOGGER_NAMESPACE_ECPRESENTATION_HIEARCHIES_CACHE    LOGGER_NAMESPACE_ECPRESENTATION_HIEARCHIES ".Cache"
#define LOGGER_NAMESPACE_ECPRESENTATION_HIEARCHIES_UPDATE   LOGGER_NAMESPACE_ECPRESENTATION_HIEARCHIES ".Update"
#define LOGGER_NAMESPACE_ECPRESENTATION_CONTENT             LOGGER_NAMESPACE_ECPRESENTATION ".Content"
#define LOGGER_NAMESPACE_ECPRESENTATION_CONTENT_UPDATE      LOGGER_NAMESPACE_ECPRESENTATION_CONTENT ".Update"
