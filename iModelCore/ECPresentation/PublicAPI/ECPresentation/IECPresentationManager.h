...
//===================================================================================
struct PresentationTaskNotificationsContext
{
private:
    std::function<void()> m_callbackOnTaskStart;
public:
    PresentationTaskNotificationsContext(std::function<void()> onTaskStart = nullptr)
        : m_callbackOnTaskStart(onTaskStart)
        {}
    void OnTaskStart() const { if (m_callbackOnTaskStart) { m_callbackOnTaskStart(); } }
};
DEFINE_POINTER_SUFFIX_TYPEDEFS(PresentationTaskNotificationsContext)
 ...
 *  @{ */
    ...
    virtual folly::Future<size_t> _GetRootNodesCount(IConnectionCR, JsonValueCR, PresentationTaskNotificationsContextCR) = 0;

    //! @see GetChildren
    virtual folly::Future<NavNodesContainer> _GetChildren(IConnectionCR, NavNodeCR, PageOptionsCR, JsonValueCR, PresentationTaskNotificationsContextCR) = 0;
    ...
    //! @see GetParent
    virtual folly::Future<NavNodeCPtr> _GetParent(IConnectionCR, NavNodeCR, JsonValueCR, PresentationTaskNotificationsContextCR) = 0;

    //! Retrieves a node by node key.
    //! @see GetNode
    virtual folly::Future<NavNodeCPtr> _GetNode(IConnectionCR, NavNodeKeyCR, JsonValueCR, PresentationTaskNotificationsContextCR) = 0;

    //! Retrieves filtered Node paths.
    //! @see GetFilteredNodes
    virtual folly::Future<bvector<NavNodeCPtr>> _GetFilteredNodes(IConnectionCR, Utf8CP, JsonValueCR, PresentationTaskNotificationsContextCR) = 0;

    //! @see NotifyNodeChecked
    virtual folly::Future<folly::Unit> _OnNodeChecked(IConnectionCR, NavNodeKeyCR, JsonValueCR, PresentationTaskNotificationsContextCR) = 0;
    //! @see NotifyNodeUnchecked
    virtual folly::Future<folly::Unit> _OnNodeUnchecked(IConnectionCR, NavNodeKeyCR, JsonValueCR, PresentationTaskNotificationsContextCR) = 0;

    //! @see NotifyNodeExpanded
    virtual folly::Future<folly::Unit> _OnNodeExpanded(IConnectionCR, NavNodeKeyCR, JsonValueCR, PresentationTaskNotificationsContextCR) = 0;
    //! @see NotifyNodeCollapsed
    virtual folly::Future<folly::Unit> _OnNodeCollapsed(IConnectionCR, NavNodeKeyCR, JsonValueCR, PresentationTaskNotificationsContextCR) = 0;
 ...
 *  @{ */
    ...
    //! @see SaveValueChange
    virtual folly::Future<bvector<ECInstanceChangeResult>> _SaveValueChange(IConnectionCR, bvector<ChangedECInstanceInfo> const&, Utf8CP, ECValueCR, JsonValueCR, PresentationTaskNotificationsContextCR) = 0;
/** @} */
 ...
 *  @{ */
    ...
    ECPRESENTATION_EXPORT folly::Future<NavNodesContainer> GetRootNodes(ECDbCR db, PageOptionsCR pageOptions, JsonValueCR extendedOptions = Json::Value(), PresentationTaskNotificationsContextCR = PresentationTaskNotificationsContext());
    ...
    //! @param[in] extendedOptions Additional options which depend on the implementation of @ref IECPresentationManager.
    ECPRESENTATION_EXPORT folly::Future<size_t> GetRootNodesCount(ECDbCR db, JsonValueCR extendedOptions = Json::Value(), PresentationTaskNotificationsContextCR = PresentationTaskNotificationsContext());
    ...
    //! @param[in] pageOptions Info about the requested page of data.
    //! @param[in] extendedOptions Additional options which depend on the implementation of @ref IECPresentationManager.
    ECPRESENTATION_EXPORT folly::Future<NavNodesContainer> GetChildren(ECDbCR db, NavNodeCR parentNode, PageOptionsCR pageOptions, JsonValueCR extendedOptions = Json::Value(), PresentationTaskNotificationsContextCR = PresentationTaskNotificationsContext());
    ...
    //! @param[in] extendedOptions Additional options which depend on the implementation of @ref IECPresentationManager.
    ECPRESENTATION_EXPORT folly::Future<NavNodeCPtr> GetParent(ECDbCR db, NavNodeCR childNode, JsonValueCR extendedOptions = Json::Value(), PresentationTaskNotificationsContextCR = PresentationTaskNotificationsContext());
    ...
    //! @param[in] extendedOptions Additional options which depend on the implementation of @ref IECPresentationManager.
    ECPRESENTATION_EXPORT folly::Future<NodesPathElement> GetNodesPath(ECDbCR db, bvector<ECInstanceKey> const& keyPath, JsonValueCR extendedOptions = Json::Value(), PresentationTaskNotificationsContextCR = PresentationTaskNotificationsContext());
    ...
    ECPRESENTATION_EXPORT folly::Future<folly::Unit> NotifyNodeUnchecked(ECDbCR, NavNodeKeyCR nodeKey, JsonValueCR extendedOptions = Json::Value(), PresentationTaskNotificationsContextCR = PresentationTaskNotificationsContext());

    //! Mark node with the specified node key as expanded.
    ECPRESENTATION_EXPORT folly::Future<folly::Unit> NotifyNodeExpanded(ECDbCR, NavNodeKeyCR nodeKey, JsonValueCR extendedOptions = Json::Value(), PresentationTaskNotificationsContextCR = PresentationTaskNotificationsContext());
    //! Mark node with the specified node key as collapsed.
    ECPRESENTATION_EXPORT folly::Future<folly::Unit> NotifyNodeCollapsed(ECDbCR, NavNodeKeyCR nodeKey, JsonValueCR extendedOptions = Json::Value(), PresentationTaskNotificationsContextCR = PresentationTaskNotificationsContext());
 ...
 *  @{ */
    ...
    //! @param[in] pageOptions Info about the requested page of data.
    ECPRESENTATION_EXPORT folly::Future<ContentCPtr> GetContent(ContentDescriptorCR descriptor, PageOptionsCR pageOptions, PresentationTaskNotificationsContextCR = PresentationTaskNotificationsContext());
 ...
 *  @{ */
    ...
    //! @param[in] extendedOptions Additional options which depend on the implementation of @ref IECPresentationManager.
    ECPRESENTATION_EXPORT folly::Future<ECInstanceChangeResult> SaveValueChange(ECDbCR db, ChangedECInstanceInfo const& instanceInfo, Utf8CP propertyAccessor, ECValueCR value, JsonValueCR extendedOptions = Json::Value(), PresentationTaskNotificationsContextCR = PresentationTaskNotificationsContext());
    ...
    //! @param[in] value The value to change to.
    //! @param[in] extendedOptions Additional options which depend on the implementation of @ref IECPresentationManager.
    ECPRESENTATION_EXPORT folly::Future<ECInstanceChangeResult> SaveValueChange(ECDbCR db, ChangedECInstanceInfo const& instanceInfo, Utf8CP propertyAccessor, JsonValueCR value, JsonValueCR extendedOptions = Json::Value(), PresentationTaskNotificationsContextCR = PresentationTaskNotificationsContext());
    ...
    //! @param[in] value The value to change to.
    //! @param[in] extendedOptions Additional options which depend on the implementation of @ref IECPresentationManager.
    ECPRESENTATION_EXPORT folly::Future<bvector<ECInstanceChangeResult>> SaveValueChange(ECDbCR db, bvector<ChangedECInstanceInfo> const& instanceInfos, Utf8CP propertyAccessor, JsonValueCR value, JsonValueCR extendedOptions = Json::Value(), PresentationTaskNotificationsContextCR = PresentationTaskNotificationsContext());
/** @} */
};
