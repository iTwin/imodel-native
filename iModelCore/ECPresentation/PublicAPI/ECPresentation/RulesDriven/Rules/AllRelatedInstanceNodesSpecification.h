 /*--------------------------------------------------------------------------------------+
|
|     $Source: PublicAPI/ECPresentation/RulesDriven/Rules/AllRelatedInstanceNodesSpecification.h $
|
...
struct EXPORT_VTABLE_ATTRIBUTE AllRelatedInstanceNodesSpecification : public ChildNodeSpecification
    ...
    protected:
        ...
        virtual ChildNodeSpecification* _Clone() const override {return new AllRelatedInstanceNodesSpecification(*this);}
