...
* @bsiclass
+---------------+---------------+---------------+---------------+---------------+------*/
struct GroupingRule : ConditionalCustomizationRule
{
...
* @bsiclass
+---------------+---------------+---------------+---------------+---------------+------*/
struct GroupSpecification : PresentationKey
{
...
* @bsiclass
+---------------+---------------+---------------+---------------+---------------+------*/
struct EXPORT_VTABLE_ATTRIBUTE SameLabelInstanceGroup : GroupSpecification
{
    DEFINE_T_SUPER(GroupSpecification)
...
* @bsiclass
+---------------+---------------+---------------+---------------+---------------+------*/
struct EXPORT_VTABLE_ATTRIBUTE ClassGroup : GroupSpecification
{
    DEFINE_T_SUPER(GroupSpecification)
...
* @bsiclass
+---------------+---------------+---------------+---------------+---------------+------*/
struct EXPORT_VTABLE_ATTRIBUTE PropertyGroup : GroupSpecification
{
    DEFINE_T_SUPER(GroupSpecification)
...
* @bsiclass
+---------------+---------------+---------------+---------------+---------------+------*/
struct PropertyRangeGroupSpecification : PresentationKey
{
    DEFINE_T_SUPER(PresentationKey)
