/*--------------------------------------------------------------------------------------+
|
|  $Source: Tests/Published/RulesEngine/Content_LocatingClasses.cpp $
|
...
//=======================================================================================
struct LocatingClasses : RulesDrivenECPresentationManagerTests
    {
    void SetUp() override
        {
...
TEST_F(LocatingClasses, ReturnsEmptyListWhenRulesetIsEmpty)
    ...
    bvector<SelectClassInfo> result = IECPresentationManager::GetManager().GetContentClasses(s_project->GetECDb(), nullptr, lookup, options.GetJson());
...
TEST_F(LocatingClasses, ReturnsLookupListWhenRulesetHasSelectedNodeInstancesRule)
    ...
    rules->GetContentRules().back()->GetSpecificationsR().push_back(new SelectedNodeInstancesSpecification());
...
TEST_F(LocatingClasses, ReturnsFilteredLookupListWhenRulesetHasSelectedNodeInstancesRuleWithAcceptableClasses)
    ...
    m_locater->AddRuleSet(*rules);
    rules->AddPresentationRule(*new ContentRule());
    rules->GetContentRules().back()->GetSpecificationsR().push_back(new SelectedNodeInstancesSpecification(1, false, 
        "", "A,C", true));
...
TEST_F(LocatingClasses, ReturnsLookupListWhenRulesetHasInstanceNodesOfSpecificClassesRule)
    ...
    m_locater->AddRuleSet(*rules);
    rules->AddPresentationRule(*new ContentRule());
    rules->GetContentRules().back()->GetSpecificationsR().push_back(new ContentInstancesOfSpecificClassesSpecification(1, "",
...
TEST_F(LocatingClasses, ReturnsEmptyListWhenRulesetHasContentRelatedInstancesRule)
    ...
    m_locater->AddRuleSet(*rules);
    rules->AddPresentationRule(*new ContentRule());
    rules->GetContentRules().back()->GetSpecificationsR().push_back(new ContentRelatedInstancesSpecification(1, false, false,
