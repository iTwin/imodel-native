...
struct ContentCacheTests : ECPresentationTest
    ...
    bvector<SpecificationContentProviderP> CacheProviderVariations(ContentProviderKey& key, int count)
        ...
        for (int i = 0; i < count; ++i)
            ...
            BeThreadUtilities::BeSleep(5); // sleep for 5 milliseconds to have different last used times
            }
        return providers;
        }
    ...
    bvector<bpair<ContentProviderKey, SpecificationContentProviderP>> CacheProviders(int count)
        ...
        for (int i = 0; i < count; ++i)
            ...
            ContentProviderKey key("connection id", rulesetId, "display type", 0, "a", ECPresentation::UnitSystem::Undefined, *NavNodeKeyListContainer::Create(), nullptr);
...
TEST_F(ContentCacheTests, CachesMultipleProvidersWithDifferentKeys)
    {
    ContentProviderKey key1("connection id 1", "ruleset id 1", "display type 1", 0, "locale 1", ECPresentation::UnitSystem::Metric, *NavNodeKeyListContainer::Create(), nullptr);
    ContentProviderKey key2("connection id 2", "ruleset id 2", "display type 2", 1, "locale 2", ECPresentation::UnitSystem::BritishImperial, *NavNodeKeyListContainer::Create(), nullptr);
...
TEST_F(ContentCacheTests, CachesMultipleProvidersWhenLocalesAreDifferent)
    {
    ContentProviderKey key1("connection id", "ruleset id", "display type", 0, "a", ECPresentation::UnitSystem::Undefined, *NavNodeKeyListContainer::Create(), nullptr);
    ContentProviderKey key2("connection id", "ruleset id", "display type", 0, "b", ECPresentation::UnitSystem::Undefined, *NavNodeKeyListContainer::Create(), nullptr);
    SpecificationContentProviderP provider1 = CacheProvider(key1);
    SpecificationContentProviderP provider2 = CacheProvider(key2);
    EXPECT_EQ(provider1, m_cache.GetProvider(key1, RulesetVariables(provider1->GetContext().GetRelatedRulesetVariables())).get());
...
TEST_F(ContentCacheTests, ClearsAllCache)
    ...
    m_cache.CacheProvider(ContentProviderKey(connection->GetId(), "ruleset id 1", "display type 1", 0, "locale 1", ECPresentation::UnitSystem::UsCustomary, *NavNodeKeyListContainer::Create(), nullptr), *CreateProvider());
    m_cache.CacheProvider(ContentProviderKey(connection->GetId(), "ruleset id 2", "display type 2", 0, "locale 2", ECPresentation::UnitSystem::UsSurvey, *NavNodeKeyListContainer::Create(), nullptr), *CreateProvider());
...
TEST_F(ContentCacheTests, ClearsCacheByConnection)
    ...
    m_cache.CacheProvider(ContentProviderKey(connection1->GetId(), "ruleset id", "display type", 0, "locale", ECPresentation::UnitSystem::Undefined, *NavNodeKeyListContainer::Create(), nullptr), *CreateProvider());

    ECDb db2;
    IConnectionPtr connection2 = new TestConnection(db2);
    m_cache.CacheProvider(ContentProviderKey(connection2->GetId(), "ruleset id", "display type", 0, "locale", ECPresentation::UnitSystem::Undefined, *NavNodeKeyListContainer::Create(), nullptr), *CreateProvider());
...
TEST_F(ContentCacheTests, ClearsCacheByRulesetId)
    {
    m_cache.CacheProvider(ContentProviderKey("connection id", "ruleset id 1", "display type", 0, "locale", ECPresentation::UnitSystem::Undefined, *NavNodeKeyListContainer::Create(), nullptr), *CreateProvider());
    m_cache.CacheProvider(ContentProviderKey("connection id", "ruleset id 2", "display type", 0, "locale", ECPresentation::UnitSystem::Undefined, *NavNodeKeyListContainer::Create(), nullptr), *CreateProvider());
...
TEST_F(ContentCacheTests, CachesProvidersDifferingJustBySelectionInfo)
    ...
    ContentProviderKey keyNoSelectionInfo1("connection id", "ruleset id", "display type", 0, "locale", ECPresentation::UnitSystem::Undefined, *NavNodeKeyListContainer::Create(), nullptr);
    ...
    ContentProviderKey keyWithSelectionInfo("connection id", "ruleset id", "display type", 0, "locale", ECPresentation::UnitSystem::Undefined, *NavNodeKeyListContainer::Create(), selectionInfo1.get());
    ...
    ContentProviderKey keyWithSelectionInfoWithDifferentName("connection id", "ruleset id", "display type", 0, "locale", ECPresentation::UnitSystem::Undefined, *NavNodeKeyListContainer::Create(), selectionInfo2.get());
    ...
    ContentProviderKey keyWithSelectionInfoWithDifferentLevel("connection id", "ruleset id", "display type", 0, "locale", ECPresentation::UnitSystem::Undefined, *NavNodeKeyListContainer::Create(), selectionInfo3.get());
    ...
    ContentProviderKey keyWithSelectionInfoWithDifferentTimestamp("connection id", "ruleset id", "display type", 0, "locale", ECPresentation::UnitSystem::Undefined, *NavNodeKeyListContainer::Create(), selectionInfo4.get());
    ...
    ContentProviderKey keyNoSelectionInfo2("connection id", "ruleset id", "display type", 0, "locale", ECPresentation::UnitSystem::Undefined, *keys, nullptr);
...
/*---------------------------------------------------------------------------------**//**
* @bsitest                                      Saulius.Skliutas                05/2020
+---------------+---------------+---------------+---------------+---------------+------*/
TEST_F(ContentCacheTests, LimitsProviderVariationsCount)
    {
    ContentProviderKey key("connection id", "ruleset id", "display type", 0, "locale", ECPresentation::UnitSystem::Undefined, *NavNodeKeyListContainer::Create(), nullptr);
...
TEST_F(ContentCacheTests, RemovesOldestProviderWhenLimitIsExceeded)
    ...
    ContentProviderKey key("connection id", "different ruleset", "display type", 0, "locale", ECPresentation::UnitSystem::Undefined, *NavNodeKeyListContainer::Create(), nullptr);
