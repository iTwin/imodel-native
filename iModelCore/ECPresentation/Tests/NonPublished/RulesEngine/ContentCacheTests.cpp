...
struct ContentCacheTests : ECPresentationTest
    ...
    SpecificationContentProviderPtr CreateProvider()
        ...
        ContentProviderContextPtr context = ContentProviderContext::Create(*ruleset, true, "", *NavNodeKeyListContainer::Create(),
...
TEST_F(ContentCacheTests, CachesMultipleProvidersWithDifferentKeys)
    {
    ContentProviderKey key1("connection id 1", "ruleset id 1", "display type 1", *NavNodeKeyListContainer::Create(), nullptr);
    ContentProviderKey key2("connection id 2", "ruleset id 2", "display type 2", *NavNodeKeyListContainer::Create(), nullptr);
...
TEST_F(ContentCacheTests, ClearsAllCache)
    ...
    m_cache.CacheProvider(ContentProviderKey(connection->GetId(), "ruleset id 1", "display type 1", *NavNodeKeyListContainer::Create(), nullptr), *CreateProvider());
    m_cache.CacheProvider(ContentProviderKey(connection->GetId(), "ruleset id 2", "display type 2", *NavNodeKeyListContainer::Create(), nullptr), *CreateProvider());
...
TEST_F(ContentCacheTests, ClearsCacheByConnection)
    ...
    m_cache.CacheProvider(ContentProviderKey(connection1->GetId(), "ruleset id", "display type", *NavNodeKeyListContainer::Create(), nullptr), *CreateProvider());

    ECDb db2;
    IConnectionPtr connection2 = new TestConnection(db2);
    m_cache.CacheProvider(ContentProviderKey(connection2->GetId(), "ruleset id", "display type", *NavNodeKeyListContainer::Create(), nullptr), *CreateProvider());
...
TEST_F(ContentCacheTests, ClearsCacheByRulesetId)
    {
    m_cache.CacheProvider(ContentProviderKey("connection id", "ruleset id 1", "display type", *NavNodeKeyListContainer::Create(), nullptr), *CreateProvider());
    m_cache.CacheProvider(ContentProviderKey("connection id", "ruleset id 2", "display type", *NavNodeKeyListContainer::Create(), nullptr), *CreateProvider());
...
TEST_F(ContentCacheTests, ReplacesProvidersDifferingJustBySelectionInfo)
    ...
    SpecificationContentProviderPtr provider1 = CreateProvider();
    ContentProviderKey keyNoSelectionInfo1("connection id", "ruleset id", "display type", *NavNodeKeyListContainer::Create(), nullptr);
    ...
    SpecificationContentProviderPtr provider2 = CreateProvider();
    SelectionInfo selectionInfo1("name1", true);
    ...
    SelectionInfo selectionInfo2("name2", true);
    ...
    SelectionInfo selectionInfo3("name2", false);
    ...
    ContentProviderKey keyNoSelectionInfo2("connection id", "ruleset id", "display type", *keys, nullptr);
    m_cache.CacheProvider(keyNoSelectionInfo2, *provider5);
    EXPECT_EQ(provider1, m_cache.GetProvider(keyNoSelectionInfo1));
    EXPECT_EQ(provider4, m_cache.GetProvider(keyWithSelectionInfoWithDifferentLevel));
    EXPECT_EQ(provider5, m_cache.GetProvider(keyNoSelectionInfo2));
    }