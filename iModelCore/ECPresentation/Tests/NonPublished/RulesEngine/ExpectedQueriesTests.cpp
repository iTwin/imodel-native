...
+---------------+---------------+---------------+---------------+---------------+------*/
ECSchemaCP ExpectedQueries::GetECSchema(Utf8CP schemaName) {return m_schemaHelper->GetSchema(schemaName);}
...
ContentDescriptorPtr ExpectedQueries::GetEmptyContentDescriptor(Utf8CP displayType = ContentDisplayType::Undefined) const
    ...
    ContentDescriptorPtr descriptor = ContentDescriptor::Create(*m_connection, options.GetJson(), *NavNodeKeyListContainer::Create(), displayType);
...
+---------------+---------------+---------------+---------------+---------------+------*/
static ContentDescriptor::Field& AddField(ContentDescriptorR descriptor, ContentDescriptor::Category category, ContentDescriptor::Property prop)
    {
...
* @bsimethod                                    Grigas.Petraitis                10/2016
+---------------+---------------+---------------+---------------+---------------+------*/
static ContentDescriptor::Field& AddField(ContentDescriptorR descriptor, ContentDescriptor::Field& field)
    {
...
void ExpectedQueries::RegisterExpectedQueries()
    ...
    // AllInstanceNodes_SupportedSchemas_NoSpaces
        ...
        NavigationQueryPtr query = RulesEngineTestHelpers::CreateECInstanceNodesQueryForClasses(expectedClasses, "this");
        query->AsUnionQuery()->OrderBy(ecInstanceNodesQuerySortedDisplayLabel.c_str());
    ...
    // AllInstanceNodes_SupportedSchemas_Excluded
        ...
        NavigationQueryPtr expected = RulesEngineTestHelpers::CreateECInstanceNodesQueryForClasses(classes, "this");
        expected->AsComplexQuery()->OrderBy(ecInstanceNodesQuerySortedDisplayLabel.c_str());
    ...
    // AllInstanceNodes_SupportedSchemas_UsedFromRulesetIfNotSpecified
        ...
        NavigationQueryPtr expected = RulesEngineTestHelpers::CreateECInstanceNodesQueryForClasses(expectedQueryClasses, "this");
        expected->AsUnionQuery()->OrderBy(ecInstanceNodesQuerySortedDisplayLabel.c_str());
    ...
    // AllInstanceNodes_GroupByClass_ChildrenQuery
        ...
        ComplexNavigationQueryPtr expected = RulesEngineTestHelpers::CreateMultiECInstanceNodesQuery(ret_Gadget,
            ComplexNavigationQuery::Create()->SelectContract(*contract, "this").From(b1_Class1A, false, "this"));
    ...
    // AllInstanceNodes_GroupByLabel_ChildrenQuery
        ...
        NavigationQueryPtr expected = RulesEngineTestHelpers::CreateECInstanceNodesQueryForClasses(expectedQueryClasses, "this", [](ComplexNavigationQuery& query)
            {
    ...
    // AllInstanceNodes_GroupByClassAndLabel_LabelNodeChildrenQuery
        ...
        ComplexNavigationQueryPtr expected = RulesEngineTestHelpers::CreateMultiECInstanceNodesQuery(b1_Class1A, *nested);
        expected->OrderBy(ecInstanceNodesQuerySortedDisplayLabel.c_str());
    ...
    // AllInstanceNodes_RecursiveNodeRelationships
        ...
        ComplexNavigationQueryPtr expected = RulesEngineTestHelpers::CreateMultiECInstanceNodesQuery(b3_Class3,
            ComplexNavigationQuery::Create()->SelectContract(*contract, "this").From(b3_Class3, true, "this"));
        expected->OrderBy(ecInstanceNodesQuerySortedDisplayLabel.c_str());
    ...
    // AllInstanceNodes_InstanceLabelOverride_AppliedByPriority
        ...
        NavigationQueryContractPtr contract = ECInstanceNodesQueryContract::Create(&class1, bvector<RelatedClassPath>(), {new InstanceLabelOverridePropertyValueSpecification("Description"), new InstanceLabelOverridePropertyValueSpecification("Code")});
    ...
    // AllInstanceNodes_InstanceLabelOverride_OverrideOnlySpecifiedClassInstancesLabels
        ...
        ECClassCR class1 = *GetECClass(queryName, "Class1");
        NavigationQueryContractPtr class1Contract = ECInstanceNodesQueryContract::Create(&class1, bvector<RelatedClassPath>(), {new InstanceLabelOverridePropertyValueSpecification("Description"), new InstanceLabelOverridePropertyValueSpecification("Code")});
    ...
    // AllRelatedInstanceNodes_NoGrouping_ForwardRelationDirection
        ...
        UnionNavigationQueryPtr expected = UnionNavigationQuery::Create({nestedQuery2, nestedQuery1, nestedQuery3, nestedQuery4});
        expected->OrderBy(ecInstanceNodesQuerySortedDisplayLabel.c_str());
    ...
    // AllRelatedInstanceNodes_NoGrouping_BothDirections
        ...
        UnionNavigationQueryPtr expected = UnionNavigationQuery::Create({nestedQuery1, nestedQuery2, nestedQuery3, nestedQuery4, nestedQuery5, nestedQuery6});
        expected->OrderBy(ecInstanceNodesQuerySortedDisplayLabel.c_str());
    ...
    // AllRelatedInstanceNodes_InstanceLabelOverride_AppliedByPriority
        {
        NavigationQueryContractPtr contract = ECInstanceNodesQueryContract::Create(&ret_Gadget, bvector<RelatedClassPath>(), {new InstanceLabelOverridePropertyValueSpecification("Description"), new InstanceLabelOverridePropertyValueSpecification("MyID")});
    ...
    // AllRelatedInstanceNodes_InstanceLabelOverride_OverrideOnlySpecifiedClassInstancesLabels
        ...
        ComplexNavigationQueryPtr nestedQuery5 = RulesEngineTestHelpers::CreateMultiECInstanceNodesQuery(ret_Sprocket,
            ComplexNavigationQuery::Create()->SelectContract(*ECInstanceNodesQueryContract::Create(&ret_Sprocket, bvector<RelatedClassPath>(), {new InstanceLabelOverridePropertyValueSpecification("MyID")}), "this")
            .From(ret_Sprocket, true, "this").Join(RelatedClass(ret_Sprocket, SelectClass(ret_Gadget, true), ret_GadgetHasSprocket, false, "related", "rel_RET_GadgetHasSprocket_0",  false))
            .Where("[related].[ECInstanceId] IN (?)", {new BoundQueryId(ECInstanceId((uint64_t)123))}));
    ...
    // RelatedInstanceNodes_SkipOneRelatedLevel_WidgetToSprocket
        ...
        relationshipPath11.push_back(RelatedClass(ret_Sprocket, SelectClass(ret_Gadget, true), ret_GadgetHasSprocket, false, TABLE_ALIAS("target", ret_Gadget, 0), "rel_RET_GadgetHasSprocket_0", false));
        ...
        relationshipPath12.push_back(RelatedClass(ret_Sprocket, SelectClass(ret_Gadget, true), ret_GadgetHasSprocket, false, TABLE_ALIAS("target", ret_Gadget, 1), "rel_RET_GadgetHasSprocket_0", false));
        ...
        relationshipPath13.push_back(RelatedClass(ret_Sprocket, SelectClass(ret_Gadget, true), ret_GadgetHasSprocket, false, TABLE_ALIAS("target", ret_Gadget, 2), "rel_RET_GadgetHasSprocket_0", false));
        ...
        relationshipPath14.push_back(RelatedClass(ret_Sprocket, SelectClass(ret_Gadget, true), ret_GadgetHasSprocket, false, TABLE_ALIAS("target", ret_Gadget, 3), "rel_RET_GadgetHasSprocket_0", false));
        ...
        relationshipPath21.push_back(RelatedClass(ret_Sprocket, SelectClass(ret_Gadget, true), ret_GadgetHasSprockets, false, TABLE_ALIAS("target", ret_Gadget, 0), "rel_RET_GadgetHasSprockets_0", false));
        ...
        relationshipPath22.push_back(RelatedClass(ret_Sprocket, SelectClass(ret_Gadget, true), ret_GadgetHasSprockets, false, TABLE_ALIAS("target", ret_Gadget, 1), "rel_RET_GadgetHasSprockets_0", false));
        ...
        relationshipPath23.push_back(RelatedClass(ret_Sprocket, SelectClass(ret_Gadget, true), ret_GadgetHasSprockets, false, TABLE_ALIAS("target", ret_Gadget, 2), "rel_RET_GadgetHasSprockets_0", false));
        ...
        relationshipPath24.push_back(RelatedClass(ret_Sprocket, SelectClass(ret_Gadget, true), ret_GadgetHasSprockets, false, TABLE_ALIAS("target", ret_Gadget, 3), "rel_RET_GadgetHasSprockets_0", false));
    ...
    // RelatedInstanceNodes_SkipRelatedLevel_GroupsByECInstanceKey
        ...
        relationshipPath1.push_back(RelatedClass(ret_Sprocket, SelectClass(ret_Gadget, true), ret_GadgetHasSprockets, false, TABLE_ALIAS("target", ret_Gadget, 0), "rel_RET_GadgetHasSprockets_0", false));
    ...
    // AllRelatedInstanceNodes_GroupByClass
        ...
        ComplexNavigationQueryPtr nested = ComplexNavigationQuery::Create();
        nested->SelectAll();
        nested->From(*UnionNavigationQuery::Create({nestedQuery1, nestedQuery2, nestedQuery3, nestedQuery4, nestedQuery5, nestedQuery6}));
        nested->GroupByContract(*contract);
    ...
    // AllRelatedInstanceNodes_GroupByClass_ChildrenQuery
        ...
        UnionNavigationQueryPtr expected = UnionNavigationQuery::Create({nestedQuery1, nestedQuery2, nestedQuery3, nestedQuery4});
        expected->OrderBy(ecInstanceNodesQuerySortedDisplayLabel.c_str());
    ...
    // AllRelatedInstanceNodes_GroupByLabel
        ...
        ComplexNavigationQueryPtr expected = ComplexNavigationQuery::Create();
        expected->SelectAll();
        expected->From(*UnionNavigationQuery::Create({nestedQuery1, nestedQuery2, nestedQuery3, nestedQuery4, nestedQuery5, nestedQuery6}));
        expected->GroupByContract(*DisplayLabelGroupingNodesQueryContract::Create(nullptr));
        expected->OrderBy(ecInstanceNodesQuerySortedDisplayLabel.c_str());
        expected->GetResultParametersR().GetNavNodeExtendedDataR().SetGroupingType((int)GroupingType::DisplayLabel);
        expected->GetResultParametersR().GetNavNodeExtendedDataR().SetHideIfOnlyOneChild(true);
    ...
    // AllRelatedInstanceNodes_GroupByClassAndLabel_ClassNodeChildrenQuery
        ...
        ComplexNavigationQueryPtr expected = ComplexNavigationQuery::Create();
        expected->SelectAll();
        expected->From(*UnionNavigationQuery::Create({nestedQuery1, nestedQuery2, nestedQuery3, nestedQuery4}));
        expected->GroupByContract(*contract);
        expected->OrderBy(ecInstanceNodesQuerySortedDisplayLabel.c_str());
        expected->GetResultParametersR().GetNavNodeExtendedDataR().SetGroupingType((int)GroupingType::DisplayLabel);
        expected->GetResultParametersR().GetNavNodeExtendedDataR().SetHideIfOnlyOneChild(true);
    ...
    // RelatedInstanceNodes_RelatedClasses_MultipleExcludedClasses
        ...
        includeQuery->Where("[this].[ECClassId] NOT IN (?,?,?)", {new BoundQueryId(ret_ClassF.GetId()), new BoundQueryId(ret_ClassG.GetId()), new BoundQueryId(ret_ClassH.GetId())});
    ...
    // RelatedInstanceNodes_ExcludedWithDifferentSorting
        ...
        ComplexNavigationQueryPtr labelOrderedEInclude = RulesEngineTestHelpers::CreateMultiECInstanceNodesQuery(ret_ClassE,
            ...
            .Where("[related].[ECInstanceId] IN (?)", {new BoundQueryId(ECInstanceId((uint64_t)123))})
            .Where("[this].[ECClassId] NOT IN (?,?,?,?)", {new BoundQueryId(ret_ClassE.GetId()), new BoundQueryId(ret_ClassF.GetId()), new BoundQueryId(ret_ClassG.GetId()), new BoundQueryId(ret_ClassH.GetId())}));
        ...
        UnionNavigationQueryPtr expected = UnionNavigationQuery::Create({orderedEInclude, wrappedLabelOrderedEInclude, unorderedGInclude});
        expected->GetResultParametersR().GetNavNodeExtendedDataR().SetRelationshipDirection(ECRelatedInstanceDirection::Forward);
        expected->GetResultParametersR().GetMatchingRelationshipIds().insert(ret_ClassDHasClassE.GetId());
    ...
    // RelatedInstanceNodes_InstanceFilter_AllowsAccessingParentNode
        ...
        ComplexNavigationQueryPtr expected = RulesEngineTestHelpers::CreateMultiECInstanceNodesQuery(ret_Gadget, *nested);
        expected->OrderBy(ecInstanceNodesQuerySortedDisplayLabel.c_str());
    ...
    // RelatedInstanceNodes_InstanceLabelOverride_AppliedByPriority
        {
        ComplexNavigationQueryPtr query = ComplexNavigationQuery::Create();
        query->SelectContract(*ECInstanceNodesQueryContract::Create(&ret_Widget, bvector<RelatedClassPath>(), {new InstanceLabelOverridePropertyValueSpecification("Description"), new InstanceLabelOverridePropertyValueSpecification("MyID")}), "this");
    ...
    // RelatedInstanceNodes_InstanceLabelOverride_OverrideOnlySpecifiedClassInstancesLabels
        {
        ComplexNavigationQueryPtr nestedQuery1 = RulesEngineTestHelpers::CreateMultiECInstanceNodesQuery(ret_Widget,
            ComplexNavigationQuery::Create()->SelectContract(*ECInstanceNodesQueryContract::Create(&ret_Widget, bvector<RelatedClassPath>(), {new InstanceLabelOverridePropertyValueSpecification("MyID")}), "this")
            .From(ret_Widget, true, "this").Join(RelatedClass(ret_Widget, SelectClass(ret_Gadget, true), ret_WidgetHasGadget, true, "related", "rel_RET_WidgetHasGadget_0", false))
            .Where("[related].[ECInstanceId] IN (?)", {new BoundQueryId(ECInstanceId((uint64_t)123))}));
    ...
    // RelatedInstanceNodes_CreatesQueryForAllNodeECInstancesChildren
        {
        Utf8CP queryName = "RelatedInstanceNodes_CreatesQueryForAllNodeECInstancesChildren";
        ...
        ECRelationshipClassCP rel1 = GetECClass(queryName, "AToC")->GetRelationshipClassCP();
        ECRelationshipClassCP rel2 = GetECClass(queryName, "BToC")->GetRelationshipClassCP();
        ...
        UnionNavigationQueryPtr expected = UnionNavigationQuery::Create({nestedQuery2, nestedQuery1});
        expected->OrderBy(ecInstanceNodesQuerySortedDisplayLabel.c_str());
    ...
    // InstancesOfSpecificClasses_ClassNames_NotPolymorphic
        {
        ComplexNavigationQueryPtr nestedQuery1 = RulesEngineTestHelpers::CreateMultiECInstanceNodesQuery(b1_Class1A,
            ComplexNavigationQuery::Create()->SelectContract(*ECInstanceNodesQueryContract::Create(&b1_Class1A), "this")
            .From(b1_Class1A, false, "this"));

        ComplexNavigationQueryPtr nestedQuery2 = RulesEngineTestHelpers::CreateMultiECInstanceNodesQuery(b1_Class1B,
            ComplexNavigationQuery::Create()->SelectContract(*ECInstanceNodesQueryContract::Create(&b1_Class1B), "this")
            .From(b1_Class1B, false, "this"));
    ...
    // InstancesOfSpecificClasses_ClassNames_Polymorphic
        ...
        ComplexNavigationQueryPtr expected = RulesEngineTestHelpers::CreateMultiECInstanceNodesQuery(b1_Class1A, *nestedQuery);
        expected->OrderBy(ecInstanceNodesQuerySortedDisplayLabel.c_str());
    ...
    // InstancesOfSpecificClasses_GroupByClass_ChildrenQuery
        {
        NavigationQueryContractPtr contract = ECInstanceNodesQueryContract::Create(&b1_Class1A);
        ComplexNavigationQueryPtr expected = RulesEngineTestHelpers::CreateMultiECInstanceNodesQuery(b1_Class1A,
            ComplexNavigationQuery::Create()->SelectContract(*contract, "this").From(b1_Class1A, false, "this"));
        expected->OrderBy(ecInstanceNodesQuerySortedDisplayLabel.c_str());
    ...
    // InstancesOfSpecificClasses_InstanceFilter_LikeOperator
        ...
        ComplexNavigationQueryPtr expected = RulesEngineTestHelpers::CreateMultiECInstanceNodesQuery(b2_Class2, *nestedQuery);
        expected->OrderBy(ecInstanceNodesQuerySortedDisplayLabel.c_str());
    ...
    // InstancesOfSpecificClasses_InstanceFilter_ReferencingParentInstance_WithParentInstanceNode
        ...
        nestedQuery->Where("[parent].[ECInstanceId] IN (?)", {new BoundQueryId(ECInstanceId((uint64_t)123))}, true);
    ...
    // InstancesOfSpecificClasses_InstanceFilter_ReferencingGrandParentInstance
        ...
        nestedQuery->Where("[parent_parent].[ECInstanceId] IN (?)", {new BoundQueryId(ECInstanceId((uint64_t)123))}, true);
    ...
    // InstancesOfSpecificClasses_InstanceFilter_ReferencingGrandParentAndParentInstance
        ...
        nestedQuery->From(b2_Class2, false, "parent", true);
        nestedQuery->From(b2_Class2, false, "parent_parent", true);
        nestedQuery->Where("[parent].[ECInstanceId] IN (?)", {new BoundQueryId(ECInstanceId((uint64_t)456))}, true);
        nestedQuery->Where("[parent_parent].[ECInstanceId] IN (?)", {new BoundQueryId(ECInstanceId((uint64_t)123))}, true);
    ...
    // InstancesOfSpecificClasses_InstanceLabelOverride_OverrideOnlySpecifiedClassInstancesLabels
        ...
        ComplexNavigationQueryPtr gadgetQuery = RulesEngineTestHelpers::CreateMultiECInstanceNodesQuery(ret_Gadget,
            ComplexNavigationQuery::Create()->SelectContract(*gadgetContract, "this").From(ret_Gadget, false, "this"));

        NavigationQueryContractPtr widgetContract = ECInstanceNodesQueryContract::Create(&ret_Widget, bvector<RelatedClassPath>(), {new InstanceLabelOverridePropertyValueSpecification("MyID")});
        ComplexNavigationQueryPtr widgetQuery = RulesEngineTestHelpers::CreateMultiECInstanceNodesQuery(ret_Widget,
            ComplexNavigationQuery::Create()->SelectContract(*widgetContract, "this").From(ret_Widget, false, "this"));

        UnionNavigationQueryPtr sorted = UnionNavigationQuery::Create({gadgetQuery, widgetQuery});
        sorted->OrderBy(ecInstanceNodesQuerySortedDisplayLabel.c_str());
    ...
    // InstancesOfSpecificClasses_InstanceLabelOverride_AppliedByPriority
        {
        NavigationQueryContractPtr widgetContract = ECInstanceNodesQueryContract::Create(&ret_Widget, bvector<RelatedClassPath>(), {new InstanceLabelOverridePropertyValueSpecification("Description"), new InstanceLabelOverridePropertyValueSpecification("MyID")});
        ...
        ComplexNavigationQueryPtr sorted = RulesEngineTestHelpers::CreateMultiECInstanceNodesQuery(ret_Widget, *widgetQuery);
        sorted->OrderBy(ecInstanceNodesQuerySortedDisplayLabel.c_str());
    ...
    // SearchResultInstanceNodes_NoGrouping
        ...
        ComplexNavigationQueryPtr ordered = RulesEngineTestHelpers::CreateMultiECInstanceNodesQuery(ret_Widget, *instancesQuery);
    ...
    // SearchResultInstanceNodes_InstanceLabelOverride_AppliedByPriority
        ...
        RefCountedPtr<DisplayLabelGroupingNodesQueryContract> contract = DisplayLabelGroupingNodesQueryContract::Create(&ret_Widget, bvector<RelatedClassPath>(), {new InstanceLabelOverridePropertyValueSpecification("IntProperty"), new InstanceLabelOverridePropertyValueSpecification("MyID")});
        contract->SetECClassIdFieldName(SEARCH_QUERY_FIELD_ECClassId);
        contract->SetECInstanceIdFieldName(SEARCH_QUERY_FIELD_ECInstanceId);
    ...
    // SearchResultInstanceNodes_InstanceLabelOverride_OverrideOnlySpecifiedClassInstancesLabels
        ...
        RefCountedPtr<DisplayLabelGroupingNodesQueryContract> widgetContract = DisplayLabelGroupingNodesQueryContract::Create(&ret_Widget, bvector<RelatedClassPath>(), {new InstanceLabelOverridePropertyValueSpecification("MyID")});
    ...
    // SortingRule_SortByRulesAndLabelAndNotSorted
        {
        ComplexNavigationQueryPtr rulesSortedQuery = RulesEngineTestHelpers::CreateMultiECInstanceNodesQuery(b4_ClassA,
            ComplexNavigationQuery::Create()->SelectContract(*ECInstanceNodesQueryContract::Create(&b4_ClassA), "this")
            .From(b4_ClassA, false, "this")
        ...
        ComplexNavigationQueryPtr notSortedQuery = RulesEngineTestHelpers::CreateMultiECInstanceNodesQuery(b4_ClassB,
            ComplexNavigationQuery::Create()->SelectContract(*ECInstanceNodesQueryContract::Create(&b4_ClassB), "this").From(b4_ClassB, false, "this"));

        UnionNavigationQueryPtr unionQuery = UnionNavigationQuery::Create({rulesSortedQuery, labelSortedQueryWrapper, notSortedQuery});
    ...
    // SortingRule_SortSingleECClassByRule
        ...
        RegisterQuery("SortingRule_SortSingleECClassByRule", *RulesEngineTestHelpers::CreateMultiECInstanceNodesQuery(b3_Class3, *rulesSortedQuery));
        }
    ...
    // SortingRule_SortSingleECClassByDoNotSortRule
        ...
        RegisterQuery("SortingRule_SortSingleECClassByDoNotSortRule", *RulesEngineTestHelpers::CreateMultiECInstanceNodesQuery(b3_Class3, *notSortedQuery));
        }
    ...
    // SortingRule_SortDescending
        ...
        RegisterQuery("SortingRule_SortDescending", *RulesEngineTestHelpers::CreateMultiECInstanceNodesQuery(b3_Class3, *rulesSortedQuery));
        }

    // SortingRule_AppliedToAllSchemaClasses
        {
        ComplexNavigationQueryPtr rulesSortedQuery = RulesEngineTestHelpers::CreateMultiECInstanceNodesQuery(b3_Class3,
            ComplexNavigationQuery::Create()->SelectContract(*ECInstanceNodesQueryContract::Create(&b3_Class3), "this")
            .From(b3_Class3, true, "this")
            .OrderBy(Utf8PrintfString("%s([this].[%s])", FUNCTION_NAME_GetSortingValue, "SomeProperty").c_str()));

        ComplexNavigationQueryPtr labelSortedQuery = RulesEngineTestHelpers::CreateMultiECInstanceNodesQuery(b2_Class2,
            ComplexNavigationQuery::Create()->SelectContract(*ECInstanceNodesQueryContract::Create(&b2_Class2), "this")
            .From(b2_Class2, true, "this"));
        labelSortedQuery->OrderBy(ecInstanceNodesQuerySortedDisplayLabel.c_str());

        ComplexNavigationQueryPtr labelSortedQueryWrapper = ComplexNavigationQuery::Create();
        labelSortedQueryWrapper->SelectAll().From(*labelSortedQuery);

        UnionNavigationQueryPtr unionQuery = UnionNavigationQuery::Create({rulesSortedQuery, labelSortedQueryWrapper});
    ...
    // SortingRule_AppliedToClassesOfAllSchemas
        {
        ComplexNavigationQueryPtr rulesSortedQuery1 = RulesEngineTestHelpers::CreateMultiECInstanceNodesQuery(b3_Class3,
            ComplexNavigationQuery::Create()->SelectContract(*ECInstanceNodesQueryContract::Create(&b3_Class3), "this")
            .From(b3_Class3, true, "this")
            .OrderBy(Utf8PrintfString("%s([this].[%s])", FUNCTION_NAME_GetSortingValue, "SomeProperty").c_str()));

        ComplexNavigationQueryPtr rulesSortedQuery2 = RulesEngineTestHelpers::CreateMultiECInstanceNodesQuery(b4_ClassA,
            ComplexNavigationQuery::Create()->SelectContract(*ECInstanceNodesQueryContract::Create(&b4_ClassA), "this")
            .From(b4_ClassA, true, "this")
            .OrderBy("[this].[SomeProperty]"));

        UnionNavigationQueryPtr unionQuery = UnionNavigationQuery::Create({rulesSortedQuery1, rulesSortedQuery2});
    ...
    // SortingRule_OverridenBySpecificationsDoNotSortFlag
        ...
        RegisterQuery("SortingRule_OverridenBySpecificationsDoNotSortFlag", *RulesEngineTestHelpers::CreateMultiECInstanceNodesQuery(b3_Class3, *notSortedQuery));
        }
    ...
    // SortingRule_SortsByProperty_WhenUsingParentInstanceOfTheSameClass
        ...
        expected->Where("[parent].[ECInstanceId] IN (?)", {new BoundQueryId(ECInstanceId((uint64_t)123))});
        ...
        RegisterQuery("SortingRule_SortsByProperty_WhenUsingParentInstanceOfTheSameClass", *RulesEngineTestHelpers::CreateMultiECInstanceNodesQuery(b3_Class3, *expected));
        }
    ...
    // SortingRule_SortsUsingRelatedInstanceProperty
        ...
        NavigationQueryContractPtr contract = ECInstanceNodesQueryContract::Create(&ret_Gadget, {RelatedClassPath{relatedInstanceClass}});
        ComplexNavigationQueryPtr expected = ComplexNavigationQuery::Create();
        expected->SelectContract(*contract, "this");
        ...
        expected->GetResultParametersR().GetMatchingRelationshipIds().insert(ret_WidgetHasGadgets.GetId());
        RegisterQuery("SortingRule_SortsUsingRelatedInstanceProperty", *RulesEngineTestHelpers::CreateMultiECInstanceNodesQuery(ret_Gadget, *expected));
        }

    // Grouping_ClassFilterIsPolymorphic
        {
        NavigationQueryContractPtr contract = MultiECInstanceNodesQueryContract::Create(&b4_ClassB, true);

        ComplexNavigationQueryPtr grouped = ComplexNavigationQuery::Create();
        grouped->SelectAll();
        grouped->From(ComplexNavigationQuery::Create()->SelectContract(*contract, "this").From(b4_ClassB, false, "this"));
        grouped->GroupByContract(*contract);
    ...
    // Grouping_IgnoresGroupingRulesWithInvalidSchemas
        {
        ComplexNavigationQueryPtr grouped = RulesEngineTestHelpers::CreateMultiECInstanceNodesQuery(b4_ClassA,
            ComplexNavigationQuery::Create()->SelectContract(*ECInstanceNodesQueryContract::Create(&b4_ClassA), "this").From(b4_ClassA, false, "this"));
        grouped->OrderBy(labelGroupingQuerySortedDisplayLabel.c_str());
    ...
    // Grouping_SameLabelInstanceGroup_OnlyGroupedInstanceNodes
        {
        NavigationQueryContractPtr contract1 = MultiECInstanceNodesQueryContract::Create(&b1_Class1A, true);
        ComplexNavigationQueryPtr grouped1 = ComplexNavigationQuery::Create();
        grouped1->SelectAll();
        grouped1->From(ComplexNavigationQuery::Create()->SelectContract(*contract1, "this").From(b1_Class1A, true, "this"));
        grouped1->GroupByContract(*contract1);

        NavigationQueryContractPtr contract2 = MultiECInstanceNodesQueryContract::Create(&b1_Class1B, true);
        ComplexNavigationQueryPtr grouped2 = ComplexNavigationQuery::Create();
        grouped2->SelectAll();
        grouped2->From(ComplexNavigationQuery::Create()->SelectContract(*contract2, "this").From(b1_Class1B, true, "this"));
        grouped2->GroupByContract(*contract2);
    ...
    // Grouping_SameLabelInstanceGroup_MultipleGroupedAndUngroupedInstanceNodes
        ...
        ComplexNavigationQueryPtr notGrouped = RulesEngineTestHelpers::CreateMultiECInstanceNodesQuery(b4_ClassA,
            *RulesEngineTestHelpers::CreateECInstanceNodesQueryForClass(b4_ClassA, true, "this"));

        UnionNavigationQueryPtr sorted = UnionNavigationQuery::Create({grouped1, grouped2, notGrouped});
        sorted->OrderBy(labelGroupingQuerySortedDisplayLabel.c_str());
        sorted->GetResultParametersR().GetNavNodeExtendedDataR().SetGroupingType((int)GroupingType::SameLabelInstance);
    ...
    // Grouping_ClassGroup_ECInstanceNodesChildrenQuery
        ...
        RegisterQuery("Grouping_ClassGroup_ECInstanceNodesChildrenQuery", *RulesEngineTestHelpers::CreateMultiECInstanceNodesQuery(b2_Class2, *expected));
        }
    ...
    // Grouping_PropertyGroup_GroupsMultipleClassesByProperty
        ...
        UnionNavigationQueryPtr unionQuery = UnionNavigationQuery::Create({grouped1, grouped2});
    ...
    // Grouping_PropertyGroup_ValueFiltering
        ...
        ComplexNavigationQueryPtr grouped = RulesEngineTestHelpers::CreateMultiECInstanceNodesQuery(b1_Class1A, *nested);
        grouped->OrderBy(labelGroupingQuerySortedDisplayLabel.c_str());
    ...
    // Grouping_PropertyGroup_GroupsSubclassNodesWhenPolymorphicallyReturningParentNodesWithRelatedInstances
        ...
        ComplexNavigationQueryPtr sorted = RulesEngineTestHelpers::CreateMultiECInstanceNodesQuery(ret_ClassE,
            ComplexNavigationQuery::Create()->SelectContract(*ECInstanceNodesQueryContract::Create(&ret_ClassE, {RelatedClassPath{relatedInstanceClass0}}), "this")
            .From(ret_ClassE, true, "this")
    ...
    // Grouping_PropertyGroup_GroupsRelatedSubclassNodesWhenPolymorphicallyReturningParentNodes
        ...
        ComplexNavigationQueryPtr sorted = RulesEngineTestHelpers::CreateMultiECInstanceNodesQuery(ret_ClassD,
            ComplexNavigationQuery::Create()->SelectContract(*ECInstanceNodesQueryContract::Create(&ret_ClassD, {RelatedClassPath{relatedInstanceClass1}}), "this")
    ...
    // ThirdPropertyGroupingNodeChildrenQueryReturnsLabelGroupingNodes
        ...
        NavigationQueryContractPtr contract = DisplayLabelGroupingNodesQueryContract::Create(&b4_ClassB, {RelatedClassPath{relatedInstanceClass}});
    ...
    // LabelGroupingNodeChildrenQueryReturnsInstanceNodes
        {
        RelatedClass relatedInstanceClass(b4_ClassB, b4_ClassC, b4_ClassBHasClassC, true, "c", "rel_b4_ClassBHasClassC_0");
        NavigationQueryContractPtr contract = MultiECInstanceNodesQueryContract::Create(&b4_ClassB, true, {RelatedClassPath{relatedInstanceClass}});
    ...
    // JoinsWithAdditionalRelatedInstances
        ...
        ComplexNavigationQueryPtr sorted = RulesEngineTestHelpers::CreateMultiECInstanceNodesQuery(ret_Gadget, *nested);
        sorted->OrderBy(ecInstanceNodesQuerySortedDisplayLabel.c_str());
    ...
    // SelectedNodeInstances_RemovesMultipleHiddenPropertiesOfDifferentClasses
        ...
        AddField(*descriptor, *new ContentDescriptor::DisplayLabelField(PRESENTATION_LOCALIZEDSTRING(ECPresentationL10N::GetNameSpace(), ECPresentationL10N::LABEL_General_DisplayLabel()), 0));
        field = new ContentDescriptor::ECPropertiesField(ContentDescriptor::Category::GetDefaultCategory(), FIELD_NAME((bvector<ECClassCP>{&sc_Class2, &sc_Class3}), "C1"), "C1");
    ...
    // SelectedNodeInstances_AddsSingleRelatedProperty
        ...
        descriptor->GetAllFields().back()->SetUniqueName(RELATED_FIELD_NAME(&ret_Gadget, &ret_Widget, "IntProperty"));
        descriptor->GetAllFields().back()->SetLabel("Widget IntProperty");
        widgetKeyField->AddKeyField(*field->AsPropertiesField());
        widgetKeyField->SetUniqueName(widgetKeyField->CreateName());
    ...
    // SelectedNodeInstances_AddsMultipleRelatedProperties
        ...
        field = &AddField(*descriptor, CreateCategory(ret_Widget), CreateProperty("rel_RET_Widget_1", ret_Widget, *ret_Widget.GetPropertyP("LongProperty"),
            relatedPropertyWidgetHasGadgets, RelationshipMeaning::RelatedInstance));
        descriptor->GetAllFields().back()->SetUniqueName(RELATED_FIELD_NAME(&ret_Gadget, &ret_Widget, "LongProperty"));
    ...
    // SelectedNodeInstances_AddsAllRelatedProperties
        ...
        descriptor->GetAllFields().back()->SetUniqueName(RELATED_FIELD_NAME(&ret_Sprocket, &ret_Gadget, "MyID"));
        ...
        field = &AddField(*descriptor, CreateCategory(ret_Gadget), CreateProperty("rel_RET_Gadget_1", ret_Gadget, *ret_Gadget.GetPropertyP("Description"),
            relatedPropertyPathGadgetHasSprockets, RelationshipMeaning::RelatedInstance));
        descriptor->GetAllFields().back()->SetUniqueName(RELATED_FIELD_NAME(&ret_Sprocket, &ret_Gadget, "Description"));
    ...
    // SelectedNodeInstances_AddsBackwardRelatedProperties
        ...
        descriptor->GetAllFields().back()->SetUniqueName(RELATED_FIELD_NAME(&sc_Class2, &sc_Class1, "PropertyA"));
        descriptor->GetAllFields().back()->SetLabel("Class1 PropertyA");
        class1KeyField->AddKeyField(*field->AsPropertiesField());
        class1KeyField->SetUniqueName(class1KeyField->CreateName());
    ...
    // SelectedNodeInstances_AddsPropertiesOfTheSameClassFoundByFollowingDifferentRelationships
        ...
        field->AsPropertiesField()->AddProperty(CreateProperty("rel_RET_Widget_2", ret_Widget, *ret_Widget.GetPropertyP("Description"),
            relatedPropertyPathWidgetHasGadget, RelationshipMeaning::RelatedInstance));
        AddField(*descriptor, *field);
        descriptor->GetAllFields().back()->SetUniqueName(RELATED_FIELD_NAME(&ret_Gadget, &ret_Widget, "Description"));
    ...
    // SelectedNodeInstances_AddsNestedPropertiesOfTheSameClassFoundByFollowingDifferentRelationships
        ...
        AddField(*descriptor, *field);
        descriptor->GetAllFields().back()->SetUniqueName(RELATED_FIELD_NAME((bvector<ECClassCP>{&ret_Sprocket, &ret_Gadget}), &ret_Widget, "IntProperty"));
        descriptor->GetAllFields().back()->SetLabel("Widget IntProperty");
        widgetKeyField->AddKeyField(*descriptor->GetAllFields().back()->AsPropertiesField());
        widgetKeyField->SetUniqueName(widgetKeyField->CreateName());
    ...
    // SelectedNodeInstances_AddsNestedRelatedProperties
        ...
        descriptor->GetAllFields().back()->SetUniqueName(RELATED_FIELD_NAME((bvector<ECClassCP>{&ret_Sprocket, &ret_Gadget}), &ret_Widget, "Description"));
        descriptor->GetAllFields().back()->SetLabel("Widget Description");
        widgetKeyField->AddKeyField(*field->AsPropertiesField());
        widgetKeyField->SetUniqueName(widgetKeyField->CreateName());
    ...
    //SelectedNodeInstances_JoinsRelatedInstanceWithInnerJoin
        ...
        descriptor->GetSelectClasses().back().SetRelatedInstancePaths({RelatedClassPath{relatedInstanceClass}});
    ...
    // AppliesRelatedInstanceSpecificationForTheSameXToManyRelationshipAndClassTwoTimes
        ...
        RelatedClass relatedInstanceClass2(ret_Gadget, SelectClass(ret_Widget, true), ret_WidgetsHaveGadgets, false, "widgetAlias2", "rel_RET_WidgetsHaveGadgets_0");
        ...
        descriptor->GetSelectClasses().back().SetRelatedInstancePaths({RelatedClassPath{relatedInstanceClass1}, RelatedClassPath{relatedInstanceClass2}});
    ...
    //  ContentInstacesOfSpecificClasses_ReturnsQueryWithCalculatedProperties
        ...
        AddField(*descriptor, *new ContentDescriptor::DisplayLabelField(PRESENTATION_LOCALIZEDSTRING(ECPresentationL10N::GetNameSpace(), ECPresentationL10N::LABEL_General_DisplayLabel()), 0));
        AddField(*descriptor, ContentDescriptor::Category::GetDefaultCategory(), ContentDescriptor::Property("this", b2_Class2, *b2_Class2.GetPropertyP("Name")));
        AddField(*descriptor, *new ContentDescriptor::CalculatedPropertyField("LabelTest_1", "CalculatedProperty_0", "\"Value\" & 1", nullptr, 1200));
        AddField(*descriptor, *new ContentDescriptor::CalculatedPropertyField("LabelTest_2", "CalculatedProperty_1", "this.Name & \"Test\"", nullptr, 1500));
    ...
    // ContentInstancesOfSpecificClasses_SetsMergeResultsFlagForPropertyPaneContentType2
        ...
        AddField(*innerDescriptor, *new ContentDescriptor::DisplayLabelField(PRESENTATION_LOCALIZEDSTRING(ECPresentationL10N::GetNameSpace(), ECPresentationL10N::LABEL_General_DisplayLabel()), 0));
    ...
    // ContentRelatedInstances_ReturnsForwardRelatedInstanceQueryWhenSelectedOneInstanceNode
        ...
        descriptor->GetSelectClasses().back().SetPathFromInputToSelectClass({
            RelatedClass(ret_Gadget, SelectClass(ret_Sprocket, true), ret_GadgetHasSprocket, true, "target_RET_Sprocket_0", "rel_RET_GadgetHasSprocket_0", false)
            });
        descriptor->GetSelectClasses().back().SetNavigationPropertyClasses({
            RelatedClass(ret_Sprocket, SelectClass(ret_Gadget, true), ret_GadgetHasSprockets, false, "nav_RET_Gadget_0", "nav_RET_GadgetHasSprockets_0")
            });
        descriptor->GetSelectClasses().push_back(SelectClassInfo(ret_Sprocket, true));
        descriptor->GetSelectClasses().back().SetPathFromInputToSelectClass({
            RelatedClass(ret_Gadget, SelectClass(ret_Sprocket, true), ret_GadgetHasSprockets, true, "target_RET_Sprocket_1", "rel_RET_GadgetHasSprockets_0", false)
            });
        descriptor->GetSelectClasses().back().SetNavigationPropertyClasses({
            RelatedClass(ret_Sprocket, SelectClass(ret_Gadget, true), ret_GadgetHasSprockets, false, "nav_RET_Gadget_0", "nav_RET_GadgetHasSprockets_0")
            });
    ...
    // ContentRelatedInstances_ReturnsBackwardRelatedInstanceQueryWhenSelectedOneInstanceNode
        ...
        descriptor->GetSelectClasses().back().SetPathFromInputToSelectClass({
            RelatedClass(ret_Gadget, SelectClass(ret_Widget, true), ret_WidgetHasGadgets, false, "target_RET_Widget_0", "rel_RET_WidgetHasGadgets_0", false)
            });
        descriptor->GetSelectClasses().push_back(SelectClassInfo(ret_Widget, true));
        descriptor->GetSelectClasses().back().SetPathFromInputToSelectClass({
            RelatedClass(ret_Gadget, SelectClass(ret_Widget, true), ret_WidgetHasGadget, false, "target_RET_Widget_1", "rel_RET_WidgetHasGadget_0", false)
            });
        descriptor->GetSelectClasses().push_back(SelectClassInfo(ret_Widget, true));
        descriptor->GetSelectClasses().back().SetPathFromInputToSelectClass({
            RelatedClass(ret_Gadget, SelectClass(ret_Widget, true), ret_WidgetsHaveGadgets, false, "target_RET_Widget_2", "rel_RET_WidgetsHaveGadgets_0", false)
            });
        descriptor->GetSelectClasses().push_back(SelectClassInfo(ret_Widget, true));
        descriptor->GetSelectClasses().back().SetPathFromInputToSelectClass({
            RelatedClass(ret_Gadget, SelectClass(ret_Widget, true), ret_WidgetsHaveGadgets2, false, "target_RET_Widget_3", "rel_RET_WidgetsHaveGadgets2_0", false)
            });
        ...
        UnionContentQueryPtr query = UnionContentQuery::Create({query1, query2, query3, query4});
#ifdef WIP_SORTING_GRID_CONTENT
        query->OrderBy(ContentQueryContract::ECInstanceIdFieldName);
#endif
    ...
    // ContentRelatedInstances_ReturnsBothDirectionsRelatedInstanceQueryWhenSelectedOneInstanceNode
        ...
        AddField(*descriptor, *new ContentDescriptor::DisplayLabelField(PRESENTATION_LOCALIZEDSTRING(ECPresentationL10N::GetNameSpace(), ECPresentationL10N::LABEL_General_DisplayLabel()), 0));
        field = new ContentDescriptor::ECPropertiesField(ContentDescriptor::Category::GetDefaultCategory(), FIELD_NAME((bvector<ECClassCP>{&ret_Widget, &ret_Sprocket}), "Description"), "Description");
        ...
        AddField(*descriptor, *field);
        field = new ContentDescriptor::ECPropertiesField(ContentDescriptor::Category::GetDefaultCategory(), FIELD_NAME((bvector<ECClassCP>{&ret_Widget, &ret_Sprocket}), "MyID"), "MyID");
        ...
        UnionContentQueryPtr query = UnionContentQuery::Create({query1, query2, query3, query4, query5, query6});
#ifdef WIP_SORTING_GRID_CONTENT
        query->OrderBy(ContentQueryContract::ECInstanceIdFieldName);
#endif
    ...
    // ContentRelatedInstances_ReturnsRelatedInstanceQueryWhenSelectedMultipleInstanceNodesOfDifferentClasses
        ...
        descriptor->GetSelectClasses().back().SetPathFromInputToSelectClass({
            RelatedClass(ret_Widget, SelectClass(ret_Gadget, true), ret_WidgetHasGadgets, true, "target_RET_Gadget_0", "rel_RET_WidgetHasGadgets_0", false)
            });
        descriptor->GetSelectClasses().back().SetNavigationPropertyClasses({
            RelatedClass(ret_Gadget, SelectClass(ret_Widget, true), ret_WidgetHasGadgets, false, "nav_RET_Widget_0", "nav_RET_WidgetHasGadgets_0")
            });
        descriptor->GetSelectClasses().push_back(SelectClassInfo(ret_Gadget, true));
        descriptor->GetSelectClasses().back().SetPathFromInputToSelectClass({
            RelatedClass(ret_Sprocket, SelectClass(ret_Gadget, true), ret_GadgetHasSprockets, false, "target_RET_Gadget_1", "rel_RET_GadgetHasSprockets_0", false)
            });
        descriptor->GetSelectClasses().back().SetNavigationPropertyClasses({
            RelatedClass(ret_Gadget, SelectClass(ret_Widget, true), ret_WidgetHasGadgets, false, "nav_RET_Widget_0", "nav_RET_WidgetHasGadgets_0")
            });
    ...
    // ContentRelatedInstances_AppliesInstanceFilter
        ...
        descriptor->GetSelectClasses().push_back(SelectClassInfo(ret_Gadget, true));
        descriptor->GetSelectClasses().back().SetPathFromInputToSelectClass({
            RelatedClass(ret_Widget, SelectClass(ret_Gadget, true), ret_WidgetsHaveGadgets, true, "target_RET_Gadget_0", "rel_RET_WidgetsHaveGadgets_0", false)
            });
        descriptor->GetSelectClasses().back().SetNavigationPropertyClasses({
            RelatedClass(ret_Gadget, SelectClass(ret_Widget, true), ret_WidgetHasGadgets, false, "nav_RET_Widget_0", "nav_RET_WidgetHasGadgets_0")
            });
    ...
    // ContentRelatedInstances_SkipsRelatedLevel
        ...
        RelatedClassPath relationshipPath12 = {
            RelatedClass(ret_Widget, SelectClass(ret_Gadget, true), ret_WidgetHasGadget, true, "target_RET_Gadget_1", "rel_RET_WidgetHasGadget_0", false),
            RelatedClass(ret_Gadget, SelectClass(ret_Sprocket, true), ret_GadgetHasSprocket, true, "target_RET_Sprocket_0", "rel_RET_GadgetHasSprocket_0", false),
            };
        RelatedClassPath relationshipPath13 = {
            RelatedClass(ret_Widget, SelectClass(ret_Gadget, true), ret_WidgetsHaveGadgets, true, "target_RET_Gadget_2", "rel_RET_WidgetsHaveGadgets_0", false),
            RelatedClass(ret_Gadget, SelectClass(ret_Sprocket, true), ret_GadgetHasSprocket, true, "target_RET_Sprocket_0", "rel_RET_GadgetHasSprocket_0", false),
            };
        RelatedClassPath relationshipPath14 = {
            RelatedClass(ret_Widget, SelectClass(ret_Gadget, true), ret_WidgetsHaveGadgets2, true, "target_RET_Gadget_3", "rel_RET_WidgetsHaveGadgets2_0", false),
            RelatedClass(ret_Gadget, SelectClass(ret_Sprocket, true), ret_GadgetHasSprocket, true, "target_RET_Sprocket_0", "rel_RET_GadgetHasSprocket_0", false),
            };
        RelatedClassPath relationshipPath21 = {
            RelatedClass(ret_Widget, SelectClass(ret_Gadget, true), ret_WidgetHasGadgets, true, "target_RET_Gadget_0", "rel_RET_WidgetHasGadgets_0", false),
        ...
        ContentDescriptorPtr descriptor = GetEmptyContentDescriptor();
        descriptor->GetSelectClasses().push_back(SelectClassInfo(ret_Sprocket, true));
        descriptor->GetSelectClasses().back().SetPathFromInputToSelectClass(relationshipPath11);
        descriptor->GetSelectClasses().back().SetNavigationPropertyClasses({navigationPropertyPath});
        descriptor->GetSelectClasses().push_back(SelectClassInfo(ret_Sprocket, true));
        descriptor->GetSelectClasses().back().SetPathFromInputToSelectClass(relationshipPath12);
        descriptor->GetSelectClasses().back().SetNavigationPropertyClasses({navigationPropertyPath});
        descriptor->GetSelectClasses().push_back(SelectClassInfo(ret_Sprocket, true));
        descriptor->GetSelectClasses().back().SetPathFromInputToSelectClass(relationshipPath13);
        descriptor->GetSelectClasses().back().SetNavigationPropertyClasses({navigationPropertyPath});
        descriptor->GetSelectClasses().push_back(SelectClassInfo(ret_Sprocket, true));
        descriptor->GetSelectClasses().back().SetPathFromInputToSelectClass(relationshipPath14);
        descriptor->GetSelectClasses().back().SetNavigationPropertyClasses({navigationPropertyPath});
        descriptor->GetSelectClasses().push_back(SelectClassInfo(ret_Sprocket, true));
        descriptor->GetSelectClasses().back().SetPathFromInputToSelectClass(relationshipPath21);
        descriptor->GetSelectClasses().back().SetNavigationPropertyClasses({navigationPropertyPath});
        descriptor->GetSelectClasses().push_back(SelectClassInfo(ret_Sprocket, true));
        descriptor->GetSelectClasses().back().SetPathFromInputToSelectClass(relationshipPath22);
        descriptor->GetSelectClasses().back().SetNavigationPropertyClasses({navigationPropertyPath});
        descriptor->GetSelectClasses().push_back(SelectClassInfo(ret_Sprocket, true));
        descriptor->GetSelectClasses().back().SetPathFromInputToSelectClass(relationshipPath23);
        descriptor->GetSelectClasses().back().SetNavigationPropertyClasses({navigationPropertyPath});
        descriptor->GetSelectClasses().push_back(SelectClassInfo(ret_Sprocket, true));
        descriptor->GetSelectClasses().back().SetPathFromInputToSelectClass(relationshipPath24);
        descriptor->GetSelectClasses().back().SetNavigationPropertyClasses({navigationPropertyPath});
        ...
        query11->Join(relationshipPath11.Reverse("related", false));
        ...
        query12->Join(relationshipPath12.Reverse("related", false));
        ...
        query13->Join(relationshipPath13.Reverse("related", false));
        ...
        query14->Join(relationshipPath14.Reverse("related", false));
        ...
        query21->Join(relationshipPath21.Reverse("related", false));
        ...
        query22->Join(relationshipPath22.Reverse("related", false));
        ...
        query23->Join(relationshipPath23.Reverse("related", false));
        ...
        query24->Join(relationshipPath24.Reverse("related", false));
        query24->Join(navigationPropertyPath);
        query24->Where("[related].[ECInstanceId] IN (?)", {new BoundQueryId({ECInstanceId((uint64_t)123)})});

        UnionContentQueryPtr query = UnionContentQuery::Create({query11, query12, query13, query14, query21, query22, query23, query24});
#ifdef WIP_SORTING_GRID_CONTENT
        query->OrderBy(ContentQueryContract::ECInstanceIdFieldName);
#endif
    ...
    // ContentRelatedInstances_SkipsRelatedLevelWithSpecifiedRelationship
        {
        RelatedClassPath relationshipPath1;
        relationshipPath1.push_back(RelatedClass(ret_Sprocket, SelectClass(ret_Gadget, true), ret_GadgetHasSprocket, false, "target_RET_Gadget_0", "rel_RET_GadgetHasSprocket_0", false));
        relationshipPath1.push_back(RelatedClass(ret_Gadget, SelectClass(ret_Widget, true), ret_WidgetHasGadgets, false, "target_RET_Widget_0", "rel_RET_WidgetHasGadgets_0", false));

        RelatedClassPath relationshipPath2;
        relationshipPath2.push_back(RelatedClass(ret_Sprocket, SelectClass(ret_Gadget, true), ret_GadgetHasSprockets, false, "target_RET_Gadget_1", "rel_RET_GadgetHasSprockets_0", false));
        relationshipPath2.push_back(RelatedClass(ret_Gadget, SelectClass(ret_Widget, true), ret_WidgetHasGadgets, false, "target_RET_Widget_0", "rel_RET_WidgetHasGadgets_0", false));

        ContentDescriptorPtr descriptor = GetEmptyContentDescriptor();
        descriptor->GetSelectClasses().push_back(SelectClassInfo(ret_Widget, true));
        descriptor->GetSelectClasses().back().SetPathFromInputToSelectClass(relationshipPath1);
        descriptor->GetSelectClasses().push_back(SelectClassInfo(ret_Widget, true));
        descriptor->GetSelectClasses().back().SetPathFromInputToSelectClass(relationshipPath2);
        ...
        query1->SelectContract(*ContentQueryContract::Create(1, *descriptor, &ret_Widget, *query1), "this");
        query1->From(ret_Widget, true, "this");
        query1->Join(relationshipPath1.Reverse("related", false));
        query1->Where("[related].[ECInstanceId] IN (?)", {new BoundQueryId({ECInstanceId((uint64_t)123)})});

        ComplexContentQueryPtr query2 = ComplexContentQuery::Create();
        query2->SelectContract(*ContentQueryContract::Create(2, *descriptor, &ret_Widget, *query2), "this");
        query2->From(ret_Widget, true, "this");
        query2->Join(relationshipPath2.Reverse("related", false));
        query2->Where("[related].[ECInstanceId] IN (?)", {new BoundQueryId({ECInstanceId((uint64_t)123)})});
    ...
    // ContentRelatedInstances_CreatesRecursiveQuery
        ...
        descriptor->GetSelectClasses().back().SetPathFromInputToSelectClass({
            RelatedClass(class_Element, SelectClass(class_Element, true), class_ElementOwnsChildElements, true, TABLE_ALIAS("target", class_Element, 0), TABLE_ALIAS("rel", class_ElementOwnsChildElements, 0), false)
            });
        descriptor->GetSelectClasses().back().SetNavigationPropertyClasses({
    ...
    // ContentRelatedInstances_CreatesRecursiveQueryWhenRelationshipIsOnBaseClass
        ...
        descriptor->GetSelectClasses().push_back(SelectClassInfo(class_Element, true));
        descriptor->GetSelectClasses().back().SetPathFromInputToSelectClass({
            RelatedClass(class_Sheet, SelectClass(class_Element, true), class_ElementOwnsChildElements, true, TABLE_ALIAS("target", class_Element, 0), TABLE_ALIAS("rel", class_ElementOwnsChildElements, 0), false)
            });
        descriptor->GetSelectClasses().back().SetNavigationPropertyClasses({
        ...
        descriptor->GetSelectClasses().push_back(SelectClassInfo(class_Element, true));
        descriptor->GetSelectClasses().back().SetPathFromInputToSelectClass({
            RelatedClass(class_Sheet, SelectClass(class_Element, true), class_ElementOwnsChildElements, true, TABLE_ALIAS("target", class_Element, 0), TABLE_ALIAS("rel", class_ElementOwnsChildElements, 0)),
            RelatedClass(class_Element, SelectClass(class_Element, true), class_ElementOwnsChildElements, true, TABLE_ALIAS("target", class_Element, 1), TABLE_ALIAS("rel", class_ElementOwnsChildElements, 2)),
            });
        descriptor->GetSelectClasses().back().SetNavigationPropertyClasses({
            RelatedClass(class_Element, SelectClass(class_Element, true), class_ElementOwnsChildElements, false, TABLE_ALIAS("nav", class_Element, 0), TABLE_ALIAS("nav", class_ElementOwnsChildElements, 0))
            });
    ...
    // ContentRelatedInstances_DoesntSplitRecursiveQueryClassesIntoDerivedClasses
        ...
        descriptor->GetSelectClasses().back().SetPathFromInputToSelectClass({
            RelatedClass(class_Sheet, SelectClass(class_Element, true), class_ElementOwnsChildElements, true, TABLE_ALIAS("target", class_Element, 0), TABLE_ALIAS("rel", class_ElementOwnsChildElements, 0), false),
            RelatedClass(class_Element, SelectClass(class_Element, true), class_ElementOwnsChildElements, true, TABLE_ALIAS("target", class_Element, 1), TABLE_ALIAS("rel", class_ElementOwnsChildElements, 2), false),
            });
        descriptor->GetSelectClasses().back().SetNavigationPropertyClasses({
            RelatedClass(class_Element, SelectClass(class_Element, true), class_ElementOwnsChildElements, false, TABLE_ALIAS("nav", class_Element, 0), TABLE_ALIAS("nav", class_ElementOwnsChildElements, 0))
            });
    ...
    // ContentRelatedInstances_DoesntDuplicateRecursiveQueryClasses
        ...
        descriptor->GetSelectClasses().push_back(SelectClassInfo(class_Element, true));
        descriptor->GetSelectClasses().back().SetPathFromInputToSelectClass({
            RelatedClass(class_Element, SelectClass(class_Element, true), class_ElementRefersToElements, true, TABLE_ALIAS("target", class_Element, 1), TABLE_ALIAS("rel", class_ElementRefersToElements, 0), false)
            });
    ...
    // ContentRelatedInstances_SelectPointPropertyRawDataGroupedByDisplayValue
        ...
        descriptor->GetSelectClasses().back().SetPathFromInputToSelectClass({
            RelatedClass(ret_ClassD, SelectClass(ret_ClassH, true), ret_ClassDHasClassE, true, "target_RET_ClassH_0", "rel_RET_ClassDHasClassE_0", false)
            });
        AddField(*descriptor, *new ContentDescriptor::DisplayLabelField(PRESENTATION_LOCALIZEDSTRING(ECPresentationL10N::GetNameSpace(), ECPresentationL10N::LABEL_General_DisplayLabel()), 0));
        AddField(*descriptor, ContentDescriptor::Category::GetDefaultCategory(), ContentDescriptor::Property("this", ret_ClassH, *ret_ClassH.GetPropertyP("PointProperty")));
    ...
    // RelatedContentField_WithNestedContentFields
        ...
        descriptor->AddField(new ContentDescriptor::RelatedContentField(category, "sprocket_field_name", "sprocket_field_label",
            ...
            {
            new ContentDescriptor::ECPropertiesField(ContentDescriptor::Category(), FIELD_NAME(&ret_Sprocket, "MyID"),
    ...
    // FieldNamesDontCollideWhenSelectingInstanceAndRelatedPropertyOfTheSameClass
        ...
        descriptor->GetAllFields().back()->SetUniqueName(RELATED_FIELD_NAME(&ret_Gadget, &ret_Widget, "MyID"));
    ...
    // FieldNamesContainNamesOfAllRelatedClassesWhenSelectingMultipleClassesWithSameRelatedProperty
        ...
        descriptor->GetAllFields().back()->SetUniqueName(FIELD_NAME((bvector<ECClassCP>{&ret_Widget, &ret_Sprocket}), "Description"));
        ...
        descriptor->GetAllFields().back()->SetUniqueName(FIELD_NAME((bvector<ECClassCP>{&ret_Widget, &ret_Sprocket}), "MyID"));
        ...
        field->AsPropertiesField()->AddProperty(CreateProperty("rel_RET_Gadget_2", ret_Gadget, *ret_Gadget.GetPropertyP("MyID"),
            relatedPropertyPathGadgetHasSprockets, RelationshipMeaning::RelatedInstance));
        AddField(*descriptor, *field);
        descriptor->GetAllFields().back()->SetUniqueName(RELATED_FIELD_NAME((bvector<ECClassCP>{&ret_Widget, &ret_Sprocket}), &ret_Gadget, "MyID"));
        descriptor->GetAllFields().back()->SetLabel("Gadget MyID");
    ...
    // CreatesContentFieldsForXToManyRelatedInstanceProperties
        ...
        AddField(*descriptor, *new ContentDescriptor::RelatedContentField(sprocketCategory, NESTED_CONTENT_FIELD_NAME(&ret_Gadget, &ret_Sprocket), "Sprocket",
            ...
            {
            new ContentDescriptor::ECPropertiesField(ContentDescriptor::Category(), FIELD_NAME(&ret_Sprocket, "Description"), ContentDescriptor::Property("rel_RET_Sprocket_0", ret_Sprocket, *ret_Sprocket.GetPropertyP("Description")))
            }));
    ...
    // CreatesNestedContentFieldsForXToManyRelatedInstanceProperties
        ...
        AddField(*descriptor, ContentDescriptor::Category::GetDefaultCategory(), ContentDescriptor::Property("this", ret_Widget, *ret_Widget.GetPropertyP("LongProperty")));
        AddField(*descriptor, ContentDescriptor::Category::GetDefaultCategory(), ContentDescriptor::Property("this", ret_Widget, *ret_Widget.GetPropertyP("DateProperty")));
        AddField(*descriptor, *new ContentDescriptor::RelatedContentField(CreateCategory(ret_Gadget), NESTED_CONTENT_FIELD_NAME(&ret_Widget, &ret_Gadget), "Gadget",
            {
            ...
            {
            new ContentDescriptor::ECPropertiesField(ContentDescriptor::Category(), FIELD_NAME(&ret_Gadget, "Description"), ContentDescriptor::Property("rel_RET_Gadget_0", ret_Gadget, *ret_Gadget.GetPropertyP("Description"))),
    ...
    // FilterExpressionQueryTest
        ...
        query->Where(Utf8PrintfString("([%s] = 'WidgetId')", FIELD_NAME(&ret_Widget, "MyID")).c_str(), BoundQueryValuesList());
