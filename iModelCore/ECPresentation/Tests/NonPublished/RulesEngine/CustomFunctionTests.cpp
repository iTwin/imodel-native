...
struct CustomFunctionTests : ::testing::Test
    ...
    CustomFunctionTests() : m_schemaHelper(s_project->GetECDb(), m_relatedPathsCache, nullptr) {}
...
void CustomFunctionTests::SetUpTestCase()
    {
    CustomFunctionTests::s_project = new ECDbTestProject();
    CustomFunctionTests::s_project->Create("CustomFunctionTests", "RulesEngineTest.01.00.ecschema.xml");
    CustomFunctionTests::s_widgetClass = const_cast<ECClassP>(CustomFunctionTests::s_project->GetECDb().Schemas().GetClass("RulesEngineTest", "Widget"));
    }
...
TEST_F(CustomFunctionTests, GetECInstanceDisplayLabel_UsesLabelOverride)
    ...
    ECSchemaHelper schemaHelper(GetDb(), m_relatedPathsCache, nullptr);
...
TEST_F(CustomFunctionTests, GetECPropertyDisplayLabel_RangeBased_ReturnsOtherRange)
    ...
    CustomFunctionsContext ctx(m_schemaHelper, *m_ruleset, m_userSettings, nullptr, m_expressionsCache, m_nodesFactory, nullptr, nullptr, &query->GetExtendedData());
...
TEST_F(CustomFunctionTests, GetGroupedInstanceIds)
    ...
    IECInstancePtr newWidget = RulesEngineTestHelpers::InsertInstance(*s_project, *s_widgetClass);
...
TEST_F(CustomFunctionTests, GetECClassId)
    ...
    RulesEngineTestHelpers::InsertInstance(*s_project, *widgetClass);
...
TEST_F(CustomFunctionTests, GetMergedValue)
    {
    ECClassCP widgetClass = s_project->GetECDb().Schemas().GetClass("RulesEngineTest", "Widget");
    RulesEngineTestHelpers::InsertInstance(*s_project, *widgetClass, [](IECInstanceR instance)
        {
...
TEST_F(CustomFunctionTests, AggregateJsonArray)
    {
    ECClassCP gadgetClass = s_project->GetECDb().Schemas().GetClass("RulesEngineTest", "Gadget");
    IECInstancePtr gadget1 = RulesEngineTestHelpers::InsertInstance(*s_project, *gadgetClass);
    IECInstancePtr gadget2 = RulesEngineTestHelpers::InsertInstance(*s_project, *gadgetClass);
    CustomFunctionsContext ctx(m_schemaHelper, *m_ruleset, m_userSettings, nullptr, m_expressionsCache, m_nodesFactory, nullptr, nullptr, nullptr);
...
+---------------+---------------+---------------+---------------+---------------+------*/
TEST_F(CustomFunctionTests, GetPoint2dDisplayValue)
    {
    ECClassCP classH = s_project->GetECDb().Schemas().GetClass("RulesEngineTest", "ClassH");
...
* @bsitest                                      Aidas.Vaiksnoras                11/2017
+---------------+---------------+---------------+---------------+---------------+------*/
TEST_F(CustomFunctionTests, GetPoint3dDisplayValue)
    {
    ECClassCP classH = s_project->GetECDb().Schemas().GetClass("RulesEngineTest", "ClassH");
    IECInstancePtr instanceH = RulesEngineTestHelpers::InsertInstance(*s_project, *classH);
...
* @bsitest                                      Aidas.Vaiksnoras                11/2017
+---------------+---------------+---------------+---------------+---------------+------*/
TEST_F(CustomFunctionTests, Are3dPointsEqualByValueReturnsTrue)
    {
    ECClassCP classH = s_project->GetECDb().Schemas().GetClass("RulesEngineTest", "ClassH");
    IECInstancePtr instanceH = RulesEngineTestHelpers::InsertInstance(*s_project, *classH, [](IECInstanceR instance)
        {
...
* @bsitest                                      Aidas.Vaiksnoras                11/2017
+---------------+---------------+---------------+---------------+---------------+------*/
TEST_F(CustomFunctionTests, Are3dPointsEqualByValueReturnsFalse)
    {
    ECClassCP classH = s_project->GetECDb().Schemas().GetClass("RulesEngineTest", "ClassH");
    IECInstancePtr instanceH = RulesEngineTestHelpers::InsertInstance(*s_project, *classH, [](IECInstanceR instance)
        {
...
* @bsitest                                      Aidas.Vaiksnoras                11/2017
+---------------+---------------+---------------+---------------+---------------+------*/
TEST_F(CustomFunctionTests, Are2dPointsEqualByValueReturnsTrue)
    {
    ECClassCP classH = s_project->GetECDb().Schemas().GetClass("RulesEngineTest", "ClassH");
    IECInstancePtr instanceH = RulesEngineTestHelpers::InsertInstance(*s_project, *classH, [](IECInstanceR instance)
        {
...
* @bsitest                                      Aidas.Vaiksnoras                11/2017
+---------------+---------------+---------------+---------------+---------------+------*/
TEST_F(CustomFunctionTests, Are2dPointsEqualByValueReturnsFalse)
    {
    ECClassCP classH = s_project->GetECDb().Schemas().GetClass("RulesEngineTest", "ClassH");
    IECInstancePtr instanceH = RulesEngineTestHelpers::InsertInstance(*s_project, *classH, [](IECInstanceR instance)
        {
