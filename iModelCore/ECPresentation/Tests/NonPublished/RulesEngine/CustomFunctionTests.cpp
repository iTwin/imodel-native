...
TEST_F(CustomFunctionTests, GetECInstanceDisplayLabel_UsesLabelOverride)
    ...
    CustomFunctionsContext ctx(*m_schemaHelper, m_connections, *m_connection, *m_ruleset, m_locale, m_rulesetVariables, nullptr, m_schemaHelper->GetECExpressionsCache(), m_nodesFactory, nullptr, nullptr, nullptr);
...
TEST_F(CustomFunctionTests, GetECPropertyDisplayLabel_RangeBased_ReturnsOtherRange)
    ...
    CustomFunctionsContext ctx(*m_schemaHelper, m_connections, *m_connection, *m_ruleset, m_locale, m_rulesetVariables, nullptr, m_schemaHelper->GetECExpressionsCache(), m_nodesFactory, nullptr, nullptr, &query->GetExtendedData());
...
TEST_F(CustomFunctionsManagerTests, ReturnsDifferentContextsOnDifferentThreads)
    ...
    std::thread([&]()
        ...
        CustomFunctionsContext ctx2(*m_schemaHelper, m_connections, *m_connection, *m_ruleset, m_locale, m_rulesetVariables, nullptr, m_schemaHelper->GetECExpressionsCache(), m_nodesFactory, nullptr, nullptr, nullptr);
