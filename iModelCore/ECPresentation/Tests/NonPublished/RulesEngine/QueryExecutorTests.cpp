...
* @bsitest                                      Grigas.Petraitis                04/2020
+---------------+---------------+---------------+---------------+---------------+------*/
TEST_F(QueryExecutorTests, ReadNext_WithResultAsReturnValue_StopsExecutingUponReaderError)
    {
    // insert a couple of widgets
    RulesEngineTestHelpers::InsertInstance(s_project->GetECDb(), *m_widgetClass);
    RulesEngineTestHelpers::InsertInstance(s_project->GetECDb(), *m_widgetClass);
...
* @bsitest                                      Grigas.Petraitis                04/2020
+---------------+---------------+---------------+---------------+---------------+------*/
TEST_F(QueryExecutorTests, ReadNext_WithStatusAsReturnValue_StopsExecutingUponReaderError)
    {
    // insert a couple of widgets
    RulesEngineTestHelpers::InsertInstance(s_project->GetECDb(), *m_widgetClass);
    RulesEngineTestHelpers::InsertInstance(s_project->GetECDb(), *m_widgetClass);
    ...
    EXPECT_EQ(QueryExecutorStatus::Error, executor.ReadNext(value, reader));
    EXPECT_TRUE(executor.IsReadStarted());
    EXPECT_TRUE(executor.IsReadFinished());
    }
