...
TEST_F (NavigationQueryExecutorTests, GetChildNodesOfClassGroupingNode_NotGroupedByLabel)
    ...
    CustomFunctionsContext ctx(*m_schemaHelper, m_connections, *m_connection, *m_ruleset, "locale",
        m_rulesetVariables, nullptr, m_schemaHelper->GetECExpressionsCache(), m_nodesFactory, nullptr, nullptr, &query->GetExtendedData());
    NavigationQueryExecutor executor(m_nodesFactory, *m_connection, "locale", *query);
    executor.ReadRecords();
    ASSERT_EQ(2, executor.GetNodesCount());
...
TEST_F(NavigationQueryExecutorTests, PropertyGroupingByBooleanProperty)
    ...
    CustomFunctionsContext ctx(*m_schemaHelper, m_connections, *m_connection, *m_ruleset, "locale", m_rulesetVariables, nullptr, m_schemaHelper->GetECExpressionsCache(), m_nodesFactory, nullptr, nullptr, &grouped->GetExtendedData());
...
TEST_F(NavigationQueryExecutorTests, SetsGroupedInstanceKeysForBaseClassGroupingNodes)
    ...
    CustomFunctionsContext ctx(*m_schemaHelper, m_connections, *m_connection, *m_ruleset, "locale", m_rulesetVariables, nullptr, m_schemaHelper->GetECExpressionsCache(), m_nodesFactory, nullptr, nullptr, &sorted->GetExtendedData());
...
TEST_F(NavigationQueryExecutorTests, SetsRelatedInstanceKeysForECInstanceNodes)
    ...
    CustomFunctionsContext ctx(*m_schemaHelper, m_connections, *m_connection, *m_ruleset, "locale", m_rulesetVariables, nullptr, m_schemaHelper->GetECExpressionsCache(), m_nodesFactory, nullptr, nullptr, &unionQuery->GetExtendedData());
...
TEST_F(ContentQueryExecutorTests, UsesSuppliedECPropertyFormatterToFormatPrimitiveECPropertyValues)
    ...
    CustomFunctionsContext ctx(*m_schemaHelper, m_connections, *m_connection, *m_ruleset, "locale", m_rulesetVariables, nullptr, m_schemaHelper->GetECExpressionsCache(), m_nodesFactory, nullptr, nullptr, &query->GetExtendedData(), m_propertyFormatter);
    ContentQueryExecutor executor(*m_connection, *query);
