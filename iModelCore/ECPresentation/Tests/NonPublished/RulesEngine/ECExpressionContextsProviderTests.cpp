...
TEST_F(ECExpressionContextsProviderTests, GetNodeRulesContext_RootNode_ParentNodeIsNull)
    {
    ExpressionContextPtr ctx = ECExpressionContextsProvider::GetNodeRulesContext(ECExpressionContextsProvider::NodeRulesContextParameters(nullptr, s_project->GetECDb(), m_userSettings, nullptr));
...
TEST_F (ECExpressionContextsProviderTests, GetNodeRulesContext_ChildNode_ParentNodeIsNotNull)
    {
    TestNavNodePtr navNode = TestNodesHelper::CreateCustomNode("", "TestLabel", "");
    ExpressionContextPtr ctx = ECExpressionContextsProvider::GetNodeRulesContext(ECExpressionContextsProvider::NodeRulesContextParameters(navNode.get(), s_project->GetECDb(), m_userSettings, nullptr));
    Utf8CP expression = "ParentNode.IsNull";
    ECValue resultValue = EvaluateAndGetResult(expression, *ctx);
    ASSERT_TRUE(resultValue.IsBoolean());
...
TEST_F (ECExpressionContextsProviderTests, GetNodeRulesContext_ChildNode_LabelAndDescriptionAreValid)
    {
    TestNavNodePtr navNode = TestNodesHelper::CreateCustomNode("", "MyLabel", "MyDescription");
    ExpressionContextPtr ctx = ECExpressionContextsProvider::GetNodeRulesContext(ECExpressionContextsProvider::NodeRulesContextParameters(navNode.get(), s_project->GetECDb(), m_userSettings, nullptr));
...
TEST_F (ECExpressionContextsProviderTests, GetNodeRulesContext_ChildNode_TypeIsValid)
    {
    TestNavNodePtr navNode = TestNodesHelper::CreateCustomNode("TestType", "MyLabel", "MyDescription");
    ExpressionContextPtr ctx = ECExpressionContextsProvider::GetNodeRulesContext(ECExpressionContextsProvider::NodeRulesContextParameters(navNode.get(), s_project->GetECDb(), m_userSettings, nullptr));
...
TEST_F (ECExpressionContextsProviderTests, GetNodeRulesContext_ChildInstanceNode_IsNodeType)
    {
    IECInstancePtr instance = ECInstanceTestsHelper::CreateInstance("ClassA", GetSchema());
    NavNodePtr navNode = TestNodesHelper::CreateInstanceNode(*instance);
    ExpressionContextPtr ctx = ECExpressionContextsProvider::GetNodeRulesContext(ECExpressionContextsProvider::NodeRulesContextParameters(navNode.get(), s_project->GetECDb(), m_userSettings, nullptr));
...
TEST_F (ECExpressionContextsProviderTests, GetNodeRulesContext_ChildRelationshipClassNode_IsNodeType)
    ...
    NavNodePtr navNode = TestNodesHelper::CreateRelationshipGroupingNode(*rel, "TestLabel");
...
TEST_F (ECExpressionContextsProviderTests, GetNodeRulesContext_ChildClassGroupingNode_IsNodeType)
    {
    NavNodePtr navNode = TestNodesHelper::CreateClassGroupingNode(*GetSchema().GetClassCP("ClassA"), "TestLabel");
    ExpressionContextPtr ctx = ECExpressionContextsProvider::GetNodeRulesContext(ECExpressionContextsProvider::NodeRulesContextParameters(navNode.get(), s_project->GetECDb(), m_userSettings, nullptr));
...
TEST_F (ECExpressionContextsProviderTests, GetNodeRulesContext_ChildPropertyGroupingNode_IsNodeType)
    ...
    NavNodePtr navNode = TestNodesHelper::CreatePropertyGroupingNode(*classA, *prop, "TestLabel", rapidjson::Value(), false);
    ExpressionContextPtr ctx = ECExpressionContextsProvider::GetNodeRulesContext(ECExpressionContextsProvider::NodeRulesContextParameters(navNode.get(), s_project->GetECDb(), m_userSettings, nullptr));
...
TEST_F (ECExpressionContextsProviderTests, GetNodeRulesContext_ClassGroupingNode_IsOfClass)
    {
    NavNodePtr navNode = TestNodesHelper::CreateClassGroupingNode(*GetSchema().GetClassCP("DerivedA"), "TestLabel");
    ExpressionContextPtr ctx = ECExpressionContextsProvider::GetNodeRulesContext(ECExpressionContextsProvider::NodeRulesContextParameters(navNode.get(), s_project->GetECDb(), m_userSettings, nullptr));
...
TEST_F (ECExpressionContextsProviderTests, GetNodeRulesContext_GroupingNode_GroupedInstancesCount)
    ...
    NavNodePtr navNode = TestNodesHelper::CreatePropertyGroupingNode(*classA, *prop, "TestLabel", rapidjson::Value(123), false);
    NavNodeExtendedData navNodeExtendedData(*navNode);
...
TEST_F(ECExpressionContextsProviderTests, GetContentRulesContext_ContentDisplayTypeMatches)
    {
    ECExpressionContextsProvider::ContentRulesContextParameters params("MyContentType", "", false, s_project->GetECDb(), TestNodeLocater(), nullptr, m_userSettings, nullptr);
...
TEST_F(ECExpressionContextsProviderTests, GetContentRulesContext_SelectionProviderNameMatches)
    {
    ECExpressionContextsProvider::ContentRulesContextParameters params("", "MySelectionProvider", false, s_project->GetECDb(), TestNodeLocater(), nullptr, m_userSettings, nullptr);
    ExpressionContextPtr ctx = ECExpressionContextsProvider::GetContentRulesContext(params);
...
TEST_F(ECExpressionContextsProviderTests, GetContentRulesContext_IsSubSelectionMatches)
    {
    ECExpressionContextsProvider::ContentRulesContextParameters params1("", "", false, s_project->GetECDb(), TestNodeLocater(), nullptr, m_userSettings, nullptr);
    ...
    ECExpressionContextsProvider::ContentRulesContextParameters params2("", "", true, s_project->GetECDb(), TestNodeLocater(), nullptr, m_userSettings, nullptr);
