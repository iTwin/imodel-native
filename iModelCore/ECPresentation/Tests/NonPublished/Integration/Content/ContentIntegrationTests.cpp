...
TEST_F(RulesDrivenECPresentationManagerContentTests, ContentInstancesOfSpecificClasses_CalculatedPropertiesValue)
    ...
    IECInstancePtr instance = RulesEngineTestHelpers::InsertInstance(s_project->GetECDb(), *classA, [](IECInstanceR instance)
        ...
        instance.SetValue("DateTimeProperty", ECValue(DateTime(2017, 5, 30)));
        });
    ...
    specification->AddCalculatedProperty(*new CalculatedPropertiesSpecification("dateTimeType", 1000, "this.DateTimeProperty", "dateTime"));
    specification->AddCalculatedProperty(*new CalculatedPropertiesSpecification("longType", 1000, "123456789876*1", "long"));
    ...
    ContentDescriptorCPtr descriptor = GetValidatedResponse(m_manager->GetContentDescriptor(AsyncContentDescriptorRequestParams::Create(s_project->GetECDb(), rules->GetRuleSetId(), RulesetVariables(), nullptr, 0, *KeySet::Create())));
    ASSERT_TRUE(descriptor.IsValid());
    ASSERT_EQ(14, descriptor->GetVisibleFields().size());
    ...
    ASSERT_TRUE(descriptor->GetVisibleFields()[10]->IsCalculatedPropertyField());
    ASSERT_TRUE(descriptor->GetVisibleFields()[11]->IsCalculatedPropertyField());
    ASSERT_TRUE(descriptor->GetVisibleFields()[12]->IsCalculatedPropertyField());
    ASSERT_TRUE(descriptor->GetVisibleFields()[13]->IsCalculatedPropertyField());

    EXPECT_STREQ("instance id", descriptor->GetVisibleFields()[2]->AsCalculatedPropertyField()->GetLabel().c_str());
    EXPECT_STREQ("class id", descriptor->GetVisibleFields()[3]->AsCalculatedPropertyField()->GetLabel().c_str());
    EXPECT_STREQ("label1", descriptor->GetVisibleFields()[4]->AsCalculatedPropertyField()->GetLabel().c_str());
    EXPECT_STREQ("label2", descriptor->GetVisibleFields()[5]->AsCalculatedPropertyField()->GetLabel().c_str());
    EXPECT_STREQ("label3", descriptor->GetVisibleFields()[6]->AsCalculatedPropertyField()->GetLabel().c_str());
    EXPECT_STREQ("noValueLabel", descriptor->GetVisibleFields()[7]->AsCalculatedPropertyField()->GetLabel().c_str());
    EXPECT_STREQ("integerType", descriptor->GetVisibleFields()[8]->AsCalculatedPropertyField()->GetLabel().c_str());
    EXPECT_STREQ("booleanType", descriptor->GetVisibleFields()[9]->AsCalculatedPropertyField()->GetLabel().c_str());
    EXPECT_STREQ("doubleType", descriptor->GetVisibleFields()[10]->AsCalculatedPropertyField()->GetLabel().c_str());
    EXPECT_STREQ("stringValue", descriptor->GetVisibleFields()[11]->AsCalculatedPropertyField()->GetLabel().c_str());
    EXPECT_STREQ("dateTimeType", descriptor->GetVisibleFields()[12]->AsCalculatedPropertyField()->GetLabel().c_str());
    EXPECT_STREQ("longType", descriptor->GetVisibleFields()[13]->AsCalculatedPropertyField()->GetLabel().c_str());

    EXPECT_EQ(1000, descriptor->GetVisibleFields()[2]->GetPriority());
    EXPECT_EQ(1000, descriptor->GetVisibleFields()[3]->GetPriority());
    EXPECT_EQ(1000, descriptor->GetVisibleFields()[4]->GetPriority());
    EXPECT_EQ(1100, descriptor->GetVisibleFields()[5]->GetPriority());
    EXPECT_EQ(1200, descriptor->GetVisibleFields()[6]->GetPriority());
    EXPECT_EQ(1000, descriptor->GetVisibleFields()[7]->GetPriority());
    EXPECT_EQ(1000, descriptor->GetVisibleFields()[8]->GetPriority());
    EXPECT_EQ(1000, descriptor->GetVisibleFields()[9]->GetPriority());
    EXPECT_EQ(1000, descriptor->GetVisibleFields()[10]->GetPriority());
    EXPECT_EQ(1000, descriptor->GetVisibleFields()[11]->GetPriority());
    EXPECT_EQ(1000, descriptor->GetVisibleFields()[12]->GetPriority());
    EXPECT_EQ(1000, descriptor->GetVisibleFields()[13]->GetPriority());

    EXPECT_EQ(PRIMITIVETYPE_String, descriptor->GetVisibleFields()[2]->AsCalculatedPropertyField()->GetType());
    EXPECT_EQ(PRIMITIVETYPE_String, descriptor->GetVisibleFields()[3]->AsCalculatedPropertyField()->GetType());
    EXPECT_EQ(PRIMITIVETYPE_String, descriptor->GetVisibleFields()[4]->AsCalculatedPropertyField()->GetType());
    EXPECT_EQ(PRIMITIVETYPE_String, descriptor->GetVisibleFields()[5]->AsCalculatedPropertyField()->GetType());
    EXPECT_EQ(PRIMITIVETYPE_String, descriptor->GetVisibleFields()[6]->AsCalculatedPropertyField()->GetType());
    EXPECT_EQ(PRIMITIVETYPE_String, descriptor->GetVisibleFields()[7]->AsCalculatedPropertyField()->GetType());
    EXPECT_EQ(PRIMITIVETYPE_Integer, descriptor->GetVisibleFields()[8]->AsCalculatedPropertyField()->GetType());
    EXPECT_EQ(PRIMITIVETYPE_Boolean, descriptor->GetVisibleFields()[9]->AsCalculatedPropertyField()->GetType());
    EXPECT_EQ(PRIMITIVETYPE_Double, descriptor->GetVisibleFields()[10]->AsCalculatedPropertyField()->GetType());
    EXPECT_EQ(PRIMITIVETYPE_String, descriptor->GetVisibleFields()[11]->AsCalculatedPropertyField()->GetType());
    EXPECT_EQ(PRIMITIVETYPE_DateTime, descriptor->GetVisibleFields()[12]->AsCalculatedPropertyField()->GetType());
    EXPECT_EQ(PRIMITIVETYPE_Long, descriptor->GetVisibleFields()[13]->AsCalculatedPropertyField()->GetType());
...
* @bsitest
+---------------+---------------+---------------+---------------+---------------+------*/
DEFINE_SCHEMA(ContentInstancesOfSpecificClassesSpecification_ContentModifierAppliesCalculatedPropertiesOnNestedContentProperties, R"*(
    <ECEntityClass typeName="A">
    </ECEntityClass>
    <ECEntityClass typeName="B">
        <ECProperty propertyName="PropertyB" typeName="string" />
...
TEST_F(RulesDrivenECPresentationManagerContentTests, ContentInstancesOfSpecificClassesSpecification_ContentModifierAppliesCalculatedPropertiesOnNestedContentProperties)
    {
    // set up data set
    ECClassCP classA = GetClass("A");
    ECClassCP classB = GetClass("B");
    ...
    IECInstancePtr instanceC = RulesEngineTestHelpers::InsertInstance(s_project->GetECDb(), *classC, [](IECInstanceR instance) {instance.SetValue("PropertyC", ECValue("InstanceC")); });

    RulesEngineTestHelpers::InsertRelationship(s_project->GetECDb(), *relationshipAHasB, *instanceA, *instanceB);
    RulesEngineTestHelpers::InsertRelationship(s_project->GetECDb(), *relationshipAHasC, *instanceA, *instanceC);
    ...
    ContentModifierP relatedPropertiesModifier = new ContentModifier(GetSchema()->GetName(), classA->GetName());
    rules->AddPresentationRule(*relatedPropertiesModifier);
    relatedPropertiesModifier->AddRelatedProperty(*new RelatedPropertiesSpecification(*new RelationshipPathSpecification(
        {
    ...
    relatedPropertiesModifier->AddRelatedProperty(*new RelatedPropertiesSpecification(*new RelationshipPathSpecification(
        {
        new RelationshipStepSpecification(relationshipAHasC->GetFullName(), RequiredRelationDirection_Forward, classC->GetFullName())
        }), { new PropertySpecification("*") }, RelationshipMeaning::RelatedInstance));
    ...
    rules->AddPresentationRule(*contentRule);
    rules->AddPresentationRule(*calculatedPropertiesModifierApplyOnNestedB);
    rules->AddPresentationRule(*calculatedPropertiesModifierApplyOnNestedC);
    ...
    rapidjson::Document jsonDoc = contentSet.Get(0)->AsJson();
    RapidJsonValueCR jsonValues = jsonDoc["Values"];
    EXPECT_STREQ("InstanceC", jsonValues[NESTED_CONTENT_FIELD_NAME(classA, classC)][0]["Values"]["CalculatedProperty_0"].GetString());
    }

/*---------------------------------------------------------------------------------**//**
* @bsitest
+---------------+---------------+---------------+---------------+---------------+------*/
DEFINE_SCHEMA(SelectedNodeInstancesSpecification_ContentModifierAppliesCalculatedPropertiesOnNestedContentProperties_WithMergedUnrelatedInstances, R"*(
    <ECEntityClass typeName="A">
        <ECCustomAttributes>
            <ClassMap xmlns="ECDbMap.02.00">
                <MapStrategy>TablePerHierarchy</MapStrategy>
...
TEST_F(RulesDrivenECPresentationManagerContentTests, SelectedNodeInstancesSpecification_ContentModifierAppliesCalculatedPropertiesOnNestedContentProperties_WithMergedUnrelatedInstances)
    ...
    IECInstancePtr a1 = RulesEngineTestHelpers::InsertInstance(s_project->GetECDb(), *classA1, [](IECInstanceR instance) {});
    IECInstancePtr a2 = RulesEngineTestHelpers::InsertInstance(s_project->GetECDb(), *classA2, [](IECInstanceR instance) {});
    IECInstancePtr b = RulesEngineTestHelpers::InsertInstance(s_project->GetECDb(), *classB, [](IECInstanceR instance) {instance.SetValue("PropertyB", ECValue("InstanceB")); });
    RulesEngineTestHelpers::InsertRelationship(s_project->GetECDb(), *relationshipAHasB, *a1, *b);
    ...
    ContentModifierP relatedPropertiesModifier = new ContentModifier(GetSchema()->GetName(), classA1->GetName());
    relatedPropertiesModifier->AddRelatedProperty(*new RelatedPropertiesSpecification(*new RelationshipPathSpecification(
        {
        new RelationshipStepSpecification(relationshipAHasB->GetFullName(), RequiredRelationDirection_Forward, classB->GetFullName())
    ...
    ContentDescriptorCPtr descriptor = GetValidatedResponse(m_manager->GetContentDescriptor(AsyncContentDescriptorRequestParams::Create(s_project->GetECDb(), rules->GetRuleSetId(), RulesetVariables(), nullptr, 0, *keys)));
    ASSERT_TRUE(descriptor.IsValid());
    EXPECT_EQ(1, descriptor->GetVisibleFields().size());
    EXPECT_EQ(2, descriptor->GetVisibleFields()[0]->AsNestedContentField()->GetFields().size());
    ...
    DataContainer<ContentSetItemCPtr> contentSet = content->GetContentSet();
    rapidjson::Document jsonA1 = contentSet.Get(0)->AsJson();
    EXPECT_STREQ("InstanceB", jsonA1["Values"][relatedContentField->GetUniqueName().c_str()][0]["Values"][calculatedField->GetUniqueName().c_str()].GetString());

    rapidjson::Document jsonA2 = contentSet.Get(1)->AsJson();
    EXPECT_TRUE(jsonA2["Values"][relatedContentField->GetUniqueName().c_str()].Empty());
    }

/*---------------------------------------------------------------------------------**//**
* @bsitest
+---------------+---------------+---------------+---------------+---------------+------*/
DEFINE_SCHEMA(SelectedNodeInstancesSpecification_ContentModifierAppliesRelatedPropertiesOnNestedContentProperties_WithMergedUnrelatedInstances, R"*(
    <ECEntityClass typeName="A">
        <ECCustomAttributes>
            <ClassMap xmlns="ECDbMap.02.00">
                <MapStrategy>TablePerHierarchy</MapStrategy>
...
TEST_F(RulesDrivenECPresentationManagerContentTests, SelectedNodeInstancesSpecification_ContentModifierAppliesRelatedPropertiesOnNestedContentProperties_WithMergedUnrelatedInstances)
    ...
    IECInstancePtr a2 = RulesEngineTestHelpers::InsertInstance(s_project->GetECDb(), *classA2, [](IECInstanceR instance) {});
    IECInstancePtr b = RulesEngineTestHelpers::InsertInstance(s_project->GetECDb(), *classB, [](IECInstanceR instance) {instance.SetValue("PropertyB", ECValue("InstanceB")); });
    IECInstancePtr c = RulesEngineTestHelpers::InsertInstance(s_project->GetECDb(), *classC, [](IECInstanceR instance) {instance.SetValue("PropertyC", ECValue("InstanceC")); });
    RulesEngineTestHelpers::InsertRelationship(s_project->GetECDb(), *relationshipAHasB, *a1, *b);
    RulesEngineTestHelpers::InsertRelationship(s_project->GetECDb(), *relationshipBHasC, *b, *c);
    ...
    ContentModifierP relatedPropertiesModifierAB = new ContentModifier(GetSchema()->GetName(), classA1->GetName());
    relatedPropertiesModifierAB->AddRelatedProperty(*new RelatedPropertiesSpecification(*new RelationshipPathSpecification(
        {
        new RelationshipStepSpecification(relationshipAHasB->GetFullName(), RequiredRelationDirection_Forward, classB->GetFullName())
        }), { new PropertySpecification("*") }, RelationshipMeaning::RelatedInstance, true));
    rules->AddPresentationRule(*relatedPropertiesModifierAB);

    ContentModifierP relatedPropertiesModifierBC = new ContentModifier(GetSchema()->GetName(), classB->GetName());
    relatedPropertiesModifierBC->AddRelatedProperty(*new RelatedPropertiesSpecification(*new RelationshipPathSpecification(
        {
        new RelationshipStepSpecification(relationshipBHasC->GetFullName(), RequiredRelationDirection_Forward, classC->GetFullName())
        }), { new PropertySpecification("*") }, RelationshipMeaning::RelatedInstance, true));
    relatedPropertiesModifierBC->SetApplyOnNestedContent(true);
    rules->AddPresentationRule(*relatedPropertiesModifierBC);
    ...
    ContentDescriptor::Field* relatedContentFieldAB = descriptor->GetVisibleFields()[0];
    EXPECT_STREQ("B", relatedContentFieldAB->GetLabel().c_str());

    ContentDescriptor::Field* relatedContentFieldBC = relatedContentFieldAB->AsNestedContentField()->GetFields()[1];
    EXPECT_STREQ("C", relatedContentFieldBC->GetLabel().c_str());
    ...
    DataContainer<ContentSetItemCPtr> contentSet = content->GetContentSet();
    rapidjson::Document jsonA1 = contentSet.Get(0)->AsJson();
    EXPECT_STREQ("InstanceC", jsonA1["Values"][relatedContentFieldAB->GetUniqueName().c_str()][0]["Values"][relatedContentFieldBC->GetUniqueName().c_str()][0]["Values"][FIELD_NAME(classC, "PropertyC")].GetString());

    rapidjson::Document jsonA2 = contentSet.Get(1)->AsJson();
    EXPECT_TRUE(jsonA2["Values"][relatedContentFieldAB->GetUniqueName().c_str()].Empty());
    }

/*---------------------------------------------------------------------------------**//**
* @bsitest
+---------------+---------------+---------------+---------------+---------------+------*/
DEFINE_SCHEMA(ContentInstancesOfSpecificClassesSpecification_ContentModifierAppliesRelatedPropertiesOnNestedContentProperties, R"*(
    <ECEntityClass typeName="A">
    </ECEntityClass>
    <ECEntityClass typeName="B">
    </ECEntityClass>
...
TEST_F(RulesDrivenECPresentationManagerContentTests, ContentInstancesOfSpecificClassesSpecification_ContentModifierAppliesRelatedPropertiesOnNestedContentProperties)
    {
    // set up data set
    ECClassCP classA = GetClass("A");
    ECClassCP classB = GetClass("B");
    ...
    ASSERT_TRUE(descriptor.IsValid());
    EXPECT_EQ(1, descriptor->GetVisibleFields().size()); // A -> B
    EXPECT_EQ(classB->GetName(), descriptor->GetVisibleFields()[0]->GetLabel());
    auto fieldsB = descriptor->GetVisibleFields()[0]->AsNestedContentField()->GetFields();
    EXPECT_EQ(1, fieldsB.size()); // B -> C
    EXPECT_EQ(classC->GetName(), fieldsB[0]->GetLabel());
    auto fieldsC = fieldsB[0]->AsNestedContentField()->GetFields();
...
TEST_F(RulesDrivenECPresentationManagerContentTests, ContentInstancesOfSpecificClassesSpecification_RecursiveContentModifiersGetAppliedOnNestedContentProperties)
    ...
    ContentModifierP relatedPropertiesModifierBtoA = new ContentModifier(GetSchema()->GetName(), classB->GetName());
    relatedPropertiesModifierBtoA->AddRelatedProperty(*new RelatedPropertiesSpecification(*new RelationshipPathSpecification(
        {
        new RelationshipStepSpecification(relationshipAHasB->GetFullName(), RequiredRelationDirection_Backward, classA->GetFullName())
        }), { new PropertySpecification("*") }, RelationshipMeaning::RelatedInstance));
    relatedPropertiesModifierBtoA->SetApplyOnNestedContent(true);

    rules->AddPresentationRule(*contentRule);
    rules->AddPresentationRule(*relatedPropertiesModifierAtoB);
    rules->AddPresentationRule(*relatedPropertiesModifierBtoA);
    ...
    EXPECT_EQ(classB->GetName(), descriptor->GetVisibleFields()[0]->GetLabel());
    auto fieldsB = descriptor->GetVisibleFields()[0]->AsNestedContentField()->GetFields();
    EXPECT_EQ(2, fieldsB.size()); // backward A -> B and PropertyB
    EXPECT_STREQ("PropertyB", fieldsB[0]->GetLabel().c_str());
    EXPECT_EQ(classA->GetName(), fieldsB[1]->GetLabel());
    auto nestedFieldsA = fieldsB[1]->AsNestedContentField()->GetFields();
    EXPECT_EQ(1, nestedFieldsA.size()); // A -> B
    EXPECT_EQ(classB->GetName(), nestedFieldsA[0]->GetLabel());
    auto nestedFieldsB = nestedFieldsA[0]->AsNestedContentField()->GetFields();
    EXPECT_EQ(1, nestedFieldsB.size()); // PropertyB
    EXPECT_STREQ("PropertyB", nestedFieldsB[0]->GetLabel().c_str());

    RapidJsonValueCR propertyB = jsonValues[NESTED_CONTENT_FIELD_NAME(classA, classB)][0]["Values"];
    EXPECT_STREQ("InstanceB", propertyB[FIELD_NAME(classB, "PropertyB")].GetString());
    RapidJsonValueCR nestedPropertyA = propertyB[NESTED_CONTENT_FIELD_NAME(classB, classA)][0]["Values"];
    EXPECT_STREQ("InstanceB", nestedPropertyA[NESTED_CONTENT_FIELD_NAME_C(classA, classB, 2)][0]["Values"][FIELD_NAME_C(classB, "PropertyB", 2)].GetString());
    }

/*---------------------------------------------------------------------------------**//**
* @bsitest
+---------------+---------------+---------------+---------------+---------------+------*/
DEFINE_SCHEMA(ContentInstancesOfSpecificClassesSpecification_ContentModifierShouldNotAddRelatedPropertiesOnNestedContentWhenNotAllPropertiesIncluded, R"*(
    <ECEntityClass typeName="A">
    </ECEntityClass>
    <ECEntityClass typeName="B">
        <ECProperty propertyName="PropertyB" typeName="string" />
...
TEST_F(RulesDrivenECPresentationManagerContentTests, ContentInstancesOfSpecificClassesSpecification_ContentModifierShouldNotAddRelatedPropertiesOnNestedContentWhenNotAllPropertiesIncluded)
    {
    // set up data set
    ECClassCP classA = GetClass("A");
    ECClassCP classB = GetClass("B");
...
* @bsitest
+---------------+---------------+---------------+---------------+---------------+------*/
DEFINE_SCHEMA(ContentInstancesOfSpecificClassesSpecification_GetsRelatedLabelWithAppendedValueThroughCalculatedProperty, R"*(
    <ECEntityClass typeName="A">
        <ECProperty propertyName="UserLabel" typeName="string" />
    </ECEntityClass>
    <ECEntityClass typeName="B">
...
TEST_F(RulesDrivenECPresentationManagerContentTests, ContentInstancesOfSpecificClassesSpecification_GetsRelatedLabelWithAppendedValueThroughCalculatedProperty)
    {
    ECClassCP classA = GetClass("A");
    ECClassCP classB = GetClass("B");
    ECRelationshipClassCP relationshipAHasB = GetClass("A_Has_B")->GetRelationshipClassCP();
    ...
    ContentModifierP modifier = new ContentModifier(GetSchema()->GetName(), "A");
    rules->AddPresentationRule(*modifier);
    modifier->AddCalculatedProperty(*new CalculatedPropertiesSpecification("label", 1200, Utf8PrintfString("this.GetRelatedDisplayLabel(\"%s\", \"Forward\", \"%s\") & \"_AppendedValue\"", relationshipAHasB->GetFullName(), classB->GetFullName())));
    ...
    RapidJsonValueCR jsonValues = jsonDoc["Values"];
    EXPECT_STREQ("A_UserLabel", jsonValues[FIELD_NAME(classA, "UserLabel")].GetString());
    EXPECT_STREQ("B_UserLabel_AppendedValue", jsonValues["CalculatedProperty_0"].GetString());
    }
...
TEST_F(RulesDrivenECPresentationManagerContentTests, LoadsPrimitiveArrayPropertyValue)
    ...
    rapidjson::Document actualArrayFieldType = arrayField->GetTypeDescription().AsJson();
    EXPECT_EQ(expectedArrayFieldType, actualArrayFieldType)
        << "Expected: \r\n" << BeRapidJsonUtilities::ToPrettyString(expectedArrayFieldType) << "\r\n"
        << "Actual: \r\n" << BeRapidJsonUtilities::ToPrettyString(actualArrayFieldType);

    rapidjson::Document expectedArrayItemsFieldType;
    expectedArrayItemsFieldType.Parse(Utf8PrintfString(R"({
        "ValueFormat": "Primitive",
        "TypeName": "int"
        })").c_str());
    rapidjson::Document actualArrayItemsFieldType = arrayField->GetItemsField().GetTypeDescription().AsJson();
    EXPECT_EQ(expectedArrayItemsFieldType, actualArrayItemsFieldType)
        << "Expected: \r\n" << BeRapidJsonUtilities::ToPrettyString(expectedArrayItemsFieldType) << "\r\n"
        << "Actual: \r\n" << BeRapidJsonUtilities::ToPrettyString(actualArrayItemsFieldType);
...
* @bsitest
+---------------+---------------+---------------+---------------+---------------+------*/
DEFINE_SCHEMA(AssignsRendererAndEditorOverridesToDirectPrimitiveArrayItemsField, R"*(
    <ECEntityClass typeName="MyClass">
        <ECArrayProperty propertyName="ArrayProperty" typeName="int" />
    </ECEntityClass>
)*");
TEST_F(RulesDrivenECPresentationManagerContentTests, AssignsRendererAndEditorOverridesToDirectPrimitiveArrayItemsField)
    {
    // set up data set
    ECClassCP ecClass = GetClass("MyClass");
    ...
    auto modifier = new ContentModifier(ecClass->GetSchema().GetName(), ecClass->GetName());
    modifier->AddPropertyOverride(*new PropertySpecification("ArrayProperty[*]", 1000, "", nullptr, nullptr,
        new CustomRendererSpecification("test renderer"), new PropertyEditorSpecification("test editor")));
    rules->AddPresentationRule(*modifier);
    ...
    auto const& itemsField = arrayField->GetItemsField();
    EXPECT_STREQ("test renderer", itemsField.GetRenderer()->GetName().c_str());
    EXPECT_STREQ("test editor", itemsField.GetEditor()->GetName().c_str());
    }

/*---------------------------------------------------------------------------------**//**
* @bsitest
+---------------+---------------+---------------+---------------+---------------+------*/
DEFINE_SCHEMA(AssignsRendererAndEditorOverridesToRelatedPrimitiveArrayItemsField, R"*(
    <ECEntityClass typeName="A">
        <ECArrayProperty propertyName="ArrayProperty" typeName="int" />
    </ECEntityClass>
    <ECEntityClass typeName="B" />
...
TEST_F(RulesDrivenECPresentationManagerContentTests, AssignsRendererAndEditorOverridesToRelatedPrimitiveArrayItemsField)
    {
    // set up data set
...
TEST_F(RulesDrivenECPresentationManagerContentTests, LoadsStructPropertyValue)
    ...
    ASSERT_TRUE(descriptor.IsValid());
    ASSERT_EQ(1, descriptor->GetVisibleFields().size());
    auto structField = descriptor->GetVisibleFields()[0]->AsPropertiesField()->AsStructPropertiesField();
    rapidjson::Document expectedFieldType;
    expectedFieldType.Parse(Utf8PrintfString(R"({
        "ValueFormat": "Struct",
        "TypeName": "MyStruct",
    ...
    rapidjson::Document actualFieldType = structField->GetTypeDescription().AsJson();
    EXPECT_EQ(expectedFieldType, actualFieldType)
        << "Expected: \r\n" << BeRapidJsonUtilities::ToPrettyString(expectedFieldType) << "\r\n"
        << "Actual: \r\n" << BeRapidJsonUtilities::ToPrettyString(actualFieldType);

    ASSERT_EQ(2, structField->GetMembers().size());
    auto const& intPropertyField = structField->GetMembers()[0];
    EXPECT_STREQ("IntProperty", intPropertyField->GetUniqueName().c_str());
    auto const& stringPropertyField = structField->GetMembers()[1];
    EXPECT_STREQ("StringProperty", stringPropertyField->GetUniqueName().c_str());
...
* @bsitest
+---------------+---------------+---------------+---------------+---------------+------*/
DEFINE_SCHEMA(AssignsRendererAndEditorOverridesToDirectStructPropertyFields, R"*(
    <ECStructClass typeName="MyStruct">
        <ECProperty propertyName="IntProperty" typeName="int" />
    </ECStructClass>
    <ECEntityClass typeName="MyClass">
...
TEST_F(RulesDrivenECPresentationManagerContentTests, AssignsRendererAndEditorOverridesToDirectStructPropertyFields)
    {
    // set up data set
...
* @bsitest
+---------------+---------------+---------------+---------------+---------------+------*/
DEFINE_SCHEMA(AssignsRendererAndEditorOverridesToRelatedStructPropertyFields, R"*(
    <ECStructClass typeName="MyStruct">
        <ECProperty propertyName="IntProperty" typeName="int" />
    </ECStructClass>
    <ECEntityClass typeName="A">
...
TEST_F(RulesDrivenECPresentationManagerContentTests, AssignsRendererAndEditorOverridesToRelatedStructPropertyFields)
    {
    // set up data set
    ECClassCP structClass = GetClass("MyStruct");
    ECClassCP classA = GetClass("A");
    ...
    auto structField = relatedContentField->GetFields()[0]->AsPropertiesField()->AsStructPropertiesField();
    EXPECT_TRUE(structField->GetRenderer() == nullptr);
    EXPECT_TRUE(structField->GetEditor() == nullptr);
...
TEST_F(RulesDrivenECPresentationManagerContentTests, LoadsStructArrayPropertyValue)
    ...
    rapidjson::Document actualFieldType = arrayField->GetTypeDescription().AsJson();
    EXPECT_EQ(expectedFieldType, actualFieldType)
        << "Expected: \r\n" << BeRapidJsonUtilities::ToPrettyString(expectedFieldType) << "\r\n"
        << "Actual: \r\n" << BeRapidJsonUtilities::ToPrettyString(actualFieldType);
...
TEST_F(RulesDrivenECPresentationManagerContentTests, LoadsStructWithArrayPropertyValue)
    ...
    ASSERT_EQ(1, structField->GetMembers().size());
    auto arrayField = structField->GetMembers()[0]->AsArrayPropertiesField();
    EXPECT_STREQ("IntProperty", arrayField->GetUniqueName().c_str());
    auto const& arrayItemsField = arrayField->GetItemsField();
    EXPECT_STREQ("int", arrayItemsField.GetTypeDescription().GetTypeName().c_str());
...
// @betest
+---------------+---------------+---------------+---------------+---------------+------*/
DEFINE_SCHEMA(SortingRule_SortingByECClassIdProperty, R"*(
    <ECEntityClass typeName="A" />
    <ECEntityClass typeName="B">
        <BaseClass>A</BaseClass>
    </ECEntityClass>
...
TEST_F(RulesDrivenECPresentationManagerContentTests, SortingRule_SortingByECClassIdProperty)
    {
    ECClassCP classA = GetClass("A");
    ECClassCP classB = GetClass("B");
    ECClassCP classC = GetClass("C");
    ...
    contentRule->AddSpecification(*new ContentInstancesOfSpecificClassesSpecification(1, "", classA->GetFullName(), true, false));
    rules->AddPresentationRule(*contentRule);
    rules->AddPresentationRule(*new SortingRule("", 1, classA->GetSchema().GetName(), classA->GetName(), "ECClassId", false, false, true));
    m_locater->AddRuleSet(*rules);
    ...
    ContentCPtr content = GetVerifiedContent(*descriptor);
    RulesEngineTestHelpers::ValidateContentSet(bvector<IECInstanceCP>{c.get(), b.get(), a.get()}, *content, true);
    }
...
* @bsitest
+---------------+---------------+---------------+---------------+---------------+------*/
DEFINE_SCHEMA(GetContentForDisplayLabelGroupingNode, R"*(
    <ECEntityClass typeName="A" />
    <ECEntityClass typeName="B">
        <BaseClass>A</BaseClass>
        <ECProperty propertyName="PropB" typeName="int" />
...
* @bsitest
+---------------+---------------+---------------+---------------+---------------+------*/
DEFINE_SCHEMA(GetContentForDisplayLabelGroupingNode_WithMultipleRulesets, R"*(
    <ECEntityClass typeName="A" />
    <ECEntityClass typeName="B">
        <BaseClass>A</BaseClass>
        <ECProperty propertyName="PropB" typeName="int" />
...
TEST_F(RulesDrivenECPresentationManagerContentTests, GetContentForDisplayLabelGroupingNode_WithMultipleRulesets)
    {
    ECClassCP classA = GetClass("A");
    ECClassCP classB = GetClass("B");
    ECClassCP classC = GetClass("C");
