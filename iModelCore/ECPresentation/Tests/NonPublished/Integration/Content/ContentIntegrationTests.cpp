...
// @betest
+---------------+---------------+---------------+---------------+---------------+------*/
DEFINE_SCHEMA(ContentInstancesOfSpecificClassesSpecification_DescriptorInstanceFilter_UsesUnrelatedClassProperty, R"*(
    <ECEntityClass typeName="A">
        <ECProperty propertyName="IntPropA" typeName="int"/>
    </ECEntityClass>
    <ECEntityClass typeName="B">
...
TEST_F(RulesDrivenECPresentationManagerContentTests, ContentInstancesOfSpecificClassesSpecification_DescriptorInstanceFilter_UsesUnrelatedClassProperty)
    {
    // set up data set
    ECClassCP classA = GetClass("A");
    ECClassCP classB = GetClass("B");
...
// @betest
+---------------+---------------+---------------+---------------+---------------+------*/
DEFINE_SCHEMA(ContentInstancesOfSpecificClassesSpecification_DescriptorInstanceFilter_UsesRelatedInsanceProperty, R"*(
    <ECEntityClass typeName="A">
        <ECProperty propertyName="IntPropA" typeName="int"/>
    </ECEntityClass>
    <ECEntityClass typeName="B">
...
TEST_F(RulesDrivenECPresentationManagerContentTests, ContentInstancesOfSpecificClassesSpecification_DescriptorInstanceFilter_UsesRelatedInsanceProperty)
    {
    // set up data set
    ECClassCP classA = GetClass("A");
    ECClassCP classB = GetClass("B");
...
// @betest
+---------------+---------------+---------------+---------------+---------------+------*/
DEFINE_SCHEMA(ContentInstancesOfSpecificClassesSpecification_DescriptorInstanceFilter_UsesDerivedClassRelatedProperty, R"*(
    <ECEntityClass typeName="A">
        <ECCustomAttributes>
            <ClassMap xmlns="ECDbMap.02.00">
                <MapStrategy>TablePerHierarchy</MapStrategy>
...
TEST_F(RulesDrivenECPresentationManagerContentTests, ContentInstancesOfSpecificClassesSpecification_DescriptorInstanceFilter_UsesDerivedClassRelatedProperty)
    {
    // set up data set
    ECClassCP classA = GetClass("A");
    ECClassCP classB = GetClass("B");
