...
* @bsitest
+---------------+---------------+---------------+---------------+---------------+------*/
DEFINE_SCHEMA(LoadsXToManyRelatedInstancesAsArrays_WithCustomDisplayLabels, R"*(
    <ECEntityClass typeName="ChildClass1">
        <ECNavigationProperty propertyName="Parent" relationshipName="ParentHasChildren1" direction="Backward" />
    </ECEntityClass>
    <ECEntityClass typeName="ChildClass2">
...
TEST_F(RulesDrivenECPresentationManagerContentTests, LoadsXToManyRelatedInstancesAsArrays_WithCustomDisplayLabels)
    ...
    auto spec = new ContentInstancesOfSpecificClassesSpecification(1, "", parentClass->GetFullName(), false, false);
    spec->AddRelatedProperty(*new RelatedPropertiesSpecification(RequiredRelationDirection_Forward, rel1->GetFullName(),
        childClass1->GetFullName(), "*", RelationshipMeaning::RelatedInstance));
    spec->AddRelatedProperty(*new RelatedPropertiesSpecification(RequiredRelationDirection_Forward, rel2->GetFullName(),
        childClass2->GetFullName(), "*", RelationshipMeaning::RelatedInstance));
    ...
    rules->AddPresentationRule(*new InstanceLabelOverride(1, false, childClass1->GetFullName(), {new InstanceLabelOverrideClassNameValueSpecification()}));
    rules->AddPresentationRule(*new InstanceLabelOverride(1, false, childClass2->GetFullName(), {new InstanceLabelOverrideClassNameValueSpecification()}));
    ...
    expectedValues.Parse(Utf8PrintfString(R"({
        ...
        NESTED_CONTENT_FIELD_NAME(parentClass, childClass1),
        childClass1->GetName().c_str(), childClass1->GetName().c_str(),
        childClass1->GetId().ToString().c_str(), child1->GetInstanceId().c_str(),
        FIELD_NAME(childClass1, "Parent"), parent->GetClass().GetId().ToString().c_str(), parent->GetInstanceId().c_str(), GetNavigationPropertyTargetLabel().c_str(),
        FIELD_NAME(childClass1, "Parent"), CommonStrings::LABEL_NOTSPECIFIED,
...
* @bsitest
+---------------+---------------+---------------+---------------+---------------+------*/
DEFINE_SCHEMA(LoadsXToManyToManyRelatedNestedInstances_WithOneIntermediateInstance, R"*(
    <ECEntityClass typeName="A" />
    <ECEntityClass typeName="B">
        <ECProperty propertyName="PropB" typeName="int" />
    </ECEntityClass>
...
TEST_F(RulesDrivenECPresentationManagerContentTests, LoadsXToManyToManyRelatedNestedInstances_WithOneIntermediateInstance)
    {
    ...
    IECInstancePtr b1 = RulesEngineTestHelpers::InsertInstance(s_project->GetECDb(), *classB, [&](IECInstanceR instance)
        {
        instance.SetValue("PropB", ECValue(1));
        });
    IECInstancePtr c11 = RulesEngineTestHelpers::InsertInstance(s_project->GetECDb(), *classC, [&](IECInstanceR instance)
        {
        instance.SetValue("PropC", ECValue(11));
        });
    IECInstancePtr c12 = RulesEngineTestHelpers::InsertInstance(s_project->GetECDb(), *classC, [&](IECInstanceR instance)
        {
        instance.SetValue("PropC", ECValue(12));
        });
    ...
    auto bField = ContainerHelpers::FindFirst<ContentDescriptor::Field const*>(descriptor->GetAllFields(), [&](auto const& f) -> bool
        {
        return f->GetLabel().Equals(classB->GetDisplayLabel());
        });
    ASSERT_TRUE(bField != nullptr);
    ASSERT_TRUE(bField->IsNestedContentField());

    auto cField = ContainerHelpers::FindFirst<ContentDescriptor::Field const*>(bField->AsNestedContentField()->GetFields(), [&](auto const& f) -> bool
        {
        return f->GetLabel().Equals(classC->GetDisplayLabel());
        });
    ASSERT_TRUE(cField != nullptr);
    ASSERT_TRUE(cField->IsNestedContentField());
    ...
    expectedValues.Parse(Utf8PrintfString(R"({
        ...
        FIELD_NAME(classB, "PropB"),
        NESTED_CONTENT_FIELD_NAME(classB, classC),
        classC->GetId().ToString().c_str(), c11->GetInstanceId().c_str(),
        FIELD_NAME(classC, "PropC"), FIELD_NAME(classC, "PropC"),
        classC->GetId().ToString().c_str(), c12->GetInstanceId().c_str(),
        FIELD_NAME(classC, "PropC"), FIELD_NAME(classC, "PropC"),
        FIELD_NAME(classB, "PropB"),
        NESTED_CONTENT_FIELD_NAME(classB, classC),
        FIELD_NAME(classC, "PropC"), FIELD_NAME(classC, "PropC")
...
* @bsitest
+---------------+---------------+---------------+---------------+---------------+------*/
DEFINE_SCHEMA(LoadsXToManyToManyRelatedNestedInstances_WithMultipleIntermediateInstances, R"*(
    <ECEntityClass typeName="A" />
    <ECEntityClass typeName="B">
        <ECProperty propertyName="PropB" typeName="int" />
    </ECEntityClass>
...
TEST_F(RulesDrivenECPresentationManagerContentTests, LoadsXToManyToManyRelatedNestedInstances_WithMultipleIntermediateInstances)
    {
    ...
    IECInstancePtr b2 = RulesEngineTestHelpers::InsertInstance(s_project->GetECDb(), *classB, [&](IECInstanceR instance)
        {
        instance.SetValue("PropB", ECValue(2));
        });
    IECInstancePtr c21 = RulesEngineTestHelpers::InsertInstance(s_project->GetECDb(), *classC, [&](IECInstanceR instance)
        {
        instance.SetValue("PropC", ECValue(21));
        });
    IECInstancePtr c22 = RulesEngineTestHelpers::InsertInstance(s_project->GetECDb(), *classC, [&](IECInstanceR instance)
        {
        instance.SetValue("PropC", ECValue(22));
        });
...
* @bsitest
+---------------+---------------+---------------+---------------+---------------+------*/
DEFINE_SCHEMA(LoadsXToManyToManyRelatedNestedInstances_WithCustomDisplayLabels, R"*(
    <ECEntityClass typeName="A" />
    <ECEntityClass typeName="B">
        <ECProperty propertyName="PropB" typeName="int" />
    </ECEntityClass>
...
TEST_F(RulesDrivenECPresentationManagerContentTests, LoadsXToManyToManyRelatedNestedInstances_WithCustomDisplayLabels)
    {
    ...
    rules->AddPresentationRule(*new InstanceLabelOverride(1, false, classA->GetFullName(), {new InstanceLabelOverrideClassNameValueSpecification()}));
    rules->AddPresentationRule(*new InstanceLabelOverride(1, false, classB->GetFullName(), {new InstanceLabelOverrideClassNameValueSpecification()}));
    rules->AddPresentationRule(*new InstanceLabelOverride(1, false, classC->GetFullName(), {new InstanceLabelOverrideClassNameValueSpecification()}));
...
* @bsitest
+---------------+---------------+---------------+---------------+---------------+------*/
DEFINE_SCHEMA(LoadsSameClassRelatedPropertiesForMultipleInstancesOfDifferentClasses, R"*(
    <ECEntityClass typeName="Model">
        <ECCustomAttributes>
            <ClassMap xmlns="ECDbMap.2.0">
                <MapStrategy>TablePerHierarchy</MapStrategy>
...
TEST_F(RulesDrivenECPresentationManagerContentTests, LoadsSameClassRelatedPropertiesForMultipleInstancesOfDifferentClasses)
    {
    Utf8PrintfString varies_string(CONTENTRECORD_MERGED_VALUE_FORMAT, CommonStrings::LABEL_VARIES);
...
TEST_F(RulesDrivenECPresentationManagerContentTests, LoadsNestedRelatedPropertiesForMultipleInstancesOfDifferentClasses)
    ...
    IECInstancePtr model1 = RulesEngineTestHelpers::InsertInstance(s_project->GetECDb(), *modelAClass);
    IECInstancePtr element1 = RulesEngineTestHelpers::InsertInstance(s_project->GetECDb(), *elementAClass);
    IECInstancePtr aspect1 = RulesEngineTestHelpers::InsertInstance(s_project->GetECDb(), *aspectClass, [](IECInstanceR instance){instance.SetValue("IntProperty", ECValue(123));});
    RulesEngineTestHelpers::InsertRelationship(s_project->GetECDb(), *modelContainsElementsRelationship, *model1, *element1);
    RulesEngineTestHelpers::InsertRelationship(s_project->GetECDb(), *elementOwnsMultipleAspectRelationship, *element1, *aspect1);

    IECInstancePtr model2 = RulesEngineTestHelpers::InsertInstance(s_project->GetECDb(), *modelBClass);
    IECInstancePtr element2 = RulesEngineTestHelpers::InsertInstance(s_project->GetECDb(), *elementBClass);
    IECInstancePtr aspect2 = RulesEngineTestHelpers::InsertInstance(s_project->GetECDb(), *aspectClass, [](IECInstanceR instance){instance.SetValue("IntProperty", ECValue(456));});
    RulesEngineTestHelpers::InsertRelationship(s_project->GetECDb(), *modelContainsElementsRelationship, *model2, *element2);
    RulesEngineTestHelpers::InsertRelationship(s_project->GetECDb(), *elementOwnsMultipleAspectRelationship, *element2, *aspect2);
    ...
    */
    ...
    ContentModifierP modelModifier = new ContentModifier(GetSchema()->GetName(), baseModelClass->GetName());
    rules->AddPresentationRule(*modelModifier);
    modelModifier->AddRelatedProperty(*new RelatedPropertiesSpecification(
    ...
    ContentModifierP elementModifier = new ContentModifier(GetSchema()->GetName(), baseElementClass->GetName());
    rules->AddPresentationRule(*elementModifier);
    elementModifier->SetApplyOnNestedContent(true);
    elementModifier->AddRelatedProperty(*new RelatedPropertiesSpecification(
        *new RelationshipPathSpecification(
            {
            new RelationshipStepSpecification(elementOwnsMultipleAspectRelationship->GetFullName(), RequiredRelationDirection_Forward, aspectClass->GetFullName()),
            }),
    ...
    ContentDescriptorCPtr descriptor = GetValidatedResponse(m_manager->GetContentDescriptor(AsyncContentDescriptorRequestParams::Create(s_project->GetECDb(), rules->GetRuleSetId(), RulesetVariables(), "", 0, *input)));
    ASSERT_TRUE(descriptor.IsValid());
    ASSERT_EQ(2, descriptor->GetVisibleFields().size()); // Model_ElementA and Model_ElementB
    ...
    expectedValues.Parse(Utf8PrintfString(R"({
        ...
        NESTED_CONTENT_FIELD_NAME(modelAClass, elementAClass),
        elementAClass->GetId().ToString().c_str(), element1->GetInstanceId().c_str(),
        NESTED_CONTENT_FIELD_NAME(elementAClass, aspectClass),
        aspectClass->GetId().ToString().c_str(), aspect1->GetInstanceId().c_str(),
        FIELD_NAME(aspectClass, "IntProperty"),
        FIELD_NAME(aspectClass, "IntProperty"),
        NESTED_CONTENT_FIELD_NAME(elementAClass, aspectClass),
        FIELD_NAME(aspectClass, "IntProperty"),
        NESTED_CONTENT_FIELD_NAME(modelBClass, elementBClass)
        ).c_str());
    EXPECT_EQ(expectedValues, recordJson["Values"])
        << "Expected: \r\n" << BeRapidJsonUtilities::ToPrettyString(expectedValues) << "\r\n"
        << "Actual: \r\n" << BeRapidJsonUtilities::ToPrettyString(recordJson["Values"]);
    ...
    expectedValues.Parse(Utf8PrintfString(R"({
        ...
        NESTED_CONTENT_FIELD_NAME(modelAClass, elementAClass),
        NESTED_CONTENT_FIELD_NAME(modelBClass, elementBClass),
        elementBClass->GetId().ToString().c_str(), element2->GetInstanceId().c_str(),
        NESTED_CONTENT_FIELD_NAME(elementBClass, aspectClass),
        aspectClass->GetId().ToString().c_str(), aspect2->GetInstanceId().c_str(),
        FIELD_NAME_C(aspectClass, "IntProperty", 2),
        FIELD_NAME_C(aspectClass, "IntProperty", 2),
        NESTED_CONTENT_FIELD_NAME(elementBClass, aspectClass),
        FIELD_NAME_C(aspectClass, "IntProperty", 2)
    ).c_str());
...
* @bsitest
+---------------+---------------+---------------+---------------+---------------+------*/
DEFINE_SCHEMA(CreatesValuesForRelatedPropertiesOfDerivedRelatedClasses, R"*(
    <ECEntityClass typeName="A">
        <ECProperty propertyName="PropertyA" typeName="string" />
    </ECEntityClass>
    <ECEntityClass typeName="B">
...
TEST_F(RulesDrivenECPresentationManagerContentTests, CreatesValuesForRelatedPropertiesOfDerivedRelatedClasses)
    {
    // set up data set
    ECClassCP classA = GetClass("A");
    ECClassCP classB = GetClass("B");
    ...
    IECInstancePtr a = RulesEngineTestHelpers::InsertInstance(s_project->GetECDb(), *classA, [](IECInstanceR instance){instance.SetValue("PropertyA", ECValue("a"));});
    IECInstancePtr b = RulesEngineTestHelpers::InsertInstance(s_project->GetECDb(), *classB, [](IECInstanceR instance){instance.SetValue("PropertyB", ECValue("b"));});
    RulesEngineTestHelpers::InsertRelationship(s_project->GetECDb(), *relAB, *a, *b);
    IECInstancePtr c = RulesEngineTestHelpers::InsertInstance(s_project->GetECDb(), *classC, [](IECInstanceR instance)
        {
        instance.SetValue("PropertyB", ECValue("c"));
        instance.SetValue("PropertyC", ECValue("c"));
        });
    RulesEngineTestHelpers::InsertRelationship(s_project->GetECDb(), *relAB, *a, *c);
    ...
    ContentRuleP rule = new ContentRule("", 1, false);
    ContentInstancesOfSpecificClassesSpecification* spec = new ContentInstancesOfSpecificClassesSpecification(1, "", classA->GetFullName(), true, true);
    ...
    expectedValues.Parse(Utf8PrintfString(R"({
        ...
        NESTED_CONTENT_FIELD_NAME(classA, classB),
        classB->GetId().ToString().c_str(), b->GetInstanceId().c_str(),
        FIELD_NAME(classB, "PropertyB"), FIELD_NAME(classB, "PropertyB"),
        NESTED_CONTENT_FIELD_NAME(classA, classC),
        classC->GetId().ToString().c_str(), c->GetInstanceId().c_str(),
