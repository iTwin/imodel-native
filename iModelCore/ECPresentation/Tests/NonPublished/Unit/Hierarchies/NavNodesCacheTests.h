...
struct NodesCacheTests : ECPresentationTest
    ...
    bpair<HierarchyLevelIdentifier, DataSourceIdentifier> CacheDataSource(IHierarchyCache& cache, Utf8StringCR connectionId, Utf8StringCR rulesetId, BeGuidCR virtualParentId = BeGuid(), bvector<uint64_t> const& = { 0 }, bool finalize = true, RulesetVariables const& variables = RulesetVariables(), InstanceFilterDefinitionCP = nullptr);
    bpair<HierarchyLevelIdentifier, DataSourceIdentifier> CacheDataSource(Utf8StringCR connectionId, Utf8StringCR rulesetId, BeGuidCR virtualParentId = BeGuid(), bvector<uint64_t> const& = { 0 }, bool finalize = true, RulesetVariables const& variables = RulesetVariables(), InstanceFilterDefinitionCP = nullptr);
    bpair<HierarchyLevelIdentifier, DataSourceIdentifier> CacheDataSource(IHierarchyCache& cache, Utf8StringCR connectionId, Utf8StringCR rulesetId, BeGuidCR virtualParentId, BeGuidCR physicalParentId, bvector<uint64_t> const& = { 0 }, bool finalize = true, RulesetVariables const& variables = RulesetVariables(), InstanceFilterDefinitionCP = nullptr);
    bpair<HierarchyLevelIdentifier, DataSourceIdentifier> CacheDataSource(Utf8StringCR connectionId, Utf8StringCR rulesetId, BeGuidCR virtualParentId, BeGuidCR physicalParentId, bvector<uint64_t> const& = { 0 }, bool finalize = true, RulesetVariables const& variables = RulesetVariables(), InstanceFilterDefinitionCP = nullptr);
    };
