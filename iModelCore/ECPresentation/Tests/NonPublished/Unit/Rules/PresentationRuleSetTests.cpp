...
TEST_F(PresentationRuleSetTests, LoadsFromXml)
    ...
    EXPECT_FALSE(ruleSet->GetIsSupplemental());
    EXPECT_EQ(Version(5, 3, 0), ruleSet->GetRulesetVersion().Value());
...
TEST_F(PresentationRuleSetTests, LoadsFromXmlWithDefaultValues)
    ...
    EXPECT_FALSE(ruleSet->GetIsSupplemental());
    EXPECT_TRUE(ruleSet->GetIsSearchEnabled());
    EXPECT_EQ(Version(1, 0, 0), ruleSet->GetRulesetVersion().Value());
    }
...
TEST_F(PresentationRuleSetTests, WritesToXml)
    ...
    ruleSet->SetRulesetVersion(Version(2, 1, 0));
    ruleSet->SetSupplementationPurpose("Supplemental");
    ruleSet->SetSupportedSchemas("DummySchemaName");
    ...
    static Utf8CP expected = ""
        ...
        R"(<PresentationRuleSet )"
         ...
         R"(SearchClasses="" )"
         R"(ExtendedData="">)"
            R"(<RootNodeRule Priority="1" OnlyIfNotHandled="true" Condition="TestCondition1" TargetTree="Both" StopFurtherProcessing="false" AutoExpand="false"/>)"
            R"(<ChildNodeRule Priority="2" OnlyIfNotHandled="true" Condition="TestCondition2" TargetTree="SelectionTree" StopFurtherProcessing="false"/>)"
            R"(<ContentRule Priority="3" OnlyIfNotHandled="true" Condition="TestCondition3" CustomControl=""/>)"
            ...
            R"(<SortingRule Priority="11" OnlyIfNotHandled="false" Condition="SortingCondition" SchemaName="DummySchemaName" ClassName="DummyClassName" )"
             R"(PropertyName="DummyPropertyName" SortAscending="false" DoNotSort="true" IsPolymorphic="false"/>)"
...
TEST_F(PresentationRuleSetTests, ComputesCorrectHashes)
    {
    Utf8CP DEFAULT_HASH = "ac12be50f1e8bec53472aaeb088914bb";
...
TEST_F(PresentationRuleSetTests, TestCustomizationRuleLoadingFromXml)
    ...
    ASSERT_EQ(1, instanceLabelOverride->GetValueSpecifications().size());
...
TEST_F(PresentationRuleSetTests, TestNestedCustomizationRulesWriteToXml)
    ...
    Utf8String expectedRuleSet = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
        "<PresentationRuleSet RuleSetId=\"TestRuleSet\" SupportedSchemas=\"\" IsSupplemental=\"false\" SupplementationPurpose=\"\" "
        "VersionMajor=\"2\" VersionMinor=\"1\" PreferredImage=\"\" IsSearchEnabled=\"true\" SearchClasses=\"\" ExtendedData=\"\">"
            "<RootNodeRule Priority=\"1\" OnlyIfNotHandled=\"true\" Condition=\"TestCondition1\" TargetTree=\"Both\" StopFurtherProcessing=\"false\" AutoExpand=\"false\">"
                "<ImageIdOverride Priority=\"4\" OnlyIfNotHandled=\"false\" Condition=\"TestCondition3\" ImageId=\"ImageIdOverrideTestValue\"/>"
            "</RootNodeRule>"
            "<ChildNodeRule Priority=\"2\" OnlyIfNotHandled=\"true\" Condition=\"TestCondition2\" TargetTree=\"Both\" StopFurtherProcessing=\"false\">"
                "<AllInstances Priority=\"1\" HasChildren=\"Unknown\" HideNodesInHierarchy=\"false\" HideIfNoChildren=\"false\" DoNotSort=\"false\" GroupByClass=\"false\" GroupByLabel=\"false\" SupportedSchemas=\"one\">"
                    "<ChildNodeRule Priority=\"1\" OnlyIfNotHandled=\"false\" Condition=\"\" TargetTree=\"MainTree\" StopFurtherProcessing=\"false\">"
