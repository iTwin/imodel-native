...
std::ostream& operator << (std::ostream &o, ECInstanceKeyCR instance)
    {
    o << Utf8PrintfString("%s:%s", instance.GetClassId().ToString().c_str(), instance.GetInstanceId().IsValid() ? instance.GetInstanceId().ToString().c_str() : "0").c_str();
    return o;
    }
...
std::ostream& operator << (std::ostream &o, ECClassCR value)
    {
    o << Utf8String(&value == nullptr ? "<NULL>" : value.GetFullName());
    return o;
    }
...
std::ostream& operator << (std::ostream &o, SchemaReadStatus status)
    {
    static std::map<SchemaReadStatus, Utf8String> names
        {
        TO_VALUE_STRING_PAIR(SchemaReadStatus::DuplicateSchema),
        TO_VALUE_STRING_PAIR(SchemaReadStatus::DuplicateTypeName),
        TO_VALUE_STRING_PAIR(SchemaReadStatus::FailedToParseXml),
        TO_VALUE_STRING_PAIR(SchemaReadStatus::HasReferenceCycle),
        TO_VALUE_STRING_PAIR(SchemaReadStatus::InvalidECSchemaXml),
        TO_VALUE_STRING_PAIR(SchemaReadStatus::InvalidPrimitiveType),
        TO_VALUE_STRING_PAIR(SchemaReadStatus::ReferencedSchemaNotFound),
        TO_VALUE_STRING_PAIR(SchemaReadStatus::Success),
    };
