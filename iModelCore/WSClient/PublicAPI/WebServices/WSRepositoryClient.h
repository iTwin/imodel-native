/*--------------------------------------------------------------------------------------+
|
|     $Source: PublicAPI/WebServices/WSRepositoryClient.h $
|
...
#include <WebServices/Response/WSCreateObjectResponse.h>
#include <WebServices/Response/WSFileResponse.h>
...
struct IWSRepositoryClient
    {
    public:
        WS_EXPORT virtual ~IWSRepositoryClient ();
...
struct WSRepositoryClient : public IWSRepositoryClient
    ...
    public:
        ...
        WS_EXPORT static IWSRepositoryClientPtr Create
            (
        ...
        WS_EXPORT IWSClientPtr GetWSClient () const override;
        WS_EXPORT Utf8StringCR GetRepositoryId () const override;

        WS_EXPORT void SetCredentials (MobileDgn::Utils::Credentials credentials);

        //! Check if user can access repository
        WS_EXPORT std::shared_ptr<MobileDgn::Utils::PackagedAsyncTask<MobileDgn::Utils::AsyncResult<void, WSError>>> VerifyAccess
            (
            MobileDgn::Utils::ICancellationTokenPtr cancellationToken = nullptr
            ) const override;

        WS_EXPORT MobileDgn::Utils::AsyncTaskPtr<WSObjectsResult> SendGetObjectRequest
            (
            ObjectIdCR objectId,
            Utf8StringCR eTag = nullptr,
            MobileDgn::Utils::ICancellationTokenPtr cancellationToken = nullptr
        ...
        WS_EXPORT MobileDgn::Utils::AsyncTaskPtr<WSObjectsResult> SendGetChildrenRequest
            (
            ObjectIdCR parentObjectId,
            Utf8StringCR eTag = nullptr,
            MobileDgn::Utils::ICancellationTokenPtr cancellationToken = nullptr
        ...
        WS_EXPORT MobileDgn::Utils::AsyncTaskPtr<WSFileResult> SendGetFileRequest
            (
            ObjectIdCR objectId,
            BeFileNameCR filePath,
            Utf8StringCR eTag = nullptr,
        ...
        WS_EXPORT MobileDgn::Utils::AsyncTaskPtr<WSObjectsResult> SendGetSchemasRequest
            (
            Utf8StringCR eTag = nullptr,
            MobileDgn::Utils::ICancellationTokenPtr cancellationToken = nullptr
            ) const override;

        WS_EXPORT MobileDgn::Utils::AsyncTaskPtr<WSObjectsResult> SendQueryRequest
            (
            WSQueryCR query,
            Utf8StringCR eTag = nullptr,
            MobileDgn::Utils::ICancellationTokenPtr cancellationToken = nullptr
        ...
        WS_EXPORT MobileDgn::Utils::AsyncTaskPtr<WSCreateObjectResult> SendCreateObjectRequest
            (
            JsonValueCR objectCreationJson,
            BeFileNameCR filePath = BeFileName (),
            MobileDgn::Utils::HttpRequest::ProgressCallbackCR uploadProgressCallback = nullptr,
        ...
        WS_EXPORT MobileDgn::Utils::AsyncTaskPtr<WSUpdateObjectResult> SendUpdateObjectRequest
            (
            ObjectIdCR objectId,
            JsonValueCR propertiesJson,
            Utf8String eTag = nullptr,
        ...
        WS_EXPORT MobileDgn::Utils::AsyncTaskPtr<WSDeleteObjectResult> SendDeleteObjectRequest
            (
            ObjectIdCR objectId,
            MobileDgn::Utils::ICancellationTokenPtr cancellationToken = nullptr
            ) const override;

        WS_EXPORT MobileDgn::Utils::AsyncTaskPtr<WSUpdateFileResult> SendUpdateFileRequest
            (
            ObjectIdCR objectId,
            BeFileNameCR filePath,
            MobileDgn::Utils::HttpRequest::ProgressCallbackCR uploadProgressCallback = nullptr,
