/*--------------------------------------------------------------------------------------+
 |
 |     $Source: PublicAPI/WebServices/Client/ChunkedUploadRequest.h $
 |
...
struct ChunkedUploadRequest
    ...
    public:
        ...
        WSCLIENT_EXPORT ChunkedUploadRequest (Utf8StringCR method, Utf8StringCR url, MobileDgn::Utils::HttpClientCR client);

        // Set body for chunked upload. FileName for Content-Disposition 
        WSCLIENT_EXPORT void SetRequestBody (MobileDgn::Utils::HttpBodyPtr body, Utf8String fileName);

        // Set body for first request. Empty by default
        WSCLIENT_EXPORT void SetHandshakeRequestBody (MobileDgn::Utils::HttpBodyPtr body, Utf8StringCR contentType);
        ...
        WSCLIENT_EXPORT void SetCancellationToken (MobileDgn::Utils::ICancellationTokenPtr token);

        // Progress callback for whole upload
        WSCLIENT_EXPORT void SetUploadProgressCallback (MobileDgn::Utils::HttpRequest::ProgressCallbackCR onProgress);

        // Send required requests and return final response
        WSCLIENT_EXPORT MobileDgn::Utils::AsyncTaskPtr<MobileDgn::Utils::HttpResponse> PerformAsync ();
    };
