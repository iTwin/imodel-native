/*--------------------------------------------------------------------------------------+
 |
 |     $Source: PublicAPI/WebServices/Client/Connect/SecureStore.h $
 |
...
struct SecureStore
    ...
    public:
        ...
        WSCLIENT_EXPORT SecureStore (MobileDgn::ILocalState* customLocalState = nullptr);
        ...
        WSCLIENT_EXPORT void SaveValue (Utf8CP nameSpace, Utf8CP key, Utf8CP value);

        //! Loads value for given key in namespace. Empty string is returned when value not found or other error occur.
        WSCLIENT_EXPORT Utf8String LoadValue (Utf8CP nameSpace, Utf8CP key);
    };
