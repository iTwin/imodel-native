/*--------------------------------------------------------------------------------------+
|
|  $Source: PublicAPI/WebServices/Response/WSObjectsReaderV1.h $
|
...
struct WSObjectsReaderV1 : public WSObjectsReader
    ...
    public:
        ...
        WS_EXPORT static std::shared_ptr<WSObjectsReaderV1> Create (Utf8StringCR schemaName);
        //! Constructor for one object request response
        WS_EXPORT static std::shared_ptr<WSObjectsReaderV1> Create (Utf8StringCR schemaName, Utf8StringCR className);
        WS_EXPORT virtual ~WSObjectsReaderV1 ();
