...
struct ConnectAuthenticationHandler : public MobileDgn::Utils::AuthenticationHandler
    ...
    public:
        WS_EXPORT ConnectAuthenticationHandler
            (
        ...
        WS_EXPORT virtual ~ConnectAuthenticationHandler ();

        WS_EXPORT virtual bool _ShouldRetryAuthentication (MobileDgn::Utils::HttpResponseCR response) override;
        WS_EXPORT virtual MobileDgn::Utils::AsyncTaskPtr<AuthorizationResult> _RetrieveAuthorization (AttemptCR previousAttempt) override;
    };
