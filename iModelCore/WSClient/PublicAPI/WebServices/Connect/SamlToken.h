...
struct SamlToken
    ...
    public:
        ...
        WS_EXPORT bool IsValidAt (DateTimeCR dateTimeUtc) const;
        ...
        WS_EXPORT bool IsValidNow (uint32_t offsetMinutes) const;
        //! Get token attributes
        WS_EXPORT BentleyStatus GetAttributes (bmap<Utf8String, Utf8String>& atributtesOut) const;
        //! Get base 64 encoded certificate
        WS_EXPORT BentleyStatus GetX509Certificate (Utf8StringR certOut) const;
        //! Create string for authroization header
        WS_EXPORT Utf8String ToAuthorizationString () const;
        //! Return original token representation
        WS_EXPORT Utf8StringCR AsString () const;
    };
