...
+--------------------------------------------------------------------------------------*/
WSJob::WSJob(HttpResponse response, Utf8StringCR jobOriginUrl) : WSJob(response)
    {
...
* @bsimethod                                                julius.cepukenas   12/2017
+---------------+---------------+---------------+---------------+---------------+------*/
WSJob::WSJob(HttpResponse response) 
    {
    auto rapidJson = std::make_shared<rapidjson::Document>();
    response.GetBody().AsRapidJson(*rapidJson);
...
* @bsimethod                                                julius.cepukenas   12/2017
+--------------------------------------------------------------------------------------*/
HttpResponse WSJob::GetResponse() const
    {
    ...
    return HttpResponse(HttpStatus(responseStatus), m_url.c_str(), responseHeaders, responseContent);
    }
