...
CWSCCDATABUFHANDLE* fileBuffer
    ...
    for (WSObjectsReader::Instance instance : result.GetValue().GetInstances())
        ...
        File_BufferStuffer(bufToFill, instance.GetProperties());
...
CWSCCDATABUFHANDLE* fileBuffer
    ...
    File_BufferStuffer(fileBuf, (*result.GetValue().GetInstances().begin()).GetProperties());
...
CWSCCDATABUFHANDLE* folderBuffer
    ...
    for (WSObjectsReader::Instance instance : result.GetValue().GetInstances())
        ...
        Folder_BufferStuffer(bufToFill, instance.GetProperties());
        buf->lItems.push_back(bufToFill);
        }
...
CWSCCDATABUFHANDLE* folderBuffer
    ...
    Folder_BufferStuffer(folderBuf, (*result.GetValue().GetInstances().begin()).GetProperties());
...
CWSCCDATABUFHANDLE* publishfileBuffer
    ...
    for (WSObjectsReader::Instance instance : result.GetValue().GetInstances())
        ...
        PublishFile_BufferStuffer(bufToFill, instance.GetProperties());
        buf->lItems.push_back(bufToFill);
        }
...
CWSCCDATABUFHANDLE* publishfileBuffer
    ...
    PublishFile_BufferStuffer(publishfileBuf, (*result.GetValue().GetInstances().begin()).GetProperties());
