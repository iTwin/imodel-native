...
/* Define to 1 if you have addrinfo struct. CARES */
...
/* SEE: https://askubuntu.com/questions/1285116/stropts-h-missing-in-ubuntu-20-04
 * modern linux distributions (e.g. ubuntu >=20.04) purged unsupported old APIs
 * like the libc6-dev package's stropts.h implementation. So disable curl using it.
 */
