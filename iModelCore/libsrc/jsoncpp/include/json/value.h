...
class JSON_API Value
{
   ...
   public:
      ...
      static constexpr Int64 minInt64() {return -9007199254740991;} // see: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number/MIN_SAFE_INTEGER

      //! Maximum signed 64 bits int value that can be stored in a Json::Value.
      static constexpr Int64 maxInt64() {return 9007199254740991;} // see: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number/MIN_SAFE_INTEGER

      //! Maximum unsigned 64 bits int value that can be stored in a Json::Value.
      static constexpr UInt64 maxUInt64() {return (UInt64) maxInt64();}
   ...
   public:
    ...
    \endcode
      */
      ...
      bool isIntegral() const {
          switch (type()) {
              ...
              case booleanValue:
                  return true;
              case realValue:
                  return value_.real_ >= minInt64() &&
                         value_.real_ < maxUInt64() && IsIntegral(value_.real_);
              default:
                  break;
          }
          return false;
      ...
      /// Return true if the object has a member named key, even if it is null.
      ...
      JsonValueR resolveReference(Utf8CP key, bool isStatic)
        ...
        return value_.map_->insert(defaultValue).first->second;
        }
