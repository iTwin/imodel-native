...
#define BEJSONCPP_LOGD(...) NativeLogging::CategoryLogger("BeJsonCpp").debugv (__VA_ARGS__)
#define BEJSONCPP_LOGE(...) NativeLogging::CategoryLogger("BeJsonCpp").errorv (__VA_ARGS__)
