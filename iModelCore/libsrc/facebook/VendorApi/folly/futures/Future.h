...
class Future {
 public:
  ...
  decltype(auto) thenMulti(Callback&& fn, Callbacks&&... fns);

  // Nothing to see here, just thenMulti's base case
  template <class Callback>
  decltype(auto) thenMulti(Callback&& fn);
  ...
  template <class Callback, class... Callbacks>
  decltype(auto) thenMultiWithExecutor(Executor* x, Callback&& fn, Callbacks&&... fns);

  // Nothing to see here, just thenMultiWithExecutor's base case
  template <class Callback>
  decltype(auto) thenMultiWithExecutor(Executor* x, Callback&& fn);
...
#ifdef _MSC_VER
#pragma warning(push)
#pragma message("Disabling C4996 for folly/Try-inl.h")
#pragma warning(disable:4996) // C++ 17 deprecation warning (MSVC)
#elif defined __clang__
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations" // C++ 17 deprecation warning (Clang)
#endif
