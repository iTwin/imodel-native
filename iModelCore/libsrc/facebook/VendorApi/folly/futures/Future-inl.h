...
decltype(auto) Future<T>::thenMulti(Callback&& fn) {
...
decltype(auto) Future<T>::thenMulti(Callback&& fn, Callbacks&&... fns) {
...
template <class T>
template <class Callback, class... Callbacks>
decltype(auto) Future<T>::thenMultiWithExecutor(Executor* x, Callback&& fn,
                                      Callbacks&&... fns) {
