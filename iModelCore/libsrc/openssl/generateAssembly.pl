...
# it prints a wall of text which can be copy and pasted into BeOpenSSL.mke to compile the assembly files.
...
foreach(@perlScripts) {
    ...
    system($^X, $fullPathToScript, @ARGS); #run the .pl script
