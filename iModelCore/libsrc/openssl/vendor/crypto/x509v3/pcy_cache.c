                               ...
                               CERTIFICATEPOLICIES *policies, int crit)
{
    ...
    if (cache->data == NULL) {
<<<<<<< HEAD:iModelCore/libsrc/openssl/vendor/crypto/x509v3/pcy_cache.c
        X509V3err(X509V3_F_POLICY_CACHE_CREATE, ERR_R_MALLOC_FAILURE);
=======
        ERR_raise(ERR_LIB_X509V3, ERR_R_MALLOC_FAILURE);
>>>>>>> 56ac539c (copy over openssl 3.1 (#276)):iModelCore/libsrc/openssl/vendor/crypto/x509/pcy_cache.c
        goto just_cleanup;
    }
    for (i = 0; i < num; i++) {
