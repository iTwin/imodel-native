...
#ifdef EXCLUDE_BENTLEY_MODIFICATIONS
...
struct TemporaryForceDefaults {
 private:
  ...
  TemporaryForceDefaults(TemporaryForceDefaults const &) = delete;
  TemporaryForceDefaults &operator=(TemporaryForceDefaults const &) = delete;
 ...
 public:
  TemporaryForceDefaults(FlatBufferBuilder &encoder, bool newValue)
      : m_encoder(encoder),
        ...
        m_newValue(newValue) {
    if (m_newValue != m_oldValue) m_encoder.ForceDefaults(m_newValue);
  }

  ~TemporaryForceDefaults() {
    if (m_newValue != m_oldValue) m_encoder.ForceDefaults(m_oldValue);
  }
