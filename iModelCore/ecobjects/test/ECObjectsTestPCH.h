...
#define EXPECTED_CONDITION(_Expression) ((_Expression) || (LOG_ASSERT_FAILURE(L"The following expected condition has failed:\n  expected condition: %hs\n  method: %hs\n  file: %hs\n  line: %i\n", #_Expression, __FUNCTION__, __FILE__, __LINE__), 0) || (ASSERT_FALSE_IF_NOT_DISABLED(_Expression), 0))
