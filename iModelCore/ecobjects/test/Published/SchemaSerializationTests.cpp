...
struct SchemaJsonSerializationTest : ECTestFixture
    {
    protected:
        WString GetTestDataPath(WCharCP dataFile)
            {
            WString path = WString(L"ECJson/") + dataFile;
            return ECTestFixture::GetTestDataPath(path.c_str());
            }

        static Utf8String JsonSchemasComparisonString(Json::Value& createdSchema, Json::Value testDataSchema)
            {
...
TEST_F(SchemaJsonSerializationTest, SchemaWithNoChildren)
    ...
    BeFileName testDataFile(SchemaJsonSerializationTest::GetTestDataPath(L"SchemaWithNoChildren.ecschema.json").c_str());
    ...
    EXPECT_TRUE(ECTestUtility::JsonDeepEqual(schemaJson, testDataJson)) << SchemaJsonSerializationTest::JsonSchemasComparisonString(schemaJson, testDataJson);
    }

//---------------------------------------------------------------------------------------
// @bsimethod                           Victor.Cushman                          11/2017
//+---------------+---------------+---------------+---------------+---------------+------
TEST_F(SchemaJsonSerializationTest, StadaloneSchemaChildEntityClass)
    {
    ECSchemaPtr schema = SchemaJsonSerializationTest::CreateSchemaWithNoChildren();
    ECEntityClassP baseEntityClass;
    ...
    Json::Value testDataJson;
    BeFileName testDataFile(SchemaJsonSerializationTest::GetTestDataPath(L"StandaloneECEntityClass.ecschema.json").c_str());
    auto readJsonStatus = ECTestUtility::ReadJsonInputFromFile(testDataJson, testDataFile);
    ASSERT_EQ(BentleyStatus::SUCCESS, readJsonStatus);

    EXPECT_TRUE(ECTestUtility::JsonDeepEqual(schemaChildJson, testDataJson)) << SchemaJsonSerializationTest::JsonSchemasComparisonString(schemaChildJson, testDataJson);
    }

//---------------------------------------------------------------------------------------
// @bsimethod                           Victor.Cushman                          11/2017
//+---------------+---------------+---------------+---------------+---------------+------
TEST_F(SchemaJsonSerializationTest, StadaloneSchemaChildMixin)
    {
    ECSchemaPtr schema = SchemaJsonSerializationTest::CreateSchemaWithNoChildren();
    ECEntityClassP entityClass;
    schema->CreateEntityClass(entityClass, "ExampleEntity");
    ...
    Json::Value testDataJson;
    BeFileName testDataFile(SchemaJsonSerializationTest::GetTestDataPath(L"StandaloneMixin.ecschema.json").c_str());
    auto readJsonStatus = ECTestUtility::ReadJsonInputFromFile(testDataJson, testDataFile);
    ASSERT_EQ(BentleyStatus::SUCCESS, readJsonStatus);
...
// @bsimethod                           Victor.Cushman                          11/2017
//+---------------+---------------+---------------+---------------+---------------+------
TEST_F(SchemaJsonSerializationTest, StadaloneSchemaChildStructClass)
    {
    ECSchemaPtr schema = SchemaJsonSerializationTest::CreateSchemaWithNoChildren();
    ECStructClassP structClass;
    ...
    Json::Value testDataJson;
    BeFileName testDataFile(SchemaJsonSerializationTest::GetTestDataPath(L"StandaloneECStructClass.ecschema.json").c_str());
    auto readJsonStatus = ECTestUtility::ReadJsonInputFromFile(testDataJson, testDataFile);
    ASSERT_EQ(BentleyStatus::SUCCESS, readJsonStatus);
...
// @bsimethod                           Victor.Cushman                          11/2017
//+---------------+---------------+---------------+---------------+---------------+------
TEST_F(SchemaJsonSerializationTest, StadaloneSchemaChildRelationshipClass)
    {
    ECSchemaPtr schema = SchemaJsonSerializationTest::CreateSchemaWithNoChildren();
    ...
    Json::Value testDataJson;
    BeFileName testDataFile(SchemaJsonSerializationTest::GetTestDataPath(L"StandaloneECRelationshipClass.ecschema.json").c_str());
    auto readJsonStatus = ECTestUtility::ReadJsonInputFromFile(testDataJson, testDataFile);
    ASSERT_EQ(BentleyStatus::SUCCESS, readJsonStatus);
...
// @bsimethod                           Victor.Cushman                          11/2017
//+---------------+---------------+---------------+---------------+---------------+------
TEST_F(SchemaJsonSerializationTest, StadaloneSchemaChildCustomAttributeClass)
    {
    ECSchemaPtr schema = SchemaJsonSerializationTest::CreateSchemaWithNoChildren();
    ...
    Json::Value testDataJson;
    BeFileName testDataFile(SchemaJsonSerializationTest::GetTestDataPath(L"StandaloneECCustomAttributeClass.ecschema.json").c_str());
    auto readJsonStatus = ECTestUtility::ReadJsonInputFromFile(testDataJson, testDataFile);
    ASSERT_EQ(BentleyStatus::SUCCESS, readJsonStatus);
...
// @bsimethod                           Victor.Cushman                          11/2017
//+---------------+---------------+---------------+---------------+---------------+------
TEST_F(SchemaJsonSerializationTest, StadaloneSchemaChildKindOfQuantity)
    {
    ECSchemaPtr schema = SchemaJsonSerializationTest::CreateSchemaWithNoChildren();
    KindOfQuantityP koq;
    ...
    Json::Value testDataJson;
    BeFileName testDataFile(SchemaJsonSerializationTest::GetTestDataPath(L"StandaloneKindOfQuantity.ecschema.json").c_str());
    auto readJsonStatus = ECTestUtility::ReadJsonInputFromFile(testDataJson, testDataFile);
    ASSERT_EQ(BentleyStatus::SUCCESS, readJsonStatus);
...
// @bsimethod                           Victor.Cushman                          11/2017
//+---------------+---------------+---------------+---------------+---------------+------
TEST_F(SchemaJsonSerializationTest, StadaloneSchemaChildEnumeration)
    {
    ECSchemaPtr schema = SchemaJsonSerializationTest::CreateSchemaWithNoChildren();
    ECEnumerationP enumeration;
    ...
    Json::Value testDataJson;
    BeFileName testDataFile(SchemaJsonSerializationTest::GetTestDataPath(L"StandaloneECEnumeration.ecschema.json").c_str());
    auto readJsonStatus = ECTestUtility::ReadJsonInputFromFile(testDataJson, testDataFile);
    ASSERT_EQ(BentleyStatus::SUCCESS, readJsonStatus);
...
// @bsimethod                           Victor.Cushman                          11/2017
//+---------------+---------------+---------------+---------------+---------------+------
TEST_F(SchemaJsonSerializationTest, StadaloneSchemaChildPropertyCategory)
    {
    ECSchemaPtr schema = SchemaJsonSerializationTest::CreateSchemaWithNoChildren();
    ...
    Json::Value testDataJson;
    BeFileName testDataFile(SchemaJsonSerializationTest::GetTestDataPath(L"StandalonePropertyCategory.ecschema.json").c_str());
    auto readJsonStatus = ECTestUtility::ReadJsonInputFromFile(testDataJson, testDataFile);
    ASSERT_EQ(BentleyStatus::SUCCESS, readJsonStatus);
...
// @bsimethod                           Victor.Cushman                          11/2017
//+---------------+---------------+---------------+---------------+---------------+------
TEST_F(SchemaJsonSerializationTest, SchemaWithClassProperties)
    {
    ECSchemaPtr schema = SchemaJsonSerializationTest::CreateSchemaWithNoChildren();
    ...
    BeFileName testDataFile(SchemaJsonSerializationTest::GetTestDataPath(L"SchemaWithClassProperties.ecschema.json").c_str());
    auto readJsonStatus = ECTestUtility::ReadJsonInputFromFile(testDataJson, testDataFile);
    ASSERT_EQ(BentleyStatus::SUCCESS, readJsonStatus);
...
TEST_F(SchemaJsonSerializationTest, SchemaWithChildren)
    ...
    Json::Value testDataJson;
    BeFileName testDataFile(SchemaJsonSerializationTest::GetTestDataPath(L"SchemaWithChildren.ecschema.json").c_str());
    auto readJsonStatus = ECTestUtility::ReadJsonInputFromFile(testDataJson, testDataFile);
    ASSERT_EQ(BentleyStatus::SUCCESS, readJsonStatus);
