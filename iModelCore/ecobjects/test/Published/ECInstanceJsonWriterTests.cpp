/*--------------------------------------------------------------------------------------+
|
|     $Source: test/Published/ECInstanceJsonWriterTests.cpp $
|
...
//=======================================================================================
// @bsistruct                                                  Gintaras.Volkvicius 09/18
//=======================================================================================
...
protected:
    void SetUp() override
        ...
        m_structClass->CreatePrimitiveProperty(m_structStringProperty, "StringProperty");
        ...
        m_structStructClass->CreatePrimitiveProperty(m_structStructStringProperty, "StringProperty");
...
public:
    static void SetStructStructProperties(ECInstanceBuilder& innerStructBuilder, Nullable<int> const& intProperty, Nullable<double> const& doubleProperty, Utf8CP stringProperty,
        ...
        {
        SetCommonStructProperties(innerStructBuilder, intProperty, doubleProperty, stringProperty, strictEnumerationProperty, looseEnumerationProperty, doubleArrayCount, doubleArray);
        }
    ...
    static void SetStructProperties(ECInstanceBuilder& outerStructBuilder, Nullable<int> const& intProperty, Nullable<double> const& doubleProperty, Utf8CP stringProperty,
        ...
        SetCommonStructProperties(outerStructBuilder, intProperty, doubleProperty, stringProperty,
            strictEnumerationProperty, looseEnumerationProperty, doubleArrayCount, doubleArray);
...
//---------------------------------------------------------------------------------------
// @bsimethod                                                  Gintaras.Volkvicius 09/18 
//---------------------------------------------------------------------------------------
TEST_F(ECInstanceJsonWriterTests, WriteEmbeddedStructValueTest)
    ...
    SetStructStructProperties(structStructBuilder, 0, 3.14, "Pi 3 digits", nullptr, 1, 4, { 1.0, 2.0, 4.0, 9.0 });
    SetStructStructProperties(structStructArrayMemberBuilder1, +1234567890, 3.1415926535897932384626433832795028841971, u8"π 41 digits", "EnumeratorB", 2, 2, { 16, 25 });
    SetStructStructProperties(structStructArrayMemberBuilder2, -1234567890, 2.7182818284590452353602874713526624977572, "e 41 digits", "EnumeratorB", 2, 0, {});
    SetStructProperties(structBuilder, 1, 2.0, "2.0", "EnumeratorA", 1, 0, {}, &structStructBuilder, 2, { &structStructArrayMemberBuilder1, &structStructArrayMemberBuilder2 });
    ...
    auto expectedJsonValue12 = Json::Value::From(u8R"(
        {
           "StructProperty" : {
              ...
              "StructStructProperty" : {
                 ...
                 "LooseEnumerationProperty" : 1,
                 "DoubleArrayProperty" : [ 1.0, 2.0, 4.0, 9.0 ]
              },
...
TEST_F(ECInstanceJsonWriterTests, WriteEmbeddedStructValueForPresentationTest)
    ...
    SetStructStructProperties(structStructBuilder, nullptr, nullptr, u8"α β γ δ ε ζ η θ ι κ λ μ ν ξ ο π ρ ς σ τ υ φ χ ψ ω", "EnumeratorB", nullptr, 1, { 7 });
    SetStructStructProperties(structStructArrayMemberBuilder1, 333333, 3.333333, nullptr, nullptr, 2, 1, { 9.0 });
    SetStructStructProperties(structStructArrayMemberBuilder2, nullptr, nullptr, nullptr, nullptr/*"EnumeratorInvalid"*/, nullptr, 0, { });
    SetStructProperties(structBuilder, nullptr, 1.111111, "1.111111", nullptr, 1, 0, { }, &structStructBuilder, 2, { &structStructArrayMemberBuilder1, &structStructArrayMemberBuilder2 });
    sourceInstanceBuilder.EmplaceProperty("StructProperty", structBuilder);
...
TEST_F(ECInstanceJsonWriterTests, WritePrimitiveValueTest)
    ...
    SetStructStructProperties(structStructBuilder, nullptr, nullptr, u8"α β γ δ ε ζ η θ ι κ λ μ ν ξ ο π ρ ς σ τ υ φ χ ψ ω", "EnumeratorB", nullptr, 1, {7});
    SetStructStructProperties(structStructArrayMemberBuilder1, 333333, 3.333333, nullptr, nullptr, 2, 1, {9.0});
    SetStructStructProperties(structStructArrayMemberBuilder2, nullptr, nullptr, nullptr, nullptr, 5, 0, { });
    SetStructProperties(structBuilder, nullptr, 1.111111, "1.111111", nullptr, 7, 0, { }, &structStructBuilder, 2, { &structStructArrayMemberBuilder1, &structStructArrayMemberBuilder2 });
    sourceInstanceBuilder.EmplaceProperty("StructProperty", structBuilder);
...
TEST_F(ECInstanceJsonWriterTests, WritePrimitiveValueForPresentationTest)
    ...
    SetStructStructProperties(structStructBuilder, nullptr, 3.14, u8"π", "EnumeratorB", nullptr, 1, {7});
    SetStructStructProperties(structStructArrayMemberBuilder1, 333333, 3.333333, nullptr, nullptr, 2, 1, {9.0});
    SetStructStructProperties(structStructArrayMemberBuilder2, nullptr, nullptr, nullptr, nullptr, 5, 0, { });
    SetStructProperties(structBuilder, nullptr, 1.111111, "1.111111", nullptr, 7, 0, { }, &structStructBuilder, 2, { &structStructArrayMemberBuilder1, &structStructArrayMemberBuilder2 });
    sourceInstanceBuilder.EmplaceProperty("StructProperty", structBuilder);
...
TEST_F(ECInstanceJsonWriterTests, WriteInstanceToJsonTest)
    ...
    SetStructStructProperties(structStructBuilder, nullptr, 3.14, "Pi 3 digits", nullptr, 1, 4, {1.0, 2.0, 4.0, 9.0});
    SetStructStructProperties(structStructArrayMemberBuilder1, +1, 3.1415926535897932384626433832795028841971, u8"π 41 digits", "EnumeratorB", 2, 2, {16, 25});
    SetStructStructProperties(structStructArrayMemberBuilder2, -1, 2.7182818284590452353602874713526624977572, "e 41 digits", "EnumeratorB", 2, 0, {});
    SetStructProperties(structBuilder, nullptr, 2.0, "2.0", "EnumeratorA", 1, 0, {}, &structStructBuilder, 2, { &structStructArrayMemberBuilder1, &structStructArrayMemberBuilder2 });
    sourceInstanceBuilder.EmplaceProperty("StructProperty", structBuilder);
...
TEST_F(ECInstanceJsonWriterTests, WriteInstanceToPresentationJsonTest)
    ...
    SetStructStructProperties(structStructBuilder, nullptr, 3.14, "Pi 3 digits", nullptr, 1, 1, { 7.0 });
    SetStructStructProperties(structStructArrayMemberBuilder1, +1, 3.1415926535897932384626433832795028841971, u8"π 41 digits", "EnumeratorB", 2, 1, { 25 });
    SetStructStructProperties(structStructArrayMemberBuilder2, nullptr, nullptr, nullptr, nullptr, nullptr, 0, { });
    SetStructProperties(structBuilder, nullptr, 2.0, "2.0", "EnumeratorA", 1, 0, { }, &structStructBuilder, 2, { &structStructArrayMemberBuilder1, &structStructArrayMemberBuilder2 });
    sourceInstanceBuilder.EmplaceProperty("StructProperty", structBuilder);
...
TEST_F(ECInstanceJsonWriterTests, WriteInstanceToSchemaJsonTest)
    ...
    SetStructStructProperties(structStructBuilder, nullptr, nullptr, "No number", nullptr, nullptr, 0, { });
    SetStructStructProperties(structStructArrayMemberBuilder1, nullptr, 3.1415926535897932384626433832795028841971, u8"π 41 digits", "EnumeratorB", nullptr, 1, { 25 });
    SetStructStructProperties(structStructArrayMemberBuilder2, nullptr, nullptr, nullptr, nullptr, nullptr, 0, { });
    SetStructProperties(structBuilder, nullptr, nullptr, nullptr, "EnumeratorA", 1, 0, { }, &structStructBuilder, 2, { &structStructArrayMemberBuilder1, &structStructArrayMemberBuilder2 });
    sourceInstanceBuilder.EmplaceProperty("StructProperty", structBuilder);
