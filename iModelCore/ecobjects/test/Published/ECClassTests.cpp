...
//+---------------+---------------+---------------+---------------+---------------+------
TEST_F(ClassTest, TestMixinClass)
    {
...
//@bsimethod                                    Caleb.Shafer                    01/2017
//+---------------+---------------+---------------+---------------+---------------+------
TEST_F(ClassTest, TestMixinClassInReferencedSchema)
    {
    ECSchemaPtr ecSchema;
...
//@bsimethod                                    Caleb.Shafer                    01/2017
//+---------------+---------------+---------------+---------------+---------------+------
TEST_F(ClassTest, TestFailureWhenMixinClassHasCircular)
    {
    ECSchemaPtr ecSchema;
    ECSchemaPtr refSchema;
    ...
    ecSchema->AddReferencedSchema(*ecSchema);
