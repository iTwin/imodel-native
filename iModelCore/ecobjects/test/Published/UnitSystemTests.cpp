/*--------------------------------------------------------------------------------------+
|
|     $Source: test/Published/UnitSystemTests.cpp $
|
...
TEST_F(UnitSystemTest, BasicUnitSystemCreation)
    ...
    auto registrySystem = Units::UnitRegistry::Instance().LookupUnitSystem("TestUnitSystem");
...
TEST_F(UnitSystemTest, UnitSystemContainer)
    ...
    {
    UnitSystemP unitSystem;
    EXPECT_EQ(ECObjectsStatus::Success, schema->CreateUnitSystem(unitSystem, "UnitSystem3", "Unit System 3", "The third UnitSystem"));
    EXPECT_TRUE(nullptr != unitSystem);
    }
    {
    UnitSystemP unitSystem;
    ...
    for (UnitSystemCP unitSystem : schema->GetUnitSystems())
        ...
        switch (curCount)
            ...
            case 2:
                ...
                EXPECT_STREQ("Unit System 3", unitSystem->GetInvariantDisplayLabel().c_str());
                break;
            case 3:
