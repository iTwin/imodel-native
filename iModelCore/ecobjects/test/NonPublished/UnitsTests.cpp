...
TEST_F (UnitsTest, InitializeStandards)
    ...
    MatchStandardNames (UnitSystem::GetStandard (StandardUnitSystem_USCustomary).GetUnits(), s_USUnits);
    MatchStandardNames (UnitSystem::GetStandard (StandardUnitSystem_SI).GetUnits(), s_SIUnits);
