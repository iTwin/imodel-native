...
TEST_F(SchemaValidatorTests, OriginalSchemaReferenceAliasTest) {
    {
        ...
        EXPECT_FALSE(validator.Validate(*badSchemaII)) << "validator should fail 'badSchemaII'. " << "The schema declared alias 'ref' for reference schema 'goodSchema', but the original alias is 'good'. " << "The schema declared alias 'good' for reference schema 'RefSchema', but the original alias is 'ref'.";
    }
    {
