...
struct SchemaCompatibilityTests : ECTestFixture
   ...
   void TestSerializationFailure(ECSchemaCR schema, Utf8StringCR testCaseName, Utf8StringCR expectedSerializedSchema)
      {
      WString wcharXml;
      ...
      EXPECT_TRUE(schema.WriteToJsonValue(actualSchemaJson, true));

      BeJsDocument expectedSchemaJson;
      expectedSchemaJson.Parse(expectedSerializedSchema.c_str());
      ASSERT_FALSE(expectedSchemaJson.hasParseError());
      EXPECT_TRUE(ECTestUtility::JsonDeepEqual(expectedSchemaJson, actualSchemaJson)) << ECTestUtility::JsonSchemasComparisonString(expectedSchemaJson, actualSchemaJson);
      }
   };
...
TEST_F(SchemaCompatibilityTests, PrimitiveTypeAdded)
   ...
   TestSerializationFailure(*m_schema, "PrimitiveTypeAdded", R"json({
      ...
      "items" : {
         "TestClass" : {
            "properties" : [
               {
                  "name" : "BananaTypeProperty",
                  "type" : "PrimitiveProperty",
                  "typeName" : "string"
               },
               {
                  "minOccurs" : 0,
                  "name" : "BananaArrayProperty",
...
TEST_F(SchemaCompatibilityTests, NewEnumerationBackingType)
   {
   Utf8CP partialXml = R"xml(<ECEnumeration typeName="TestEnumeration" backingTypeName="banana" />)xml";
   ...
   TestSerializationFailure(*m_schema, "NewEnumerationBackingType", R"json({
      "$schema" : "https://dev.bentley.com/json_schemas/ec/32/ecschema",
      "alias" : "ts",
      "items" : {
         "TestEnumeration" : {
...
TEST_F(SchemaCompatibilityTests, NewClassModifier)
   {
   Utf8CP partialXml = R"xml(<ECEntityClass typeName="TestClass" modifier="banana" />)xml";
   ...
   TestSerializationFailure(*m_schema, "NewClassModifier", R"json({
      "$schema" : "https://dev.bentley.com/json_schemas/ec/32/ecschema",
      "alias" : "ts",
      "items" : {
         "TestClass" : {
...
TEST_F(SchemaCompatibilityTests, NewPropertyKind)
   ...
   TestSerializationFailure(*m_schema, "NewPropertyKind", R"json({
      "$schema" : "https://dev.bentley.com/json_schemas/ec/32/ecschema",
      "alias" : "ts",
      "items" : {
         "TestClass" : {
...
TEST_F(SchemaCompatibilityTests, NewStrengthType)
   ...
   TestSerializationFailure(*m_schema, "NewStrengthType", R"json({
      "$schema" : "https://dev.bentley.com/json_schemas/ec/32/ecschema",
      "alias" : "ts",
      "items" : {
         "Source" : { "schemaItemType" : "EntityClass" },
         "Target" : { "schemaItemType" : "EntityClass" },
         "TestRelationship" : {
            "modifier" : "None",
            "schemaItemType" : "RelationshipClass",
            "source" : {
               "constraintClasses" : [ "testSchema.Source" ],
               "multiplicity" : "(1..1)",
               "polymorphic" : false,
               "roleLabel" : "likes"
            },
            ...
            "target" : {
               "constraintClasses" : [ "testSchema.Target" ],
               "multiplicity" : "(1..1)",
               "polymorphic" : true,
               "roleLabel" : "is liked by"
            }
         }
      },
      "name" : "testSchema",
...
TEST_F(SchemaCompatibilityTests, NewSchemaItemType)
   {
   Utf8CP partialXml = R"xml(<BananaClass typeName="TestBananaClass" bananaAttribute="yellow"/>)xml";

   CreateSchema(partialXml, "with an unknown Schema Item type.");
   ASSERT_NE(nullptr, m_schema.get());

   TestSerializationFailure(*m_schema, "NewSchemaItemType", R"json({
      "$schema" : "https://dev.bentley.com/json_schemas/ec/32/ecschema",
      "alias" : "ts",
      "name" : "testSchema",
      "version" : "01.00.00"
...
TEST_F(SchemaCompatibilityTests, SchemaItemWithUnknownAttributes)
   {
   Utf8CP partialXml = R"xml(<ECEntityClass typeName="TestBananaClass" bananaAttribute="yellow"/>)xml";
   ...
   TestSerializationFailure(*m_schema, "SchemaItemWithUnknownAttributes", R"json({
      "$schema" : "https://dev.bentley.com/json_schemas/ec/32/ecschema",
      "alias" : "ts",
      "items" : {
         "TestBananaClass" : { "schemaItemType" : "EntityClass" }
      },
      "name" : "testSchema",
      "version" : "01.00.00"
      })json");
