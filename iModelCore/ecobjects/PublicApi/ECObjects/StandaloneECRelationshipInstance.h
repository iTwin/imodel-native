...
//! two IECInstances
//=======================================================================================
struct EXPORT_VTABLE_ATTRIBUTE StandaloneECRelationshipInstance : IECRelationshipInstance, MemoryECInstanceBase {
   ...
   protected:
    ...
    ECObjectsStatus _GetShouldSerializeProperty(bool& serialize, uint32_t propertyIndex, bool useArrayIndex, uint32_t arrayIndex) const override { return GetShouldSerializeProperty(serialize, propertyIndex, useArrayIndex, arrayIndex); }
