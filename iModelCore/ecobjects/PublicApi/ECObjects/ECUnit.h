...
private:
    ...
    ECObjectsStatus SetDisplayLabel(Utf8StringCR value) {T_Super::SetDisplayLabel(value.c_str()); return ECObjectsStatus::Success;}
    ECObjectsStatus SetDescription(Utf8StringCR value) {m_description = value; return ECObjectsStatus::Success;}
    ECObjectsStatus SetConstant(bool isConstant) {T_Super::SetConstant(isConstant); return ECObjectsStatus::Success;}
...
public:
    ...
    ECObjectsStatus SetName(Utf8StringCR nameOrFormat) {m_nameOrFormatString = nameOrFormat; return ECObjectsStatus::Success;}
