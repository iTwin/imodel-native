...
protected:
    ...
    virtual SchemaReadStatus _ReadXmlAttributes (pugi::xml_node classNode, ECSchemaReadContextCR context);
...
protected:
    SchemaReadStatus _ReadXmlAttributes(pugi::xml_node classNode, ECSchemaReadContextCR context) override;
    SchemaWriteStatus _WriteXml(BeXmlWriterR xmlWriter, ECVersion ecXmlVersion) const override;
    bool _ToJson(BeJsValue outValue, bool standalone, bool includeSchemaVersion, bool includeInheritedProperties) const override;
