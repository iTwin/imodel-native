...
public:
    ...
    ECOBJECTS_EXPORT ECObjectsStatus CreateEnumerator(ECEnumeratorP& enumerator, Utf8CP value); //!< Creates a new enumerator at the end of this enumeration. Use autogenerated name
    ECOBJECTS_EXPORT ECObjectsStatus CreateEnumerator(ECEnumeratorP& enumerator, int32_t value); //!< Creates a new enumerator at the end of this enumeration. Use autogenerated name
