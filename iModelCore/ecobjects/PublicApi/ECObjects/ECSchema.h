...
public:
    ...
    ECObjectsStatus SetPriority(int32_t priority) {m_priority = priority; m_flags.prioritySet = true; return ECObjectsStatus::Success;}
...
public:
    ...
    ECObjectsStatus SetDescription(Utf8StringCR value) {m_description = value; return ECObjectsStatus::Success;} //!< Sets the description of this ECEnumeration
    ...
    ECObjectsStatus SetIsStrict(bool value) { m_isStrict = value; return ECObjectsStatus::Success;}
...
public:
    ...
    //! @param[in]  value  The new value to apply
    ECObjectsStatus SetRelativeError(double value) {m_relativeError = value; return ECObjectsStatus::Success;}
...
public:
    ...
    ECObjectsStatus SetClassModifier(ECClassModifier modifier) {m_modifier = modifier; return ECObjectsStatus::Success;} //!< Sets the class modifier
...
private:
    ...
    //  serve as a factory for classes and will manage their lifecycle.  We'll reconsider if we identify a real-world story for constructing a class outside
    //  of a schema.
    ECRelationshipClass(ECSchemaCR schema, bool verify = true) : ECClass(ECClassType::Relationship, schema), m_strength(StrengthType::Referencing),
        m_strengthDirection(ECRelatedInstanceDirection::Forward), m_verify(verify), m_verified(false),
        m_source(this, true, verify), m_target(this, false, verify)
        {}
...
{
private:
    bmap<Utf8String, std::tuple<Utf8String, SchemaKey, ECSchemaPtr>> m_knownSchemas;
protected:
    ECOBJECTS_EXPORT ECSchemaPtr _LocateSchema(SchemaKeyR key, SchemaMatchType matchType, ECSchemaReadContextR schemaContext) override;
public:
    ECOBJECTS_EXPORT void AddSchemaString(SchemaKeyCR schemaKey, Utf8StringCR schemaXml) {m_knownSchemas[schemaKey.GetName()] = std::make_tuple(schemaXml, schemaKey, nullptr);}
};
