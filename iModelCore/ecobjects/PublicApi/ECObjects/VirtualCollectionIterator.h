...
struct VirtualCollectionIterator
{
    ...
    using value_type=typename IteratorImplementation::value_type;
    using difference_type=std::ptrdiff_t;
    using pointer=typename IteratorImplementation::value_type*;
    using reference=typename IteratorImplementation::value_type&;
