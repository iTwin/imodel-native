...
public:
    ...
    ECOBJECTS_EXPORT static ECClassCP GetClassFromClassNameJson(BeJsConst json, IECClassLocaterR locater);
    ...
    ECOBJECTS_EXPORT static ECClassId GetClassIdFromClassNameJson(BeJsConst json, IECClassLocaterR locater);
    ...
    //! @return SUCCESS or ERROR
    ECOBJECTS_EXPORT static BentleyStatus IdToJson(BeJsValue json, BeInt64Id id);
    ...
    ECOBJECTS_EXPORT static void Int64ToJson(BeJsValue json, int64_t int64Val, ECJsonInt64Format int64Format = ECJsonInt64Format::AsDecimalString);
    ...
    //! @return SUCCESS or ERROR
    ECOBJECTS_EXPORT static BentleyStatus JsonToInt64(int64_t& int64Val, BeJsConst json);
    ...
    ECOBJECTS_EXPORT static BentleyStatus JsonToDateTime(DateTime& dateTime, BeJsConst json);
    ...
    //! @return SUCCESS or ERROR
    ECOBJECTS_EXPORT static BentleyStatus Point2dToJson(BeJsValue json, DPoint2d pt);
    ...
    //! @return SUCCESS or ERROR
    ECOBJECTS_EXPORT static BentleyStatus JsonToPoint2d(DPoint2d& pt, BeJsConst json);
    ...
    //! @param[in] pt Point to convert
    //! @return SUCCESS or ERROR
    ECOBJECTS_EXPORT static BentleyStatus Point3dToJson(BeJsValue json, DPoint3d pt);
    ...
    ECOBJECTS_EXPORT static BentleyStatus IGeometryToIModelJson(BeJsValue json, IGeometryCR geom);
...
private:
    ...
    static StatusInt WriteArrayPropertyValue(BeJsValue valueToPopulate, ECN::ArrayECPropertyCR arrayProperty, ECN::IECInstanceCR ecInstance, Utf8CP baseAccessString, IECClassLocaterP classLocator, bool writeFormattedQuantities = false, bool serializeNullValues = false, MemberNameCasing casing = MemberNameCasing::KeepOriginal);
    static StatusInt WriteNavigationPropertyValue(BeJsValue valueToPopulate, ECN::NavigationECPropertyCR navigationProperty, ECN::IECInstanceCR ecInstance, Utf8CP baseAccessString, IECClassLocaterP classLocator, bool writeFormattedQuantities = false, bool serializeNullValues = false, MemberNameCasing casing = MemberNameCasing::KeepOriginal);
...
public:
    ...
    ECOBJECTS_EXPORT static StatusInt WriteEmbeddedStructValue(BeJsValue valueToPopulate, ECN::StructECPropertyCR structProperty, ECN::IECInstanceCR ecInstance, Utf8CP baseAccessString);
    ...
    //! @param[in] baseAccessString The prefix to use to determine the full access string to the property, typically this would be the containing ECStruct's name.
    //! @return SUCCESS or error status.
    ECOBJECTS_EXPORT static StatusInt WriteEmbeddedStructValueForPresentation(BeJsValue valueToPopulate, ECN::StructECPropertyCR structProperty, ECN::IECInstanceCR ecInstance, Utf8CP baseAccessString);
    ...
    //! @return SUCCESS or error status.
    ECOBJECTS_EXPORT static StatusInt WritePrimitiveValue(BeJsValue valueToPopulate, PrimitiveECPropertyCR primitiveProperty, IECInstanceCR ecInstance, Utf8CP baseAccessString);
    ...
    //! @param[in] baseAccessString The prefix to use to determine the full access string to the property, typically this would be the containing ECStruct name.
    //! @return SUCCESS or error status.
    ECOBJECTS_EXPORT static StatusInt WritePrimitiveValueForPresentation(BeJsValue valueToPopulate, PrimitiveECPropertyCR primitiveProperty, IECInstanceCR ecInstance, Utf8CP baseAccessString);
    ...
    //! @return SUCCESS or error status.
    ECOBJECTS_EXPORT static StatusInt WriteInstanceToJson(BeJsValue valueToPopulate, ECN::IECInstanceCR ecInstance, Utf8CP instanceName, bool writeInstanceId, bool serializeNullValues = false, IECClassLocaterP classLocator = nullptr);

    //! Write the supplied instance as JSON excluding system properties and optionally filtering by property name
    //! @return SUCCESS or error status.
    ECOBJECTS_EXPORT static StatusInt WritePartialInstanceToJson(BeJsValue valueToPopulate, ECN::IECInstanceCR ecInstance, MemberNameCasing casing, std::function<bool(Utf8CP)> shouldWriteProperty, IECClassLocaterP classLocator = nullptr);

    //! Write the supplied instance in the ECSchemaJSON format
    //! @param[out] valueToPopulate the JSON object to populate
    //! @param[in] ecInstance the IEInstance containing the property values
    //! @param[in] classLocator to look-up class by ECClassId.
    ECOBJECTS_EXPORT static StatusInt WriteInstanceToSchemaJson(BeJsValue valueToPopulate, ECN::IECInstanceCR ecInstance, IECClassLocaterP classLocator = nullptr);
    ...
    //! @param[in] classLocator to look-up class by ECClassId.
    //! @return SUCCESS or error status.
    ECOBJECTS_EXPORT static StatusInt WriteInstanceToPresentationJson(BeJsValue valueToPopulate, IECInstanceCR ecInstance, Utf8CP instanceName, bool writeInstanceId, IECClassLocaterP classLocator = nullptr);
};
