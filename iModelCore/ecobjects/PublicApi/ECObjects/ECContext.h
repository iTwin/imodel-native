...
public:
    ...
    Utf8String      GetOldUnitName(ECClassCR ecClass, ECPropertyCR property) const {if (nullptr != m_unitResolver) return m_unitResolver->_ResolveUnitName(ecClass, property); else return "";}
