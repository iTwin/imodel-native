...
struct ECQuantityFormatting {
   ...
   public:
    ...
    ECOBJECTS_EXPORT static BEU::Quantity CreateQuantity(Utf8CP input, double* persist, KindOfQuantityCP koq, Formatting::FormatCR presentationFormat, Formatting::FormatProblemCode* probCode, Formatting::QuantityFormatting::UnitResolver* resolver = nullptr) { return Formatting::QuantityFormatting::CreateQuantity(input, persist, koq->GetPersistenceUnit(), presentationFormat, probCode, resolver); }
    ...
    ECOBJECTS_EXPORT static BEU::Quantity CreateQuantity(Utf8CP input, Formatting::FormatCR format, Formatting::FormatProblemCode* probCode, Formatting::QuantityFormatting::UnitResolver* resolver = nullptr) { return Formatting::QuantityFormatting::CreateQuantity(input, format, probCode, resolver); }
};
