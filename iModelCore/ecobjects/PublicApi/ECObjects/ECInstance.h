...
//=======================================================================================    
//! @ingroup ECObjectsGroup
//! ECObject::IECInstance is the native equivalent of a .NET IECInstance.
...
/*__PUBLISH_SECTION_START__*/
    ...
    ECOBJECTS_EXPORT static bool        IsFixedArrayProperty (ECObject::IECInstanceR instance, WCharCP accessString, UInt32* numFixedEntries=NULL);
...
//=======================================================================================    
//! @ingroup ECObjectsGroup
//! ECObject::IECRelationshipInstance is the native equivalent of a .NET IECRelationshipInstance.
...
struct ECInstanceInteropHelper
    ...
    ECOBJECTS_EXPORT static ECObject::ECEnablerP  GetEnablerForStructArrayEntry (IECInstanceR instance, ECValueAccessorR arrayMemberAccessor, SchemaKeyCR schemaKey, WCharCP className);
    ECOBJECTS_EXPORT static ECObjectsStatus GetStructArrayEntry (ECObject::ECValueAccessorR structArrayEntryValueAccessor, IECInstanceR instance, UInt32 index, ECObject::ECValueAccessorCR structArrayValueAccessor, 
