...
struct IECSchemaRemapper
    {
protected:
    virtual void                _ResolvePropertyName (Utf8StringR serializedPropertyName, ECClassCR ecClass) const = 0;
    virtual void                _ResolveClassName (Utf8StringR serializedClassName, ECSchemaCR ecSchema) const = 0;
public:
    //! Given a serialized property name, return the name of the possibly renamed property in the specified ECClass.
    ECOBJECTS_EXPORT void       ResolvePropertyName (Utf8StringR serializedPropertyName, ECClassCR ecClass) const;
    //! Given a serialized class name, return the name of the possibly renamed class in the specified ECSchema
    ECOBJECTS_EXPORT void       ResolveClassName (Utf8StringR serializedClassName, ECSchemaCR ecSchema) const;
    };
