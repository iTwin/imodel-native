...
struct ICustomAttributeDeserializer
    ...
    virtual InstanceReadStatus LoadCustomAttributeFromString(IECInstancePtr& ecInstance, pugi::xml_node xmlNode, ECInstanceReadContextR context, ECSchemaReadContextR schemaContext, IECCustomAttributeContainerR customAttributeContainer) = 0;
    };
...
public:
    ...
    //! Given a xml_document and an instance read context, deserializes and constructs an IECInstance
    //! @param[out] ecInstance  The instance constructed from deserializing the xml file
