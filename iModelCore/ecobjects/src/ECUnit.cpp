...
// @bsimethod
//--------------------------------------------------------------------------------------
ECUnit::ECUnit(ECSchemaCR schema, Units::PhenomenonCR phenomenon, Utf8CP name, Utf8CP definition, double numerator, Nullable<double> denominator) : Units::Unit(phenomenon, name, definition, numerator, 1.0), m_isNumeratorExplicitlyDefined(true), m_schema(schema) {
