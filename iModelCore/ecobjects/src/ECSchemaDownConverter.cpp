...
bool addUnitSpecificationsToProperty(ECSchemaR schema, ECPropertyP ecProperty, ECSchemaR unitAttributesSchema)
    ...
    Utf8CP oldPerUnitName = Units::UnitRegistry::Instance().TryGetOldNameFromECName(perUnitName);
    ...
    if (ecProperty->GetKindOfQuantity()->HasPresentationUnits())
        ...
        Utf8CP oldPresUnitName = Units::UnitRegistry::Instance().TryGetOldNameFromECName(presUnitName);
