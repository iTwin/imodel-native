...
/*---------------------------------------------------------------------------------**/ /**
  @bsimethod
 +---------------+---------------+---------------+---------------+---------------+------*/
ECProperty::ECProperty(ECClassCR ecClass) : m_class(ecClass), m_baseProperty(nullptr), m_kindOfQuantity(nullptr), m_propertyCategory(nullptr), m_priority(0), m_flags() {}
...
bool propertySupportsMinMaxValue(ECPropertyCP prop, PrimitiveType& pt) {
    if (resolvePrimitiveType(prop, pt) && (pt == PrimitiveType::PRIMITIVETYPE_Double ||
...
bool propertySupportsMinMaxLength(ECPropertyCP prop, PrimitiveType& pt) {
    if (resolvePrimitiveType(prop, pt) && (pt == PrimitiveType::PRIMITIVETYPE_String ||
