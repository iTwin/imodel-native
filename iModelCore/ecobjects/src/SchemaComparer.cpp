...
BentleyStatus SchemaComparer::CompareBaseClasses(BaseClassChanges& changes, ECBaseClassesList const* oldList, ECBaseClassesList const* newList) {
    ...
    if (oldBaseClass == nullptr && newBaseClass != nullptr) {
        ...
        if (BeStringUtilities::StricmpAscii(oldFullName, newFullName) != 0) {
            ...
            if (newBaseClass->Is(oldBaseClass->GetSchema().GetName().c_str(), oldBaseClass->GetName().c_str())) {  // in this case we consider it a modification
                ...
                changes.Add(baseClassChange);
            } else {  // in this case we consider it add and remove
                RefCountedPtr<StringChange> baseClassChange = changes.CreateElement(ECChange::OpCode::Deleted, ECChange::Type::BaseClass);
                baseClassChange->Set(Nullable<Utf8String>(Utf8String(oldBaseClass->GetFullName())), nullValue);
                changes.Add(baseClassChange);
...
Utf8CP ECChange::TypeToString(Type type) {
    switch (type) {
        case Type::AbstractConstraint:
            return "AbstractConstraint";
        case Type::Alias:
            return "Alias";
        case Type::BaseClass:
            return "BaseClass";
        case Type::BaseClasses:
            return "BaseClasses";
        case Type::Classes:
            return "Classes";
        case Type::Class:
            return "Class";
        case Type::ClassModifier:
            return "ClassModifier";
        case Type::ClassType:
            return "ClassType";
        case Type::CompositeIncludeZero:
            return "CompositeIncludeZero";
        case Type::CompositeSpacer:
            return "CompositeSpacer";
        case Type::CompositeMajorUnit:
            return "CompositeMajorUnit";
        case Type::CompositeMajorLabel:
            return "CompositeMajorLabel";
        case Type::CompositeMiddleUnit:
            return "CompositeMiddleUnit";
        case Type::CompositeMiddleLabel:
            return "CompositeMiddleLabel";
        case Type::CompositeMinorUnit:
            return "CompositeMinorUnit";
        case Type::CompositeMinorLabel:
            return "CompositeMinorLabel";
        case Type::CompositeSubUnit:
            return "CompositeSubUnit";
        case Type::CompositeSubLabel:
            return "CompositeSubLabel";
        case Type::CompositeValueSpec:
            return "CompositeValueSpec";
        case Type::ConstraintClass:
            return "ConstraintClass";
        case Type::ConstraintClasses:
            return "ConstraintClasses";
        case Type::Constraint:
            return "Constraint";
        case Type::CustomAttribute:
            return "CustomAttribute";
        case Type::CustomAttributes:
            return "CustomAttributes";
        case Type::DecimalPrecision:
            return "DecimalPrecision";
        case Type::DecimalSeparator:
            return "DecimalSeparator";
        case Type::Description:
            return "Description";
        case Type::Direction:
            return "Direction";
        case Type::DisplayLabel:
            return "DisplayLabel";
        case Type::ECVersion:
            return "ECVersion";
        ...
        case Type::Enumerator:
            return "Enumerator";
        case Type::Enumerators:
            return "Enumerators";
        case Type::ExtendedTypeName:
            return "ExtendedTypeName";
        case Type::Format:
            return "Format";
        case Type::Formats:
            return "Formats";
        case Type::FormatTraits:
            return "FormatTraits";
        case Type::FractionalPrecision:
            return "FractionalPrecision";
        case Type::Integer:
            return "Integer";
        case Type::IsInteger:
            return "IsInteger";
        case Type::IsPolymorphic:
            return "IsPolymorphic";
        case Type::IsReadonly:
            return "IsReadonly";
        case Type::IsStrict:
            return "IsStrict";
        case Type::IsString:
        ...
        case Type::IsStruct:
            return "IsStruct";
        case Type::IsStructArray:
            return "IsStructArray";
        case Type::IsPrimitive:
            return "IsPrimitive";
        case Type::IsPrimitiveArray:
            return "IsPrimitiveArray";
        case Type::IsNavigation:
            return "IsNavigation";
        case Type::KindOfQuantities:
            return "KindOfQuantities";
        case Type::KindOfQuantity:
            return "KindOfQuantity";
        case Type::KoqPersistenceUnit:
            return "KoqPersistenceUnit";
        case Type::KoqPresentationFormat:
            return "KoqPresentationFormat";
        case Type::KoqPresentationFormats:
            return "KoqPresentationFormats";
        case Type::KoqRelativeError:
            return "KoqRelativeError";
        case Type::MaximumLength:
            return "MaximumLength";
        case Type::MaximumValue:
            return "MaximumValue";
        case Type::MaxOccurs:
            return "MaxOccurs";
        case Type::MinimumLength:
            return "MinimumLength";
        case Type::MinimumValue:
            return "MinimumValue";
        case Type::MinOccurs:
            return "MinOccurs";
        case Type::MinWidth:
            return "MinWidth";
        case Type::Multiplicity:
            return "Multiplicity";
        case Type::Name:
            return "Name";
        case Type::NumericFormatSpec:
            return "NumericFormatSpec";
        case Type::OriginalECXmlVersionMajor:
            return "OriginalECXmlVersionMajor";
        case Type::OriginalECXmlVersionMinor:
            return "OriginalECXmlVersionMinor";
        case Type::Phenomena:
            return "Phenomena";
        case Type::Phenomenon:
            return "Phenomenon";
        case Type::PhenomenonDefinition:
            return "PhenomenonDefinition";
        case Type::PresentationType:
            return "PresentationType";
        case Type::Properties:
            return "Properties";
        case Type::Property:
            return "Property";
        case Type::PropertyCategories:
            return "PropertyCategories";
        case Type::PropertyCategory:
            return "PropertyCategory";
        case Type::PropertyCategoryPriority:
            return "PropertyCategoryPriority";
        case Type::PropertyPriority:
            return "PropertyPriority";
        case Type::PropertyType:
            return "PropertyType";
        case Type::PropertyValue:
            return "PropertyValue";
        case Type::PropertyValues:
            return "PropertyValues";
        case Type::Relationship:
            return "Relationship";
        case Type::RoleLabel:
            return "RoleLabel";
        case Type::RoundFactor:
            return "RoundFactor";
        case Type::Schema:
            return "Schema";
        case Type::SchemaReference:
            return "SchemaReference";
        case Type::SchemaReferences:
            return "SchemaReferences";
        case Type::Schemas:
            return "Schemas";
        case Type::ScientificType:
            return "ScientificType";
        case Type::ShowSignOption:
            return "ShowSignOption";
        case Type::Source:
            return "Source";
        case Type::StationSeparator:
            return "StationSeparator";
        case Type::StationOffsetSize:
            return "StationOffsetSize";
        case Type::StrengthDirection:
            return "StrengthDirection";
        case Type::StrengthType:
            return "StrengthType";
        case Type::String:
            return "String";
        case Type::Target:
            return "Target";
        case Type::ThousandSeparator:
            return "ThousandSeparator";
        case Type::TypeName:
            return "TypeName";
        case Type::UnitSystem:
            return "UnitSystem";
        case Type::UnitSystems:
            return "UnitSystems";
        case Type::Unit:
            return "Unit";
        case Type::UnitDefinition:
            return "UnitDefinition";
        case Type::UnitNumerator:
            return "UnitNumerator";
        case Type::UnitDenominator:
            return "UnitDenominator";
        case Type::UnitInvertingUnit:
            return "UnitInvertingUnit";
        case Type::UnitIsConstant:
            return "UnitIsConstant";
        case Type::UnitOffset:
            return "UnitOffset";
        case Type::Units:
            return "Units";
        case Type::UomSeparator:
            return "UomSeparator";
        case Type::VersionRead:
            return "VersionRead";
        case Type::VersionMinor:
            return "VersionMinor";
        case Type::VersionWrite:
            return "VersionWrite";
    }
...
CustomAttributeValidator::Policy CustomAttributeValidator::Validate(CustomAttributeChange const& change) const {
    ...
    ChangeType classChangeType = change.GetOpCode() == ECChange::OpCode::New ? ChangeType::New : (change.GetOpCode() == ECChange::OpCode::Modified ? ChangeType::Modified : ChangeType::Delete);
    ...
    for (auto propValueChangePtr : change.PropValues()) {
        ...
        ChangeType propertyChangeType = propValueChangePtr->GetOpCode() == ECChange::OpCode::New ? ChangeType::New : (change.GetOpCode() == ECChange::OpCode::Modified ? ChangeType::Modified : ChangeType::Delete);
