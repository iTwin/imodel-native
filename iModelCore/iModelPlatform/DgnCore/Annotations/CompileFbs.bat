...
SET SrcDir=%SrcRoot%imodel02\iModelCore\iModelPlatform\DgnCore\Annotations\
...
SET OutDir=%SrcRoot%imodel02\iModelCore\iModelPlatform\PrivateApi\DgnPlatformInternal\DgnCore\Annotations\
