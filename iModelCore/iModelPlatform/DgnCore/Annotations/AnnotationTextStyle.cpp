...
AnnotationTextStylePtr AnnotationTextStyle::CreateEffectiveStyle(
    ...
    effectiveStyle->SetFontId(runOverrides.HasProperty(AnnotationTextStyleProperty::FontId) ? FontId((uint64_t)runOverrides.GetIntegerProperty(AnnotationTextStyleProperty::FontId)) : runStyle.GetFontId());
