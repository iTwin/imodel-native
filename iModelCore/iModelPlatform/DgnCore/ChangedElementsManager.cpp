...
// @bsimethod
//---------------------------------------------------------------------------------------
bool ChangedElementsManager::HasChangeset(ECDbR cacheDb, ChangesetInfoPtr revision)
    {
...
// @bsimethod
//---------------------------------------------------------------------------------------
DbResult ChangedElementsManager::InsertEntries(ECDbR cacheDb, ChangesetInfoPtr revision, bvector<ChangedElement> const& elements)
    {
...
// @bsimethod
//---------------------------------------------------------------------------------------
DbResult ChangedElementsManager::ProcessChangesets(ECDbR cacheDb, Utf8String rulesetId, bvector<ChangesetInfoPtr> const& revisions)
    {
    ...
    bvector<ChangesetInfoPtr> processedRevisions;
    for (ChangesetInfoPtr rev : revisions)
    ...
    for (ChangesetInfoPtr revision : processedRevisions)
        {
        // Generate a summary for each revision
        bvector<ChangesetInfoPtr> currentRevisions;
