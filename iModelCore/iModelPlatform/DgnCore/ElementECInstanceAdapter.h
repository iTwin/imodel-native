...
DEFINE_REF_COUNTED_PTR(ElementAutoHandledPropertiesECInstanceAdapter)
...
private:
    ...
    IECInstanceP        _GetAsIECInstance() const override;
...
protected:
    ElementAutoHandledPropertiesECInstanceAdapter(DgnElement const&, bool loadProperties, size_t initialAllocation);
    ElementAutoHandledPropertiesECInstanceAdapter(DgnElement const&, ECClassCR, ECN::ClassLayoutCR, bool loadProperties, size_t initialAllocation);

public:
    static ElementAutoHandledPropertiesECInstanceAdapterPtr Create(DgnElement const&, bool loadProperties, size_t initialAllocation = 0);
    static ElementAutoHandledPropertiesECInstanceAdapterPtr Create(DgnElement const&, ECClassCR, ECN::ClassLayoutCR, bool loadProperties, size_t initialAllocation = 0);
