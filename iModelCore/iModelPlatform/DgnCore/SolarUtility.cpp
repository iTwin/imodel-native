...
// @bsimethod
//---------------------------------------------------------------------------------------
DPoint3dR   SolarUtility::AzimuthAnglesToDirection (DPoint3dR direction, double azimuth, double altitude, DgnGCS const* dgnGcs)
    {
...
// @bsimethod
//---------------------------------------------------------------------------------------
void    SolarUtility::DirectionToAzimuthAngles (double& azimuth, double& altitude, DPoint3dCR direction, DgnGCS const* dgnGcs)
    {
    /* Compensate for true North */
    RotMatrix   azimuthRotMatrix;
    double azimuthAngle = (dgnGcs != nullptr) ? dgnGcs->GetAzimuth() : 0.0;
...
double*             outAltitude
    ...
    DVec3d      outVector;
    AzimuthAnglesToDirection (outVector, azimuth, altitude, gcs);
