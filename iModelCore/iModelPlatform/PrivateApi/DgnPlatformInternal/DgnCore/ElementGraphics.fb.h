...
MANUALLY_ALIGNED_STRUCT(8) Trans2x3 {
 private:
  double x00_;
  double x01_;
  double tx_;
 ...
 public:
  Trans2x3(double x00, double x01, double tx, double y00, double y01, double ty)
    : x00_(flatbuffers::EndianScalar(x00)), x01_(flatbuffers::EndianScalar(x01)), tx_(flatbuffers::EndianScalar(tx)), y00_(flatbuffers::EndianScalar(y00)), y01_(flatbuffers::EndianScalar(y01)), ty_(flatbuffers::EndianScalar(ty)) { }

  double x00() const { return flatbuffers::EndianScalar(x00_); }
  double x01() const { return flatbuffers::EndianScalar(x01_); }
  double tx() const { return flatbuffers::EndianScalar(tx_); }
  double y00() const { return flatbuffers::EndianScalar(y00_); }
  double y01() const { return flatbuffers::EndianScalar(y01_); }
  double ty() const { return flatbuffers::EndianScalar(ty_); }
};
STRUCT_END(Trans2x3, 48);
...
struct Image : private flatbuffers::Table {
  uint8_t drawBorder() const { return GetField<uint8_t>(4, 0); }
  uint8_t useFillTint() const { return GetField<uint8_t>(6, 0); }
  const DPoint3d *tileCorner0() const { return GetStruct<const DPoint3d *>(8); }
  const DPoint3d *tileCorner1() const { return GetStruct<const DPoint3d *>(10); }
  const DPoint3d *tileCorner2() const { return GetStruct<const DPoint3d *>(12); }
  const DPoint3d *tileCorner3() const { return GetStruct<const DPoint3d *>(14); }
  uint32_t width() const { return GetField<uint32_t>(16, 0); }
  uint32_t height() const { return GetField<uint32_t>(18, 0); }
  uint32_t format() const { return GetField<uint32_t>(20, 0); }
  const flatbuffers::Vector<uint8_t> *byteData() const { return GetPointer<const flatbuffers::Vector<uint8_t> *>(22); }
  int64_t textureId() const { return GetField<int64_t>(24, 0); }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<uint8_t>(verifier, 4 /* drawBorder */) &&
           VerifyField<uint8_t>(verifier, 6 /* useFillTint */) &&
           VerifyField<DPoint3d>(verifier, 8 /* tileCorner0 */) &&
           VerifyField<DPoint3d>(verifier, 10 /* tileCorner1 */) &&
           VerifyField<DPoint3d>(verifier, 12 /* tileCorner2 */) &&
           VerifyField<DPoint3d>(verifier, 14 /* tileCorner3 */) &&
           VerifyField<uint32_t>(verifier, 16 /* width */) &&
           VerifyField<uint32_t>(verifier, 18 /* height */) &&
           VerifyField<uint32_t>(verifier, 20 /* format */) &&
           VerifyField<flatbuffers::uoffset_t>(verifier, 22 /* byteData */) &&
           verifier.Verify(byteData()) &&
           VerifyField<int64_t>(verifier, 24 /* textureId */) &&
           verifier.EndTable();
  }
  bool has_drawBorder() const { return CheckField(4); }
  bool has_useFillTint() const { return CheckField(6); }
  bool has_tileCorner0() const { return CheckField(8); }
  bool has_tileCorner1() const { return CheckField(10); }
  bool has_tileCorner2() const { return CheckField(12); }
  bool has_tileCorner3() const { return CheckField(14); }
  bool has_width() const { return CheckField(16); }
  bool has_height() const { return CheckField(18); }
  bool has_format() const { return CheckField(20); }
  bool has_byteData() const { return CheckField(22); }
  bool has_textureId() const { return CheckField(24); }
};

struct ImageBuilder {
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_drawBorder(uint8_t drawBorder) { fbb_.AddElement<uint8_t>(4, drawBorder, 0); }
  void add_useFillTint(uint8_t useFillTint) { fbb_.AddElement<uint8_t>(6, useFillTint, 0); }
  void add_tileCorner0(const DPoint3d *tileCorner0) { fbb_.AddStruct(8, tileCorner0); }
  void add_tileCorner1(const DPoint3d *tileCorner1) { fbb_.AddStruct(10, tileCorner1); }
  void add_tileCorner2(const DPoint3d *tileCorner2) { fbb_.AddStruct(12, tileCorner2); }
  void add_tileCorner3(const DPoint3d *tileCorner3) { fbb_.AddStruct(14, tileCorner3); }
  void add_width(uint32_t width) { fbb_.AddElement<uint32_t>(16, width, 0); }
  void add_height(uint32_t height) { fbb_.AddElement<uint32_t>(18, height, 0); }
  void add_format(uint32_t format) { fbb_.AddElement<uint32_t>(20, format, 0); }
  void add_byteData(flatbuffers::Offset<flatbuffers::Vector<uint8_t>> byteData) { fbb_.AddOffset(22, byteData); }
  void add_textureId(int64_t textureId) { fbb_.AddElement<int64_t>(24, textureId, 0); }
  ...
  flatbuffers::Offset<Image> Finish() {
    auto o = flatbuffers::Offset<Image>(fbb_.EndTable(start_, 11));
    return o;
  }
};
...
inline flatbuffers::Offset<Image> CreateImage(flatbuffers::FlatBufferBuilder &_fbb,
   ...
   const DPoint3d *tileCorner0 = 0,
   const DPoint3d *tileCorner1 = 0,
   const DPoint3d *tileCorner2 = 0,
   const DPoint3d *tileCorner3 = 0,
   uint32_t width = 0,
   uint32_t height = 0,
   uint32_t format = 0,
...
struct Material : private flatbuffers::Table {
  ...
  const Trans2x3 *trans2x3() const { return GetStruct<const Trans2x3 *>(18); }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<Trans2x3>(verifier, 18 /* trans2x3 */) &&
           verifier.EndTable();
  }
  ...
  bool has_trans2x3() const { return CheckField(18); }
};
...
struct MaterialBuilder {
  ...
  void add_trans2x3(const Trans2x3 *trans2x3) { fbb_.AddStruct(18, trans2x3); }
  ...
  flatbuffers::Offset<Material> Finish() {
    auto o = flatbuffers::Offset<Material>(fbb_.EndTable(start_, 8));
    return o;
  }
};
...
struct ThematicSettings : private flatbuffers::Table {
  ...
  bool has_margin() const { return CheckField(6); }
...
inline flatbuffers::Offset<ThematicSettings> CreateThematicSettings(flatbuffers::FlatBufferBuilder &_fbb,
...
struct AreaFill : private flatbuffers::Table {
  ...
  const ThematicSettings *thematicSettings() const { return GetPointer<const ThematicSettings *>(28); }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<flatbuffers::uoffset_t>(verifier, 28 /* thematicSettings */) &&
  ...
  bool has_thematicSettings() const { return CheckField(28); }
};
...
struct AreaFillBuilder {
  ...
  void add_thematicSettings(flatbuffers::Offset<ThematicSettings> thematicSettings) { fbb_.AddOffset(28, thematicSettings); }
  ...
  flatbuffers::Offset<AreaFill> Finish() {
    auto o = flatbuffers::Offset<AreaFill>(fbb_.EndTable(start_, 13));
    return o;
  }
};
...
inline flatbuffers::Offset<AreaFill> CreateAreaFill(flatbuffers::FlatBufferBuilder &_fbb,
   ...
   flatbuffers::Offset<ThematicSettings> thematicSettings = 0) {
