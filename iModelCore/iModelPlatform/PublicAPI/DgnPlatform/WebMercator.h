...
struct ImageryProvider : RefCountedBase
{
    ...
    virtual void _FromJson(BeJsConst value) = 0;
...
protected:
    ...
    void FromJson(BeJsConst value);
    void ToJson(BeJsValue value) const;
...
public:
    ...
    private:
        BeJsDocument m_jsonParameters;

    public:
        // used when creating a new WebMercatorModel from user inputs, which are passed in the jsonParameters.
        CreateParams(DgnDbR dgndb, DgnElementId modeledElementId, BeJsConst jsonParameters) :
                ...
                { m_jsonParameters.From(jsonParameters); }
...
public:
    ...
    void _FromJson(BeJsConst value) override;
    void _ToJson(BeJsValue) const override;
    MapType _GetMapType () const override {return m_mapType; }

    static MapBoxImageryProvider* Create (BeJsConst providerDataValue);
};
...
public:
    ...
    static BingImageryProvider* Create (BeJsConst providerDataValue);
    };
...
public:
    ...
    static HereImageryProvider* Create (BeJsConst providerDataValue);
    };
