...
DGNPLATFORM_TYPEDEFS(SheetIndexModel)
DGNPLATFORM_TYPEDEFS(SheetIndexPartition)
DGNPLATFORM_TYPEDEFS(SheetIndexElement)
...
DGNPLATFORM_TYPEDEFS(ChangesetProps)
...
DGNPLATFORM_REF_COUNTED_PTR(ChangesetProps)
...
DGNPLATFORM_REF_COUNTED_PTR(SheetIndexModel)
DGNPLATFORM_REF_COUNTED_PTR(SheetIndexPartition)
DGNPLATFORM_REF_COUNTED_PTR(SheetIndexElement)
