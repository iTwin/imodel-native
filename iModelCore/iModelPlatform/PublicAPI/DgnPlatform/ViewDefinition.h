...
protected:
    ...
    DGNPLATFORM_EXPORT DgnDbStatus _InsertInDb(std::optional<EditOptions> options) override;
    DGNPLATFORM_EXPORT DgnDbStatus _OnUpdate(DgnElementCR, std::optional<EditOptions> options) override;
    DGNPLATFORM_EXPORT DgnDbStatus _OnDelete(std::optional<EditOptions> options) const override;
    DGNPLATFORM_EXPORT void _OnDeleted(std::optional<EditOptions> options) const override;
...
protected:
    ...
    void _OnInserted(DgnElementP copiedFrom, std::optional<EditOptions> options) const override {ClearState(); T_Super::_OnInserted(copiedFrom, options);}
    DGNPLATFORM_EXPORT DgnDbStatus _OnDelete(std::optional<EditOptions> options) const override;
    void _OnDeleted(std::optional<EditOptions> options) const override {DeleteThumbnail(); T_Super::_OnDeleted(options);}
    ...
    DgnDbStatus _OnChildInsert(DgnElementCR, std::optional<EditOptions> options) const override {return DgnDbStatus::InvalidParent;}
    DgnDbStatus _OnChildUpdate(DgnElementCR, DgnElementCR, std::optional<EditOptions> options) const override {return DgnDbStatus::InvalidParent;}
...
protected:
    ...
    DGNPLATFORM_EXPORT bool _EqualState(ViewDefinitionR) override;
    DGNPLATFORM_EXPORT DgnDbStatus _OnInsert(std::optional<EditOptions> options) override;
    void _OnInserted(DgnElementP copiedFrom, std::optional<EditOptions> options) const override {m_modelSelector=nullptr; T_Super::_OnInserted(copiedFrom, options);}
