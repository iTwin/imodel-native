...
public:
    ...
    DGNPLATFORM_EXPORT static GraphicalModel3dPtr Create(DgnElementCR modeledElement);
    DGNPLATFORM_EXPORT static GraphicalModel3dPtr CreateAndInsert(DgnElementCR modeledElement);
};
