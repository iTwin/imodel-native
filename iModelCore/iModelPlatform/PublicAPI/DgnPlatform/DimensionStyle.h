...
struct DimStyleIterator
{
    ...
    using value_type=DimensionStyleP const;
    using difference_type=std::ptrdiff_t;
    using pointer=DimensionStyleP const*;
    using reference=DimensionStyleP const&;
...
/*===========================================================================
  ...
  dimension line. TextLocation flag is needed to support DWG's Outside
...
/*===========================================================================
  Pursuing dwg behavior, we have got ourselves into a complicated
  situation with the following flags.

  uElbowJointLocation       - introduced earlier
