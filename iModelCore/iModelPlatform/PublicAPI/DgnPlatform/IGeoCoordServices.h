...
{
virtual ~IGeoCoordinateServices() { }
virtual Utf8CP                              GetGCSName (Utf8StringR gcsName, DgnGCSP sourceGCS) = 0;
virtual Utf8CP                              GetDescription (Utf8StringR gcsDescription, DgnGCSP sourceGCS) = 0;
