...
public:
    ...
    AnnotationLeaderStyleCPtr Insert(std::optional<EditOptions> options = std::nullopt); { return GetDgnDb().Elements().Insert<AnnotationLeaderStyle>(*this, nullptr, options); }
