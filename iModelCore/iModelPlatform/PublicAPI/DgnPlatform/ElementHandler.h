...
namespace dgn_ElementHandler
{
    ...
    struct EXPORT_VTABLE_ATTRIBUTE RenderTimeline : InformationRecord
    {
        ELEMENTHANDLER_DECLARE_MEMBERS(BIS_CLASS_RenderTimeline, Dgn::RenderTimeline, RenderTimeline, InformationRecord, DGNPLATFORM_EXPORT)
    };
    ...
    {
        ELEMENTHANDLER_DECLARE_MEMBERS(BIS_CLASS_ExternalSourceGroup, Dgn::ExternalSourceGroup, ExternalSourceGroup, ExternalSource, DGNPLATFORM_EXPORT)
    };

    struct EXPORT_VTABLE_ATTRIBUTE ExternalSourceAttachment : InformationContent
    {
        ELEMENTHANDLER_DECLARE_MEMBERS(BIS_CLASS_ExternalSourceAttachment, Dgn::ExternalSourceAttachment, ExternalSourceAttachment, InformationContent, DGNPLATFORM_EXPORT)
    };
