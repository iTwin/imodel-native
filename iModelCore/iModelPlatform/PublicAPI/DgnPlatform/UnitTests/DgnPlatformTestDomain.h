...
protected:
    ...
    Dgn::DgnDbStatus _InsertInDb(std::optional<EditOptions> options = std::nullopt) override;
    Dgn::DgnDbStatus _UpdateInDb(std::optional<EditOptions> options = std::nullopt) override;
    Dgn::DgnDbStatus _DeleteInDb(std::optional<EditOptions> options = std::nullopt) const override;
