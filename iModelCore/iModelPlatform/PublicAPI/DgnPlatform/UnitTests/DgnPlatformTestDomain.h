...
protected:
    ...
    Dgn::DgnDbStatus _InsertInDb(std::optional<Dgn::EditOptions> options) override;
    Dgn::DgnDbStatus _UpdateInDb(std::optional<Dgn::EditOptions> options) override;
    Dgn::DgnDbStatus _DeleteInDb(std::optional<Dgn::EditOptions> options) const override;
