...
struct ChangedElementsManager final {
    private:
        ...
        DbResult InsertEntries(ECDbR cacheDb, ChangesetPropsPtr revision, bvector<ChangedElement> const& elements);
        bool HasChangeset(ECDbR cacheDb, ChangesetPropsPtr revision);
    ...
    public:
        ...
        DGNPLATFORM_EXPORT DbResult ProcessChangesets(ECDbR cacheDb, Utf8String rulesetId, bvector<ChangesetPropsPtr> const& revisions);
