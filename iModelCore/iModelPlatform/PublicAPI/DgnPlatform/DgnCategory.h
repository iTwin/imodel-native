...
public:
    ...
    public:
        ...
        DGNPLATFORM_EXPORT void FromJson(BeJsConst); //!< initialize this appearance from a previously saved json
        DGNPLATFORM_EXPORT void ToJson(BeJsValue) const;   //!< convert this appearance to a json value
    ...
    public:
        Override() {Init();}
        explicit Override(BeJsConst val) {Init(); FromJson(val);}
        ...
        void ToJson(BeJsValue outValue) const;
...
public:
    ...
    SpatialCategoryCP ToSpatialCategory() const {return _ToSpatialCategory();} //!< more efficient substitute for dynamic_cast<SpatialCategoryCP>(category)
    DrawingCategoryCP ToDrawingCategory() const {return _ToDrawingCategory();} //!< more efficient substitute for dynamic_cast<DrawingCategoryCP>(category)
...
protected:
    bool _SupportsCodeSpec(CodeSpecCR codeSpec) const override {return !codeSpec.IsNullCodeSpec();}
    DrawingCategoryCP _ToDrawingCategory() const override final {return this;}
...
protected:
    bool _SupportsCodeSpec(CodeSpecCR codeSpec) const override {return !codeSpec.IsNullCodeSpec();}
    SpatialCategoryCP _ToSpatialCategory() const override final {return this;}
