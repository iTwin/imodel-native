...
void ChangeTestFixture::SetUpTestCase()
    ...
    ASSERT_EQ(SchemaStatus::Success, DgnPlatformTestDomain::GetDomain().ImportSchema(*db, SchemaManager::SchemaImportOptions::AllowDataTransformDuringSchemaUpgrade));
