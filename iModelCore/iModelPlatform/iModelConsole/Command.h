...
// @bsiclass
//---------------------------------------------------------------------------------------
struct ExplainCommand final : public Command
    {
    private:
        Utf8String _GetName() const override { return ".explain"; }
        Utf8String _GetUsage() const override;
        void _Run(Session&, Utf8StringCR args) const override;
...
// @bsiclass
//---------------------------------------------------------------------------------------
struct CheckTransformCommand final : public Command
    {
    private:
        Utf8String _GetName() const override { return ".check-transform"; }
        Utf8String _GetUsage() const override;
        void _Run(Session&, Utf8StringCR args) const override;
...
struct DropCommand final : public Command
    {
    private:
        Utf8String _GetName() const override { return ".drop"; }
        Utf8String _GetUsage() const override;
        void _Run(Session&, Utf8StringCR args) const override;
...
// @bsiclass
//---------------------------------------------------------------------------------------
struct MergeCommand final : public Command
    {
    private:
        static Utf8CP const ECSCHEMA_SWITCH;

        Utf8String _GetName() const override { return ".merge"; }
        Utf8String _GetUsage() const override;
        void _Run(Session&, Utf8StringCR args) const override;
...
// @bsiclass
//---------------------------------------------------------------------------------------
struct MergeExternalCommand final : public Command
    {
    private:
        static Utf8CP const ECSCHEMA_SWITCH;

        Utf8String _GetName() const override { return ".mergeexternal"; }
        Utf8String _GetUsage() const override;
        void _Run(Session&, Utf8StringCR args) const override;
    ...
    public:
        MergeExternalCommand() : Command() {}
        ~MergeExternalCommand() {}
    };
