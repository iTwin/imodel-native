...
MessageList MSGLISTID_GeoCoordNames =
{
    ...
    { COORDSYS_OST15,           "Ordinance Survey Transform 2015 (Great Britain)"   },
...
MessageList    MSGLISTID_DgnGeoCoordStrings =
{
    ...
    { DGNGEOCOORD_Msg_VerticalConvertErrors,                  "Warning or Error: Vertical Coordinate System conversion error(s) occurred for %d points for which elevation may have been incorrectly adjusted; the selected Vertical CS may not be suitable for use with the selected Horizontal CS at the point(s) location, or required Geoid or VERTCON files may not be properly installed or configured."  },
