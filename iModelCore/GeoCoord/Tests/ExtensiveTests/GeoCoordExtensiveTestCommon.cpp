...
* @bsimethod
+---------------+---------------+---------------+---------------+---------------+------*/
bool GeoCoordExtensiveTestCommon::Initialize(bool doNotUseAllEarth)
    {
    BeFileName tempDir;
...
* @bsimethod
+---------------+---------------+---------------+---------------+---------------+------*/
void GeoCoordExtensiveTestCommon::Shutdown()
    {
    if (GeoCoordinates::BaseGCS::IsLibraryInitialized())
...
* @bsimethod
+---------------+---------------+---------------+---------------+---------------+------*/
const Utf8String& GeoCoordExtensiveTestCommon::InitializedLibraryPath()
    {
    GeoCoordExtensiveTestCommon::Initialize();
...
* @bsimethod
+---------------+---------------+---------------+---------------+---------------+------*/
const bvector<Utf8String>& GeoCoordExtensiveTestCommon::GetListOfGCS()
    {
    GeoCoordExtensiveTestCommon::Initialize();
...
* @bsimethod
+---------------+---------------+---------------+---------------+---------------+------*/
const bvector<Utf8String>& GeoCoordExtensiveTestCommon::GetRepresentativeListOfGCS()
    {
    GeoCoordExtensiveTestCommon::Initialize();
    ...
    if(s_representativeListOfGCS.empty())
        ...
        const bvector<Utf8String>& listOfGCS = GeoCoordExtensiveTestCommon::GetListOfGCS();
        ...
        for (auto GCSName : listOfGCS)
            ...
            if (currentGCS.IsValid() && currentGCS->IsValid())
                ...
                // If it is not a datum we already have .. we add
...
* @bsimethod
+---------------+---------------+---------------+---------------+---------------+------*/
const bvector<Utf8String>& GeoCoordExtensiveTestCommon::GetListOfDatums()
    {
    GeoCoordExtensiveTestCommon::Initialize();
...
* @bsimethod
+---------------+---------------+---------------+---------------+---------------+------*/
const bvector<Utf8String>& GeoCoordExtensiveTestCommon::GetListOfUnsupportedDatums()
    {
...
* @bsimethod
+---------------+---------------+---------------+---------------+---------------+------*/
const bvector<Utf8String>& GeoCoordExtensiveTestCommon::GetListOfDatumsWithAdditionalPaths()
    {
