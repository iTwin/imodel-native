...
enum    DgnProjectionTypes 
    ...
    COORDSYS_OST15     =    84, // (Cyln) OSTN15 Ordnance Survey 2015 Great Britain
...
enum  BaseGeoCoordErrors
    ...
    GEOCOORDERR_MaxUserLibraryGeodeticTransforms= (GeoCoordErrorBase  - 63),
