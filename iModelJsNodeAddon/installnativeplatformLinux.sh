...
cp $OutRoot/LinuxX64/imodeljsnodeaddon_pkgs/imodeljs-native/* $tempDir/full-stack-tests/backend/node_modules/@bentley/imodeljs-native
cp -r $OutRoot/LinuxX64/imodeljsnodeaddon_pkgs/imodeljs-linux-x64 $tempDir/full-stack-tests/backend/node_modules/@bentley/imodeljs-native
