...
struct GeometryManipulationStrategyBase : RefCountedBase
    ...
    protected:
        ...
        GMS_V_SET_TRYGET_PROPERTY_TYPE(Dgn::DgnElementCP)
        GMS_V_SET_TRYGET_PROPERTY_TYPE(Dgn::ColorDef)
    ...
    public:
        ...
        GMS_SET_TRYGET_PROPERTY_TYPE(Dgn::DgnElementCP)
        GMS_SET_TRYGET_PROPERTY_TYPE(Dgn::ColorDef)
