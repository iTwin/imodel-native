...
public:
    ...
    BUILDINGUTILS_EXPORT static int ExtractNameIndexAndTemplateString(Utf8String& tmpStr);
    ...
    BUILDINGUTILS_EXPORT static int ParseStringForInt(Utf8CP string);
    BUILDINGUTILS_EXPORT static double ParseStringForDouble(Utf8CP string);

    BUILDINGUTILS_EXPORT static bool CheckIfModelHasElements(Dgn::DgnModelP model);
};
...
public:
    ...
    BUILDINGUTILS_EXPORT static Dgn::DgnElementId GetElementIdByParentElementAuthorityAndName(Dgn::DgnDbR db, Utf8CP authorityName, Dgn::DgnElementId parentId, Utf8CP elementName);
    ...
    BUILDINGUTILS_EXPORT static Dgn::ElementIterator MakeIterator(Dgn::DgnElementCR element, ECN::ECClassId classId);
};
