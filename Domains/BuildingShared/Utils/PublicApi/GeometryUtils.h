...
public:
    ...
    BUILDINGUTILS_EXPORT static CurveVectorPtr   ExtractXYProfileFromSolid (Dgn::IBRepEntityCR solid, CurveVectorPtr* pTopProfile = nullptr);
    ...
    BUILDINGUTILS_EXPORT static bool AlmostEqual(double a, double b, double tolerance = BUILDING_TOLERANCE);
    ...
    BUILDINGUTILS_EXPORT static DPoint3d FindFurthestPoint(CurveVectorCPtr curveVector, DPoint3d point);
    ...
    //! @param[in] theta            angle in radians
    BUILDINGUTILS_EXPORT static void RotatePlacementAroundPointXY(Dgn::Placement3dR placement, DPoint3d origin, double theta);
    ...
    BUILDINGUTILS_EXPORT static double RotMatrixToAngleXY(RotMatrix rotMatrix);

    //! Finds angle in XY plane from placement
    //! @param[in] placement    placement with rotation angle
    //! @return                 rotation angle aroud z axis
    BUILDINGUTILS_EXPORT static double PlacementToAngleXY(Dgn::Placement3d placement);
    ...
    BUILDINGUTILS_EXPORT static DgnExtrusionDetail CreatePlaneExtrusionDetail(double length, double height);
    ...
    //! @return                 formed extrusion detail
    BUILDINGUTILS_EXPORT static DgnExtrusionDetail CreatePlaneExtrusionDetail(DPoint3d startPoint, DPoint3d endPoint, double height);
    ...
    BUILDINGUTILS_EXPORT static DgnExtrusionDetail CreateArcExtrusionDetail(double radius, double baseAngle, double height, double extendLength = 0);
    ...
    BUILDINGUTILS_EXPORT static DgnExtrusionDetail CreateSplineExtrusionDetail(bvector<DPoint3d> poles, double height, int order = SPLINE_ORDER);
    ...
    BUILDINGUTILS_EXPORT static bool CheckIfLineIntersectsCurveVector(bvector<DSegment3d>& intersections, DSegment3d line, CurveVectorCPtr curveVector);
    ...
    BUILDINGUTILS_EXPORT static bool CheckIfTwoLinesIntersect(DSegment3dR intersectionSegment, DSegment3d line1, DSegment3d line2);
    ...
    BUILDINGUTILS_EXPORT static bool CheckIfParallelLineSegmentsCoincide(DSegment3dR intersectionSegment, DSegment3d line1, DSegment3d line2);
    ...
    BUILDINGUTILS_EXPORT static DPoint3d GetPointFromParamtericForm(DVec3d v, DVec3d d, double t);
    ...
    //! @return determinant
    BUILDINGUTILS_EXPORT static double GetDeterminant2x2(double a11, double a12, double a21, double a22);
    ...
    BUILDINGUTILS_EXPORT static void ToParametricForm(DVec3dR v, DVec3dR d, DSegment3d line);
    ...
    BUILDINGUTILS_EXPORT static bool IsPointContainedInRangeToTolerance(DRange3d range, DPoint3d point, double tolerance);
    ...
    BUILDINGUTILS_EXPORT static BentleyStatus FindShortestPathBetweenPointsInCurveVector(bvector<DPoint3d>& pathLineString, CurveVectorPtr curveVector, DPoint3d source, DPoint3d destination);
    ...
    BUILDINGUTILS_EXPORT static CurveVectorPtr OffsetCurveInnerOuterChildren(CurveVectorCPtr originalCurve, double innerOffset, double outerOffset, bool mergeIntoDifference = false);
    ...
    BUILDINGUTILS_EXPORT static bool CheckIfLineIsContainedInPolygonArea(CurveVectorCPtr area, DSegment3d line);
    ...
    BUILDINGUTILS_EXPORT static void ExtractInnerOuterCurves(bvector<CurveVectorCPtr>& innerCurves, bvector<CurveVectorCPtr>& outerCurves, CurveVectorCPtr source);
    ...
    BUILDINGUTILS_EXPORT static bvector<DPoint3d> ExtractLineString(CurveVectorCPtr curveVector);
    ...
    BUILDINGUTILS_EXPORT static double DistanceFromPointToLine(DSegment3d line, DPoint3d point);
    ...
    BUILDINGUTILS_EXPORT static bool CheckIfLineIntersectsWithLineString(bvector<DPoint3d> lineString, DSegment3d line);
    ...
    BUILDINGUTILS_EXPORT static void ExtractInnerOuterLineStrings(bvector<bvector<DPoint3d>>& innerLineStrings, bvector<bvector<DPoint3d>>& outerLineStrings, CurveVectorCPtr shape);
    ...
    BUILDINGUTILS_EXPORT static double GetPathLength(bvector<DPoint3d> path);
    ...
    BUILDINGUTILS_EXPORT static double GetCorrectedPathLength(DPoint3d source, DPoint3d target, bvector<DPoint3d> correctionPoints);
    ...
    BUILDINGUTILS_EXPORT static CurveVectorPtr GeometryUtils::GetXYCrossSection(Dgn::IBRepEntityCR solid, double z);
    ...
    BUILDINGUTILS_EXPORT static BentleyStatus    SliceBodyByZElevations (bvector<bpair<Dgn::IBRepEntityPtr, Dgn::IBRepEntityPtr>>& slicedGeometry, Dgn::IBRepEntityCR geometryToSlice, bvector<double>& zElevationVector);
    ...
    BUILDINGUTILS_EXPORT static void AddVertex(CurveVectorR cv, DPoint3d const& vertex);

    BUILDINGUTILS_EXPORT static void LineStringAsWeightedCurve(CurveVectorPtr&, double);
    ...
    BUILDINGUTILS_EXPORT static bool AllPointsInOrOnShape(bvector<DPoint3d> const& shapePoints, bvector<DPoint3d> const& pointsToTest);
    ...
    BUILDINGUTILS_EXPORT static bvector<DPoint3d> GetConvexPolygonVertices(size_t n, double ccRadius, DPoint3d ccCenter = {0,0,0}, bool keepArea = false);
    ...
    BUILDINGUTILS_EXPORT static bvector<DPoint3d> GetCircularArcPoints(DEllipse3d arc, double maxEdgeLength = DEFAULT_MAX_EDGE_LENGTH, bool keepSectorArea = false);
    ...
    BUILDINGUTILS_EXPORT static bvector<DPoint3d> GetCurvePrimitivePoints(ICurvePrimitiveCPtr curvePrimitive, double maxEdgeLength = DEFAULT_MAX_EDGE_LENGTH, bool keepSectorArea = false);
    ...
    BUILDINGUTILS_EXPORT static bvector<DPoint3d> GetCurveVectorPoints(CurveVectorCPtr curveVectorPtr, double maxEdgeLength = DEFAULT_MAX_EDGE_LENGTH, bool keepSectorArea = false);
    ...
    BUILDINGUTILS_EXPORT static bool IsSameSingleLoopGeometry(CurveVectorCR geom1, CurveVectorCR geom2, double tolerace = DoubleOps::SmallMetricDistance());

    //! Checks if given ICurvePrimitives have the same geometry (within tolerance).
    BUILDINGUTILS_EXPORT static bool IsSameGeometry(ICurvePrimitiveCR geom1, ICurvePrimitiveCR geom2, double tolerance = DoubleOps::SmallMetricDistance());
    };
