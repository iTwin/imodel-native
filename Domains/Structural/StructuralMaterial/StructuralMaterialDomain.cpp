/*--------------------------------------------------------------------------------------+
|
|     $Source: StructuralMaterial/StructuralMaterialDomain.cpp $
|
|  $Copyright: (c) 2017 Bentley Systems, Incorporated. All rights reserved. $
|
+--------------------------------------------------------------------------------------*/
#include <StructuralDomain/StructuralMaterial/StructuralMaterialApi.h>

BEGIN_BENTLEY_STRUCTURAL_NAMESPACE

DOMAIN_DEFINE_MEMBERS(StructuralMaterialDomain)

//---------------------------------------------------------------------------------------
// @bsimethod                                   Bentley.Systems
//---------------------------------------------------------------------------------------
StructuralMaterialDomain::StructuralMaterialDomain() : DgnDomain(BENTLEY_STRUCTURAL_MATERIAL_SCHEMA_NAME, "Bentley Structural Material Domain", 1)
    {
