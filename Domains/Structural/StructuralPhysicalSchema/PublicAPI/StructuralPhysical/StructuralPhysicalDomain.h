/*--------------------------------------------------------------------------------------+
|
|     $Source: StructuralPhysicalSchema/PublicAPI/StructuralPhysical/StructuralPhysicalDomain.h $
|
...
struct StructuralPhysicalDomain : Dgn::DgnDomain
    {
    DOMAIN_DECLARE_MEMBERS(StructuralPhysicalDomain, STRUCTURAL_PHYSICAL_EXPORT)
    ...
    public:
        ...
        STRUCTURAL_PHYSICAL_EXPORT static Dgn::CodeSpecId QueryStructuralPhysicalCodeSpecId(Dgn::DgnDbCR dgndb);
        STRUCTURAL_PHYSICAL_EXPORT static Dgn::DgnCode CreateCode(Dgn::DgnDbR dgndb, Utf8StringCR nameSpace, Utf8StringCR value);
    };
