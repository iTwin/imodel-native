/*--------------------------------------------------------------------------------------+
|
|     $Source: StructuralMaterials/Tests/StructuralMaterialsBaseFixture.h $
|
...
//=======================================================================================
struct StructuralMaterialsTestsHost : DgnViewLib::Host
    {
    protected:
        virtual void _SupplyProductName(BentleyApi::Utf8StringR name) override { name.assign("StructuralMaterialsTests"); }
...
class StructuralMaterialsBaseFixture : public testing::Test
    {
    private:
        static StructuralMaterialsTestsHost m_host;
...
class StructuralMaterialsTestFixture : public StructuralMaterialsBaseFixture
    {
  ...
  //  Revit::RevitBridge& GetBridgeInstance()
  //      {
  //      return m_bridge;
   //     }
    };