/*--------------------------------------------------------------------------------------+
|
|     $Source: _old/StructuralMaterials/Tests/StructuralMaterialsTestsMain.cpp $
|
...
static wchar_t const* s_configFileName = L"ArchitecturePhysicalTestFixtureTests.logging.config.xml";
