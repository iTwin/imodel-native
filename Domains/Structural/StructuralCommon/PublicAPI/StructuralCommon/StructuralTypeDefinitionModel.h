/*--------------------------------------------------------------------------------------+
|
|     $Source: StructuralCommon/PublicAPI/StructuralCommon/StructuralTypeDefinitionModel.h $
|
...
struct StructuralTypeDefinitionModel : Dgn::DefinitionModel
    ...
    // Parameter 1) STRUCTURAL_COMMON_CLASS_StructuralTypeDefinitionModel - the name of the ECEntityClass in the ecschema.xml file
    // Parameter 2) Dgn::DefinitionModel - the superclass of StructuralTypeDefinitionModel
    DGNMODEL_DECLARE_MEMBERS(STRUCTURAL_COMMON_CLASS_StructuralTypeDefinitionModel, Dgn::DefinitionModel);
