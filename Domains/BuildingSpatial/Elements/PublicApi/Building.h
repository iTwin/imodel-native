...
struct Building : SPATIALCOMPOSITION_NAMESPACE_NAME::CompositeElement, SPATIALCOMPOSITION_NAMESPACE_NAME::ICompositeVolume
    {
    DGNELEMENT_DECLARE_MEMBERS(BUILDINGSPATIAL_CLASS_Building, SPATIALCOMPOSITION_NAMESPACE_NAME::CompositeElement);
