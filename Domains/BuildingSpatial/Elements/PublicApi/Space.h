...
struct Space : SPATIALCOMPOSITION_NAMESPACE_NAME::CompositeElement
    {
    DGNELEMENT_DECLARE_MEMBERS(BUILDINGSPATIAL_CLASS_Space, SPATIALCOMPOSITION_NAMESPACE_NAME::CompositeElement);
