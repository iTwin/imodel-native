/*-------------------------------------------------------------------------------------+
|
|     $Source: PublicApi/ThreeMxSchema/ThreeMXReader.h $
|
...
public:
    ...
    THREEMX_SCHEMA_EXPORT static BentleyStatus Read3MX(std::istream& in, S3SceneInfo& outSceneInfo, std::string& err);
    THREEMX_SCHEMA_EXPORT static BentleyStatus Read3MX(BeFileNameCR filename, S3SceneInfo& outSceneInfo, std::string& err);
};
...
public:
	// read .3mxb file
	// failure: returns false, error message in err
    THREEMX_SCHEMA_EXPORT BentleyStatus Read3MXB(std::istream& in, std::string& err);
    THREEMX_SCHEMA_EXPORT BentleyStatus Read3MXB(BeFileNameCR filename, std::string& err);
