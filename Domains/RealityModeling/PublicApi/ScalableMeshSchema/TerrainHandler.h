/*--------------------------------------------------------------------------------------+
|
|     $Source: PublicApi/ScalableMeshSchema/TerrainHandler.h $
|
...
struct TerrainSpatialModel : Dgn::SpatialModel
    {
    protected:
        TerrainSpatialModel(CreateParams const& params) : Dgn::SpatialModel(params){};
