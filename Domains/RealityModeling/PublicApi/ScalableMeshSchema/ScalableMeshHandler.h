...
private:
    ...
    virtual Dgn::TileTree::TriMeshTree::TriMeshPtr _CreateGeometry(Dgn::TileTree::TriMeshTree::TriMesh::CreateParams const& args, Dgn::Render::SystemP renderSys) { return new SMGeometry(args, *this, renderSys); }
