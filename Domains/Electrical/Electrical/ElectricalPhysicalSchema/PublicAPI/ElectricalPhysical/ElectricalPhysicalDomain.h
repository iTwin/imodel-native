/*--------------------------------------------------------------------------------------+
|
|     $Source: Electrical/ElectricalPhysicalSchema/PublicAPI/ElectricalPhysical/ElectricalPhysicalDomain.h $
|
...
namespace ElectricalPhysical
	...
	//! @ingroup GROUP_ElectricalPhyscal
	//=======================================================================================
	...
	public:
		...
		ELECTRICAL_PHYSICAL_EXPORT static Dgn::DgnSubCategoryId QueryElectricalPhysicalDoorPanelSubCategoryId(Dgn::DgnDbR);

		//! Get the DgnSubCategoryId for a Door frame
		ELECTRICAL_PHYSICAL_EXPORT static Dgn::DgnSubCategoryId QueryElectricalPhysicalDoorFrameSubCategoryId(Dgn::DgnDbR);

		//! Get the DgnCategoryId to be used for Window Elements
		ELECTRICAL_PHYSICAL_EXPORT static Dgn::DgnCategoryId QueryElectricalPhysicalWindowCategoryId(Dgn::DgnDbR);

		//! Get the DgnSubCategoryId for a Door Panel
		ELECTRICAL_PHYSICAL_EXPORT static Dgn::DgnSubCategoryId QueryElectricalPhysicalWindowPanelSubCategoryId(Dgn::DgnDbR);

		//! Get the DgnSubCategoryId for a Door frame
		ELECTRICAL_PHYSICAL_EXPORT static Dgn::DgnSubCategoryId QueryElectricalPhysicalWindowFrameSubCategoryId(Dgn::DgnDbR);

		//! Get the DgnSubCategoryId for a Door frame
		ELECTRICAL_PHYSICAL_EXPORT static Dgn::DgnCategoryId QueryElectricalPhysicalWallCategoryId(Dgn::DgnDbR db);
#endif
		//! Get the DgnSubCategoryId for a Door frame
