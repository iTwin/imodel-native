/*--------------------------------------------------------------------------------------+
|
|     $Source: Electrical/ElectricalPhysicalSchema/ElectricalPhysicalDomain.cpp $
|
...
namespace ElectricalPhysical
{
	...
	{
		RegisterHandler(ElectricalBaseElementHandler::GetHandler());
		RegisterHandler(DeviceHandler::GetHandler());
		RegisterHandler(DeviceTypeHandler::GetHandler());
	}
