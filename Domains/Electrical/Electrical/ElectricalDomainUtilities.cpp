/*--------------------------------------------------------------------------------------+
|
|     $Source: Electrical/ElectricalDomainUtilities.cpp $
|
...
namespace ElectricalDomain
{
	...
	/*ECN::ECEntityClassP   ElectricalDomainUtilities::CreatePhysicalElementEntityClassFromArchPhysicalClass(Dgn::DgnDbPtr db, ECN::ECSchemaPtr schema, Utf8StringCR  className, Utf8StringCR  archClassName)
	{
