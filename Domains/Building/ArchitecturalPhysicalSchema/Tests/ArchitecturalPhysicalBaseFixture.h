/*--------------------------------------------------------------------------------------+
|
|     $Source: ArchitecturalPhysicalSchema/Tests/ArchitecturalPhysicalBaseFixture.h $
|
...
//=======================================================================================
struct ArchitecturalPhysicalTestsHost : DgnViewLib::Host
    {
    protected:
        virtual void _SupplyProductName(BentleyApi::Utf8StringR name) override { name.assign("ArchitecturalPhysicalTests"); }
...
class ArchitecturalPhysicalBaseFixture : public testing::Test
    {
    private:
        static ArchitecturalPhysicalTestsHost m_host;
...
class ArchitecturalPhysicalTestFixture : public ArchitecturalPhysicalBaseFixture
    {
