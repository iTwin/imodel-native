/*--------------------------------------------------------------------------------------+
|
|     $Source: tests/AecUnitsBaseFixture.h $
|
...
//=======================================================================================
struct AecUnitsTestsHost : DgnViewLib::Host
    {
    protected:
        virtual void _SupplyProductName(BentleyApi::Utf8StringR name) override { name.assign("AecUnitsTests"); }
...
class AecUnitsBaseFixture : public testing::Test
    {
    private:
        static AecUnitsTestsHost m_host;
...
class AecUnitsTestFixture : public AecUnitsBaseFixture
    {
  ...
  //  void    GetWorkingDb(DgnDbPtr& db, BeFileNameR revitFile, WCharCP rvtFileName);
    ...
    Dgn::DgnCategoryId       QueryPhysicalCategoryId(Dgn::DgnDbR db, Utf8CP categoryName);
    Dgn::DgnCategoryId       InsertCategory(Dgn::DgnDbR db, Utf8CP codeValue, Dgn::ColorDef const& color);
    Dgn::PhysicalElementPtr  CreatePhysicalElement(Utf8StringCR schemaName, Utf8StringCR className, Dgn::PhysicalModelCR model, Utf8CP categoryName = nullptr);
