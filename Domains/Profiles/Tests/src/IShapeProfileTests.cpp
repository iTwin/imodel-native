...
* @bsimethod                                                                     11/2018
+---------------+---------------+---------------+---------------+---------------+------*/
TEST_F (IShapeProfileTestCase, Insert_ValidCreateParams_SuccessfulInsert)
    {
...
* @bsimethod                                                                     11/2018
+---------------+---------------+---------------+---------------+---------------+------*/
TEST_F (IShapeProfileTestCase, Insert_EmptyCreateParams_FailedInsert)
    {
    CreateParams params (GetModel(), "I");
...
* @bsimethod                                                                     11/2018
+---------------+---------------+---------------+---------------+---------------+------*/
TEST_F (IShapeProfileTestCase, Insert_InvalidProfileName_FailedInsert)
    {
...
* @bsimethod                                                                     11/2018
+---------------+---------------+---------------+---------------+---------------+------*/
TEST_F (IShapeProfileTestCase, Insert_ValidProfileName_SuccessfulInsert)
    {
    CreateParams params (GetModel(), nullptr, 10.0, 10.0, 1.0, 1.0);
...
* @bsimethod                                                                     11/2018
+---------------+---------------+---------------+---------------+---------------+------*/
TEST_F (IShapeProfileTestCase, Insert_InvalidFlangeWidth_FailedInsert)
    {
    CreateParams params (GetModel(), "I", INFINITY, 10.0, 1.0, 1.0);
...
* @bsimethod                                                                     11/2018
+---------------+---------------+---------------+---------------+---------------+------*/
TEST_F (IShapeProfileTestCase, Insert_ValidFlangeWidth_SuccessfulInsert)
    {
    CreateParams params (GetModel(), "I", INFINITY, 10.0, 1.0, 1.0);
...
* @bsimethod                                                                     11/2018
+---------------+---------------+---------------+---------------+---------------+------*/
TEST_F (IShapeProfileTestCase, Insert_InvalidDepth_FailedInsert)
    {
    CreateParams params (GetModel(), "I", 10.0, INFINITY, 1.0, 1.0);
...
* @bsimethod                                                                     11/2018
+---------------+---------------+---------------+---------------+---------------+------*/
TEST_F (IShapeProfileTestCase, Insert_ValidDepth_SuccessfulInsert)
    {
    CreateParams params (GetModel(), "I", 10.0, INFINITY, 1.0, 1.0);
...
* @bsimethod                                                                     11/2018
+---------------+---------------+---------------+---------------+---------------+------*/
TEST_F (IShapeProfileTestCase, Insert_InvalidFlangeThickness_FailedInsert)
    {
    CreateParams params (GetModel(), "I", 10.0, 10.0, INFINITY, 1.0);
...
* @bsimethod                                                                     11/2018
+---------------+---------------+---------------+---------------+---------------+------*/
TEST_F (IShapeProfileTestCase, Insert_ValidFlangeThickness_SuccessfulInsert)
    {
    CreateParams params (GetModel(), "I", 10.0, 10.0, INFINITY, 1.0);
...
* @bsimethod                                                                     11/2018
+---------------+---------------+---------------+---------------+---------------+------*/
TEST_F (IShapeProfileTestCase, Insert_InvalidWebThickness_FailedInsert)
    {
    CreateParams params (GetModel(), "I", 10.0, 10.0, 1.0, INFINITY);
...
* @bsimethod                                                                     11/2018
+---------------+---------------+---------------+---------------+---------------+------*/
TEST_F (IShapeProfileTestCase, Insert_ValidWebThickness_SuccessfulInsert)
    {
    CreateParams params (GetModel(), "I", 10.0, 10.0, 1.0, INFINITY);
...
* @bsimethod                                                                     11/2018
+---------------+---------------+---------------+---------------+---------------+------*/
TEST_F (IShapeProfileTestCase, Insert_VariousFilletRadiusAndShortFlange_CorrectInsertResult)
    {
...
* @bsimethod                                                                     11/2018
+---------------+---------------+---------------+---------------+---------------+------*/
TEST_F (IShapeProfileTestCase, Insert_VariousFilletRadiusAndShortWeb_CorrectInsertResult)
    {
...
* @bsimethod                                                                     11/2018
+---------------+---------------+---------------+---------------+---------------+------*/
TEST_F (IShapeProfileTestCase, Insert_VariousFilletRadiusAndNonZeroFlangeSlope_CorrectInsertResult)
    {
    CreateParams params (GetModel(), "I_NonZeroFlangeSlope", 20.0, 10.0, 1.0, 1.0, INFINITY);
    params.flangeSlope = (PI / 180.0) * 10.0;

    double const innerWebFaceLength = params.depth - params.flangeThickness * 2.0;
    double const innerFlangeFaceLength = (params.flangeWidth - params.webThickness) / 2.0;
    double const slopeDepth = (innerFlangeFaceLength / std::cos (params.flangeSlope)) * std::sin (params.flangeSlope);

    double const maximumFilletRadiusForWeb = innerWebFaceLength / 2.0 - slopeDepth;
    BeAssert (maximumFilletRadiusForWeb >= 0.0 && "Flange slope height cannot be greater than half of the inner web face length");
...
* @bsimethod                                                                     11/2018
+---------------+---------------+---------------+---------------+---------------+------*/
TEST_F (IShapeProfileTestCase, Insert_VariousFlangeSlope_CorrectInsertResult)
    {
...
* @bsimethod                                                                     11/2018
+---------------+---------------+---------------+---------------+---------------+------*/
TEST_F (IShapeProfileTestCase, Insert_FlangeSlopeOfPIRadians_FailedInsert)
    {
