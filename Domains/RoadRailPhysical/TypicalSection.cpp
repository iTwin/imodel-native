...
* @bsimethod                                    Diego.Diaz                      04/2017
+---------------+---------------+---------------+---------------+---------------+------*/
EndConditionDefinitionCPtr EndConditionDefinition::Insert(TypicalSectionPortionBreakDownModelPtr& breakDownModelPtr, DgnDbStatus* stat)
    {
...
* @bsimethod                                    Diego.Diaz                      04/2017
+---------------+---------------+---------------+---------------+---------------+------*/
BufferDefinitionCPtr BufferDefinition::Insert(TypicalSectionPortionBreakDownModelPtr& breakDownModelPtr, DgnDbStatus* stat)
    {
