...
#define V8ORD_PROP_CorridorSurfaceAspect_CorridorName                            "CorridorName"
#define V8ORD_PROP_CorridorSurfaceAspect_HorizontalName                          "HorizontalName"
#define V8ORD_PROP_CorridorSurfaceAspect_ProfileName                             "ProfileName"
