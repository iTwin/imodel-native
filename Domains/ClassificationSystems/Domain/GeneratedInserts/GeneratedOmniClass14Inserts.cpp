...
void GeneratedInserts::InsertOmniClass14Definitions(Dgn::DgnDbR db, Dgn::DgnModelCR model) const
    {
    ClassificationSystemCPtr omniClassSystem = TryAndGetSystem(db, model, "OmniClass", "2006-03-28");
