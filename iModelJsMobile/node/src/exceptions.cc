...
Local<Value> ErrnoException(Isolate* isolate,
  ...
  obj->Set(env->context(), env->errno_string(), Integer::New(isolate, errorno)).Check();
  ...
  if (syscall != nullptr) {
    obj->Set(env->context(), env->syscall_string(), OneByteString(isolate, syscall)).Check();
  }
...
Local<Value> UVException(Isolate* isolate,
  ...
  e->Set(env->context(), env->errno_string(), Integer::New(isolate, errorno)).Check();
