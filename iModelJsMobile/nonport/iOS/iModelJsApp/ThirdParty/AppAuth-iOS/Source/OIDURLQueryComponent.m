    ...
    if (@available(iOS 8.0, macOS 10.10, *)) {
      ...
      if (!gOIDURLQueryComponentForceIOS7Handling) {
        ...
        if(!components.percentEncodedQuery) {
          NSString* param = [components.fragment stringByReplacingOccurrencesOfString:@" " withString:@"%20"];
          components.fragment  = nil;
          components.percentEncodedQuery = [param stringByReplacingOccurrencesOfString:@"+" withString:@"%20"];;
